...
var schema = (0, _schemas.generateObjSchema)({
  hoverInHandlers: _objectSpread(_objectSpread({***REMOVED***, _schemas.arraySchema), {***REMOVED***, {
    description: 'An array of events that need to be accompanied by `onFocus`'
  ***REMOVED***),
  hoverOutHandlers: _objectSpread(_objectSpread({***REMOVED***, _schemas.arraySchema), {***REMOVED***, {
