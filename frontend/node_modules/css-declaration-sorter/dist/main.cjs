...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case '../orders/alphabetical.mjs': return Promise.resolve().then(function () { return alphabetical; ***REMOVED***);
    case '../orders/concentric-css.mjs': return Promise.resolve().then(function () { return concentricCss; ***REMOVED***);
    case '../orders/smacss.mjs': return Promise.resolve().then(function () { return smacss; ***REMOVED***);
...
const cssDeclarationSorter = ({ order = 'alphabetical', keepOverrides = false ***REMOVED*** = {***REMOVED***) => ({
  ...
  OnceExit (css) {
    ...
    ***REMOVED***
    ...
    return __variableDynamicImportRuntime0__(`../orders/${order***REMOVED***.mjs`)
