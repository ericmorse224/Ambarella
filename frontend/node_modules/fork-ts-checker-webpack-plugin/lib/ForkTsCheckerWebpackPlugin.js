...
class ForkTsCheckerWebpackPlugin {
    constructor(options = {***REMOVED***) {
        ...
        const { config: externalOptions ***REMOVED*** = explorerSync.search() || {***REMOVED***;
        // first validate options directly passed to the constructor
        const configuration = { name: 'ForkTsCheckerWebpackPlugin' ***REMOVED***;
        schema_utils_1.default(ForkTsCheckerWebpackPluginOptions_json_1.default, options, configuration);
        this.options = deepmerge_1.default(externalOptions || {***REMOVED***, options || {***REMOVED***);
