...
let utils = new (function () {
  /**
    ...
    final callback.
    `
    @param {String[]***REMOVED*** cmds The list of shell-commands to execute
    @param {Object***REMOVED*** [opts]
      @param {Boolean***REMOVED*** [opts.printStdout=false] Print stdout from each command
      @param {Boolean***REMOVED*** [opts.printStderr=false] Print stderr from each command
      @param {Boolean***REMOVED*** [opts.breakOnError=true] Stop further execution on
      the first error.
      @param {Boolean***REMOVED*** [opts.windowsVerbatimArguments=false] Don't translate
      arguments on Windows.
    @param {Function***REMOVED*** [callback] Callback to run after executing  the
    commands
    ...
    let cmds = [
      ...
      , callback = function () {
        ...
        ***REMOVED***
    jake.exec(cmds, {stdout: true***REMOVED***, callback);
   */
      ...
      sh.on('exit', function (code) {
        ...
        ***REMOVED***
        if (code === 0 || !config.breakOnError) {
          ...
          setTimeout(function () { _run.call(self); ***REMOVED***, 0);
        ***REMOVED***
      ***REMOVED***);
