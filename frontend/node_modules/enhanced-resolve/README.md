...
```js
const fs = require("fs");
const { CachedInputFileSystem, ResolverFactory ***REMOVED*** = require("enhanced-resolve");
...
| extensionAlias   | {***REMOVED***                          | An object which maps extension to extension aliases                                                                                                       |
| cachePredicate   | function() { return true ***REMOVED***; | A function which decides whether a request should be cached or not. An object is passed to the function with `path` and `request` properties.             |
