...
### Case: I got the error "Elements with the '${role***REMOVED***' interactive role must be tabbable". How can I fix this?
...
### Case: I got the error "Elements with the '${role***REMOVED***' interactive role must be focusable". How can I fix this?
...
<div aria-hidden onClick={() => void 0***REMOVED*** />
