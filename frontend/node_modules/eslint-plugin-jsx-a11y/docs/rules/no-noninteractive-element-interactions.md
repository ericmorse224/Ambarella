...
<div role="article">
  <div
    ...
    onKeyPress={onKeyPressHandler***REMOVED***
    role="presentation">
    {this.props.children***REMOVED***
  </div>
</div>
```
...
```jsx
<h3>
  <button onClick={this._expandSection***REMOVED***>News</button>
</h3>
<ul id="articles-list">
  <li>...</li>
</ul>
...
<table role="grid">
  <tr>
    <td role="gridcell" onClick={this.sort***REMOVED***>Sort</td>
  </tr>
</table>
```
...
```jsx
<div onClick={() => void 0***REMOVED*** role="button" />
<div onClick={() => void 0***REMOVED*** role="presentation" />
<input type="text" onClick={() => void 0***REMOVED*** /> // Interactive element does not require role.
<button onClick={() => void 0***REMOVED*** className="foo" /> // button is interactive.
<div onClick={() => void 0***REMOVED*** role="button" aria-hidden /> // This is hidden from screen reader.
<Input onClick={() => void 0***REMOVED*** type="hidden" /> // This is a higher-level DOM component
```

### Fail

```jsx
<li onClick={() => void 0***REMOVED*** />
<div onClick={() => void 0***REMOVED*** role="listitem" />
```
