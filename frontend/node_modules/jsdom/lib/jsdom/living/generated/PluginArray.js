...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'PluginArray'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(PluginArray.prototype, {
    refresh: { enumerable: true ***REMOVED***,
    item: { enumerable: true ***REMOVED***,
    namedItem: { enumerable: true ***REMOVED***,
    length: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "PluginArray", configurable: true ***REMOVED***,
