...
if (program.debug) console.log(`Program name is ${program.name()***REMOVED***`);
```

```js
// New code
const options = program.opts();
if (options.debug) console.log(`Program name is ${program.name()***REMOVED***`);
```
...
program
  ...
  // Old code before Commander 7
  .action((filename, cmd)) => {
    if (cmd.trace) console.log(`Command name is ${cmd.name()***REMOVED***`);
  ***REMOVED***);
```
...
```js
  ...
  .action((filename, options, command)) => {
    if (options.trace) console.log(`Command name is ${command.name()***REMOVED***`);
  ***REMOVED***);
```
...
program
  ...
  .action((filename, command)) => {
    if (command.opts().trace) console.log(`Command name is ${command.name()***REMOVED***`);
  ***REMOVED***);
```
