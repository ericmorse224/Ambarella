...
* the packages exports was changed, please use `const { validate ***REMOVED*** = require('schema-utils');`
* the `ValidateError` export was removed in favor the `ValidationError` export, please use `const { ValidationError ***REMOVED*** = require('schema-utils');`
...
* add support for `typeof`, `instanceof` (`{Function\|RegExp***REMOVED***`) ([#10](https://github.com/webpack-contrib/schema-utils/issues/10)) ([9f01816](https://github.com/webpack-contrib/schema-utils/commit/9f01816))
