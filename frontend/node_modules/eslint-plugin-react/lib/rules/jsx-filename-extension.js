...
const messages = {
  noJSXWithExtension: 'JSX not allowed in files with extension \'{{ext***REMOVED******REMOVED***\'',
  extensionOnlyForJSX: 'Only files containing JSX may use the extension \'{{ext***REMOVED******REMOVED***\'',
***REMOVED***;
