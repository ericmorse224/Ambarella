...
* [`e9cef99`](https://github.com/eslint/eslint/commit/e9cef99e6ebec1faefdb576ca597e81ae4f04afd) Docs: wrap {{***REMOVED******REMOVED*** in raw liquid tags to prevent interpolation (#12643) (Kai Cataldo)
...
* 54b329a Docs: fix substitution of {{ name ***REMOVED******REMOVED*** (#9822) (Andres Kalle)

v4.15.0 - January 6, 2018

* 6ab04b5 New: Add context.report({ messageId ***REMOVED***) (fixes #6740) (#9165) (Jed Fox)
...
* aafebb2 Docs: Wrap placeholder sample in {% raw %***REMOVED*** (#7798) (Daniel Lo Nigro)
...
* 3c379ff Update: `no-restricted-{imports,modules***REMOVED***`: add “patterns” (fixes #6963) (#7433) (Jordan Harband)
...
* Fix: camelcase rule with {properties: never***REMOVED*** shouldn't check assignment (fixes #2189) (Gyandeep Singh)
...
* #595 remove needless 'function Foo() {***REMOVED***' in tests (Kyle Nunery)
...
* remove "function invalid(){ return D ***REMOVED***" from some tests (Michael Ficarra)
