import type { CacheDurationSeconds, DebugLevel ***REMOVED*** from '@typescript-eslint/types';
import type * as ts from 'typescript';
import type { TSESTree, TSESTreeToTSNode, TSNode, TSToken ***REMOVED*** from './ts-estree';
