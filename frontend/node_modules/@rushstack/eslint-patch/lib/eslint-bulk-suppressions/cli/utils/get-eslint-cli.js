...
function getEslintPath(packagePath) {
    ...
    try {
        ...
        ***REMOVED***);
        ...
        const { version: localEslintVersion ***REMOVED*** = require(`${localEslintPath***REMOVED***/package.json`);
    ...
    ***REMOVED***
        ...
        try {
            const { dependencies, devDependencies ***REMOVED*** = require(`${packagePath***REMOVED***/package.json`);
