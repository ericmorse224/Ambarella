 ...
 * TCP or `IPC` servers ({@link createServer***REMOVED***) and clients
 * ({@link createConnection***REMOVED***).
 *
...
declare module "net" {
    ...
    ***REMOVED***
     ...
     * a server. For example, it is returned by {@link createConnection***REMOVED***,
     * so the user can use it to talk to the server.
     *
     * It can also be created by Node.js and passed to the user when a connection
     * is received. For example, it is passed to the listeners of a `'connection'` event emitted on a {@link Server***REMOVED***, so the user can use
    ...
    class Socket extends stream.Duplex {
         ...
         * socket as reported by the operating system:`{ port: 12346, family: 'IPv4', address: '127.0.0.1' ***REMOVED***`
         * @since v0.1.90
         */
        address(): AddressInfo | {***REMOVED***;
        /**
    ...
    ***REMOVED***
    ...
    class Server extends EventEmitter {
         ...
         *
         * All {@link Socket***REMOVED*** are set to `SO_REUSEADDR` (see [`socket(7)`](https://man7.org/linux/man-pages/man7/socket.7.html) for
         * details).
         *
         ...
         * (useful to find which port was assigned when getting an OS-assigned address):`{ port: 12346, family: 'IPv4', address: '127.0.0.1' ***REMOVED***`.
         *
        ...
        /**
         * Calls {@link Server.close()***REMOVED*** and returns a promise that fulfills when the server has closed.
         * @since v20.5.0
         */
    ...
    ***REMOVED***
     ...
     * ```
     * @since v0.5.0
     * @param connectionListener Automatically set as a listener for the {@link 'connection'***REMOVED*** event.
     */
    function createServer(connectionListener?: (socket: Socket) => void): Server;
    function createServer(options?: ServerOpts, connectionListener?: (socket: Socket) => void): Server;
    /**
     * Aliases to {@link createConnection***REMOVED***.
     *
     * Possible signatures:
     *
     * * {@link connect***REMOVED***
     * * {@link connect***REMOVED*** for `IPC` connections.
     * * {@link connect***REMOVED*** for TCP connections.
     */
    function connect(options: NetConnectOpts, connectionListener?: () => void): Socket;
    function connect(port: number, host?: string, connectionListener?: () => void): Socket;
    function connect(path: string, connectionListener?: () => void): Socket;
    /**
     * A factory function, which creates a new {@link Socket***REMOVED***,
     ...
     *
     * * {@link createConnection***REMOVED***
     * * {@link createConnection***REMOVED*** for `IPC` connections.
     * * {@link createConnection***REMOVED*** for TCP connections.
     *
     * The {@link connect***REMOVED*** function is an alias to this function.
     */
