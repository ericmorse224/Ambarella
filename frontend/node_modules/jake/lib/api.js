 ...
 *
*/
let { uuid ***REMOVED*** = require('./utils');
...
let api = new (function () {
  /**
    ...
    `
    @param {String***REMOVED*** name The name of the Task
    @param {Array***REMOVED*** [prereqs] Prerequisites to be run before this task
    @param {Function***REMOVED*** [action] The action to perform for this task
    @param {Object***REMOVED*** [opts]
      @param {Boolean***REMOVED*** [opts.asyc=false] Perform this task asynchronously.
  ...
  ***REMOVED***;
  ...
  /**
    ...
    `
    @param {String***REMOVED*** pattern The suffix name of the objective
    @param {String***REMOVED*** source The suffix name of the objective
    @param {Array***REMOVED*** [prereqs] Prerequisites to be run before this task
    @param {Function***REMOVED*** [action] The action to perform for this task
    @param {Object***REMOVED*** [opts]
      @param {Boolean***REMOVED*** [opts.asyc=false] Perform this task asynchronously.
    ...
    rule('.o', '.c', {async: true***REMOVED***, function () {
      let cmd = util.format('gcc -o %s %s', this.name, this.source);
      jake.exec([cmd], function () {
        complete();
      ***REMOVED***, {printStdout: true***REMOVED***);
    ***REMOVED***);

    desc('This rule has prerequisites.');
    rule('.o', '.c', ['util.h'], {async: true***REMOVED***, function () {
      let cmd = util.format('gcc -o %s %s', this.name, this.source);
      jake.exec([cmd], function () {
        complete();
      ***REMOVED***, {printStdout: true***REMOVED***);
    ...
    ***REMOVED***);
    ...
    rule('obj/%.o', 'src/%.c', {async: true***REMOVED***, function () {
      let cmd = util.format('gcc -o %s %s', this.name, this.source);
      jake.exec([cmd], function () {
        complete();
      ***REMOVED***, {printStdout: true***REMOVED***);
    ***REMOVED***);
    ...
    rule('%.pdf', '%.dvi', {async: true***REMOVED***, function () {
    ...
    ***REMOVED***);
    ...
    rule('%.dvi', '%.tex', {async: true***REMOVED***, function () {
    ...
    ***REMOVED***);
    ...
    namespace('debug', {async: true***REMOVED***, function() {
  ...
  ***REMOVED***;
  ...
  /**
    ...
    Task's action.
    `
    @param {String***REMOVED*** name The name of the DiretoryTask
  ...
  ***REMOVED***;
  ...
  /**
    ...
    `
    @param {String***REMOVED*** name The name of the FileTask
    @param {Array***REMOVED*** [prereqs] Prerequisites to be run before this task
    @param {Function***REMOVED*** [action] The action to create this file, if it doesn't
    exist already.
    @param {Object***REMOVED*** [opts]
      @param {Array***REMOVED*** [opts.asyc=false] Perform this task asynchronously.
      If you flag a task with this option, you must call the global
      `complete` method inside the task's action, for execution to proceed
      to the next task.
  ...
  ***REMOVED***;
  ...
  /**
    ...
    `
    @param {String***REMOVED*** description The description for the Task
   */
  ...
  ***REMOVED***;
  ...
  /**
    ...
    `
    @param {String***REMOVED*** name The name of the namespace
    @param {Function***REMOVED*** scope The enclosing scope for the namespaced tasks
  ...
  this.namespace = function (name, closure) {
    ...
    let fn = closure || function () {***REMOVED***;
  ...
  ***REMOVED***;
  ...
  /**
    ...
    `
    @param {Error|String***REMOVED*** err The error to thow when aborting execution.
