...
function jsxDEV(type, config, maybeKey, source, self) {
  {
    ...
    // issue if key is also explicitly declared (ie. <div {...props***REMOVED*** key="Hi" />
    // or <div key="Hi" {...props***REMOVED*** /> ). We want to deprecate key spread,
    // but as an intermediary step, we will use jsxDEV for everything except
    // <div {...props***REMOVED*** key="Hi" />, because we aren't currently able to tell if
    ...
    ***REMOVED*** // Remaining properties are added to a new props object
...
var didWarnAboutKeySpread = {***REMOVED***;
function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
  {
...

    {
      if (hasOwnProperty.call(props, 'key')) {
        ...
        var keys = Object.keys(props).filter(function (k) {
          return k !== 'key';
        ***REMOVED***);
        var beforeExample = keys.length > 0 ? '{key: someKey, ' + keys.join(': ..., ') + ': ...***REMOVED***' : '{key: someKey***REMOVED***';

        if (!didWarnAboutKeySpread[componentName + beforeExample]) {
          var afterExample = keys.length > 0 ? '{' + keys.join(': ..., ') + ': ...***REMOVED***' : '{***REMOVED***';

          error('A props object containing a "key" prop is being spread into JSX:\n' + '  let props = %s;\n' + '  <%s {...props***REMOVED*** />\n' + 'React keys must be passed directly to JSX without using spread:\n' + '  let props = %s;\n' + '  <%s key={someKey***REMOVED*** {...props***REMOVED*** />', beforeExample, componentName, afterExample, componentName);
    ...
    ***REMOVED***
    ...
    return element;
  ***REMOVED***
***REMOVED*** // These two functions exist to still get child warnings in dev
