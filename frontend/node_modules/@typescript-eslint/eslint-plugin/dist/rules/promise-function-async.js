...
exports.default = util.createRule({
    ...
    ***REMOVED***,
    ...
    create(context, [{ allowAny, allowedPromiseNames, checkArrowFunctions, checkFunctionDeclarations, checkFunctionExpressions, checkMethodDeclarations, ***REMOVED***,]) {
        ...
        function validateNode(node) {
            ...
            ***REMOVED***);
        ***REMOVED***
        return Object.assign(Object.assign(Object.assign({***REMOVED***, (checkArrowFunctions && {
            'ArrowFunctionExpression[async = false]'(node) {
                validateNode(node);
            ***REMOVED***,
        ***REMOVED***)), (checkFunctionDeclarations && {
            'FunctionDeclaration[async = false]'(node) {
                validateNode(node);
            ***REMOVED***,
        ***REMOVED***)), { 'FunctionExpression[async = false]'(node) {
                if (node.parent &&
                    node.parent.type === utils_1.AST_NODE_TYPES.MethodDefinition &&
