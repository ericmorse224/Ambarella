...
function validate(input, methodName) {
    ...
    const inputCopy = Object.assign({***REMOVED***, input);
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    const jsonSchema = require(`../schema/${methodName***REMOVED***Options.json`);
    ...
    ***REMOVED***
    const betterErrors = (0, better_ajv_errors_1.betterAjvErrors)({
        ...
        schema: jsonSchema,
    ***REMOVED***);
    const messages = betterErrors.map((err) => (0, common_tags_1.oneLine) `[${err.path***REMOVED***] ${err.message***REMOVED***.
    ${err.suggestion ? err.suggestion : ''***REMOVED***`);
...
// runtimeCaching.handler, as it needs to accept {***REMOVED*** (i.e. any) due to
