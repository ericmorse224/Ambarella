...
small performance penalty) by setting `{async: true***REMOVED***` in the
constructor options.
...
import { Minipass ***REMOVED*** from 'minipass'
// or:
const { Minipass ***REMOVED*** = require('minipass')
...
const asyncStream = new Minipass({ async: true ***REMOVED***)
...
```js
import { Minipass ***REMOVED*** from 'minipass'
const stream = new Minipass({ encoding: 'utf8' ***REMOVED***)
...
const p1 = new PassThrough({ highWaterMark: 1024 ***REMOVED***)
const p2 = new PassThrough({ highWaterMark: 1024 ***REMOVED***)
const p3 = new PassThrough({ highWaterMark: 1024 ***REMOVED***)
const p4 = new PassThrough({ highWaterMark: 1024 ***REMOVED***)
...
async: true ***REMOVED***` in the Minipass constructor, or by setting
