...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {ASTNode***REMOVED*** node to check for matching errors.
        ...
        function removeWhitespaceError(node) {
            ...
            errors = errors.filter(({ loc: { start: errorLocStart ***REMOVED*** ***REMOVED***) => (
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The program node
         * @returns {void***REMOVED***
         * @private
         */
