...
module.exports = {
		...
		***REMOVED***,
		...
		messages: {
			combineUninitialized:
				"Combine this with the previous '{{type***REMOVED******REMOVED***' statement with uninitialized variables.",
			combineInitialized:
				"Combine this with the previous '{{type***REMOVED******REMOVED***' statement with initialized variables.",
			splitUninitialized:
				"Split uninitialized '{{type***REMOVED******REMOVED***' declarations into multiple statements.",
			splitInitialized:
				"Split initialized '{{type***REMOVED******REMOVED***' declarations into multiple statements.",
			splitRequires:
	...
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED*** else if (typeof mode === "object") {
						...
						***REMOVED***
						...
						if (
							...
							return fixer.replaceText(
								tokenAfterDeclarator,
								`; ${exportPlacement***REMOVED***${declaration.kind***REMOVED*** `,
							);
						***REMOVED***
