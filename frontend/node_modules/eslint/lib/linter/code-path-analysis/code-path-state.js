...
class BreakContext {
	 ...
	 * @param {BreakContext***REMOVED*** upperContext The previous `BreakContext`.
	 * @param {boolean***REMOVED*** breakable Indicates if we are inside a statement where
	 *      `break` without a label will exit the statement.
	 * @param {string|null***REMOVED*** label The label for the statement.
	 * @param {ForkContext***REMOVED*** forkContext The current fork context.
	 */
	constructor(upperContext, breakable, label, forkContext) {
		/**
		 * The previous `BreakContext`
		 * @type {BreakContext***REMOVED***
		 */
...
class ChainContext {
	/**
	 * Creates a new instance.
	 * @param {ChainContext***REMOVED*** upperContext The previous `ChainContext`.
	 */
	constructor(upperContext) {
		/**
		 * The previous `ChainContext`
		 * @type {ChainContext***REMOVED***
		 */
		this.upper = upperContext;
...
class ChoiceContext {
	/**
	 * Creates a new instance.
	 * @param {ChoiceContext***REMOVED*** upperContext The previous `ChoiceContext`.
	 * @param {string***REMOVED*** kind The kind of choice. If it's a logical or assignment expression, this
	 *      is `"&&"` or `"||"` or `"??"`; if it's an `if` statement or
	 *      conditional expression, this is `"test"`; otherwise, this is `"loop"`.
	 * @param {boolean***REMOVED*** isForkingAsResult Indicates if the result of the choice
	 *      creates a fork.
	 * @param {ForkContext***REMOVED*** forkContext The containing `ForkContext`.
	 */
	constructor(upperContext, kind, isForkingAsResult, forkContext) {
		/**
		 * The previous `ChoiceContext`
		 * @type {ChoiceContext***REMOVED***
		 */
		this.upper = upperContext;
...
class LoopContextBase {
	/**
	 * Creates a new instance.
	 * @param {LoopContext|null***REMOVED*** upperContext The previous `LoopContext`.
	 * @param {string***REMOVED*** type The AST node's `type` for the loop.
	 * @param {string|null***REMOVED*** label The label for the loop from an enclosing `LabeledStatement`.
	 * @param {BreakContext***REMOVED*** breakContext The context for breaking the loop.
	 */
	constructor(upperContext, type, label, breakContext) {
		/**
		 * The previous `LoopContext`.
		 * @type {LoopContext***REMOVED***
		 */
		this.upper = upperContext;
...
class WhileLoopContext extends LoopContextBase {
	...
	constructor(upperContext, label, breakContext) {
		 ...
		 * @type {Array<CodePathSegment>|null***REMOVED***
		 */
...
class DoWhileLoopContext extends LoopContextBase {
	 ...
	 * @param {string|null***REMOVED*** label The label for the loop from an enclosing `LabeledStatement`.
	 * @param {BreakContext***REMOVED*** breakContext The context for breaking the loop.
	 * @param {ForkContext***REMOVED*** forkContext The enclosing fork context.
	 */
 ...
 * @typedef {WhileLoopContext|DoWhileLoopContext|ForLoopContext|ForInLoopContext|ForOfLoopContext***REMOVED*** LoopContext
 */
...
class SwitchContext {
	/**
	 * Creates a new instance.
	 * @param {SwitchContext***REMOVED*** upperContext The previous context.
	 * @param {boolean***REMOVED*** hasCase Indicates if there is at least one `case` statement.
	 *      `default` doesn't count.
	 */
	constructor(upperContext, hasCase) {
		/**
		 * The previous context.
		 * @type {SwitchContext***REMOVED***
		 */
		this.upper = upperContext;
...
class TryContext {
	/**
	 * Creates a new instance.
	 * @param {TryContext***REMOVED*** upperContext The previous context.
	 * @param {boolean***REMOVED*** hasFinalizer Indicates if the `try` statement has a
	 *      `finally` block.
	 * @param {ForkContext***REMOVED*** forkContext The enclosing fork context.
	 */
	constructor(upperContext, hasFinalizer, forkContext) {
		 ...
		 * @type {"try"|"catch"|"finally"***REMOVED***
		 */
		this.position = "try";
 ...
 * @param {CodePathState***REMOVED*** state The state to search within.
 * @param {string|null***REMOVED*** label The label of a `continue` statement.
 ...
 * @param {CodePathState***REMOVED*** state The state to search within.
 * @param {string|null***REMOVED*** label The label of a `break` statement.
 * @returns {BreakContext***REMOVED*** A context for a `break` statement.
 */
 ...
 * @param {any[]***REMOVED*** elements An array to remove the specific element.
 * @param {any***REMOVED*** value The value to be removed.
 * @returns {void***REMOVED***
 */
 ...
 * @param {CodePathState***REMOVED*** state The state to operate on.
...
class CodePathState {
	...
	constructor(idGenerator, onLooped) {
		 ...
		 * modified.
		 * @type {Array<CodePathSegment>***REMOVED***
		 */
	...
	***REMOVED***
	 ...
	 * @param {boolean***REMOVED*** isCaseBodyEmpty `true` if the body is empty.
	 * @param {boolean***REMOVED*** isDefaultCase `true` if the body is the default case.
	 * @returns {void***REMOVED***
	 */
	...
	***REMOVED***
	 ...
	 * @throws {Error***REMOVED*** (Unreachable - unknown type.)
	 * @returns {void***REMOVED***
	 */
	...
	***REMOVED***
	 ...
	 * @param {boolean***REMOVED*** breakable Indicates if we are inside a statement where
	 *      `break` without a label will exit the statement.
	 * @param {string|null***REMOVED*** label The label associated with the statement.
	 * @returns {BreakContext***REMOVED*** The new context.
	 */
	...
	***REMOVED***
	 ...
	 * @param {string|null***REMOVED*** label A label of the break statement.
	 * @returns {void***REMOVED***
	 */
	makeBreak(label) {
		const forkContext = this.forkContext;
	...
	***REMOVED***
	 ...
	 * It makes new unreachable segment, then it set the head with the segment.
	 * @param {string|null***REMOVED*** label A label of the continue statement.
	 * @returns {void***REMOVED***
	 */
	makeContinue(label) {
		const forkContext = this.forkContext;
