/** @typedef {import('postcss-selector-parser').Root***REMOVED*** Root */ /** @typedef {import('postcss-selector-parser').Selector***REMOVED*** Selector */ /** @typedef {import('postcss-selector-parser').Pseudo***REMOVED*** Pseudo */ /** @typedef {import('postcss-selector-parser').Node***REMOVED*** Node */ // There are some pseudo-elements that may or may not be:
// **Actionable**
...
/** @typedef {'terminal' | 'actionable' | 'jumpable'***REMOVED*** PseudoProperty */ /** @type {Record<string, PseudoProperty[]>***REMOVED*** */ "use strict";
...
function movePseudos(sel) {
    ...
    return sel;
***REMOVED***
/** @typedef {[sel: Selector, pseudo: Pseudo, attachedTo: Pseudo | null]***REMOVED*** MovablePseudo */ /** @typedef {[pseudos: MovablePseudo[], lastSeenElement: Pseudo | null]***REMOVED*** MovablePseudosResult */ /**
 * @param {Selector***REMOVED*** sel
 * @returns {MovablePseudosResult***REMOVED***
 */ function movablePseudos(sel) {
    /** @type {MovablePseudo[]***REMOVED*** */ let buffer = [];
    /** @type {Pseudo | null***REMOVED*** */ let lastSeenElement = null;
    for (let node of sel.nodes){
        if (node.type === "combinator") {
            buffer = buffer.filter(([, node])=>propertiesForPseudo(node).includes("jumpable"));
            lastSeenElement = null;
        ***REMOVED*** else if (node.type === "pseudo") {
            ...
            ***REMOVED*** else if (lastSeenElement && isAttachablePseudoClass(node, lastSeenElement)) {
                buffer.push([
                    sel,
                    node,
                    lastSeenElement
...
/**
 * @param {Pseudo***REMOVED*** pseudo
 * @returns {PseudoProperty[]***REMOVED***
