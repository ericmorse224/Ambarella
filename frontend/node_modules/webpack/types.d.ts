...
import { Buffer ***REMOVED*** from "buffer";
import { Scope ***REMOVED*** from "eslint-scope";
import {
	ArrayExpression,
	ArrayPattern,
	...
	YieldExpression
***REMOVED*** from "estree";
import { IncomingMessage, ServerOptions ***REMOVED*** from "http";
import {
	Session as SessionImportInspectorClass_1,
	Session as SessionImportInspectorClass_2
***REMOVED*** from "inspector";
import { JSONSchema4, JSONSchema6, JSONSchema7 ***REMOVED*** from "json-schema";
import { ListenOptions, Server ***REMOVED*** from "net";
import { validate as validateFunction ***REMOVED*** from "schema-utils";
import { default as ValidationError ***REMOVED*** from "schema-utils/declarations/ValidationError";
import { ValidationErrorConfiguration ***REMOVED*** from "schema-utils/declarations/validate";
import {
	AsArray,
	AsyncParallelHook,
	AsyncSeriesBailHook,
	...
	SyncWaterfallHook,
	TapOptions
***REMOVED*** from "tapable";
import { SecureContextOptions, TlsOptions ***REMOVED*** from "tls";
import { URL ***REMOVED*** from "url";
import { Context ***REMOVED*** from "vm";
...
declare interface AssetInlineGeneratorOptions {
	...
	dataUrl?:
		...
		| ((
				...
				context: { filename: string; module: Module ***REMOVED***
		  ) => string);
***REMOVED***
...
declare class AsyncDependenciesBlock extends DependenciesBlock {
	constructor(
		groupOptions:
			| null
			| string
			| (RawChunkGroupOptions & { name?: null | string ***REMOVED*** & {
					entryOptions?: EntryOptions;
			  ***REMOVED***),
		loc?: null | SyntheticDependencyLocation | RealDependencyLocation,
		request?: null | string
	);
	groupOptions: RawChunkGroupOptions & { name?: null | string ***REMOVED*** & {
		entryOptions?: EntryOptions;
	***REMOVED***;
	loc?: null | SyntheticDependencyLocation | RealDependencyLocation;
	request?: null | string;
...
declare class BannerPlugin {
	...
	banner: (data: { hash?: string; chunk: Chunk; filename: string ***REMOVED***) => string;
...
type BannerPluginArgument =
	| string
	| BannerPluginOptions
	| ((data: { hash?: string; chunk: Chunk; filename: string ***REMOVED***) => string);
...
type BufferEncoding =
	...
	| "binary"
	| "hex";
type BufferEncodingOption = "buffer" | { encoding: "buffer" ***REMOVED***;
...
declare class Chunk {
	...
	getChildrenOfTypeInOrder(
		chunkGraph: ChunkGraph,
		type: string
	): undefined | { onChunks: Chunk[]; chunks: Set<Chunk> ***REMOVED***[];
...
***REMOVED***
type ChunkGroupOptions = RawChunkGroupOptions & { name?: null | string ***REMOVED***;
	...
	hooks: Readonly<{
		renderManifest: {
			tap: <AdditionalOptions>(
				options:
					| string
					| (TapOptions & { name: string ***REMOVED*** & IfSet<AdditionalOptions>),
				fn: (
...
declare class Compilation {
	...
	***REMOVED***>;
	...
	compilationDependencies: { add: (item: string) => LazySet<string> ***REMOVED***;
	getStats(): Stats;
	createStatsOptions(
	...
	***REMOVED***): void;
	...
	factorizeModule: {
		(
			options: FactorizeModuleOptions & { factoryResult?: false ***REMOVED***,
			callback: (err?: null | WebpackError, result?: null | Module) => void
		): void;
		(
			options: FactorizeModuleOptions & { factoryResult: true ***REMOVED***,
			callback: (
...
declare class ConcatenationScope {
	...
	static matchModuleReference(
		name: string
	): null | (ModuleReferenceOptions & { index: number ***REMOVED***);
...
declare interface Configuration {
	 ...
	 */
	amd?: false | { [index: string]: any ***REMOVED***;
	...
	externals?:
		...
		| ((
				...
				callback: (
					err?: null | Error,
					result?: string | boolean | string[] | { [index: string]: any ***REMOVED***
				) => void
		  ) => void)
...
type CreateWriteStreamFSImplementation = FSImplementation & {
	...
	close?: (...args: any[]) => any;
***REMOVED***;
declare interface CreatedObject<T, F> {***REMOVED***
...
declare interface DllReferencePluginOptionsContent {
	[index: string]: {
		 ...
		 */
		buildMeta?: { [index: string]: any ***REMOVED***;
		/**
 ...
 */
declare interface EmptyGeneratorOptions {***REMOVED***

/**
 * No parser options are supported for this module type.
 */
declare interface EmptyParserOptions {***REMOVED***
...
declare interface EntryData {
	...
	options: EntryOptions;
***REMOVED***
declare abstract class EntryDependency extends ModuleDependency {***REMOVED***
...
***REMOVED***
type EntryOptions = { name?: string ***REMOVED*** & Omit<
...
declare interface Environment {
	/**
	 * The environment supports arrow functions ('() => { ... ***REMOVED***').
	 */
	arrowFunction?: boolean;

	/**
	 * The environment supports async function and await ('async function () { await ... ***REMOVED***').
	 */
	...
	/**
	 * The environment supports destructuring ('{ a, b ***REMOVED*** = obj').
	 */
	...
	/**
	 * The environment supports 'for of' iteration ('for (const x of array) { ... ***REMOVED***').
	 */
	forOf?: boolean;
...
declare class EnvironmentPlugin {
	...
	apply(compiler: Compiler): void;
***REMOVED***
type ErrorWithDetail = Error & { details?: string ***REMOVED***;
...
declare interface ExecuteModuleContext {
	assets: Map<string, { source: Source; info?: AssetInfo ***REMOVED***>;
	chunk: Chunk;
	chunkGraph: ChunkGraph;
...
declare interface ExternalItemObjectKnown {
	 ...
	 */
	byLayer?:
		| { [index: string]: ExternalItem ***REMOVED***
...
***REMOVED***
type ExternalItemValue = string | boolean | string[] | { [index: string]: any ***REMOVED***;
...
declare interface FakeHookMarker {***REMOVED***
...
declare interface FileCacheOptions {
	 ...
	 */
	buildDependencies?: { [index: string]: string[] ***REMOVED***;
...
declare interface GeneratorOptionsByModuleTypeUnknown {
	[index: string]: { [index: string]: any ***REMOVED***;
***REMOVED***
...
***REMOVED***
declare abstract class HelperRuntimeModule extends RuntimeModule {***REMOVED***
...
type ImportAttribute = BaseNode & {
	...
	value: Literal;
***REMOVED***;
type ImportAttributes = Record<string, string> & {***REMOVED***;
...
declare class JavascriptParser extends Parser {
	...
	***REMOVED***;
	...
	parseCommentOptions(range: [number, number]): {
		...
		errors: null | (Error & { comment: Comment ***REMOVED***)[];
	***REMOVED***;
	...
	***REMOVED***;
	getFreeInfoFromVariable(
		varName: string
	): undefined | { name: string; info: string | VariableInfo ***REMOVED***;
...
declare interface JavascriptParserOptions {
	...
	/**
	 * Enable/disable parsing "import { createRequire ***REMOVED*** from "module"" and evaluating createRequire().
	 */
...
declare interface JsonGeneratorOptions {
	...
	JSONParse?: boolean;
***REMOVED***
type JsonObjectFs = { [index: string]: JsonValueFs ***REMOVED*** & {
	[index: string]:
		| undefined
		| null
		| string
		...
		| JsonValueFs[];
***REMOVED***;
type JsonObjectTypes = { [index: string]: JsonValueTypes ***REMOVED*** & {
	[index: string]:
		| undefined
		| null
		| string
...
declare interface KnownStatsChunkGroup {
	...
	assets?: { name: string; size?: number ***REMOVED***[];
	filteredAssets?: number;
	assetsSize?: number;
	auxiliaryAssets?: { name: string; size?: number ***REMOVED***[];
	filteredAuxiliaryAssets?: number;
	auxiliaryAssetsSize?: number;
	children?: { [index: string]: StatsChunkGroup[] ***REMOVED***;
	childAssets?: { [index: string]: string[] ***REMOVED***;
	isOverSizeLimit?: boolean;
***REMOVED***
...
declare interface KnownStatsModule {
	...
	size?: number;
	sizes?: { [index: string]: number ***REMOVED***;
	cacheable?: boolean;
	built?: boolean;
...
declare interface LStatFs {
	...
	(
		path: PathLikeFs,
		options: undefined | (StatOptions & { bigint?: false ***REMOVED***),
		callback: (err: null | NodeJS.ErrnoException, result?: IStats) => void
	): void;
	(
		path: PathLikeFs,
		options: StatOptions & { bigint: true ***REMOVED***,
...
declare interface LStatSync {
	...
	(
		path: PathLikeFs,
		options?: StatSyncOptions & { bigint?: false; throwIfNoEntry: false ***REMOVED***
	): undefined | IStats;
	(
		path: PathLikeFs,
		options: StatSyncOptions & { bigint: true; throwIfNoEntry: false ***REMOVED***
	): undefined | IBigIntStats;
	(path: PathLikeFs, options?: StatSyncOptions & { bigint?: false ***REMOVED***): IStats;
	(path: PathLikeFs, options: StatSyncOptions & { bigint: true ***REMOVED***): IBigIntStats;
	(
		path: PathLikeFs,
		options: StatSyncOptions & { bigint: boolean; throwIfNoEntry?: false ***REMOVED***
	): IStats | IBigIntStats;
	(
		path: PathLikeFs,
...
> = (() => InputValue | Promise<InputValue>) &
	Partial<{ options: InternalLazyOptions ***REMOVED***>;
...
declare interface LoaderItem {
	...
	type: null | string;
***REMOVED***
declare interface LoaderModule<OptionsType = {***REMOVED***, ContextAdditions = {***REMOVED***> {
	default?:
...
declare interface LoaderRunnerLoaderContext<OptionsType> {
	 ...
	 * loaders = [{request: string, path: string, query: string, module: function***REMOVED***]
	 * In the example:
	 * [
	...
	***REMOVED***[];
	 ...
	 * Example: { arrowFunction: true ***REMOVED***
	 */
...
declare abstract class MainTemplate {
	hooks: Readonly<{
		...
		***REMOVED***;
		modules: { tap: () => never ***REMOVED***;
		moduleObj: { tap: () => never ***REMOVED***;
		require: {
			tap: <AdditionalOptions>(
				options:
					| string
		...
		***REMOVED***;
		beforeStartup: { tap: () => never ***REMOVED***;
		startup: { tap: () => never ***REMOVED***;
		afterStartup: { tap: () => never ***REMOVED***;
		render: {
			tap: <AdditionalOptions>(
				options:
					| string
		...
		***REMOVED***;
		globalHashPaths: { tap: () => void ***REMOVED***;
		globalHash: { tap: () => void ***REMOVED***;
		hotBootstrap: { tap: () => never ***REMOVED***;
...
declare interface Mkdir {
	(
		file: PathLikeFs,
		options: MakeDirectoryOptions & { recursive: true ***REMOVED***,
	...
	(
		...
		options:
			...
			| string
			| number
			| (MakeDirectoryOptions & { recursive?: false ***REMOVED***),
		callback: (err: null | NodeJS.ErrnoException) => void
	): void;
	(
		file: PathLikeFs,
...
declare abstract class ModuleProfile {
	...
	additionalFactoryTimes?: { start: number; end: number ***REMOVED***[];
...
declare interface ModuleSettings {
	 ...
	 * Options for parsing.
	 */
	parser?: { [index: string]: any ***REMOVED***;

	/**
	 * The options for the module generator.
	 */
	generator?: { [index: string]: any ***REMOVED***;
...
declare abstract class NormalModuleFactory extends ModuleFactory {
	hooks: Readonly<{
		...
		createModule: AsyncSeriesBailHook<
			[
				Partial<NormalModuleCreateData & { settings: ModuleSettings ***REMOVED***>,
				ResolveData
			],
			void | Module
		>;
...
declare interface Optimization {
	...
	runtimeChunk?:
		...
		| {
				 ...
				 */
				name?: string | ((entrypoint: { name: string ***REMOVED***) => string);
		  ***REMOVED***;
...
declare interface OptimizationNormalized {
	...
	runtimeChunk?:
		...
		| {
				 ...
				 */
				name?: (entrypoint: { name: string ***REMOVED***) => string;
		  ***REMOVED***;
...
declare interface OptimizationSplitChunksCacheGroup {
	 ...
	 */
	enforceSizeThreshold?: number | { [index: string]: number ***REMOVED***;
	 ...
	 */
	maxAsyncSize?: number | { [index: string]: number ***REMOVED***;
	 ...
	 */
	maxInitialSize?: number | { [index: string]: number ***REMOVED***;

	/**
	 * Maximal size hint for the created chunks.
	 */
	maxSize?: number | { [index: string]: number ***REMOVED***;
	 ...
	 */
	minRemainingSize?: number | { [index: string]: number ***REMOVED***;

	/**
	 * Minimal size for the created chunk.
	 */
	minSize?: number | { [index: string]: number ***REMOVED***;

	/**
	 * Minimum size reduction due to the created chunk.
	 */
	minSizeReduction?: number | { [index: string]: number ***REMOVED***;
...
type Plugin =
	...
	| ""
	| 0
	| { apply: (arg0: Resolver) => void ***REMOVED***
...
declare class Profiler {
	...
	stopProfiling(): Promise<{ profile: any ***REMOVED***>;
***REMOVED***
...
declare interface ReadFileFs {
	(
		...
		options:
			| undefined
			| null
			| ({ encoding?: null; flag?: string ***REMOVED*** & Abortable),
		callback: (err: null | NodeJS.ErrnoException, result?: Buffer) => void
	): void;
	(
		path: PathOrFileDescriptorFs,
		options:
			| ({ encoding: BufferEncoding; flag?: string ***REMOVED*** & Abortable)
			| "ascii"
			| "utf8"
			| "utf-8"
			| "utf16le"
	...
	(
		...
		options:
			...
			| "binary"
			| "hex"
			| (ObjectEncodingOptions & { flag?: string ***REMOVED*** & Abortable),
		callback: (
			err: null | NodeJS.ErrnoException,
...
declare interface ReadFileSync {
	(
		path: PathOrFileDescriptorFs,
		options?: null | { encoding?: null; flag?: string ***REMOVED***
	): Buffer;
	(
		path: PathOrFileDescriptorFs,
		options:
			...
			| "binary"
			| "hex"
			| { encoding: BufferEncoding; flag?: string ***REMOVED***
	): string;
	(
		path: PathOrFileDescriptorFs,
		options?:
			...
			| "binary"
			| "hex"
			| (ObjectEncodingOptions & { flag?: string ***REMOVED***)
	): string | Buffer;
***REMOVED***
...
declare interface ReaddirFs {
	...
	(
		...
		options:
			| "buffer"
			| { encoding: "buffer"; withFileTypes?: false; recursive?: boolean ***REMOVED***,
		callback: (err: null | NodeJS.ErrnoException, result?: Buffer[]) => void
	): void;
	(
		path: PathLikeFs,
...
declare interface ReaddirSync {
	...
	(
		...
		options?:
			...
			| "binary"
			| "hex"
			| (ObjectEncodingOptions & { withFileTypes?: false; recursive?: boolean ***REMOVED***)
	): string[] | Buffer[];
	(
		path: PathLikeFs,
		options: ObjectEncodingOptions & {
...
type RecursiveArrayOrRecord<T> =
	| { [index: string]: RecursiveArrayOrRecord<T> ***REMOVED***
...
declare interface RenderManifestOptions {
	...
	outputOptions: Output;
	codeGenerationResults: CodeGenerationResults;
	moduleTemplates: { javascript: ModuleTemplate ***REMOVED***;
	dependencyTemplates: DependencyTemplates;
	runtimeTemplate: RuntimeTemplate;
	moduleGraph: ModuleGraph;
	chunkGraph: ChunkGraph;
...
declare interface ResolveData {
	...
	dependencyType: string;
	createData: Partial<NormalModuleCreateData & { settings: ModuleSettings ***REMOVED***>;
	fileDependencies: LazySet<string>;
	missingDependencies: LazySet<string>;
	contextDependencies: LazySet<string>;
...
declare interface ResolveOptions {
	...
	alias?:
		| {
				...
				onlyModule?: boolean;
		  ***REMOVED***[]
		| { [index: string]: string | false | string[] ***REMOVED***;
	 ...
	 */
	byDependency?: { [index: string]: ResolveOptions ***REMOVED***;
	 ...
	 */
	extensionAlias?: { [index: string]: string | string[] ***REMOVED***;
	 ...
	 */
	unsafeCache?: boolean | { [index: string]: any ***REMOVED***;
...
declare interface ResolveOptionsResolverFactoryObject1 {
	...
	mainFields: { name: string[]; forceRelative: boolean ***REMOVED***[];
...
declare interface ResolveOptionsResolverFactoryObject2 {
	...
	mainFields?: (
		| string
		| string[]
		| { name: string | string[]; forceRelative: boolean ***REMOVED***
	)[];
...
type RuleSetConditionOrConditions =
	...
	| RuleSetLogicalConditions
	| RuleSetCondition[];
type RuleSetLoaderOptions = string | { [index: string]: any ***REMOVED***;
...
declare interface RuleSetRule {
	 ...
	 */
	assert?: { [index: string]: RuleSetConditionOrConditions ***REMOVED***;
	 ...
	 */
	descriptionData?: { [index: string]: RuleSetConditionOrConditions ***REMOVED***;
	 ...
	 */
	options?: string | { [index: string]: any ***REMOVED***;
	 ...
	 */
	with?: { [index: string]: RuleSetConditionOrConditions ***REMOVED***;
***REMOVED***
type RuleSetUse =
	| string
	| (
...
declare class RuntimeChunkPlugin {
	constructor(options?: {
		...
		name?: (entrypoint: { name: string ***REMOVED***) => string;
	***REMOVED***);
	options: { name: (entrypoint: { name: string ***REMOVED***) => string ***REMOVED***;
...
declare abstract class RuntimeTemplate {
	...
	concatenation(...args: (string | { expr: string ***REMOVED***)[]): string;
...
declare class Source {
	...
	sourceAndMap(options?: MapOptions): { source: string | Buffer; map: Object ***REMOVED***;
	updateHash(hash: Hash): void;
	source(): string | Buffer;
	buffer(): Buffer;
***REMOVED***
 ...
 */
declare interface URL_url extends URL {***REMOVED***
...
declare class WebpackError extends Error {
	 ...
	 */
	constructor(message?: string, options?: { cause?: unknown ***REMOVED***);
	[index: number]: () => string;
	details?: string;
	module?: null | Module;
	loc?: SyntheticDependencyLocation | RealDependencyLocation;
	 ...
	 * ```js
	 * const myObject = {***REMOVED***;
	 * Error.captureStackTrace(myObject);
	 * myObject.stack;  // Similar to `new Error().stack`
	 * ```
	 * The first line of the trace will be prefixed with
	 * `${myObject.name***REMOVED***: ${myObject.message***REMOVED***`.
	 ...
	 *   const { stackTraceLimit ***REMOVED*** = Error;
...
declare interface WebpackOptionsNormalized {
	 ...
	 */
	devServer?: false | { [index: string]: any ***REMOVED***;
...
type WriteFileOptions =
	...
	| "hex"
	| (ObjectEncodingOptions &
			Abortable & { mode?: string | number; flag?: string; flush?: boolean ***REMOVED***);
...
declare namespace exports {
	...
	***REMOVED***>;
	export namespace cache {
		export { MemoryCachePlugin ***REMOVED***;
	***REMOVED***
	...
	***REMOVED***
	export namespace optimize {
		export namespace InnerGraph {
			...
			export { TopLevelSymbol, topLevelSymbolTag ***REMOVED***;
		***REMOVED***
		export {
	...
	***REMOVED***
	export namespace runtime {
		export { GetChunkFilenameRuntimeModule, LoadScriptRuntimeModule ***REMOVED***;
	***REMOVED***
	export namespace prefetch {
		export { ChunkPrefetchPreloadPlugin ***REMOVED***;
	***REMOVED***
	...
	***REMOVED***
	export namespace esm {
		export { ModuleChunkLoadingRuntimeModule ***REMOVED***;
	***REMOVED***
	export namespace webworker {
		export { WebWorkerTemplatePlugin ***REMOVED***;
	***REMOVED***
	...
	***REMOVED***
	export namespace electron {
		export { ElectronTargetPlugin ***REMOVED***;
	***REMOVED***
	export namespace wasm {
		export { AsyncWebAssemblyModulesPlugin, EnableWasmLoadingPlugin ***REMOVED***;
	***REMOVED***
	export namespace css {
		export { CssModulesPlugin ***REMOVED***;
	***REMOVED***
	export namespace library {
		export { AbstractLibraryPlugin, EnableLibraryPlugin ***REMOVED***;
	***REMOVED***
	...
	***REMOVED***
	export namespace sharing {
		...
		export { ConsumeSharedPlugin, ProvideSharedPlugin, SharePlugin ***REMOVED***;
	***REMOVED***
	export namespace debug {
		export { ProfilingPlugin ***REMOVED***;
	***REMOVED***
	export namespace util {
		...
		***REMOVED***
		export namespace runtime {
			...
			export { RuntimeSpecMap, RuntimeSpecSet ***REMOVED***;
		***REMOVED***
		export namespace serialization {
			...
			export { MEASURE_START_OPERATION, MEASURE_END_OPERATION ***REMOVED***;
		***REMOVED***
	...
	***REMOVED***
	export namespace experiments {
		export namespace schemes {
			export { HttpUriPlugin ***REMOVED***;
		***REMOVED***
		export namespace ids {
			export { SyncModuleIdsPlugin ***REMOVED***;
		***REMOVED***
	***REMOVED***
