...
function navigate(obj, prop, value) {
  if (value.computed) {
    return value.optional ? `${obj***REMOVED***?.[${prop***REMOVED***]` : `${obj***REMOVED***[${prop***REMOVED***]`;
  ***REMOVED***
  return value.optional ? `${obj***REMOVED***?.${prop***REMOVED***` : `${obj***REMOVED***.${prop***REMOVED***`;
***REMOVED***
...
export default function extractValueFromTSNonNullExpression(value) {
  ...
  ***REMOVED***
  ...
  if (value.type === 'TSNonNullExpression' && (!value.extra || value.extra.parenthesized === false)) {
    const { expression ***REMOVED*** = value;
    return `${extractValueFromTSNonNullExpression(expression)***REMOVED***${'!'***REMOVED***`;
  ***REMOVED***
  ...
  if (value.type === 'TSNonNullExpression' && value.extra && value.extra.parenthesized === true) {
    const { expression ***REMOVED*** = value;
    return `${'('***REMOVED***${extractValueFromTSNonNullExpression(expression)***REMOVED***${'!'***REMOVED***${')'***REMOVED***`;
  ***REMOVED***
