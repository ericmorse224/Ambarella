import type {FuncKeywordDefinition***REMOVED*** from "ajv"
...
***REMOVED*** = Object.assign(_getDef, {CONSTRUCTORS***REMOVED***)
...
function _getDef(): FuncKeywordDefinition {
  return {
    ...
    ***REMOVED***,
    metaSchema: {
      anyOf: [{type: "string"***REMOVED***, {type: "array", items: {type: "string"***REMOVED******REMOVED***],
    ***REMOVED***,
  ***REMOVED***
***REMOVED***
...
function getConstructor(c: string): Constructor {
  ...
  if (C) return C
  throw new Error(`invalid "instanceof" keyword value ${c***REMOVED***`)
***REMOVED***
