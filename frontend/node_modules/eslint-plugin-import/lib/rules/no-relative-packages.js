...
function findNamedPackage(filePath) {
  var found = (0, _readPkgUp2['default'])({ cwd: filePath ***REMOVED***);
  ...
  ***REMOVED***
  ...
  if (importPkg.pkg && contextPkg.pkg && importPkg.pkg.name !== contextPkg.pkg.name) {
    ...
    context.report({
      ...
      fix: function () {function fix(fixer) {return fixer.replaceText(node, JSON.stringify(toPosixPath(properImport)));***REMOVED***return fix;***REMOVED***() ***REMOVED***);
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-relative-packages') ***REMOVED***,
  ...
  create: function () {function create(context) {
      return (0, _moduleVisitor2['default'])(function (source) {return checkImportForRelativePackage(context, source.value, source);***REMOVED***, context.options[0]);
