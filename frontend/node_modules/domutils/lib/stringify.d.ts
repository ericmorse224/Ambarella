import { Node ***REMOVED*** from "domhandler";
import { DomSerializerOptions ***REMOVED*** from "dom-serializer";
/**
 ...
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent***REMOVED***
 */
 ...
 * @param node Node to get the inner text of.
 * @returns `node`'s inner text.
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/API/Node/innerText***REMOVED***
 */
