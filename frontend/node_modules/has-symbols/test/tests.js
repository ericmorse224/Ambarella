...
/** @type {(t: import('tape').Test) => false | void***REMOVED*** */
// eslint-disable-next-line consistent-return
module.exports = function runSymbolTests(t) {
	t.equal(typeof Symbol, 'function', 'global Symbol is a function');

	if (typeof Symbol !== 'function') { return false; ***REMOVED***
	...
	*/
	...
	/** @type {{ [k in symbol]?: unknown ***REMOVED******REMOVED*** */
	var obj = {***REMOVED***;
	var sym = Symbol('test');
	...
	for (var _ in obj) { t.fail('symbol property key was found in for..in of object'); ***REMOVED***
