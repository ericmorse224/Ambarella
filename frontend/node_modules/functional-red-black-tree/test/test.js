...
function print(t) {
  console.log(util.inspect(printTree(t.root), {depth:12***REMOVED***))
***REMOVED***
...
tape("insert()", function(t) {
  ...
  ***REMOVED***
  for(var i=-20; i<0; ++i) {
    ...
    checkTree(u, t)
    checkTree(next, t)
    arr.sort(function(a,b) { return a-b ***REMOVED***)
    var ptr = 0
...
tape("keys and values", function(t) {
  ...
  var original_values = [ 42, 10, false, "!!!", {***REMOVED***, null ]
  ...
  ***REMOVED***)
  ...
  zipped.sort(function(a,b) {
    if(a[0] < b[0]) { return -1 ***REMOVED***
    if(a[0] > b[0]) { return 1 ***REMOVED***
    return 0
  ***REMOVED***)

  var keys = zipped.map(function(v) { return v[0] ***REMOVED***)
  var values = zipped.map(function(v) { return v[1] ***REMOVED***)
