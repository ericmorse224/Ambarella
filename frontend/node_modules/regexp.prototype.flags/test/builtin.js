...
test('builtin', function (t) {
	...
	***REMOVED***);
	...
	t.test('bad array/this value', { skip: !hasStrictMode ***REMOVED***, function (st) {
		st['throws'](function () { return descriptor.get.call(undefined); ***REMOVED***, TypeError, 'undefined is not an object');
		st['throws'](function () { return descriptor.get.call(null); ***REMOVED***, TypeError, 'null is not an object');
		st.end();
	***REMOVED***);
