import { Directives ***REMOVED*** from '../doc/directives';
import { Document ***REMOVED*** from '../doc/Document';
import type { ErrorCode ***REMOVED*** from '../errors';
import { YAMLParseError, YAMLWarning ***REMOVED*** from '../errors';
import type { ParsedNode, Range ***REMOVED*** from '../nodes/Node';
import type { DocumentOptions, ParseOptions, SchemaOptions ***REMOVED*** from '../options';
import type { Token ***REMOVED*** from '../parse/cst';
