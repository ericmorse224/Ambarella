...
test('merge()', function (t) {
    ...
    var noOptionsNonObjectSource = utils.merge({ foo: 'baz' ***REMOVED***, 'bar');
    t.deepEqual(noOptionsNonObjectSource, { foo: 'baz', bar: true ***REMOVED***);

    t.test(
        'avoids invoking array setters unnecessarily',
        { skip: typeof Object.defineProperty !== 'function' ***REMOVED***,
        function (st) {
            var setCount = 0;
            var getCount = 0;
            var observed = [];
            Object.defineProperty(observed, 0, {
                get: function () {
                    getCount += 1;
                    return { bar: 'baz' ***REMOVED***;
                ***REMOVED***,
                set: function () { setCount += 1; ***REMOVED***
            ***REMOVED***);
...
test('isBuffer()', function (t) {
    forEach([null, undefined, true, false, '', 'abc', 42, 0, NaN, {***REMOVED***, [], function () {***REMOVED***, /a/g], function (x) {
        t.equal(utils.isBuffer(x), false, inspect(x) + ' is not a buffer');
    ***REMOVED***);

    var fakeBuffer = { constructor: Buffer ***REMOVED***;
