"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***);var _index = require('../tokenizer/index');
...
***REMOVED*** exports.isContextual = isContextual;
...
// Asserts that following token is given contextual keyword.
 function expectContextual(contextualKeyword) {
  if (!eatContextual(contextualKeyword)) {
    unexpected();
  ***REMOVED***
***REMOVED*** exports.expectContextual = expectContextual;
...
***REMOVED*** exports.canInsertSemicolon = canInsertSemicolon;
  ...
  ***REMOVED***
  return false;
***REMOVED*** exports.hasPrecedingLineBreak = hasPrecedingLineBreak;
  ...
  ***REMOVED***
  return false;
***REMOVED*** exports.hasFollowingLineBreak = hasFollowingLineBreak;

 function isLineTerminator() {
  return _index.eat.call(void 0, _types.TokenType.semi) || canInsertSemicolon();
***REMOVED*** exports.isLineTerminator = isLineTerminator;
...
// pretend that there is a semicolon at this position.
  ...
  ***REMOVED***
***REMOVED*** exports.semicolon = semicolon;
...
// raise an unexpected token error at given pos.
 function expect(type) {
  ...
  if (!matched) {
    unexpected(`Unexpected token, expected "${_types.formatTokenType.call(void 0, type)***REMOVED***"`);
  ***REMOVED***
***REMOVED*** exports.expect = expect;
...
***REMOVED*** exports.unexpected = unexpected;
