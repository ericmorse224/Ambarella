...
import type { Configuration ***REMOVED*** from "webpack";
...
```ts
import type { Configuration as DevServerConfiguration ***REMOVED*** from "webpack-dev-server";
import type { Configuration ***REMOVED*** from "webpack";

const devServer: DevServerConfiguration = {***REMOVED***;
const config: Configuration = { devServer ***REMOVED***;
