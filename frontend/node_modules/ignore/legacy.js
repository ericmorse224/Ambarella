...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; ***REMOVED***
function _iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; ***REMOVED*** else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); ***REMOVED*** catch (err) { _d = !0, _e = err; ***REMOVED*** finally { try { if (!_n && null != _i["return"] && (_r = _i["return"](), Object(_r) !== _r)) return; ***REMOVED*** finally { if (_d) throw _e; ***REMOVED*** ***REMOVED*** return _arr; ***REMOVED*** ***REMOVED***
...
var Ignore = /*#__PURE__*/function () {
  function Ignore() {
    var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {***REMOVED***,
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    ...
    // @param {Array<string> | string | Ignore***REMOVED*** pattern
  ***REMOVED***, {
    key: "add",
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    ...
    // @param {boolean***REMOVED*** whether should check if the path is unignored,
    //   setting `checkUnignored` to `false` could reduce additional
    //   path matching.

    // @returns {TestResult***REMOVED*** true if a file is ignored
  ***REMOVED***, {
    key: "_testOne",
