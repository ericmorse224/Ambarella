...
console.log(response); // { username: 'jonschlinkert' ***REMOVED***
```
...
console.log(response); // { name: 'Edward Chan', username: 'edwardmchan' ***REMOVED***
```
...
```js
const { Confirm ***REMOVED*** = require('enquirer');
...
```js
const { Input ***REMOVED*** = require('enquirer');
...
* `options` **{Object***REMOVED*****: (optional) Options to use with all prompts.
* `answers` **{Object***REMOVED*****: (optional) Answers object to initialize with.
...
* `type` **{String***REMOVED*****
* `fn` **{Function|Prompt***REMOVED*****: `Prompt` class, or a function that returns a `Prompt` class.
* `returns` **{Object***REMOVED*****: Returns the Enquirer instance
...
* `questions` **{Array|Object***REMOVED*****: Options objects for one or more prompts to run.
* `returns` **{Promise***REMOVED*****: Promise that returns an "answers" object with the user's responses.
...
* `plugin` **{Function***REMOVED*****: Plugin function that takes an instance of Enquirer.
* `returns` **{Object***REMOVED*****: Returns the Enquirer instance.
...
```js
const { Prompt ***REMOVED*** = require('enquirer');
class MyCustomPrompt extends Prompt {***REMOVED***
```
...
```js
const { AutoComplete ***REMOVED*** = require('enquirer');
...
```js
const { BasicAuth ***REMOVED*** = require('enquirer');
...
```js
const { Form ***REMOVED*** = require('enquirer');

const prompt = new Form({
  name: 'user',
  message: 'Please provide the following information:',
  choices: [
    { name: 'firstname', message: 'First Name', initial: 'Jon' ***REMOVED***,
    { name: 'lastname', message: 'Last Name', initial: 'Schlinkert' ***REMOVED***,
    { name: 'username', message: 'GitHub username', initial: 'jonschlinkert' ***REMOVED***
  ]
***REMOVED***);
...
```js
const { Invisible ***REMOVED*** = require('enquirer');
...
prompt.run()
  .then(answer => console.log('Answer:', { secret: answer ***REMOVED***))
  .catch(console.error);
```
...
```js
const { List ***REMOVED*** = require('enquirer');
...
```js
const { MultiSelect ***REMOVED*** = require('enquirer');
...
const prompt = new MultiSelect({
  ...
  limit: 7,
  choices: [
    { name: 'aqua', value: '#00ffff' ***REMOVED***,
    { name: 'black', value: '#000000' ***REMOVED***,
    { name: 'blue', value: '#0000ff' ***REMOVED***,
    { name: 'fuchsia', value: '#ff00ff' ***REMOVED***,
    { name: 'gray', value: '#808080' ***REMOVED***,
    { name: 'green', value: '#008000' ***REMOVED***,
    { name: 'lime', value: '#00ff00' ***REMOVED***,
    { name: 'maroon', value: '#800000' ***REMOVED***,
    { name: 'navy', value: '#000080' ***REMOVED***,
    { name: 'olive', value: '#808000' ***REMOVED***,
    { name: 'purple', value: '#800080' ***REMOVED***,
    { name: 'red', value: '#ff0000' ***REMOVED***,
    { name: 'silver', value: '#c0c0c0' ***REMOVED***,
    { name: 'teal', value: '#008080' ***REMOVED***,
    { name: 'white', value: '#ffffff' ***REMOVED***,
    { name: 'yellow', value: '#ffff00' ***REMOVED***
  ]
***REMOVED***);
...
// Answer: { aqua: '#00ffff', blue: '#0000ff', fuchsia: '#ff00ff' ***REMOVED***
```
...
const prompt = new MultiSelect({
  ...
  choices: [
    { message: 'Negative Red', name: 'cyan', value: '#00ffff' ***REMOVED***,
    { message: 'Lights Out', name: 'black', value: '#000000' ***REMOVED***,
    { message: 'The Ocean', name: 'blue', value: '#0000ff' ***REMOVED***,
  ]
***REMOVED***);
...
```js
const { NumberPrompt ***REMOVED*** = require('enquirer');
...
```js
const { Password ***REMOVED*** = require('enquirer');
...
```js
const { Quiz ***REMOVED*** = require('enquirer');
 ...
 prompt
  ...
  .then(answer => {
    if (answer.correct) {
      console.log('Correct!');
    ***REMOVED*** else {
      console.log(`Wrong! Correct answer is ${answer.correctAnswer***REMOVED***`);
    ***REMOVED***
  ***REMOVED***)
  .catch(console.error);
```
...
```js
const { Survey ***REMOVED*** = require('enquirer');

const prompt = new Survey({
  name: 'experience',
  message: 'Please rate your experience',
   scale: [
    { name: '1', message: 'Strongly Disagree' ***REMOVED***,
    { name: '2', message: 'Disagree' ***REMOVED***,
    { name: '3', message: 'Neutral' ***REMOVED***,
    { name: '4', message: 'Agree' ***REMOVED***,
    { name: '5', message: 'Strongly Agree' ***REMOVED***
  ],
  margin: [0, 0, 2, 1],
  choices: [
    {
...
```js
const { Scale ***REMOVED*** = require('enquirer');
...
```js
const { Select ***REMOVED*** = require('enquirer');
...
const prompt = new Select({
  ...
  choices: [
    { name: 'cyan', value: '#00ffff' ***REMOVED***,
    { name: 'black', value: '#000000' ***REMOVED***,
    { name: 'blue', value: '#0000ff' ***REMOVED***,
  ]
***REMOVED***);
...
const { Sort ***REMOVED*** = require('enquirer');
...
const { Snippet ***REMOVED*** = require('enquirer');
const prompt = new Snippet({
  ...
  "homepage": "https://github.com/\${username***REMOVED***/\${name***REMOVED***",
  "author": "\${author_name***REMOVED*** (https://github.com/\${username***REMOVED***)",
  "repository": "\${username***REMOVED***/\${name***REMOVED***",
  "license": "\${license:ISC***REMOVED***"
***REMOVED***
`
***REMOVED***);
...
```js
const { Toggle ***REMOVED*** = require('enquirer');
...
const questions = [{
  ...
  initial: 1,
  choices: [
    { name: 'red',   message: 'Red',   value: '#ff0000' ***REMOVED***, //<= choice object
    { name: 'green', message: 'Green', value: '#00ff00' ***REMOVED***, //<= choice object
    { name: 'blue',  message: 'Blue',  value: '#0000ff' ***REMOVED***  //<= choice object
  ]
***REMOVED***];
...
const question = {
  ...
  message: 'Favorite fruit?',
  choices: [
    { name: 'Apple', message: 'Apple', value: 'Apple' ***REMOVED***,
    { name: 'Orange', message: 'Orange', value: 'Orange' ***REMOVED***,
    { name: 'Raspberry', message: 'Raspberry', value: 'Raspberry' ***REMOVED***
  ]
***REMOVED***;
```
...
```js
const { AuthPrompt ***REMOVED*** = require('enquirer');
...
const prompt = new CustomAuthPrompt({
  ...
  choices: [
    ...
    { name: 'password', message: 'password' ***REMOVED***
  ]
***REMOVED***);
...
```js
const { BooleanPrompt ***REMOVED*** = require('enquirer');
...
```js
const { StringPrompt ***REMOVED*** = require('enquirer');
...
class HaiKarate extends Prompt {
  ...
  ***REMOVED***
  render() {
    ...
    this.write(`${this.state.message***REMOVED***: ${this.value***REMOVED***`);
  ***REMOVED***
***REMOVED***
