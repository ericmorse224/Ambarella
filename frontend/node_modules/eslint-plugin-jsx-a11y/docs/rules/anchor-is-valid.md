...
```jsx
<a href="javascript:void(0)" onClick={foo***REMOVED***>Perform action</a>
<a href="#" onClick={foo***REMOVED***>Perform action</a>
<a onClick={foo***REMOVED***>Perform action</a>
```
...
```jsx
<button onClick={foo***REMOVED***>Perform action</button>
```
...
<a
  className="thing"
  onMouseEnter={() => this.setState({ showSomething: true ***REMOVED***)***REMOVED***
>
  {label***REMOVED***
</a>
```
...
<button
  className="thing"
  onClick={() => this.setState({ showSomething: true ***REMOVED***)***REMOVED***
>
  {label***REMOVED***
</button>
```
...
1. If you have only a few `Link`s, or they're clustered in just a few files like `nav.tsx`, you can use disable macros like `{/* eslint-disable-next-line jsx-a11y/anchor-is-valid */***REMOVED***` to turn off validation of this rule for those usages.
...
```js
// Link.js
const Link = props => <a {...props***REMOVED***>A link</a>;
...
<a href="foo" />
<a href="/foo/bar" />
<a href={someValidPath***REMOVED*** />
<a href="https://github.com" onClick={foo***REMOVED*** />
<a href="#section" onClick={foo***REMOVED*** />
<a href="foo" onClick={foo***REMOVED*** />
<a href="/foo/bar" onClick={foo***REMOVED*** />
<a href={someValidPath***REMOVED*** onClick={foo***REMOVED*** />
```
...
```jsx
<a onClick={foo***REMOVED*** />
<a href="#" onClick={foo***REMOVED*** />
<a href={"#"***REMOVED*** onClick={foo***REMOVED*** />
<a href={`#`***REMOVED*** onClick={foo***REMOVED*** />
<a href="javascript:void(0)" onClick={foo***REMOVED*** />
<a href={"javascript:void(0)"***REMOVED*** onClick={foo***REMOVED*** />
<a href={`javascript:void(0)`***REMOVED*** onClick={foo***REMOVED*** />
```
...
<a href={"javascript:void(0)"***REMOVED*** />
<a href={`javascript:void(0)`***REMOVED*** />
```
