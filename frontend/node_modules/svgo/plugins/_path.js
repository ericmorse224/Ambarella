...
var rNumber = String.raw`[-+]?(?:\d*\.\d+|\d+\.?)(?:[eE][-+]?\d+)?\s*`,
    ...
    rNumberCommaWsp = `(${rNumber***REMOVED***)` + rCommaWsp,
    rFlagCommaWsp = `([01])${rCommaWsp***REMOVED***?`,
    rCoordinatePair = String.raw`(${rNumber***REMOVED***)${rCommaWsp***REMOVED***?(${rNumber***REMOVED***)`,
 ...
 *
 * @param {String***REMOVED*** pathString input string
 * @param {Object***REMOVED*** params plugin params
 * @return {Array***REMOVED*** output array
 */
 ...
 *
 * @param {Array***REMOVED*** data input data
 * @return {Array***REMOVED*** output data
 */
var relative2absolute = exports.relative2absolute = function(data) {
    ...
    return data.map(function(item) {
        ...
        ***REMOVED*** else if ('mlcsqt'.indexOf(instruction) > -1) {
 ...
 *
 * @param {Object***REMOVED*** elem current element
 * @param {Array***REMOVED*** path input path data
 * @param {Object***REMOVED*** params whether to apply transforms to stroked lines and transform precision (used for stroke width)
 * @return {Array***REMOVED*** output path data
 */
exports.applyTransforms = function(elem, path, params) {
    ...
    if (stroke && stroke != 'none') {
        ...
        if (id) {
            ...
            ***REMOVED*** while (!idElem.hasAttr('id', id) && !hasStrokeWidth && (idElem = idElem.parentNode));
        ...
        ***REMOVED***
        ...
        if (scale !== 1) {
            ...
            ***REMOVED***
        ***REMOVED***
    ***REMOVED*** else if (id) { // Stroke and stroke-width can be redefined with <use>
        return path;
    ***REMOVED***
    ...
    path.forEach(function(pathItem) {
        ...
        if (pathItem.data) {
            ...
            // v -> l
            ***REMOVED*** else if (pathItem.instruction === 'v') {
 ...
 *
 * @param {Array***REMOVED*** matrix transform 3x3 matrix
 * @param {Array***REMOVED*** point x-y point
 * @return {Array***REMOVED*** point with new coordinates
 */
 ...
 *
 * @param {Float***REMOVED*** xa
 * @param {Float***REMOVED*** ya
 * @param {Float***REMOVED*** xb
 * @param {Float***REMOVED*** yb
 * @param {Float***REMOVED*** xc
 * @param {Float***REMOVED*** yc
 * @param {Float***REMOVED*** xd
 * @param {Float***REMOVED*** yd
 *
...
exports.computeCubicBoundingBox = function(xa, ya, xb, yb, xc, yc, xd, yd) {
    ...
    // X
    if (xa < minx) { minx = xa; ***REMOVED***
    if (xa > maxx) { maxx = xa; ***REMOVED***
    if (xd < minx) { minx= xd; ***REMOVED***
    if (xd > maxx) { maxx = xd; ***REMOVED***
    ...
    for (i = 0; i < ts.length; i++) {
        ...
        if (t >= 0 && t <= 1) {
            ...
            if (x < minx) { minx = x; ***REMOVED***
            if (x > maxx) { maxx = x; ***REMOVED***
        ***REMOVED***

    ***REMOVED***

    // Y
    if (ya < miny) { miny = ya; ***REMOVED***
    if (ya > maxy) { maxy = ya; ***REMOVED***
    if (yd < miny) { miny = yd; ***REMOVED***
    if (yd > maxy) { maxy = yd; ***REMOVED***
    ...
    for (i = 0; i < ts.length; i++) {
        ...
        if (t >= 0 && t <= 1) {
            ...
            if (y < miny) { miny = y; ***REMOVED***
            if (y > maxy) { maxy = y; ***REMOVED***
        ***REMOVED***
...
exports.computeQuadraticBoundingBox = function(xa, ya, xb, yb, xc, yc) {
    ...
    if (xa < minx) { minx = xa; ***REMOVED***
    if (xa > maxx) { maxx = xa; ***REMOVED***
    if (xc < minx) { minx = xc; ***REMOVED***
    if (xc > maxx) { maxx = xc; ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (ya < miny) { miny = ya; ***REMOVED***
    if (ya > maxy) { maxy = ya; ***REMOVED***
    if (yc < miny) { miny = yc; ***REMOVED***
    if (yc > maxy) { maxy = yc; ***REMOVED***
 ...
 * @param {Array***REMOVED*** path input path data
 * @param {Object***REMOVED*** params plugin params
 * @return {String***REMOVED*** output path string
 */
 ...
 *
 * @param {Array***REMOVED*** path1 JS path representation
 * @param {Array***REMOVED*** path2 JS path representation
...
function processSimplex(simplex, direction) {
    ...
    ***REMOVED*** else { // 2-simplex
        ...
        if (dot(ACB, AO) > 0) {
            ...
            ***REMOVED*** else { // region 5
                set(direction, AO);
                simplex.splice(0, 2); // simplex = [a]
            ***REMOVED***
        ***REMOVED*** else if (dot(ABC, AO) > 0) {
            if (dot(AC, AO) > 0) { // region 6
                set(direction, ABC);
                simplex.splice(1, 1); // simplex = [c, a]
            ***REMOVED*** else { // region 5 (again)
                set(direction, AO);
                simplex.splice(0, 2); // simplex = [a]
            ***REMOVED***
        ***REMOVED*** else // region 7
            return true;
    ***REMOVED***
    return false;
***REMOVED***
...
function gatherPoints(points, item, index, path) {
    ...
    ***REMOVED***
    ...
    function toAbsolute(n, i) { return n + basePoint[i % 2] ***REMOVED***
...
function a2c(x1, y1, rx, ry, angle, large_arc_flag, sweep_flag, x2, y2, recursive) {
    ...
    var _120 = Math.PI * 120 / 180,
        ...
        res = [],
        rotateX = function(x, y, rad) { return x * Math.cos(rad) - y * Math.sin(rad) ***REMOVED***,
        rotateY = function(x, y, rad) { return x * Math.sin(rad) + y * Math.cos(rad) ***REMOVED***;
    if (!recursive) {
