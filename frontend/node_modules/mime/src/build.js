...
for (let type in db) {
  ...
  entry.extensions.forEach(ext => {
    if (ext in byExtension) {
      ...
      console.log(`${ext***REMOVED***: Keeping ${chalk.green(keep.type)***REMOVED*** (${keep.pri***REMOVED***), dropping ${chalk.red(drop.type)***REMOVED*** (${drop.pri***REMOVED***)`);
    ***REMOVED***
