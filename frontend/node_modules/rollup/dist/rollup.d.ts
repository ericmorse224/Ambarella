...
export type SourceMapInput = ExistingRawSourceMap | string | null | { mappings: '' ***REMOVED***;
...
export type EmitChunk = (id: string, options?: { name?: string ***REMOVED***) => string;
...
export interface PluginContext extends MinimalPluginContext {
	...
	emitChunk: EmitChunk;
	emitFile: EmitFile;
	error: (err: RollupError | string, pos?: number | { column: number; line: number ***REMOVED***) => never;
	...
	load: (
		options: { id: string; resolveDependencies?: boolean ***REMOVED*** & Partial<PartialNull<ModuleOptions>>
	) => Promise<ModuleInfo>;
	...
	resolve: (
		source: string,
		importer?: string,
		options?: { custom?: CustomPluginOptions; isEntry?: boolean; skipSelf?: boolean ***REMOVED***
	) => Promise<ResolvedId | null>;
	/** @deprecated Use `this.resolve` instead */
	resolveId: (source: string, importer?: string) => Promise<string | null>;
	setAssetSource: (assetReferenceId: string, source: string | Uint8Array) => void;
	warn: (warning: RollupWarning | string, pos?: number | { column: number; line: number ***REMOVED***) => void;
***REMOVED***
...
export type ResolveIdHook = (
	...
	options: { custom?: CustomPluginOptions; isEntry: boolean ***REMOVED***
) => ResolveIdResult;
...
) => { code: string; map?: SourceMapInput ***REMOVED*** | string | null | undefined;
...
export type ResolveImportMetaHook = (
	this: PluginContext,
	prop: string | null,
	options: { chunkId: string; format: InternalModuleFormat; moduleId: string ***REMOVED***
) => string | null | void;
...
export type WatchChangeHook = (
	this: PluginContext,
	id: string,
	change: { event: ChangeEvent ***REMOVED***
) => void;
 ...
 * ...
 * ***REMOVED***
 * const myPlugin: PluginImpl<Options> = (options = {***REMOVED***) => { ... ***REMOVED***
 * ```
 */
...
export interface FunctionPluginHooks {
	...
	renderDynamicImport: (
		...
		***REMOVED***
	) => { left: string; right: string ***REMOVED*** | null | void;
...
// eslint-disable-next-line @typescript-eslint/ban-types
type ObjectHook<T, O = {***REMOVED***> = T | ({ handler: T; order?: 'pre' | 'post' | null ***REMOVED*** & O);

export type PluginHooks = {
	[K in keyof FunctionPluginHooks]: ObjectHook<
		K extends AsyncPluginHooks ? MakeAsync<FunctionPluginHooks[K]> : FunctionPluginHooks[K],
		// eslint-disable-next-line @typescript-eslint/ban-types
		K extends ParallelPluginHooks ? { sequential?: boolean ***REMOVED*** : {***REMOVED***
	>;
***REMOVED***;

export interface OutputPlugin
	extends Partial<{ [K in OutputPluginHooks]: PluginHooks[K] ***REMOVED***>,
		Partial<{ [K in AddonHooks]: ObjectHook<AddonHook> ***REMOVED***> {
	cacheKey?: string;
	name: string;
***REMOVED***
...
export type GlobalsOption = { [name: string]: string ***REMOVED*** | ((name: string) => string);
export type InputOption = string | string[] | { [entryAlias: string]: string ***REMOVED***;
export type ManualChunksOption = { [chunkAlias: string]: string[] ***REMOVED*** | GetManualChunk;
...
export interface InputOptions {
	...
	moduleContext?: ((id: string) => string | null | void) | { [id: string]: string ***REMOVED***;
...
export interface NormalizedInputOptions {
	...
	input: string[] | { [entryAlias: string]: string ***REMOVED***;
	makeAbsoluteExternalsRelative: boolean | 'ifRelativeSource';
	/** @deprecated Use the "manualChunks" output option instead. */
...
interface TypedEventEmitter<T extends { [event: string]: (...args: any) => any ***REMOVED***> {
...
export interface RollupAwaitingEmitter<T extends { [event: string]: (...args: any) => any ***REMOVED***>
...
export type RollupWatcherEvent =
	| { code: 'START' ***REMOVED***
	| { code: 'BUNDLE_START'; input?: InputOption; output: readonly string[] ***REMOVED***
	| {
			code: 'BUNDLE_END';
			duration: number;
			input?: InputOption;
	  ...
	  ***REMOVED***
	| { code: 'END' ***REMOVED***
	| { code: 'ERROR'; error: RollupError; result: RollupBuild | null ***REMOVED***;

export type RollupWatcher = RollupAwaitingEmitter<{
	change: (id: string, change: { event: ChangeEvent ***REMOVED***) => void;
	close: () => void;
