...
// Transpiled version of: /^([A-Za-z]:[/\\])?[\p{L***REMOVED***0-9/.\-_\\]+$/u
...
function guessEditor() {
  ...
  try {
    ...
    ***REMOVED*** else if (process.platform === 'win32') {
      ...
      for (let i = 0; i < runningProcesses.length; i++) {
        ...
        ***REMOVED***
      ***REMOVED***
    ***REMOVED*** else if (process.platform === 'linux') {
  ...
  ***REMOVED*** else if (process.env.EDITOR) {
  ...
  ***REMOVED***
  ...
  if (process.platform === 'win32') {
    ...
    _childProcess = child_process.spawn(
      ...
      { stdio: 'inherit' ***REMOVED***
    );
  ***REMOVED*** else {
    _childProcess = child_process.spawn(editor, args, { stdio: 'inherit' ***REMOVED***);
  ***REMOVED***
