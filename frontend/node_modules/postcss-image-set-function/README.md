...
```js
postcssImageSetFunction({ preserve: false ***REMOVED***)
```
...
```js
postcssImageSetFunction({ oninvalid: 'warning' ***REMOVED***) // warn on invalid usages
```

```js
postcssImageSetFunction({ oninvalid: 'throw' ***REMOVED***) // throw on invalid usages
```
