...
import { resultingClientExists ***REMOVED*** from 'workbox-core/_private/resultingClientExists.js';
import { logger ***REMOVED*** from 'workbox-core/_private/logger.js';
import { responsesAreSame ***REMOVED*** from './responsesAreSame.js';
import { CACHE_UPDATED_MESSAGE_META, CACHE_UPDATED_MESSAGE_TYPE, DEFAULT_HEADERS_TO_CHECK, NOTIFY_ALL_CLIENTS, ***REMOVED*** from './utils/constants.js';
import './_version.js';
...
class BroadcastCacheUpdate {
     ...
     * @param {boolean***REMOVED*** [options.notifyAllClients=true] If true (the default) then
     ...
     */
    constructor({ generatePayload, headersToCheck, notifyAllClients, ***REMOVED*** = {***REMOVED***) {
    ...
    ***REMOVED***
     ...
     *
     * @param {Object***REMOVED*** options
     * @param {Response***REMOVED*** [options.oldResponse] Cached response to compare.
     * @param {Response***REMOVED*** options.newResponse Possibly updated response to compare.
     * @param {Request***REMOVED*** options.request The request.
     * @param {string***REMOVED*** options.cacheName Name of the cache the responses belong
     *     to. This is included in the broadcast message.
     * @param {Event***REMOVED*** options.event event The event that triggered
     *     this possible cache update.
     * @return {Promise***REMOVED*** Resolves once the update is sent.
     */
        ...
        if (!responsesAreSame(options.oldResponse, options.newResponse, this._headersToCheck)) {
            ...
            ***REMOVED***
            if (this._notifyAllClients) {
                const windows = await self.clients.matchAll({ type: 'window' ***REMOVED***);
    ...
    ***REMOVED***
***REMOVED***
export { BroadcastCacheUpdate ***REMOVED***;
