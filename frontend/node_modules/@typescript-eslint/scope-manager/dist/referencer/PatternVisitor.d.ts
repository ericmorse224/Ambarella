...
import type { VisitorOptions ***REMOVED*** from './VisitorBase';
import { VisitorBase ***REMOVED*** from './VisitorBase';
...
***REMOVED***
export { PatternVisitor, PatternVisitorCallback, PatternVisitorOptions ***REMOVED***;
