import { GeneratorOptions ***REMOVED*** from "@babel/generator";
import { ParserOptions ***REMOVED*** from "@babel/parser";
import template from "@babel/template";
import traverse, { Hub, NodePath, Scope, Visitor ***REMOVED*** from "@babel/traverse";
import * as t from "@babel/types";

export { GeneratorOptions, NodePath, ParserOptions, t as types, template, traverse, Visitor ***REMOVED***;
 ...
 * @see {@link https://sourcemaps.info/spec.html***REMOVED***
 * @see {@link https://github.com/mozilla/source-map/blob/HEAD/source-map.d.ts***REMOVED***
 */
...
export interface TransformOptions {
     ...
     */
    assumptions?: { [name: string]: boolean ***REMOVED*** | null | undefined;
    ...
    /**
     * This is an object of keys that represent different environments. For example, you may have: `{ env: { production: { \/* specific options *\/ ***REMOVED*** ***REMOVED*** ***REMOVED***`
     * which will use those options when the `envName` is `production`
     *
     * Default: `{***REMOVED***`
     */
    env?: { [index: string]: TransformOptions | null | undefined ***REMOVED*** | null | undefined;
...
export interface TransformCaller {
    ...
    // augment this with a "declare module '@babel/core' { ... ***REMOVED***" if you need more keys
***REMOVED***
...
export interface ConfigItem {
    /**
     * The name that the user gave the plugin instance, e.g. `plugins: [ ['env', {***REMOVED***, 'my-env'] ]`
     */
    name?: string | undefined;
...
export interface ConfigAPI {
     ...
     *
     * @example
     * function isBabelRegister(caller?: { name: string ***REMOVED***) {
