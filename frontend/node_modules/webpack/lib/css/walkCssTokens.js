...
/**
 * @typedef {object***REMOVED*** CssTokenCallbacks
 * @property {((input: string, start: number, end: number, innerStart: number, innerEnd: number) => number)=***REMOVED*** url
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** comment
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** string
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** leftParenthesis
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** rightParenthesis
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** function
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** colon
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** atKeyword
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** delim
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** identifier
 * @property {((input: string, start: number, end: number, isId: boolean) => number)=***REMOVED*** hash
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** leftCurlyBracket
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** rightCurlyBracket
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** semicolon
 * @property {((input: string, start: number, end: number) => number)=***REMOVED*** comma
 * @property {(() => boolean)=***REMOVED*** needTerminate
 */

/** @typedef {(input: string, pos: number, callbacks: CssTokenCallbacks) => number***REMOVED*** CharHandler */
...
const CC_RIGHT_CURLY = "***REMOVED***".charCodeAt(0);
...
/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, if cc is a newline
 */
const _isNewline = cc =>
 ...
 * @returns {number***REMOVED*** position
 */
...
/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, if cc is a space (U+0009 CHARACTER TABULATION or U+0020 SPACE)
 */
const _isSpace = cc => cc === CC_TAB || cc === CC_SPACE;

/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, if cc is a whitespace
 */
 ...
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, if cc is a start code point of an identifier
 */
...
/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, if cc is a hex digit
 */
...
/**
 * @param {number***REMOVED*** cc char code
 * @param {number***REMOVED*** q char code
 * @returns {boolean***REMOVED*** is non-ASCII code point
 */
...
/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** is letter
 */
const isLetter = cc =>
	(cc >= CC_LOWER_A && cc <= CC_LOWER_Z) ||
	(cc >= CC_UPPER_A && cc <= CC_UPPER_Z);
 ...
 * @param {number***REMOVED*** cc char code
 * @param {number***REMOVED*** q char code
 * @returns {boolean***REMOVED*** is identifier start code
 */
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @param {number=***REMOVED*** f first code point
 * @param {number=***REMOVED*** s second code point
 * @returns {boolean***REMOVED*** true if two code points are a valid escape
 */
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @param {number=***REMOVED*** f first
 * @param {number=***REMOVED*** s second
 * @param {number=***REMOVED*** t third
 * @returns {boolean***REMOVED*** true, if input at pos starts an identifier
 */
...
const _ifThreeCodePointsWouldStartANumber = (input, pos, f, s, t) => {
	...
	if (first === CC_PLUS_SIGN || first === CC_HYPHEN_MINUS) {
		if (_isDigit(second)) {
			return true;
		***REMOVED*** else if (second === CC_FULL_STOP && _isDigit(third)) {
			return true;
		***REMOVED***
...
/**
 * @param {number***REMOVED*** cc char code
 * @returns {boolean***REMOVED*** true, when cc is the non-printable code point, otherwise false
 */
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @param {number***REMOVED*** fnStart start
 * @param {CssTokenCallbacks***REMOVED*** callbacks callbacks
 * @returns {pos***REMOVED*** pos
 */
	...
	switch (cc) {
		...
		default:
			...
			if (_isDigit(cc)) {
				pos--;
				return consumeANumericToken(input, pos, callbacks);
			***REMOVED*** else if (cc === CC_LOWER_U || cc === CC_UPPER_U) {
...
/**
 * @param {string***REMOVED*** input input css
 * @param {number=***REMOVED*** pos pos
 * @param {CssTokenCallbacks=***REMOVED*** callbacks callbacks
 * @returns {number***REMOVED*** pos
 */
module.exports = (input, pos = 0, callbacks = {***REMOVED***) => {
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @returns {number***REMOVED*** position after comments
 */
module.exports.eatComments = (input, pos) => {
	for (;;) {
		const originalPos = pos;
		pos = consumeComments(input, pos, {***REMOVED***);
		if (originalPos === pos) {
			break;
		***REMOVED***
	***REMOVED***
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @returns {number***REMOVED*** position after whitespace
 */
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @returns {number***REMOVED*** position after whitespace and comments
 */
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @returns {[number, number] | undefined***REMOVED*** positions of ident sequence
 */
module.exports.skipCommentsAndEatIdentSequence = (input, pos) => {
	...
	if (
		...
		return [start, _consumeAnIdentSequence(input, pos, {***REMOVED***)];
	***REMOVED***
...
module.exports.eatString = (input, pos) => {
	...
	if (
		...
		return [start, consumeAStringToken(input, pos + 1, {***REMOVED***)];
	***REMOVED***
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @param {CssTokenCallbacks***REMOVED*** cbs callbacks
 * @returns {[number, number][]***REMOVED*** positions of ident sequence
 */
module.exports.eatImageSetStrings = (input, pos, cbs) => {
	/** @type {[number, number][]***REMOVED*** */
	const result = [];
	...
	/** @type {CssTokenCallbacks***REMOVED*** */
	const callbacks = {
		...cbs,
 ...
 * @param {number***REMOVED*** pos position
 * @param {CssTokenCallbacks***REMOVED*** cbs callbacks
 * @returns {[[number, number, number, number] | undefined, [number, number] | undefined, [number, number] | undefined, [number, number] | undefined]***REMOVED*** positions of top level tokens
 */
module.exports.eatImportTokens = (input, pos, cbs) => {
	const result =
		/** @type {[[number, number, number, number] | undefined, [number, number] | undefined, [number, number] | undefined, [number, number] | undefined]***REMOVED*** */
		(new Array(4));

	/** @type {0 | 1 | 2 | undefined***REMOVED*** */
	let scope;
	let needStop = false;
	let balanced = 0;
		...
		***REMOVED***,
		string: (_input, start, end) => {
			if (
				...
				scope = undefined;
			***REMOVED*** else if (result[0] !== undefined && scope === 0) {
				result[0][2] = start + 1;
				result[0][3] = end - 1;
			***REMOVED***
		...
		***REMOVED***,
		function: (input, start, end) => {
			if (balanced === 0) {
				...
				***REMOVED*** else if (name === "supports" && result[2] === undefined) {
					scope = 2;
					result[scope] = [start, end];
				***REMOVED*** else {
					scope = undefined;
 ...
 * @param {string***REMOVED*** input input
 * @param {number***REMOVED*** pos position
 * @returns {[number, number, boolean] | undefined***REMOVED*** positions of ident sequence or string
 */
module.exports.eatIdentSequenceOrString = (input, pos) => {
	...
	if (
		...
		return [start, consumeAStringToken(input, pos + 1, {***REMOVED***), false];
	***REMOVED*** else if (
		_ifThreeCodePointsWouldStartAnIdentSequence(
			input,
			pos,
		...
		return [start, _consumeAnIdentSequence(input, pos, {***REMOVED***), true];
	***REMOVED***
...
/**
 * @param {string***REMOVED*** chars characters
 * @returns {(input: string, pos: number) => number***REMOVED*** function to eat characters
 */
module.exports.eatUntil = chars => {
	const charCodes = Array.from({ length: chars.length ***REMOVED***, (_, i) =>
		chars.charCodeAt(i)
	);
	const arr = Array.from(
		{ length: charCodes.reduce((a, b) => Math.max(a, b), 0) + 1 ***REMOVED***,
		() => false
	);
