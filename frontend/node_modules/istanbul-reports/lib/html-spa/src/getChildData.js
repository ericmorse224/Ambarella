function addPath(node, parentPath) {
    if (!parentPath) {
        return node;
    ***REMOVED***
    return { ...node, file: parentPath + '/' + node.file ***REMOVED***;
***REMOVED***
...
function filterByFile(nodes, fileFilter, parentPath) {
    ...
    for (let i = 0; i < nodes.length; i++) {
        ...
        ***REMOVED*** else if (isChildAboveFilter) {
    ...
    for (let i = 0; i < nodes.length; i++) {
        ...
        if (child.children) {
            ...
            if (newSubChildren.length) {
                child = { ...child, children: newSubChildren ***REMOVED***;
                children.push(child);
            ***REMOVED***
        ***REMOVED*** else {
            if (
...
module.exports = function getChildData(
    ...
    ***REMOVED***
    ...
    if (activeFilters.low) {
        activeFilters = { ...activeFilters, empty: true ***REMOVED***;
    ***REMOVED***
