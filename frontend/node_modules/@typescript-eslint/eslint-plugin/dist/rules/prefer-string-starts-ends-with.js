        ...
        ***REMOVED***
        ...
        function parseRegExp(node) {
            ...
            if (evaluated == null || !(evaluated.value instanceof RegExp)) {
                return null;
            ***REMOVED***
            const { source, flags ***REMOVED*** = evaluated.value;
            ...
            ***REMOVED***
            ...
            if (text == null) {
                return null;
            ***REMOVED***
            return { isEndsWith, isStartsWith, text ***REMOVED***;
        ***REMOVED***
        function getLeftNode(node) {
            ...
            ***REMOVED***
            if (leftNode.type !== utils_1.AST_NODE_TYPES.MemberExpression) {
                throw new Error(`Expected a MemberExpression, got ${leftNode.type***REMOVED***`);
            ***REMOVED***
            return leftNode;
        ***REMOVED***
        /**
        ...
        function* fixWithRightOperand(fixer, node, kind, isNegative, isOptional) {
            ...
            ***REMOVED***
            yield fixer.replaceTextRange([propertyRange[0], node.right.range[0]], `${isOptional ? '?.' : '.'***REMOVED***${kind***REMOVED***sWith(`);
        ...
        ***REMOVED***
        ...
        function* fixWithArgument(fixer, node, callNode, calleeNode, kind, negative, isOptional) {
            if (negative) {
                yield fixer.insertTextBefore(node, '!');
            ***REMOVED***
            yield fixer.replaceTextRange(getPropertyRange(calleeNode), `${isOptional ? '?.' : '.'***REMOVED***${kind***REMOVED***sWith`);
            ...
            [[
                ...
                ***REMOVED***
                ...
                if (parsed == null) {
                    return;
                ***REMOVED***
                const { isStartsWith, text ***REMOVED*** = parsed;
                context.report({
                    node: callNode,
                    messageId: isStartsWith ? 'preferStartsWith' : 'preferEndsWith',
                    *fix(fixer) {
                        ...
                        ***REMOVED***
                        yield fixer.replaceTextRange(getPropertyRange(node), `${node.optional ? '?.' : '.'***REMOVED***${isStartsWith ? 'start' : 'end'***REMOVED***sWith`);
                ...
                ***REMOVED***
                ...
                context.report({
                    ...
                    *fix(fixer) {
                        ...
                        ***REMOVED***
                        yield fixer.insertTextAfter(argNode, `${node.optional ? '?.' : '.'***REMOVED***${methodName***REMOVED***(${JSON.stringify(text)***REMOVED***`);
                    ***REMOVED***,
                ***REMOVED***);
            ***REMOVED***,
        ***REMOVED***;
