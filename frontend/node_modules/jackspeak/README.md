...
```js
import { jack ***REMOVED*** from 'jackspeak'
// this works too:
// const { jack ***REMOVED*** = require('jackspeak')

const { positionals, values ***REMOVED*** = jack({ envPrefix: 'FOO' ***REMOVED***)
  .flag({
    asdf: { description: 'sets the asfd flag', short: 'a', default: true ***REMOVED***,
    'no-asdf': { description: 'unsets the asdf flag', short: 'A' ***REMOVED***,
    foo: { description: 'another boolean', short: 'f' ***REMOVED***,
  ***REMOVED***)
  .optList({
    'ip-addrs': {
...
## `jack(options: JackOptions = {***REMOVED***) => Jack`
...
### `Jack.description(text: string, { pre?: boolean ***REMOVED*** = {***REMOVED***)`
...
### `Jack.opt({ [option: string]: definition, ... ***REMOVED***)`

Define one or more string option fields.

### `Jack.optList({ [option: string]: definition, ... ***REMOVED***)`

Define one or more string list fields.

### `Jack.addFields({ [option: string]: definition, ... ***REMOVED***)`
...
### `Jack.parse(args: string[] = process.argv): { positionals: string[], values: OptionsResults ***REMOVED***`
...
const { values, positionals ***REMOVED*** = j.parse(process.argv)
