...
test('setProto', function (t) {
	...
	t.test('can set', { skip: !setProto ***REMOVED***, function (st) {
		var obj = { a: 1 ***REMOVED***;
		var proto = { b: 2 ***REMOVED***;
		...
		st.equal(/** @type {NonNullable<typeof setProto>***REMOVED*** */ (setProto)(obj, proto), obj, 'returns the object');
	...
	***REMOVED***);
	...
	t.test('can not set', { skip: !!setProto ***REMOVED***, function (st) {
