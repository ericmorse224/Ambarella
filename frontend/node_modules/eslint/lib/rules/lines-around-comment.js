 ...
 * @param {Array***REMOVED*** lines An array of each line of the file.
 * @returns {Array***REMOVED*** An array of line numbers.
 */
 ...
 * @param {Array***REMOVED*** comments An array of comment tokens.
 * @returns {Array***REMOVED*** An array of line numbers.
 */
...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		const options = Object.assign({***REMOVED***, context.options[0]);
		 ...
		 * @param {token***REMOVED*** token The comment token to check.
		 * @returns {boolean***REMOVED*** True if the comment is not alone.
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** parent The Comment parent node.
		 * @param {string***REMOVED*** nodeType The parent type to check against.
		 * @returns {boolean***REMOVED*** True if the comment is inside nodeType.
		 */
		...
		***REMOVED***
		 ...
		 * @returns {ASTNode|null***REMOVED*** The parent node that contains the given token.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @param {string***REMOVED*** nodeType The parent type to check against.
		 * @returns {boolean***REMOVED*** True if the comment is at parent start.
		 */
			...
			if (parent && isParentNodeType(parent, nodeType)) {
				...
				if (parent.type === "StaticBlock") {
					parentStartNodeOrToken = sourceCode.getFirstToken(parent, {
						skip: 1,
					***REMOVED***); // opening brace of the static block
				***REMOVED*** else if (parent.type === "SwitchStatement") {
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @param {string***REMOVED*** nodeType The parent type to check against.
		 * @returns {boolean***REMOVED*** True if the comment is at parent end.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at block start.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at block end.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at class start.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at class end.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at object start.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at object end.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at array start.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @returns {boolean***REMOVED*** True if the comment is at array end.
		 */
		...
		***REMOVED***
		 ...
		 * @param {token***REMOVED*** token The Comment token.
		 * @param {Object***REMOVED*** opts Options to determine the newline.
		 * @param {boolean***REMOVED*** opts.after Should have a newline after this line.
		 * @param {boolean***REMOVED*** opts.before Should have a newline before this line.
				...
				comments.forEach(token => {
					if (token.type === "Line") {
						if (
							...
							***REMOVED***);
						***REMOVED***
					***REMOVED*** else if (token.type === "Block") {
						if (
							options.beforeBlockComment ||
							...
							***REMOVED***);
						***REMOVED***
					***REMOVED*** else if (token.type === "Shebang") {
