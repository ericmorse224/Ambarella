import { CompileToken ***REMOVED*** from "./../types";
import type { Selector ***REMOVED*** from "css-what";
import type { CompiledQuery, InternalOptions, Adapter ***REMOVED*** from "../types";
/** Used as a placeholder for :has. Will be replaced with the actual element. */
export declare const PLACEHOLDER_ELEMENT: {***REMOVED***;
