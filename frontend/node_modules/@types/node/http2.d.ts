...
declare module "http2" {
    ...
    import {
        ...
        OutgoingHttpHeaders,
        ServerResponse,
    ***REMOVED*** from "node:http";
    export { OutgoingHttpHeaders ***REMOVED*** from "node:http";
    ...
    ***REMOVED***
    export interface Http2Stream extends stream.Duplex {
         ...
         * const { NGHTTP2_CANCEL ***REMOVED*** = http2.constants;
         * const req = client.request({ ':path': '/' ***REMOVED***);
         *
         ...
         *   stream.respond(undefined, { waitForTrailers: true ***REMOVED***);
         *   stream.on('wantTrailers', () => {
         *     stream.sendTrailers({ xyz: 'abc' ***REMOVED***);
         *   ***REMOVED***);
    ...
    ***REMOVED***
    export interface ClientHttp2Stream extends Http2Stream {
        addListener(event: "continue", listener: () => {***REMOVED***): this;
        addListener(
            event: "headers",
        ...
        emit(event: string | symbol, ...args: any[]): boolean;
        on(event: "continue", listener: () => {***REMOVED***): this;
        on(
            event: "headers",
            listener: (headers: IncomingHttpHeaders & IncomingHttpStatusHeader, flags: number) => void,
        ): this;
        ...
        on(event: string | symbol, listener: (...args: any[]) => void): this;
        once(event: "continue", listener: () => {***REMOVED***): this;
        once(
            event: "headers",
            listener: (headers: IncomingHttpHeaders & IncomingHttpStatusHeader, flags: number) => void,
        ): this;
        ...
        once(event: string | symbol, listener: (...args: any[]) => void): this;
        prependListener(event: "continue", listener: () => {***REMOVED***): this;
        prependListener(
            event: "headers",
            listener: (headers: IncomingHttpHeaders & IncomingHttpStatusHeader, flags: number) => void,
        ): this;
        ...
        prependListener(event: string | symbol, listener: (...args: any[]) => void): this;
        prependOnceListener(event: "continue", listener: () => {***REMOVED***): this;
        prependOnceListener(
            event: "headers",
            listener: (headers: IncomingHttpHeaders & IncomingHttpStatusHeader, flags: number) => void,
        ): this;
    ...
    ***REMOVED***
    export interface ServerHttp2Stream extends Http2Stream {
         ...
         * const server = http2.createServer();
         * server.on('stream', (stream) => {
         *   stream.respond({ ':status': 200 ***REMOVED***);
         *   stream.pushStream({ ':path': '/' ***REMOVED***, (err, pushStream, headers) => {
         *     if (err) throw err;
         *     pushStream.respond({ ':status': 200 ***REMOVED***);
         ...
         * const server = http2.createServer();
         * server.on('stream', (stream) => {
         *   stream.respond({ ':status': 200 ***REMOVED***, { waitForTrailers: true ***REMOVED***);
         *   stream.on('wantTrailers', () => {
         *     stream.sendTrailers({ ABC: 'some value to send' ***REMOVED***);
         *   ***REMOVED***);
         *   stream.end('some data');
         * ***REMOVED***);
         * ```
         ...
         *     'content-type': 'text/plain; charset=utf-8',
         *   ***REMOVED***;
         *   stream.respondWithFD(fd, headers, { waitForTrailers: true ***REMOVED***);
         *   stream.on('wantTrailers', () => {
         *     stream.sendTrailers({ ABC: 'some value to send' ***REMOVED***);
         *   ***REMOVED***);
         *
         ...
         *     try {
         *       if (err.code === 'ENOENT') {
         *         stream.respond({ ':status': 404 ***REMOVED***);
         *       ***REMOVED*** else {
         *         stream.respond({ ':status': 500 ***REMOVED***);
         *       ***REMOVED***
         *     ***REMOVED*** catch (err) {
         ...
         *                          { 'content-type': 'text/plain; charset=utf-8' ***REMOVED***,
         *                          { statCheck, onError ***REMOVED***);
         * ***REMOVED***);
         * ```
         *
         ...
         *   function statCheck(stat, headers) {
         *     // Check the stat here...
         *     stream.respond({ ':status': 304 ***REMOVED***);
    ...
    ***REMOVED***
    export interface Http2Session extends EventEmitter {
         ...
         *   if (!err) {
         *     console.log(`Ping acknowledged in ${duration***REMOVED*** milliseconds`);
         *     console.log(`With payload '${payload.toString()***REMOVED***'`);
         *   ***REMOVED***
         * ***REMOVED***);
         * ```
         *
    ...
    ***REMOVED***
    export interface ClientHttp2Session extends Http2Session {
         ...
         *
         * const req = clientSession.request({ [HTTP2_HEADER_PATH]: '/' ***REMOVED***);
    ...
    ***REMOVED***
    export interface SecureClientSessionOptions extends ClientSessionOptions, tls.ConnectionOptions {***REMOVED***
    export interface SecureServerSessionOptions<
        Http1Request extends typeof IncomingMessage = typeof IncomingMessage,
        Http1Response extends typeof ServerResponse<InstanceType<Http1Request>> = typeof ServerResponse,
        Http2Request extends typeof Http2ServerRequest = typeof Http2ServerRequest,
        Http2Response extends typeof Http2ServerResponse<InstanceType<Http2Request>> = typeof Http2ServerResponse,
    > extends ServerSessionOptions<Http1Request, Http1Response, Http2Request, Http2Response>, tls.TlsOptions {***REMOVED***
    export interface ServerOptions<
        Http1Request extends typeof IncomingMessage = typeof IncomingMessage,
        Http1Response extends typeof ServerResponse<InstanceType<Http1Request>> = typeof ServerResponse,
        Http2Request extends typeof Http2ServerRequest = typeof Http2ServerRequest,
        Http2Response extends typeof Http2ServerResponse<InstanceType<Http2Request>> = typeof Http2ServerResponse,
    > extends ServerSessionOptions<Http1Request, Http1Response, Http2Request, Http2Response> {***REMOVED***
    ...
    ***REMOVED***
    /**
     * A `Http2ServerRequest` object is created by {@link Server***REMOVED*** or {@link SecureServer***REMOVED*** and passed as the first argument to the `'request'` event. It may be used to access a request status,
     * headers, and
     * data.
     * @since v8.4.0
     */
    ...
    ***REMOVED***
    ...
    export class Http2ServerResponse<Request extends Http2ServerRequest = Http2ServerRequest> extends stream.Writable {
         ...
         *
         * If there were no previous values for the header, this is equivalent to calling {@link setHeader***REMOVED***.
         *
         ...
         *   res.end(`Your IP address is ${ip***REMOVED*** and your source port is ${port***REMOVED***.`);
         * ***REMOVED***).listen(3000);
         * ```
         * @since v8.4.0
         */
         ...
         *   res.writeHead(200, { 'Content-Type': 'text/plain; charset=utf-8' ***REMOVED***);
         *   res.end('ok');
         * ***REMOVED***);
         * ```
         * @since v8.4.0
    ...
    ***REMOVED***
     ...
     * import http2 from 'node:http2';
     *
     * const packed = http2.getPackedSettings({ enablePush: false ***REMOVED***);
     *
     ...
     *
     * Since there are no browsers known that support [unencrypted HTTP/2](https://http2.github.io/faq/#does-http2-require-encryption), the use of {@link createSecureServer***REMOVED*** is necessary when
     * communicating
     ...
     * @param listener Will be registered as a one-time listener of the {@link 'connect'***REMOVED*** event.
     */
     ...
     * @param options Any `{@link createServer***REMOVED***` options can be provided.
     * @since v20.12.0
     */
