(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["SockJS"] = factory();
***REMOVED***)((typeof self !== 'undefined' ? self : this), function() {
...
***REMOVED*** else {
  ...
  module.exports = function inherits(ctor, superCtor) {
    if (superCtor) {
      ctor.super_ = superCtor;
      var TempCtor = function TempCtor() {***REMOVED***;
 ...
 * @throws {Error***REMOVED*** throw an error if val is not a non-empty string or a number
...
module.exports = function (val, options) {
  ...
  if (type === 'string' && val.length > 0) {
    return parse(val);
  ***REMOVED*** else if (type === 'number' && isFinite(val)) {
 ...
 * @param {Number|String***REMOVED*** port Port number we need to check
 * @param {String***REMOVED*** protocol Protocol we need to check against.
 * @returns {Boolean***REMOVED*** Is it a default port for the given protocol
 * @api private
 */
...
Event.prototype.initEvent = function (eventType, canBubble, cancelable) {
  ...
  return this;
***REMOVED***;
Event.prototype.stopPropagation = function () {***REMOVED***;
Event.prototype.preventDefault = function () {***REMOVED***;
...
var debug = function debug() {***REMOVED***;
if (true) {
...
function SockJS(url, protocols, options) {
  ...
  ***REMOVED***
  ...
  this._transportOptions = options.transportOptions || {***REMOVED***;
  this._timeout = options.timeout || 0;
  var sessionId = options.sessionId || 8;
  if (typeof sessionId === 'function') {
    this._generateSessionId = sessionId;
  ***REMOVED*** else if (typeof sessionId === 'number') {
  ...
  ***REMOVED*** else if (parsedUrl.hash) {
    throw new SyntaxError('The URL must not contain a fragment');
  ***REMOVED*** else if (parsedUrl.protocol !== 'http:' && parsedUrl.protocol !== 'https:') {
  ...
  ***REMOVED***
  ...
  if (!protocols) {
    protocols = [];
  ***REMOVED*** else if (!Array.isArray(protocols)) {
    protocols = [protocols];
  ***REMOVED***
...
defineProperties(FunctionPrototype, {
  bind: function bind(that) {
    ...
    ***REMOVED***
    ...
    var bound = Function('binder', 'return function (' + boundArgs.join(',') + '){ return binder.apply(this, arguments); ***REMOVED***')(binder);
    if (target.prototype) {
...
defineProperties(ArrayPrototype, {
  forEach: function forEach(fun /*, thisp*/) {
    ...
    ***REMOVED***
  ***REMOVED***
***REMOVED***, !properlyBoxesContext(ArrayPrototype.forEach));
...
if ('ab'.split(/(?:ab)*/).length !== 2 || '.'.split(/(.?)(.?)/).length !== 4 || 'tesst'.split(/(s)*/)[1] === 't' || 'test'.split(/(?:)/, -1).length !== 4 || ''.split(/.?/).length || '.'.split(/()()/).length > 1) {
  ...
  ***REMOVED***)();
  ...
  // elements.
  // "0".split(undefined, 0) -> []
***REMOVED*** else if ('0'.split(void 0, 0).length) {
...
AbstractXHRObject.prototype._cleanup = function (abort) {
  ...
  ***REMOVED***
  ...
  this.xhr.onreadystatechange = function () {***REMOVED***;
  ...
  ***REMOVED***
  ...
  IframeWrapTransport.enabled = function (url, info) {
    if (!__webpack_require__.g.document) {
      return false;
    ***REMOVED***
    var iframeInfo = objectUtils.extend({***REMOVED***, info);
...
JsonpReceiver.prototype._scriptError = function () {
  ...
  ***REMOVED***
  this.errorTimer = setTimeout(function () {
    ...
    ***REMOVED***
  ***REMOVED***, JsonpReceiver.scriptErrorTimeout);
***REMOVED***;
  ...
  ***REMOVED***;
  ...
  if (typeof script.async === 'undefined' && __webpack_require__.g.document.attachEvent) {
    ...
    ***REMOVED*** else {
      ...
      script2.text = "try{var a = document.getElementById('" + script.id + "'); if(a)a.onerror();***REMOVED***catch(x){***REMOVED***;";
...
function XHRFake( /* method, url, payload, opts */
  ...
  this.to = setTimeout(function () {
    self.emit('finish', 200, '{***REMOVED***');
  ***REMOVED***, XHRFake.timeout);
***REMOVED***
...
module.exports = {
  attachEvent: function attachEvent(event, listener) {
    ...
    ***REMOVED*** else if (__webpack_require__.g.document && __webpack_require__.g.attachEvent) {
      // IE quirks.
  ...
  ***REMOVED***,
  detachEvent: function detachEvent(event, listener) {
    ...
    ***REMOVED*** else if (__webpack_require__.g.document && __webpack_require__.g.detachEvent) {
...
module.exports = {
  ...
  polluteGlobalNamespace: function polluteGlobalNamespace() {
    if (!(module.exports.WPrefix in __webpack_require__.g)) {
      __webpack_require__.g[module.exports.WPrefix] = {***REMOVED***;
    ***REMOVED***
  ***REMOVED***,
...
['log', 'debug', 'warn'].forEach(function (level) {
  ...
  ***REMOVED*** : level === 'log' ? function () {***REMOVED*** : logObject.log;
***REMOVED***);
    ...
    filterToEnabled: function filterToEnabled(transportsWhitelist, info) {
      ...
      ***REMOVED***;
      if (!transportsWhitelist) {
        transportsWhitelist = [];
      ***REMOVED*** else if (typeof transportsWhitelist === 'string') {
...
module.exports = {
  ...
  ***REMOVED***,
  isLoopbackAddr: function isLoopbackAddr(addr) {
    return /^127\.([0-9]{1,3***REMOVED***)\.([0-9]{1,3***REMOVED***)\.([0-9]{1,3***REMOVED***)$/i.test(addr) || /^\[::1\]$/.test(addr);
  ***REMOVED***
***REMOVED***;
 ...
 * Save `namespaces`.
 *
 * @param {String***REMOVED*** namespaces
 * @api private
 */
 ...
 * Load `namespaces`.
 *
 * @return {String***REMOVED*** returns the previously persisted debug modes
 * @api private
 */
...
function setup(env) {
  ...
  */
  ...
  createDebug.formatters = {***REMOVED***;
  /**
  * Selects a color for a debug namespace
  * @param {String***REMOVED*** namespace The namespace string for the for the debug instance to be colored
  * @return {Number|String***REMOVED*** An ANSI color code for the given namespace
  * @api private
  */
...
function lolcation(loc) {
  var globalVar;
  if (typeof window !== 'undefined') globalVar = window;else if (typeof __webpack_require__.g !== 'undefined') globalVar = __webpack_require__.g;else if (typeof self !== 'undefined') globalVar = self;else globalVar = {***REMOVED***;
...
function toString(stringify) {
  ...
  ***REMOVED*** else if (url.password) {
    result += ':' + url.password;
    result += '@';
  ***REMOVED*** else if (url.protocol !== 'file:' && isSpecial(url.protocol) && !host && url.pathname !== '/') {
    //
...
/******/ 				function() { return module['default']; ***REMOVED*** :
/******/ 				function() { return module; ***REMOVED***;
...
/* harmony export */   "default": function() { return /* reexport default from dynamic */ sockjs_client__WEBPACK_IMPORTED_MODULE_0___default.a; ***REMOVED***
