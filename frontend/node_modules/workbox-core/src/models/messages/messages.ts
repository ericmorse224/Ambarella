...
export const messages: MessageMap = {
  'invalid-value': ({paramName, validValueDescription, value***REMOVED***) => {
    ...
    ***REMOVED***
    return (
      `The '${paramName***REMOVED***' parameter was given a value with an ` +
  ...
  ***REMOVED***,
  ...
  'not-an-array': ({moduleName, className, funcName, paramName***REMOVED***) => {
    ...
    ***REMOVED***
    return (
      `The parameter '${paramName***REMOVED***' passed into ` +
  ...
  ***REMOVED***) => {
    ...
    ***REMOVED***
    return (
      `${moduleName***REMOVED***.${className***REMOVED***.${funcName***REMOVED***() expected the ` +
  ...
  ***REMOVED***,
  ...
  'add-to-cache-list-unexpected-type': ({entry***REMOVED***) => {
    return (
      ...
      `'${JSON.stringify(
        entry,
      )***REMOVED***' isn't supported. You must supply an array of ` +
  ...
  ***REMOVED***,
  ...
  'duplicate-queue-name': ({name***REMOVED***) => {
    return (
      `The Queue name '${name***REMOVED***' is already being used. ` +
  ...
  ***REMOVED***,
  ...
  'expired-test-without-max-age': ({methodName, paramName***REMOVED***) => {
    return (
      `The '${methodName***REMOVED***()' method can only be used when the ` +
  ...
  ***REMOVED***,
  ...
  'unsupported-route-type': ({moduleName, className, funcName, paramName***REMOVED***) => {
    return (
      `The supplied '${paramName***REMOVED***' parameter was an unsupported type. ` +
  ...
  ***REMOVED***) => {
    return (
      `The supplied '${paramName***REMOVED***' parameter must be an array of ` +
  ...
  ***REMOVED***,
  ...
  'invalid-string': ({moduleName, funcName, paramName***REMOVED***) => {
    ...
    ***REMOVED***
    return (
      `When using strings, the '${paramName***REMOVED***' parameter must start with ` +
  ...
  ***REMOVED***,
  ...
  'range-not-satisfiable': ({size, start, end***REMOVED***) => {
    return (
      `The start (${start***REMOVED***) and end (${end***REMOVED***) values in the Range are ` +
  ...
  ***REMOVED***,
  ...
  'attempt-to-cache-non-get-request': ({url, method***REMOVED***) => {
    return (
      `Unable to cache '${url***REMOVED***' because it is a '${method***REMOVED***' request and ` +
  ...
  ***REMOVED***,
  ...
  'cache-put-with-no-response': ({url***REMOVED***) => {
    return (
      `There was an attempt to cache '${url***REMOVED***' but the response was not ` +
      `defined.`
    );
  ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  'bad-precaching-response': ({url, status***REMOVED***) => {
    return (
      `The precaching request for '${url***REMOVED***' failed` +
  ...
  ***REMOVED***,
  ...
  'non-precached-url': ({url***REMOVED***) => {
    return (
      `createHandlerBoundToURL('${url***REMOVED***') was called, but that URL is ` +
  ...
  ***REMOVED***,
  ...
  'opaque-streams-source': ({type***REMOVED***) => {
    ...
    if (type === 'opaqueredirect') {
      return (
        `${message***REMOVED*** Please do not use a navigation request that results ` +
