...
var defs = {***REMOVED***;
var defFiles = glob.sync('./dot/**/*.def', { cwd: defsRootPath ***REMOVED***);
...
var files = glob.sync('./dot/**/*.jst', { cwd: filesRootPath ***REMOVED***);

var dotjsPath = path.join(filesRootPath, './dotjs');
try { fs.mkdirSync(dotjsPath); ***REMOVED*** catch(e) {***REMOVED***
...
files.forEach(function (f) {
  ...
  code = "'use strict';\nmodule.exports = " + code;
  code = beautify(code, { indent_size: 2 ***REMOVED***) + '\n';
