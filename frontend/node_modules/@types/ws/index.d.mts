...
> extends EventEmitter {
    ...
    removeListener(event: string | symbol, listener: (...args: any[]) => void): this;
***REMOVED***
export { type Server ***REMOVED***;

export const WebSocketServer: typeof Server;
export interface WebSocketServer extends Server {***REMOVED*** // eslint-disable-line @typescript-eslint/no-empty-interface

// WebSocket stream
export function createWebSocketStream(websocket: WebSocket, options?: DuplexOptions): Duplex;

export default WebSocket;
export { WebSocket ***REMOVED***;
