...
async function requireOrImportModule(
  ...
  if (!(0, _path().isAbsolute)(filePath) && filePath[0] === '.') {
    throw new Error(
      `Jest: requireOrImportModule path must be absolute, was "${filePath***REMOVED***"`
    );
  ***REMOVED***
      ...
      try {
        ...
        ***REMOVED***
        ...
        if (!importedModule.default) {
          throw new Error(
            `Jest: Failed to load ESM at ${filePath***REMOVED*** - did you use a default export?`
          );
        ***REMOVED***

        return importedModule.default;
      ***REMOVED*** catch (innerError) {
        if (innerError.message === 'Not supported') {
          throw new Error(
            `Jest: Your version of Node does not support dynamic import - please enable it or use a .cjs file extension for file ${filePath***REMOVED***`
          );
        ***REMOVED***
