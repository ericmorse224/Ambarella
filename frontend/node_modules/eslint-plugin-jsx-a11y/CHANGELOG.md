...
- 0f6a8af [fix] More easier `plugin:jsx-a11y/{recommended,strict***REMOVED***` configs
...
- 46e9abd [fix] Handle the type={truthy***REMOVED*** case in jsx
...
0.4.3 / 2016-03-29
==================
- [fix] Handle LogicalExpression attribute types when extracting values. LogicalExpressions are of form `<Component prop={foo || "foobar"***REMOVED*** />`
