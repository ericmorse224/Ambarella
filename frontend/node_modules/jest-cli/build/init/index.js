...
async function init(rootDir = (0, _jestUtil().tryRealpath)(process.cwd())) {
  ...
  if (hasJestProperty || existingJestConfigExt) {
    ...
    ***REMOVED***);
    ...
    if (!result.continue) {
      ...
      return;
    ***REMOVED***
  ***REMOVED*** // Add test script installation only if needed
  ...
  ***REMOVED*** // Start the init process
  ...
  ***REMOVED***);
  ...
  if (promptAborted) {
    ...
    console.log('Aborting...');
    return;
  ***REMOVED*** // Determine if Jest should use JS or TS for the config file
  ...
  if (shouldModifyScripts || hasJestProperty) {
    ...
    ***REMOVED***);
    ...
    console.log('');
    console.log(
      `✏️  Modified ${_chalk().default.cyan(projectPackageJsonPath)***REMOVED***`
    );
  ***REMOVED***
  ...
  console.log('');
  console.log(
    `📝  Configuration file created at ${_chalk().default.cyan(jestConfigPath)***REMOVED***`
  );
***REMOVED***
