...
```js
// ESM
import {parse, stringify, toJSON, fromJSON***REMOVED*** from 'flatted';

// CJS
const {parse, stringify, toJSON, fromJSON***REMOVED*** = require('flatted');

const a = [{***REMOVED***];
a[0].a = a;
a.push(a);

stringify(a); // [["1","0"],{"a":"0"***REMOVED***]
```
...
```js
import {toJSON, fromJSON***REMOVED*** from 'flatted';
...
```js
// logic example
var a = [{one: 1***REMOVED***, {two: '2'***REMOVED***];
a[0].a = a;
// a is the main object, will be at index '0'
// {one: 1***REMOVED*** is the second object, index '1'
// {two: '2'***REMOVED*** the third, in '2', and it has a string
// which will be found at index '3'

Flatted.stringify(a);
// [["1","2"],{"one":1,"a":"0"***REMOVED***,{"two":"3"***REMOVED***,"2"]
// a[one,two]    {one: 1, a***REMOVED***    {two: '2'***REMOVED***  '2'
```
