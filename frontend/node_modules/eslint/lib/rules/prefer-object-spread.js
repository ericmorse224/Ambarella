...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            useSpreadMessage: "Use an object spread instead of `Object.assign` eg: `{ ...foo ***REMOVED***`.",
            useLiteralMessage: "Use an object literal instead of `Object.assign`. eg: `{ foo: bar ***REMOVED***`."
        ***REMOVED***
    ***REMOVED***,
                ...
                ***REMOVED***;
                ...
                for (const { node ***REMOVED*** of tracker.iterateGlobalReferences(trackMap)) {
                    if (
                        ...
                        context.report({ node, messageId, fix ***REMOVED***);
                    ***REMOVED***
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***;
