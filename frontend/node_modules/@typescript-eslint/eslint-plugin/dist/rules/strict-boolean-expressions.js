        ...
        schema: [
            {
                type: 'object',
                properties: {
                    allowString: { type: 'boolean' ***REMOVED***,
                    allowNumber: { type: 'boolean' ***REMOVED***,
                    allowNullableObject: { type: 'boolean' ***REMOVED***,
                    allowNullableBoolean: { type: 'boolean' ***REMOVED***,
                    allowNullableString: { type: 'boolean' ***REMOVED***,
                    allowNullableNumber: { type: 'boolean' ***REMOVED***,
                    allowNullableEnum: { type: 'boolean' ***REMOVED***,
                    allowAny: { type: 'boolean' ***REMOVED***,
        ...
        function checkNode(node) {
            ...
            ***REMOVED***
            ...
            if (is('nullish')) {
                ...
                context.report({ node, messageId: 'conditionErrorNullish' ***REMOVED***);
                return;
            ***REMOVED***
                            ...
                            suggest: [
                                {
                                    ...
                                    fix: util.getWrappingFixer({
                                        ...
                                        node: node.parent,
                                        innerNode: node,
                                        wrap: code => `${code***REMOVED***.length === 0`,
                                    ***REMOVED***),
                                ***REMOVED***,
                                {
                                ...
                                ***REMOVED***,
                                {
                                    ...
                                    fix: util.getWrappingFixer({
                                        ...
                                        node: node.parent,
                                        innerNode: node,
                                        wrap: code => `!Boolean(${code***REMOVED***)`,
                                    ***REMOVED***),
                                ***REMOVED***,
                            ],
                        ***REMOVED***);
                                ...
                                ***REMOVED***,
                                {
                                    ...
                                    fix: util.getWrappingFixer({
                                        ...
                                        node: node.parent,
                                        innerNode: node,
                                        wrap: code => `Number.isNaN(${code***REMOVED***)`,
                                    ***REMOVED***),
                                ***REMOVED***,
                                {
                                    messageId: 'conditionFixCastBoolean',
            ...
            ***REMOVED***
            ...
            if (is('object')) {
                ...
                context.report({ node, messageId: 'conditionErrorObject' ***REMOVED***);
                return;
            ***REMOVED***
            // nullable object
            ...
            ***REMOVED***
            // other
            context.report({ node, messageId: 'conditionErrorOther' ***REMOVED***);
        ***REMOVED***
        /**
