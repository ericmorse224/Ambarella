...
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; ***REMOVED***)), t.push.apply(t, o); ***REMOVED*** return t; ***REMOVED***
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {***REMOVED***; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); ***REMOVED***) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); ***REMOVED***); ***REMOVED*** return e; ***REMOVED***
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 ***REMOVED***) : e[r] = t, e; ***REMOVED***
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; ***REMOVED***
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); ***REMOVED*** return ("string" === r ? String : Number)(t); ***REMOVED***
...
var jsxA11y = {
  meta: {
    ...
    version
  ***REMOVED***,
  rules: _objectSpread({***REMOVED***, allRules)
***REMOVED***;

/**
 * Given a ruleset and optionally a flat config name, generate a config.
 * @param {object***REMOVED*** rules - ruleset for this config
 * @param {string***REMOVED*** flatConfigName - name for the config if flat
 * @returns Config for this set of rules.
 */
var createConfig = function createConfig(rules, flatConfigName) {
  return _objectSpread(_objectSpread({***REMOVED***, flatConfigName ? _objectSpread(_objectSpread({***REMOVED***, flatConfigBase), {***REMOVED***, {
    name: "jsx-a11y/".concat(flatConfigName),
    plugins: {
      'jsx-a11y': jsxA11y
    ***REMOVED***
  ***REMOVED***) : _objectSpread(_objectSpread({***REMOVED***, legacyConfigBase), {***REMOVED***, {
    plugins: ['jsx-a11y']
  ***REMOVED***)), {***REMOVED***, {
    rules: _objectSpread({***REMOVED***, rules)
  ***REMOVED***);
***REMOVED***;
...
***REMOVED***;
module.exports = _objectSpread(_objectSpread({***REMOVED***, jsxA11y), {***REMOVED***, {
  configs,
  flatConfigs
***REMOVED***);