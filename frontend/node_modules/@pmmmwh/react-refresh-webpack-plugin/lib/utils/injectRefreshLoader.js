...
/**
 * @typedef {Object***REMOVED*** InjectLoaderOptions
 * @property {MatchObject***REMOVED*** match A function to include/exclude files to be processed.
 * @property {import('../../loader/types').ReactRefreshLoaderOptions***REMOVED*** [options] Options passed to the loader.
 */
 ...
 * @param {****REMOVED*** moduleData Module factory creation data.
 * @param {InjectLoaderOptions***REMOVED*** injectOptions Options to alter how the loader is injected.
 * @returns {****REMOVED*** The injected module factory creation data.
 */
function injectRefreshLoader(moduleData, injectOptions) {
  const { match, options ***REMOVED*** = injectOptions;
  ...
  if (moduleData.loaders.find(({ loader ***REMOVED***) => loader === resolvedLoader)) return moduleData;
