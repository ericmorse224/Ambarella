...
const countCommonItemsF = (aIndex, aEnd, bIndex, bEnd, isCommon) => {
  ...
  ***REMOVED***
  ...
  return nCommon;
***REMOVED***; // Return the number of common items that precede in reverse direction.
...
const countCommonItemsR = (aStart, aIndex, bStart, bIndex, isCommon) => {
  ...
  ***REMOVED***
  ...
  return nCommon;
***REMOVED***; // A simple function to extend forward paths from (d - 1) to d changes
...
const extendPathsF = (
  ...
  for (iF += 1, kF += 2; iF <= nF; iF += 1, kF += 2) {
    ...
    ***REMOVED*** else {
      ...
      if (aEnd <= aFirst) {
        ...
        return iF - 1;
      ***REMOVED***
    ***REMOVED*** // To get last point of path segment, move along diagonal of common items.
  ...
  ***REMOVED***
  ...
  return iMaxF;
***REMOVED***; // A simple function to extend reverse paths from (d - 1) to d changes
...
const extendPathsR = (
  ...
  ***REMOVED***
  ...
  return iMaxR;
***REMOVED***; // A complete function to extend forward paths from (d - 1) to d changes.
...
const extendOverlappablePathsF = (
  ...
  ***REMOVED***
  ...
  return false;
***REMOVED***; // A complete function to extend reverse paths from (d - 1) to d changes.
...
const extendOverlappablePathsR = (
  ...
  ***REMOVED***
  ...
  return false;
***REMOVED***; // Given index intervals and input function to compare items at indexes,
...
const divide = (
  ...
  ***REMOVED***
  ...
  throw new Error(
    `${pkg***REMOVED***: no overlap aStart=${aStart***REMOVED*** aEnd=${aEnd***REMOVED*** bStart=${bStart***REMOVED*** bEnd=${bEnd***REMOVED***`
  );
***REMOVED***; // Given index intervals and input function to compare items at indexes,
...
const findSubsequences = (
  ...
  if (bEnd - bStart < aEnd - aStart) {
    ...
    if (transposed && callbacks.length === 1) {
      ...
      const {foundSubsequence, isCommon***REMOVED*** = callbacks[0];
      callbacks[1] = {
  ...
  ***REMOVED***
  ...
  const {foundSubsequence, isCommon***REMOVED*** = callbacks[transposed ? 1 : 0]; // Divide the index intervals at the middle change.
  ...
  const {
    ...
    aStartFollowing,
    bStartFollowing
  ***REMOVED*** = division; // Unless either index interval is empty, they might contain common items.
  ...
  ***REMOVED*** // Return common subsequences that are adjacent to the middle change.
  ...
  ***REMOVED*** // Unless either index interval is empty, they might contain common items.
...
const validateLength = (name, arg) => {
  if (typeof arg !== 'number') {
    throw new TypeError(`${pkg***REMOVED***: ${name***REMOVED*** typeof ${typeof arg***REMOVED*** is not a number`);
  ***REMOVED***

  if (!Number.isSafeInteger(arg)) {
    throw new RangeError(`${pkg***REMOVED***: ${name***REMOVED*** value ${arg***REMOVED*** is not a safe integer`);
  ***REMOVED***

  if (arg < 0) {
    throw new RangeError(`${pkg***REMOVED***: ${name***REMOVED*** value ${arg***REMOVED*** is a negative integer`);
  ***REMOVED***
***REMOVED***;
...
const validateCallback = (name, arg) => {
  ...
  if (type !== 'function') {
    throw new TypeError(`${pkg***REMOVED***: ${name***REMOVED*** typeof ${type***REMOVED*** is not a function`);
  ***REMOVED***
***REMOVED***; // Compare items in two sequences to find a longest common subsequence.
...
function diffSequence(aLength, bLength, isCommon, foundSubsequence) {
  ...
  ***REMOVED*** // Unless both sequences consist of common items only,
  ...
  if (aLength !== nCommonF || bLength !== nCommonF) {
    ...
    if (aLength !== nCommonFR && bLength !== nCommonFR) {
      ...
      ***REMOVED***; // Find and return common subsequences in the trimmed index intervals.
