...
/**
 * @import { SourceLocation, SourceRange ***REMOVED*** from "@eslint/core";
 */
...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		...
		const BLANK_CLASS = "[ \t\u00a0\u2000-\u200b\u3000]",
			SKIP_BLANK = `^${BLANK_CLASS***REMOVED****$`,
			NONBLANK = `${BLANK_CLASS***REMOVED***+$`;
		 ...
		 * @param {SourceLocation***REMOVED*** location range information
		 * @param {SourceRange***REMOVED*** fixRange Range based on the whole program
		...
		***REMOVED***
		 ...
		 * @returns {number[]***REMOVED*** An array of line numbers containing comments.
		 */
