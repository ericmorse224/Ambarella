...
class Receiver extends Writable {
   ...
   * @param {String***REMOVED*** [options.binaryType=nodebuffer] The type for binary data
   * @param {Object***REMOVED*** [options.extensions] An object containing the negotiated
   *     extensions
   * @param {Boolean***REMOVED*** [options.isServer=false] Specifies whether to operate in
   *     client or server mode
   * @param {Number***REMOVED*** [options.maxPayload=0] The maximum allowed message length
  ...
  constructor(options = {***REMOVED***) {
    ...
    this._extensions = options.extensions || {***REMOVED***;
  ...
  dataMessage(cb) {
    ...
    ***REMOVED***
    ...
    if (this._opcode === 2) {
      ...
      ***REMOVED*** else if (this._binaryType === 'blob') {
