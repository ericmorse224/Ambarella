...
import { setGlobalDispatcher, getGlobalDispatcher ***REMOVED*** from './global-dispatcher'
import { setGlobalOrigin, getGlobalOrigin ***REMOVED*** from './global-origin'
import Pool from'./pool'
import { RedirectHandler, DecoratorHandler ***REMOVED*** from './handlers'
...
import { request, pipeline, stream, connect, upgrade ***REMOVED*** from './api'
...
export * from './cache'
export { Interceptable ***REMOVED*** from './mock-interceptor'
