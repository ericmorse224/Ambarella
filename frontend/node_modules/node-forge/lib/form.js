...
/* Form API */
var form = module.exports = forge.form = forge.form || {***REMOVED***;
...
var _addField = function(obj, names, value, dict) {
  ...
  for(var i = 0; i < names.length; ++i) {
    ...
    if(name.indexOf('[') !== -1 && name.indexOf(']') === -1 &&
      ...
      do {
        name += '.' + names[++i];
      ***REMOVED*** while(i < names.length - 1 && names[i].indexOf(']') === -1);
    ***REMOVED***
    tmp.push(name);
  ***REMOVED***
  names = tmp;
    ...
    ***REMOVED***
    ...
    if(obj[name]) {
      ...
      ***REMOVED*** else {
        ...
        obj = obj[name];
      ***REMOVED***
    ***REMOVED*** else if(n == names.length - 1) {
