 ...
 * @param {string***REMOVED*** content Css content
 * @param {object***REMOVED*** sourceMap The source-map
 * @returns {string|String***REMOVED***
 */
function resolveUrlLoader(content, sourceMap) {
  ...
  ***REMOVED*** else if (options.join.length !== 2) {
    return handleAsError(
      'loader misconfiguration',
  ...
  ***REMOVED*** else if (joinProper.length !== 1) {
    return handleAsError(
      'loader misconfiguration',
  ...
  ***REMOVED***
  ...
  if (typeof options.root === 'string') {
    ...
    ***REMOVED***
  ***REMOVED*** else if (options.root !== false) {
    handleAsWarning(
      'loader misconfiguration',
  ...
  ***REMOVED***
  ...
  if (sourceMap) {
    ...
    ***REMOVED***
    ...
    try {
      absSourceMap = adjustSourceMap(loader, {format: 'absolute'***REMOVED***, sourceMap);
    ***REMOVED***
    catch (exception) {
      return handleAsError(
        'source-map error',
  ...
  ***REMOVED***
   ...
   * @returns {string***REMOVED*** The original CSS content
   */
  ...
  ***REMOVED***
   ...
   * @param {string***REMOVED*** label Summary of the error
   * @param {string|Error***REMOVED*** [exception] Optional extended error details
   * @returns {string***REMOVED*** The original CSS content
   */
