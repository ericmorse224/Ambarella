...
function* run(config, code, ast) {
  ...
  ***REMOVED*** catch (e) {
    var _opts$filename;
    e.message = `${(_opts$filename = opts.filename) != null ? _opts$filename : "unknown file"***REMOVED***: ${e.message***REMOVED***`;
    if (!e.code) {
  ...
  try {
    if (opts.code !== false) {
      ({
        outputCode,
        outputMap
      ***REMOVED*** = (0, _generate.default)(config.passes, file));
    ***REMOVED***
  ***REMOVED*** catch (e) {
    var _opts$filename2;
    e.message = `${(_opts$filename2 = opts.filename) != null ? _opts$filename2 : "unknown file"***REMOVED***: ${e.message***REMOVED***`;
    if (!e.code) {
