...
export interface TInteger extends TSchema, NumericOptions {
    ...
    type: 'integer';
***REMOVED***
export declare type IntersectReduce<I extends unknown, T extends readonly any[]> = T extends [infer A, ...infer B] ? IntersectReduce<I & A, B> : I extends object ? I : {***REMOVED***;
...
export declare type IntersectProperties<T extends readonly TObject[]> = {
    [K in keyof T]: T[K] extends TObject<infer P> ? P : {***REMOVED***;
***REMOVED***;
...
***REMOVED*** extends infer R ? UnionToTuple<R[keyof R]> : never;
