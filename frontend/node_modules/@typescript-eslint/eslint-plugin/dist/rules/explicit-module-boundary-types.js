    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            ...
            missingArgType: "Argument '{{name***REMOVED******REMOVED***' should be typed.",
            missingArgTypeUnnamed: '{{type***REMOVED******REMOVED*** argument should be typed.',
            anyTypedArg: "Argument '{{name***REMOVED******REMOVED***' should be typed with a non-any type.",
            anyTypedArgUnnamed: '{{type***REMOVED******REMOVED*** argument should be typed with a non-any type.',
        ***REMOVED***,
        schema: [
            {
                type: 'object',
                ...
                function report(namedMessageId, unnamedMessageId) {
                    ...
                    ***REMOVED***
                        ...
                        context.report({
                            ...
                            data: { type: 'Array pattern' ***REMOVED***,
                        ***REMOVED***);
                    ***REMOVED***
                        ...
                        context.report({
                            node: param,
                            messageId: unnamedMessageId,
                            data: { type: 'Object pattern' ***REMOVED***,
                        ***REMOVED***);
                    ***REMOVED***
                        ...
                        if (param.argument.type === utils_1.AST_NODE_TYPES.Identifier) {
                            context.report({
                                node: param,
                                messageId: namedMessageId,
                                data: { name: param.argument.name ***REMOVED***,
                            ***REMOVED***);
                        ***REMOVED***
                        else {
                            context.report({
