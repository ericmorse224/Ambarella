	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			maxComment:
				"This line has a comment length of {{lineLength***REMOVED******REMOVED***. Maximum allowed is {{maxCommentLength***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {number***REMOVED*** tabWidth The width of each tab stop in spaces.
		 * @returns {number***REMOVED*** The computed line length.
		 * @private
		 */
		...
		***REMOVED***
		...
		const options = Object.assign({***REMOVED***, context.options.at(-1));
