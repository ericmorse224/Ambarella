...
Client.prototype.connect = function() {
  ...
  function makeSock(sockname) {
    ...
    self.bunser.on('value', function(obj) {
      ...
      ***REMOVED*** else if (self.currentCommand) {
  ...
  ***REMOVED***
  ...
  function spawnError(error) {
    ...
    ***REMOVED*** else if (error.code === 'ENOENT' || error.errno === 'ENOENT') {
...
Client.prototype.command = function(args, done) {
  done = done || function() {***REMOVED***;

  // Queue up the command
  this.commands.push({cmd: args, cb: done***REMOVED***);
