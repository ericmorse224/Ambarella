...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'Plugin'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
    ...
    item(index) {
      ...
      ***REMOVED***
      const args = [];
      {
        ...
        curArg = conversions["unsigned long"](curArg, { context: "Failed to execute 'item' on 'Plugin': parameter 1" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
  ...
  ***REMOVED***
  Object.defineProperties(Plugin.prototype, {
    ...
    namedItem: { enumerable: true ***REMOVED***,
    name: { enumerable: true ***REMOVED***,
    description: { enumerable: true ***REMOVED***,
    filename: { enumerable: true ***REMOVED***,
    length: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "Plugin", configurable: true ***REMOVED***,
