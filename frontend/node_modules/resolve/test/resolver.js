...
test('async foo', function (t) {
    ...
    resolve('./foo', { basedir: dir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'foo.js'));
        t.equal(pkg && pkg.name, 'resolve');
    ***REMOVED***);

    resolve('./foo.js', { basedir: dir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'foo.js'));
        t.equal(pkg && pkg.name, 'resolve');
    ***REMOVED***);

    resolve('./foo', { basedir: dir, 'package': { main: 'resolver' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'foo.js'));
        t.equal(pkg && pkg.main, 'resolver');
    ***REMOVED***);

    resolve('./foo.js', { basedir: dir, 'package': { main: 'resolver' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'foo.js'));
        t.equal(pkg.main, 'resolver');
    ***REMOVED***);

    resolve('./foo', { basedir: dir, filename: path.join(dir, 'baz.js') ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'foo.js'));
    ***REMOVED***);

    resolve('foo', { basedir: dir ***REMOVED***, function (err) {
        t.equal(err.message, "Cannot find module 'foo' from '" + path.resolve(dir) + "'");
        t.equal(err.code, 'MODULE_NOT_FOUND');
    ***REMOVED***);

    // Test that filename is reported as the "from" value when passed.
    resolve('foo', { basedir: dir, filename: path.join(dir, 'baz.js') ***REMOVED***, function (err) {
...
test('bar', function (t) {
    ...
    resolve('foo', { basedir: dir + '/bar' ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
    ...
    ***REMOVED***);
    ...
    resolve('foo', { basedir: dir + '/bar', 'package': { main: 'bar' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'bar/node_modules/foo/index.js'));
...
test('baz', function (t) {
    ...
    resolve('./baz', { basedir: dir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'baz/quux.js'));
        t.equal(pkg.main, 'quux.js');
    ***REMOVED***);

    resolve('./baz', { basedir: dir, 'package': { main: 'resolver' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'baz/quux.js'));
        t.equal(pkg.main, 'quux.js');
    ***REMOVED***);
...
test('biz', function (t) {
    ...
    resolve('./grux', { basedir: dir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'grux/index.js'));
        t.equal(pkg, undefined);
    ***REMOVED***);

    resolve('./grux', { basedir: dir, 'package': { main: 'biz' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'grux/index.js'));
        t.equal(pkg.main, 'biz');
    ***REMOVED***);

    resolve('./garply', { basedir: dir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'garply/lib/index.js'));
        t.equal(pkg.main, './lib');
    ***REMOVED***);

    resolve('./garply', { basedir: dir, 'package': { main: 'biz' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'garply/lib/index.js'));
        t.equal(pkg.main, './lib');
    ***REMOVED***);

    resolve('tiv', { basedir: dir + '/grux' ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'tiv/index.js'));
        t.equal(pkg, undefined);
    ***REMOVED***);

    resolve('tiv', { basedir: dir + '/grux', 'package': { main: 'grux' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'tiv/index.js'));
        t.equal(pkg.main, 'grux');
    ***REMOVED***);

    resolve('tiv', { basedir: dir + '/garply' ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'tiv/index.js'));
        t.equal(pkg, undefined);
    ***REMOVED***);

    resolve('tiv', { basedir: dir + '/garply', 'package': { main: './lib' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'tiv/index.js'));
        t.equal(pkg.main, './lib');
    ***REMOVED***);

    resolve('grux', { basedir: dir + '/tiv' ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'grux/index.js'));
        t.equal(pkg, undefined);
    ***REMOVED***);

    resolve('grux', { basedir: dir + '/tiv', 'package': { main: 'tiv' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'grux/index.js'));
        t.equal(pkg.main, 'tiv');
    ***REMOVED***);

    resolve('garply', { basedir: dir + '/tiv' ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'garply/lib/index.js'));
        t.equal(pkg.main, './lib');
    ***REMOVED***);

    resolve('garply', { basedir: dir + '/tiv', 'package': { main: 'tiv' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'garply/lib/index.js'));
        t.equal(pkg.main, './lib');
    ***REMOVED***);
...
test('quux', function (t) {
    ...
    resolve('./foo', { basedir: dir, 'package': { main: 'quux' ***REMOVED*** ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
...
test('cup', function (t) {
    ...
    resolve('./cup', { basedir: dir, extensions: ['.js', '.coffee'] ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'cup.coffee'));
    ***REMOVED***);

    resolve('./cup.coffee', { basedir: dir ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'cup.coffee'));
    ***REMOVED***);

    resolve('./cup', { basedir: dir, extensions: ['.js'] ***REMOVED***, function (err, res) {
        t.equal(err.message, "Cannot find module './cup' from '" + path.resolve(dir) + "'");
        t.equal(err.code, 'MODULE_NOT_FOUND');
    ***REMOVED***);

    // Test that filename is reported as the "from" value when passed.
    resolve('./cup', { basedir: dir, extensions: ['.js'], filename: path.join(dir, 'cupboard.js') ***REMOVED***, function (err, res) {
...
test('mug', function (t) {
    ...
    resolve('./mug', { basedir: dir ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'mug.js'));
    ***REMOVED***);

    resolve('./mug', { basedir: dir, extensions: ['.coffee', '.js'] ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, '/mug.coffee'));
    ***REMOVED***);

    resolve('./mug', { basedir: dir, extensions: ['.js', '.coffee'] ***REMOVED***, function (err, res) {
        t.equal(res, path.join(dir, '/mug.js'));
    ***REMOVED***);
***REMOVED***);
...
test('other path', function (t) {
    ...
    resolve('root', { basedir: dir, paths: [otherDir] ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(resolverDir, 'other_path/root.js'));
    ***REMOVED***);

    resolve('lib/other-lib', { basedir: dir, paths: [otherDir] ***REMOVED***, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, path.join(resolverDir, 'other_path/lib/other-lib.js'));
    ***REMOVED***);

    resolve('root', { basedir: dir ***REMOVED***, function (err, res) {
        t.equal(err.message, "Cannot find module 'root' from '" + path.resolve(dir) + "'");
        t.equal(err.code, 'MODULE_NOT_FOUND');
    ***REMOVED***);

    resolve('zzz', { basedir: dir, paths: [otherDir] ***REMOVED***, function (err, res) {
...
test('path iterator', function (t) {
    ...
    ***REMOVED***;
    ...
    resolve('baz', { packageIterator: exactIterator ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
...
test('incorrect main', function (t) {
    ...
    resolve('./incorrect_main', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'index.js'));
    ***REMOVED***);
***REMOVED***);
...
test('missing index', function (t) {
    ...
    var resolverDir = path.join(__dirname, 'resolver');
    resolve('./missing_index', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
...
test('missing main', function (t) {
    ...
    resolve('./missing_main', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
        t.equal(err && err.code, 'MODULE_NOT_FOUND', 'error has correct error code');
    ***REMOVED***);
***REMOVED***);
...
test('null main', function (t) {
    ...
    resolve('./null_main', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
        t.equal(err && err.code, 'MODULE_NOT_FOUND', 'error has correct error code');
    ***REMOVED***);
***REMOVED***);
...
test('main: false', function (t) {
    ...
    resolve('./false_main', { basedir: basedir ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(
            res,
...
test('#52 - incorrectly resolves module-paths like "./someFolder/" when there is a file of the same name', function (t) {
    ...
    resolve('./foo', { basedir: path.join(dir, 'same_names') ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
...
test('#211 - incorrectly resolves module-paths like "." when from inside a folder with a sibling file of the same name', function (t) {
    ...
    resolve('./', { basedir: path.join(dir, 'same_names/foo') ***REMOVED***, function (err, res, pkg) {
        if (err) t.fail(err);
        t.equal(res, path.join(dir, 'same_names/foo/index.js'));
    ***REMOVED***);
...
test('not a directory', function (t) {
    t.plan(6);
    var path = './foo';
    resolve(path, { basedir: __filename ***REMOVED***, function (err, res, pkg) {
...
test('non-string "main" field in package.json', function (t) {
    ...
    var dir = path.join(__dirname, 'resolver');
    resolve('./invalid_main', { basedir: dir ***REMOVED***, function (err, res, pkg) {
...
test('absolute paths', function (t) {
    ...
    ***REMOVED***);
    resolve(__filename, { basedir: process.cwd() ***REMOVED***, function (err, res) {
        t.equal(
            res,
            __filename,
    ...
    ***REMOVED***);
    resolve(extensionless, { basedir: process.cwd() ***REMOVED***, function (err, res) {
        t.equal(
            res,
            __filename,
...
test('malformed package.json', { skip: !fs.existsSync(malformedDir) ***REMOVED***, function (t) {
    ...
    resolve('./index.js', { basedir: basedir ***REMOVED***, function (err, res, pkg) {
