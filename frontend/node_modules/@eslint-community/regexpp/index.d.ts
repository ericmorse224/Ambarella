...
declare module "@eslint-community/regexpp" {
  ...
  import { RegExpParser ***REMOVED*** from "@eslint-community/regexpp/parser";
  import { RegExpValidator ***REMOVED*** from "@eslint-community/regexpp/validator";
  import { RegExpVisitor ***REMOVED*** from "@eslint-community/regexpp/visitor";
  export { RegExpSyntaxError ***REMOVED*** from "@eslint-community/regexpp/regexp-syntax-error";
  export { AST, RegExpParser, RegExpValidator ***REMOVED***;
  /**
...
declare module "@eslint-community/regexpp/ast" {
  ...
  ***REMOVED***
  /**
   * The quantifier.
   * E.g. `a?`, `a*`, `a+`, `a{1,2***REMOVED***`, `a??`, `a*?`, `a+?`, `a{1,2***REMOVED***?`
   */
  ...
  ***REMOVED***
   ...
   *
   * In Unicode sets mode (`v` flag), {@link UnicodeSetsCharacterClass***REMOVED*** is used.
   */
  ...
  ***REMOVED***
   ...
   * E.g. `\p{ASCII***REMOVED***`, `\P{ASCII***REMOVED***`, `\p{Script=Hiragana***REMOVED***`
   */
  ...
  ***REMOVED***
  /** StringAlternative is only used for `\q{alt***REMOVED***`({@link ClassStringDisjunction***REMOVED***). */
...
declare module "@eslint-community/regexpp/parser" {
  import type {
    ...
    RegExpLiteral,
    Pattern,
  ***REMOVED*** from "@eslint-community/regexpp/ast";
  import type { EcmaVersion ***REMOVED*** from "@eslint-community/regexpp/ecma-versions";
...
declare module "@eslint-community/regexpp/regexp-syntax-error" {
  import type { RegExpValidatorSourceContext ***REMOVED*** from "@eslint-community/regexpp/validator";
