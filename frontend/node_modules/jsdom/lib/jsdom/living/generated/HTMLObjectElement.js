...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'HTMLObjectElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(HTMLObjectElement.prototype, {
    checkValidity: { enumerable: true ***REMOVED***,
    reportValidity: { enumerable: true ***REMOVED***,
    setCustomValidity: { enumerable: true ***REMOVED***,
    data: { enumerable: true ***REMOVED***,
    type: { enumerable: true ***REMOVED***,
    name: { enumerable: true ***REMOVED***,
    useMap: { enumerable: true ***REMOVED***,
    form: { enumerable: true ***REMOVED***,
    width: { enumerable: true ***REMOVED***,
    height: { enumerable: true ***REMOVED***,
    contentDocument: { enumerable: true ***REMOVED***,
    willValidate: { enumerable: true ***REMOVED***,
    validity: { enumerable: true ***REMOVED***,
    validationMessage: { enumerable: true ***REMOVED***,
    align: { enumerable: true ***REMOVED***,
    archive: { enumerable: true ***REMOVED***,
    code: { enumerable: true ***REMOVED***,
    declare: { enumerable: true ***REMOVED***,
    hspace: { enumerable: true ***REMOVED***,
    standby: { enumerable: true ***REMOVED***,
    vspace: { enumerable: true ***REMOVED***,
    codeBase: { enumerable: true ***REMOVED***,
    codeType: { enumerable: true ***REMOVED***,
    border: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "HTMLObjectElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
