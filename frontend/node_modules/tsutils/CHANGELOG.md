...
* `isBindableObjectDefinePropertyCall` returns true for statically analyzable forms of `Object.defineProperty(o, 'p', {value, writable***REMOVED***)`
...
* `collectVariableUsage`:
  ...
  * treat everything in a declaration file as exported if there is no explicit `export {***REMOVED***;`
...
* **still WIP**: `export {Foo as Bar***REMOVED***` inside ambient namespaces and modules
