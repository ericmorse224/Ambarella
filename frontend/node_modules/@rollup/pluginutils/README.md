...
```js
import { addExtension ***REMOVED*** from '@rollup/pluginutils';

export default function myPlugin(options = {***REMOVED***) {
  return {
    resolveId(code, id) {
...
```js
import { attachScopes ***REMOVED*** from '@rollup/pluginutils';
import { walk ***REMOVED*** from 'estree-walker';
...
```js
import { dataToEsm ***REMOVED*** from '@rollup/pluginutils';
...
Outputs the string ES module source:
  ...
  export default { custom, to ***REMOVED***;
*/
```
...
```js
import { extractAssignedNames ***REMOVED*** from '@rollup/pluginutils';
import { walk ***REMOVED*** from 'estree-walker';
      ...
      walk(ast, {
        enter(node) {
          if (node.type === 'VariableDeclarator') {
            ...
            // e.g. for `const {x, y: z***REMOVED*** = ... => declaredNames = ['x', 'z']
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***);
    ***REMOVED***
...
```js
import { makeLegalIdentifier ***REMOVED*** from '@rollup/pluginutils';
