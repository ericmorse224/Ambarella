...
var stackFrame = new StackFrame({
    ...
    evalOrigin: new StackFrame({functionName: 'withinEval', lineNumber: 2, columnNumber: 43***REMOVED***)
***REMOVED***);
...
stackFrame.evalOrigin                         // => StackFrame({functionName: 'withinEval', lineNumber: ...***REMOVED***)
stackFrame.setEvalOrigin({functionName: 'evalFn', fileName: 'anonymous'***REMOVED***)
