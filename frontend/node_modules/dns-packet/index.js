...
const name = exports.name = {***REMOVED***

name.encode = function (str, buf, offset, { mail = false ***REMOVED*** = {***REMOVED***) {
...
name.decode = function (buf, offset, { mail = false ***REMOVED*** = {***REMOVED***) {
  if (!offset) offset = 0
...
const runknown = exports.unknown = {***REMOVED***
...
const rsoa = exports.soa = {***REMOVED***
...
rsoa.encode = function (data, buf, offset) {
  ...
  name.encode(data.rname, buf, offset, { mail: true ***REMOVED***)
  offset += name.encode.bytes
...
rsoa.decode = function (buf, offset) {
  ...
  data.rname = name.decode(buf, offset, { mail: true ***REMOVED***)
  offset += name.decode.bytes
...
const rtxt = exports.txt = {***REMOVED***
...
const rnull = exports.null = {***REMOVED***
...
const rhinfo = exports.hinfo = {***REMOVED***
...
const rptr = exports.ptr = {***REMOVED***
...
const rsrv = exports.srv = {***REMOVED***
...
const rcaa = exports.caa = {***REMOVED***
...
const raaaa = exports.aaaa = {***REMOVED***
...
const roption = exports.option = {***REMOVED***
    ...
    switch (code) {
      ...
      case 14: // KEY-TAG
        ...
        ***REMOVED***
        break
      default:
        throw new Error(`Unknown roption code: ${option.code***REMOVED***`)
    ***REMOVED***
  ***REMOVED***
...
const ropt = exports.opt = {***REMOVED***
...
const rdnskey = exports.dnskey = {***REMOVED***
...
const rrrsig = exports.rrsig = {***REMOVED***
...
rrp.encode = function (data, buf, offset) {
  ...
  offset += 2 // Leave space for length
  name.encode(data.mbox || '.', buf, offset, { mail: true ***REMOVED***)
  offset += name.encode.bytes
...
rrp.decode = function (buf, offset) {
  ...
  const data = {***REMOVED***
  offset += 2
  data.mbox = name.decode(buf, offset, { mail: true ***REMOVED***) || '.'
  offset += name.decode.bytes
...
const rnsec = exports.nsec = {***REMOVED***
...
const rnsec3 = exports.nsec3 = {***REMOVED***
...
const rsshfp = exports.sshfp = {***REMOVED***
...
const rnaptr = exports.naptr = {***REMOVED***
...
const rtlsa = exports.tlsa = {***REMOVED***
...
const answer = exports.answer = {***REMOVED***
...
const question = exports.question = {***REMOVED***
