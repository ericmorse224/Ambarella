...
describe("tsconfig-loader", function () {
    it("should find tsconfig in cwd", function () {
        var result = (0, tsconfig_loader_1.tsConfigLoader)({
            cwd: "/foo/bar",
            getEnv: function (_) { return undefined; ***REMOVED***,
...
describe("walkForTsConfig", function () {
    it("should find tsconfig in starting directory", function () {
        ...
        var res = (0, tsconfig_loader_1.walkForTsConfig)((0, path_1.join)("/root", "dir1"), function (path) { return path === pathToTsconfig; ***REMOVED***);
    ...
    ***REMOVED***);
    it("should return undefined when reaching the top", function () {
        var res = (0, tsconfig_loader_1.walkForTsConfig)((0, path_1.join)("/root", "dir1", "kalle"), function () { return false; ***REMOVED***);
...
describe("loadConfig", function () {
    it("should load a config", function () {
        var config = { compilerOptions: { baseUrl: "hej" ***REMOVED*** ***REMOVED***;
        var res = (0, tsconfig_loader_1.loadTsconfig)("/root/dir1/tsconfig.json", function (path) { return path === "/root/dir1/tsconfig.json"; ***REMOVED***, function (_) { return JSON.stringify(config); ***REMOVED***);
        // assert.deepEqual(res, config);
        expect(res).toStrictEqual(config);
    ***REMOVED***);
    it("should load a config with comments", function () {
        var config = { compilerOptions: { baseUrl: "hej" ***REMOVED*** ***REMOVED***;
        var res = (0, tsconfig_loader_1.loadTsconfig)("/root/dir1/tsconfig.json", function (path) { return path === "/root/dir1/tsconfig.json"; ***REMOVED***, function (_) { return "{\n          // my comment\n          \"compilerOptions\": { \n            \"baseUrl\": \"hej\"\n          ***REMOVED***\n        ***REMOVED***"; ***REMOVED***);
        // assert.deepEqual(res, config);
        expect(res).toStrictEqual(config);
    ***REMOVED***);
    ...
    ***REMOVED***);
    it("should throw an error including the file path when encountering invalid JSON5", function () {
        expect(function () {
            return (0, tsconfig_loader_1.loadTsconfig)("/root/dir1/tsconfig.json", function (path) { return path === "/root/dir1/tsconfig.json"; ***REMOVED***, function (_) { return "{\n            \"compilerOptions\": {\n          ***REMOVED***"; ***REMOVED***);
        ***REMOVED***).toThrowError("/root/dir1/tsconfig.json is malformed JSON5: invalid end of input at 3:12");
    ***REMOVED***);
    it("should load a config with string extends and overwrite all options", function () {
        ...
        ***REMOVED***;
        ...
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "dir1", "tsconfig.json"), function (path) { return path === firstConfigPath || path === baseConfigPath; ***REMOVED***, function (path) {
    ...
    ***REMOVED***);
    it("should use baseUrl relative to location of extended tsconfig", function () {
        var firstConfig = { compilerOptions: { baseUrl: "." ***REMOVED*** ***REMOVED***;
        var firstConfigPath = (0, path_1.join)("/root", "first-config.json");
        var secondConfig = { extends: "../first-config.json" ***REMOVED***;
        var secondConfigPath = (0, path_1.join)("/root", "dir1", "second-config.json");
        var thirdConfig = { extends: "../second-config.json" ***REMOVED***;
        ...
        ***REMOVED***);
        ...
        expect(res).toEqual({
            extends: "../second-config.json",
            compilerOptions: { baseUrl: (0, path_1.join)("..", "..") ***REMOVED***,
        ***REMOVED***);
    ***REMOVED***);
    it("should load a config with array extends and overwrite all options", function () {
        ...
        ***REMOVED***;
        ...
        var baseConfig2 = { compilerOptions: { baseUrl: "." ***REMOVED*** ***REMOVED***;
    ...
    ***REMOVED***);
    it("should load a config with array extends without .json extension", function () {
        ...
        ***REMOVED***;
        ...
        var actualConfig = { extends: ["./base-config-1"] ***REMOVED***;
        var actualConfigPath = (0, path_1.join)("/root", "tsconfig.json");
        var res = (0, tsconfig_loader_1.loadTsconfig)((0, path_1.join)("/root", "tsconfig.json"), function (path) { return [baseConfigPath, actualConfigPath].indexOf(path) >= 0; ***REMOVED***, function (path) {
            if (path === baseConfigPath) {
                return JSON.stringify(baseConfig);
            ***REMOVED***
            if (path === actualConfigPath) {
