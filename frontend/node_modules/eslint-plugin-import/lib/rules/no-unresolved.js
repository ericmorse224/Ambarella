...
var _docsUrl = require('../docsUrl');var _docsUrl2 = _interopRequireDefault(_docsUrl);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED*** /**
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-unresolved') ***REMOVED***,


    schema: [
    (0, _moduleVisitor.makeOptionsSchema)({
      caseSensitive: { type: 'boolean', 'default': true ***REMOVED***,
      caseSensitiveStrict: { type: 'boolean', 'default': false ***REMOVED*** ***REMOVED***)] ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      function checkSourceValue(source, node) {
        ...
        ***REMOVED*** else if (caseSensitive || caseSensitiveStrict) {
