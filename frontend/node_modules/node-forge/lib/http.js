...
var http = module.exports = forge.http = forge.http || {***REMOVED***;
...
var _normalize = function(name) {
  return name.toLowerCase().replace(/(^.)|(-.)/g,
    function(a) {return a.toUpperCase();***REMOVED***);
***REMOVED***;
...
var _loadCookies = function(client) {
  if(client.persistCookies) {
    try {
      ...
      client.cookies = cookies || {***REMOVED***;
    ***REMOVED*** catch(ex) {
  ...
  for(var name in cookies) {
    ...
    for(var p in paths) {
      ...
      if(_hasCookieExpired(cookie)) {
        // store for clean up
        expired.push(cookie);
      ***REMOVED*** else if(request.path.indexOf(cookie.path) === 0) {
...
http.createClient = function(options) {
  ...
  ***REMOVED*** catch(e) {
    ...
    error.details = {url: options.url***REMOVED***;
    throw error;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  client.send = function(options) {
    ...
    ***REMOVED***
    ...
    opts.connected = options.connected || function() {***REMOVED***;
    opts.closed = options.close || function() {***REMOVED***;
    opts.headerReady = function(e) {
      ...
      ***REMOVED***
    ***REMOVED***;
    opts.bodyReady = options.bodyReady || function() {***REMOVED***;
    opts.error = options.error || function() {***REMOVED***;
    ...
    opts.request.abort = function() {
      ...
      opts.connected = function() {***REMOVED***;
      opts.closed = function() {***REMOVED***;
      opts.headerReady = function() {***REMOVED***;
      opts.bodyReady = function() {***REMOVED***;
      opts.error = function() {***REMOVED***;
    ***REMOVED***;
      ...
      ***REMOVED*** else {
        ...
        ***REMOVED***
        ...
        if(!(cookie.name in client.cookies)) {
          client.cookies[cookie.name] = {***REMOVED***;
        ***REMOVED***
...
http.createRequest = function(options) {
  ...
  ***REMOVED***;
  ...
  request.toString = function() {
    ...
    ***REMOVED*** else if(request.body !== null) {
...
http.createResponse = function() {
      ...
      if(line !== null) {
        ...
        if(_first) {
          ...
          ***REMOVED*** else {
            ...
            error.details = {'line': line***REMOVED***;
            throw error;
          ***REMOVED***
        ***REMOVED*** else if(line.length === 0) {
    ...
    while(line !== null && b.length() > 0) {
      ...
      if(_chunkSize > 0) {
        ...
        ***REMOVED***
        ...
        b.getBytes(2);
        _chunkSize = 0;
      ***REMOVED*** else if(!_chunksFinished) {
  ...
  ***REMOVED***;
  ...
  response.readBody = function(b) {
    ...
    ***REMOVED*** else if(transferEncoding !== null) {
      ...
      ***REMOVED*** else {
        ...
        error.details = {'transferEncoding': transferEncoding***REMOVED***;
        throw error;
      ***REMOVED***
...
http.withinCookieDomain = function(url, cookie) {
  ...
  if(domain === null) {
    rval = true;
  ***REMOVED*** else if(domain.charAt(0) === '.') {
