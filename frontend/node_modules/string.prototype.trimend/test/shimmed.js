...
test('shimmed', function (t) {
	...
	***REMOVED***);
	...
	t.test('bad string/this value', { skip: !supportsStrictMode ***REMOVED***, function (st) {
		st['throws'](function () { return String.prototype.trimEnd.call(undefined, 'a'); ***REMOVED***, TypeError, 'undefined is not an object');
		st['throws'](function () { return String.prototype.trimEnd.call(null, 'a'); ***REMOVED***, TypeError, 'null is not an object');
		st.end();
	***REMOVED***);
