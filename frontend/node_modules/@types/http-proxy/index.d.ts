...
declare namespace Server {
    ...
    interface ServerOptions {
        ...
        cookieDomainRewrite?: false | string | { [oldDomain: string]: string ***REMOVED*** | undefined;
        /** rewrites path of set-cookie headers. Default: false */
        cookiePathRewrite?: false | string | { [oldPath: string]: string ***REMOVED*** | undefined;
        /** object with extra headers to be added to target requests. */
        headers?: { [header: string]: string ***REMOVED*** | undefined;
