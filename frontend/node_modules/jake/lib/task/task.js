        ...
        if (!(this.reenabled && previous == this)) {
          if (previous.taskStatus != Task.runStatuses.DONE) {
            ...
            if (now - this.startTime > jake._taskTimeout) {
              return jake.fail(`Timed out waiting for task: ${previous.name***REMOVED*** with status of ${previous.taskStatus***REMOVED***`);
            ***REMOVED***
      ...
      ***REMOVED***);
      if (stillWaiting) {
        ...
        if (elapsed > jake._taskTimeout) {
          return jake.fail(`Timed out waiting for task: ${this.name***REMOVED*** with status of ${this.taskStatus***REMOVED***. Elapsed: ${elapsed***REMOVED***`);
        ***REMOVED***
        setTimeout(() => {
          this.complete(val);
        ***REMOVED***, POLLING_INTERVAL);
        return;
      ***REMOVED***
    ***REMOVED***
