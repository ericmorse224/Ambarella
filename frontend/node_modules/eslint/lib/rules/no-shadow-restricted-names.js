 ...
 * as the global).
 * @param {eslintScope.Variable***REMOVED*** variable The variable to check
 * @returns {boolean***REMOVED*** true if this variable safely shadows `undefined`
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            shadowingRestrictedName: "Shadowing of global property '{{name***REMOVED******REMOVED***'."
        ***REMOVED***
    ***REMOVED***,
