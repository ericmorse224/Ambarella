...
const { compare, has ***REMOVED*** = require('./helpers');
...
module.exports = function (targets) {
  const { browsers, esmodules, node, ...rest ***REMOVED*** = (typeof targets != 'object' || Array.isArray(targets))
    ? { browsers: targets ***REMOVED*** : toLowerKeys(targets);
