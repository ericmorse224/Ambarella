  ...
  if (node.selfClosing) {
    ...
    if (option === 'never') {
      if (!adjacent) {
        ...
        ***REMOVED***);
      ***REMOVED***
    ***REMOVED*** else if (option === 'always' && adjacent) {
  ...
  ***REMOVED***
  ...
  if ((option === 'always' || option === 'proportional-always') && adjacent) {
    report(context, messages.beforeSelfCloseNeedSpace, 'beforeSelfCloseNeedSpace', {
      ...
      ***REMOVED***,
    ***REMOVED***);
  ***REMOVED*** else if (option === 'never' && !adjacent) {
  ...
  if (!node.selfClosing) {
    ...
    ***REMOVED*** else if (option === 'always' && adjacent) {
      report(context, messages.beforeCloseNeedSpace, 'beforeCloseNeedSpace', {
        ...
        ***REMOVED***,
      ***REMOVED***);
    ***REMOVED*** else if (option === 'proportional-always' && node.type === 'JSXOpeningElement' && adjacent !== (node.loc.start.line === node.loc.end.line)) {
      report(context, messages.beforeCloseNeedSpace, 'beforeCloseNeedSpace', {
        node,
        loc: {
          start: leftToken.loc.end,
