 ...
 * @param   {*[]***REMOVED***     xs Any array.
 * @returns {Array[]***REMOVED***    An array of arrays.
 */
 ...
 * @param   {Array***REMOVED*** arr1 The first array to combine.
 * @param   {Array***REMOVED*** arr2 The second array to combine.
 * @returns {Array***REMOVED***      A mixture of the elements of the first and second arrays.
 */
 ...
 * will return:
 * [
 *     [{before: true***REMOVED***, {before: false***REMOVED***],
 *     [{after: true***REMOVED***, {after: false***REMOVED***]
 * ]
 * @param   {Object[]***REMOVED*** objects Array of objects, each with one property/value pair
 * @returns {Array[]***REMOVED***          Array of arrays of objects grouped by property
 */
 ...
 * @typedef {Array|number***REMOVED*** ruleConfig
 * @param {number***REMOVED***  0  The rule's severity (0, 1, 2).
 */
 ...
 * will return:
 * [
 *     {before: true, after: true***REMOVED***,
 *     {before: true, after: false***REMOVED***,
 *     {before: false, after: true***REMOVED***,
 *     {before: false, after: false***REMOVED***
 * ]
 * @param   {Object[]***REMOVED*** objArr1 Single key/value objects, all with the same key
 * @param   {Object[]***REMOVED*** objArr2 Single key/value objects, all with another key
 * @returns {Object[]***REMOVED***         Combined objects for each combination of input properties and values
 */
...
class RuleConfigSet {
    ...
    /**
     * @param {ruleConfig[]***REMOVED*** configs Valid rule configurations
     */
    constructor(configs) {
    ...
    ***REMOVED***
     ...
     * @param  {string[]***REMOVED*** enums Array of valid rule options (e.g. ["always", "never"])
     * @returns {void***REMOVED***
     */
    addEnums(enums) {
    ...
    ***REMOVED***
     ...
     * @param  {Object***REMOVED*** obj Schema item with type === "object"
     * @returns {boolean***REMOVED*** true if at least one schema for the object could be generated, false otherwise
     */
    addObject(obj) {
 ...
 * @param   {Object***REMOVED*** schema  A rule's schema object
 * @returns {Array[]***REMOVED***        Valid rule configurations
 */
function generateConfigsFromSchema(schema) {
    ...
    if (Array.isArray(schema)) {
        for (const opt of schema) {
            ...
            ***REMOVED*** else if (opt.type && opt.type === "object") {
 ...
 * @param {boolean***REMOVED*** noDeprecated Indicates whether ignores deprecated rules or not.
 * @returns {rulesConfig***REMOVED*** Hash of rule names and arrays of possible configurations
 */
