...
function createFsFromVolume(vol) {
    var fs = { F_OK: F_OK, R_OK: R_OK, W_OK: W_OK, X_OK: X_OK, constants: constants_1.constants, Stats: Stats_1.default, Dirent: Dirent_1.default ***REMOVED***;
    // Bind FS methods.
...
module.exports = __assign(__assign({***REMOVED***, module.exports), exports.fs);
