    ...
    if (!isPromise(actual)) {
      throw new JestAssertionError(
        matcherUtils.matcherErrorMessage(
          ...
          `${matcherUtils.RECEIVED_COLOR('received')***REMOVED*** value must be a promise`,
    ...
    return actual.then(
      ...
      reason => {
        outerErr.message =
          ...
          `Rejected to value: ${matcherUtils.printReceived(reason)***REMOVED***`;
      ...
      throw new JestAssertionError(
        matcherUtils.matcherErrorMessage(
          ...
          `${matcherUtils.RECEIVED_COLOR(
            'received'
          )***REMOVED*** value must be a promise or a function returning a promise`,
          matcherUtils.printWithType(
            'Received',
            actual,
            matcherUtils.printReceived
    ...
    return actualWrapper.then(
      result => {
        outerErr.message =
          ...
          `Resolved to value: ${matcherUtils.printReceived(result)***REMOVED***`;
        return Promise.reject(outerErr);
      ***REMOVED***,
      reason =>
    ...
    const processResult = (result, asyncError) => {
      ...
      if ((result.pass && isNot) || (!result.pass && !isNot)) {
        ...
        ***REMOVED*** else {
          ...
          ***REMOVED***
        ***REMOVED*** // Passing the result of the matcher with the error so that a custom
        // reporter could access the actual and expected objects of the result
        // for example in order to display a custom visual diff

        error.matcherResult = {...result, message***REMOVED***;
  ...
  if (
    ...
    throw new Error(
      'Unexpected return from a matcher function.\n' +
        ...
        '  {message?: string | function, pass: boolean***REMOVED***\n' +
        `'${matcherUtils.stringify(result)***REMOVED***' was returned`
    );
  ***REMOVED***
***REMOVED***;
...
function hasAssertions(...args) {
  ...
  ***REMOVED***);
***REMOVED*** // add default jest matchers
