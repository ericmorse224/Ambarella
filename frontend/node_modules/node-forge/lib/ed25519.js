...
module.exports = forge.pki.ed25519 = forge.ed25519 = forge.ed25519 || {***REMOVED***;
var ed25519 = forge.ed25519;

ed25519.constants = {***REMOVED***;
...
ed25519.generateKeyPair = function(options) {
  ...
  ***REMOVED*** else if(typeof seed === 'string') {
    if(seed.length !== ed25519.constants.SEED_BYTE_LENGTH) {
      throw new TypeError(
        '"seed" must be ' + ed25519.constants.SEED_BYTE_LENGTH +
        ' bytes in length.');
    ***REMOVED***
  ***REMOVED*** else if(!(seed instanceof Uint8Array)) {
    throw new TypeError(
      '"seed" must be a node.js Buffer, Uint8Array, or a binary string.');
  ***REMOVED***

  seed = messageToNativeBuffer({message: seed, encoding: 'binary'***REMOVED***);
  ...
  ***REMOVED***
  ...
  return {publicKey: pk, privateKey: sk***REMOVED***;
***REMOVED***;
 ...
 *
 * @returns {Object***REMOVED*** keyInfo - The key information.
 * @returns {Buffer|Uint8Array***REMOVED*** keyInfo.privateKeyBytes - 32 private key bytes.
 */
ed25519.privateKeyFromAsn1 = function(obj) {
  ...
  ***REMOVED***);
  ...
  return {privateKeyBytes: privateKeyBytes***REMOVED***;
***REMOVED***;
 ...
 *
 * @return {Buffer|Uint8Array***REMOVED*** - 32 public key bytes.
 */
...
ed25519.sign = function(options) {
  ...
  ***REMOVED***);
  if(privateKey.length === ed25519.constants.SEED_BYTE_LENGTH) {
    var keyPair = ed25519.generateKeyPair({seed: privateKey***REMOVED***);
    privateKey = keyPair.privateKey;
  ***REMOVED*** else if(privateKey.length !== ed25519.constants.PRIVATE_KEY_BYTE_LENGTH) {
    throw new TypeError(
      '"options.privateKey" must have a byte length of ' +
...
function messageToNativeBuffer(options) {
  ...
  ***REMOVED*** else if(!(message instanceof ByteBuffer)) {
    throw new TypeError(
