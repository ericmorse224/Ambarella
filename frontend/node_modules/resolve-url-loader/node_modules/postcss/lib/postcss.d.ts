...
declare namespace postcss {
  ...
  ***REMOVED*** | Processor;
  ...
  interface Plugin<T> extends Transformer {
    ...
    process: (css: string | {
      toString(): string;
    ***REMOVED*** | Result, processOpts?: ProcessOptions, pluginOpts?: T) => LazyResult;
  ***REMOVED***
  ...
  ***REMOVED***
  type ParserInput = string | { toString(): string ***REMOVED***;
  interface Parser {
  ...
  ***REMOVED***
   ...
   * @param options
   * @returns {***REMOVED*** A new Root node, which contains the source CSS nodes.
   */
  const parse: Parser;
  /**
  ...
  ***REMOVED***
  ...
  interface ContainerBase extends NodeBase {
     ...
     * Unlike the for {***REMOVED*** -cycle or Array#forEach() this iterator is safe if
    ...
    replaceValues(pattern: string | RegExp, options: {
         ...
         */
        fast?: string;
    ***REMOVED***, callbackOrReplaceValue: string | {
    ...
    ***REMOVED***): this;
     ...
     *     root.prepend({ name: '@charset', params: '"UTF-8"' ***REMOVED***); // at-rule
     *     root.prepend({ selector: 'a' ***REMOVED***);                       // rule
     *     rule.prepend({ prop: 'color', value: 'black' ***REMOVED***);       // declaration
     *     rule.prepend({ text: 'Comment' ***REMOVED***)                      // comment
     * A string containing the CSS of the new element can also be used. This
     * approach is slower than the above shortcuts.
     *     root.prepend('a {***REMOVED***');
  ...
  ***REMOVED***
  /**
   * Represents an at-rule. If it's followed in the CSS by a {***REMOVED*** block, this
  ...
  interface AtRule extends ContainerBase {
    ...
    name: string;
    /**
     * These are the values that follow the at-rule's name, but precede any {***REMOVED***
