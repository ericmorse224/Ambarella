 ...
 *
 * @param {*|{line: number, column: number***REMOVED******REMOVED*** maybeObj Possible location hash
 * @returns {{line: number, column: number***REMOVED******REMOVED*** Location hash with possible NaN values
 */
function sanitise(maybeObj) {
  var obj = !!maybeObj && typeof maybeObj === 'object' && maybeObj || {***REMOVED***;
  return {
 ...
 *
 * @param candidate {string***REMOVED*** A string with possible linebreaks
 * @returns {{line: number, column: number***REMOVED******REMOVED*** A position object where line and column are deltas
 */
 ...
 *
 * @param {{line: number, column: number***REMOVED***[]***REMOVED*** list One or more sourcemap position elements to add
 * @returns {{line: number, column: number***REMOVED******REMOVED*** Resultant position element
 */
function add(list) {
  return list
    .slice(1)
