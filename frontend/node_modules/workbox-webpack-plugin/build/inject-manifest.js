...
const { RawSource ***REMOVED*** = webpack_1.default.sources || require('webpack-sources');
/**
    ...
    ***REMOVED***
    ...
    apply(compiler) {
        ...
        ***REMOVED***
            ...
            const { PROCESS_ASSETS_STAGE_OPTIMIZE_TRANSFER ***REMOVED*** = webpack_1.default.Compilation;
            ...
            compiler.hooks.thisCompilation.tap(this.constructor.name, (compilation) => {
                ...
                ***REMOVED***, () => this.addAssets(compilation).catch((error) => {
                    compilation.errors.push(error);
                ***REMOVED***));
            ***REMOVED***);
        ***REMOVED***
    ...
    async handleMake(compilation, parentCompiler) {
        ...
        ***REMOVED***
            ...
            if (error instanceof Error) {
                throw new Error(`Please check your ${this.constructor.name***REMOVED*** plugin ` +
    ...
    ***REMOVED***
    ...
    async addAssets(compilation) {
        ...
        if (this.alreadyCalled) {
            const warningMessage = `${this.constructor.name***REMOVED*** has been called ` +
        ...
        ***REMOVED***
        ...
        if (!injectionResults) {
            throw new Error(`Can't find ${(_a = config.injectionPoint) !== null && _a !== void 0 ? _a : ''***REMOVED*** in your SW source.`);
        ***REMOVED***
        if (injectionResults.length !== 1) {
            throw new Error(`Multiple instances of ${(_b = config.injectionPoint) !== null && _b !== void 0 ? _b : ''***REMOVED*** were ` +
                `found in your SW source. Include it only once. For more info, see ` +
                `https://github.com/GoogleChrome/workbox/issues/2681`);
        ***REMOVED***
        const { size, sortedEntries ***REMOVED*** = await (0, get_manifest_entries_from_compilation_1.getManifestEntriesFromCompilation)(compilation, config);
        ...
        ***REMOVED***
        ...
        if (sourcemapAssetName) {
            ...
            const { source, map ***REMOVED*** = await (0, replace_and_update_source_map_1.replaceAndUpdateSourceMap)({
        ...
        ***REMOVED***
        if (compilation.getLogger) {
            ...
            logger.info(`The service worker at ${(_e = config.swDest) !== null && _e !== void 0 ? _e : ''***REMOVED*** will precache
        ${sortedEntries.length***REMOVED*** URLs, totaling ${(0, pretty_bytes_1.default)(size)***REMOVED***.`);
        ***REMOVED***
    ***REMOVED***
***REMOVED***
