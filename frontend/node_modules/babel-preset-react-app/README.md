...
```json
{
  "presets": [["react-app", { "flow": true, "typescript": false ***REMOVED***]]
***REMOVED***
```
...
```json
{
  "presets": [["react-app", { "flow": false, "typescript": true ***REMOVED***]]
***REMOVED***
```
...
```
{
  "presets": [["react-app", { "absoluteRuntime": false ***REMOVED***]]
***REMOVED***
```
