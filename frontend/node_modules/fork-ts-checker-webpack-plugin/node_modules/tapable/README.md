...
``` js
keyedHook.tap("some-key", "MyPlugin", (arg) => { /* ... */ ***REMOVED***);
keyedHook.tapAsync("some-key", "MyPlugin", (arg, callback) => { /* ... */ ***REMOVED***);
keyedHook.tapPromise("some-key", "MyPlugin", (arg) => { /* ... */ ***REMOVED***);
```
