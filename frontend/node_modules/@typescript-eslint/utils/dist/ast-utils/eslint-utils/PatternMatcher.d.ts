interface PatternMatcher {
     ...
     *
     * @see {@link https://eslint-community.github.io/eslint-utils/api/ast-utils.html#matcher-execall***REMOVED***
     */
    execAll(str: string): IterableIterator<RegExpExecArray>;
    /**
     * Check whether this pattern matches a given string or not.
     *
     * @see {@link https://eslint-community.github.io/eslint-utils/api/ast-utils.html#matcher-test***REMOVED***
     */
    test(str: string): boolean;
    /**
     * Replace all matched parts by a given replacer.
     *
     * @see {@link https://eslint-community.github.io/eslint-utils/api/ast-utils.html#matcher-symbol-replace***REMOVED***
     * @example
     * const { PatternMatcher ***REMOVED*** = require("eslint-utils")
     * const matcher = new PatternMatcher(/\\p{Script=Greek***REMOVED***/g)
     *
     * module.exports = {
     *     meta: {***REMOVED***,
     *     create(context) {
 ...
 *
 * @see {@link https://eslint-community.github.io/eslint-utils/api/ast-utils.html#patternmatcher-class***REMOVED***
 */
declare const PatternMatcher: new (pattern: RegExp, options?: {
    escaped?: boolean;
***REMOVED***) => PatternMatcher;
export { PatternMatcher ***REMOVED***;
