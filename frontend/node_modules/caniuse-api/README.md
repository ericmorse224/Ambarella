...
/*
{ and_chr: { y: 67 ***REMOVED***,
  and_ff: { y: 60 ***REMOVED***,
  and_qq: { y: 1.2 ***REMOVED***,
  and_uc: { y: 11.8 ***REMOVED***,
  android: { y: 2.1, x: 2.1 ***REMOVED***,
  baidu: { y: 7.12 ***REMOVED***,
  chrome: { y: 4, x: 4 ***REMOVED***,
  edge: { y: 12 ***REMOVED***,
  firefox: { a: 2, x: 3.6, y: 3 ***REMOVED***,
  ie: { n: 8, y: 9 ***REMOVED***,
  ie_mob: { y: 10 ***REMOVED***,
  ios_saf: { y: 3.2, x: 3.2 ***REMOVED***,
  op_mini: {***REMOVED***,
  op_mob: { n: 10, y: 11 ***REMOVED***,
  opera: { n: 10, y: 10.5 ***REMOVED***,
  safari: { y: 3.1, x: 4 ***REMOVED***,
  samsung: { y: 4 ***REMOVED*** ***REMOVED***
*/
```
