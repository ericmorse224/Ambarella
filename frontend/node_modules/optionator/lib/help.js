...
(function(){
  ...
  ***REMOVED***;
  generateHelp = function(arg$){
    ...
    return function(arg$){
      ...
      ref$ = arg$ != null
        ? arg$
        : {***REMOVED***, showHidden = ref$.showHidden, interpolate = ref$.interpolate;
      maxWidth = stdout != null && stdout.isTTY ? stdout.columns - 1 : null;
      output = [];
      out = function(it){
  ...
  ***REMOVED***
  function interp(string, object){
    return string.replace(/{{([a-zA-Z$_][a-zA-Z$_0-9]*)***REMOVED******REMOVED***/g, function(arg$, key){
      var ref$;
