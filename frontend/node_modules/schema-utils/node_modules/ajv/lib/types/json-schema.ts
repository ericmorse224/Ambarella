...
type StrictNullChecksWrapper<Name extends string, Type> = undefined extends null
  ? `strictNullChecks must be true in tsconfig to use ${Name***REMOVED***`
  : Type
...
type UncheckedJSONSchemaType<T, IsPartial extends boolean> = (
  ...
  | {
    ...
    ***REMOVED***
  // this union allows for { type: (primitive)[] ***REMOVED*** style schemas
  | ({
  ...
  | ((T extends number
      ? {
        ...
        ***REMOVED*** & NumberKeywords
      : T extends string
      ? {
          type: JSONType<"string", IsPartial>
        ***REMOVED*** & StringKeywords
      : T extends boolean
      ? {
      ...
      ? {
          ...
          ***REMOVED*** & {length: T["length"]***REMOVED***
          minItems: T["length"]
        ***REMOVED*** & ({maxItems: T["length"]***REMOVED*** | {additionalItems: false***REMOVED***)
      ...
      ? {
          ...
          propertyNames?: Omit<UncheckedJSONSchemaType<string, false>, "type"> & {type?: "string"***REMOVED***
          dependencies?: {[K in keyof T]?: readonly (keyof T)[] | UncheckedPartialSchema<T>***REMOVED***
          dependentRequired?: {[K in keyof T]?: readonly (keyof T)[]***REMOVED***
          dependentSchemas?: {[K in keyof T]?: UncheckedPartialSchema<T>***REMOVED***
          minProperties?: number
          maxProperties?: number
        ***REMOVED*** & (IsPartial extends true // "required" is not necessary if it's a non-partial type with no required keys // are listed it only asserts that optional cannot be listed. // "required" type does not guarantee that all required properties
          ? {required: readonly (keyof T)[]***REMOVED***
          : [UncheckedRequiredMembers<T>] extends [never]
          ? {required?: readonly UncheckedRequiredMembers<T>[]***REMOVED***
          : {required: readonly UncheckedRequiredMembers<T>[]***REMOVED***)
      : T extends null
      ? {
...
type UncheckedPropertiesSchema<T> = {
  [K in keyof T]-?: (UncheckedJSONSchemaType<T[K], false> & Nullable<T[K]>) | {$ref: string***REMOVED***
***REMOVED***
