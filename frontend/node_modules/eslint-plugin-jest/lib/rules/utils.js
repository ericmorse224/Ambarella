...
const createRule = _experimentalUtils.ESLintUtils.RuleCreator(name => {
  ...
  return `${REPO_URL***REMOVED***/blob/v${_package.version***REMOVED***/docs/rules/${ruleName***REMOVED***.md`;
***REMOVED***);
 ...
 * @param {V***REMOVED*** [value]
 *
 * @return {node is StringLiteral<V>***REMOVED***
 *
 * @template V
 */
 ...
 * @param {V***REMOVED*** [value]
 *
 * @return {node is TemplateLiteral<V>***REMOVED***
 *
 * @template V
 */
...
/**
 * Checks if the given `node` is a {@link StringNode***REMOVED***.
 *
 * @param {Node***REMOVED*** node
 * @param {V***REMOVED*** [specifics]
 *
 * @return {node is StringNode***REMOVED***
 *
 * @template V
 */
 ...
 *
 * @param {StringNode<S>***REMOVED*** node
 *
 * @return {S***REMOVED***
 *
 * @template S
 ...
 *
 * @param {CallExpression***REMOVED*** call
 *
 * @return {call is CallExpressionWithSingleArgument***REMOVED***
 */
 ...
 *
 * @param {Node***REMOVED*** node
 * @param {V***REMOVED*** [name]
 *
 * @return {node is KnownIdentifier<Name>***REMOVED***
 *
 * @template V
 */
 ...
 * @param {V***REMOVED*** [value]
 *
 * @return {node is AccessorNode<V>***REMOVED***
 *
 * @template V
 */
 ...
 *
 * @param {AccessorNode<S>***REMOVED*** accessor
 *
 * @return {S***REMOVED***
 *
 * @template S
 ...
 * @param {Node***REMOVED*** node
 *
 * @return {node is ExpectCall***REMOVED***
 */
...
***REMOVED***)(ModifierName || (exports.ModifierName = ModifierName = {***REMOVED***));
...
***REMOVED***)(EqualityMatcher || (exports.EqualityMatcher = EqualityMatcher = {***REMOVED***));
 ...
 *
 * @param {ParsedExpectMember<ModifierName>***REMOVED*** parsedMember
 *
 * @return {ParsedExpectModifier***REMOVED***
 */
...
const reparseMemberAsModifier = parsedMember => {
  ...
  ***REMOVED***
  ...
  if (!isSpecificMember(parsedMember, ModifierName.resolves) && !isSpecificMember(parsedMember, ModifierName.rejects)) {
    ...
    throw new Error(`modifier name must be either "${ModifierName.resolves***REMOVED***" or "${ModifierName.rejects***REMOVED***" (got "${parsedMember.name***REMOVED***")`);
  ***REMOVED***
 ...
 *
 * @param {ParsedExpectMember***REMOVED*** member
 *
 * @return {member is ParsedExpectMember<ModifierName>***REMOVED***
 */
...
***REMOVED***)(DescribeAlias || (exports.DescribeAlias = DescribeAlias = {***REMOVED***));
...
***REMOVED***)(TestCaseName || (exports.TestCaseName = TestCaseName = {***REMOVED***));
...
***REMOVED***)(HookName || (exports.HookName = HookName = {***REMOVED***));
...
***REMOVED***)(DescribeProperty || (exports.DescribeProperty = DescribeProperty = {***REMOVED***));
...
***REMOVED***)(TestCaseProperty || (exports.TestCaseProperty = TestCaseProperty = {***REMOVED***));

const joinNames = (a, b) => a && b ? `${a***REMOVED***.${b***REMOVED***` : null;
...
const getTestCallExpressionsFromDeclaredVariables = declaredVariables => {
  return declaredVariables.reduce((acc, {
    references
  ***REMOVED***) => acc.concat(references.map(({
    identifier
  ***REMOVED***) => identifier.parent).filter(node => !!node && node.type === _experimentalUtils.AST_NODE_TYPES.CallExpression && isTestCaseCall(node))), []);
***REMOVED***;
 ...
 *
 * @param {TSESTree.CallExpression***REMOVED*** node
 *
 * @return {node is JestFunctionCallExpression<TestCaseName>***REMOVED***
 */
