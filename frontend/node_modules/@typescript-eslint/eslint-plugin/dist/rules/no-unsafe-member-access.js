...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            unsafeMemberExpression: 'Unsafe member access {{property***REMOVED******REMOVED*** on an `any` value.',
            unsafeThisMemberExpression: [
                'Unsafe member access {{property***REMOVED******REMOVED*** on an `any` value. `this` is typed as `any`.',
                'You can try to fix this by turning on the `noImplicitThis` compiler option, or adding a `this` parameter to the function.',
            ].join('\n'),
            unsafeComputedMemberAccess: 'Computed name {{property***REMOVED******REMOVED*** resolves to an any value.',
        ***REMOVED***,
        schema: [],
    ***REMOVED***,
    defaultOptions: [],
            ...
            if (state === 1 /* State.Unsafe */) {
                ...
                ***REMOVED***
                context.report({
                    ...
                    messageId,
                    data: {
                        property: node.computed ? `[${propertyName***REMOVED***]` : `.${propertyName***REMOVED***`,
                    ***REMOVED***,
                ***REMOVED***);
            ***REMOVED***
            return state;
