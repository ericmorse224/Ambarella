(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.sourceMap = {***REMOVED***));
***REMOVED***)(this, (function (exports) { 'use strict';
    ...
    ***REMOVED***
    ...
    function memoizedBinarySearch(haystack, needle, state, key) {
        const { lastKey, lastNeedle, lastIndex ***REMOVED*** = state;
        let low = 0;
    ...
    ***REMOVED***
    function recurse(input, mapUrl, mappings, sources, sourcesContent, names, ignoreList, lineOffset, columnOffset, stopLine, stopColumn) {
        const { sections ***REMOVED*** = input;
        for (let i = 0; i < sections.length; i++) {
            const { map, offset ***REMOVED*** = sections[i];
            let sl = stopLine;
            let sc = stopColumn;
    ...
    ***REMOVED***
    function addSection(input, mapUrl, mappings, sources, sourcesContent, names, ignoreList, lineOffset, columnOffset, stopLine, stopColumn) {
        ...
        const { resolvedSources, sourcesContent: contents, ignoreList: ignores ***REMOVED*** = map;
    ...
    ***REMOVED***
    ...
    class TraceMap {
        constructor(map, mapUrl) {
            ...
            const { version, file, names, sourceRoot, sources, sourcesContent ***REMOVED*** = parsed;
    ...
    ***REMOVED***
    ...
    function originalPositionFor(map, needle) {
        let { line, column, bias ***REMOVED*** = needle;
        line--;
        if (line < 0)
        ...
        if (segment.length === 1)
            return OMapping(null, null, null, null);
        const { names, resolvedSources ***REMOVED*** = map;
    ...
    ***REMOVED***
    ...
    function generatedPositionFor(map, needle) {
        const { source, line, column, bias ***REMOVED*** = needle;
    ...
    ***REMOVED***
    function sourceIndex(map, source) {
        const { sources, resolvedSources ***REMOVED*** = map;
    ...
    ***REMOVED***
    ...
    function sourceContentFor(map, source) {
        const { sourcesContent ***REMOVED*** = map;
    ...
    ***REMOVED***
    function OMapping(source, line, column, name) {
        return { source, line, column, name ***REMOVED***;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    class SetArray {
        constructor() {
            this._indexes = { __proto__: null ***REMOVED***;
            this.array = [];
        ***REMOVED***
    ***REMOVED***
    /**
    ...
    ***REMOVED***
    ...
    function put(setarr, key) {
        ...
        if (index !== undefined)
            return index;
        const { array, _indexes: indexes ***REMOVED*** = cast$1(setarr);
    ...
    ***REMOVED***
     ...
     */
    class GenMapping {
        constructor({ file, sourceRoot ***REMOVED*** = {***REMOVED***) {
    ...
    ***REMOVED***;
    ...
    function setSourceContent(map, source, content) {
        const { _sources: sources, _sourcesContent: sourcesContent ***REMOVED*** = cast(map);
    ...
    ***REMOVED***
    ...
    function toDecodedMap(map) {
        const { _mappings: mappings, _sources: sources, _sourcesContent: sourcesContent, _names: names, _ignoreList: ignoreList, ***REMOVED*** = cast(map);
    ...
    ***REMOVED***
    ...
    function toEncodedMap(map) {
        ...
        return Object.assign(Object.assign({***REMOVED***, decoded), { mappings: encode(decoded.mappings) ***REMOVED***);
    ***REMOVED***
    /**
    ...
    function fromMap(input) {
        ...
        const gen = new GenMapping({ file: map.file, sourceRoot: map.sourceRoot ***REMOVED***);
    ...
    ***REMOVED***
    ...
    function addSegmentInternal(skipable, map, genLine, genColumn, source, sourceLine, sourceColumn, name, content) {
        const { _mappings: mappings, _sources: sources, _sourcesContent: sourcesContent, _names: names, ***REMOVED*** = cast(map);
    ...
    ***REMOVED***
    function addMappingInternal(skipable, map, mapping) {
        const { generated, source, original, name, content ***REMOVED*** = mapping;
        if (!source) {
