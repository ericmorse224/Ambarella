...
// understand `require`.
const {version: VERSION***REMOVED*** = require('../package.json');
 ...
 *   files: {[filepath: string]: FileMetaData***REMOVED***,
 *   map: {[id: string]: ModuleMapItem***REMOVED***,
 *   mocks: {[id: string]: string***REMOVED***,
 * ***REMOVED***
 *
 * // Watchman clocks are used for query synchronization and file system deltas.
 * type WatchmanClocks = {[filepath: string]: string***REMOVED***;
 *
 * type FileMetaData = {
 ...
 * type ModuleMapItem = {[platform: string]: ModuleMetaData***REMOVED***;
 *
 * //
 * type ModuleMetaData = {
 ...
 * `{id: 'flatMap', mtime: 3421, size: 42, visited: true, dependencies: []***REMOVED***` the real
...
class HasteMap extends _events().EventEmitter {
  ...
  constructor(options) {
    ...
    ***REMOVED***
    ...
    this._cachePath = HasteMap.getCacheFilePath(
      ...
      `haste-map-${this._options.name***REMOVED***-${rootDirHash***REMOVED***`,
      VERSION,
      this._options.name,
      this._options.roots
  ...
  _processFile(hasteMap, map, mocks, filePath, workerOptions) {
    ...
    const setModule = (id, module) => {
      ...
      ***REMOVED***
      ...
      if (
        ...
        ***REMOVED*** // We do NOT want consumers to use a module that is ambiguous.
    ...
    ***REMOVED***
    ...
    const workerReply = metadata => {
      ...
      ***REMOVED***
    ***REMOVED***; // Callback called when the response from the worker is an error.
    ...
    const workerError = error => {
      ...
      ***REMOVED***
      ...
      if (!['ENOENT', 'EACCES'].includes(error.code)) {
        throw error;
      ***REMOVED*** // If a file cannot be read we remove it from the file list and
      // ignore the failure silently.

      hasteMap.files.delete(relativeFilePath);
    ***REMOVED***; // If we retain all files in the virtual HasteFS representation, we avoid
  ...
  ***REMOVED***
  ...
  _buildHasteMap(data) {
    const {removedFiles, changedFiles, hasteMap***REMOVED*** = data; // If any files were removed or we did not track what files changed, process
    ...
    ***REMOVED***
    ...
    for (const relativeFilePath of filesToProcess.keys()) {
      if (
        ...
        continue;
      ***REMOVED*** // SHA-1, if requested, should already be present thanks to the crawler.
        ...
        return (0, _node.default)(crawlerOptions).catch(e => {
          throw new Error(
            'Crawler retry failed:\n' +
              `  Original error: ${error.message***REMOVED***\n` +
              `  Retry error: ${e.message***REMOVED***\n`
          );
        ***REMOVED***);
      ***REMOVED***
  ...
  ***REMOVED***
  ...
  _watch(hasteMap) {
    ...
    ***REMOVED*** // In watch mode, we'll only warn about module collisions and we'll retain
      ...
      ***REMOVED***
      ...
      changeQueue = changeQueue
        .then(() => {
          ...
          ***REMOVED*** // If the file was added or changed,
