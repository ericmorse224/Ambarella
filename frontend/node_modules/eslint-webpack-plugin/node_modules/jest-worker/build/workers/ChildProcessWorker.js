    ...
    ***REMOVED***
    ...
    if (this._retries > this._options.maxRetries) {
      const error = new Error(
        `Jest worker encountered ${this._retries***REMOVED*** child process exceptions, exceeding retry limit`
      );
  ...
  _onMessage(response) {
    ...
    switch (response[0]) {
      ...
      case _types.PARENT_MESSAGE_SETUP_ERROR:
        error = new Error(`Error when calling setup: ${response[2]***REMOVED***`);
        error.type = response[1];
        error.stack = response[3];
      ...
      default:
        throw new TypeError(`Unexpected response from worker: ${response[0]***REMOVED***`);
    ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  send(request, onProcessStart, onProcessEnd, onCustomMessage) {
    ...
    ***REMOVED***;
    ...
    this._child.send(request, () => {***REMOVED***);
  ***REMOVED***
