  ...
  ***REMOVED***, {
    ...
    value: function toString(ctx, _ref9, onComment, onChompKeep) {
      ...
      ***REMOVED*** else if (inFlow) {
        ...
        ***REMOVED***, 2) > Collection.maxFlowStringSingleLineLength) {
          str = start;
...
var Pair = /*#__PURE__*/function (_Node) {
  ...
  ***REMOVED***, {
    ...
    value: function addToJSMap(ctx, map) {
      ...
      if (map instanceof Map) {
        ...
        map.set(key, value);
      ***REMOVED*** else if (map instanceof Set) {
        map.add(key);
      ***REMOVED*** else {
  ...
  ***REMOVED***, {
    ...
    value: function toJSON(_, ctx) {
      var pair = ctx && ctx.mapAsMap ? new Map() : {***REMOVED***;
  ...
  ***REMOVED***, {
    ...
    value: function toString(ctx, onComment, onChompKeep) {
      ...
      ***REMOVED*** else if (value && _typeof(value) === 'object') {
      ...
      ***REMOVED***);
      ...
      if (vcb || this.comment) {
        ws = "".concat(vcb, "\n").concat(ctx.indent);
      ***REMOVED*** else if (!explicitKey && value instanceof Collection) {
...
var getAliasCount = function getAliasCount(node, anchors) {
  ...
  ***REMOVED*** else if (node instanceof Collection) {
    var count = 0;
    ...
    ***REMOVED***
    ...
    return count;
  ***REMOVED*** else if (node instanceof Pair) {
...
var YAMLMap = /*#__PURE__*/function (_Collection) {
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    /**
     * @param {****REMOVED*** arg ignored
     * @param {****REMOVED*** ctx Conversion context, originally set in Document#toJSON()
     * @param {Class***REMOVED*** Type If set, forces the returned collection type
     * @returns {****REMOVED*** Instance of Type, Map, or Object
     */

  ***REMOVED***, {
    key: "toJSON",
    value: function toJSON(_, ctx, Type) {
      var map = Type ? new Type() : ctx && ctx.mapAsMap ? new Map() : {***REMOVED***;
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              ***REMOVED*** else if (map instanceof Set) {
                map.add(key);
              ***REMOVED*** else if (!Object.prototype.hasOwnProperty.call(map, key)) {
 ...
 * @param {string***REMOVED*** indent
 * @param {string***REMOVED*** [mode='flow'] `'block'` prevents more-indented lines
 *   from being folded; `'quoted'` allows for `\` escapes, including escaped
 *   newlines
 * @param {Object***REMOVED*** options
 * @param {number***REMOVED*** [options.indentAtStart] Accounts for leading contents on
 *   the first line, defaulting to `indent.length`
 * @param {number***REMOVED*** [options.lineWidth=80]
 * @param {number***REMOVED*** [options.minContentWidth=20] Allow highly indented lines to
 *   stretch the line width or indent content from the start
 * @param {function***REMOVED*** options.onFold Called once if the text is folded
 * @param {function***REMOVED*** options.onFold Called once if any line of text exceeds
      ...
      ***REMOVED***
      ...
      if (i >= end) {
        if (split) {
          ...
          split = undefined;
        ***REMOVED*** else if (mode === FOLD_QUOTED) {
...
function blockString(_ref2, ctx, onComment, onChompKeep) {
  ...
  ***REMOVED***
  ...
  value = value.replace(/[\n\t ]*$/, function (ws) {
    ...
    if (n === -1) {
      header += '-'; // strip
    ***REMOVED*** else if (value === ws || n !== ws.length - 1) {
      header += '+'; // keep
...
function plainString(item, ctx, onComment, onChompKeep) {
  ...
  if (implicitKey && /[\n[\]{***REMOVED***,]/.test(value) || inFlow && /[[\]{***REMOVED***,]/.test(value)) {
    return doubleQuotedString(value, ctx);
  ***REMOVED***
...
function stringifyString(item, ctx, onComment, onChompKeep) {
  ...
  if (typeof value !== 'string') {
    value = String(value);
    item = Object.assign({***REMOVED***, item, {
      value: value
    ***REMOVED***);
  ***REMOVED***
  ...
  ***REMOVED*** else if ((implicitKey || inFlow) && (type === Type.BLOCK_FOLDED || type === Type.BLOCK_LITERAL)) {
...
// on error, will return { str: string, errors: Error[] ***REMOVED***
  ...
  for (var i = 0; i < cst.items.length; ++i) {
    ...
    if (typeof item.char === 'string') {
      ...
      ***REMOVED***
      ...
      err.offset = offset;
      doc.errors.push(err);
    ***REMOVED*** else if (item.type === Type.BLANK_LINE) {
      comments.push({
        afterKey: !!key,
        before: items.length
      ***REMOVED***);
    ***REMOVED*** else if (item.type === Type.COMMENT) {
  ...
  for (var i = 0; i < cst.items.length; ++i) {
    ...
    if (typeof item.char === 'string') {
      ...
      ***REMOVED***
      ...
      if (char === next) {
        next = null;
      ***REMOVED*** else if (!next && char === '?') {
        explicitKey = true;
      ***REMOVED*** else if (next !== '[' && char === ':' && key === undefined) {
        if (next === ',') {
          key = items.pop();
        ...
        ***REMOVED***
        ...
        explicitKey = false;
        next = null;
      ***REMOVED*** else if (next === '[' || char !== ']' || i < cst.items.length - 1) {
