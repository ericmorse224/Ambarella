...
describe("match-path-sync", function () {
    Tests.tests.forEach(function (t) {
        return it(t.name, function () {
            ...
            var result = matchPath(t.requestedModule, function (_) { return t.packageJson; ***REMOVED***, function (name) { return t.existingFiles.indexOf(name) !== -1; ***REMOVED***, t.extensions);
