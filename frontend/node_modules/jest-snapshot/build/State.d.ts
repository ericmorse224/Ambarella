...
import type { OptionsReceived as PrettyFormatOptions ***REMOVED*** from 'pretty-format';
...
export default class SnapshotState {
    ...
    match({ testName, received, key, inlineSnapshot, isInline, error, ***REMOVED***: SnapshotMatchOptions): SnapshotReturnOptions;
