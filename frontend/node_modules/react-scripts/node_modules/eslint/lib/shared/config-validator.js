 ...
 * @throws {Error***REMOVED*** Wrong severity value.
 ...
 * @throws {Error***REMOVED*** Any rule validation errors.
 ...
 * @throws {Error***REMOVED*** Upon any bad rule configuration.
 * @returns {void***REMOVED***
 */
 ...
 * @throws {Error***REMOVED*** For invalid processor configuration.
 * @returns {void***REMOVED***
 */
 ...
 * @param {string***REMOVED*** source The name of the configuration source to report in any errors.
 * @throws {Error***REMOVED*** For any config invalid per the schema.
 * @returns {void***REMOVED***
 */
