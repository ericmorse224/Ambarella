...
if (program.pizzaType) console.log(`- ${program.pizzaType***REMOVED***`);
```
...
console.log(`cheese: ${program.cheese***REMOVED***`);
```
...
const cheeseStr = (program.cheese === false) ? 'no cheese' : `${program.cheese***REMOVED*** cheese`;
...
else console.log(`add cheese type ${program.cheese***REMOVED***`);
```
...
if (program.float !== undefined) console.log(`float: ${program.float***REMOVED***`);
if (program.integer !== undefined) console.log(`integer: ${program.integer***REMOVED***`);
if (program.verbose > 0) console.log(`verbosity: ${program.verbose***REMOVED***`);
