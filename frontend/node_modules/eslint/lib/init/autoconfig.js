 ...
 * @typedef {Object***REMOVED***     registryItem
 * @param   {ruleConfig***REMOVED*** config        A valid configuration for the rule
 * @param   {number***REMOVED***     specificity   The number of elements in the ruleConfig array
 * @param   {number***REMOVED***     errorCount    The number of errors encountered when linting with the config
 */

/**
 * This callback is used to measure execution status in a progress bar
 * @callback progressCallback
 * @param {number***REMOVED*** The total number of times the callback will be called.
 */

/**
 * Create registryItems for rules
 * @param   {rulesConfig***REMOVED*** rulesConfig Hash of rule names and arrays of ruleConfig items
 * @returns {Object***REMOVED***                  registryItems for each rule in provided rulesConfig
 */
...
class Registry {
    ...
    /**
     * @param {rulesConfig***REMOVED*** [rulesConfig] Hash of rule names and arrays of possible configurations
     */
    constructor(rulesConfig) {
        this.rules = (rulesConfig) ? makeRegistryItems(rulesConfig) : {***REMOVED***;
    ***REMOVED***
    ...
    ***REMOVED***
     ...
     * @returns {Object[]***REMOVED***          "rules" configurations to use for linting
     */
    buildRuleSets() {
        let idx = 0;
         ...
         * @param   {string***REMOVED*** rule The ruleId to add.
         * @returns {void***REMOVED***
         */
        const addRuleToRuleSet = function(rule) {
            ...
            if (this.rules[rule][idx] && (hasFewCombos || this.rules[rule][idx].specificity <= 2)) {
                ...
                ***REMOVED***
                ...
                ruleSets[idx] = ruleSets[idx] || {***REMOVED***;
    ...
    ***REMOVED***
    ...
    stripFailingConfigs() {
        ...
        newRegistry.rules = Object.assign({***REMOVED***, this.rules);
    ...
    ***REMOVED***
     ...
     * @returns {Registry***REMOVED***  A registry of failing rules.
     */
    ...
    ***REMOVED***
     ...
     * in the registry.
     * @returns {Object***REMOVED*** An eslint config with rules section populated
     */
    createConfig() {
        const ruleIds = Object.keys(this.rules),
            config = { rules: {***REMOVED*** ***REMOVED***;
    ...
    ***REMOVED***
     ...
     * @param   {number***REMOVED*** specificity Only keep configs with this specificity
     * @returns {Registry***REMOVED***           A registry of rules
     */
    ...
    ***REMOVED***
     ...
     * @param   {Object[]***REMOVED*** sourceCodes  SourceCode objects for each filename
     * @param   {Object***REMOVED***   config       ESLint config object
     * @param   {progressCallback***REMOVED*** [cb] Optional callback for reporting execution status
     * @returns {Registry***REMOVED***              New registry with errorCount populated
     */
    lintSourceCode(sourceCodes, config, cb) {
        let lintedRegistry = new Registry();

        lintedRegistry.rules = Object.assign({***REMOVED***, this.rules);
        ...
        filenames.forEach(filename => {
            debug(`Linting file: ${filename***REMOVED***`);

            let ruleSetIdx = 0;

            ruleSets.forEach(ruleSet => {
                const lintConfig = Object.assign({***REMOVED***, config, { rules: ruleSet ***REMOVED***);
 ...
 * @param   {Object***REMOVED*** config config object
 * @returns {Object***REMOVED***        config object using `"extends": ["eslint:recommended"]`
 */
function extendFromRecommended(config) {
    const newConfig = Object.assign({***REMOVED***, config);
