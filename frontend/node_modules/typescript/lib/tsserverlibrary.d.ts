...
declare namespace ts {
    ...
    ***REMOVED***
    export interface ClassDeclaration extends ClassLikeDeclarationBase, DeclarationStatement {
        ...
        readonly modifiers?: NodeArray<ModifierLike>;
        /** May be undefined in `export default class { ... ***REMOVED***`. */
        readonly name?: Identifier;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    export type TypeOnlyAliasDeclaration = ImportClause & {
        ...
        readonly name: Identifier;
    ***REMOVED*** | ImportEqualsDeclaration & {
        readonly isTypeOnly: true;
    ***REMOVED*** | NamespaceImport & {
        readonly parent: ImportClause & {
            readonly isTypeOnly: true;
        ***REMOVED***;
    ***REMOVED*** | ImportSpecifier & ({
        readonly isTypeOnly: true;
    ***REMOVED*** | {
        readonly parent: NamedImports & {
            readonly parent: ImportClause & {
    ...
    ***REMOVED***
    export interface DiagnosticMessage {
        ...
        code: number;
        message: string;
        reportsUnnecessary?: {***REMOVED***;
        reportsDeprecated?: {***REMOVED***;
    ***REMOVED***
    /**
...
declare namespace ts {
    ...
    ***REMOVED***;
    ...
    function validateLocaleAndSetLanguage(locale: string, sys: {
        ...
        fileExists(fileName: string): boolean;
        readFile(fileName: string): string | undefined;
    ***REMOVED***, errors?: Push<Diagnostic>): void;
     ...
     * type Id = <T>(x: T) => T
     * /** @type {Id***REMOVED*** /
     * function id(x) { return x ***REMOVED***
     */
...
declare namespace ts {
    ...
    /**
     * @param {string | undefined***REMOVED*** containingFile - file that contains type reference directive, can be undefined if containing file is unknown.
...
declare namespace ts {
    ...
    ***REMOVED***, usage: StringLiteralLike): ModuleKind.CommonJS | ModuleKind.ESNext | undefined;
...
declare namespace ts {
    ...
    ***REMOVED***
    function createIncrementalProgram<T extends BuilderProgram = EmitAndSemanticDiagnosticsBuilderProgram>({ rootNames, options, configFileParsingDiagnostics, projectReferences, host, createProgram ***REMOVED***: IncrementalProgramOptions<T>): T;
...
declare namespace ts {
    ...
    ***REMOVED***
    interface LanguageService {
        ...
        getCombinedCodeFix(scope: CombinedCodeFixScope, fixId: {***REMOVED***, formatOptions: FormatCodeSettings, preferences: UserPreferences): CombinedCodeActions;
    ...
    ***REMOVED***
    enum ScriptElementKind {
        ...
        /** class X { [public|private]* foo() {***REMOVED*** ***REMOVED*** */
        memberFunctionElement = "method",
        /** class X { [public|private]* [get|set] foo:number; ***REMOVED*** */
        memberGetAccessorElement = "getter",
        memberSetAccessorElement = "setter",
        /**
         * class X { [public|private]* foo:number; ***REMOVED***
         * interface Y { foo:number; ***REMOVED***
         */
        memberVariableElement = "property",
        /** class X { [public|private]* accessor foo: number; ***REMOVED*** */
        memberAccessorVariableElement = "accessor",
        /**
         * class X { constructor() { ***REMOVED*** ***REMOVED***
         * class X { static { ***REMOVED*** ***REMOVED***
         */
        constructorImplementationElement = "constructor",
        /** interface Y { ():number; ***REMOVED*** */
        callSignatureElement = "call",
        /** interface Y { []:number; ***REMOVED*** */
        indexSignatureElement = "index",
        /** interface Y { new():Y; ***REMOVED*** */
        ...
        /**
         * <JsxTagName attribute1 attribute2={0***REMOVED*** />
         * @deprecated
         */
        jsxAttribute = "JSX attribute",
        /** String literal */
        string = "string",
        /** Jsdoc @link: in `{@link C link text***REMOVED***`, the before and after text "{@link " and "***REMOVED***" */
        link = "link",
        /** Jsdoc @link: in `{@link C link text***REMOVED***`, the entity name "C" */
        linkName = "link name",
        /** Jsdoc @link: in `{@link C link text***REMOVED***`, the link text "link text" */
        linkText = "link text"
    ***REMOVED***
...
declare namespace ts.server {
    ...
    ***REMOVED*** | {
        ...
        ***REMOVED***;
    ***REMOVED***;
    /** @deprecated Use {@link ModuleImportResult***REMOVED*** instead. */
...
declare namespace ts.server.protocol {
    ...
    ***REMOVED***
    interface ReferencesResponseItem extends FileSpanWithContext {
         ...
         *
         * If {@link UserPreferences.disableLineTextInReferences***REMOVED*** is enabled, the property won't be filled
         */
        lineText?: string;
        /**
    ...
    ***REMOVED***
    interface CompletionEntryLabelDetails {
         ...
         * {@link CompletionEntry.name name***REMOVED***, without any spacing. Should be
         * used for function signatures or type annotations.
         */
        detail?: string;
        /**
         * An optional string which is rendered less prominently after
         * {@link CompletionEntryLabelDetails.detail***REMOVED***. Should be used for fully qualified
         * names or file path.
         */
        description?: string;
    ***REMOVED***
    ...
    ***REMOVED***
    interface UserPreferences {
         ...
         * `import write|` to be completed to `import { writeFile ***REMOVED*** from "fs"`.
         */
        readonly includeCompletionsForImportStatements?: boolean;
        /**
         ...
         * E.g., `class A { f| ***REMOVED***` could be completed to `class A { foo(): number {***REMOVED*** ***REMOVED***`, instead of
         * `class A { foo ***REMOVED***`.
         */
        readonly includeCompletionsWithClassMemberSnippets?: boolean;
        /**
         ...
         * E.g., `const objectLiteral: T = { f| ***REMOVED***` could be completed to `const objectLiteral: T = { foo(): void {***REMOVED*** ***REMOVED***`,
         * in addition to `const objectLiteral: T = { foo ***REMOVED***`.
         */
        readonly includeCompletionsWithObjectLiteralMethodSnippets?: boolean;
        /**
         * Indicates whether {@link CompletionEntry.labelDetails completion entry label details***REMOVED*** are supported.
         * If not, contents of `labelDetails` may be included in the {@link CompletionEntry.name***REMOVED*** property.
         */
        readonly useLabelDetailsInCompletionEntries?: boolean;
        readonly allowIncompleteCompletions?: boolean;
        readonly importModuleSpecifierPreference?: "shortest" | "project-relative" | "relative" | "non-relative";
        ...
        readonly autoImportFileExcludePatterns?: string[];
        /**
         * Indicates whether {@link ReferencesResponseItem.lineText***REMOVED*** is supported.
         */
...
declare namespace ts.server {
    ...
    ***REMOVED***) => PluginModule;
    abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
        ...
        static resolveModule(moduleName: string, initialDir: string, host: ServerHost, log: (message: string) => void, logErrors?: (message: string) => void): {***REMOVED*** | undefined;
        isKnownTypesPackageName(name: string): boolean;
        installPackage(options: InstallPackageOptions): Promise<ApplyCodeActionCommandResult>;
...
declare namespace ts {
    ...
    ***REMOVED***;
    ...
    const createJSDocAugmentsTag: (tagName: Identifier | undefined, className: ExpressionWithTypeArguments & {
        readonly expression: Identifier | PropertyAccessEntityNameExpression;
    ***REMOVED***, comment?: string | NodeArray<JSDocComment> | undefined) => JSDocAugmentsTag;
    ...
    const createJSDocImplementsTag: (tagName: Identifier | undefined, className: ExpressionWithTypeArguments & {
        readonly expression: Identifier | PropertyAccessEntityNameExpression;
    ***REMOVED***, comment?: string | NodeArray<JSDocComment> | undefined) => JSDocImplementsTag;
