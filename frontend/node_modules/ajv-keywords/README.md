...
__Please note__: `{prohibited: ['foo', 'bar']***REMOVED***` is equivalent to `{not: {anyRequired: ['foo', 'bar']***REMOVED******REMOVED***` (i.e. it has the same validation result for any data).
