...
assert.deepEqual([...matchAll(str, globalRegex)], [
	Object.assign(['a'], { index: 0, input: str, groups: undefined ***REMOVED***),
	Object.assign(['a'], { index: 1, input: str, groups: undefined ***REMOVED***),
	Object.assign(['c'], { index: 3, input: str, groups: undefined ***REMOVED***),
]);
