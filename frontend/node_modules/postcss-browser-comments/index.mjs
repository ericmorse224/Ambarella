...
const plugin = opts => {
  return {
    ...
    Once(root) {
      ...
      ***REMOVED***); // root children references
          ...
          if (browserdata.isNumbered) {
            rule.nodes.filter(isBrowserReferenceCommentNode).map(comment => {
              ...
              if (removeRule) {
                ...
                comment.remove();
              ***REMOVED***
            ***REMOVED***); // conditionally remove the empty rule and comment
