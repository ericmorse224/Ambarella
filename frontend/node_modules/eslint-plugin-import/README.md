...
{
  "rules": {
    "import/no-unresolved": ["error", { "commonjs": true, "amd": true ***REMOVED***]
    "import/named": "error",
...
module.exports = {
  settings: {
    'import/resolver': {
      'my-awesome-npm-module': { someConfig: value ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
module.exports = {
  settings: {
    'import/resolver': {
      [path.resolve('../../../my-resolver')]: { someConfig: value ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
Note that `${project***REMOVED***/code` matches the `code` provided at `folders[0].path`.
