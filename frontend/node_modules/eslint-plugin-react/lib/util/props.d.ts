 ...
 * @returns {boolean***REMOVED*** `true` if the node is a propTypes declaration, `false` if not
 */
 ...
 * @returns {boolean***REMOVED*** `true` if the node is a contextTypes declaration, `false` if not
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is a contextType declaration, `false` if not
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is a childContextTypes declaration, `false` if not
 */
 ...
 * @returns {boolean***REMOVED*** True if we are declaring a display name, false if not.
 */
 ...
 * @param {ASTNode***REMOVED*** propTypeExpression node to check. Must be a `PropTypes` MemberExpression.
 * @returns {boolean***REMOVED*** `true` if this PropType is required, `false` if not.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to get the type arguments from.
 * @returns {ASTNode***REMOVED*** The type arguments or type parameters of the node.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to get the super type arguments from.
 * @returns {ASTNode***REMOVED*** The super type arguments or parameters of the node.
 */
