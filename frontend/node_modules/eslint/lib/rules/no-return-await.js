...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {ASTNode***REMOVED*** node The node representing the `await` expression to report
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A node representing a location where an could be thrown
		 * @returns {boolean***REMOVED*** `true` if a thrown error will be caught/handled in this function
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A node representing the `await` expression to check
		 * @returns {boolean***REMOVED*** The checking result
		 */
