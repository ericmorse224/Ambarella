...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unexpectedSpaceAfterMarker: "Unexpected space or tab after marker ({{refChar***REMOVED******REMOVED***) in comment.",
            expectedExceptionAfter: "Expected exception block, space or tab after '{{refChar***REMOVED******REMOVED***' in comment.",
            unexpectedSpaceBefore: "Unexpected space or tab before '*/' in comment.",
            unexpectedSpaceAfter: "Unexpected space or tab after '{{refChar***REMOVED******REMOVED***' in comment.",
            expectedSpaceBefore: "Expected space or tab before '*/' in comment.",
            expectedSpaceAfter: "Expected space or tab after '{{refChar***REMOVED******REMOVED***' in comment."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
        ...
        const styleRules = ["block", "line"].reduce((rule, type) => {
            ...
            rule[type] = {
                ...
                endRegex: balanced && requireSpace ? new RegExp(`${createExceptionsPattern(exceptions)***REMOVED***$`, "u") : new RegExp(endNeverPattern, "u"),
                hasExceptions: exceptions.length > 0,
                captureMarker: new RegExp(`^(${markers.map(escape).join("|")***REMOVED***)`, "u"),
