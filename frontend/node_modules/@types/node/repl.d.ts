 ...
 */
declare module "repl" {
    import { AsyncCompleter, Completer, Interface ***REMOVED*** from "node:readline";
    ...
    ***REMOVED***
    /**
     * Instances of `repl.REPLServer` are created using the {@link start***REMOVED*** method
     * or directly using the JavaScript `new` keyword.
     *
     * ```js
     * import repl from 'node:repl';
     *
     * const options = { useColors: true ***REMOVED***;
     *
    ...
    class REPLServer extends Interface {
         ...
         * import repl from 'node:repl';
         *
         * const replServer = repl.start({ prompt: '> ' ***REMOVED***);
         * replServer.defineCommand('sayhello', {
         *   help: 'Say hello',
         *   action(name) {
         *     this.clearBufferedCommand();
         *     console.log(`Hello, ${name***REMOVED***!`);
         *     this.displayPrompt();
         *   ***REMOVED***,
         * ***REMOVED***);
    ...
    ***REMOVED***
    ...
    /**
     * The `repl.start()` method creates and starts a {@link REPLServer***REMOVED*** instance.
     *
