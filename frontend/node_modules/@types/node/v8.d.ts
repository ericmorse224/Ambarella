...
declare module "v8" {
    ...
    ***REMOVED***
     ...
     * setTimeout(() => { v8.setFlagsFromString('--notrace_gc'); ***REMOVED***, 60e3);
     * ```
     * @since v1.0.0
     */
     ...
     *
     * ```js
     * import { queryObjects ***REMOVED*** from 'node:v8';
     * class A { foo = 'bar'; ***REMOVED***
     * console.log(queryObjects(A)); // 0
     * const a = new A();
     * console.log(queryObjects(A)); // 1
     * // [ "A { foo: 'bar' ***REMOVED***" ]
     * console.log(queryObjects(A, { format: 'summary' ***REMOVED***));
     *
     * class B extends A { bar = 'qux'; ***REMOVED***
     * const b = new B();
     * console.log(queryObjects(B)); // 1
     * // [ "B { foo: 'bar', bar: 'qux' ***REMOVED***" ]
     * console.log(queryObjects(B, { format: 'summary' ***REMOVED***));
     *
     ...
     * // [ "B { foo: 'bar', bar: 'qux' ***REMOVED***", 'A {***REMOVED***', "A { foo: 'bar' ***REMOVED***" ]
     * console.log(queryObjects(A, { format: 'summary' ***REMOVED***));
     * ```
    ...
    function queryObjects(ctor: Function, options: { format: "count" ***REMOVED***): number;
    function queryObjects(ctor: Function, options: { format: "summary" ***REMOVED***): string[];
    /**
     ...
     *
     * ```js
     * import { writeHeapSnapshot ***REMOVED*** from 'node:v8';
     * import {
     *   Worker,
     *   isMainThread,
     *   parentPort,
     * ***REMOVED*** from 'node:worker_threads';
     *
     * if (isMainThread) {
     *   const worker = new Worker(__filename);
     *
     *   worker.once('message', (filename) => {
     *     console.log(`worker heapdump: ${filename***REMOVED***`);
     *     // Now get a heapdump for the main thread.
     *     console.log(`main thread heapdump: ${writeHeapSnapshot()***REMOVED***`);
     *   ***REMOVED***);
     *
     ...
     * ```
     * @since v11.13.0
     * @param filename The file path where the V8 heap snapshot is to be saved. If not specified, a file name with the pattern `'Heap-${yyyymmdd***REMOVED***-${hhmmss***REMOVED***-${pid***REMOVED***-${thread_id***REMOVED***.heapsnapshot'` will be
     * generated, where `{pid***REMOVED***` will be the PID of the Node.js process, `{thread_id***REMOVED***` will be `0` when `writeHeapSnapshot()` is called from the main Node.js thread or the id of a
     * worker thread.
    ...
    ***REMOVED***
     ...
     * from a buffer.
     * @since v8.0.0
     * @param buffer A buffer returned by {@link serialize***REMOVED***.
     */
     ...
     * disk unless {@link stopCoverage***REMOVED*** is invoked before the process exits.
     ...
     * records and optimize code. This can be used in conjunction with {@link takeCoverage***REMOVED*** if the user wants to collect the coverage on demand.
     * @since v15.1.0, v14.18.0, v12.22.0
     */
    ...
    class GCProfiler {
         ...
         *
         * ```js
         * import { GCProfiler ***REMOVED*** from 'node:v8';
    ...
    ***REMOVED***
    /**
     * Called when the promise receives a resolution or rejection value. This may occur synchronously in the case of {@link Promise.resolve()***REMOVED*** or
     * {@link Promise.reject()***REMOVED***.
     * @since v17.1.0, v16.14.0
     */
    interface Settled {
        (promise: Promise<unknown>): void;
    ...
    ***REMOVED***
    interface PromiseHooks {
         ...
         * @since v17.1.0, v16.14.0
         * @param init The {@link Init | `init` callback***REMOVED*** to call when a promise is created.
         ...
         * @since v17.1.0, v16.14.0
         * @param settled The {@link Settled | `settled` callback***REMOVED*** to call when a promise is created.
         * @return Call to stop the hook.
         */
         ...
         * @since v17.1.0, v16.14.0
         * @param before The {@link Before | `before` callback***REMOVED*** to call before a promise continuation executes.
         * @return Call to stop the hook.
         */
         ...
         * @since v17.1.0, v16.14.0
         * @param after The {@link After | `after` callback***REMOVED*** to call after a promise continuation executes.
         * @return Call to stop the hook.
         */
         ...
         * @since v17.1.0, v16.14.0
         * @param callbacks The {@link HookCallbacks | Hook Callbacks***REMOVED*** to register
    ...
    ***REMOVED***
     ...
     *   const name = `${book***REMOVED***.${lang***REMOVED***.txt`;
