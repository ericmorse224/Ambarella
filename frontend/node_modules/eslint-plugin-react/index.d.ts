export = plugin;
/** @typedef {{ plugins: { react: typeof plugin ***REMOVED***, rules: import('eslint').Linter.RulesRecord, languageOptions: { parserOptions: import('eslint').Linter.ParserOptions ***REMOVED*** ***REMOVED******REMOVED*** ReactFlatConfig */
/** @type {{ deprecatedRules: typeof deprecatedRules, rules: typeof allRules, configs: typeof configs & { flat: Record<string, ReactFlatConfig> ***REMOVED******REMOVED******REMOVED*** */
...
declare namespace plugin {
    export { ReactFlatConfig ***REMOVED***;
***REMOVED***
/** @type {Partial<typeof allRules>***REMOVED*** */
