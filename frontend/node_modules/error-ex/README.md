...
To add a stack line:
```javascript
var JSONError = errorEx('JSONError', {fileName: errorEx.line('in %s')***REMOVED***);
...
```javascript
var JSONError = errorEx('JSONError', {fileName: errorEx.append('in %s')***REMOVED***);
...
var FileError = errorEx('FileError', {fileName: errorEx.line('in %s')***REMOVED***);
...
var SyntaxError = errorEx('SyntaxError', {fileName: errorEx.append('in %s')***REMOVED***);
