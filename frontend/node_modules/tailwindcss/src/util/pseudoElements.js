/** @typedef {import('postcss-selector-parser').Root***REMOVED*** Root */
/** @typedef {import('postcss-selector-parser').Selector***REMOVED*** Selector */
/** @typedef {import('postcss-selector-parser').Pseudo***REMOVED*** Pseudo */
/** @typedef {import('postcss-selector-parser').Node***REMOVED*** Node */
...
/** @typedef {'terminal' | 'actionable' | 'jumpable'***REMOVED*** PseudoProperty */

/** @type {Record<string, PseudoProperty[]>***REMOVED*** */
...
/** @typedef {[sel: Selector, pseudo: Pseudo, attachedTo: Pseudo | null]***REMOVED*** MovablePseudo */
/** @typedef {[pseudos: MovablePseudo[], lastSeenElement: Pseudo | null]***REMOVED*** MovablePseudosResult */
...
function movablePseudos(sel) {
  /** @type {MovablePseudo[]***REMOVED*** */
  let buffer = []

  /** @type {Pseudo | null***REMOVED*** */
