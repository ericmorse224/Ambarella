...
> type: `{ [type: string]: string[] | undefined ***REMOVED***`
...
const node = {
    ...
    left: { type: "Identifier", name: "foo" ***REMOVED***,
    right: { type: "Literal", value: 0 ***REMOVED***
***REMOVED***
...
> type: `(additionalKeys: object) => { [type: string]: string[] | undefined ***REMOVED***`
...
***REMOVED***)) // → { ..., MethodDefinition: ["decorators", "key", "value"], ... ***REMOVED***
```
