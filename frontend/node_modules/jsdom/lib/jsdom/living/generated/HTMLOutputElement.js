...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'HTMLOutputElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(HTMLOutputElement.prototype, {
    ...
    [Symbol.toStringTag]: { value: "HTMLOutputElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
