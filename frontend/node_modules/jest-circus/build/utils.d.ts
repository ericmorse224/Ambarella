 ...
 */
import type { AssertionResult ***REMOVED*** from '@jest/test-result';
import type { Circus ***REMOVED*** from '@jest/types';
...
export declare const callAsyncCircusFn: (testOrHook: Circus.TestEntry | Circus.Hook, testContext: Circus.TestContext | undefined, { isHook, timeout ***REMOVED***: {
    isHook: boolean;
    timeout: number;
***REMOVED***) => Promise<unknown>;
