...
Framer.prototype._split = function _split (frame) {
  ...
  for (var i = 0; i < frame.chunks.length; i++) { buf.push(frame.chunks[i]) ***REMOVED***
  ...
  frames.forEach(function (subFrame, i) {
    ...
    ***REMOVED***
    ...
    this._frame({
      ...
      flags: flags
    ***REMOVED***, function (buf) {
      // Fill those reserved bytes
      if (isFirst && body) { body(buf) ***REMOVED***

      buf.reserve(subFrame.size)
      for (var i = 0; i < subFrame.chunks.length; i++) { buf.copyFrom(subFrame.chunks[i]) ***REMOVED***
    ***REMOVED***, isLast ? callback : null)
  ***REMOVED***, this)
...
Framer.prototype._compressHeaders = function _compressHeaders (headers,
  pairs,
  callback) {
  Object.keys(headers || {***REMOVED***).forEach(function (name) {
...
Framer.prototype._isDefaultPriority = function _isDefaultPriority (priority) {
  if (!priority) { return true ***REMOVED***
...
Framer.prototype._defaultHeaders = function _defaultHeaders (frame, pairs) {
  ...
  ***REMOVED***)
  pairs.push({ name: ':path', value: frame.path ***REMOVED***)
  pairs.push({ name: ':scheme', value: frame.scheme || 'https' ***REMOVED***)
  pairs.push({
    name: ':authority',
    value: frame.host ||
...
Framer.prototype._headersFrame = function _headersFrame (kind, frame, callback) {
  ...
  ***REMOVED*** else if (kind === 'response') {
    pairs.push({ name: ':status', value: (frame.status || 200) + '' ***REMOVED***)
  ***REMOVED***
  ...
  this._compressHeaders(frame.headers, pairs, function (err, chunks) {
    ...
    ***REMOVED***
    ...
    if (!self._isDefaultPriority(priority)) { reserve = 5 ***REMOVED***
  ...
  ***REMOVED***
  ...
  this._checkPush(function (err) {
    ...
    ***REMOVED***
    ...
    pairs.response.push({ name: ':status', value: (frame.status || 200) + '' ***REMOVED***)
  ...
  for (var i = 0; i < constants.settingsIndex.length; i++) {
    ...
    ***REMOVED***
    ...
    if (options[name] !== undefined) {
      params.push({ key: i, value: options[name] ***REMOVED***)
    ***REMOVED***
  ***REMOVED***
...
Framer.prototype.goawayFrame = function goawayFrame (frame, callback) {
  ...
  ***REMOVED***, function (buf) {
    ...
    if (frame.extra) { buf.write(frame.extra) ***REMOVED***
  ***REMOVED***, callback)
***REMOVED***
