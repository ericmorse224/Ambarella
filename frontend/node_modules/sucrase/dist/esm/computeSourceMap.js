import {GenMapping, maybeAddSegment, toEncodedMap***REMOVED*** from "@jridgewell/gen-mapping";
...
export default function computeSourceMap(
  ...
  const map = new GenMapping({file: options.compiledFilename***REMOVED***);
  let tokenIndex = 0;
  ...
  ***REMOVED***
  for (let i = 0; i < generatedCode.length; i++) {
    ...
    ***REMOVED***
  ***REMOVED***
  const {sourceRoot, sourcesContent, ...sourceMap***REMOVED*** = toEncodedMap(map);
  return sourceMap ;
***REMOVED***
