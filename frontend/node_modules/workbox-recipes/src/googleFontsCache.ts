 ...
 */
function googleFontsCache(options: GoogleFontCacheOptions = {***REMOVED***): void {
  ...
  registerRoute(
    ({url***REMOVED***) => url.origin === 'https://fonts.googleapis.com',
  ...
  registerRoute(
    ({url***REMOVED***) => url.origin === 'https://fonts.gstatic.com',
    new CacheFirst({
...
export {googleFontsCache***REMOVED***;
