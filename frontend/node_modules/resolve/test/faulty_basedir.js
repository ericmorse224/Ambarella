...
test('faulty basedir must produce error in windows', { skip: process.platform !== 'win32' ***REMOVED***, function (t) {
    t.plan(1);

    var resolverDir = 'C:\\a\\b\\c\\d';

    resolve('tape/lib/test.js', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
        t.equal(!!err, true);
    ***REMOVED***);
***REMOVED***);
