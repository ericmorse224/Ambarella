				...
				const handler = (parser, parserOptions) => {
					...
					parser.hooks.expression
						...
						.tap(
							...
							toConstantDependency(
								parser,
								`${RuntimeGlobals.moduleCache***REMOVED***[${RuntimeGlobals.entryModuleId***REMOVED***]`,
...
class HarmonyModuleDecoratorRuntimeModule extends RuntimeModule {
	...
	***REMOVED***
	 ...
	 */
	generate() {
		const { runtimeTemplate ***REMOVED*** = /** @type {Compilation***REMOVED*** */ (this.compilation);
		return Template.asString([
			`${
				RuntimeGlobals.harmonyModuleDecorator
			***REMOVED*** = ${runtimeTemplate.basicFunction("module", [
...
class NodeModuleDecoratorRuntimeModule extends RuntimeModule {
	...
	***REMOVED***
	...
	generate() {
		const { runtimeTemplate ***REMOVED*** = /** @type {Compilation***REMOVED*** */ (this.compilation);
		return Template.asString([
			`${RuntimeGlobals.nodeModuleDecorator***REMOVED*** = ${runtimeTemplate.basicFunction(
				"module",
				[
					"module.paths = [];",
					"if (!module.children) module.children = [];",
