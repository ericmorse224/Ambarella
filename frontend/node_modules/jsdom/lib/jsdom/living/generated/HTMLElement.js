...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'HTMLElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(HTMLElement.prototype, {
    click: { enumerable: true ***REMOVED***,
    focus: { enumerable: true ***REMOVED***,
    blur: { enumerable: true ***REMOVED***,
    title: { enumerable: true ***REMOVED***,
    lang: { enumerable: true ***REMOVED***,
    translate: { enumerable: true ***REMOVED***,
    dir: { enumerable: true ***REMOVED***,
    hidden: { enumerable: true ***REMOVED***,
    accessKey: { enumerable: true ***REMOVED***,
    draggable: { enumerable: true ***REMOVED***,
    offsetParent: { enumerable: true ***REMOVED***,
    offsetTop: { enumerable: true ***REMOVED***,
    offsetLeft: { enumerable: true ***REMOVED***,
    offsetWidth: { enumerable: true ***REMOVED***,
    offsetHeight: { enumerable: true ***REMOVED***,
    style: { enumerable: true ***REMOVED***,
    onabort: { enumerable: true ***REMOVED***,
    onauxclick: { enumerable: true ***REMOVED***,
    onblur: { enumerable: true ***REMOVED***,
    oncancel: { enumerable: true ***REMOVED***,
    oncanplay: { enumerable: true ***REMOVED***,
    oncanplaythrough: { enumerable: true ***REMOVED***,
    onchange: { enumerable: true ***REMOVED***,
    onclick: { enumerable: true ***REMOVED***,
    onclose: { enumerable: true ***REMOVED***,
    oncontextmenu: { enumerable: true ***REMOVED***,
    oncuechange: { enumerable: true ***REMOVED***,
    ondblclick: { enumerable: true ***REMOVED***,
    ondrag: { enumerable: true ***REMOVED***,
    ondragend: { enumerable: true ***REMOVED***,
    ondragenter: { enumerable: true ***REMOVED***,
    ondragleave: { enumerable: true ***REMOVED***,
    ondragover: { enumerable: true ***REMOVED***,
    ondragstart: { enumerable: true ***REMOVED***,
    ondrop: { enumerable: true ***REMOVED***,
    ondurationchange: { enumerable: true ***REMOVED***,
    onemptied: { enumerable: true ***REMOVED***,
    onended: { enumerable: true ***REMOVED***,
    onerror: { enumerable: true ***REMOVED***,
    onfocus: { enumerable: true ***REMOVED***,
    oninput: { enumerable: true ***REMOVED***,
    oninvalid: { enumerable: true ***REMOVED***,
    onkeydown: { enumerable: true ***REMOVED***,
    onkeypress: { enumerable: true ***REMOVED***,
    onkeyup: { enumerable: true ***REMOVED***,
    onload: { enumerable: true ***REMOVED***,
    onloadeddata: { enumerable: true ***REMOVED***,
    onloadedmetadata: { enumerable: true ***REMOVED***,
    onloadend: { enumerable: true ***REMOVED***,
    onloadstart: { enumerable: true ***REMOVED***,
    onmousedown: { enumerable: true ***REMOVED***,
    onmouseenter: { enumerable: true ***REMOVED***,
    onmouseleave: { enumerable: true ***REMOVED***,
    onmousemove: { enumerable: true ***REMOVED***,
    onmouseout: { enumerable: true ***REMOVED***,
    onmouseover: { enumerable: true ***REMOVED***,
    onmouseup: { enumerable: true ***REMOVED***,
    onwheel: { enumerable: true ***REMOVED***,
    onpause: { enumerable: true ***REMOVED***,
    onplay: { enumerable: true ***REMOVED***,
    onplaying: { enumerable: true ***REMOVED***,
    onprogress: { enumerable: true ***REMOVED***,
    onratechange: { enumerable: true ***REMOVED***,
    onreset: { enumerable: true ***REMOVED***,
    onresize: { enumerable: true ***REMOVED***,
    onscroll: { enumerable: true ***REMOVED***,
    onsecuritypolicyviolation: { enumerable: true ***REMOVED***,
    onseeked: { enumerable: true ***REMOVED***,
    onseeking: { enumerable: true ***REMOVED***,
    onselect: { enumerable: true ***REMOVED***,
    onstalled: { enumerable: true ***REMOVED***,
    onsubmit: { enumerable: true ***REMOVED***,
    onsuspend: { enumerable: true ***REMOVED***,
    ontimeupdate: { enumerable: true ***REMOVED***,
    ontoggle: { enumerable: true ***REMOVED***,
    onvolumechange: { enumerable: true ***REMOVED***,
    onwaiting: { enumerable: true ***REMOVED***,
    dataset: { enumerable: true ***REMOVED***,
    nonce: { enumerable: true ***REMOVED***,
    tabIndex: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "HTMLElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
