...
=================
  ...
  * [New] `ES2015`+: add `IntegerIndexedElement{Get,Set***REMOVED***`
  * [New] `ES2018`+: add `TimeZoneString`
  * [New] `ES2022`+: add `DefineMethodProperty`
  * [New] `ES2023`: add `DefaultTimeZone`
  * [Fix] `ES2023`+: `SetTypedArrayFrom{TypedArray,ArrayLike***REMOVED***`: match engine reality
...
=================
  ...
  * [Tests] use `define-{accessor,data***REMOVED***-property`
...
=================
  ...
  * [Fix] `ES2015+`: `GetOwnPropertyKeys`/`IsExtensible`/`{Set,Test***REMOVED***IntegrityLevel`: avoid a crash in IE 8 on missing ES5 intrinsics
...
=================
  ...
  * [Robustness]: `ES2015+`: ensure `Math.{abs,floor***REMOVED***` and `Function.call` are cached
