...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {ASTNode***REMOVED*** nodeA The first node
		 * @param {ASTNode***REMOVED*** nodeB The second node
		 * @returns {boolean***REMOVED*** true if the nodes have identical token representations
		 */
		...
		return {
			BinaryExpression(node) {
				...
				if (
					...
					context.report({ node, messageId: "comparingToSelf" ***REMOVED***);
				***REMOVED***
			***REMOVED***,
		***REMOVED***;
	***REMOVED***,
