...
```js
import { className ***REMOVED*** from "file.css";
```
...
```js
import sheet from "./styles.css" assert { type: "css" ***REMOVED***;
...
// import sheet from "./styles.scss" assert { type: "css" ***REMOVED***;

// Example for CSS modules:
// import sheet, { myClass ***REMOVED*** from "./styles.scss" assert { type: "css" ***REMOVED***;
          ...
          ***REMOVED***,
          {
            ...
            options: { plugins: () => [postcssPresetEnv({ stage: 0 ***REMOVED***)] ***REMOVED***,
          ***REMOVED***,
          // Can be `less-loader`
          {
            loader: "sass-loader",
...
// <div className={styles.componentClass***REMOVED***>
//   <canvas ref={mountsCanvas***REMOVED***/>
// </div>

// Somewhere in JavaScript canvas drawing code use the variable directly
// const ctx = mountsCanvas.current.getContext('2d',{alpha: false***REMOVED***);
ctx.fillStyle = `${svars.colorBackgroundCanvas***REMOVED***`;
```
