...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-restricted-paths') ***REMOVED***,
          ...
          items: {
            ...
            properties: {
              ...
              from: {
                ...
                uniqueItems: true ***REMOVED***,

              message: { type: 'string' ***REMOVED*** ***REMOVED***,

            additionalProperties: false ***REMOVED*** ***REMOVED***,


        basePath: { type: 'string' ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function noRestrictedPaths(context) {
      ...
      function (zone) {return [].concat(zone.target).
        map(function (target) {return _path2['default'].resolve(basePath, target);***REMOVED***).
        some(function (targetPath) {return isMatchingTargetPath(currentFilename, targetPath);***REMOVED***);***REMOVED***);
      ...
      ***REMOVED***
      ...
      function areBothGlobPatternAndAbsolutePath(areGlobPatterns) {
        return areGlobPatterns.some(function (isGlob) {return isGlob;***REMOVED***) && areGlobPatterns.some(function (isGlob) {return !isGlob;***REMOVED***);
      ***REMOVED***

      function reportInvalidExceptionPath(node) {
        context.report({
          node: node,
          message: 'Restricted path exceptions must be descendants of the configured `from` path for that zone.' ***REMOVED***);
      ...
      ***REMOVED***
      ...
      function reportInvalidExceptionMixedGlobAndNonGlob(node) {
        context.report({
          node: node,
          message: 'Restricted path `from` must contain either only glob patterns or none' ***REMOVED***);
      ...
      ***REMOVED***
      ...
      function reportInvalidExceptionGlob(node) {
        context.report({
          node: node,
          message: 'Restricted path exceptions must be glob patterns when `from` contains glob patterns' ***REMOVED***);

      ***REMOVED***

      function computeMixedGlobAndAbsolutePathValidator() {
        return {
          isPathRestricted: function () {function isPathRestricted() {return true;***REMOVED***return isPathRestricted;***REMOVED***(),
          hasValidExceptions: false,
          reportInvalidException: reportInvalidExceptionMixedGlobAndNonGlob ***REMOVED***;
      ...
      ***REMOVED***
      ...
      function computeGlobPatternPathValidator(absoluteFrom, zoneExcept) {
        ...
        var isPathRestricted = function () {function isPathRestricted(absoluteImportPath) {return mm.match(absoluteImportPath);***REMOVED***return isPathRestricted;***REMOVED***();
        var hasValidExceptions = zoneExcept.every(_isGlob2['default']);

        if (hasValidExceptions) {
          var exceptionsMm = zoneExcept.map(function (except) {return new _minimatch.Minimatch(except);***REMOVED***);
          isPathException = function () {function isPathException(absoluteImportPath) {return exceptionsMm.some(function (mm) {return mm.match(absoluteImportPath);***REMOVED***);***REMOVED***return isPathException;***REMOVED***();
        ***REMOVED***
        ...
        return {
          ...
          reportInvalidException: reportInvalidException ***REMOVED***;
      ...
      ***REMOVED***
      ...
      function computeAbsolutePathValidator(absoluteFrom, zoneExcept) {
        ...
        var isPathRestricted = function () {function isPathRestricted(absoluteImportPath) {return containsPath(absoluteImportPath, absoluteFrom);***REMOVED***return isPathRestricted;***REMOVED***();

        var absoluteExceptionPaths = zoneExcept.
        map(function (exceptionPath) {return _path2['default'].resolve(absoluteFrom, exceptionPath);***REMOVED***);
        var hasValidExceptions = absoluteExceptionPaths.
        every(function (absoluteExceptionPath) {return isValidExceptionPath(absoluteFrom, absoluteExceptionPath);***REMOVED***);

        if (hasValidExceptions) {
          isPathException = function () {function isPathException(absoluteImportPath) {return absoluteExceptionPaths.some(
              function (absoluteExceptionPath) {return containsPath(absoluteImportPath, absoluteExceptionPath);***REMOVED***);***REMOVED***return isPathException;***REMOVED***();
      ...
      ***REMOVED***
      ...
      function reportInvalidExceptions(validators, node) {
        validators.forEach(function (validator) {return validator.reportInvalidException(node);***REMOVED***);
      ***REMOVED***
      ...
      function reportImportsInRestrictedZone(validators, node, importPath, customMessage) {
        validators.forEach(function () {
          context.report({
            node: node,
            message: 'Unexpected path "{{importPath***REMOVED******REMOVED***" imported in restricted zone.' + (customMessage ? ' ' + String(customMessage) : ''),
            data: { importPath: importPath ***REMOVED*** ***REMOVED***);
      ...
      ***REMOVED***
      ...
      var makePathValidators = function () {function makePathValidators(zoneFrom) {var zoneExcept = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
          ...
          ***REMOVED***
          ...
          var isGlobPattern = areGlobPatterns.every(function (isGlob) {return isGlob;***REMOVED***);
          ...
          ***REMOVED***);
        ***REMOVED***return makePathValidators;***REMOVED***();
        ...
        ***REMOVED***
        ...
        matchingZones.forEach(function (zone, index) {
          ...
          ***REMOVED***
          ...
          var applicableValidatorsForImportPath = validators[index].filter(function (validator) {return validator.isPathRestricted(absoluteImportPath);***REMOVED***);

          var validatorsWithInvalidExceptions = applicableValidatorsForImportPath.filter(function (validator) {return !validator.hasValidExceptions;***REMOVED***);
          ...
          filter(function (validator) {return validator.hasValidExceptions && !validator.isPathException(absoluteImportPath);***REMOVED***);
      ...
      ***REMOVED***, { commonjs: true ***REMOVED***);
    ***REMOVED***return noRestrictedPaths;***REMOVED***() ***REMOVED***;
