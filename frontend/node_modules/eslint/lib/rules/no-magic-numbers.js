 ...
 * @param {bigint|number|string***REMOVED*** x The value to normalize.
 * @returns {bigint|number***REMOVED*** The normalized value.
 */
	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			noMagic: "No magic number: {{raw***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {bigint|number***REMOVED*** value The value to check
		 * @returns {boolean***REMOVED*** true if the value is ignored
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns {boolean***REMOVED*** true if the number is a default value
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns {boolean***REMOVED*** true if the number is the initial value of a class field.
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns {boolean***REMOVED*** true if the node is radix
		 */
		...
		***REMOVED***
		 ...
		 * Example: <input maxLength={10***REMOVED*** />
		 * @param {ASTNode***REMOVED*** fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @returns {boolean***REMOVED*** true if the node is a JSX number
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** fullNumberNode `Literal` or `UnaryExpression` full number node
		 * @param {bigint|number***REMOVED*** value Value expressed by the fullNumberNode
		 * @returns {boolean***REMOVED*** true if the node is a valid array index
		 */
