...
jsesc('foo 𝌆 bar 💩 baz', {
  'es6': true
***REMOVED***);
// → 'foo \\u{1D306***REMOVED*** bar \\u{1F4A9***REMOVED*** baz'
```
...
jsesc({ 'foo\x00bar\xFF\uFFFDbaz': 'foo\x00bar\xFF\uFFFDbaz' ***REMOVED***, {
  'json': true
***REMOVED***);
// → '{"foo\\u0000bar\\u00FF\\uFFFDbaz":"foo\\u0000bar\\u00FF\\uFFFDbaz"***REMOVED***'
...
jsesc([ 'foo\x00bar', [1, '©', { 'foo': true, 'qux': null ***REMOVED***], 42 ], {
  'json': true
***REMOVED***);
// → '["foo\\u0000bar",[1,"\\u00A9",{"foo":true,"qux":null***REMOVED***],42]'
...
```bash
$ jsesc --object '{ "föo": "♥", "bår": "𝌆 baz" ***REMOVED***'
{'f\xF6o':'\u2665','b\xE5r':'\uD834\uDF06 baz'***REMOVED***
```

To prettify the output in such cases, use the `-p`/`--pretty` option:

```bash
$ jsesc --pretty '{ "föo": "♥", "bår": "𝌆 baz" ***REMOVED***'
{
  'f\xF6o': '\u2665',
  'b\xE5r': '\uD834\uDF06 baz'
***REMOVED***
...
```bash
$ jsesc --json --pretty '{ "föo": "♥", "bår": "𝌆 baz" ***REMOVED***'
{
  "f\u00F6o": "\u2665",
  "b\u00E5r": "\uD834\uDF06 baz"
***REMOVED***
