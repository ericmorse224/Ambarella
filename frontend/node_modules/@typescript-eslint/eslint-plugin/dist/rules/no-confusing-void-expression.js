        ...
        schema: [
            {
                type: 'object',
                properties: {
                    ignoreArrowShorthand: { type: 'boolean' ***REMOVED***,
                    ignoreVoidOperator: { type: 'boolean' ***REMOVED***,
                ***REMOVED***,
            ...
            'AwaitExpression, CallExpression, TaggedTemplateExpression'(node) {
                ...
                ***REMOVED***
                ...
                const wrapVoidFix = (fixer) => {
                    ...
                    const newNodeText = `void ${nodeText***REMOVED***`;
                    ...
                    ***REMOVED***
                    ...
                    return context.report({
                        ...
                        fix(fixer) {
                            ...
                            const newArrowBodyText = `{ ${arrowBodyText***REMOVED***; ***REMOVED***`;
                    ...
                    if (isFinalReturn(returnStmt)) {
                        ...
                        return context.report({
                            ...
                            fix(fixer) {
                                ...
                                let newReturnStmtText = `${returnValueText***REMOVED***;`;
                                if (isPreventingASI(returnValue, sourceCode)) {
                                    // put a semicolon at the beginning of the line
                                    newReturnStmtText = `;${newReturnStmtText***REMOVED***`;
                                ***REMOVED***
                    ...
                    ***REMOVED***
                    ...
                    return context.report({
                        ...
                        fix(fixer) {
                            ...
                            const returnValue = returnStmt.argument;
                            const returnValueText = sourceCode.getText(returnValue);
                            let newReturnStmtText = `${returnValueText***REMOVED***; return;`;
                            if (isPreventingASI(returnValue, sourceCode)) {
                                // put a semicolon at the beginning of the line
                                newReturnStmtText = `;${newReturnStmtText***REMOVED***`;
                            ***REMOVED***
                            if (((_a = returnStmt.parent) === null || _a === void 0 ? void 0 : _a.type) !== utils_1.AST_NODE_TYPES.BlockStatement) {
                                ...
                                newReturnStmtText = `{ ${newReturnStmtText***REMOVED*** ***REMOVED***`;
                            ***REMOVED***
                            return fixer.replaceText(returnStmt, newReturnStmtText);
                        ***REMOVED***,
                    ***REMOVED***);
                ***REMOVED***
                ...
                if (options.ignoreVoidOperator) {
                    ...
                    return context.report({
                        ...
                        suggest: [{ messageId: 'voidExprWrapVoid', fix: wrapVoidFix ***REMOVED***],
                    ***REMOVED***);
                ***REMOVED***
                context.report({
                    node,
