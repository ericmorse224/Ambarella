...
module.exports = (request, options) => {
  ...
  ***REMOVED*** = options;
  ...
  if (process.versions.pnp) {
    ...
    if (!pnpApi) {
      try {
        const baseReq = createRequire(`${basedir***REMOVED***/internal.js`);
    ...
    ***REMOVED***
    ...
    if (pnpApi) {
      const resolution = pnpApi.resolveRequest(request, `${basedir***REMOVED***/`, {extensions***REMOVED***);
  ...
  ***REMOVED***
  ...
  return defaultResolver(request, {...options, allowPnp: false***REMOVED***);
***REMOVED***;
