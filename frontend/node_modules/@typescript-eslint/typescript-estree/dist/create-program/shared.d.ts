import type { Program ***REMOVED*** from 'typescript';
import * as ts from 'typescript';
import type { ModuleResolver ***REMOVED*** from '../parser-options';
import type { ParseSettings ***REMOVED*** from '../parseSettings';
...
export { ASTAndProgram, CORE_COMPILER_OPTIONS, canonicalDirname, CanonicalPath, createDefaultCompilerOptionsFromExtra, createHash, ensureAbsolutePath, getCanonicalFileName, getAstFromProgram, getModuleResolver, ***REMOVED***;
