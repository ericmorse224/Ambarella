...
const radixMap = new Map([
    [2, { system: "binary", literalPrefix: "0b" ***REMOVED***],
    [8, { system: "octal", literalPrefix: "0o" ***REMOVED***],
    [16, { system: "hexadecimal", literalPrefix: "0x" ***REMOVED***]
]);

/**
 * Checks to see if a CallExpression's callee node is `parseInt` or
 * `Number.parseInt`.
 * @param {ASTNode***REMOVED*** calleeNode The callee node to evaluate.
 * @returns {boolean***REMOVED*** True if the callee is `parseInt` or `Number.parseInt`,
 * false otherwise.
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            useLiteral: "Use {{system***REMOVED******REMOVED*** literals instead of {{functionName***REMOVED******REMOVED***()."
        ***REMOVED***,
        ...
        return {
            ...
            "CallExpression[arguments.length=2]"(node) {
                ...
                if (
                    ...
                    const { system, literalPrefix ***REMOVED*** = radixMap.get(radix);
                        ...
                        ***REMOVED***,
                        fix(fixer) {
                            ...
                            ***REMOVED***
                            ...
                            const replacement = `${literalPrefix***REMOVED***${str***REMOVED***`;
                            ...
                            ***REMOVED***
                            ...
                            return fixer.replaceText(node, `${prefix***REMOVED***${replacement***REMOVED***${suffix***REMOVED***`);
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED***
            ***REMOVED***
