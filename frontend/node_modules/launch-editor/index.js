...
function launchEditor (file, specifiedEditor, onErrorCallback) {
  ...
  let { fileName ***REMOVED*** = parsed
  const { lineNumber, columnNumber ***REMOVED*** = parsed
  ...
  ***REMOVED***
  ...
  if (process.platform === 'win32') {
    ...
    ***REMOVED***)
  ***REMOVED*** else {
    _childProcess = childProcess.spawn(editor, args, { stdio: 'inherit' ***REMOVED***)
  ***REMOVED***
  ...
  ***REMOVED***)
  ...
  _childProcess.on('error', function (error) {
    let { code, message ***REMOVED*** = error
    if ('ENOENT' === code) {
      message = `${message***REMOVED*** ('${editor***REMOVED***' command does not exist in 'PATH')`
    ***REMOVED***
