...
module.exports = {
	tests: function (from, name, t) {
		t['throws'](
			function () { return new from(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
			'`' + name + '` itself is not a constructor'
		);
		t['throws'](
			function () { return new from({***REMOVED***); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			if (typeof nonIterator !== 'string') {
				t['throws'](
					function () { from(nonIterator).next(); ***REMOVED***,
					TypeError,
		...
		***REMOVED***);
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			forEach(v.nonFunctions, function (nonFunction) {
				var badIterable = {***REMOVED***;
				badIterable[Symbol.iterator] = nonFunction;
				st['throws'](
					function () { from(badIterable).next(); ***REMOVED***,
					TypeError,
			...
			***REMOVED***);
			...
			st.test('__proto__ is Iterator.prototype', { skip: !hasProto ***REMOVED***, function (s2t) {
				var fakeIterator = {
					__proto__: iterProto,
			...
			***REMOVED***);
			...
			st.test('real iterators', { skip: !hasSymbols ***REMOVED***, function (s2t) {
				...
				s2t.equal(
					...
					{ skip: !arrayIterHasIterProto && 'node 0.12 - 3 do not have Iterator.prototype in the proto chains' ***REMOVED***
				);
