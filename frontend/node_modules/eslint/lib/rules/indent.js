...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			wrongIndentation:
				"Expected indentation of {{expected***REMOVED******REMOVED*** but found {{actual***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** expectedAmount The expected amount of indentation characters for this line
		 * @param {number***REMOVED*** actualSpaces The actual number of indentation spaces that were found on this line
		 * @param {number***REMOVED*** actualTabs The actual number of indentation tabs that were found on this line
		...
		function createErrorMessageData(
			...
			if (actualSpaces > 0) {
				...
				foundStatement =
					indentType === "space"
						? actualSpaces
						: `${actualSpaces***REMOVED*** ${foundSpacesWord***REMOVED***`;
			***REMOVED*** else if (actualTabs > 0) {
				foundStatement =
					indentType === "tab"
						? actualTabs
						: `${actualTabs***REMOVED*** ${foundTabsWord***REMOVED***`;
			***REMOVED*** else {
				foundStatement = "0";
			***REMOVED***
			return {
			...
			***REMOVED***
			...
			if (node.optional) {
				...
				const calleeParenCount = sourceCode.getTokensBetween(
					node.callee,
					dotToken,
					{ filter: astUtils.isClosingParenToken ***REMOVED***,
				).length;
		...
		***REMOVED***
		...
		function ignoreNode(node) {
			const unknownNodeTokens = new Set(
				sourceCode.getTokens(node, { includeComments: true ***REMOVED***),
			);
			...
			***REMOVED***,
			...
			ExportNamedDeclaration(node) {
				if (node.declaration === null) {
					...
					addElementListIndent(
						node.specifiers,
						sourceCode.getFirstToken(node, { skip: 1 ***REMOVED***),
						closingCurly,
						1,
					);
		...
		***REMOVED***;
		...
		for (const [selector, listener] of Object.entries(
			...
			offsetListeners[selector] = node =>
				listenerCallQueue.push({ listener, node ***REMOVED***);
		***REMOVED***
