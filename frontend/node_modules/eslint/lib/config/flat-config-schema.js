...
class InvalidRuleOptionsError extends Error {
    ...
    constructor(ruleId, value) {
        super(`Key "${ruleId***REMOVED***": Expected severity of "off", 0, "warn", 1, "error", or 2.`);
...
function assertIsPluginMemberName(value) {
    if (!/[@a-z0-9-_$]+(?:\/(?:[a-z0-9-_$]+))+$/iu.test(value)) {
        throw new TypeError(`Expected string in the form "pluginName/objectName" but found "${value***REMOVED***".`);
    ***REMOVED***
***REMOVED***
    ...
    validate(value) {
        ...
        for (const key of Object.keys(value)) {
            ...
            ***REMOVED***
            ...
            if (key !== key.trim()) {
                throw new TypeError(`Global "${key***REMOVED***" has leading or trailing whitespace.`);
            ***REMOVED***

            if (!globalVariablesValues.has(value[key])) {
                throw new TypeError(`Key "${key***REMOVED***": Expected "readonly", "writable", or "off".`);
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
***REMOVED***;
        ...
        for (const ruleId of Object.keys(result)) {
            ...
            try {
                ...
                ***REMOVED***
                 ...
                 */
            ***REMOVED*** catch (ex) {
                throw new Error(`Key "${ruleId***REMOVED***": ${ex.message***REMOVED***`, { cause: ex ***REMOVED***);
            ***REMOVED***
