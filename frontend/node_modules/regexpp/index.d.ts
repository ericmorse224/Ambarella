...
declare module 'regexpp' {
    ...
    import { RegExpParser ***REMOVED*** from "regexpp/parser";
    import { RegExpValidator ***REMOVED*** from "regexpp/validator";
    import { RegExpVisitor ***REMOVED*** from "regexpp/visitor";
...
declare module 'regexpp/parser' {
    import { Flags, RegExpLiteral, Pattern ***REMOVED*** from "regexpp/ast";
    import { EcmaVersion ***REMOVED*** from "regexpp/ecma-versions";
...
declare module 'regexpp/visitor' {
    import { Alternative, Assertion, Backreference, CapturingGroup, Character, CharacterClass, CharacterClassRange, CharacterSet, Flags, Group, Node, Pattern, Quantifier, RegExpLiteral ***REMOVED*** from "regexpp/ast";
