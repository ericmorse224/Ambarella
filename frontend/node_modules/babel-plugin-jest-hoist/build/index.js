...
const IDVisitor = {
  ReferencedIdentifier(path, {ids***REMOVED***) {
    ids.add(path);
  ***REMOVED***,
...
FUNCTIONS.mock = args => {
  ...
  ***REMOVED*** else if (args.length === 2 || args.length === 3) {
      ...
      if (!found) {
        ...
        if (!isAllowedIdentifier) {
          ...
          if (
            ...
            const {node***REMOVED*** = binding.path;
...
function GETTER_NAME() {
  const { JEST_GLOBALS_MODULE_JEST_EXPORT_NAME ***REMOVED*** = require("JEST_GLOBALS_MODULE_NAME");
...
const isJestObject = expression => {
  ...
  if (
    ...
    return true;
  ***REMOVED*** // import { jest ***REMOVED*** from '@jest/globals'
  ...
  if (
    ...
    return true;
  ***REMOVED*** // import * as JestGlobals from '@jest/globals'
...
const extractJestObjExprIfHoistable = expr => {
  ...
  ***REMOVED***
  ...
  if (!jestObjExpr) {
    return null;
  ***REMOVED*** // Important: Call the function check last
        ...
        ***REMOVED***
        ...
        function visitVariableDeclarator(varDecl) {
          if (hoistedVariables.has(varDecl.node)) {
            ...
            const {kind, declarations***REMOVED*** = varDecl.parent;
