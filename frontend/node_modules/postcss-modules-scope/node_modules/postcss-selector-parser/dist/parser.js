...
var WHITESPACE_TOKENS = (_WHITESPACE_TOKENS = {***REMOVED***, _WHITESPACE_TOKENS[tokens.space] = true, _WHITESPACE_TOKENS[tokens.cr] = true, _WHITESPACE_TOKENS[tokens.feed] = true, _WHITESPACE_TOKENS[tokens.newline] = true, _WHITESPACE_TOKENS[tokens.tab] = true, _WHITESPACE_TOKENS);
var WHITESPACE_EQUIV_TOKENS = Object.assign({***REMOVED***, WHITESPACE_TOKENS, (_Object$assign = {***REMOVED***, _Object$assign[tokens.comment] = true, _Object$assign));
...
var Parser = /*#__PURE__*/function () {
      ...
      switch (token[_tokenize.FIELDS.TYPE]) {
        ...
        case tokens.asterisk:
          if (next[_tokenize.FIELDS.TYPE] === tokens.equals) {
            ...
            lastAdded = 'operator';
          ***REMOVED*** else if ((!node.namespace || lastAdded === "namespace" && !spaceAfterMeaningfulToken) && next) {
            if (spaceBefore) {
        ...
        case tokens.combinator:
          ...
          ***REMOVED***
          if (next[_tokenize.FIELDS.TYPE] === tokens.equals) {
            node.operator = content;
            lastAdded = 'operator';
          ***REMOVED*** else if (!node.namespace && !node.attribute) {
            node.namespace = true;
          ***REMOVED***
          spaceAfterMeaningfulToken = false;
          break;
        case tokens.word:
          ...
          !node.operator && !node.namespace) {
            ...
            lastAdded = 'namespace';
          ***REMOVED*** else if (!node.attribute || lastAdded === "attribute" && !spaceAfterMeaningfulToken) {
            if (spaceBefore) {
              (0, _util.ensureObject)(node, 'spaces', 'attribute');
              node.spaces.attribute.before = spaceBefore;
              spaceBefore = '';
            ...
            ***REMOVED***
            lastAdded = 'attribute';
          ***REMOVED*** else if (!node.value && node.value !== "" || lastAdded === "value" && !(spaceAfterMeaningfulToken || node.quoteMark)) {
            ...
            if ((node.value || node.value === '') && (node.quoteMark || spaceAfterMeaningfulToken)) {
              ...
              ***REMOVED***
              if (commentBefore) {
                ...
                commentBefore = '';
              ***REMOVED***
            ***REMOVED*** else if (node.value || node.value === '') {
              lastAdded = 'value';
              node.value += content;
              if (node.raws.value) {
  ...
  _proto.parseWhitespaceEquivalentTokens = function parseWhitespaceEquivalentTokens(stopPosition) {
    ...
    do {
      if (WHITESPACE_TOKENS[this.currToken[_tokenize.FIELDS.TYPE]]) {
        if (!this.options.lossy) {
          space += this.content();
        ***REMOVED***
      ***REMOVED*** else if (this.currToken[_tokenize.FIELDS.TYPE] === tokens.comment) {
        var spaces = {***REMOVED***;
        if (space) {
          spaces.before = space;
          space = "";
    ...
    ***REMOVED*** while (++this.position < stopPosition);
    if (space) {
      ...
      ***REMOVED*** else if (!this.options.lossy) {
  ...
  ***REMOVED***;
  _proto.combinator = function combinator() {
    ...
    ***REMOVED*** else if (this.currToken[_tokenize.FIELDS.TYPE] === tokens.combinator) {
      ...
      ***REMOVED***);
      this.position++;
    ***REMOVED*** else if (WHITESPACE_TOKENS[this.currToken[_tokenize.FIELDS.TYPE]]) {
      // pass
    ***REMOVED*** else if (!spaceOrDescendantSelectorNodes) {
      this.unexpected();
    ***REMOVED***
    if (node) {
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED*** else if (_space2.startsWith(' ') && _rawSpace2.startsWith(' ')) {
  ...
  ***REMOVED***;
  _proto.namespace = function namespace() {
    ...
    ***REMOVED*** else if (this.nextToken[_tokenize.FIELDS.TYPE] === tokens.asterisk) {
      this.position++;
  ...
  ***REMOVED***;
  _proto.space = function space() {
    ...
    ***REMOVED***)) {
      ...
      this.position++;
    ***REMOVED*** else if (this.position === this.tokens.length - 1 || this.nextToken[_tokenize.FIELDS.TYPE] === tokens.comma || this.nextToken[_tokenize.FIELDS.TYPE] === tokens.closeParenthesis) {
  ...
  _proto.splitWord = function splitWord(namespace, firstCallback) {
    ...
    ***REMOVED***
    ...
    indices.forEach(function (ind, i) {
      ...
      ***REMOVED*** else if (~hasId.indexOf(ind)) {
        var idOpts = {
          value: value.slice(1),
          source: source,
          sourceIndex: sourceIndex
