...
class Worker {
  ...
  constructor(workerPath, options) {
    ...
    if (!(0, _path().isAbsolute)(workerPath)) {
      throw new Error(`'workerPath' must be absolute, got '${workerPath***REMOVED***'`);
    ***REMOVED***
  ...
  _bindExposedWorkerMethods(workerPath, options) {
    getExposedMethods(workerPath, options).forEach(name => {
      if (name.startsWith('_')) {
        return;
      ***REMOVED*** // eslint-disable-next-line no-prototype-builtins

      if (this.constructor.prototype.hasOwnProperty(name)) {
        throw new TypeError(`Cannot define a method called ${name***REMOVED***`);
      ***REMOVED*** // @ts-expect-error: dynamic extension of the class instance is expected.
