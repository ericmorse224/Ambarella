...
/**
 * @typedef {object***REMOVED*** CommonJsChunkLoadingPluginOptions
 * @property {boolean=***REMOVED*** asyncChunkLoading enable async chunk loading
 */
...
class CommonJsChunkLoadingPlugin {
	/**
	 * @param {CommonJsChunkLoadingPluginOptions=***REMOVED*** options options
	 */
