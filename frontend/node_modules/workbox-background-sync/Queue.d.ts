...
declare class Queue {
     ...
     *     implementation.
     */
    constructor(name: string, { forceSyncFallback, onSync, maxRetentionTime ***REMOVED***?: QueueOptions);
    /**
     ...
     * @private
     */
    _addRequest({ request, metadata, timestamp ***REMOVED***: QueueEntry, operation: 'push' | 'unshift'): Promise<void>;
    /**
