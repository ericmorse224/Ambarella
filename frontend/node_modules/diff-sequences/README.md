...
const getRange = (start, end) =>
  start + 1 === end ? `${start + 1***REMOVED***` : `${start + 1***REMOVED***,${end***REMOVED***`;
...
const pushDelIns = (aLines, aIndex, aEnd, bLines, bIndex, bEnd, array) => {
  ...
  ***REMOVED*** else if (deleteLines) {
    array.push(getRange(aIndex, aEnd) + 'd' + String(bIndex));
  ***REMOVED*** else if (insertLines) {
...
const formatDiffLines = (a, b) => {
  ...
  const aLinesUn = format(a, {indent: 0 /*, other options*/***REMOVED***).split('\n');
  const bLinesUn = format(b, {indent: 0 /*, other options*/***REMOVED***).split('\n');
  // Indented to display changed and unchanged lines:
  const aLinesIn = format(a, {indent: 2 /*, other options*/***REMOVED***).split('\n');
  const bLinesIn = format(b, {indent: 2 /*, other options*/***REMOVED***).split('\n');
