...
- supports multiple composes, i.e. `.class { composes: a b, global(c), d e from "./path/file.css" ***REMOVED***`
...
- handles properly selector with escaping characters (like: `.\31 a2b3c { color: red ***REMOVED***`)

### Feature

- `generateExportEntry` option (allow to setup key and value for `:export {***REMOVED***` rule)
