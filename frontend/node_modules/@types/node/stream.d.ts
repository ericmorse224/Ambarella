...
declare module "stream" {
    ...
    import { Blob as NodeBlob ***REMOVED*** from "node:buffer";
    ...
    class Stream extends EventEmitter {
        ...
        compose<T extends NodeJS.ReadableStream>(
            ...
            options?: { signal: AbortSignal ***REMOVED***,
        ): T;
    ***REMOVED***
    namespace Stream {
        export { Stream, streamPromises as promises ***REMOVED***;
    ***REMOVED***
    namespace Stream {
        ...
        ***REMOVED***
        ...
        class Readable extends Stream implements NodeJS.ReadableStream {
            ...
            /**
             * Is `true` if it is safe to call {@link read***REMOVED***, which means
            ...
            /**
             * Getter for the property `encoding` of a given `Readable` stream. The `encoding` property can be set using the {@link setEncoding***REMOVED*** method.
             * @since v12.7.0
             */
             ...
             *     console.log(`Read ${chunk.length***REMOVED*** bytes of data...`);
             *   ***REMOVED***
             * ***REMOVED***);
             *
             ...
             * also be emitted.
             *
             * Calling {@link read***REMOVED*** after the `'end'` event has
             ...
             * const readable = getReadableStreamSomehow();
             * readable.on('data', (chunk) => {
             *   console.log(`Received ${chunk.length***REMOVED*** bytes of data.`);
             *   readable.pause();
             ...
             * using the {@link pipe***REMOVED*** method.
             *
             ...
             * import { StringDecoder ***REMOVED*** from 'node:string_decoder';
             ...
             * ```
             *
             * Unlike {@link push***REMOVED***, `stream.unshift(chunk)` will not
             * end the reading process by resetting the internal reading state of the stream.
             * This can cause unexpected results if `readable.unshift()` is called during a
             * read (i.e. from within a {@link _read***REMOVED*** implementation on a
             * custom stream). Following the call to `readable.unshift()` with an immediate {@link push***REMOVED*** will reset the reading state appropriately,
             ...
             * be a {string***REMOVED***, {Buffer***REMOVED***, {TypedArray***REMOVED***, {DataView***REMOVED*** or `null`. For object mode streams, `chunk` may be any JavaScript value.
             ...
             * information.)
             *
             * When using an older Node.js library that emits `'data'` events and has a {@link pause***REMOVED*** method that is advisory only, the `readable.wrap()` method can be used to create a `Readable`
             * stream that uses
             ...
             *
             * ```js
             * import { OldReader ***REMOVED*** from './old-api-module.js';
             ...
             * **Default: `true`**.
             */
            iterator(options?: { destroyOnReturn?: boolean ***REMOVED***): NodeJS.AsyncIterator<any>;
            /**
        ...
        ***REMOVED***
        ...
        class Writable extends Stream implements NodeJS.WritableStream {
             ...
             * recommended to encapsulate the logic into a `Readable` and use {@link pipe***REMOVED***. However, if calling `write()` is preferred, it is
             ...
             * @since v0.9.4
             * @param chunk Optional data to write. For streams not operating in object mode, `chunk` must be a {string***REMOVED***, {Buffer***REMOVED***,
             * {TypedArray***REMOVED*** or {DataView***REMOVED***. For object mode streams, `chunk` may be any JavaScript value other than `null`.
             ...
             * stream.
             *
             * Calling the {@link write***REMOVED*** method after calling {@link end***REMOVED*** will raise an error.
             *
             * ```js
             ...
             * The buffered data will be flushed when either the {@link uncork***REMOVED*** or {@link end***REMOVED*** methods are called.
             *
            ...
            cork(): void;
            /**
             * The `writable.uncork()` method flushes all data buffered since {@link cork***REMOVED*** was called.
             *
        ...
        ***REMOVED***
        ...
        class Duplex extends Stream implements NodeJS.ReadWriteStream {
             ...
             * - `Object ({ writable, readable ***REMOVED***)` converts `readable` and
            ...
            ***REMOVED***;
            ...
            removeListener(event: string | symbol, listener: (...args: any[]) => void): this;
        ***REMOVED***
        interface Duplex extends Readable, Writable {***REMOVED***
        /**
         ...
         * @param options A value to pass to both {@link Duplex***REMOVED*** constructors,
        ...
        ***REMOVED***
         ...
         */
        class PassThrough extends Transform {***REMOVED***
        /**
         ...
         *
         * reader.read().then(({ value, done ***REMOVED***) => {
        ...
        ***REMOVED***
         ...
         *
         * ```js
         * import { finished ***REMOVED*** from 'node:stream';
         * import fs from 'node:fs';
         *
        ...
        ***REMOVED***
         ...
         *
         * ```js
         * import { pipeline ***REMOVED*** from 'node:stream';
         * import fs from 'node:fs';
