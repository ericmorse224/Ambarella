...
test('Iterator.prototype', function (t) {
	...
	t.test('Symbol.iterator', { skip: !hasSymbols ***REMOVED***, function (st) {
	...
	***REMOVED***);
	...
	t.test('Array keys', { skip: typeof [].keys !== 'function' ***REMOVED***, function (st) {
		var grandProto = getProto(getProto([].keys()));
		st.equal(
			grandProto,
			iterProto,
			'ArrayIterator [[Prototype]] is Iterator.prototype',
			{ skip: grandProto === Object.prototype && 'this environment lacks Iterator.prototype' ***REMOVED***
		);

		st.end();
	***REMOVED***);

	t.test('Set keys', { skip: typeof Set !== 'function' || typeof Set.prototype.keys !== 'function' ***REMOVED***, function (st) {
