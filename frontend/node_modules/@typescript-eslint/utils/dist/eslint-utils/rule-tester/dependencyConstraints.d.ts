...
***REMOVED***
type AtLeastVersionConstraint = `${number***REMOVED***` | `${number***REMOVED***.${number***REMOVED***` | `${number***REMOVED***.${number***REMOVED***.${number***REMOVED***` | `${number***REMOVED***.${number***REMOVED***.${number***REMOVED***-${string***REMOVED***`;
...
export { satisfiesAllDependencyConstraints ***REMOVED***;
export type { DependencyConstraint ***REMOVED***;
