                ...
                if (shorthandProperties.length !== properties.length) {
                    ...
                    ***REMOVED*** else if (checkRedundancy) {
                        ...
                        if (canAlwaysUseShorthand) {
                            context.report({ node, messageId: "expectedAllPropertiesShorthanded" ***REMOVED***);
                        ***REMOVED***
                    ***REMOVED***
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
        ...
        function makeFunctionShorthand(fixer, node) {
            ...
            ***REMOVED***
            ...
            const newParamText = shouldAddParensAroundParameters ? `(${oldParamText***REMOVED***)` : oldParamText;
        ...
        ***REMOVED***
        ...
        function makeFunctionLongform(fixer, node) {
            ...
            ***REMOVED***
            ...
            return fixer.replaceTextRange([node.range[0], lastKeyToken.range[1]], `${keyText***REMOVED***: ${functionHeader***REMOVED***`);
        ***REMOVED***
                ...
                if (isConciseProperty) {
                    ...
                    ***REMOVED*** else if (APPLY_NEVER) {
                        ...
                        context.report({
                            ...
                            fix: fixer => fixer.insertTextAfter(node.key, `: ${node.key.name***REMOVED***`)
                        ***REMOVED***);
                    ***REMOVED***
                ***REMOVED*** else if (APPLY_TO_METHODS && !node.value.id && (node.value.type === "FunctionExpression" || node.value.type === "ArrowFunctionExpression")) {
                    ...
                    ***REMOVED***
                    ...
                    if (node.value.type === "FunctionExpression" ||
                        ...
                        ***REMOVED***);
                    ***REMOVED***
                ***REMOVED*** else if (node.value.type === "Identifier" && node.key.name === node.value.name && APPLY_TO_PROPS) {
                    ...
                    context.report({
                        ...
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED*** else if (node.value.type === "Identifier" && node.key.type === "Literal" && node.key.value === node.value.name && APPLY_TO_PROPS) {
                    if (AVOID_QUOTES) {
                        return;
                    ***REMOVED***
