 ...
 */
  ...
  ***REMOVED***
  ...
  while (!tokens.matchesContextIdAndLabel(_types.TokenType.braceR, classContextId)) {
    if (tokens.matchesContextual(_keywords.ContextualKeyword._constructor) && !tokens.currentToken().isType) {
      ({constructorInitializerStatements, constructorInsertPos***REMOVED*** = processConstructor(tokens));
    ***REMOVED*** else if (tokens.matches1(_types.TokenType.semi)) {
      if (!disableESTransforms) {
        rangesToRemove.push({start: tokens.currentIndex(), end: tokens.currentIndex() + 1***REMOVED***);
      ***REMOVED***
      tokens.nextToken();
    ***REMOVED*** else if (tokens.currentToken().isType) {
      tokens.nextToken();
    ***REMOVED*** else {
      ...
      ***REMOVED***
      if (tokens.matches1(_types.TokenType.eq)) {
        ...
        ***REMOVED***);
      ***REMOVED*** else if (!disableESTransforms || isDeclareOrAbstract) {
        ...
        // value to undefined.
        rangesToRemove.push({start: statementStartIndex, end: tokens.currentIndex()***REMOVED***);
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED*** else {
    ...
    ***REMOVED***;
  ***REMOVED***
***REMOVED*** exports.default = getClassInfo;
  ...
  ***REMOVED***
  while (!tokens.matchesContextIdAndLabel(_types.TokenType.braceL, contextId)) {
    ...
    ***REMOVED***
    tokens.nextToken();
  ***REMOVED***
  return {isExpression, className, hasSuperclass***REMOVED***;
***REMOVED***
...
function processConstructor(tokens)
    ...
    if (tokens.currentToken().contextId === constructorContextId) {
      ...
      if (isAccessModifier(tokens.currentToken())) {
        ...
        ***REMOVED***
        ...
        constructorInitializerStatements.push(`this.${name***REMOVED*** = ${name***REMOVED***`);
      ***REMOVED***
    ***REMOVED*** else {
      tokens.nextToken();
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  return {constructorInitializerStatements, constructorInsertPos***REMOVED***;
***REMOVED***
