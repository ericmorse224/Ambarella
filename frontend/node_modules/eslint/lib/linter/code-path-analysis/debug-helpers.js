...
function nodeToString(node, label) {
    ...
    switch (node.type) {
        case "Identifier": return `${node.type***REMOVED***${suffix***REMOVED*** (${node.name***REMOVED***)`;
        case "Literal": return `${node.type***REMOVED***${suffix***REMOVED*** (${node.value***REMOVED***)`;
        default: return `${node.type***REMOVED***${suffix***REMOVED***`;
    ***REMOVED***
***REMOVED***
