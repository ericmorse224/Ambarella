 ...
 *
 * @param {Object***REMOVED*** childNode - JSX element being tested.
 * @returns {boolean***REMOVED*** Whether or not the node name match the JSX tag convention.
 */
 ...
 *
 * @param {string***REMOVED*** name - Attribute name to be normalized
 ...
 *
 * @param {string***REMOVED*** name - Attribute name to be tested
 ...
 * @param {JSXAttribute***REMOVED*** node - JSXAttribute being tested.
 * @returns {string | null***REMOVED*** tag name
 */
 ...
 * @param {string***REMOVED*** name - Name of the attribute.
 * @param {object***REMOVED*** context - eslint context
 * @returns {string | undefined***REMOVED*** The standard name of the attribute, or undefined if no standard name was found.
 */
function getStandardName(name, context) {
  if (has(DOM_ATTRIBUTE_NAMES, name)) {
    return DOM_ATTRIBUTE_NAMES[/** @type {keyof DOM_ATTRIBUTE_NAMES***REMOVED*** */ (name)];
  ***REMOVED***
  if (has(SVGDOM_ATTRIBUTE_NAMES, name)) {
    return SVGDOM_ATTRIBUTE_NAMES[/** @type {keyof SVGDOM_ATTRIBUTE_NAMES***REMOVED*** */ (name)];
  ***REMOVED***
...
const messages = {
  invalidPropOnTag: 'Invalid property \'{{name***REMOVED******REMOVED***\' found on tag \'{{tagName***REMOVED******REMOVED***\', but it is only allowed on: {{allowedTags***REMOVED******REMOVED***',
  unknownPropWithStandardName: 'Unknown property \'{{name***REMOVED******REMOVED***\' found, use \'{{standardName***REMOVED******REMOVED***\' instead',
  unknownProp: 'Unknown property \'{{name***REMOVED******REMOVED***\' found',
  dataLowercaseRequired: 'React does not recognize data-* props with uppercase characters on a DOM element. Found \'{{name***REMOVED******REMOVED***\', use \'{{lowerCaseName***REMOVED******REMOVED***\' instead',
***REMOVED***;
    ...
    return {
      JSXAttribute(node) {
        ...
        ***REMOVED***
        ...
        if (isValidAriaAttribute(name)) { return; ***REMOVED***

        const tagName = getTagName(node);

        if (tagName === 'fbt' || tagName === 'fbs') { return; ***REMOVED*** // fbt/fbs nodes are bonkers, let's not go there

        if (!isValidHTMLTagInJSX(node)) { return; ***REMOVED***
        ...
        const allowedTags = has(ATTRIBUTE_TAGS_MAP, name)
          ? ATTRIBUTE_TAGS_MAP[/** @type {keyof ATTRIBUTE_TAGS_MAP***REMOVED*** */ (name)]
          : null;
