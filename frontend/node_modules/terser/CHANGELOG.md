...
## v5.38.0
 ...
 - Remove more object spreads, such as `{ ...void !0 ***REMOVED***` (#1142)
...
## v5.32.0
 ...
 - `typeof` an object or array (`typeof {***REMOVED***` and `typeof []`) can now be statically evaluated. (#1546)
...
## v5.23.0
 ...
 - Remove empty class `static {***REMOVED***` blocks.
...
## v5.17.4
 ...
 - Fix crash when trying to negate a class (`!class{***REMOVED***`)
...
## v5.16.4
 ...
 - Use modern unicode property escapes (`\p{...***REMOVED***`) to parse identifiers when available
...
## v5.16.1
 ...
 - Properly handle references in destructurings (`const { [reference]: val ***REMOVED*** = ...`)
...
## v5.13.1
 ...
 - Allow multiple identifiers with the same name in `var` destructuring (eg `var { a, a ***REMOVED*** = x`) (#1176)
...
## v5.11.0
 ...
 - Unicode code point escapes (`\u{abcde***REMOVED***`) are not emitted inside RegExp literals anymore (#1147)
...
## v5.10.0
 ...
 - Fix an issue with `return someVariable = (async () => { ... ***REMOVED***)()` (#1073)
...
## v5.9.0
 ...
 - Fix for inlining object spread `{ ...obj ***REMOVED***` (#1071)
...
## v5.7.1
 ...
 - Removed undefined from object expansions (`{ ...void 0 ***REMOVED***` -> `{***REMOVED***`)
...
## v5.7.0
 ...
 - Accept `{get = "default val"***REMOVED***` and `{set = "default val"***REMOVED***` in destructuring arguments.
...
(hotfix release)
 ...
 - Fixed issue where `() => ({***REMOVED***)[something]` was not parenthesised correctly.
...
## v4.3.5
 ...
 - Variable names of anonymous functions (eg: `const x = () => { ... ***REMOVED***` or `var func = function () {...***REMOVED***`) are now preserved when keep_fnames is true.
