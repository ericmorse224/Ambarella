...
module.exports = {
    meta: {
        ...
        ***REMOVED***],
        ...
        messages: {
            globalNonLexicalBinding: "Unexpected {{kind***REMOVED******REMOVED*** declaration in the global scope, wrap in an IIFE for a local variable, assign as global property for a global variable.",
            globalLexicalBinding: "Unexpected {{kind***REMOVED******REMOVED*** declaration in the global scope, wrap in a block or in an IIFE.",
                        ...
                        if (def.type === "FunctionName" || (def.type === "Variable" && def.parent.kind === "var")) {
                            ...
                            ***REMOVED*** else {
                                report(
                                    ...
                                    def.type === "FunctionName" ? "function" : `'${def.parent.kind***REMOVED***'`
                                );
                            ***REMOVED***
                        ***REMOVED***
                            ...
                            if (def.type === "ClassName" ||
                                ...
                                ***REMOVED*** else {
                                    report(
                                        ...
                                        def.type === "ClassName" ? "class" : `'${def.parent.kind***REMOVED***'`
                                    );
                                ***REMOVED***
                            ***REMOVED***
                        ***REMOVED***
