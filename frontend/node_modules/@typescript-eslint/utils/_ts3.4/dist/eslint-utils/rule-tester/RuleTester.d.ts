import { RuleModule ***REMOVED*** from '../../ts-eslint/Rule';
import * as BaseRuleTester from '../../ts-eslint/RuleTester';
import { DependencyConstraint ***REMOVED*** from './dependencyConstraints';
...
export { InvalidTestCase, ValidTestCase, RunTests ***REMOVED***;
