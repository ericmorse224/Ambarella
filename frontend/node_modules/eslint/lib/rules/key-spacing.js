	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			extraValue:
				"Extra space before value for {{computed***REMOVED******REMOVED***key '{{key***REMOVED******REMOVED***'.",
			missingKey: "Missing space after {{computed***REMOVED******REMOVED***key '{{key***REMOVED******REMOVED***'.",
			missingValue:
				"Missing space before value for {{computed***REMOVED******REMOVED***key '{{key***REMOVED******REMOVED***'.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** expected Expected whitespace length.
		...
		function report(property, side, whitespace, expected, mode) {
			...
			if (
				...
				const missingLoc = isKeySide
					...
					: tokenAfterColon.loc;
				const loc = isExtra
					? { start: locStart, end: locEnd ***REMOVED***
					: missingLoc;
		...
		***REMOVED***
		 ...
		 * @returns {number***REMOVED*** Width of the key.
		 */
