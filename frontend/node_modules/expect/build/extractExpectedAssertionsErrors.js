...
const resetAssertionsLocalState = () => {
  ...
  ***REMOVED***);
***REMOVED***; // Create and format all errors related to the mismatched number of `expect`
...
const extractExpectedAssertionsErrors = () => {
  ...
  ***REMOVED*** = (0, _jestMatchersObject.getState)();
  ...
  if (
    ...
    expectedAssertionsNumberError.message =
      ...
      '\n\n' +
      `Expected ${numOfAssertionsExpected***REMOVED*** to be called but received ` +
  ...
  ***REMOVED***
  ...
  if (isExpectingAssertions && assertionCalls === 0) {
    ...
    isExpectingAssertionsError.message =
      ...
      ***REMOVED***) +
      '\n\n' +
      `Expected ${expected***REMOVED*** to be called but ${received***REMOVED***.`;
    result.push({
      actual: 'none',
