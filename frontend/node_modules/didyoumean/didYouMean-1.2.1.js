...
```
var input = 'insargrm';
var list = [ { id: 'facebook' ***REMOVED***, { id: 'twitter' ***REMOVED***, { id: 'instagram' ***REMOVED***, { id: 'linkedin' ***REMOVED*** ];
var key = 'id';
...
(function() {
  ...
  function didYouMean(str, list, key) {
    ...
    if (!didYouMean.caseSensitive) { str = str.toLowerCase(); ***REMOVED***
    ...
    for (i = 0; i < len; i++) {
      ...
      if (key) { candidate = candidate[key]; ***REMOVED***
      // Gatekeep.
      if (!candidate) { continue; ***REMOVED***
      // If we're running a case-insensitive search, smallify the candidate.
      if (!didYouMean.caseSensitive) { testCandidate = candidate.toLowerCase(); ***REMOVED***
      else { testCandidate = candidate; ***REMOVED***
  ...
  ***REMOVED***
  ...
  function getEditDistance(a, b, max) {
    ...
    for (i = 0; i <= lenb; i++) { matrix[i] = [i]; ***REMOVED***

    // Set up the first column (same).
    for (j = 0; j <= lena; j++) { matrix[0][j] = j; ***REMOVED***
