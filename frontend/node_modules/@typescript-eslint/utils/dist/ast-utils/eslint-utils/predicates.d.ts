...
declare const isClosingBraceToken: IsPunctuatorTokenWithValueFunction<"***REMOVED***">;
declare const isNotClosingBraceToken: IsNotPunctuatorTokenWithValueFunction<"***REMOVED***">;
