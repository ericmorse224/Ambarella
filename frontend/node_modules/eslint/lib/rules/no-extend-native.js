...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unexpected: "{{builtin***REMOVED******REMOVED*** prototype is read only, properties should not be added."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {string***REMOVED*** builtin The name of the native builtin being extended.
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** identifierNode The Identifier representing the object
         * to check.
         * @returns {boolean***REMOVED*** True if the identifier is the object of a
        ...
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** True if an assignment to the property of the node.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The node to check.
         * @returns {boolean***REMOVED*** True if the node is at the first argument of the method call of `Object.defineProperty()` or `Object.defineProperties()`.
         */
        ...
        ***REMOVED***
        ...
        function checkAndReportPrototypeExtension(identifierNode) {
            ...
            ***REMOVED*** else if (isInDefinePropertyCall(prototypeNode)) {
