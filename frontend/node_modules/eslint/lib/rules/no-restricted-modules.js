		...
		***REMOVED***,
		...
		messages: {
			...
			customMessage:
				...
				"'{{name***REMOVED******REMOVED***' module is restricted from being used. {{customMessage***REMOVED******REMOVED***",
			patternMessage:
				"'{{name***REMOVED******REMOVED***' module is restricted from being used by a pattern.",
		***REMOVED***,
	***REMOVED***,
