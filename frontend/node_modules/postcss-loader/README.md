...
| :---------------------------------: | :------------------: | :-----------------------------------: | :------------------------------------------- |
|        [`execute`](#execute)        |     `{Boolean***REMOVED***`      |              `undefined`              | Enable PostCSS Parser support in `CSS-in-JS` |
| [`postcssOptions`](#postcssOptions) | `{Object\|Function***REMOVED***` | `defaults values for Postcss.process` | Set `PostCSS` options and plugins            |
|      [`sourceMap`](#sourcemap)      |     `{Boolean***REMOVED***`      |          `compiler.devtool`           | Enables/Disables generation of source maps   |
| [`implementation`](#implementation) | `{Function\|String***REMOVED***` |               `postcss`               | Setup PostCSS implementation to use          |
    ...
    rules: [
      {
        ...
        options: {
          postcssOptions: {
            plugins: [
              "postcss-import",
              ["postcss-short", { prefix: "x" ***REMOVED***],
              require.resolve("my-postcss-plugin"),
              myOtherPostcssPlugin({ myOption: true ***REMOVED***),
              // Deprecated and will be removed in the next major release
              { "postcss-nested": { preserveEmpty: true ***REMOVED*** ***REMOVED***,
            ],
          ***REMOVED***,
        ***REMOVED***,
      ***REMOVED***,
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: "style-loader" ***REMOVED***,
          { loader: "css-loader", options: { sourceMap: true ***REMOVED*** ***REMOVED***,
          { loader: "postcss-loader", options: { sourceMap: true ***REMOVED*** ***REMOVED***,
          { loader: "sass-loader", options: { sourceMap: true ***REMOVED*** ***REMOVED***,
        ],
      ***REMOVED***,
    ],
  ***REMOVED***,
    ...
    rules: [
      {
        ...
        use: [
          { loader: "style-loader" ***REMOVED***,
          { loader: "css-loader" ***REMOVED***,
          { loader: "postcss-loader" ***REMOVED***,
          { loader: "sass-loader" ***REMOVED***,
        ],
      ***REMOVED***,
    ],
  ***REMOVED***,
    ...
    rules: [
      {
        ...
        use: [
          ...
          {
            loader: "postcss-loader",
            options: { implementation: require("postcss") ***REMOVED***,
          ***REMOVED***,
          { loader: "sass-loader" ***REMOVED***,
        ],
      ***REMOVED***,
    ...
    rules: [
      {
        ...
        use: [
          ...
          {
            loader: "postcss-loader",
            options: { implementation: require.resolve("postcss") ***REMOVED***,
          ***REMOVED***,
          { loader: "sass-loader" ***REMOVED***,
        ],
      ***REMOVED***,
    ...
    rules: [
      {
        ...
        use: [
          ...
          {
            loader: "css-loader",
            options: { importLoaders: 1 ***REMOVED***,
          ***REMOVED***,
          {
            loader: "postcss-loader",
            options: {
