...
var Declaration = /*#__PURE__*/function (_Node) {
  ...
  ***REMOVED***
   ...
   * @member {string***REMOVED*** prop The declaration’s property name.
   *
   * @example
   * const root = postcss.parse('a { color: black ***REMOVED***')
   * const decl = root.first.first
  ...
  /**
   * @memberof Declaration#
   * @member {string***REMOVED*** value The declaration’s value.
   *
   * @example
   * const root = postcss.parse('a { color: black ***REMOVED***')
   * const decl = root.first.first
  ...
  /**
   * @memberof Declaration#
   * @member {boolean***REMOVED*** important `true` if the declaration
   *                             has an !important annotation.
   *
   * @example
   * const root = postcss.parse('a { color: black !important; color: red ***REMOVED***')
