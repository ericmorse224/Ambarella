    ...
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            ...
            tooShortPrivate: "Identifier name '#{{name***REMOVED******REMOVED***' is too short (< {{min***REMOVED******REMOVED***).",
            tooLong: "Identifier name '{{name***REMOVED******REMOVED***' is too long (> {{max***REMOVED******REMOVED***).",
            tooLongPrivate: "Identifier name #'{{name***REMOVED******REMOVED***' is too long (> {{max***REMOVED******REMOVED***)."
        ***REMOVED***
    ***REMOVED***,
