...
declare namespace Q {
    ...
    ***REMOVED***
    ...
    export interface Promise<T> {
         ...
         *
         * @example
         * promise.then(function (o) { return o[propertyName]; ***REMOVED***);
         */
         ...
         *
         * @example
         * promise.then(function (o) { return o[methodName].apply(o, args); ***REMOVED***);
         */
         ...
         *
         * @example
         * promise.then(function (o) { return Object.keys(o); ***REMOVED***);
         */
        keys(): Promise<string[]>;
        ...
        /**
         * A sugar method, equivalent to promise.then(function () { return value; ***REMOVED***).
         */
        thenResolve<U>(value: U): Promise<U>;

        /**
         * A sugar method, equivalent to promise.then(function () { throw reason; ***REMOVED***).
         */
         ...
         * - { state: "fulfilled", value: <fulfllment value> ***REMOVED***
         * - { state: "rejected", reason: <rejection reason> ***REMOVED***
         */
    ...
    ***REMOVED***
     ...
     * findKitties({ cute: true ***REMOVED***).done(function (theKitties) {
     *     //...
     * ***REMOVED***);
     */
