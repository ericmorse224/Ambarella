...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            as: "Use 'as {{cast***REMOVED******REMOVED***' instead of '<{{cast***REMOVED******REMOVED***>'.",
            'angle-bracket': "Use '<{{cast***REMOVED******REMOVED***>' instead of 'as {{cast***REMOVED******REMOVED***'.",
            never: 'Do not use any type assertions.',
            unexpectedObjectTypeAssertion: 'Always prefer const x: T = { ... ***REMOVED***.',
            replaceObjectTypeAssertionWithAnnotation: 'Use const x: {{cast***REMOVED******REMOVED*** = { ... ***REMOVED*** instead.',
            replaceObjectTypeAssertionWithSatisfies: 'Use const x = { ... ***REMOVED*** satisfies {{cast***REMOVED******REMOVED*** instead.',
        ***REMOVED***,
        schema: [
            {
                oneOf: [
            ...
            ***REMOVED***
            context.report({
                ...
                data: messageId !== 'never'
                    ? { cast: sourceCode.getText(node.typeAnnotation) ***REMOVED***
                    : {***REMOVED***,
                fix: messageId === 'as'
                    ? (fixer) => [
                        fixer.replaceText(node, getTextWithParentheses(node.expression)),
                        fixer.insertTextAfter(node, ` as ${getTextWithParentheses(node.typeAnnotation)***REMOVED***`),
                    ]
                    : undefined,
            ***REMOVED***);
        ***REMOVED***
            ...
            if (checkType(node.typeAnnotation) &&
                ...
                if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === utils_1.AST_NODE_TYPES.VariableDeclarator &&
                    ...
                    suggest.push({
                        ...
                        data: { cast: sourceCode.getText(node.typeAnnotation) ***REMOVED***,
                        fix: fixer => [
                            fixer.insertTextAfter(parent.id, `: ${sourceCode.getText(node.typeAnnotation)***REMOVED***`),
                            fixer.replaceText(node, getTextWithParentheses(node.expression)),
                        ],
                    ***REMOVED***);
                ***REMOVED***
                suggest.push({
                    ...
                    fix: fixer => [
                        ...
                        fixer.insertTextAfter(node, ` satisfies ${context
                            .getSourceCode()
                            .getText(node.typeAnnotation)***REMOVED***`),
                    ],
                ***REMOVED***);
                context.report({
                    node,
