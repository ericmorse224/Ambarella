...
module.exports = core => {
  ...
  ***REMOVED***
   ...
   */
  function unionExpr(stream, a) { return binaryL(pathExpr, stream, a, '|'); ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  function andExpr(stream, a) { return binaryL(equalityExpr, stream, a, 'and'); ***REMOVED***
  /** [23] EqualityExpr::= RelationalExpr | EqualityExpr '=' RelationalExpr
   *                     | EqualityExpr '!=' RelationalExpr
   */
  function equalityExpr(stream, a) { return binaryL(relationalExpr, stream, a, ['=','!=']); ***REMOVED***
  /** [24] RelationalExpr::= AdditiveExpr | RelationalExpr '<' AdditiveExpr
   *                       | RelationalExpr '>' AdditiveExpr
   *                       | RelationalExpr '<=' AdditiveExpr
   *                       | RelationalExpr '>=' AdditiveExpr
   */
  function relationalExpr(stream, a) { return binaryL(additiveExpr, stream, a, ['<','>','<=','>=']); ***REMOVED***
  /** [25] AdditiveExpr::= MultiplicativeExpr
   *                     | AdditiveExpr '+' MultiplicativeExpr
   *                     | AdditiveExpr '-' MultiplicativeExpr
   */
  function additiveExpr(stream, a) { return binaryL(multiplicativeExpr, stream, a, ['+','-']); ***REMOVED***
  /** [26] MultiplicativeExpr::= UnaryExpr
   *                           | MultiplicativeExpr MultiplyOperator UnaryExpr
   *                           | MultiplicativeExpr 'div' UnaryExpr
   *                           | MultiplicativeExpr 'mod' UnaryExpr
   */
  function multiplicativeExpr(stream, a) { return binaryL(unaryExpr, stream, a, ['*','div','mod']); ***REMOVED***
  ...
  ***REMOVED***
  var astFactory = {
    node: function() {return Array.prototype.slice.call(arguments);***REMOVED***
  ***REMOVED***;
  ...
  ***REMOVED***
   ...
   *    {nodes: [node, ...]***REMOVED***
   * or {nodes: [node, ...], pos: [[1], [2], ...], lasts: [[1], [2], ...]***REMOVED***
   *
   ...
   * {nodes:[], pos:[], lasts:[]***REMOVED*** structures. It is useful for the
  ...
  ***REMOVED***
  NodeMultiSet.prototype = {
    ...
    ***REMOVED***,
    simplify: function() {
      this.finalize();
      return {nodes:this.nodes, pos:this.pos, lasts:this.lasts***REMOVED***;
    ***REMOVED***
  ***REMOVED***;
  function eachContext(nodeMultiSet) {
    ...
    for (var i = 0; i < nodeMultiSet.nodes.length; i++) {
      ...
      if (!nodeMultiSet.pos) {
        r.push({nodes:[node], pos: [[i + 1]], lasts: [[nodeMultiSet.nodes.length]]***REMOVED***);
      ***REMOVED*** else {
        for (var j = 0; j < nodeMultiSet.pos[i].length; ++j) {
          r.push({nodes:[node], pos: [[nodeMultiSet.pos[i][j]]], lasts: [[nodeMultiSet.lasts[i][j]]]***REMOVED***);
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
    return r;
  ...
  ***REMOVED***
  NodeMatcher.prototype = {
    ...
    ***REMOVED***,
    _alwaysTrue: function(name) {return true;***REMOVED***,
  ...
  ***REMOVED***
  ...
  function followingNonDescendantNode(node) {
    ...
    ***REMOVED*** while (node = node.parentNode);
    return null;
  ***REMOVED***
  ...
  ***REMOVED***
  function precedingHelper(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase) {
    ...
    if (null == cursor) return {nodes:{***REMOVED******REMOVED***;
    var r = {nodes:[], pos:[], lasts:[]***REMOVED***;
  ...
  function descendantDfs(nodeMultiSet, node, remaining, matcher, andSelf, attrIndices, attrNodes) {
    ...
    ***REMOVED***
    ...
    if (null == node) {
      ...
      nodeMultiSet.pushSeries();
      pushed = true;
    ***REMOVED*** else if (0 < remaining.length && node === remaining[0]) {
      nodeMultiSet.pushSeries();
      pushed = true;
      remaining.shift();
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  function ancestorHelper(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase, andSelf) {
    ...
    ***REMOVED***
    ...
    var newCtx = {nodes:[], pos:[], lasts:[]***REMOVED***;
  ...
  function sortNodeMultiSet(nodeMultiSet) {
    ...
    for (var i = 0; i < nodeMultiSet.nodes.length; i++) {
      ...
      a.push({v:v, n:nodeMultiSet.nodes[i],
              p:nodeMultiSet.pos[i], l:nodeMultiSet.lasts[i]***REMOVED***);
    ***REMOVED***
    a.sort(compare);
    var r = {nodes:[], pos:[], lasts:[]***REMOVED***;
    for (var i = 0; i < a.length; ++i) {
  ...
  function mergeNodeLists(x, y) {
    ...
    while (true) {
      ...
      ***REMOVED*** else if (c > 0) {
        ...
        b = null;
        banc = null;
      ***REMOVED*** else if (getNodeName(a) < getNodeName(b)) {  // attributes
        r.push(a);
        a = null;
        aanc = null;
      ***REMOVED*** else if (getNodeName(a) > getNodeName(b)) {  // attributes
  ...
  function comparisonHelper(test, x, y, isNumericComparison) {
    ...
    if ('object' === typeof x && 'object' === typeof y) {
      ...
      for (var i = 0; i < x.nodes.length; ++i) {
        var xi = coersion({nodes:[x.nodes[i]]***REMOVED***);
        for (var j = 0; j < y.nodes.length; ++j) {
          var yj = coersion({nodes:[y.nodes[j]]***REMOVED***);
          if (test(xi, yj)) return true;
        ***REMOVED***
      ***REMOVED***
      return false;
    ***REMOVED*** else if ('object' === typeof x && x.nodes && x.nodes.length) {
      for (var i = 0; i < x.nodes.length; ++i) {
        var xi = coersion({nodes:[x.nodes[i]]***REMOVED***), yc = coersion(y);
        if (test(xi, yc))
          return true;
      ***REMOVED***
      return false;
    ***REMOVED*** else if ('object' === typeof y && x.nodes && x.nodes.length) {
      for (var i = 0; i < x.nodes.length; ++i) {
        var yi = coersion({nodes:[y.nodes[i]]***REMOVED***), xc = coersion(x);
        if (test(xc, yi))
          return true;
      ***REMOVED***
      return false;
  ...
  var axes = xpath.axes = {
    ...
    'following-sibling':
      function followingSibling(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase) {
        return followingSiblingHelper(
          ...
          Array.prototype.shift, function() {return this[0];***REMOVED***,
          function(node) {return node.nextSibling;***REMOVED***);
      ***REMOVED***,
    'namespace':
    ...
    'parent':
      function parent(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase) {
        ...
        for (var i = 0; i < nodeList.length; ++i) {
          ...
          pos.push([1]);
        ***REMOVED***
        return {nodes:nodes, pos:pos, lasts:pos***REMOVED***;
      ***REMOVED***,
    'preceding':
    ...
    'preceding-sibling':
      function precedingSibling(nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase) {
        return followingSiblingHelper(
          nodeList  /*destructive!*/, nodeTypeNum, nodeName, shouldLowerCase,
          Array.prototype.pop, function() {return this[this.length-1];***REMOVED***,
          function(node) {return node.previousSibling***REMOVED***,
          false, true);
      ***REMOVED***,
    'self':
    ...
    'id': function id(object) {
      ...
      if ('object' === typeof object) {
        ...
        for (var i = 0; i < object.nodes.length; ++i) {
          ...
          var idsString = fn.string({nodes:[idNode]***REMOVED***);
    ...
    ***REMOVED***,
    'translate': function translate(string, from, to) {
      ...
      for (var i = 0; i < sFrom.length; ++i) {
        ...
        eachCharRe.push(
          c.replace(/([-()\[\]{***REMOVED***+?*.$\^|,:#<!\\])/g, '\\$1').
            replace(/\x08/g, '\\x08'));
      ***REMOVED***
      var re = new RegExp(eachCharRe.join('|'), 'g');
      return sString.replace(re, function(c) {return map[c];***REMOVED***);
    ***REMOVED***,
    /// Boolean functions
    'not': function not(x) {
      var bx = fn['boolean'](x);
      return !bx;
    ***REMOVED***,
    'true': function trueVal() { return true; ***REMOVED***,
    'false': function falseVal() { return false; ***REMOVED***,
    // TODO
    'lang': function lang(string) { throw new Error('Not implemented');***REMOVED***,
    'sum': function sum(optNodeSet) {
      ...
      for (var i = 0; i < optNodeSet.nodes.length; ++i) {
        ...
        var x = fn.number({nodes:[node]***REMOVED***);
        sum += x;
      ***REMOVED***
      return sum;
    ***REMOVED***,
  ...
  ***REMOVED***;
   ...
   ***************************************************************************/
  var more = {
    UnaryMinus: function(x) { return -fn.number(x); ***REMOVED***,
    '+': function(x, y) { return fn.number(x) + fn.number(y); ***REMOVED***,
    '-': function(x, y) { return fn.number(x) - fn.number(y); ***REMOVED***,
    '*': function(x, y) { return fn.number(x) * fn.number(y); ***REMOVED***,
    'div': function(x, y) { return fn.number(x) / fn.number(y); ***REMOVED***,
    'mod': function(x, y) { return fn.number(x) % fn.number(y); ***REMOVED***,
    '<': function(x, y) {
      return comparisonHelper(function(x, y) { return fn.number(x) < fn.number(y);***REMOVED***, x, y, true);
    ***REMOVED***,
    '<=': function(x, y) {
      return comparisonHelper(function(x, y) { return fn.number(x) <= fn.number(y);***REMOVED***, x, y, true);
    ***REMOVED***,
    ...
    ***REMOVED***,
    '>=': function(x, y) {
      return comparisonHelper(function(x, y) { return fn.number(x) >= fn.number(y);***REMOVED***, x, y, true);
    ***REMOVED***,
    'and': function(x, y) { return fn['boolean'](x) && fn['boolean'](y); ***REMOVED***,
    'or': function(x, y) { return fn['boolean'](x) || fn['boolean'](y); ***REMOVED***,
    '|': function(x, y) { return {nodes: mergeNodeLists(x.nodes, y.nodes)***REMOVED***; ***REMOVED***,
    '=': function(x, y) {
      // optimization for two node-sets case: avoid n^2 comparisons.
      if ('object' === typeof x && 'object' === typeof y) {
        var aMap = {***REMOVED***;
        for (var i = 0; i < x.nodes.length; ++i) {
          var s = fn.string({nodes:[x.nodes[i]]***REMOVED***);
          aMap[s] = true;
        ***REMOVED***
        for (var i = 0; i < y.nodes.length; ++i) {
          var s = fn.string({nodes:[y.nodes[i]]***REMOVED***);
          if (aMap[s]) return true;
        ***REMOVED***
        return false;
      ***REMOVED*** else {
        return comparisonHelper(function(x, y) {return x === y;***REMOVED***, x, y);
      ***REMOVED***
    ***REMOVED***,
    '!=': function(x, y) {
      // optimization for two node-sets case: avoid n^2 comparisons.
  ...
  var stringifyObject = xpath.stringifyObject = function stringifyObject(ctx) {
    ...
    function helper(ctx) {
      if (Array.isArray(ctx)) {
        return ctx.map(function(x) {return helper(x);***REMOVED***);
      ***REMOVED***
  ...
  ***REMOVED***
  Evaluator.prototype = {
    val: function val(ast, ctx) {
      ...
      ***REMOVED***
      switch (ast[0]) {
        case 'Root': return {nodes: [this.doc]***REMOVED***;
        case 'FunctionCall':
        ...
        case 'Axis':
          ...
          if ('object' !== typeof ctx) return {nodes:[], pos:[]***REMOVED***;
  ...
  ***REMOVED***;
  var evaluate = xpath.evaluate = function evaluate(expr, doc, context) {
    ...
    var val = new Evaluator(doc).val(ast, {nodes: [context]***REMOVED***);
    return val;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  var XPathEvaluator = xpath.XPathEvaluator = function XPathEvaluator() {***REMOVED***
  ...
  XPathExpression.prototype = {
    evaluate: function evaluate(contextNode, type, result) {
      ...
      ***REMOVED***
      ...
      var value = evaluator.val(this._ast, {nodes: [contextNode]***REMOVED***);
