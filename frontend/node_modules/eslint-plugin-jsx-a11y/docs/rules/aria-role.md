...
<div role={role***REMOVED***></div>       <!-- Good: role is a variable & cannot be determined until runtime. -->
<div></div>                   <!-- Good: No ARIA role -->
<Foo role={role***REMOVED***></Foo>       <!-- Good: ignoreNonDOM is set to true -->
```
...
<Foo role={role***REMOVED***></Foo>       <!-- Bad: ignoreNonDOM is set to false or not set -->
```
