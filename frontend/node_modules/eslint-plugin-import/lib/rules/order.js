'use strict';var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;***REMOVED*** : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;***REMOVED***;var _slicedToArray = function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;***REMOVED******REMOVED*** catch (err) {_d = true;_e = err;***REMOVED*** finally {try {if (!_n && _i["return"]) _i["return"]();***REMOVED*** finally {if (_d) throw _e;***REMOVED******REMOVED***return _arr;***REMOVED***return function (arr, i) {if (Array.isArray(arr)) {return arr;***REMOVED*** else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);***REMOVED*** else {throw new TypeError("Invalid attempt to destructure non-iterable instance");***REMOVED******REMOVED***;***REMOVED***();
...
var _docsUrl = require('../docsUrl');var _docsUrl2 = _interopRequireDefault(_docsUrl);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***
...
function reverse(array) {
  return array.map(function (v) {return Object.assign({***REMOVED***, v, { rank: -v.rank ***REMOVED***);***REMOVED***).reverse();
***REMOVED***
...
function commentOnSameLineAs(node) {
  return function (token) {return (token.type === 'Block' || token.type === 'Line') &&
    ...
    token.loc.end.line === node.loc.end.line;***REMOVED***;
***REMOVED***
...
function findSpecifierStart(sourceCode, node) {
  ...
  ***REMOVED*** while (token.value !== ',' && token.value !== '{');
...
function findSpecifierEnd(sourceCode, node) {
  ...
  ***REMOVED*** while (token.value !== ',' && token.value !== '***REMOVED***');
...
function isCJSExports(context, node) {
  ...
  {
    return (0, _contextCompat.getScope)(context, node).variables.findIndex(function (variable) {return variable.name === 'module';***REMOVED***) === -1;
  ***REMOVED***
  if (
  node.type === 'Identifier' &&
  node.name === 'exports')
  {
    return (0, _contextCompat.getScope)(context, node).variables.findIndex(function (variable) {return variable.name === 'exports';***REMOVED***) === -1;
  ***REMOVED***
***REMOVED***
  ...
  var nodesBetween = parent.body.slice(firstIndex, secondIndex + 1);var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
    for (var _iterator = nodesBetween[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var nodeBetween = _step.value;
      if (!canCrossNodeWhileReorder(nodeBetween)) {
        return false;
      ***REMOVED***
    ***REMOVED******REMOVED*** catch (err) {_didIteratorError = true;_iteratorError = err;***REMOVED*** finally {try {if (!_iteratorNormalCompletion && _iterator['return']) {_iterator['return']();***REMOVED******REMOVED*** finally {if (_didIteratorError) {throw _iteratorError;***REMOVED******REMOVED******REMOVED***
  return true;
***REMOVED***
...
function fixOutOfOrder(context, firstNode, secondNode, order, category) {
  ...
  isNamed ? {
    ...
    secondRoot: secondNode.node ***REMOVED*** :
  {
    firstRoot: findRootNode(firstNode.node),
    secondRoot: findRootNode(secondNode.node) ***REMOVED***,firstRoot = _ref.firstRoot,secondRoot = _ref.secondRoot;var _ref2 =
  ...
  isNamed ? {
    ...
    secondRootEnd: findSpecifierEnd(sourceCode, secondRoot) ***REMOVED*** :
  {
    ...
    secondRootEnd: findEndOfLineWithComments(sourceCode, secondRoot) ***REMOVED***,firstRootStart = _ref2.firstRootStart,firstRootEnd = _ref2.firstRootEnd,secondRootStart = _ref2.secondRootStart,secondRootEnd = _ref2.secondRootEnd;
    ...
    if (order === 'before') {
      ...
      context.report({
        ...
        fix: function () {function fix(fixer) {return fixer.replaceTextRange(
            ...
            secondCode) + ',' + String(trimmedTrivia) + String(firstCode) + String(firstTrivia) + String(gapCode) + String(whitespaces));***REMOVED***return fix;***REMOVED***() ***REMOVED***);


    ***REMOVED*** else if (order === 'after') {
      ...
      context.report({
        ...
        fix: function () {function fix(fixes) {return fixes.replaceTextRange(
            ...
            _gapCode) + String(firstCode) + ',' + String(_trimmedTrivia) + String(secondCode) + String(_whitespaces));***REMOVED***return fix;***REMOVED***() ***REMOVED***);
    ...
    if (order === 'before') {
      context.report({
        ...
        fix: canFix && function (fixer) {return fixer.replaceTextRange(
          ...
          newCode + sourceCode.text.substring(firstRootStart, secondRootStart));***REMOVED*** ***REMOVED***);
    ...
    ***REMOVED*** else if (order === 'after') {
      context.report({
        ...
        fix: canFix && function (fixer) {return fixer.replaceTextRange(
          ...
          sourceCode.text.substring(secondRootEnd, firstRootEnd) + newCode);***REMOVED*** ***REMOVED***);
...
function reportOutOfOrder(context, imported, outOfOrder, order, category) {
  outOfOrder.forEach(function (imp) {
    var found = imported.find(function () {function hasHigherRank(importedItem) {
      ...
      ***REMOVED***return hasHigherRank;***REMOVED***());
...
function getSorter(alphabetizeOptions) {
  ...
  return function () {function importsSorter(nodeA, nodeB) {
      ...
      ***REMOVED*** else {
        ...
        for (var i = 0; i < Math.min(a, b); i++) {
          ...
          if (i === 0 && (A[i] === '.' || A[i] === '..') && (B[i] === '.' || B[i] === '..')) {
            ...
            if (A[i] !== B[i]) {break;***REMOVED***
            continue;
          ***REMOVED***
          result = compareString(A[i], B[i]);
          if (result) {break;***REMOVED***
        ***REMOVED***
      ...
      ***REMOVED***
      ...
      return result;
    ***REMOVED***return importsSorter;***REMOVED***();
***REMOVED***

function mutateRanksToAlphabetize(imported, alphabetizeOptions) {
  var groupedByRanks = (0, _object2['default'])(imported, function (item) {return item.rank;***REMOVED***);
...
function computePathRank(ranks, pathGroups, path, maxPosition) {
  for (var i = 0, l = pathGroups.length; i < l; i++) {var _pathGroups$i =
    ...
    if ((0, _minimatch2['default'])(path, pattern, patternOptions || { nocomment: true ***REMOVED***)) {
...
function computeRank(context, ranks, importEntry, excludedImportTypes) {
  ...
  if (importEntry.type === 'import:object') {
    impType = 'object';
  ***REMOVED*** else if (importEntry.node.importKind === 'type' && ranks.omittedTypes.indexOf('type') === -1) {
    impType = 'type';
  ***REMOVED*** else {
...
function registerNode(context, importEntry, ranks, imported, excludedImportTypes) {
  ...
  if (rank !== -1) {
    imported.push(Object.assign({***REMOVED***, importEntry, { rank: rank ***REMOVED***));
  ***REMOVED***
***REMOVED***
...
// Example: { index: 0, sibling: 1, parent: 1, external: 1, builtin: 2, internal: 2 ***REMOVED***
...
function convertGroupsToRanks(groups) {
  ...
  ***REMOVED***, rankObject);
  ...
  return { groups: ranks, omittedTypes: omittedTypes ***REMOVED***;
***REMOVED***
...
function convertPathGroupsForRanks(pathGroups) {
  ...
  var transformed = pathGroups.map(function (pathGroup, index) {var
    ...
    ***REMOVED*** else if (positionString === 'before') {
      if (!before[group]) {
        before[group] = [];
      ***REMOVED***
    ...
    ***REMOVED***
    ...
    return Object.assign({***REMOVED***, pathGroup, { position: position ***REMOVED***);
  ***REMOVED***);
  ...
  ***REMOVED***);
  ...
  return {
    ...
    maxPosition: maxPosition > 10 ? Math.pow(10, Math.ceil(Math.log10(maxPosition))) : 10 ***REMOVED***;
...
function removeNewLineAfterImport(context, currentImport, previousImport) {
  ...
  if (/^\s*$/.test(sourceCode.text.substring(rangeToRemove[0], rangeToRemove[1]))) {
    return function (fixer) {return fixer.removeRange(rangeToRemove);***REMOVED***;
  ***REMOVED***
  return undefined;
***REMOVED***
...
function makeNewlinesBetweenReport(context, imported, newlinesBetweenImports, distinctGroup) {
  var getNumberOfEmptyLinesBetween = function getNumberOfEmptyLinesBetween(currentImport, previousImport) {
    ...
    return linesBetweenImports.filter(function (line) {return !line.trim().length;***REMOVED***).length;
  ***REMOVED***;
  var getIsStartOfDistinctGroup = function getIsStartOfDistinctGroup(currentImport, previousImport) {return currentImport.rank - 1 >= previousImport.rank;***REMOVED***;
      ...
      if (currentImport.rank !== previousImport.rank && emptyLinesBetween === 0) {
        if (distinctGroup || !distinctGroup && isStartOfDistinctGroup) {
          context.report({
            ...
            fix: fixNewLineAfterImport(context, previousImport) ***REMOVED***);

        ***REMOVED***
      ***REMOVED*** else if (emptyLinesBetween > 0 &&
      newlinesBetweenImports !== 'always-and-inside-groups') {
        if (distinctGroup && currentImport.rank === previousImport.rank || !distinctGroup && !isStartOfDistinctGroup) {
          context.report({
            node: previousImport.node,
            message: 'There should be no empty line within import group',
            fix: removeNewLineAfterImport(context, currentImport, previousImport) ***REMOVED***);
...
function getAlphabetizeConfig(options) {
  var alphabetize = options.alphabetize || {***REMOVED***;
  ...
  return { order: order, orderImportKind: orderImportKind, caseInsensitive: caseInsensitive ***REMOVED***;
***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('order') ***REMOVED***,
    ...
    schema: [
    {
      ...
      properties: {
        ...
        distinctGroup: {
          type: 'boolean',
          'default': defaultDistinctGroup ***REMOVED***,
        ...
        pathGroups: {
          ...
          items: {
            ...
            properties: {
              ...
              position: {
                type: 'string',
                'enum': ['after', 'before'] ***REMOVED*** ***REMOVED***,


            additionalProperties: false,
            required: ['pattern', 'group'] ***REMOVED*** ***REMOVED***,
        ...
        named: {
            ...
            type: 'boolean' ***REMOVED***,
          {
            type: 'object',
            properties: {
              enabled: { type: 'boolean' ***REMOVED***,
              'import': { type: 'boolean' ***REMOVED***,
              'export': { type: 'boolean' ***REMOVED***,
              require: { type: 'boolean' ***REMOVED***,
              cjsExports: { type: 'boolean' ***REMOVED***,
              types: {
                type: 'string',
                'enum': [
                'mixed',
                'types-first',
                'types-last'] ***REMOVED*** ***REMOVED***,



            additionalProperties: false ***REMOVED***] ***REMOVED***,
        ...
        alphabetize: {
          ...
          properties: {
            ...
            orderImportKind: {
              'enum': ['ignore', 'asc', 'desc'],
              'default': 'ignore' ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function create(context) {
      var options = context.options[0] || {***REMOVED***;
      ...
      var named = Object.assign({
        types: 'mixed' ***REMOVED***,
      _typeof(options.named) === 'object' ? Object.assign({***REMOVED***,
      options.named, {
        ...
        cjsExports: 'cjsExports' in options.named ? options.named.cjsExports : options.named.enabled ***REMOVED***) :
      {
        'import': options.named,
        'export': options.named,
        require: options.named,
        cjsExports: options.named ***REMOVED***);
      ...
      try {var _convertPathGroupsFor =
        ...
        ranks = {
          ...
          maxPosition: maxPosition ***REMOVED***;
      ...
      ***REMOVED*** catch (error) {
        ...
        return {
          Program: function () {function Program(node) {
            ...
            ***REMOVED***return Program;***REMOVED***() ***REMOVED***;
      ...
      function makeNamedOrderReport(context, namedImports) {
        if (namedImports.length > 1) {
          ...
          function (namedImport) {
            ...
            var rank = namedGroups.findIndex(function (entry) {return [].concat(entry).indexOf(kind) > -1;***REMOVED***);

            return Object.assign({
              displayName: namedImport.value,
              rank: rank === -1 ? namedGroups.length : rank ***REMOVED***,
            namedImport, {
              value: String(namedImport.value) + ':' + String(namedImport.alias || '') ***REMOVED***);
      ...
      ***REMOVED***
      ...
      return Object.assign({
        ImportDeclaration: function () {function ImportDeclaration(node) {
            ...
            if (node.specifiers.length || options.warnOnUnassignedImports) {
              ...
              if (named['import']) {
                ...
                function (specifier) {return specifier.type === 'ImportSpecifier';***REMOVED***).map(
                function (specifier) {return Object.assign({
                    node: specifier,
                    value: specifier.imported.name,
                    type: 'import',
                    kind: specifier.importKind ***REMOVED***,
                  specifier.local.range[0] !== specifier.imported.range[0] && {
                    alias: specifier.local.name ***REMOVED***);***REMOVED***));
              ...
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***return ImportDeclaration;***REMOVED***(),
        TSImportEqualsDeclaration: function () {function TSImportEqualsDeclaration(node) {
          ...
          ***REMOVED***return TSImportEqualsDeclaration;***REMOVED***(),
        CallExpression: function () {function CallExpression(node) {
          ...
          ***REMOVED***return CallExpression;***REMOVED***() ***REMOVED***,
      named.require && {
              ...
              ***REMOVED***
              ...
              node.id.properties.map(function (prop) {return Object.assign({
                ...
                prop.key.range[0] !== prop.value.range[0] && {
                  alias: prop.value.name ***REMOVED***);***REMOVED***));



            ***REMOVED***
          ***REMOVED***return VariableDeclarator;***REMOVED***() ***REMOVED***,
      ...
      named['export'] && {
        ExportNamedDeclaration: function () {function ExportNamedDeclaration(node) {
            ...
            node.specifiers.map(function (specifier) {return Object.assign({
                ...
                type: 'export',
                kind: specifier.exportKind ***REMOVED***,
              specifier.local.range[0] !== specifier.exported.range[0] && {
                alias: specifier.exported.name ***REMOVED***);***REMOVED***));



          ***REMOVED***return ExportNamedDeclaration;***REMOVED***() ***REMOVED***,
      ...
      named.cjsExports && {
        AssignmentExpression: function () {function AssignmentExpression(node) {
            if (node.parent.type === 'ExpressionStatement') {
              ...
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***return AssignmentExpression;***REMOVED***() ***REMOVED***, {
        ...
        'Program:exit': function () {function ProgramExit() {
            ...
            ***REMOVED***);
            ...
            importMap.clear();
            exportMap.clear();
          ***REMOVED***return ProgramExit;***REMOVED***() ***REMOVED***);

    ***REMOVED***return create;***REMOVED***() ***REMOVED***;
