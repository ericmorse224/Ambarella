...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
        const options = Object.assign({***REMOVED***, DEFAULT_OPTIONS, context.options[0]);
        ...
        return {
            SequenceExpression(node) {
                ...
                ***REMOVED***
                ...
                context.report({ node, loc: firstCommaToken.loc, messageId: "unexpectedCommaExpression" ***REMOVED***);
            ***REMOVED***
        ***REMOVED***;
