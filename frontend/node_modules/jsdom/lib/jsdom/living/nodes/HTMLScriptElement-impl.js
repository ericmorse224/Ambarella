  ...
  _fetchExternalScript() {
    ...
    ***REMOVED***
    ...
    const onLoadExternalScript = data => {
      const { response ***REMOVED*** = request;
      let contentType;
...
function processJavaScript(element, code, filename) {
  ...
  if (window) {
    ...
    ***REMOVED***
    ...
    try {
      vm.runInContext(code, window, { filename, lineOffset, displayErrors: false ***REMOVED***);
    ***REMOVED*** catch (e) {
