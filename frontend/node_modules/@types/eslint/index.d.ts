...
import { JSONSchema4 ***REMOVED*** from "json-schema";
...
export namespace Scope {
    ...
    ***REMOVED***
    ...
    type DefinitionType =
        | { type: "CatchClause"; node: ESTree.CatchClause; parent: null ***REMOVED***
        | { type: "ClassName"; node: ESTree.ClassDeclaration | ESTree.ClassExpression; parent: null ***REMOVED***
        | { type: "FunctionName"; node: ESTree.FunctionDeclaration | ESTree.FunctionExpression; parent: null ***REMOVED***
        | { type: "ImplicitGlobalVariable"; node: ESTree.Program; parent: null ***REMOVED***
        | {
            type: "ImportBinding";
        ...
        ***REMOVED***
        | {
            ...
            parent: null;
        ***REMOVED***
        | { type: "TDZ"; node: any; parent: null ***REMOVED***
        | { type: "Variable"; node: ESTree.VariableDeclarator; parent: ESTree.VariableDeclaration ***REMOVED***;

    type Definition = DefinitionType & { name: ESTree.Identifier ***REMOVED***;
***REMOVED***
...
export class SourceCode {
    ...
    getComments(node: ESTree.Node): { leading: ESTree.Comment[]; trailing: ESTree.Comment[] ***REMOVED***;
    ...
    getTokenByRangeStart(offset: number, options?: { includeComments: false ***REMOVED***): AST.Token | null;
    getTokenByRangeStart(offset: number, options: { includeComments: boolean ***REMOVED***): AST.Token | ESTree.Comment | null;
...
export namespace Rule {
    ...
    ***REMOVED***
    ...
    interface RuleMetaData {
        ...
        ***REMOVED*** | undefined;
        ...
        messages?: { [messageId: string]: string ***REMOVED*** | undefined;
        /**
    ...
    ***REMOVED***
    ...
    interface RuleContext {
        id: string;
        options: any[];
        settings: { [name: string]: any ***REMOVED***;
    ...
    ***REMOVED***
    ...
    interface ReportDescriptorOptionsBase {
        data?: { [key: string]: string ***REMOVED***;
    ...
    ***REMOVED***
    ...
    type SuggestionDescriptorMessage = { desc: string ***REMOVED*** | { messageId: string ***REMOVED***;
    ...
    ***REMOVED***
    ...
    type ReportDescriptorMessage = { message: string ***REMOVED*** | { messageId: string ***REMOVED***;
    type ReportDescriptorLocation =
        | { node: ESTree.Node ***REMOVED***
        | { loc: AST.SourceLocation | { line: number; column: number ***REMOVED*** ***REMOVED***;
...
export class Linter {
    ...
    constructor(options?: { cwd?: string | undefined; configType?: "flat" | "eslintrc" ***REMOVED***);
    ...
    defineRules(rules: { [name: string]: Rule.RuleModule ***REMOVED***): void;
...
export namespace Linter {
    ...
    ***REMOVED***
        ...
        extends HasRules<Rules>
    {
         ...
         */
        env?: { [name: string]: boolean ***REMOVED*** | undefined;
         ...
         */
        globals?: { [name: string]: boolean | "off" | "readonly" | "readable" | "writable" | "writeable" ***REMOVED*** | undefined;
         ...
         */
        settings?: { [name: string]: any ***REMOVED*** | undefined;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    type ParserModule =
        ...
        & (
            | { parse(text: string, options?: any): AST.Program ***REMOVED***
            | { parseForESLint(text: string, options?: any): ESLintParseResult ***REMOVED***
        );
...
export class ESLint {
    ...
    lintText(
        code: string,
        options?: { filePath?: string | undefined; warnIgnored?: boolean | undefined ***REMOVED***,
...
export namespace RuleTester {
    interface ValidTestCase {
        ...
        settings?: { [name: string]: any ***REMOVED*** | undefined;
        parser?: string | undefined;
        globals?: { [name: string]: boolean ***REMOVED*** | undefined;
    ***REMOVED***
