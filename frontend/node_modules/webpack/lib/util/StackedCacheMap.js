...
class StackedCacheMap {
	...
	***REMOVED***
	 ...
	 * @param {ReadonlyMap<K, V>***REMOVED*** map map to add
	 * @param {boolean=***REMOVED*** immutable if 'map' is immutable and StackedCacheMap can keep referencing it
	 */
	...
	***REMOVED***
	 ...
	 * @returns {V | undefined***REMOVED*** the value of the element
	 */
	get(item) {
	...
	***REMOVED***
	...
	/**
	 * @returns {number***REMOVED*** size of the map
	 */
	get size() {
	...
	***REMOVED***
	...
	/**
	 * @returns {Iterator<[K, V]>***REMOVED*** iterator
	 */
	[Symbol.iterator]() {
		...
		return {
			next() {
				...
				while (result.done && iterators.length > 0) {
					current = /** @type {IterableIterator<[K, V]>***REMOVED*** */ (iterators.pop());
					result = current.next();
				***REMOVED***
				return result;
			***REMOVED***
