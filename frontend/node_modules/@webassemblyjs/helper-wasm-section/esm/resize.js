import { encodeU32 ***REMOVED*** from "@webassemblyjs/wasm-gen";
import { getSectionMetadata, traverse, shiftSection ***REMOVED*** from "@webassemblyjs/ast";
...
export function resizeSectionByteSize(ast, uint8Buffer, section, deltaBytes) {
  ...
  ***REMOVED*** // keep old node location to be overriden
  ...
  ***REMOVED*** // Once we hit our section every that is after needs to be shifted by the delta
