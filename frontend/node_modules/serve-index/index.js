 ...
 *
 * @param {String***REMOVED*** root
 * @param {Object***REMOVED*** options
 * @return {Function***REMOVED*** middleware
 * @public
 */
  ...
  ***REMOVED***
  ...
  stat(path, files, function (err, stats) {
    ...
    var fileList = files.map(function (file, i) {
      return { name: file, stat: stats[i] ***REMOVED***;
    ***REMOVED***);
...
function createHtmlFileList(files, dir, useIcons, view) {
  ...
  html += files.map(function (file) {
    ...
    var path = dir.split('/').map(function (c) { return encodeURIComponent(c); ***REMOVED***);
...
function createHtmlRender(template) {
  return function render(locals, callback) {
    ...
    fs.readFile(template, 'utf8', function (err, str) {
      ...
      var body = str
        .replace(/\{style\***REMOVED***/g, locals.style.concat(iconStyle(locals.fileList, locals.displayIcons)))
        .replace(/\{files\***REMOVED***/g, createHtmlFileList(locals.fileList, locals.directory, locals.displayIcons, locals.viewName))
        .replace(/\{directory\***REMOVED***/g, escapeHtml(locals.directory))
        .replace(/\{linked-path\***REMOVED***/g, htmlPath(locals.directory));
...
function iconStyle(files, useIcons) {
  ...
  for (i = 0; i < files.length; i++) {
    ...
    var isDir = file.stat && file.stat.isDirectory();
    var icon = isDir
      ? { className: 'icon-directory', fileName: icons.folder ***REMOVED***
