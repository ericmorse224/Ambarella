import type { SourceMapInput ***REMOVED*** from '@jridgewell/trace-mapping';
import type { DecodedSourceMap, EncodedSourceMap, Pos, Mapping ***REMOVED*** from './types';
export type { DecodedSourceMap, EncodedSourceMap, Mapping ***REMOVED***;
...
export declare class GenMapping {
    ...
    constructor({ file, sourceRoot ***REMOVED***?: Options);
***REMOVED***
/**
