...
```js
import { openDB, deleteDB, wrap, unwrap ***REMOVED*** from 'idb';
...
```html
<script type="module">
  import { openDB, deleteDB, wrap, unwrap ***REMOVED*** from 'https://cdn.jsdelivr.net/npm/idb@7/+esm';
...
```js
import { openDB ***REMOVED*** from 'idb/with-async-ittr';
```
...
```js
import { openDB ***REMOVED*** from 'idb/with-async-ittr.js';
  ...
  ***REMOVED***
  ...
  // Add 'And, happy new year!' to all articles on 2019-01-01:
  {
    ...
    for await (const cursor of index.iterate(new Date('2019-01-01'))) {
      const article = { ...cursor.value ***REMOVED***;
...
```ts
import { openDB, DBSchema ***REMOVED*** from 'idb';
...
interface MyDB extends DBSchema {
  ...
  ***REMOVED***;
  products: {
    ...
    ***REMOVED***;
    key: string;
    indexes: { 'by-price': number ***REMOVED***;
  ***REMOVED***;
***REMOVED***
...
```ts
import { openDB, DBSchema, IDBPDatabase ***REMOVED*** from 'idb';

interface MyDBV1 extends DBSchema {
  'favourite-number': { key: string; value: number ***REMOVED***;
***REMOVED***

interface MyDBV2 extends DBSchema {
  'fave-num': { key: string; value: number ***REMOVED***;
***REMOVED***
