...
function getExportSpecifierName(node, stringSpecifiers) {
  if (node.type === "Identifier") {
    return node.name;
  ***REMOVED*** else if (node.type === "StringLiteral") {
    ...
    ***REMOVED***
    return stringValue;
  ***REMOVED*** else {
    throw new Error(`Expected export specifier to be either Identifier or StringLiteral, got ${node.type***REMOVED***`);
  ***REMOVED***
***REMOVED***
          ...
          ***REMOVED***
          ...
          for (const path of body) {
            ...
            ***REMOVED*** else if (path.isImportDeclaration()) {
              ...
              ***REMOVED***
              path.remove();
            ***REMOVED*** else if (path.isExportAllDeclaration()) {
              pushModule(path.node.source.value, "exports", path.node);
              path.remove();
            ***REMOVED*** else if (path.isExportDefaultDeclaration()) {
              ...
              if (_core.types.isClassDeclaration(declar)) {
                ...
                ***REMOVED*** else {
                  ...
                  removedPaths.push(path);
                ***REMOVED***
              ***REMOVED*** else if (_core.types.isFunctionDeclaration(declar)) {
                const id = declar.id;
                if (id) {
              ...
              ***REMOVED***
            ***REMOVED*** else if (path.isExportNamedDeclaration()) {
              const declar = path.node.declaration;
              if (declar) {
                ...
                if (_core.types.isFunction(declar)) {
                  ...
                  removedPaths.push(path);
                ***REMOVED*** else if (_core.types.isClass(declar)) {
                  const name = declar.id.name;
                  exportNames.push(name);
                  exportValues.push(scope.buildUndefinedNode());
          ...
          ***REMOVED***
          modules.forEach(function (specifiers) {
            ...
            for (let specifier of specifiers.imports) {
              ...
              ***REMOVED*** else if (_core.types.isImportDefaultSpecifier(specifier)) {
            ...
            if (specifiers.exports.length) {
              ...
              for (const node of specifiers.exports) {
                if (_core.types.isExportAllDeclaration(node)) {
                  hasExportStar = true;
                ***REMOVED*** else if (_core.types.isExportSpecifier(node)) {
