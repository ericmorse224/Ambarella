...
if (process.stdout.isTTY /* Detect redirecting output to a file */  && (process.argv[2] === undefined || process.argv.slice(2).every((flag)=>sharedFlags[flag] !== undefined))) {
    (0, _help.help)({
        ...
        commands: Object.keys(commands).filter((command)=>command !== "build").map((command)=>`${command***REMOVED*** [options]`),
        options: {
            ...commands.build.args,
            ...sharedFlags
        ***REMOVED***
...
if (commands[command] === undefined) {
    ...
    ***REMOVED*** else {
        (0, _help.help)({
            message: `Invalid command: ${command***REMOVED***`,
            usage: [
...
***REMOVED***
// Execute command
let { args: flags , run  ***REMOVED*** = commands[command];
let args = (()=>{
    try {
        let result = (0, _arg.default)(Object.fromEntries(Object.entries({
            ...flags,
            ...sharedFlags
        ***REMOVED***).filter(([_key, value])=>{
            var _value_type;
...
if (args["--help"]) {
    (0, _help.help)({
        ...
        ***REMOVED***,
        usage: [
            `tailwindcss ${command***REMOVED*** [options]`
        ]
    ***REMOVED***);
    process.exit(0);
***REMOVED***
