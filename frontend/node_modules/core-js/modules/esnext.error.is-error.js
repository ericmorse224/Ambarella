...
var PROTOTYPE_SETTING_AVAILABLE = Object.setPrototypeOf || ({***REMOVED***).__proto__;
...
var FORCED = !$isError || !PROTOTYPE_SETTING_AVAILABLE || fails(function () {
  ...
  return (DOMException && !$isError(new DOMException(DOM_EXCEPTION))) ||
    ...
    !$isError(new $Error(ERROR, { cause: function () { /* empty */ ***REMOVED*** ***REMOVED***)) ||
...
$({ target: 'Error', stat: true, sham: true, forced: FORCED ***REMOVED***, {
