...
class Composer {
    constructor(options = {***REMOVED***) {
        ...
        ***REMOVED***;
        ...
        this.directives = new directives.Directives({ version: options.version || '1.2' ***REMOVED***);
    ...
    *next(token) {
        if (node_process.env.LOG_STREAM)
            console.dir(token, { depth: null ***REMOVED***);
        switch (token.type) {
            case 'directive':
            ...
            ***REMOVED***
            default:
                this.errors.push(new errors.YAMLParseError(getErrorPos(token), 'UNEXPECTED_TOKEN', `Unsupported token ${token.type***REMOVED***`));
        ***REMOVED***
    ***REMOVED***
    /**
