...
async function suppressAsync() {
    ...
    ***REMOVED***
    ...
    const parsedArgs = args.reduce((acc, arg, index, arr) => {
        ...
        ***REMOVED***
            ...
            throw new Error(`@rushstack/eslint-bulk: Unknown option: ${arg***REMOVED***`);
        ***REMOVED***
        else {
            acc.files.push(arg);
        ***REMOVED***
        return acc;
    ***REMOVED***, { rules: [], all: false, files: [] ***REMOVED***);
    ...
    ***REMOVED***
    ...
    if (parsedArgs.all) {
        console.log(`@rushstack/eslint-bulk: Successfully suppressed all rules for file(s) ${parsedArgs.files***REMOVED***`);
    ***REMOVED***
    else if (parsedArgs.rules.length > 0) {
        console.log(`@rushstack/eslint-bulk: Successfully suppressed rules ${parsedArgs.rules***REMOVED*** for file(s) ${parsedArgs.files***REMOVED***`);
    ***REMOVED***
***REMOVED***
