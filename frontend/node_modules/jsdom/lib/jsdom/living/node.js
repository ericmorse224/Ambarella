...
exports.listOfElementsWithClassNames = (classNames, root) => {
  ...
  if (classes.size === 0) {
    return HTMLCollection.createImpl(root._globalObject, [], { element: root, query: () => [] ***REMOVED***);
  ***REMOVED***
