...
import { elementType ***REMOVED*** from 'jsx-ast-utils';
...
test('getAccessibleChildText', (t) => {
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [JSXAttributeMock('aria-label', 'foo')],
      [{ type: 'JSXText', value: 'bar' ***REMOVED***],
    ), elementType),
    'foo',
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [],
      [{ type: 'Literal', value: 'bar' ***REMOVED***],
    ), elementType),
    'bar',
    'returns literal value for JSXText child',
  );
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [],
      [{ type: 'Literal', value: 'foo         bar' ***REMOVED***],
    ), elementType),
    'foo bar',
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [],
      [{ type: 'Literal', value: 'foo, bar. baz? foo; bar:' ***REMOVED***],
    ), elementType),
    'foo bar baz foo bar',
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [],
      [{ type: 'Literal', value: 'foo' ***REMOVED***, { type: 'Literal', value: 'bar' ***REMOVED***],
    ), elementType),
    'foo bar',
  ...
  t.equal(
    getAccessibleChildText(JSXElementMock(
      'a',
      [],
      [{ type: 'Literal', value: 'foo' ***REMOVED***, { type: 'Unknown' ***REMOVED***, { type: 'Literal', value: 'bar' ***REMOVED***],
    ), elementType),
    'foo bar',
