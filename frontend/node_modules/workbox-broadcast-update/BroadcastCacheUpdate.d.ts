import { CacheDidUpdateCallbackParam ***REMOVED*** from 'workbox-core/types.js';
import './_version.js';
...
declare class BroadcastCacheUpdate {
     ...
     */
    constructor({ generatePayload, headersToCheck, notifyAllClients, ***REMOVED***?: BroadcastCacheUpdateOptions);
    /**
