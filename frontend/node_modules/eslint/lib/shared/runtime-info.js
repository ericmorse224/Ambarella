...
function environment() {
	...
	***REMOVED***
	...
	function getBinVersion(bin) {
		...
		***REMOVED*** catch (e) {
			log.error(
				`Error finding ${bin***REMOVED*** version running the command \`${bin***REMOVED*** ${binArgs.join(" ")***REMOVED***\``,
			);
			throw e;
		***REMOVED***
	***REMOVED***
	...
	function getNpmPackageVersion(pkg, { global = false ***REMOVED*** = {***REMOVED***) {
		...
		***REMOVED***
		...
		try {
			...
			***REMOVED*** catch (e) {
				log.error(
					`Error finding npm binary path when running command \`npm ${npmBinArgs.join(" ")***REMOVED***\``,
				);
				throw e;
			***REMOVED***
		...
		***REMOVED*** catch (e) {
			log.error(
				`Error finding ${pkg***REMOVED*** version running the command \`npm ${npmLsArgs.join(" ")***REMOVED***\``,
			);
			throw e;
		***REMOVED***
	***REMOVED***
