...
Examples of code for this rule with `{ allowAny: true ***REMOVED***`:
...
Examples of code for this rule with `{ allowBoolean: true ***REMOVED***`:
...
Examples of code for this rule with `{ allowNullish: true ***REMOVED***`:
...
Examples of code for this rule with `{ allowNumberAndString: true ***REMOVED***`:
...
Examples of code for this rule with `{ allowRegExp: true ***REMOVED***`:
...
Examples of code for this rule with `{ checkCompoundAssignments: true ***REMOVED***`:
