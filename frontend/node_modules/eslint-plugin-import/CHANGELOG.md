...
### Fixed
- [`no-extraneous-dependencies`]: ignore `export type { ... ***REMOVED*** from '...'` when `includeTypes` is `false` ([#2919], thanks [@Pandemic1617])
...
- [`no-duplicates`]: avoid crash with empty `import type {***REMOVED***` ([#2201], thanks [@ljharb])
...
### Fixed
- [`newline-after-import`]: fix crash with `export {***REMOVED***` syntax ([#2063], [#2056], thanks [@ljharb])
...
- [`no-unused-modules`]: Handle `export { default ***REMOVED*** from` syntax ([#1631], thanks [@richardxia])
...
- [`no-unused-modules`]: make `import { name as otherName ***REMOVED***` work ([#1340], [#1342], thanks [@rfermann])
