...
***REMOVED***)(AllowedType || (AllowedType = {***REMOVED***));
    ...
    create(context) {
        ...
        ***REMOVED***
        function getDesiredTypeForDefinition(node) {
            const { imports, previousSibling ***REMOVED*** = collectNodeDefinitions(node);
            // Case: Merged ambiently via module augmentation
            // import { MyEnum ***REMOVED*** from 'other-module';
            // declare module 'other-module' {
            //   enum MyEnum { A ***REMOVED***
            // ***REMOVED***
