  ...
  ***REMOVED***
  ...
  if (isTaggedTemplateLiteral(table)) {
    ...
    ***REMOVED***
    ...
    throw new Error(
      'Error: `.each` called with a Tagged Template Literal with no data, remember to interpolate with ${expression***REMOVED*** syntax.\n'
    );
  ***REMOVED***
  ...
  if (missingData > 0) {
    throw new Error(
      'Not enough arguments supplied for given headings:\n' +
        ...
        '\n\n' +
        `Missing ${RECEIVED_COLOR(missingData.toString())***REMOVED*** ${pluralize(
          'argument',
          missingData
        )***REMOVED***`
    );
...
const HEADING = '\\s*[^\\s]+\\s*';
const PIPE = '\\|';
const REPEATABLE_HEADING = `(${PIPE***REMOVED***${HEADING***REMOVED***)*`;
