...
const expandIncludesAndExcludes = (filterList = [], type, corejs) => {
  ...
  const selectedPlugins = flatMap(filterList, filter => {
    ...
    if (typeof filter === "string") {
      try {
        re = new RegExp(`^${normalizePluginName(filter)***REMOVED***$`);
      ***REMOVED*** catch (_) {
    ...
    ***REMOVED***);
    ...
    return items;
  ***REMOVED***);
  v.invariant(invalidFilters.length === 0, `The plugins/built-ins '${invalidFilters.join(", ")***REMOVED***' passed to the '${type***REMOVED***' option are not
...
const checkDuplicateIncludeExcludes = (include = [], exclude = []) => {
  ...
  v.invariant(duplicates.length === 0, `The plugins/built-ins '${duplicates.join(", ")***REMOVED***' were found in both the "include" and
    "exclude" options.`);
***REMOVED***;
...
const normalizeTargets = targets => {
  if (typeof targets === "string" || Array.isArray(targets)) {
    ...
    ***REMOVED***;
  ***REMOVED***
  return Object.assign({***REMOVED***, targets);
***REMOVED***;
...
function normalizeCoreJSOption(corejs, useBuiltIns) {
  ...
  if (useBuiltIns && corejs === undefined) {
    ...
    ***REMOVED***
  ***REMOVED*** else if (typeof corejs === "object" && corejs !== null) {
