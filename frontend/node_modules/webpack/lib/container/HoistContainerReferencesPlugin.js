...
class HoistContainerReferences {
	 ...
	 * @param {Compiler***REMOVED*** compiler The webpack compiler instance.
	 */
	apply(compiler) {
	...
	***REMOVED***
	 ...
	 * @param {Compilation***REMOVED*** compilation The webpack compilation instance.
	 * @param {Set<Dependency>***REMOVED*** depsToTrace Set of container entry dependencies.
	 * @param {Set<Dependency>***REMOVED*** entryExternalsToHoist Set of container entry dependencies to hoist.
	 */
	hoistModulesInChunks(compilation, depsToTrace, entryExternalsToHoist) {
		const { chunkGraph, moduleGraph ***REMOVED*** = compilation;
	...
	***REMOVED***
	 ...
	 * @param {Compilation***REMOVED*** compilation The webpack compilation instance.
	 * @param {Set<Module>***REMOVED*** modules Set of modules to clean up.
	 */
 ...
 * @param {Compilation***REMOVED*** compilation The webpack compilation instance.
 * @param {Module***REMOVED*** module The module to start collecting from.
 * @param {string***REMOVED*** type The type of modules to collect ("initial", "external", or "all").
 * @param {boolean***REMOVED*** includeInitial Should include the referenced module passed
 * @returns {Set<Module>***REMOVED*** Set of collected modules.
 */
