          ...
          if (whiteSpaceBefore !== '\n' && whiteSpaceBefore !== '\r') {
            context.report({
              ...
              ***REMOVED***,
              ...
              message: 'There must be no space at start of "{{name***REMOVED******REMOVED***" generic type annotation',
              node: types
            ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
          ...
          if (whiteSpaceAfter !== '\n' && whiteSpaceAfter !== '\r') {
            context.report({
              ...
              ***REMOVED***,
              ...
              message: 'There must be no space at end of "{{name***REMOVED******REMOVED***" generic type annotation',
              node: types
            ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
        ...
        if (spacesBefore > 1) {
          context.report({
            ...
            ***REMOVED***,
            ...
            message: 'There must be one space at start of "{{name***REMOVED******REMOVED***" generic type annotation',
            node: types
          ***REMOVED***);
        ***REMOVED*** else if (spacesBefore === 0) {
          context.report({
            data: {
              name: node.id.name
            ***REMOVED***,
            fix: _utilities.spacingFixers.addSpaceAfter(opener),
            message: 'There must be a space at start of "{{name***REMOVED******REMOVED***" generic type annotation',
            node: types
          ***REMOVED***);
        ***REMOVED***
        ...
        if (spacesAfter > 1) {
          context.report({
            ...
            ***REMOVED***,
            ...
            message: 'There must be one space at end of "{{name***REMOVED******REMOVED***" generic type annotation',
            node: types
          ***REMOVED***);
        ***REMOVED*** else if (spacesAfter === 0) {
          context.report({
            data: {
              name: node.id.name
            ***REMOVED***,
            fix: _utilities.spacingFixers.addSpaceAfter(lastInnerToken),
            message: 'There must be a space at end of "{{name***REMOVED******REMOVED***" generic type annotation',
            node: types
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***
