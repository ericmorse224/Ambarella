...
function walkForTsConfig(directory, existsSync) {
    if (existsSync === void 0) { existsSync = fs.existsSync; ***REMOVED***
...
existsSync, readFileSync) {
    ...
    ***REMOVED***
    var config = loadTsconfig(extendedConfigPath, existsSync, readFileSync) || {***REMOVED***;
...
function mergeTsconfigs(base, config) {
    ...
    return __assign(__assign(__assign({***REMOVED***, base), config), { compilerOptions: __assign(__assign({***REMOVED***, base.compilerOptions), config.compilerOptions) ***REMOVED***);
***REMOVED***
