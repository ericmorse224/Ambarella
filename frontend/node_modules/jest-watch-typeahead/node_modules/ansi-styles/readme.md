...
console.log(`${style.green.open***REMOVED***Hello world!${style.green.close***REMOVED***`);
...
//       original color.
console.log(`${style.color.ansi256(style.rgbToAnsi256(199, 20, 250))***REMOVED***Hello World${style.color.close***REMOVED***`)
console.log(`${style.color.ansi16m(...style.hexToRgb('#abcdef'))***REMOVED***Hello World${style.color.close***REMOVED***`)
```
