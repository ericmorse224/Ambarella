...
> If you need to target browsers with native modules support (like this preset does), you can use `targets: { esmodules: true ***REMOVED***`.
...
const foo = ({ a = 1 ***REMOVED***) => {***REMOVED***;

// .. but this doesn't:
function foo({ a = 1, b ***REMOVED***, ...args) {***REMOVED***

// ... and neither does this:
const foo = ({ a: a = 1 ***REMOVED***) => {***REMOVED***;
```
...
```js
const foo = ({ a = 1 ***REMOVED***, b = 2, ...args) => [a,b,args];
```

**output:**

```js
const foo = ({ a: a = 1 ***REMOVED***, b = 2, ...args) => [a,b,args];
```
...
>  let { a = 1 ***REMOVED*** = _ref;
>
>  if (b === void 0) { b = 2; ***REMOVED***
>
>  for (
