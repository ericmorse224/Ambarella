...
import type {CodeGen, Code, Name, ScopeValueSets, ValueScopeName***REMOVED*** from "../compile/codegen"
import type {SchemaEnv, SchemaCxt, SchemaObjCxt***REMOVED*** from "../compile"
import type {JSONType***REMOVED*** from "../compile/rules"
...
export type SchemaMap = {[Key in string]?: AnySchema***REMOVED***
...
export interface DataValidationCxt<T extends string | number = string | number> {
  instancePath: string
  parentData: {[K in T]: any***REMOVED*** // object or array
  parentDataProperty: T // string or number
  rootData: Record<string, any> | any[]
  dynamicAnchors: {[Ref in string]?: ValidateFunction***REMOVED***
***REMOVED***
...
export type EvaluatedProperties = {[K in string]?: true***REMOVED*** | true
...
export type KeywordCxtParams = {[P in string]?: Code | string | number***REMOVED***
