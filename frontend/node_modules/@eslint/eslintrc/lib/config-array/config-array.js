...
const { ExtractedConfig ***REMOVED*** = require("./extracted-config");
 ...
 * @param {function(T): U***REMOVED*** [normalize] The normalize function for each value.
 * @returns {void***REMOVED***
 */
 ...
 * @param {Function|Rule***REMOVED*** rule The rule definition to normalize.
 * @returns {Rule***REMOVED*** The normalized rule definition.
 */
function normalizePluginRule(rule) {
    return typeof rule === "function" ? { create: rule ***REMOVED*** : rule;
***REMOVED***
