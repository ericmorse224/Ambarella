 ...
 * @returns {boolean***REMOVED*** Whether or not the node is a `.apply()` for variadic.
 */
 ...
 * @param {ASTNode***REMOVED*** thisArg The node that is given to the first argument of the `.apply()`.
 * @param {RuleContext***REMOVED*** context The ESLint rule context object.
 * @returns {boolean***REMOVED*** Whether or not `thisArg` is not changed by `.apply()`.
 */
