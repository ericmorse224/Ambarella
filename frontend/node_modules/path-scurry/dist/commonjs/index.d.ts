...
import type { Dirent, Stats ***REMOVED*** from 'node:fs';
/**
...
export interface FSOption {
    ...
    readdir?: (path: string, options: {
        withFileTypes: true;
    ***REMOVED***, cb: (er: NodeJS.ErrnoException | null, entries?: Dirent[]) => any) => void;
...
export declare abstract class PathBase implements Dirent {
    ...
    ***REMOVED***;
    ...
    constructor(name: string, type: number | undefined, root: PathBase | undefined, roots: {
        [k: string]: PathBase;
    ***REMOVED***, nocase: boolean, children: ChildrenCache, opts: PathOpts);
    /**
...
export declare abstract class PathScurryBase {
    ...
    ***REMOVED***;
     ...
     * @internal
     */
    constructor(cwd: string | URL | undefined, pathImpl: typeof win32 | typeof posix, sep: string | RegExp, { nocase, childrenCacheSize, fs, ***REMOVED***?: PathScurryOpts);
    /**
     ...
     * `{ withFileTypes: false ***REMOVED***` to return strings.
     */
    readdir(): Promise<PathBase[]>;
    readdir(opts: {
        withFileTypes: true;
    ***REMOVED***): Promise<PathBase[]>;
    readdir(opts: {
        withFileTypes: false;
    ***REMOVED***): Promise<string[]>;
    readdir(opts: {
        withFileTypes: boolean;
    ***REMOVED***): Promise<PathBase[] | string[]>;
    ...
    ***REMOVED***): Promise<PathBase[] | string[]>;
    /**
     * synchronous {@link PathScurryBase.readdir***REMOVED***
     */
    readdirSync(): PathBase[];
    readdirSync(opts: {
        withFileTypes: true;
    ...
    ***REMOVED***): PathBase[] | string[];
     ...
     * Result is cached, and thus may be outdated if the filesystem is mutated.
     *
     * `{withFileTypes***REMOVED***` option defaults to `false`.
     *
    ...
    readlink(opt: {
        withFileTypes: false;
    ***REMOVED***): Promise<string | undefined>;
    readlink(opt: {
        withFileTypes: true;
    ***REMOVED***): Promise<PathBase | undefined>;
    readlink(opt: {
        withFileTypes: boolean;
    ***REMOVED***): Promise<PathBase | string | undefined>;
    ...
    ***REMOVED***): Promise<PathBase | undefined>;
    readlink(entry: string | PathBase, opt: {
        withFileTypes: boolean;
    ***REMOVED***): Promise<string | PathBase | undefined>;
    /**
     * synchronous {@link PathScurryBase.readlink***REMOVED***
     */
    ...
    ***REMOVED***): string | undefined;
    readlinkSync(opt: {
        withFileTypes: true;
    ***REMOVED***): PathBase | undefined;
    readlinkSync(opt: {
        withFileTypes: boolean;
    ***REMOVED***): PathBase | string | undefined;
    ...
    ***REMOVED***): PathBase | undefined;
    readlinkSync(entry: string | PathBase, opt: {
        withFileTypes: boolean;
    ***REMOVED***): string | PathBase | undefined;
    /**
    ...
    ***REMOVED***): string | PathBase | undefined;
    ...
    /**
     * Async generator form of {@link PathScurryBase.walk***REMOVED***
     *
     * Note: As of Node 19, this is very slow, compared to other methods of
     * walking, especially if most/all of the directory tree has been previously
     * walked.  Consider using {@link PathScurryBase.stream***REMOVED*** if memory overhead
     * and backpressure are concerns, or {@link PathScurryBase.walk***REMOVED*** if not.
     */
    ...
    /**
     * Stream form of {@link PathScurryBase.walk***REMOVED***
     *
     * Returns a Minipass stream that emits {@link PathBase***REMOVED*** objects by default,
     * or strings if `{ withFileTypes: false ***REMOVED***` is set in the options.
     */
    ...
    /**
     * Synchronous form of {@link PathScurryBase.stream***REMOVED***
     *
     * Returns a Minipass stream that emits {@link PathBase***REMOVED*** objects by default,
     * or strings if `{ withFileTypes: false ***REMOVED***` is set in the options.
     *
...
export interface WalkOptions {
    /**
     * Return results as {@link PathBase***REMOVED*** objects rather than strings.
     * When set to false, results are fully resolved paths, as returned by
     * {@link PathBase.fullpath***REMOVED***.
     * @default true
     */
    withFileTypes?: boolean;
    /**
     ...
     * being included in the result set.  See {@link walkFilter***REMOVED***
     *
    ...
    /**
     * Only traverse directories (and in the case of {@link follow***REMOVED*** being set to
     * true, symbolic links to directories) if the provided function returns
     * true.
     *
     * This will not prevent directories from being included in the result set,
     * even if they do not pass the supplied filter function.  See {@link filter***REMOVED***
     * to do that.
     *
     * Asynchronous functions are not supported here.
     */
