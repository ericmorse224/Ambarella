...
var allNamedReferences = __assign(__assign({***REMOVED***, named_references_js_1.namedReferences), { all: named_references_js_1.namedReferences.html5 ***REMOVED***);
var encodeRegExps = {
    specialChars: /[<>'"&]/g,
    nonAscii: /[<>'"&\u0080-\uD7FF\uE000-\uFFFF\uDC00-\uDFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]?/g,
...
var baseDecodeRegExps = {
    ...
    ***REMOVED***
***REMOVED***;
var decodeRegExps = __assign(__assign({***REMOVED***, baseDecodeRegExps), { all: baseDecodeRegExps.html5 ***REMOVED***);
...
function decode(text, _a) {
    ...
    ***REMOVED***
    ...
    return text.replace(decodeRegExp, function (entity) { return getDecodedEntity(entity, references, isAttribute, isStrict); ***REMOVED***);
***REMOVED***
