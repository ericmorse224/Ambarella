...
module.exports = {
	meta: {
		...
		defaultOptions: [{ defaultAssignment: true ***REMOVED***],
	...
	***REMOVED***,
	...
	create(context) {
		const [{ defaultAssignment ***REMOVED***] = context.options;
		...
		function invertExpression(node) {
			...
			***REMOVED***
			...
			if (
				...
				astUtils.getPrecedence({ type: "UnaryExpression" ***REMOVED***)
			) {
							...
							***REMOVED***
							...
							return fixer.replaceText(
								...
								isBooleanExpression(node.test)
									...
									: `!${invertExpression(node.test)***REMOVED***`,
							);
						***REMOVED***,
					***REMOVED***);
				***REMOVED*** else if (
					...
					context.report({
						...
						fix(fixer) {
							...
							return fixer.replaceText(
								node,
								`${testText***REMOVED*** || ${alternateText***REMOVED***`,
							);
						***REMOVED***,
					***REMOVED***);
				***REMOVED***
