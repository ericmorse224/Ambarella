...
test('Constructor throws', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    t.throws(function () { impl.Buffer() ***REMOVED***)
    t.throws(function () { impl.Buffer(0) ***REMOVED***)
    t.throws(function () { impl.Buffer('a') ***REMOVED***)
    t.throws(function () { impl.Buffer('a', 'utf-8') ***REMOVED***)
    t.throws(function () { return new impl.Buffer() ***REMOVED***)
    t.throws(function () { return new impl.Buffer(0) ***REMOVED***)
    t.throws(function () { return new impl.Buffer('a') ***REMOVED***)
    t.throws(function () { return new impl.Buffer('a', 'utf-8') ***REMOVED***)
  ***REMOVED***)
  t.end()
***REMOVED***)
...
test('Invalid calls throw', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
    t.throws(function () { impl.Buffer.from(0) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(10) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(10, 'utf-8') ***REMOVED***)
    t.throws(function () { impl.Buffer.from('string', 'invalid encoding') ***REMOVED***)
    t.throws(function () { impl.Buffer.from(-10) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(1e90) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(Infinity) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(-Infinity) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(NaN) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(null) ***REMOVED***)
    t.throws(function () { impl.Buffer.from(undefined) ***REMOVED***)
    t.throws(function () { impl.Buffer.from() ***REMOVED***)
    t.throws(function () { impl.Buffer.from({***REMOVED***) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc('') ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc('string') ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc('string', 'utf-8') ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc('b25ldHdvdGhyZWU=', 'base64') ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(-10) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(1e90) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(2 * (1 << 30)) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(Infinity) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(-Infinity) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(null) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc(undefined) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc() ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc([]) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc([0, 42, 3]) ***REMOVED***)
    t.throws(function () { impl.Buffer.alloc({***REMOVED***) ***REMOVED***)
  ***REMOVED***);
  ['allocUnsafe', 'allocUnsafeSlow'].forEach(function (method) {
    t.throws(function () { dangerous.Buffer[method]('') ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]('string') ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]('string', 'utf-8') ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method](2 * (1 << 30)) ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method](Infinity) ***REMOVED***)
    if (dangerous.Buffer[method] === buffer.Buffer.allocUnsafe) {
      t.skip('Skipping, older impl of allocUnsafe coerced negative sizes to 0')
    ***REMOVED*** else {
      t.throws(function () { dangerous.Buffer[method](-10) ***REMOVED***)
      t.throws(function () { dangerous.Buffer[method](-1e90) ***REMOVED***)
      t.throws(function () { dangerous.Buffer[method](-Infinity) ***REMOVED***)
    ***REMOVED***
    t.throws(function () { dangerous.Buffer[method](null) ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method](undefined) ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]() ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]([]) ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]([0, 42, 3]) ***REMOVED***)
    t.throws(function () { dangerous.Buffer[method]({***REMOVED***) ***REMOVED***)
  ***REMOVED***)
  t.end()
***REMOVED***)
