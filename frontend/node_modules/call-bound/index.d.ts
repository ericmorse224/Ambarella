...
type IntrinsicName = keyof Intrinsic | `%${keyof Intrinsic***REMOVED***%`;

type IntrinsicPath = IntrinsicName | `${StripPercents<IntrinsicName>***REMOVED***.${string***REMOVED***` | `%${StripPercents<IntrinsicName>***REMOVED***.${string***REMOVED***%`;

type AllowMissing = boolean;

type StripPercents<T extends string> = T extends `%${infer U***REMOVED***%` ? U : T;
...
type GetPrototypeMethod<T extends keyof typeof globalThis, M extends string> =
  (typeof globalThis)[T] extends { prototype: any ***REMOVED***
...
type BoundIntrinsic<S extends string> =
  S extends `${infer Obj***REMOVED***.prototype.${infer Method***REMOVED***`
  ? Obj extends keyof typeof globalThis
  ? BindMethodPrecise<GetPrototypeMethod<Obj, Method & string>>
  : unknown
  : S extends `${infer Obj***REMOVED***.${infer Prop***REMOVED***`
  ? Obj extends keyof typeof globalThis
...
interface SpecialCases {
  '%Object.prototype.isPrototypeOf%': (thisArg: {***REMOVED***, obj: unknown) => boolean;
  ...
  ***REMOVED***;
  '%Object.prototype.toString%': (obj: {***REMOVED***) => string;
  '%Object.prototype.hasOwnProperty%': (obj: {***REMOVED***, v: PropertyKey) => boolean;
 ...
 * @param {AllowMissing***REMOVED*** [allowMissing] - Whether to allow missing intrinsics (default: false)
 */
declare function callBound<K extends keyof SpecialCases | StripPercents<keyof SpecialCases>, S extends IntrinsicPath>(name: K, allowMissing?: AllowMissing): SpecialCases[`%${StripPercents<K>***REMOVED***%`];
