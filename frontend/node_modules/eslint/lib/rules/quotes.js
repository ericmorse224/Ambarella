...
const UNESCAPED_LINEBREAK_PATTERN = new RegExp(
	String.raw`(^|[^\\])(\\\\)*[${Array.from(astUtils.LINEBREAKS).join("")***REMOVED***]`,
	"u",
);
 ...
 * @param {string***REMOVED*** str A string to convert.
 * @returns {string***REMOVED*** The string with changed quotes.
 * @private
 */
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			wrongQuotes: "Strings must use {{description***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED***
		 ...
		 *
		 * - `<div className={"foo"***REMOVED***></div>`
		 * - `<div>{"foo"***REMOVED***</div>`
		 *
		 * In both cases, inside of the braces is handled as normal JavaScript.
		 * The braces are `JSXExpressionContainer` nodes.
		 * @param {ASTNode***REMOVED*** node The Literal node to check.
		 * @returns {boolean***REMOVED*** True if the node is a part of JSX, false if not.
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @returns {boolean***REMOVED*** Whether or not the node is a directive.
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @see {@link http://www.ecma-international.org/ecma-262/6.0/#sec-directive-prologues-and-the-use-strict-directive***REMOVED***
		 * @param {ASTNode***REMOVED*** node A node to check.
		 * @returns {boolean***REMOVED*** Whether a specified node is either part of, or immediately follows a (possibly empty) directive prologue.
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A node to check.
		 * @returns {boolean***REMOVED*** Whether or not the node is allowed as non backtick.
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A TemplateLiteral node to check.
		 * @returns {boolean***REMOVED*** Whether or not the TemplateLiteral node is using any of the special features provided by template literal strings.
		 * @private
		 */
