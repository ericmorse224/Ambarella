...
class JsonpChunkLoadingRuntimeModule extends RuntimeModule {
	...
	***REMOVED***
	...
	_generateBaseUri(chunk) {
		...
		***REMOVED***
		return `${RuntimeGlobals.baseURI***REMOVED*** = document.baseURI || self.location.href;`;
	***REMOVED***
	...
	generate() {
		...
		***REMOVED*** = compilation;
		...
		const stateExpression = withHmr
			? `${RuntimeGlobals.hmrRuntimeStatePrefix***REMOVED***_jsonp`
			: undefined;
			...
			***REMOVED***{`,
										...
										Template.indent([
											...
											Template.indent([
												...
												Template.indent([
													...
													"",
													"// start chunk loading",
													`var url = ${RuntimeGlobals.publicPath***REMOVED*** + ${RuntimeGlobals.getChunkScriptFilename***REMOVED***(chunkId);`,
													...
													***REMOVED***(url, loadingEnded, "chunk-" + chunkId, chunkId${
							...
							linkPreload.call(
								Template.asString([
									...
									scriptType && scriptType !== "module"
										? `link.type = ${JSON.stringify(scriptType)***REMOVED***;`
										: "",
									charset ? "link.charset = 'utf-8';" : "",
									`if (${RuntimeGlobals.scriptNonce***REMOVED***) {`,
									Template.indent(
			...
			withHmr
				? Template.asString([
						...
						"var waitingUpdateResolves = {***REMOVED***;",
						...
						Template.indent([
							...
							`return new Promise(${runtimeTemplate.basicFunction(
								...
								[
									...
									`var url = ${RuntimeGlobals.publicPath***REMOVED*** + ${RuntimeGlobals.getChunkUpdateScriptFilename***REMOVED***(chunkId);`,
									"// create error before stack unwound to get useful stacktrace later",
									"var error = new Error();",
									...
									`${RuntimeGlobals.loadScript***REMOVED***(url, loadingEnded);`
								]
							)***REMOVED***);`
						]),
						"***REMOVED***",
						...
						`var webpackJsonpCallback = ${runtimeTemplate.basicFunction(
							...
							[
								...
								Template.indent([
									...
									"***REMOVED***",
									`if(runtime) var result = runtime(${RuntimeGlobals.require***REMOVED***);`
								]),
								"***REMOVED***",
								...
								"***REMOVED***",
								withOnChunkLoad
									? `return ${RuntimeGlobals.onChunksLoaded***REMOVED***(result);`
									: ""
							]
						)***REMOVED***`,
						"",
