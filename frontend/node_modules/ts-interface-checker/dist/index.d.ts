import { ITypeSuite, TType ***REMOVED*** from "./types";
import { IErrorDetail ***REMOVED*** from "./util";
/**
 * Export functions used to define interfaces.
 */
export { TArray, TEnumType, TEnumLiteral, TFunc, TIface, TLiteral, TName, TOptional, TParam, TParamList, TProp, TTuple, TType, TUnion, TIntersection, array, enumlit, enumtype, func, iface, lit, name, opt, param, tuple, union, intersection, BasicType, ITypeSuite, ***REMOVED*** from "./types";
export { VError, IErrorDetail ***REMOVED*** from './util';
 ...
 *
 * eg.
 *   import { MyInterface ***REMOVED*** from './my-interface';
