 ...
 * @param {number***REMOVED*** groupStart Starting index of the regex group.
 * @param {string***REMOVED*** pattern The regular expression pattern to be checked.
 * @param {string***REMOVED*** rawText Source text of the regexNode.
 * @param {ASTNode***REMOVED*** regexNode AST node which contains the regular expression.
 * @returns {Array<SuggestionResult>***REMOVED*** Fixer suggestions for the regex, if statically determinable.
 */
	...
	return [
		{
			fix(fixer) {
				...
				return fixer.insertTextBeforeRange(
					[start, start],
					`?<temp${highestTempCount + 1***REMOVED***>`,
				);
			***REMOVED***,
	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			required:
				"Capture group '{{group***REMOVED******REMOVED***' should be converted to a named or non-capturing group.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {string***REMOVED*** pattern The regular expression pattern to be checked.
		 * @param {ASTNode***REMOVED*** node AST node which contains the regular expression or a call/new expression.
		 * @param {ASTNode***REMOVED*** regexNode AST node which contains the regular expression.
		 * @param {string|null***REMOVED*** flags The regular expression flags to be checked.
