...
function getConsoleOutput(buffer, config, globalConfig) {
  ...
  const logEntries = buffer.reduce((output, {type, message, origin***REMOVED***) => {
    message = message
      .split(/\n/)
      .map(line => CONSOLE_INDENT + line)
      .join('\n');
    let typeMessage = `console.${type***REMOVED***`;
    ...
    ***REMOVED***\n${message.trimRight()***REMOVED***\n${_chalk().default.dim(
      formattedStackTrace.trimRight()
    )***REMOVED***\n\n`;
  ***REMOVED***, '');
  return `${logEntries.trimRight()***REMOVED***\n`;
***REMOVED***
