...
```js
"import/no-extraneous-dependencies": ["error", {"devDependencies": false, "optionalDependencies": false, "peerDependencies": false***REMOVED***]
```

You can also use an array of globs instead of literal booleans:

```js
"import/no-extraneous-dependencies": ["error", {"devDependencies": ["**/*.test.js", "**/*.spec.js"]***REMOVED***]
```
...
```js
"import/no-extraneous-dependencies": ["error", {"includeInternal": true, "includeTypes": true***REMOVED***]
```
...
```js
"import/no-extraneous-dependencies": ["error", {"packageDir": './some-dir/'***REMOVED***]
// or
"import/no-extraneous-dependencies": ["error", {"packageDir": path.join(__dirname, 'some-dir')***REMOVED***]
```
...
```js
"import/no-extraneous-dependencies": ["error", {"packageDir": ['./some-dir/', './root-pkg']***REMOVED***]
```
...
/* eslint import/no-extraneous-dependencies: ["error", {"devDependencies": false***REMOVED***] */
import test from 'ava';
var test = require('ava');

/* eslint import/no-extraneous-dependencies: ["error", {"optionalDependencies": false***REMOVED***] */
import isArray from 'lodash.isarray';
var isArray = require('lodash.isarray');

/* eslint import/no-extraneous-dependencies: ["error", {"bundledDependencies": false***REMOVED***] */
import foo from '"@generated/foo"';
var foo = require('"@generated/foo"');

/* eslint import/no-extraneous-dependencies: ["error", {"includeInternal": true***REMOVED***] */
import foo from './foo';
var foo = require('./foo');

/* eslint import/no-extraneous-dependencies: ["error", {"includeTypes": true***REMOVED***] */
import type { MyType ***REMOVED*** from 'foo';
```
...
/* eslint import/no-extraneous-dependencies: ["error", {"peerDependencies": true***REMOVED***] */
import react from 'react';
```
