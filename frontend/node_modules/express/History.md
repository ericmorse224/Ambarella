 ...
 * custom etag control with `app.set('etag', val)`
   - `app.set('etag', function(body, encoding){ return '"etag"' ***REMOVED***)` custom etag generation
...
==================
  ...
  * Added `req.ip`
  * Added `{ signed: true ***REMOVED***` option to `res.cookie()`
...
==================
  ...
  * Fixed `partial()` collection object support.
    ...
    however now `{ collection: {foo: 'bar'***REMOVED******REMOVED***` is valid, exposes
...
==================
  ...
  * Fixed blog example
  * Fixed `{req,res***REMOVED***.app` reference when mounting [Ben Weaver]
...
==================
  ...
  * Removed set("session cookie") in favour of use(Session, { cookie: { ... ***REMOVED******REMOVED***)
