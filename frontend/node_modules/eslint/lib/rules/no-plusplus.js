 ...
 * @returns {boolean***REMOVED*** `true` if the node is `ForStatement` update.
 */
 ...
 *   - The update node of a `ForStatement`: for (;; i++) {***REMOVED***
 *   - An operand of a sequence expression that is the update node: for (;; foo(), i++) {***REMOVED***
 *   - An operand of a sequence expression that is child of another sequence expression, etc.,
 *     up to the sequence expression that is the update node: for (;; foo(), (bar(), (baz(), i++))) {***REMOVED***
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is a for loop afterthought.
 */
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			unexpectedUnaryOp: "Unary operator '{{operator***REMOVED******REMOVED***' used.",
		***REMOVED***,
	***REMOVED***,

	create(context) {
		const [{ allowForLoopAfterthoughts ***REMOVED***] = context.options;
