...
assert.equal(getPrototypeOf(function () {***REMOVED***), Function.prototype);
assert.equal(getPrototypeOf([]), Array.prototype);
assert.equal(getPrototypeOf({***REMOVED***), Object.prototype);
```
...
if (typeof Reflect === 'object') { delete Reflect.getPrototypeOf; ***REMOVED***
...
assert.equal(Reflect.getPrototypeOf(function () {***REMOVED***), Function.prototype);
assert.equal(Reflect.getPrototypeOf([]), Array.prototype);
assert.equal(Reflect.getPrototypeOf({***REMOVED***), Object.prototype);
```
