...
function report(context, node) {
  context.report({
    node: node,
    message: 'Imported module should be assigned' ***REMOVED***);
...
function testIsAllow(globs, filename, source) {
  ...
  ***REMOVED***
  ...
  return globs.find(function (glob) {return (0, _minimatch2['default'])(filePath, glob) ||
    (0, _minimatch2['default'])(filePath, _path2['default'].join(process.cwd(), glob));***REMOVED***) !==
  undefined;
***REMOVED***
...
function create(context) {
  ...
  var isAllow = function isAllow(source) {return testIsAllow(options.allow, filename, source);***REMOVED***;
  ...
  return {
    ...
    ExpressionStatement: function () {function ExpressionStatement(node) {
        ...
        ***REMOVED***
      ***REMOVED***return ExpressionStatement;***REMOVED***() ***REMOVED***;
...
module.exports = {
  ...
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-unassigned-import') ***REMOVED***,
