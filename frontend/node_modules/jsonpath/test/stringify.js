...
suite('stringify', function() {
  ...
  ***REMOVED***);
  ...
  test('simple parsed path stringifies', function() {
    var path = [
      { scope: 'child', operation: 'member', expression: { type: 'identifier', value: 'a' ***REMOVED*** ***REMOVED***,
      { scope: 'child', operation: 'member', expression: { type: 'identifier', value: 'b' ***REMOVED*** ***REMOVED***,
      { scope: 'child', operation: 'member', expression: { type: 'identifier', value: 'c' ***REMOVED*** ***REMOVED***
    ];
  ...
  ***REMOVED***);
  ...
  test('throws for no input', function() {
    assert.throws(function() { jp.stringify() ***REMOVED***, /we need a path/);
  ***REMOVED***);
