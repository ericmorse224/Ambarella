...
class Service extends events_1.EventEmitter {
    constructor(config) {
        ...
        this.type = (0, service_types_1.toString)({ name: config.type, protocol: this.protocol ***REMOVED***);
        this.port = config.port;
        this.host = config.host || os_1.default.hostname();
        this.fqdn = `${this.name***REMOVED***.${this.type***REMOVED***${TLD***REMOVED***`;
        this.txt = config.txt;
    ...
    ***REMOVED***
    RecordPTR(service) {
        return {
            name: `${service.type***REMOVED***${TLD***REMOVED***`,
            type: 'PTR',
            ttl: 28800,
            data: service.fqdn
        ***REMOVED***;
    ***REMOVED***
    RecordSubtypePTR(service, subtype) {
        return {
            name: `_${subtype***REMOVED***._sub.${service.type***REMOVED***${TLD***REMOVED***`,
            type: 'PTR',
            ttl: 28800,
            data: `${service.name***REMOVED***.${service.type***REMOVED***${TLD***REMOVED***`
        ***REMOVED***;
    ***REMOVED***
    RecordSRV(service) {
        return {
