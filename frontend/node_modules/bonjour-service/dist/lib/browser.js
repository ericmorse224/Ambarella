...
class Browser extends events_1.EventEmitter {
    constructor(mdns, opts, onup) {
        ...
        ***REMOVED***
            ...
            this.name = (0, service_types_1.toString)({ name: opts.type, protocol: opts.protocol || 'tcp' ***REMOVED***) + TLD;
            if (opts.name)
    ...
    ***REMOVED***
    updateService(service) {
        var _a;
        if ((0, equal_txt_1.default)(service.txt, ((_a = this._services.find((s) => (0, dns_equal_1.default)(s.fqdn, service.fqdn))) === null || _a === void 0 ? void 0 : _a.txt) || {***REMOVED***))
            return;
