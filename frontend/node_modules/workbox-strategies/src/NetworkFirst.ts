...
class NetworkFirst extends Strategy {
   ...
   * scenarios.
   */
  constructor(options: NetworkFirstOptions = {***REMOVED***) {
    super(options);
  ...
  ***REMOVED***): {promise: Promise<Response | undefined>; id?: number***REMOVED*** {
    let timeoutId;
    ...
    ***REMOVED***
    ...
    if (error || !response) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (response) {
          logs.push(
            `Found a cached response in the '${this.cacheName***REMOVED***'` + ` cache.`,
          );
        ***REMOVED*** else {
