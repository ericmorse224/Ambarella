                        ...
                        ***REMOVED***,
                        {
                            type: "object",
                            properties: {
                                requireReturnForObjectLiteral: { type: "boolean" ***REMOVED***
                            ***REMOVED***,
            ...
            if (arrowBody.type === "BlockStatement") {
                ...
                ***REMOVED***
                ...
                if (never || asNeeded && blockBody[0].type === "ReturnStatement") {
                    ...
                    ***REMOVED*** else if (blockBody.length > 1) {
                        messageId = "unexpectedOtherBlock";
                    ***REMOVED*** else if (blockBody[0].argument === null) {
                        messageId = "unexpectedSingleBlock";
                    ***REMOVED*** else if (astUtils.isOpeningBraceToken(sourceCode.getFirstToken(blockBody[0], { skip: 1 ***REMOVED***))) {
                ...
                if (always || (asNeeded && requireReturnForObjectLiteral && arrowBody.type === "ObjectExpression")) {
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            const [firstTokenAfterArrow, secondTokenAfterArrow] = sourceCode.getTokensAfter(arrowToken, { count: 2 ***REMOVED***);
                            ...
                            ***REMOVED***
                            ...
                            if (parenthesisedObjectLiteral) {
                                ...
                                ***REMOVED***
                                ...
                                fixes.push(fixer.insertTextAfter(lastToken, "***REMOVED***"));
