 ...
 * @param {{resourcePath:string, context:string, output:{path:string***REMOVED******REMOVED******REMOVED*** context A loader or compilation
 * @param {{debug:boolean, fail:boolean, format:string|boolean, root:string, codecs:object***REMOVED******REMOVED*** opt Options hash
 * @param {object|string***REMOVED*** sourceMapOrSource An incoming source-map or single source path
 * @returns {undefined|object|string***REMOVED*** An amended source-map or source path else undefined
 */
function process(context, opt, sourceMapOrSource) {
  ...
  ***REMOVED***, opt);
  ...
  if (inputSources) {
    ...
    outputMap = (!inputMap || (options.format === 'remove')) ? undefined : Object.assign({***REMOVED***, inputMap);
