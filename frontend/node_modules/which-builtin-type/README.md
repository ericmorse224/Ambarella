...
assert.equal('Object', whichBuiltinType({***REMOVED***));
...
assert.equal('Function', whichBuiltinType(function () {***REMOVED***));
assert.equal('GeneratorFunction', whichBuiltinType(function* () {***REMOVED***));
