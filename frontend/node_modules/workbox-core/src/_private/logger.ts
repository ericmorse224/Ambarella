  ...
  process.env.NODE_ENV === 'production'
    ...
    : (() => {
        ...
        ***REMOVED***
        ...
        const methodToColorMap: {[methodName: string]: string | null***REMOVED*** = {
          debug: `#7f8c8d`, // Gray
          log: `#2ecc71`, // Green
          warn: `#f39c12`, // Yellow
          error: `#c0392b`, // Red
        ...
        ***REMOVED***;
        ...
        const print = function (method: LoggerMethods, args: any[]) {
          ...
          ***REMOVED***
          ...
          const styles = [
            `background: ${methodToColorMap[method]!***REMOVED***`,
            `border-radius: 0.5em`,
            `color: white`,
            `font-weight: bold`,
            `padding: 2px 0.5em`,
        ...
        ***REMOVED***;
        ...
        const api: {[methodName: string]: Function***REMOVED*** = {***REMOVED***;
