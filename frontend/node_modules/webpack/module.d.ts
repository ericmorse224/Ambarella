	...
	interface Hot {
		accept: {
			(
				...
				errorHandler?: (
					err: Error,
					context: { moduleId: string | number; dependencyId: string | number ***REMOVED***
				) => void
			): void;
			(
				errorHandler?: (
					err: Error,
					ids: { moduleId: string | number; module: NodeJS.Module ***REMOVED***
				) => void
			): void;
		***REMOVED***;
...
declare const __webpack_share_scopes__: Record<
	...
	Record<
		string,
		{ loaded?: 1; get: () => Promise<unknown>; from: string; eager: boolean ***REMOVED***
	>
>;
