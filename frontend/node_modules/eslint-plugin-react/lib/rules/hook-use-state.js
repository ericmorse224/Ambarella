      ...
      CallExpression(node) {
        ...
        ***REMOVED***
        ...
        const expectedSetterVariableNames = upperCaseCandidatePrefix ? [
          `set${upperCaseCandidatePrefix.charAt(0).toUpperCase()***REMOVED***${upperCaseCandidatePrefix.slice(1)***REMOVED***${caseCandidateSuffix***REMOVED***`,
          `set${upperCaseCandidatePrefix.toUpperCase()***REMOVED***${caseCandidateSuffix***REMOVED***`,
        ] : [];
        ...
        if (!isSymmetricGetterSetterPair) {
                ...
                fix(fixer) {
                  if (expectedSetterVariableNames.length > 0) {
                    return fixer.replaceTextRange(
                      ...
                      `[${valueVariableName***REMOVED***, ${expectedSetterVariableNames[0]***REMOVED***]`
                    );
                  ***REMOVED***
                ***REMOVED***,
              ***REMOVED***
          ...
          if (isSingleGetter && isUseStateCalledWithSingleArgument) {
            ...
            ***REMOVED*** else if (defaultReactImportName) {
              useMemoCode = `${defaultReactImportName***REMOVED***.useMemo`;
            ***REMOVED*** else {
              useMemoCode = 'useMemo';
            ***REMOVED***
              ...
              getMessageData('suggestMemo', messages.suggestMemo),
              {
                fix: (fixer) => [
                  ...
                  fixer.replaceTextRange(
                    node.range,
                    `${useMemoCode***REMOVED***(() => ${getText(context, node.arguments[0])***REMOVED***, [])`
                  ),
                ].filter(Boolean),
              ***REMOVED***
            ));
