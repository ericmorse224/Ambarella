        ...
        ***REMOVED***
        ...
        namespace ed25519 {
            ...
            ***REMOVED***
            ...
            function generateKeyPair(options?: { seed?: NativeBuffer | string | undefined ***REMOVED***): {
                publicKey: NativeBuffer;
                privateKey: NativeBuffer;
            ***REMOVED***;

            function privateKeyFromAsn1(obj: asn1.Asn1): { privateKeyBytes: NativeBuffer ***REMOVED***;

            function publicKeyFromAsn1(obj: asn1.Asn1): NativeBuffer;

            function publicKeyFromPrivateKey(options: { privateKey: BinaryBuffer ***REMOVED***): NativeBuffer;
        ...
        ***REMOVED***
        ...
        interface Certificate {
            ...
            ***REMOVED***;
             ...
             */
            getExtension(options: string | { name: string ***REMOVED*** | { id: number ***REMOVED***): {***REMOVED*** | undefined;
    ...
    ***REMOVED***
    ...
    namespace pkcs7 {
        interface PkcsSignedData {
            ...
            contentInfo?: { value: any[] ***REMOVED*** | undefined;
            ...
            addSigner(options: {
                ...
                authenticatedAttributes?: Array<{ type: string; value?: string | undefined ***REMOVED***> | undefined;
            ***REMOVED***): void;
            sign(options?: { detached?: boolean | undefined ***REMOVED***): void;
            toAsn1(): asn1.Asn1;
        ***REMOVED***
    ...
    ***REMOVED***
    ...
    namespace tls {
        ...
        ***REMOVED***
        ...
        const CipherSuites: { [name: string]: CipherSuite ***REMOVED***;
        ...
        ***REMOVED***
        ...
        interface Connection {
            ...
            state: { pending: ConnectionState | null; current: ConnectionState ***REMOVED***;
            expect: number;
        ...
        ***REMOVED***
        ...
        interface Session {
            ...
            extensions: { [_: string]: object ***REMOVED***;
        ...
        ***REMOVED***
        ...
        interface SessionCache {
            cache: { [key: string]: Session ***REMOVED***;
            capacity: number;
            order: [Hex];
        ...
        ***REMOVED***
        ...
        function createSessionCache(cache?: SessionCache | { [key: string]: Session ***REMOVED***, capacity?: number): SessionCache;
        ...
        ***REMOVED***
        ...
        type Verified = true | { message?: string | undefined; alert?: Alert.Description | undefined ***REMOVED***;

        function createConnection(options: {
            server?: boolean | undefined;
            sessionId?: Bytes | null | undefined;
            caStore?: pki.CAStore | readonly pki.Certificate[] | undefined;
            sessionCache?: SessionCache | { [key: string]: Session ***REMOVED*** | undefined;
