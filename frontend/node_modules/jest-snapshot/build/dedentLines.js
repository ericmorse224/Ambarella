...
const getIndentationLength = line => {
  const result = /^( {2***REMOVED***)+/.exec(line);
...
const isFirstLineOfTag = line => /^( {2***REMOVED***)*\</.test(line); // The length of the output array is the index of the next input line.
...
const dedentStartTag = (input, output) => {
  ...
  ***REMOVED***
  ...
  while (output.length < input.length) {
    ...
    ***REMOVED*** else if (isFirstLineOfTag(line)) {
  ...
  ***REMOVED***
  ...
  return false;
***REMOVED***; // Push dedented lines of markup onto output and return true;
// otherwise return false because:
...
***REMOVED***; // Return lines unindented by heuristic;
