...
var schema = (0, _schemas.generateObjSchema)({
  roles: _objectSpread(_objectSpread({***REMOVED***, _schemas.arraySchema), {***REMOVED***, {
    description: 'An array of ARIA roles'
  ***REMOVED***),
  tags: _objectSpread(_objectSpread({***REMOVED***, _schemas.arraySchema), {***REMOVED***, {
