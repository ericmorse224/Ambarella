 ...
 * @returns {boolean***REMOVED*** `true` if the node is located at `ForStatement.init`.
 */
 ...
 * @param {ASTNode***REMOVED*** identifier An Identifier node to check.
 * @returns {boolean***REMOVED*** `true` if the node can become a VariableDeclaration.
 */
 ...
 * @param {string***REMOVED*** name A variable name to be checked.
 * @param {eslint-scope.Scope***REMOVED*** initScope A scope to start find.
 * @returns {boolean***REMOVED*** Indicates if the variable is from outer scope or function parameters.
 */
 ...
 * destructuring.
 * @param {eslint-scope.Reference***REMOVED*** reference A reference to get.
 * @returns {ASTNode|null***REMOVED*** A VariableDeclarator/AssignmentExpression node or
 *      null.
 */
 ...
 * @param {ASTNode***REMOVED*** node The ObjectPattern or ArrayPattern node to check.
 * @returns {boolean***REMOVED*** True if the destructuring pattern contains
 ...
 * @param {eslint-scope.Variable***REMOVED*** variable A variable to get.
 * @param {boolean***REMOVED*** ignoreReadBeforeAssign
		...
		if (reference.isWrite()) {
			...
			***REMOVED***
			...
			if (
				...
				***REMOVED*** else if (leftNode.type === "ArrayPattern") {
			...
			***REMOVED***
			...
			writer = reference;
		***REMOVED*** else if (reference.isRead() && writer === null) {
 ...
 * This is used to detect a mix of reassigned and never reassigned in a
 * destructuring.
 * @param {eslint-scope.Variable[]***REMOVED*** variables Variables to group by destructuring.
 * @param {boolean***REMOVED*** ignoreReadBeforeAssign
 *      The value of `ignoreReadBeforeAssign` option.
 * @returns {Map<ASTNode, ASTNode[]>***REMOVED*** Grouped identifier nodes.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to search from.
 * @param {string***REMOVED*** type The type field of the parent node.
 * @param {Function***REMOVED*** shouldStop A predicate that returns true if the traversal should stop, and false otherwise.
 * @returns {ASTNode***REMOVED*** The closest ancestor with the specified type; null if no such ancestor exists.
 */
		...
		schema: [
			{
				type: "object",
				properties: {
					destructuring: { enum: ["any", "all"] ***REMOVED***,
					ignoreReadBeforeAssign: { type: "boolean" ***REMOVED***,
				***REMOVED***,
				additionalProperties: false,
			***REMOVED***,
		],
		messages: {
			useConst: "'{{name***REMOVED******REMOVED***' is never reassigned. Use 'const' instead.",
		***REMOVED***,
	***REMOVED***,

	create(context) {
		const [{ destructuring, ignoreReadBeforeAssign ***REMOVED***] = context.options;
		 ...
		 * be 2 or more.
		 * @param {(eslint-scope.Reference|null)[]***REMOVED*** nodes
				...
				if (
					...
					if (
						...
						varDeclParent.declarations.forEach(declaration => {
							...
							***REMOVED*** else if (declaration.id.type === "ArrayPattern") {
								totalDeclarationsCount +=
