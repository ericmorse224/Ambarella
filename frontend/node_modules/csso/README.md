...
var minifiedCss = csso.minify('.test { color: #ff0000; ***REMOVED***').css;

console.log(minifiedCss);
// .test{color:red***REMOVED***
```
...
```js
var csso = require('csso');
var ast = csso.syntax.parse('.test { color: #ff0000; ***REMOVED***');
...
```js
var result = csso.minify('.test { color: #ff0000; ***REMOVED***', {
...
console.log(result);
// { css: '...minified...', map: SourceMapGenerator {***REMOVED*** ***REMOVED***

console.log(result.map.toString());
// '{ .. source map content .. ***REMOVED***'
```
...
```css
* { color: green; ***REMOVED***
ul, ol, li { color: blue; ***REMOVED***
UL.foo, span.bar { color: red; ***REMOVED***
```
...
```css
*{color:green***REMOVED***ul,li{color:blue***REMOVED***ul.foo{color:red***REMOVED***
```
...
```css
:nth-child(2n of ul, ol) { color: red ***REMOVED***
:nth-child(3n + 1 of img) { color: yellow ***REMOVED***
:not(div, ol, ul) { color: green ***REMOVED***
:has(:matches(ul, ol), ul, ol) { color: blue ***REMOVED***
```

Turns into:

```css
:nth-child(2n of ul){color:red***REMOVED***:not(div,ol,ul){color:green***REMOVED***:has(:matches(ul),ul){color:blue***REMOVED***
```
...
* { color: green; ***REMOVED***
ul, ol, li { color: blue; ***REMOVED***
UL.foo, li.bar { color: red; ***REMOVED***
```
...
```css
*{color:green***REMOVED***li{color:blue***REMOVED***li.bar{color:red***REMOVED***
```
...
```css
.module1-foo { color: red; ***REMOVED***
.module1-bar { font-size: 1.5em; background: yellow; ***REMOVED***

.module2-baz { color: red; ***REMOVED***
.module2-qux { font-size: 1.5em; background: yellow; width: 50px; ***REMOVED***
```
...
```css
.module1-foo{color:red***REMOVED***.module1-bar{font-size:1.5em;background:#ff0***REMOVED***.module2-baz{color:red***REMOVED***.module2-qux{font-size:1.5em;background:#ff0;width:50px***REMOVED***
```
...
```css
.module1-foo,.module2-baz{color:red***REMOVED***.module1-bar,.module2-qux{font-size:1.5em;background:#ff0***REMOVED***.module2-qux{width:50px***REMOVED***
```
