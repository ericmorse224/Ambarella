...
var _arrayPrototype = require('array.prototype.flat');var _arrayPrototype2 = _interopRequireDefault(_arrayPrototype);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***
...
var meta = {
  ...
  docs: {
    ...
    url: (0, _docsUrl2['default'])('group-exports') ***REMOVED*** ***REMOVED***;


/* eslint-disable max-len */
var errors = {
  ExportNamedDeclaration: 'Multiple named export declarations; consolidate all named exports into a single export declaration',
  AssignmentExpression: 'Multiple CommonJS exports; consolidate all exports into a single assignment to `module.exports`' ***REMOVED***;
...
/**
                             ...
                             * Example:
                             *
                             * `module.exports = {***REMOVED***` => ['module', 'exports']
                             * `module.exports.property = true` => ['module', 'exports', 'property']
                             *
                             * @param     {Node***REMOVED***    node    AST Node (MemberExpression)
                             * @return    {Array***REMOVED***           Array with the property names in the chain
                             * @private
                             */
function accessorChain(node) {
  ...
  do {
    ...
    ***REMOVED***
    ...
    node = node.object;
  ***REMOVED*** while (node.type === 'MemberExpression');
...
function create(context) {
  ...
  return {
    ExportNamedDeclaration: function () {function ExportNamedDeclaration(node) {
        ...
        if (!node.source) {
          target.set.add(node);
        ***REMOVED*** else if (Array.isArray(target.sources[node.source.value])) {
    ...
    AssignmentExpression: function () {function AssignmentExpression(node) {
        ...
        ***REMOVED***
        ...
        if (chain[0] === 'exports' && chain.length === 2) {
          ...
          return;
        ***REMOVED***
      ***REMOVED***return AssignmentExpression;***REMOVED***(),
    ...
    'Program:exit': function () {function onExit() {
        ...
        if (nodes.modules.set.size > 1) {
          nodes.modules.set.forEach(function (node) {
            context.report({
              node: node,
              message: errors[node.type] ***REMOVED***);
        ...
        ***REMOVED***
        ...
        filter(function (nodesWithSource) {return Array.isArray(nodesWithSource) && nodesWithSource.length > 1;***REMOVED***)).
        ...
        ***REMOVED***);
        ...
        if (nodes.commonjs.set.size > 1) {
          ...
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***return onExit;***REMOVED***() ***REMOVED***;

***REMOVED***

module.exports = {
  meta: meta,
  create: create ***REMOVED***;
