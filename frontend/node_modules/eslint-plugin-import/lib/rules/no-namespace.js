...
/**
                                                                                                                                                                                       * @param {MemberExpression***REMOVED*** memberExpression
                                                                                                                                                                                       * @returns {string***REMOVED*** the name of the member in the object expression, e.g. the `x` in `namespace.x`
                                                                                                                                                                                       */
...
/**
   * @param {ScopeManager***REMOVED*** scopeManager
  ...
  ***REMOVED***
  return new Set(scope.variables.concat(scope.upper.variables).map(function (variable) {return variable.name;***REMOVED***));
***REMOVED***

/**
   *
   * @param {****REMOVED*** names
   * @param {****REMOVED*** nameConflicts
   * @param {****REMOVED*** namespaceName
   */
function generateLocalNames(names, nameConflicts, namespaceName) {
  var localNames = {***REMOVED***;
  names.forEach(function (name) {
    var localName = void 0;
    if (!nameConflicts[name].has(name)) {
      localName = name;
    ***REMOVED*** else if (!nameConflicts[name].has(String(namespaceName) + '_' + String(name))) {
...
/**
   * @param {Identifier[]***REMOVED*** namespaceIdentifiers
   * @returns {boolean***REMOVED*** `true` if the namespace variable is more than just a glorified constant
   */
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-namespace') ***REMOVED***,
    ...
    schema: [{
      ...
      properties: {
        ignore: {
          ...
          uniqueItems: true ***REMOVED*** ***REMOVED*** ***REMOVED***] ***REMOVED***,
  ...
  create: function () {function create(context) {
      var firstOption = context.options[0] || {***REMOVED***;
      var ignoreGlobs = firstOption.ignore;

      return {
        ImportNamespaceSpecifier: function () {function ImportNamespaceSpecifier(node) {
            if (ignoreGlobs && ignoreGlobs.find(function (glob) {return (0, _minimatch2['default'])(node.parent.source.value, glob, { matchBase: true ***REMOVED***);***REMOVED***)) {
              return;
            ***REMOVED***

            var scopeVariables = (0, _contextCompat.getScope)(context, node).variables;
            var namespaceVariable = scopeVariables.find(function (variable) {return variable.defs[0].node === node;***REMOVED***);
            var namespaceReferences = namespaceVariable.references;
            var namespaceIdentifiers = namespaceReferences.map(function (reference) {return reference.identifier;***REMOVED***);
            ...
            context.report({
              ...
              fix: canFix && function (fixer) {var _getSourceCode =
                ...
                var importNameConflicts = {***REMOVED***;
                namespaceIdentifiers.forEach(function (identifier) {
                  ...
                  if (parent && parent.type === 'MemberExpression') {
                    ...
                    ***REMOVED*** else {
                      localConflicts.forEach(function (c) {return importNameConflicts[importName].add(c);***REMOVED***);
                    ***REMOVED***
                  ***REMOVED***
                ***REMOVED***);
                ...
                var namedImportSpecifiers = importNames.map(function (importName) {return importName === importLocalNames[importName] ?
                  importName : String(
                  importName) + ' as ' + String(importLocalNames[importName]);***REMOVED***);

                fixes.push(fixer.replaceText(node, '{ ' + String(namedImportSpecifiers.join(', ')) + ' ***REMOVED***'));
          ...
          ***REMOVED***return ImportNamespaceSpecifier;***REMOVED***() ***REMOVED***;
