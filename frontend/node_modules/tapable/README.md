...
``` js
myCar.hooks.accelerate.tap("LoggerPlugin", newSpeed => console.log(`Accelerating to ${newSpeed***REMOVED***`));
```
...
myCar.hooks.calculateRoutes.intercept({
	...
	***REMOVED***,
	register: (tapInfo) => {
		// tapInfo = { type: "promise", name: "GoogleMapsPlugin", fn: ... ***REMOVED***
		console.log(`${tapInfo.name***REMOVED*** is doing its job`);
...
myCar.hooks.accelerate.intercept({
	context: true,
	tap: (context, tapInfo) => {
		// tapInfo = { type: "sync", name: "NoisePlugin", fn: ... ***REMOVED***
		console.log(`${tapInfo.name***REMOVED*** is doing it's job`);
...
``` js
keyedHook.for("some-key").tap("MyPlugin", (arg) => { /* ... */ ***REMOVED***);
keyedHook.for("some-key").tapAsync("MyPlugin", (arg, callback) => { /* ... */ ***REMOVED***);
keyedHook.for("some-key").tapPromise("MyPlugin", (arg) => { /* ... */ ***REMOVED***);
```

``` js
const hook = keyedHook.get("some-key");
if(hook !== undefined) {
	hook.callAsync("arg", err => { /* ... */ ***REMOVED***);
***REMOVED***
```
...
``` js
const { MultiHook ***REMOVED*** = require("tapable");
