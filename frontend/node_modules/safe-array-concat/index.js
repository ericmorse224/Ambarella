...
/** @type {never[]***REMOVED*** */ var empty = [];
var $concatApply = isConcatSpreadable ? callBind.apply($concat, empty) : null;

// eslint-disable-next-line no-extra-parens
var isArray = isConcatSpreadable ? /** @type {(value: unknown) => value is unknown[]***REMOVED*** */ (require('isarray')) : null;
...
module.exports = isConcatSpreadable
	...
	? function safeArrayConcat(item) {
		for (var i = 0; i < arguments.length; i += 1) {
			/** @type {typeof item***REMOVED*** */ var arg = arguments[i];
