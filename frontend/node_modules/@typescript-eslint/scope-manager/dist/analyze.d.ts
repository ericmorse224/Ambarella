import type { EcmaVersion, Lib, TSESTree ***REMOVED*** from '@typescript-eslint/types';
import type { ReferencerOptions ***REMOVED*** from './referencer';
...
export { analyze, AnalyzeOptions ***REMOVED***;
