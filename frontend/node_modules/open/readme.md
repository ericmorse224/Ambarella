...
await open('unicorn.png', {wait: true***REMOVED***);
...
await open('https://sindresorhus.com', {app: {name: 'firefox'***REMOVED******REMOVED***);

// Specify app arguments.
await open('https://sindresorhus.com', {app: {name: 'google chrome', arguments: ['--incognito']***REMOVED******REMOVED***);

// Open an app
await open.openApp('xcode');

// Open an app with arguments
await open.openApp(open.apps.chrome, {arguments: ['--incognito']***REMOVED***);
```
...
Type: `{name: string | string[], arguments?: string[]***REMOVED*** | Array<{name: string | string[], arguments: string[]***REMOVED***>`
