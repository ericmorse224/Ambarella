...
const { CLIEngine, getCLIEngineInternalSlots ***REMOVED*** = require("../cli-engine/cli-engine");
...
/** @typedef {import("../cli-engine/cli-engine").LintReport***REMOVED*** CLIEngineLintReport */
...
/** @typedef {import("../shared/types").LintResult***REMOVED*** LintResult */
/** @typedef {import("../shared/types").ResultsMeta***REMOVED*** ResultsMeta */

/**
 * The main formatter object.
 * @typedef LoadedFormatter
 * @property {(results: LintResult[], resultsMeta: ResultsMeta) => string | Promise<string>***REMOVED*** format format function.
 */
 ...
 * @property {ConfigData***REMOVED*** [baseConfig] Base config object, extended by all configs used with this instance
 ...
 * @property {string[]***REMOVED*** [extensions] An array of file extensions to check.
 ...
 * @property {ConfigData***REMOVED*** [overrideConfig] Override config object, overrides all configs used with this instance
 * @property {string***REMOVED*** [overrideConfigFile] The configuration file to use.
 * @property {Record<string,Plugin>|null***REMOVED*** [plugins] Preloaded plugins. This is a map-like object, keys are plugin IDs and each value is implementation.
 * @property {"error" | "warn" | "off"***REMOVED*** [reportUnusedDisableDirectives] the severity to report unused eslint-disable directives.
 ...
 * @property {boolean***REMOVED*** [useEslintrc] False disables looking for .eslintrc.* files.
 */

/**
 * A rules metadata object.
 * @typedef {Object***REMOVED*** RulesMeta
 * @property {string***REMOVED*** id The plugin ID.
 * @property {Object***REMOVED*** definition The plugin definition.
 */

/**
 * Private members for the `ESLint` instance.
 * @typedef {Object***REMOVED*** ESLintPrivateMembers
 * @property {CLIEngine***REMOVED*** cliEngine The wrapped CLIEngine instance.
 * @property {ESLintOptions***REMOVED*** options The options used to instantiate the ESLint instance.
 */
 ...
 * @type {WeakMap<ESLint, ESLintPrivateMembers>***REMOVED***
 */
 ...
 * @param {ESLintOptions***REMOVED*** options The options to process.
 * @throws {ESLintInvalidOptionsError***REMOVED*** If of any of a variety of type errors.
 * @returns {ESLintOptions***REMOVED*** The normalized options.
 */
 ...
 * @param {any***REMOVED*** obj The value to check.
 * @returns {boolean***REMOVED*** `true` if `obj` has one or more properties that that value is not undefined.
 */
 ...
 * @param {Map<string,Rule>***REMOVED*** rules a map of rules from which to generate the object.
 ...
 * @param {CLIEngine***REMOVED*** cliEngine The CLIEngine instance.
...
function getOrFindUsedDeprecatedRules(cliEngine, maybeFilePath) {
    const {
        configArrayFactory,
        options: { cwd ***REMOVED***
    ***REMOVED*** = getCLIEngineInternalSlots(cliEngine);
        ...
        for (const [ruleId, ruleConf] of Object.entries(config.rules)) {
            ...
            ***REMOVED***
            ...
            if (meta && meta.deprecated) {
                retv.push({ ruleId, replacedBy: meta.replacedBy || [] ***REMOVED***);
            ***REMOVED***
        ***REMOVED***
 ...
 */
function processCLIEngineLintReport(cliEngine, { results ***REMOVED***) {
    const descriptor = {
        configurable: true,
        enumerable: true,
        get() {
...
class ESLint {
    ...
    constructor(options = {***REMOVED***) {
        ...
        const cliEngine = new CLIEngine(processedOptions, { preloadedPlugins: options.plugins ***REMOVED***);
        const {
            configArrayFactory,
            lastConfigArrays
        ***REMOVED*** = getCLIEngineInternalSlots(cliEngine);
    ...
    ***REMOVED***
    ...
    getRulesMetaForResults(results) {
        ...
        for (const result of results) {
            for (const { ruleId ***REMOVED*** of result.messages) {
                resultRuleIds.add(ruleId);
            ***REMOVED***
            for (const { ruleId ***REMOVED*** of result.suppressedMessages) {
                resultRuleIds.add(ruleId);
            ***REMOVED***
        ***REMOVED***
        ...
        const { cliEngine ***REMOVED*** = privateMembersMap.get(this);
    ...
    async lintText(code, options = {***REMOVED***) {
        ...
        ***REMOVED*** = options || {***REMOVED***;
        ...
        if (unknownOptionKeys.length > 0) {
            throw new Error(`'options' must not include the unknown option(s): ${unknownOptionKeys.join(", ")***REMOVED***`);
        ***REMOVED***
    ...
    ***REMOVED***
     ...
     * @returns {Promise<LoadedFormatter>***REMOVED*** A promise resolving to the formatter object.
    ...
    async loadFormatter(name = "stylish") {
        ...
        ***REMOVED***
        ...
        const { cliEngine, options ***REMOVED*** = privateMembersMap.get(this);
        const formatter = cliEngine.getFormatter(name);

        if (typeof formatter !== "function") {
            throw new Error(`Formatter must be a function, but got a ${typeof formatter***REMOVED***.`);
        ***REMOVED***
        ...
        return {
             ...
             * @returns {string | Promise<string>***REMOVED*** The formatted lint results.
             */
    ...
    ***REMOVED***
     ...
     * @returns {Promise<ConfigData>***REMOVED*** A configuration object for the file.
     */
...
module.exports = {
     ...
     * @param {ESLint***REMOVED*** instance The ESLint instance to get.
     * @returns {ESLintPrivateMembers***REMOVED*** The instance's private class members.
     */
