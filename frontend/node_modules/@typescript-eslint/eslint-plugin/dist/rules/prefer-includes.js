    ...
    create(context) {
        ...
        ***REMOVED***
        ...
        function parseRegExp(node) {
            ...
            if (evaluated == null || !(evaluated.value instanceof RegExp)) {
                return null;
            ***REMOVED***
            const { pattern, flags ***REMOVED*** = (0, regexpp_1.parseRegExpLiteral)(evaluated.value);
        ...
        ***REMOVED***
        function checkArrayIndexOf(node, allowFixing) {
            ...
            ***REMOVED***
            // Report it.
            context.report(Object.assign({ node: compareNode, messageId: 'preferIncludes' ***REMOVED***, (allowFixing && {
                *fix(fixer) {
                    if (negative) {
                ...
                ***REMOVED***
                context.report({
                    ...
                    *fix(fixer) {
                        ...
                        ***REMOVED***
                        yield fixer.insertTextAfter(argNode, `${node.optional ? '?.' : '.'***REMOVED***includes('${escapeString(text)***REMOVED***')`);
                    ***REMOVED***,
                ***REMOVED***);
            ***REMOVED***,
        ***REMOVED***;
