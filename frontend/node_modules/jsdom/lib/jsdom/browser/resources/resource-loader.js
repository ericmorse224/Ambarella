...
const { parseURL ***REMOVED*** = require("whatwg-url");
...
module.exports = class ResourceLoader {
  constructor({
    strictSSL = true,
    proxy = undefined,
    userAgent = `Mozilla/5.0 (${process.platform || "unknown OS"***REMOVED***) AppleWebKit/537.36 ` +
                `(KHTML, like Gecko) jsdom/${packageVersion***REMOVED***`
  ***REMOVED*** = {***REMOVED***) {
  ...
  ***REMOVED***
  ...
  fetch(urlString, { accept, cookieJar, referrer ***REMOVED*** = {***REMOVED***) {
    const url = parseURL(urlString);

    if (!url) {
      return Promise.reject(new Error(`Tried to fetch invalid URL ${urlString***REMOVED***`));
    ***REMOVED***
    ...
    switch (url.scheme) {
      ...
      case "https": {
        ...
        ***REMOVED***
        const requestClient = new Request(
          urlString,
          { followRedirects: true, cookieJar, agents ***REMOVED***,
          { headers ***REMOVED***
        );
        const promise = new Promise((resolve, reject) => {
          const accumulated = [];
          requestClient.once("response", res => {
            ...
            if (statusCode < 200 || statusCode > 299) {
              requestClient.abort();
              reject(new Error(`Resource was not loaded. Status: ${statusCode***REMOVED***`));
            ***REMOVED***
          ***REMOVED***);
      ...
      ***REMOVED***
      ...
      default: {
        return Promise.reject(new Error(`Tried to fetch URL ${urlString***REMOVED*** with invalid scheme ${url.scheme***REMOVED***`));
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***;
