...
declare module "querystring" {
    ...
    ***REMOVED***
    interface ParsedUrlQuery extends NodeJS.Dict<string | string[]> {***REMOVED***
     ...
     *
     * ```js
     * querystring.stringify({ foo: 'bar', baz: ['qux', 'quux'], corge: '' ***REMOVED***);
     * // Returns 'foo=bar&#x26;baz=qux&#x26;baz=quux&#x26;corge='
     *
     * querystring.stringify({ foo: 'bar', baz: 'qux' ***REMOVED***, ';', ':');
     ...
     *
     * querystring.stringify({ w: '中文', foo: 'bar' ***REMOVED***, null, null,
     *                       { encodeURIComponent: gbkEncodeURIComponent ***REMOVED***);
     * ```
     * @since v0.1.25
     ...
     *                   { decodeURIComponent: gbkDecodeURIComponent ***REMOVED***);
     * ```
     * @since v0.1.25
