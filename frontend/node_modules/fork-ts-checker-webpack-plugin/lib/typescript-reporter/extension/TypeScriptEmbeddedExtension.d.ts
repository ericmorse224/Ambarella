import { TypeScriptExtension ***REMOVED*** from './TypeScriptExtension';
 ...
 */
declare function createTypeScriptEmbeddedExtension({ embeddedExtensions, getEmbeddedSource, ***REMOVED***: TypeScriptEmbeddedExtensionHost): TypeScriptExtension;
export { TypeScriptEmbeddedExtensionHost, TypeScriptEmbeddedSource, createTypeScriptEmbeddedExtension, ***REMOVED***;
