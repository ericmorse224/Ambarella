...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {Token***REMOVED*** leftToken The last token of the callee. This may be the closing parenthesis that encloses the callee.
		 * @param {Token***REMOVED*** rightToken Tha first token of the arguments. this is the opening parenthesis that encloses the arguments.
		...
		function checkSpacing(node, leftToken, rightToken) {
			...
			***REMOVED*** else if (!never && !hasWhitespace) {
				context.report({
					...
					***REMOVED***,
				***REMOVED***);
			***REMOVED*** else if (!never && !allowNewlines && hasNewline) {
				context.report({
					node,
					loc: {
						start: leftToken.loc.end,
