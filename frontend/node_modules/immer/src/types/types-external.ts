import {Nothing***REMOVED*** from "../internal"
 ...
 * or `{***REMOVED***` (from the node types), in both cases entering an infinite recursion in
...
export type WritableDraft<T> = {-readonly [K in keyof T]: Draft<T[K]>***REMOVED***
...
export function never_used() {***REMOVED***
