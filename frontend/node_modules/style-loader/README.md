    ...
    rules: [
      {
        ...
        use: [
          ...
          { loader: "style-loader", options: { injectType: "styleTag" ***REMOVED*** ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
    ],
    ...
    rules: [
      {
        ...
        use: [
          {
            loader: "style-loader",
            options: { injectType: "singletonStyleTag" ***REMOVED***,
          ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
      ...
      ***REMOVED***,
      {
        test: /\.lazy\.css$/i,
        use: [
          { loader: "style-loader", options: { injectType: "lazyStyleTag" ***REMOVED*** ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
    ],
      ...
      ***REMOVED***,
      {
        ...
        use: [
          {
            loader: "style-loader",
            options: { injectType: "lazySingletonStyleTag" ***REMOVED***,
          ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
    ...
    rules: [
      {
        test: /\.link\.css$/i,
        use: [
          { loader: "style-loader", options: { injectType: "linkTag" ***REMOVED*** ***REMOVED***,
          { loader: "file-loader" ***REMOVED***,
        ],
      ***REMOVED***,
    ],
  ***REMOVED***,
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: "style-loader", options: { attributes: { id: "id" ***REMOVED*** ***REMOVED*** ***REMOVED***,
        ...
        use: [
          {
            ...
            options: {
              insert: function insertAtTop(element) {
                ...
                ***REMOVED*** else if (lastInsertedElement.nextSibling) {
...
class CustomSquare extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" ***REMOVED***);
    ...
    customSquareStyles.use({ target: this.shadowRoot ***REMOVED***);
    ...
    bgPurple.replace(`div { width: ${width***REMOVED***px; height: ${height***REMOVED***px; ***REMOVED***`);
        ...
        use: [
          {
            ...
            options: {
              ...
              styleTagTransform: function (css, style) {
                // Do something ...
                style.innerHTML = `${css***REMOVED***.modify{***REMOVED***\n`;
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: "style-loader", options: { base: 1000 ***REMOVED*** ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
    ],
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: "style-loader", options: { base: 2000 ***REMOVED*** ***REMOVED***,
          "css-loader",
        ],
      ***REMOVED***,
    ],
...
```js
import { fooBaz, bar ***REMOVED*** from "./styles.css";
