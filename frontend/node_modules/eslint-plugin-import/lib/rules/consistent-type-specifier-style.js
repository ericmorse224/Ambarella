...
/**
   * @param {import('eslint').Rule.Fix[]***REMOVED*** fixes
   * @param {import('eslint').Rule.RuleFixer***REMOVED*** fixer
   * @param {import('eslint').SourceCode.SourceCode***REMOVED*** sourceCode
   * @param {(ImportSpecifier | ImportDefaultSpecifier | ImportNamespaceSpecifier)[]***REMOVED*** specifiers
   * */
...
/** @type {(node: import('estree').Node, sourceCode: import('eslint').SourceCode.SourceCode, specifiers: (ImportSpecifier | ImportNamespaceSpecifier)[], kind: 'type' | 'typeof') => string***REMOVED*** */
...
kind)
{
  ...
  ***REMOVED***);
  ...
  return 'import ' + String(kind) + ' {' + String(names.join(', ')) + '***REMOVED*** from ' + String(sourceString) + ';';
***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('consistent-type-specifier-style') ***REMOVED***,
    ...
    schema: [
    {
      ...
      'default': 'prefer-inline' ***REMOVED***] ***REMOVED***,
        ...
        return {
          ImportDeclaration: function () {function ImportDeclaration(node) {
              ...
              ***REMOVED***
              ...
              if (
              // no specifiers (import type {***REMOVED*** from '') have no specifiers to mark as inline
              ...
              ***REMOVED***
              ...
              context.report({
                node: node,
                message: 'Prefer using inline {{kind***REMOVED******REMOVED*** specifiers instead of a top-level {{kind***REMOVED******REMOVED***-only import.',
                data: {
                  kind: node.importKind ***REMOVED***,

                fix: function () {function fix(fixer) {
                    var kindToken = sourceCode.getFirstToken(node, { skip: 1 ***REMOVED***);

                    return [].concat(
                    kindToken ? fixer.remove(kindToken) : [],
                    node.specifiers.map(function (specifier) {return fixer.insertTextBefore(specifier, String(node.importKind) + ' ');***REMOVED***));

                  ***REMOVED***return fix;***REMOVED***() ***REMOVED***);

            ***REMOVED***return ImportDeclaration;***REMOVED***() ***REMOVED***;

      ***REMOVED***

      // prefer-top-level
      return {
        /** @param {import('estree').ImportDeclaration***REMOVED*** node */
        ImportDeclaration: function () {function ImportDeclaration(node) {
            if (
            // already top-level is valid
            node.importKind === 'type' ||
            node.importKind === 'typeof'
            // no specifiers (import {***REMOVED*** from '') cannot have inline - so is valid
            || node.specifiers.length === 0 ||
            node.specifiers.length === 1
            // default imports are both "inline" and "top-level"
            && (
            ...
            ***REMOVED***
            ...
            /** @type {typeof node.specifiers***REMOVED*** */
            var typeSpecifiers = [];
            /** @type {typeof node.specifiers***REMOVED*** */
            var typeofSpecifiers = [];
            /** @type {typeof node.specifiers***REMOVED*** */
            var valueSpecifiers = [];
            /** @type {typeof node.specifiers[number]***REMOVED*** */
            var defaultSpecifier = null;var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
              for (var _iterator2 = node.specifiers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var specifier = _step2.value;
                ...
                ***REMOVED*** else if (specifier.importKind === 'typeof') {
                  typeofSpecifiers.push(specifier);
                ***REMOVED*** else if (specifier.importKind === 'value' || specifier.importKind == null) {
            ...
            if (typeSpecifiers.length + typeofSpecifiers.length === node.specifiers.length) {
              ...
              context.report({
                node: node,
                message: 'Prefer using a top-level {{kind***REMOVED******REMOVED***-only import instead of inline {{kind***REMOVED******REMOVED*** specifiers.',
                data: {
                  kind: kind.join('/') ***REMOVED***,
                ...
                context.report({
                  ...
                  fix: function () {function fix(fixer) {
                      ...
                      if (valueSpecifiers.length > 0) {
                        // import { Value, type Type ***REMOVED*** from 'mod';
                        ...
                        ***REMOVED***
                      ***REMOVED*** else if (defaultSpecifier) {
                        // import Default, { type Type ***REMOVED*** from 'mod';
                        ...
                        function (token) {return token.type === 'Punctuator' && token.value === '***REMOVED***';***REMOVED***);
