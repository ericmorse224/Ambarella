...
import type {ConsoleBuffer***REMOVED*** from '@jest/console';
import type {CoverageMap***REMOVED*** from 'istanbul-lib-coverage';
import type {CoverageMapData***REMOVED*** from 'istanbul-lib-coverage';
import type {FS***REMOVED*** from 'jest-haste-map';
import type {ModuleMap***REMOVED*** from 'jest-haste-map';
import type Resolver from 'jest-resolve';
import type {TestResult as TestResult_2***REMOVED*** from '@jest/types';
import type {TransformTypes***REMOVED*** from '@jest/types';
import type {V8Coverage***REMOVED*** from 'collect-v8-coverage';
