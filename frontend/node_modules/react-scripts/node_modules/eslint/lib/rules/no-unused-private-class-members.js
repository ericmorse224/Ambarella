...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unusedPrivateClassMember: "'{{classMemberName***REMOVED******REMOVED***' is defined but never used."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {ASTNode***REMOVED*** privateIdentifierNode Node referring to a private identifier
         * @returns {boolean***REMOVED*** Whether the node is in a write only assignment
         * @private
         */
        ...
        return {
            ...
            ***REMOVED***,
            ...
            PrivateIdentifier(privateIdentifierNode) {
                ...
                ***REMOVED***
                ...
                /*
                 * ({ x: this.#usedInDestructuring ***REMOVED*** = bar);
                 *
                 * But should treat the following as a read:
                 * ({ [this.#x]: a ***REMOVED*** = foo);
                 */
            ...
            ***REMOVED***,
            ...
            "ClassBody:exit"() {
                ...
                for (const [classMemberName, { declaredNode, isUsed ***REMOVED***] of unusedPrivateMembers.entries()) {
                    if (isUsed) {
                        continue;
                    ***REMOVED***
                    context.report({
                        ...
                        data: {
                            classMemberName: `#${classMemberName***REMOVED***`
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED***
            ***REMOVED***
