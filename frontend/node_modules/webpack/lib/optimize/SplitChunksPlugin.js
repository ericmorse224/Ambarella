...
const { requestToId ***REMOVED*** = require("../ids/IdHelpers");
...
/** @typedef {import("../../declarations/WebpackOptions").OptimizationSplitChunksCacheGroup***REMOVED*** OptimizationSplitChunksCacheGroup */
/** @typedef {import("../../declarations/WebpackOptions").OptimizationSplitChunksGetCacheGroups***REMOVED*** OptimizationSplitChunksGetCacheGroups */
/** @typedef {import("../../declarations/WebpackOptions").OptimizationSplitChunksOptions***REMOVED*** OptimizationSplitChunksOptions */
/** @typedef {import("../../declarations/WebpackOptions").OptimizationSplitChunksSizes***REMOVED*** OptimizationSplitChunksSizes */
...
/** @typedef {import("../util/deterministicGrouping").GroupedItems<Module>***REMOVED*** DeterministicGroupingGroupedItemsForModule */
/** @typedef {import("../util/deterministicGrouping").Options<Module>***REMOVED*** DeterministicGroupingOptionsForModule */

/** @typedef {Record<string, number>***REMOVED*** SplitChunksSizes */
...
/**
 * @typedef {object***REMOVED*** CacheGroupSource
 * @property {string***REMOVED*** key
 * @property {number=***REMOVED*** priority
 * @property {GetName=***REMOVED*** getName
 * @property {ChunkFilterFunction=***REMOVED*** chunksFilter
 * @property {boolean=***REMOVED*** enforce
 * @property {SplitChunksSizes***REMOVED*** minSize
 * @property {SplitChunksSizes***REMOVED*** minSizeReduction
 * @property {SplitChunksSizes***REMOVED*** minRemainingSize
 * @property {SplitChunksSizes***REMOVED*** enforceSizeThreshold
 * @property {SplitChunksSizes***REMOVED*** maxAsyncSize
 * @property {SplitChunksSizes***REMOVED*** maxInitialSize
 * @property {number=***REMOVED*** minChunks
 * @property {number=***REMOVED*** maxAsyncRequests
 * @property {number=***REMOVED*** maxInitialRequests
 * @property {TemplatePath=***REMOVED*** filename
 * @property {string=***REMOVED*** idHint
 * @property {string=***REMOVED*** automaticNameDelimiter
 * @property {boolean=***REMOVED*** reuseExistingChunk
 * @property {boolean=***REMOVED*** usedExports
 */

/**
 * @typedef {object***REMOVED*** CacheGroup
 * @property {string***REMOVED*** key
 * @property {number***REMOVED*** priority
 * @property {GetName=***REMOVED*** getName
 * @property {ChunkFilterFunction***REMOVED*** chunksFilter
 ...
 * @property {boolean***REMOVED*** reuseExistingChunk
 * @property {boolean***REMOVED*** usedExports
 * @property {boolean***REMOVED*** _validateSize
 * @property {boolean***REMOVED*** _validateRemainingSize
 * @property {SplitChunksSizes***REMOVED*** _minSizeForMaxSize
 * @property {boolean***REMOVED*** _conditionalEnforce
 */

/**
 * @typedef {object***REMOVED*** FallbackCacheGroup
 * @property {ChunkFilterFunction***REMOVED*** chunksFilter
 * @property {SplitChunksSizes***REMOVED*** minSize
 * @property {SplitChunksSizes***REMOVED*** maxAsyncSize
 * @property {SplitChunksSizes***REMOVED*** maxInitialSize
...
/**
 * @typedef {object***REMOVED*** CacheGroupsContext
 ...
 * @param {CacheGroupsContext***REMOVED*** context
 * @returns {CacheGroupSource[] | null***REMOVED***
 */

/**
 * @callback GetName
 * @param {Module***REMOVED*** module
 * @param {Chunk[]***REMOVED*** chunks
 * @param {string***REMOVED*** key
 * @returns {string=***REMOVED***
 */

/**
 * @typedef {object***REMOVED*** SplitChunksOptions
 * @property {ChunkFilterFunction***REMOVED*** chunksFilter
 * @property {string[]***REMOVED*** defaultSizeTypes
 * @property {SplitChunksSizes***REMOVED*** minSize
 * @property {SplitChunksSizes***REMOVED*** minSizeReduction
 * @property {SplitChunksSizes***REMOVED*** minRemainingSize
 * @property {SplitChunksSizes***REMOVED*** enforceSizeThreshold
 ...
 * @property {number***REMOVED*** maxAsyncRequests
 * @property {number***REMOVED*** maxInitialRequests
 * @property {boolean***REMOVED*** hidePathInfo
 * @property {TemplatePath=***REMOVED*** filename
 * @property {string***REMOVED*** automaticNameDelimiter
 * @property {GetCacheGroups***REMOVED*** getCacheGroups
 * @property {GetName***REMOVED*** getName
 * @property {boolean***REMOVED*** usedExports
 * @property {FallbackCacheGroup***REMOVED*** fallbackCacheGroup
 */

/**
 * @typedef {object***REMOVED*** ChunksInfoItem
 * @property {SortableSet<Module>***REMOVED*** modules
 * @property {CacheGroup***REMOVED*** cacheGroup
 * @property {number***REMOVED*** cacheGroupIndex
 * @property {string=***REMOVED*** name
 * @property {Record<string, number>***REMOVED*** sizes
 * @property {Set<Chunk>***REMOVED*** chunks
 * @property {Set<Chunk>***REMOVED*** reusableChunks
 * @property {Set<bigint | Chunk>***REMOVED*** chunksKeys
 */

/** @type {GetName***REMOVED*** */
const defaultGetName = () => undefined;

const deterministicGroupingForModules =
	/** @type {(options: DeterministicGroupingOptionsForModule) => DeterministicGroupingGroupedItemsForModule[]***REMOVED*** */
	(deterministicGrouping);

/** @type {WeakMap<Module, string>***REMOVED*** */
const getKeyCache = new WeakMap();

/**
 * @param {string***REMOVED*** name a filename to hash
 * @param {OutputOptions***REMOVED*** outputOptions hash function used
 * @returns {string***REMOVED*** hashed filename
 */
const hashFilename = (name, outputOptions) => {
	const digest =
		/** @type {string***REMOVED*** */
		(
			createHash(/** @type {HashFunction***REMOVED*** */ (outputOptions.hashFunction))
				.update(name)
 ...
 * @returns {number***REMOVED*** the number of requests
 */
 ...
 * @param {T***REMOVED*** obj obj an object
 * @param {function(T[keyof T], keyof T): T[keyof T]***REMOVED*** fn fn
...
/**
 * @template T
 * @param {Set<T>***REMOVED*** a set
 * @param {Set<T>***REMOVED*** b other set
 * @returns {boolean***REMOVED*** true if at least one item of a is in b
 */
const isOverlap = (a, b) => {
	for (const item of a) {
...
/**
 * @param {ChunksInfoItem***REMOVED*** a item
 * @param {ChunksInfoItem***REMOVED*** b item
 * @returns {number***REMOVED*** compare result
 */
...
/**
 * @param {Chunk***REMOVED*** chunk the chunk
 * @returns {boolean***REMOVED*** true, if the chunk is an entry chunk
 */
const INITIAL_CHUNK_FILTER = chunk => chunk.canBeInitial();
/**
 * @param {Chunk***REMOVED*** chunk the chunk
 * @returns {boolean***REMOVED*** true, if the chunk is an async chunk
 */
const ASYNC_CHUNK_FILTER = chunk => !chunk.canBeInitial();
/**
 * @param {Chunk***REMOVED*** chunk the chunk
 * @returns {boolean***REMOVED*** always true
 */
const ALL_CHUNK_FILTER = chunk => true;

/**
 * @param {OptimizationSplitChunksSizes | undefined***REMOVED*** value the sizes
 * @param {string[]***REMOVED*** defaultSizeTypes the default size types
 * @returns {SplitChunksSizes***REMOVED*** normalized representation
 */
const normalizeSizes = (value, defaultSizeTypes) => {
	if (typeof value === "number") {
		...
		return o;
	***REMOVED*** else if (typeof value === "object" && value !== null) {
...
/**
 * @param {...(SplitChunksSizes | undefined)***REMOVED*** sizes the sizes
 * @returns {SplitChunksSizes***REMOVED*** the merged sizes
 */
const mergeSizes = (...sizes) => {
	/** @type {SplitChunksSizes***REMOVED*** */
	let merged = {***REMOVED***;
...
/**
 * @param {SplitChunksSizes***REMOVED*** sizes the sizes
 * @returns {boolean***REMOVED*** true, if there are sizes > 0
 */
...
/**
 * @param {SplitChunksSizes***REMOVED*** a first sizes
 * @param {SplitChunksSizes***REMOVED*** b second sizes
 * @param {CombineSizeFunction***REMOVED*** combine a function to combine sizes
 * @returns {SplitChunksSizes***REMOVED*** the combine sizes
 */
...
/**
 * @param {SplitChunksSizes***REMOVED*** sizes the sizes
 * @param {SplitChunksSizes***REMOVED*** minSize the min sizes
 * @returns {boolean***REMOVED*** true if there are sizes and all existing sizes are at least `minSize`
 */
...
/**
 * @param {SplitChunksSizes***REMOVED*** sizes the sizes
 * @param {SplitChunksSizes***REMOVED*** minSizeReduction the min sizes
 * @param {number***REMOVED*** chunkCount number of chunks
 * @returns {boolean***REMOVED*** true if there are sizes and all existing sizes are at least `minSizeReduction`
 */
 ...
 * @param {SplitChunksSizes***REMOVED*** sizes the sizes
 * @param {SplitChunksSizes***REMOVED*** minSize the min sizes
 * @returns {undefined | string[]***REMOVED*** list of size types that are below min size
 */
...
/**
 * @param {SplitChunksSizes***REMOVED*** sizes the sizes
 * @returns {number***REMOVED*** the total size
 */
...
/**
 * @param {OptimizationSplitChunksCacheGroup["name"]***REMOVED*** name the chunk name
 * @returns {GetName | undefined***REMOVED*** a function to get the name of the chunk
 */
const normalizeName = name => {
	...
	***REMOVED***
	if (typeof name === "function") {
		return /** @type {GetName***REMOVED*** */ (name);
	***REMOVED***
***REMOVED***;

/**
 * @param {OptimizationSplitChunksCacheGroup["chunks"]***REMOVED*** chunks the chunk filter option
 * @returns {ChunkFilterFunction | undefined***REMOVED*** the chunk filter function
 */
...
/**
 * @param {undefined | GetCacheGroups | Record<string, false | string | RegExp | OptimizationSplitChunksGetCacheGroups | OptimizationSplitChunksCacheGroup>***REMOVED*** cacheGroups the cache group options
 * @param {string[]***REMOVED*** defaultSizeTypes the default size types
 * @returns {GetCacheGroups***REMOVED*** a function to get the cache groups
 */
const normalizeCacheGroups = (cacheGroups, defaultSizeTypes) => {
	...
	***REMOVED***
	if (typeof cacheGroups === "object" && cacheGroups !== null) {
		/** @type {((module: Module, context: CacheGroupsContext, results: CacheGroupSource[]) => void)[]***REMOVED*** */
		const handlers = [];
		for (const key of Object.keys(cacheGroups)) {
			...
			***REMOVED***
			if (typeof option === "string" || option instanceof RegExp) {
				const source = createCacheGroupSource({***REMOVED***, key, defaultSizeTypes);
				handlers.push((module, context, results) => {
					if (checkTest(option, module, context)) {
						results.push(source);
					***REMOVED***
				***REMOVED***);
			***REMOVED*** else if (typeof option === "function") {
		...
		***REMOVED***
		 ...
		 * @param {CacheGroupsContext***REMOVED*** context the current context
		 * @returns {CacheGroupSource[]***REMOVED*** the matching cache groups
		 */
		const fn = (module, context) => {
			/** @type {CacheGroupSource[]***REMOVED*** */
			const results = [];
...
/**
 * @param {OptimizationSplitChunksCacheGroup["test"]***REMOVED*** test test option
 * @param {Module***REMOVED*** module the module
 * @param {CacheGroupsContext***REMOVED*** context context object
 * @returns {boolean***REMOVED*** true, if the module should be selected
 */
...
/**
 * @param {OptimizationSplitChunksCacheGroup["type"]***REMOVED*** test type option
 * @param {Module***REMOVED*** module the module
 * @returns {boolean***REMOVED*** true, if the module should be selected
 */
...
/**
 * @param {OptimizationSplitChunksCacheGroup["layer"]***REMOVED*** test type option
 * @param {Module***REMOVED*** module the module
 * @returns {boolean***REMOVED*** true, if the module should be selected
 */
...
/**
 * @param {OptimizationSplitChunksCacheGroup***REMOVED*** options the group options
 * @param {string***REMOVED*** key key of cache group
 * @param {string[]***REMOVED*** defaultSizeTypes the default size types
 * @returns {CacheGroupSource***REMOVED*** the normalized cached group
 */
...
module.exports = class SplitChunksPlugin {
	/**
	 * @param {OptimizationSplitChunksOptions=***REMOVED*** options plugin options
	 */
	constructor(options = {***REMOVED***) {
		...
		const fallbackCacheGroup = options.fallbackCacheGroup || {***REMOVED***;
		const minSize = normalizeSizes(options.minSize, defaultSizeTypes);
		const minSizeReduction = normalizeSizes(
			options.minSizeReduction,
			defaultSizeTypes
		...
		/** @type {SplitChunksOptions***REMOVED*** */
		this.options = {
			chunksFilter:
				/** @type {ChunkFilterFunction***REMOVED*** */
			...
			getName: options.name
				? /** @type {GetName***REMOVED*** */ (normalizeName(options.name))
				: defaultGetName,
			automaticNameDelimiter: options.automaticNameDelimiter || "-",
		...
		***REMOVED***;
		...
		/** @type {WeakMap<CacheGroupSource, CacheGroup>***REMOVED*** */
		this._cacheGroupCache = new WeakMap();
	***REMOVED***

	/**
	 * @param {CacheGroupSource***REMOVED*** cacheGroupSource source
	 * @returns {CacheGroup***REMOVED*** the cache group (cached)
	 */
			...
			compilation.hooks.optimizeChunks.tap(
				...
				***REMOVED***,
				chunks => {
					...
					***REMOVED***
					/**
					 * @param {Iterable<Chunk>***REMOVED*** chunks list of chunks
					 * @returns {bigint | Chunk***REMOVED*** key of the chunks
					 */
					const getKey = chunks => {
						...
						let key =
							/** @type {bigint***REMOVED*** */ (chunkIndexMap.get(first)) |
							/** @type {bigint***REMOVED*** */ (chunkIndexMap.get(result.value));
						while (!(result = iterator.next()).done) {
							const raw = chunkIndexMap.get(result.value);
							key = key ^ /** @type {bigint***REMOVED*** */ (raw);
						***REMOVED***
						return key;
					***REMOVED***;
					/**
					 * @param {bigint | Chunk***REMOVED*** key key of the chunks
					 * @returns {string***REMOVED*** stringified key
					 */
					const keyToString = key => {
						if (typeof key === "bigint") return key.toString(16);
						return /** @type {bigint***REMOVED*** */ (chunkIndexMap.get(key)).toString(16);
					***REMOVED***;

					const getChunkSetsInGraph = memoize(() => {
						/** @type {Map<bigint, Set<Chunk>>***REMOVED*** */
						...
						for (const module of compilation.modules) {
							...
							***REMOVED***
						***REMOVED***
						return { chunkSetsInGraph, singleChunkSets ***REMOVED***;
					***REMOVED***);

					/**
					 * @param {Module***REMOVED*** module the module
					 * @returns {Iterable<Chunk[]>***REMOVED*** groups of chunks with equal exports
					 */
					...
					***REMOVED***;
					...
					/** @type {Map<Module, Iterable<Chunk[]>>***REMOVED*** */
					const groupedByExportsMap = new Map();

					const getExportsChunkSetsInGraph = memoize(() => {
						/** @type {Map<bigint | Chunk, Set<Chunk>>***REMOVED*** */
						const chunkSetsInGraph = new Map();
						/** @type {Set<Chunk>***REMOVED*** */
						const singleChunkSets = new Set();
						for (const module of compilation.modules) {
					...
					***REMOVED***);
					...
					/**
					 * @param {IterableIterator<Set<Chunk>>***REMOVED*** chunkSets set of sets of chunks
					 * @returns {Map<number, Array<Set<Chunk>>>***REMOVED*** map of sets of chunks by count
					 */
					const groupChunkSetsByCount = chunkSets => {
						/** @type {Map<number, Array<Set<Chunk>>>***REMOVED*** */
					...
					***REMOVED***;
					...
					/**
					 * @param {Map<bigint | Chunk, Set<Chunk>>***REMOVED*** chunkSets chunk sets
					 * @param {Set<Chunk>***REMOVED*** singleChunkSets single chunks sets
					 * @param {Map<number, Set<Chunk>[]>***REMOVED*** chunkSetsByCount chunk sets by count
					 * @returns {(key: bigint | Chunk) => (Set<Chunk> | Chunk)[]***REMOVED*** combinations
					 */
					const createGetCombinations = (
						...
						/** @type {Map<bigint | Chunk, (Set<Chunk> | Chunk)[]>***REMOVED*** */
					...
					***REMOVED***;
					...
					const getCombinationsFactory = memoize(() => {
						const { chunkSetsInGraph, singleChunkSets ***REMOVED*** = getChunkSetsInGraph();
					...
					***REMOVED***);
					...
					/**
					 * @param {bigint | Chunk***REMOVED*** key key
					 * @returns {(Set<Chunk> | Chunk)[]***REMOVED*** combinations by key
					 */
					const getCombinations = key => getCombinationsFactory()(key);

					const getExportsCombinationsFactory = memoize(() => {
						const { chunkSetsInGraph, singleChunkSets ***REMOVED*** =
					...
					***REMOVED***);
					/**
					 * @param {bigint | Chunk***REMOVED*** key key
					 * @returns {(Set<Chunk> | Chunk)[]***REMOVED*** exports combinations by key
					 */
					const getExportsCombinations = key =>
						getExportsCombinationsFactory()(key);

					/**
					 * @typedef {object***REMOVED*** SelectedChunksResult
					 * @property {Chunk[]***REMOVED*** chunks the list of chunks
					 * @property {bigint | Chunk***REMOVED*** key a key of the list
					 */

					/** @type {WeakMap<Set<Chunk> | Chunk, WeakMap<ChunkFilterFunction, SelectedChunksResult>>***REMOVED*** */
					const selectedChunksCacheByChunksSet = new WeakMap();

					/**
					 * get list and key by applying the filter function to the list
					 * It is cached for performance reasons
					 * @param {Set<Chunk> | Chunk***REMOVED*** chunks list of chunks
					 * @param {ChunkFilterFunction***REMOVED*** chunkFilter filter function for chunks
					 * @returns {SelectedChunksResult***REMOVED*** list and key
					 */
					const getSelectedChunks = (chunks, chunkFilter) => {
						...
						***REMOVED***
						let entry2 =
							/** @type {SelectedChunksResult***REMOVED*** */
					...
					***REMOVED***;
					...
					/** @type {Map<string, boolean>***REMOVED*** */
					...
					/** @type {Map<string, ChunksInfoItem>***REMOVED*** */
					const chunksInfoMap = new Map();

					/**
					 * @param {CacheGroup***REMOVED*** cacheGroup the current cache group
					 * @param {number***REMOVED*** cacheGroupIndex the index of the cache group of ordering
					 * @param {Chunk[]***REMOVED*** selectedChunks chunks selected for this module
					 * @param {bigint | Chunk***REMOVED*** selectedChunksKey a key of selectedChunks
					 * @param {Module***REMOVED*** module the current module
					 * @returns {void***REMOVED***
					 */
					const addModuleToChunksInfoMap = (
						...
						if (existingChunk) {
							const parentValidationKey = `${name***REMOVED***|${
								...
								if (!valid) {
									if (!alreadyReportedErrors.has(name)) {
										...
										compilation.errors.push(
											new WebpackError(
												`${PLUGIN_NAME***REMOVED***\n` +
													`Cache group "${cacheGroup.key***REMOVED***" conflicts with existing chunk.\n` +
													`Both have the same name "${name***REMOVED***" and existing chunk is not a parent of the selected modules.\n` +
						...
						***REMOVED***
						...
						const key =
							...
							(name
								? ` name:${name***REMOVED***`
								: ` chunks:${keyToString(selectedChunksKey)***REMOVED***`);
						// Add module to maps
					...
					for (const module of compilation.modules) {
						...
						***REMOVED***);
						...
						const getCombsByUsedExports = memoize(() => {
							...
							getExportsChunkSetsInGraph();
							/** @type {Set<Set<Chunk> | Chunk>***REMOVED*** */
							const set = new Set();
							const groupedByUsedExports =
								/** @type {Iterable<Chunk[]>***REMOVED*** */
						...
						***REMOVED***);
						...
						for (const cacheGroupSource of cacheGroups) {
							...
							for (const chunkCombination of combs) {
								...
								const { chunks: selectedChunks, key: selectedChunksKey ***REMOVED*** =
									getSelectedChunks(
										chunkCombination,
										/** @type {ChunkFilterFunction***REMOVED*** */
					...
					***REMOVED***
					...
					/**
					 * @param {ChunksInfoItem***REMOVED*** info entry
					 * @param {string[]***REMOVED*** sourceTypes source types to be removed
					 */
					...
					***REMOVED***;
					...
					/**
					 * @param {ChunksInfoItem***REMOVED*** info entry
					 * @returns {boolean***REMOVED*** true, if entry become empty
					 */
					...
					***REMOVED***
					...
					/**
					 * @typedef {object***REMOVED*** MaxSizeQueueItem
					 * @property {SplitChunksSizes***REMOVED*** minSize
					 * @property {SplitChunksSizes***REMOVED*** maxAsyncSize
					 * @property {SplitChunksSizes***REMOVED*** maxInitialSize
					 * @property {string***REMOVED*** automaticNameDelimiter
					 * @property {string[]***REMOVED*** keys
					 */

					/** @type {Map<Chunk, MaxSizeQueueItem>***REMOVED*** */
					...
					while (chunksInfoMap.size > 0) {
						...
						***REMOVED***
						...
						const item = /** @type {ChunksInfoItem***REMOVED*** */ (bestEntry);
						chunksInfoMap.delete(/** @type {string***REMOVED*** */ (bestEntryKey));

						/** @type {ChunkName | undefined***REMOVED*** */
						let chunkName = item.name;
						// Variable for the new chunk (lazy created)
						/** @type {Chunk | undefined***REMOVED*** */
						let newChunk;
						...
						if (chunkName) {
							...
							***REMOVED***
						***REMOVED*** else if (item.cacheGroup.reuseExistingChunk) {
						...
						***REMOVED***
						...
						if (usedChunks.size < item.chunks.size) {
							if (isExistingChunk)
								usedChunks.add(/** @type {Chunk***REMOVED*** */ (newChunk));
							...
							***REMOVED***
							...
							if (violatingSizes !== undefined) {
								...
								if (
									...
									chunksInfoMap.set(/** @type {string***REMOVED*** */ (bestEntryKey), item);
								***REMOVED***
								continue;
							***REMOVED***
						***REMOVED***
						...
						***REMOVED***
						...
						newChunk.chunkReason =
							(newChunk.chunkReason ? `${newChunk.chunkReason***REMOVED***, ` : "") +
							(isReusedWithAllModules
								? "reused as split chunk"
								: "split chunk");
						if (item.cacheGroup.key) {
							newChunk.chunkReason += ` (cache group: ${item.cacheGroup.key***REMOVED***)`;
						***REMOVED***
						if (chunkName) {
							newChunk.chunkReason += ` (name: ${chunkName***REMOVED***)`;
						***REMOVED***
					...
					***REMOVED***
					...
					const { outputOptions ***REMOVED*** = compilation;

					// Make sure that maxSize is fulfilled
					const { fallbackCacheGroup ***REMOVED*** = this.options;
					for (const chunk of Array.from(compilation.chunks)) {
						...
						const {
							...
							maxInitialSize,
							automaticNameDelimiter
						***REMOVED*** = chunkConfig || fallbackCacheGroup;
						...
						***REMOVED***
						for (const key of Object.keys(maxSize)) {
							...
							if (
								...
								const warningKey = `${
									keys && keys.join()
								***REMOVED*** ${minSizeValue***REMOVED*** ${maxSizeValue***REMOVED***`;
