const { promises: fsPromises ***REMOVED*** = require('fs');
const path = require('path');

/** @type {Map<string, string | undefined>***REMOVED*** */
let packageJsonTypeMap = new Map();

/**
 * Infers the current active module system from loader context and options.
 * @this {import('webpack').loader.LoaderContext***REMOVED***
 * @param {import('webpack').ModuleFilenameHelpers***REMOVED*** ModuleFilenameHelpers Webpack's module filename helpers.
 * @param {import('../types').NormalizedLoaderOptions***REMOVED*** options The normalized loader options.
 * @return {Promise<'esm' | 'cjs'>***REMOVED*** The inferred module system.
 */
