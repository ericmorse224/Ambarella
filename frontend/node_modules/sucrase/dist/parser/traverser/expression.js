"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***);/* eslint max-len: 0 */
...
var _util = require('./util');
 ...
 class StopState {
  ...
  constructor(stop) {
    this.stop = stop;
  ***REMOVED***
***REMOVED*** exports.StopState = StopState;
...
// the AST node that the inner parser gave them in another node.
 function parseExpression(noIn = false) {
  ...
  if (_index3.match.call(void 0, _types3.TokenType.comma)) {
    ...
    ***REMOVED***
  ***REMOVED***
***REMOVED*** exports.parseExpression = parseExpression;
 ...
 */
  ...
  ***REMOVED*** else if (_base.isFlowEnabled) {
    return _flow.flowParseMaybeAssign.call(void 0, noIn, isWithinParens);
  ***REMOVED*** else {
    return baseParseMaybeAssign(noIn, isWithinParens);
  ***REMOVED***
***REMOVED*** exports.parseMaybeAssign = parseMaybeAssign;
...
// Returns true if the expression was an arrow function.
  ...
  ***REMOVED***
  return wasArrow;
***REMOVED*** exports.baseParseMaybeAssign = baseParseMaybeAssign;
...
***REMOVED***
 ...
 function baseParseConditional(noIn) {
  if (_index3.eat.call(void 0, _types3.TokenType.question)) {
    ...
    parseMaybeAssign(noIn);
  ***REMOVED***
***REMOVED*** exports.baseParseConditional = baseParseConditional;
...
// Returns true if this was an arrow function.
  ...
  ***REMOVED***
  return false;
***REMOVED*** exports.parseMaybeUnary = parseMaybeUnary;
...
// Returns true if this was an arrow function.
  ...
  ***REMOVED***
  return false;
***REMOVED*** exports.parseExprSubscripts = parseExprSubscripts;
...
***REMOVED***
  ...
  ***REMOVED*** while (!stopState.stop && !_base.state.error);
***REMOVED*** exports.baseParseSubscripts = baseParseSubscripts;
...
/** Set 'state.stop = true' to indicate that we should stop parsing subscripts. */
  ...
  ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType.questionDot)) {
    ...
    ***REMOVED*** else if (_index3.eat.call(void 0, _types3.TokenType.parenL)) {
      parseCallExpressionArguments();
    ***REMOVED*** else {
      parseMaybePrivateName();
    ***REMOVED***
  ***REMOVED*** else if (_index3.eat.call(void 0, _types3.TokenType.dot)) {
    _base.state.tokens[_base.state.tokens.length - 1].subscriptStartIndex = startTokenIndex;
    parseMaybePrivateName();
  ***REMOVED*** else if (_index3.eat.call(void 0, _types3.TokenType.bracketL)) {
    _base.state.tokens[_base.state.tokens.length - 1].subscriptStartIndex = startTokenIndex;
    parseExpression();
    _util.expect.call(void 0, _types3.TokenType.bracketR);
  ***REMOVED*** else if (!noCalls && _index3.match.call(void 0, _types3.TokenType.parenL)) {
    if (atPossibleAsync()) {
    ...
    ***REMOVED*** else {
      ...
      _base.state.tokens[_base.state.tokens.length - 1].contextId = callContextId;
    ***REMOVED***
  ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType.backQuote)) {
    // Tagged template expression.
    parseTemplate();
  ***REMOVED*** else {
    stopState.stop = true;
  ***REMOVED***
***REMOVED*** exports.baseParseSubscript = baseParseSubscript;
...
***REMOVED*** exports.atPossibleAsync = atPossibleAsync;
  ...
  ***REMOVED***
***REMOVED*** exports.parseCallExpressionArguments = parseCallExpressionArguments;
...
// Returns true if the parsed expression was an arrow function.
  ...
  ***REMOVED***
  ...
  if (_index3.match.call(void 0, _types3.TokenType.jsxText) || _index3.match.call(void 0, _types3.TokenType.jsxEmptyText)) {
    parseLiteral();
    return false;
  ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType.lessThan) && _base.isJSXEnabled) {
  ...
  switch (_base.state.type) {
    ...
    case _types3.TokenType.name: {
      ...
      ***REMOVED*** else if (
        ...
        _util.expect.call(void 0, _types3.TokenType.arrow);
        // let foo = async bar => {***REMOVED***;
        parseArrowExpression(startTokenIndex);
        return true;
      ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType._do) && !_util.canInsertSemicolon.call(void 0, )) {
        _index3.next.call(void 0, );
    ...
    ***REMOVED***
    ...
    default:
      ...
      return false;
  ***REMOVED***
***REMOVED*** exports.parseExprAtom = parseExprAtom;
...
// Returns whether there was an arrow token.
  ...
  ***REMOVED***
***REMOVED*** exports.parseArrow = parseArrow;
...
***REMOVED***
 ...
 function parseTemplate() {
  ...
  while (!_index3.match.call(void 0, _types3.TokenType.backQuote) && !_base.state.error) {
    ...
    parseExpression();
    // Finish ***REMOVED***, read quasi
    _index3.nextTemplateToken.call(void 0, );
    // Finish quasi, read either ${ or `
    _index3.nextTemplateToken.call(void 0, );
  ***REMOVED***
  _index3.next.call(void 0, );
***REMOVED*** exports.parseTemplate = parseTemplate;
...
// Parse an object literal or binding pattern.
  ...
  ***REMOVED***
  ...
  _base.state.tokens[_base.state.tokens.length - 1].contextId = contextId;
***REMOVED*** exports.parseObj = parseObj;
...
function isGetterOrSetterMethod(isPattern) {
  ...
  return (
    !isPattern &&
    (_index3.match.call(void 0, _types3.TokenType.string) || // get "string"() {***REMOVED***
      _index3.match.call(void 0, _types3.TokenType.num) || // get 1() {***REMOVED***
      _index3.match.call(void 0, _types3.TokenType.bracketL) || // get ["string"]() {***REMOVED***
      _index3.match.call(void 0, _types3.TokenType.name) || // get foo() {***REMOVED***
      !!(_base.state.type & _types3.TokenType.IS_KEYWORD)) // get debugger() {***REMOVED***
  );
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else {
    ...
    ***REMOVED***
    ...
    _base.state.tokens[_base.state.tokens.length - 1].contextId = objectContextId;
  ***REMOVED***
***REMOVED*** exports.parsePropertyName = parsePropertyName;
...
// Parse object or class method.
 function parseMethod(functionStart, isConstructor) {
  ...
  _base.state.scopeDepth--;
***REMOVED*** exports.parseMethod = parseMethod;
...
// assignable list.
 function parseArrowExpression(startTokenIndex) {
  ...
  _base.state.scopes.push(new (0, _state.Scope)(startTokenIndex, endTokenIndex, true));
  _base.state.scopeDepth--;
***REMOVED*** exports.parseArrowExpression = parseArrowExpression;
  ...
  ***REMOVED***
***REMOVED*** exports.parseFunctionBodyAndFinish = parseFunctionBodyAndFinish;
  ...
  ***REMOVED***
***REMOVED*** exports.parseFunctionBody = parseFunctionBody;
...
function parseExprListItem(allowEmpty) {
  ...
  ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType.ellipsis)) {
    _lval.parseSpread.call(void 0, );
    parseParenItem();
  ***REMOVED*** else if (_index3.match.call(void 0, _types3.TokenType.question)) {
...
// Parse the next token as an identifier.
 function parseIdentifier() {
  _index3.next.call(void 0, );
  _base.state.tokens[_base.state.tokens.length - 1].type = _types3.TokenType.name;
***REMOVED*** exports.parseIdentifier = parseIdentifier;
