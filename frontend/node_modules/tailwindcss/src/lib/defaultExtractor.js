...
import { splitAtTopLevelOnly ***REMOVED*** from '../util/splitAtTopLevelOnly'
...
function* buildRegExps(context) {
  ...
  ***REMOVED***
  ...
  // 5. Inner matches
  yield /[^<>"'`\s.(){***REMOVED***[\]#=%$][^<>"'`\s(){***REMOVED***[\]#=%$]*[^<>"'`\s.(){***REMOVED***[\]#=%:$]/g
***REMOVED***
  ...
  ***REMOVED***)
  ...
  for (let match of matches) {
    ...
    if (char === inStringType) {
      openStringTypes.pop()
    ***REMOVED*** else if (char === "'" || char === '"' || char === '`') {
      openStringTypes.push(char)
    ***REMOVED***

    if (inStringType) {
      continue
    ***REMOVED*** else if (char === '[') {
      depth++
      continue
    ***REMOVED*** else if (char === ']') {
      depth--
...
// Regular utilities
// {{modifier***REMOVED***:***REMOVED****{namespace***REMOVED***{-{suffix***REMOVED******REMOVED****{/{opacityModifier***REMOVED******REMOVED***?

// Arbitrary values
// {{modifier***REMOVED***:***REMOVED****{namespace***REMOVED***-[{arbitraryValue***REMOVED***]{/{opacityModifier***REMOVED******REMOVED***?
// arbitraryValue: no whitespace, balanced quotes unless within quotes, balanced brackets unless within quotes

// Arbitrary properties
// {{modifier***REMOVED***:***REMOVED****[{validCssPropertyName***REMOVED***:{arbitraryValue***REMOVED***]
