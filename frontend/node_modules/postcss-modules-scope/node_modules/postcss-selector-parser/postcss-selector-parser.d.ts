...
declare namespace parser {
    ...
    ***REMOVED***
    ...
    > {
        ...
        next(): Node | undefined;
        prev(): Node | undefined;
        clone(opts?: {[override: string]:any***REMOVED***): this;
        /**
         ...
         * @param {string***REMOVED*** name the property to set
         * @param {any***REMOVED*** value the unescaped value of the property
         * @param {string***REMOVED*** valueEscaped optional. the escaped value of the property.
         */
