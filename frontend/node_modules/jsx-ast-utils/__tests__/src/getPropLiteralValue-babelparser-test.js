...
describe('getLiteralPropValue', () => {
  ...
  ***REMOVED***);
  ...
  describeIfNotBabylon('Chain Expression', () => {
    it('should return null', () => {
      const prop = extractProp('<div foo={abc?.def***REMOVED*** />');
  ...
  ***REMOVED***);
  ...
  describeIfNotBabylon('import.meta', () => {
    ...
    ***REMOVED***);
    ...
    it('should return null', () => {
      const prop = extractProp('<div foo={import.meta.env.whyIsThisNotOnProcess***REMOVED*** />');
  ...
  describeIfNotBabylon('Typescript', () => {
    ...
    ***REMOVED***);
    ...
    it('should work with a this.props value', () => {
      const prop = extractProp('<a href={this.props.href!***REMOVED***>Download</a>', 'href');
      const expected = null;
      const actual = getLiteralPropValue(prop);
      assert.equal(actual, expected);
    ***REMOVED***);
