...
exports._convertInherit = (obj, ret, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
...

  {
    ...
    if (value !== undefined) {
      value = conversions["unsigned short"](value, { context: context + " has member 'code' that" ***REMOVED***);
  ...
  ***REMOVED***

  {
    ...
    let value = obj === undefined || obj === null ? undefined : obj[key];
    if (value !== undefined) {
      value = conversions["USVString"](value, { context: context + " has member 'reason' that" ***REMOVED***);
  ...
  ***REMOVED***

  {
    ...
    let value = obj === undefined || obj === null ? undefined : obj[key];
    if (value !== undefined) {
      value = conversions["boolean"](value, { context: context + " has member 'wasClean' that" ***REMOVED***);
