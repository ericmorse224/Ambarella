 ...
 *
 * @param o The object.
 * @throws {TypeError***REMOVED*** If `o` is neither `Iterable`, nor an `ArrayLike`.
 */
 ...
 *
 * @param o The object.
 * @throws {TypeError***REMOVED*** If `o` is neither `AsyncIterable`, `Iterable`, nor an `ArrayLike`.
 */
 ...
 *
 * ```js
 * import Default, { Named, Other ***REMOVED*** from "mod";
 * // or
 * import { default as Default, Named, Other ***REMOVED*** from "mod";
 * ```
 *
 ...
 * @param mod The CommonJS module exports object.
 */
export declare function __importDefault<T>(mod: T): T | { default: T ***REMOVED***;
 ...
 *
 * @throws {TypeError***REMOVED*** If `state` doesn't have an entry for `receiver`.
 */
export declare function __classPrivateFieldGet<T extends object, V>(
    receiver: T,
    state: { has(o: T): boolean, get(o: T): V | undefined ***REMOVED***,
    kind?: "f"
): V;
 ...
 *
 * @throws {TypeError***REMOVED*** If `receiver` is not `state`.
 */
...
export declare function __classPrivateFieldSet<T extends object, V>(
    receiver: T,
    state: { has(o: T): boolean, set(o: T, value: V): unknown ***REMOVED***,
    value: V,
    kind?: "f"
): V;
...
export declare function __classPrivateFieldIn(
    state: (new (...args: any[]) => unknown) | { has(o: any): boolean ***REMOVED***,
    receiver: unknown,
): boolean;
 ...
 * @returns The {@link value***REMOVED*** argument.
 *
 * @throws {TypeError***REMOVED*** If {@link value***REMOVED*** is not an object, or if either `Symbol.dispose` or `Symbol.asyncDispose` are not
 * defined, or if {@link value***REMOVED*** does not have an appropriate `Symbol.dispose` or `Symbol.asyncDispose` method.
 */
export declare function __addDisposableResource<T>(env: { stack: { value?: unknown, dispose?: Function, async: boolean ***REMOVED***[]; error: unknown; hasError: boolean; ***REMOVED***, value: T, async: boolean): T;

/**
 * Disposes all resources in a resource-tracking environment object.
 * @param env A resource-tracking environment object.
 * @returns A {@link Promise***REMOVED*** if any resources in the environment were marked as `async` when added; otherwise, `void`.
 *
 * @throws {SuppressedError***REMOVED*** if an error thrown during disposal would have suppressed a prior error from disposal or the
 * error recorded in the resource-tracking environment object.
 * @seealso {@link __addDisposableResource***REMOVED***
 */
export declare function __disposeResources(env: { stack: { value?: unknown, dispose?: Function, async: boolean ***REMOVED***[]; error: unknown; hasError: boolean; ***REMOVED***): any;
