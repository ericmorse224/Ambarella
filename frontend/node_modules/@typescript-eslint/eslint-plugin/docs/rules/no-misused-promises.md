...
```ts
const getData = () => someAsyncOperation({ myArg: 'foo' ***REMOVED***);

return { foo: 42, ...getData() ***REMOVED***;

const getData2 = async () => {
  await someAsyncOperation({ myArg: 'foo' ***REMOVED***);
***REMOVED***;

return { foo: 42, ...getData2() ***REMOVED***;
```
...
return { foo: 42, ...(await getData()) ***REMOVED***;

const getData2 = async () => {
  await someAsyncOperation({ myArg: 'foo' ***REMOVED***);
***REMOVED***;

return { foo: 42, ...(await getData2()) ***REMOVED***;
```
