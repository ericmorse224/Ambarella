...
function getFirstSemanticOrSyntacticError(program, ast) {
    ...
    ***REMOVED***
        ...
        console.warn(`Warning From TSC: "${e.message***REMOVED***`); // eslint-disable-line no-console
        /* istanbul ignore next */
        return undefined;
    ***REMOVED***
***REMOVED***
...
function whitelistSupportedDiagnostics(diagnostics) {
    return diagnostics.filter(diagnostic => {
        switch (diagnostic.code) {
            ...
            case 1044: // "'{0***REMOVED***' modifier cannot appear on a module or namespace element."
            case 1045: // "A '{0***REMOVED***' modifier cannot be used with an interface declaration."
            case 1048: // "A rest parameter cannot have an initializer."
            case 1049: // "A 'set' accessor must have exactly one parameter."
            case 1070: // "'{0***REMOVED***' modifier cannot appear on a type member."
            case 1071: // "'{0***REMOVED***' modifier cannot appear on an index signature."
            case 1085: // "Octal literals are not available when targeting ECMAScript 5 and higher. Use the syntax '{0***REMOVED***'."
            case 1090: // "'{0***REMOVED***' modifier cannot appear on a parameter."
            case 1096: // "An index signature must have exactly one parameter."
            case 1097: // "'{0***REMOVED***' list cannot be empty."
            ...
            case 8017: // "Octal literal types must use ES2015 syntax. Use the syntax '{0***REMOVED***'."
            case 17012: // "'{0***REMOVED***' is not a valid meta-property for keyword '{1***REMOVED***'. Did you mean '{2***REMOVED***'?"
            case 17013: // "Meta-property '{0***REMOVED***' is only allowed in the body of a function declaration, function expression, or constructor."
                return true;
        ***REMOVED***
        return false;
    ***REMOVED***);
...
function convertDiagnosticToSemanticOrSyntacticError(diagnostic) {
    return Object.assign(Object.assign({***REMOVED***, diagnostic), { message: (0, typescript_1.flattenDiagnosticMessageText)(diagnostic.messageText, typescript_1.sys.newLine) ***REMOVED***);
***REMOVED***
