...
test('Objects', function (t) {
	...
	t.ok(is(toPrimitive({***REMOVED***), '[object Object]'), '{***REMOVED*** with no hint coerces to Object#toString');
	t.equal(toPrimitive({***REMOVED***, String), '[object Object]', '{***REMOVED*** with hint String coerces to Object#toString');
	t.ok(is(toPrimitive({***REMOVED***, Number), '[object Object]'), '{***REMOVED*** with hint Number coerces to Object#toString');
