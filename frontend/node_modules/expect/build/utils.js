...
const getPath = (object, propertyPath) => {
  ...
  ***REMOVED***
  ...
  return {
    ...
    value: object
  ***REMOVED***;
***REMOVED***; // Strip properties from object that are not present in the subset. Useful for
...
const getObjectSubset = (object, subset, seenReferences = new WeakMap()) => {
  ...
  if (Array.isArray(object)) {
    ...
    ***REMOVED***
  ***REMOVED*** else if (object instanceof Date) {
    return object;
  ***REMOVED*** else if (isObject(object) && isObject(subset)) {
    if (
    ...
    ***REMOVED*** else if (
      ...
      for (const aValue of a) {
        if (!b.has(aValue)) {
          ...
          ***REMOVED***
        ***REMOVED***
      ***REMOVED*** // Remove the first value from the stack of traversed values.
...
const arrayBufferEquality = (a, b) => {
  ...
  ***REMOVED***
  ...
  if (dataViewA.byteLength !== dataViewB.byteLength) {
    return false;
  ***REMOVED*** // Check if every byte value is equal to each other
...
const sparseArrayEquality = (a, b) => {
  if (!Array.isArray(a) || !Array.isArray(b)) {
    return undefined;
  ***REMOVED*** // A sparse array [, , 1] will have keys ["2"] whereas [undefined, undefined, 1] will have keys ["0", "1", "2"]
...
const pathAsArray = propertyPath => {
  ...
  if (propertyPath === '') {
    properties.push('');
    return properties;
  ***REMOVED*** // will match everything that's not a dot or a bracket, and "" for consecutive dots.
  ...
  ***REMOVED***);
  return properties;
***REMOVED***; // Copied from https://github.com/graingert/angular.js/blob/a43574052e9775cbc1d7dd8a086752c979b0f020/src/Angular.js#L685-L693
