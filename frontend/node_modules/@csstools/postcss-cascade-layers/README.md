...
```js
postcssCascadeLayers({ onRevertLayerKeyword: 'warn' ***REMOVED***) // 'warn' | false
```
...
```js
postcssCascadeLayers({ onConditionalRulesChangingLayerOrder: 'warn' ***REMOVED***) // 'warn' | false
```
...
```js
postcssCascadeLayers({ onImportLayerRule: 'warn' ***REMOVED***) // 'warn' | false
```
