...
const { setAttributeValue, removeAttributeByName ***REMOVED*** = require("../attributes");
...
function attrSnakeCase(name) {
  return name.replace(/[A-Z]/g, match => `-${match.toLowerCase()***REMOVED***`);
***REMOVED***
...
exports.implementation = class DOMStringMapImpl {
  ...
  ***REMOVED***
  get [idlUtils.supportedPropertyNames]() {
    ...
    const { attributes ***REMOVED*** = this._element;
  ...
  [idlUtils.namedSetNew](name, value) {
    if (/-[a-z]/.test(name)) {
      throw DOMException.create(this._globalObject, [
        `'${name***REMOVED***' is not a valid property name`,
        "SyntaxError"
      ]);
    ***REMOVED***
    name = `data-${attrSnakeCase(name)***REMOVED***`;
