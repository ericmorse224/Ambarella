...
class TestSequencer {
  ...
  ***REMOVED***
  ...
  sort(tests) {
    ...
    const fileSize = ({path, context: {hasteFS***REMOVED******REMOVED***) =>
    ...
    return tests.sort((testA, testB) => {
      ...
      if (failedA !== failedB) {
        return failedA ? -1 : 1;
      ***REMOVED*** else if (hasTimeA != (testB.duration != null)) {
        // If only one of two tests has timing information, run it last
        return hasTimeA ? 1 : -1;
      ***REMOVED*** else if (testA.duration != null && testB.duration != null) {
