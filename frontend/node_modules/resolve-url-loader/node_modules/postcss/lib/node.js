...
function cloneNode(obj, parent) {
  ...
  for (var i in obj) {
    ...
    ***REMOVED*** else if (i === 'source') {
      cloned[i] = value;
    ***REMOVED*** else if (value instanceof Array) {
...
var Node = /*#__PURE__*/function () {
  /**
   * @param {object***REMOVED*** [defaults] Value for node properties.
   */
  ...
  ***REMOVED***
   ...
   *
   * @param {string***REMOVED*** message     Error description.
   * @param {object***REMOVED*** [opts]      Options.
   * @param {string***REMOVED*** opts.plugin Plugin name that created this error.
   *                             PostCSS will set it automatically.
   * @param {string***REMOVED*** opts.word   A word inside a node’s string that should
   *                             be highlighted as the source of the error.
   * @param {number***REMOVED*** opts.index  An index inside a node’s string that should
   *                             be highlighted as the source of the error.
   *
   * @return {CssSyntaxError***REMOVED*** Error object to throw it.
   *
   * @example
   * if (!variables[name]) {
   *   throw decl.error('Unknown variable ' + name, { word: name ***REMOVED***)
  ...
  ***REMOVED***
  /**
   * This method is provided as a convenience wrapper for {@link Result#warn***REMOVED***.
   *
   * @param {Result***REMOVED*** result      The {@link Result***REMOVED*** instance
   *                             that will receive the warning.
   * @param {string***REMOVED*** text        Warning message.
   * @param {object***REMOVED*** [opts]      Options
   * @param {string***REMOVED*** opts.plugin Plugin name that created this warning.
   *                             PostCSS will set it automatically.
   * @param {string***REMOVED*** opts.word   A word inside a node’s string that should
   ...
   *                             be highlighted as the source of the warning.
   *
   * @return {Warning***REMOVED*** Created warning object.
   *
   * @example
  ...
  ***REMOVED***
   ...
   * ***REMOVED***
   *
   * @return {Node***REMOVED*** Node to make calls chain.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {stringifier|syntax***REMOVED*** [stringifier] A syntax to use
   *                                           in string generation.
   *
   * @return {string***REMOVED*** CSS string of this node.
   *
   * @example
   * postcss.rule({ selector: 'a' ***REMOVED***).toString() //=> "a {***REMOVED***"
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {object***REMOVED*** [overrides] New properties to override in the clone.
   *
   * @example
   * decl.raws.before    //=> "\n  "
   * const cloned = decl.clone({ prop: '-moz-' + decl.prop ***REMOVED***)
   * cloned.raws.before  //=> "\n  "
   * cloned.toString()   //=> -moz-transform: scale(0)
   *
   * @return {Node***REMOVED*** Clone of the node.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {object***REMOVED*** [overrides] Mew properties to override in the clone.
   *
   * @example
   * decl.cloneBefore({ prop: '-moz-' + decl.prop ***REMOVED***)
   *
  ...
  ***REMOVED***
   ...
   *
   * @param {...Node***REMOVED*** nodes Mode(s) to replace current one.
   *
   * @example
   ...
   * ***REMOVED***
   *
   * @return {Node***REMOVED*** Current node to methods chain.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @return {Node|undefined***REMOVED*** Next node.
   *
   * @example
  ...
  ***REMOVED***
   ...
   *
   * @return {Node|undefined***REMOVED*** Previous node.
   *
   * @example
  ...
  ***REMOVED***
  /**
   * Returns a {@link Node#raws***REMOVED*** value. If the node is missing
   * the code style property (because the node was manually built or cloned),
   * PostCSS will try to autodetect the code style property by looking
   * at other nodes in the tree.
   *
   * @param {string***REMOVED*** prop          Name of code style property.
   * @param {string***REMOVED*** [defaultType] Name of default value, it can be missed
   *                               if the value is the same as prop.
   *
   * @example
   * const root = postcss.parse('a { background: white ***REMOVED***')
   * root.nodes[0].append({ prop: 'color', value: 'black' ***REMOVED***)
   * root.nodes[0].nodes[1].raws.before   //=> undefined
   * root.nodes[0].nodes[1].raw('before') //=> ' '
   *
   * @return {string***REMOVED*** Code style value.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @return {Root***REMOVED*** Root parent.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {boolean***REMOVED*** [keepBetween] Keep the raws.between symbols.
   *
  ...
  ***REMOVED***
  /**
   * @memberof Node#
   * @member {string***REMOVED*** type String representing the node’s type.
   *                       Possible values are `root`, `atrule`, `rule`,
   *                       `decl`, or `comment`.
   *
   * @example
   * postcss.decl({ prop: 'color', value: 'black' ***REMOVED***).type //=> 'decl'
   */

  /**
   * @memberof Node#
   * @member {Container***REMOVED*** parent The node’s parent node.
   *
   * @example
  ...
  /**
   * @memberof Node#
   * @member {source***REMOVED*** source The input source of the node.
   *
   ...
   *
   * // Good
   * const prefixed = decl.clone({ prop: '-moz-' + decl.prop ***REMOVED***)
   * ```
   *
   * ```js
   * if (atrule.name === 'add-link') {
   *   const rule = postcss.rule({ selector: 'a', source: atrule.source ***REMOVED***)
   ...
   * decl.source.start      //=> { line: 10, column: 2 ***REMOVED***
   * decl.source.end        //=> { line: 10, column: 12 ***REMOVED***
   */

  /**
   * @memberof Node#
   * @member {object***REMOVED*** raws Information to generate byte-to-byte equal
...
var _default = Node;
/**
 * @typedef {object***REMOVED*** position
 * @property {number***REMOVED*** line   Source line in file.
 * @property {number***REMOVED*** column Source column in file.
 */

/**
 * @typedef {object***REMOVED*** source
 * @property {Input***REMOVED*** input    {@link Input***REMOVED*** with input file
 * @property {position***REMOVED*** start The starting position of the node’s source.
 * @property {position***REMOVED*** end   The ending position of the node’s source.
 */
