...
```js
console.log(c.yellow(`foo ${c.red.bold('red')***REMOVED*** bar ${c.cyan('cyan')***REMOVED*** baz`));
```
...
```js
const { bold, red ***REMOVED*** = require('ansi-styles');
console.log(bold(`foo ${red.dim('bar')***REMOVED*** baz`));

const colorette = require('colorette');
console.log(colorette.bold(`foo ${colorette.red(colorette.dim('bar'))***REMOVED*** baz`));

const kleur = require('kleur');
console.log(kleur.bold(`foo ${kleur.red.dim('bar')***REMOVED*** baz`));

const chalk = require('chalk');
console.log(chalk.bold(`foo ${chalk.red.dim('bar')***REMOVED*** baz`));
```
