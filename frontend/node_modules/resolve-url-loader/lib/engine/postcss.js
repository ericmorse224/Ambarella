 ...
 *
 * @param {string***REMOVED*** sourceFile The absolute path of the file being processed
 * @param {string***REMOVED*** sourceContent CSS content without source-map
 * @param {{outputSourceMap: boolean, transformDeclaration:function, absSourceMap:object,
 *        sourceMapConsumer:object, removeCR:boolean***REMOVED******REMOVED*** params Named parameters
 * @return {{content: string, map: object***REMOVED******REMOVED*** Reworked CSS and optional source-map
 */
function process(sourceFile, sourceContent, params) {
    ...
    ***REMOVED***;
    ...
    function eachDeclaration(declaration) {
      ...
      ***REMOVED***
       ...
       *
       * @param {number***REMOVED*** index Index in the declaration value at which to evaluate
       * @throws Error on invalid source map
       * @returns {{subString:string, value:string, property:string, selector:string***REMOVED******REMOVED*** Hash of base path strings
       */
  ...
  ***REMOVED***
   ...
   *
   * @param startPosApparent {{line: number, column: number***REMOVED******REMOVED***
   * @returns {false|string***REMOVED*** Directory of original file or false on invalid
   */
