...
import { AsyncSeriesBailHook, AsyncSeriesHook, SyncHook ***REMOVED*** from "tapable";
import { URL as URL_Import ***REMOVED*** from "url";
...
***REMOVED***
type JsonObject = { [index: string]: JsonValue ***REMOVED*** & {
	[index: string]:
		| undefined
		| null
		| string
...
declare interface LStatSync {
	...
	(path: PathLike, options?: StatSyncOptions & { bigint?: false ***REMOVED***): IStats;
 ...
 */
declare interface URL_url extends URL_Import {***REMOVED***
