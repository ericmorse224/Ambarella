...
normalizeUrl('//sindresorhus.com:80/', {normalizeProtocol: false***REMOVED***);
//=> '//sindresorhus.com'
```
...
normalizeUrl('https://sindresorhus.com:80/', {forceHttp: true***REMOVED***);
//=> 'http://sindresorhus.com'
```
...
normalizeUrl('http://sindresorhus.com:80/', {forceHttps: true***REMOVED***);
//=> 'https://sindresorhus.com'
```
...
normalizeUrl('user:password@sindresorhus.com', {stripAuthentication: false***REMOVED***);
...
normalizeUrl('sindresorhus.com/about.html#contact', {stripHash: true***REMOVED***);
...
normalizeUrl('https://sindresorhus.com', {stripProtocol: true***REMOVED***);
//=> 'sindresorhus.com'
```
...
normalizeUrl('http://sindresorhus.com/about.html#:~:text=hello', {stripTextFragment: false***REMOVED***);
//=> 'http://sindresorhus.com/about.html#:~:text=hello'

normalizeUrl('http://sindresorhus.com/about.html#section:~:text=hello', {stripTextFragment: false***REMOVED***);
...
normalizeUrl('http://www.sindresorhus.com', {stripWWW: false***REMOVED***);
...
normalizeUrl('http://sindresorhus.com/redirect/', {removeTrailingSlash: false***REMOVED***);
//=> 'http://sindresorhus.com/redirect/'

normalizeUrl('http://sindresorhus.com/', {removeTrailingSlash: false***REMOVED***);
//=> 'http://sindresorhus.com'
```
...
normalizeUrl('https://sindresorhus.com/', {removeSingleSlash: false***REMOVED***);
//=> 'https://sindresorhus.com/'
```
