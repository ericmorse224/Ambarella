...
module.exports = {
	meta: {
		...
		defaultOptions: [{ builtinGlobals: true ***REMOVED***],
		...
		***REMOVED***,
		...
		messages: {
			...
			redeclaredAsBuiltin:
				"'{{id***REMOVED******REMOVED***' is already defined as a built-in global variable.",
			redeclaredBySyntax:
				"'{{id***REMOVED******REMOVED***' is already defined by a variable declaration.",
		***REMOVED***,
	...
	***REMOVED***,
	...
	create(context) {
		const [{ builtinGlobals ***REMOVED***] = context.options;
