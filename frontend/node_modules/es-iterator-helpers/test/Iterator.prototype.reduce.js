...
module.exports = {
	tests: function (reduce, name, t) {
		t['throws'](
			function () { return new reduce(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			t['throws'](
				function () { iterate(reduce(nonIterator, function () {***REMOVED***)); ***REMOVED***,
				TypeError,
			...
			t['throws'](
				function () { iterate(reduce(badNext, function () {***REMOVED***)); ***REMOVED***,
				TypeError,
		...
		***REMOVED***);
		...
		forEach(v.nonFunctions, function (nonFunction) {
			t['throws'](
				function () { reduce({ next: function () {***REMOVED*** ***REMOVED***, nonFunction); ***REMOVED***,
				TypeError,
		...
		***REMOVED***);
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			...
			st['throws'](
				function () { return new reduce(iterator()); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);
			st['throws'](
				function () { return new reduce(iterator(), function () {***REMOVED***); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);
			...
			var ret = reduce(
				...
				function (acc, x, i) {
					...
					results.push({ acc: acc, value: x, count: i, 'this': this, args: arguments.length ***REMOVED***);
					return acc + x;
				***REMOVED***
			);
			...
			st.deepEqual(
				results,
				[
					{ acc: 1, value: 2, count: 1, 'this': undefined, args: 3 ***REMOVED***,
					{ acc: 3, value: 3, count: 2, 'this': undefined, args: 3 ***REMOVED***
				],
			...
			var ret2 = reduce(
				...
				function (acc, x, i) {
					// eslint-disable-next-line no-invalid-this
					results2.push({ acc: acc, value: x, count: i, 'this': this, args: arguments.length ***REMOVED***);
					return acc + x;
				***REMOVED***,
				10
			);
			...
			st.deepEqual(
				results2,
				[
					{ acc: 10, value: 1, count: 0, 'this': undefined, args: 3 ***REMOVED***,
					{ acc: 11, value: 2, count: 1, 'this': undefined, args: 3 ***REMOVED***,
					{ acc: 13, value: 3, count: 2, 'this': undefined, args: 3 ***REMOVED***
				],
