...
class ScriptTransformer {
  ...
  ***REMOVED***
  ...
  _getCacheKey(fileData, filename, options) {
    ...
    const {transformer, transformerConfig = {***REMOVED******REMOVED*** =
      this._getTransformer(filename) || {***REMOVED***;
  ...
  ***REMOVED***
  ...
  _getTransformer(filename) {
    ...
    ***REMOVED***
    ...
    throw new Error(
      `Jest was unable to load the transformer defined for ${filename***REMOVED***. This is a bug in Jest, please open up an issue`
    );
  ***REMOVED***
  ...
  _buildTransformResult(
    ...
    ***REMOVED***;
    ...
    if (transformer && shouldCallTransform) {
      ...
      ***REMOVED*** else if (processed != null && typeof processed.code === 'string') {
    ...
    ***REMOVED***
    ...
    if (!transformed.map) {
      ...
      ***REMOVED***
    ***REMOVED*** // That means that the transform has a custom instrumentation
  ...
  ***REMOVED***
  ...
  async _transformAndBuildScriptAsync(
    ...
    const {isInternalModule***REMOVED*** = options;
    let fileContent =
  ...
  ***REMOVED***
  ...
  transformJson(filename, options, fileSource) {
    ...
    if (willTransform) {
      const {code: transformedJsonSource***REMOVED*** = this.transformSource(
        filename,
        fileSource,
        {...options, instrument: false***REMOVED***
      );
  ...
  ***REMOVED***
  ...
  async requireAndTranspileModule(
    ...
    ***REMOVED***
    ...
    const {applyInteropRequireDefault, ...transformOptions***REMOVED*** = options;
    const revertHook = (0, _pirates().addHook)(
      ...
      ***REMOVED***,
      {
        exts: this._config.moduleFileExtensions.map(ext => `.${ext***REMOVED***`),
  ...
  ***REMOVED***
***REMOVED*** // TODO: do we need to define the generics twice?
