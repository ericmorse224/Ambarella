...
serialize({
    ...
    set  : new Set([123, 456]),
    fn   : function echo(arg) { return arg; ***REMOVED***,
    re   : /([^\s]+)/g,
    big  : BigInt(10),
...
```js
'{"str":"string","num":0,"obj":{"foo":"foo"***REMOVED***,"arr":[1,2,3],"bool":true,"nil":null,"undef":undefined,"inf":Infinity,"date":new Date("2016-04-28T22:02:17.000Z"),"map":new Map([["hello","world"]]),"set":new Set([123,456]),"fn":function echo(arg) { return arg; ***REMOVED***,"re":new RegExp("([^\\\\s]+)", "g"),"big":BigInt("10"),"url":new URL("https://example.com/")***REMOVED***'
```
...
```js
serialize(obj, {isJSON: true***REMOVED***);
```
...
```js
serialize(obj, {unsafe: true***REMOVED***);
```
...
```js
serialize(obj, {ignoreFunction: true***REMOVED***);
```
