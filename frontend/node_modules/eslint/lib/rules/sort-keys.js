 ...
 * @returns {string|null***REMOVED*** The property name or null.
 * @private
 */
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			sortKeys:
				"Expected object keys to be in {{natural***REMOVED******REMOVED***{{insensitive***REMOVED******REMOVED***{{order***REMOVED******REMOVED***ending order. '{{thisName***REMOVED******REMOVED***' should be before '{{prevName***REMOVED******REMOVED***'.",
		***REMOVED***,
	***REMOVED***,
