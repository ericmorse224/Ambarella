...
assert(!isWeakRef(function () {***REMOVED***));
assert(!isWeakRef(null));
assert(!isWeakRef(function* () { yield 42; return Infinity; ***REMOVED***);
...
assert(isWeakRef(new WeakRef({***REMOVED***)));

class MyWeakRef extends WeakRef {***REMOVED***
assert(isWeakRef(new MyWeakRef({***REMOVED***)));
```
