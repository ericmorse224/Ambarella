...
function restructure(tokens, context) {
  ...
  var movableTokens = {***REMOVED***;
  var movedProperties = [];
  var multiPropertyMoveCache = {***REMOVED***;
  ...
  ***REMOVED***
  ...
  function shortenIfPossible(position, movedProperty) {
    ...
    if (mergeableTokens.length < 2) { return; ***REMOVED***

    var allFits = findAllFits(mergeableTokens, valueSize, 1);
    var bestFit = allFits[0];
    if (bestFit[1] > 0) { return sendToMultiPropertyMoveCache(position, movedProperty, allFits); ***REMOVED***
  ...
  ***REMOVED***
  ...
  function dropPropertiesAt(position, movedProperty) {
    ...
    if (toMove && toMove.length > 1) {
      if (!shortenMultiMovesIfPossible(position, movedProperty)) { shortenIfPossible(position, movedProperty); ***REMOVED***
    ***REMOVED***
  ***REMOVED***
  ...
  function shortenMultiMovesIfPossible(position, movedProperty) {
    ...
    for (var value in movableTokens) {
      ...
      for (j = mergeableTokens.length - 1; j >= 0; j--) {
        if (tokensList.indexOf(mergeableTokens[j]) == -1) { continue movableLoop; ***REMOVED***
      ***REMOVED***

      candidates.push(value);
    ***REMOVED***

    if (candidates.length < 2) { return false; ***REMOVED***
  ...
  ***REMOVED***
  ...
  function processMultiPropertyMove(position, propertiesAndMergableTokens) {
    ...
    ***REMOVED***
    ...
    if (bestFit[1] > 0) { return false; ***REMOVED***
    ...
    ***REMOVED***
    ...
    for (i = properties.length - 1; i >= 0; i--) {
      ...
      if (index > -1 && movedToBeDropped.indexOf(index) == -1) { movedToBeDropped.push(index); ***REMOVED***
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  function boundToAnotherPropertyInCurrrentToken(property, movedProperty, token) {
    ...
    if (propertyName != movedPropertyName) { return false; ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (var i = tokens.length - 1; i >= 0; i--) {
    ...
    if (token[0] == Token.RULE) {
      isRule = true;
    ***REMOVED*** else if (token[0] == Token.NESTED_BLOCK) {
      isRule = false;
    ***REMOVED*** else {
      continue;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    for (j = properties.length - 1; j >= 0; j--) {
      ...
      ***REMOVED***
      ...
      if (!isRule || unmovableInCurrentToken.indexOf(j) > -1) { continue; ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (; position < tokens.length - 1; position++) {
    ...
    if (!(isImportRule || isComment)) { break; ***REMOVED***
  ***REMOVED***
