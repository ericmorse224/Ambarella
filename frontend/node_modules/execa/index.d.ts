...
import {Stream, Readable as ReadableStream***REMOVED*** from 'stream';
...
declare const execa: {
	...
	(async () => {
		const {stdout***REMOVED*** = await execa('echo', ['unicorns']);
		console.log(stdout);
		//=> 'unicorns'
	...
	*/
	...
	(async () => {
		const {stdout***REMOVED*** = await execa.command('echo unicorns');
		console.log(stdout);
		//=> 'unicorns'
	***REMOVED***)();
	```
