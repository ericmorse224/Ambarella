 ...
 * @typedef {import('../lib/types').PathDataItem***REMOVED*** PathDataItem
 */

const { parsePathData, stringifyPathData ***REMOVED*** = require('../lib/path.js');
 ...
 *
 * @type {(path: XastElement) => Array<PathDataItem>***REMOVED***
 */
const path2js = (path) => {
  // @ts-ignore legacy
  if (path.pathJS) return path.pathJS;
  /**
   * @type {Array<PathDataItem>***REMOVED***
   */
  const pathData = []; // JS representation of the path data
  const newPathData = parsePathData(path.attributes.d);
  for (const { command, args ***REMOVED*** of newPathData) {
    pathData.push({ command, args ***REMOVED***);
  ***REMOVED***
 ...
 *
 * @type {(data: Array<PathDataItem>) => Array<PathDataItem>***REMOVED***
 *
 */
const convertRelativeToAbsolute = (data) => {
  ...
  for (let { command, args ***REMOVED*** of data) {
    args = args.slice();
    ...
    ***REMOVED***
    ...
    newData.push({ command, args ***REMOVED***);
  ***REMOVED***
  return newData;
***REMOVED***;

/**
 * @typedef {{ floatPrecision?: number, noSpaceAfterFlags?: boolean ***REMOVED******REMOVED*** Js2PathParams
 */

/**
 * Convert path array to string.
 *
 * @type {(path: XastElement, data: Array<PathDataItem>, params: Js2PathParams) => void***REMOVED***
 */
...
/**
 * @type {(dest: Array<number>, source: Array<number>) => Array<number>***REMOVED***
 */
 ...
 *
 * @type {(path1: Array<PathDataItem>, path2: Array<PathDataItem>) => boolean***REMOVED***
 */
exports.intersects = function (path1, path2) {
  ...
  ***REMOVED***);
  ...
  /**
   * @type {(a: Point, b: Point, direction: Array<number>) => Array<number>***REMOVED***
   */
  ...
  ***REMOVED***
  ...
  /**
   * @type {(polygon: Point, direction: Array<number>) => Array<number>***REMOVED***
   */
...
/**
 * @type {(simplex: Array<Array<number>>, direction: Array<number>) => boolean***REMOVED***
 */
...
/**
 * @type {(v: Array<number>) => Array<number>***REMOVED***
 */
function minus(v) {
  return [-v[0], -v[1]];
***REMOVED***
...
/**
 * @type {(v1: Array<number>, v2: Array<number>) => Array<number>***REMOVED***
 */
function sub(v1, v2) {
...
/**
 * @type {(v1: Array<number>, v2: Array<number>) => number***REMOVED***
 */
function dot(v1, v2) {
  return v1[0] * v2[0] + v1[1] * v2[1];
***REMOVED***
...
/**
 * @type {(pathData: Array<PathDataItem>) => Points***REMOVED***
 */
function gatherPoints(pathData) {
  /**
   * @type {Points***REMOVED***
   */
  const points = { list: [], minX: 0, minY: 0, maxX: 0, maxY: 0 ***REMOVED***;

  // Writes data about the extreme points on each axle
  /**
   * @type {(path: Point, point: Array<number>) => void***REMOVED***
   */
  ...
  for (let i = 0; i < pathData.length; i += 1) {
    ...
    let subPath =
      points.list.length === 0
        ? { list: [], minX: 0, minY: 0, maxX: 0, maxY: 0 ***REMOVED***
    ...
    /**
     * @type {(n: number, i: number) => number***REMOVED***
     * TODO fix null hack
     */
    ...
    switch (pathDataItem.command) {
      case 'M':
        subPath = { list: [], minX: 0, minY: 0, maxX: 0, maxY: 0 ***REMOVED***;
 ...
 *
 * @type {(points: Point) => Point***REMOVED***
 */
...
/**
 * @type {(o: Array<number>, a: Array<number>, b: Array<number>) => number***REMOVED***
 */
...
const a2c = (
  ...
  /**
   * @type {Array<number>***REMOVED***
   */
  let res = [];
  /**
   * @type {(x: number, y: number, rad: number) => number***REMOVED***
   */
