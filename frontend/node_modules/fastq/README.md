...
const that = { hello: 'world' ***REMOVED***
...
import type { queue, done ***REMOVED*** from "fastq";
...
import * as fastq from "fastq";
import type { queueAsPromised ***REMOVED*** from "fastq";
...
q.push({ id: 42***REMOVED***).catch((err) => console.error(err))
