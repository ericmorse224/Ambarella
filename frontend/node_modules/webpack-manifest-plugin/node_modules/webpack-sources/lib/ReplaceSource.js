...
const { getSourceAndMap, getMap, getNode, getListMap ***REMOVED*** = require("./helpers");
	...
	***REMOVED***
	...
	updateHash(hash) {
		...
		for (const repl of this._replacements) {
			hash.update(`${repl.start***REMOVED***`);
			hash.update(`${repl.end***REMOVED***`);
			hash.update(`${repl.content***REMOVED***`);
			hash.update(`${repl.insertIndex***REMOVED***`);
			hash.update(`${repl.name***REMOVED***`);
		***REMOVED***
	***REMOVED***
***REMOVED***
...
class ReplacementEnumerator {
	/**
	 * @param {Replacement[]***REMOVED*** replacements list of replacements
	 */
