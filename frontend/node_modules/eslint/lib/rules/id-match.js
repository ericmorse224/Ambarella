...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            notMatch: "Identifier '{{name***REMOVED******REMOVED***' does not match the pattern '{{pattern***REMOVED******REMOVED***'."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** effectiveParent The effective parent node of the node to be reported
         * @param {string***REMOVED*** name The identifier name of the identifier node
         * @returns {boolean***REMOVED*** whether an error should be reported or not
         */
        ...
        return {
            ...
            Identifier(node) {
                ...
                if (parent.type === "MemberExpression") {
                    ...
                    ***REMOVED*** else if (effectiveParent.type === "AssignmentExpression" && effectiveParent.right.type !== "MemberExpression") {
                        if (isInvalid(name)) {
                            report(node);
                        ***REMOVED***
                    ***REMOVED***
                 ...
                 */
                ***REMOVED*** else if (parent.type === "Property" || parent.type === "AssignmentPattern") {
                ...
                ***REMOVED*** else if (IMPORT_TYPES.has(parent.type)) {
                ...
                ***REMOVED*** else if (shouldReport(effectiveParent, name)) {
                    report(node);
                ***REMOVED***
            ***REMOVED***
