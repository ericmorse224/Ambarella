import type { SpanningCellConfig ***REMOVED*** from './types/api';
import type { BaseConfig, CellCoordinates, RangeCoordinate ***REMOVED*** from './types/internal';
...
export declare const isCellInRange: (cell: CellCoordinates, { topLeft, bottomRight ***REMOVED***: RangeCoordinate) => boolean;
