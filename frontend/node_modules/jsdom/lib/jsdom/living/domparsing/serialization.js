...
function htmlSerialization(node) {
  ...
  ***REMOVED***
  ...
  return parse5.serialize(node, { treeAdapter ***REMOVED***);
***REMOVED***

module.exports.fragmentSerialization = (node, { requireWellFormed, globalObject ***REMOVED***) => {
