...
module.exports = {
		...
		schema: [
			{
				type: "object",
				properties: {
					ignoreDestructuring: { type: "boolean" ***REMOVED***,
					ignoreImport: { type: "boolean" ***REMOVED***,
					ignoreExport: { type: "boolean" ***REMOVED***,
				***REMOVED***,
	...
	***REMOVED***,
	...
	create(context) {
		...
		const [{ ignoreDestructuring, ignoreImport, ignoreExport ***REMOVED***] =
			context.options;
