...
import type { GlobOptions, GlobOptionsWithFileTypesFalse, GlobOptionsWithFileTypesTrue, GlobOptionsWithFileTypesUnset ***REMOVED*** from './glob.js';
import { Glob ***REMOVED*** from './glob.js';
export { escape, unescape ***REMOVED*** from 'minimatch';
export type { FSOption, Path, WalkOptions, WalkOptionsWithFileTypesTrue, WalkOptionsWithFileTypesUnset, ***REMOVED*** from 'path-scurry';
export { Glob ***REMOVED*** from './glob.js';
export type { GlobOptions, GlobOptionsWithFileTypesFalse, GlobOptionsWithFileTypesTrue, GlobOptionsWithFileTypesUnset, ***REMOVED*** from './glob.js';
...
export declare const glob: typeof glob_ & {
    ...
    ***REMOVED***;
    ...
    escape: (s: string, { windowsPathsNoEscape, ***REMOVED***?: Pick<import("minimatch").MinimatchOptions, "windowsPathsNoEscape">) => string;
    unescape: (s: string, { windowsPathsNoEscape, ***REMOVED***?: Pick<import("minimatch").MinimatchOptions, "windowsPathsNoEscape">) => string;
***REMOVED***;
