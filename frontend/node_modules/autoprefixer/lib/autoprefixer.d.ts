import { Plugin ***REMOVED*** from 'postcss'
import { Stats ***REMOVED*** from 'browserslist'
...
declare namespace autoprefixer {
  ...
  ***REMOVED***
  ...
  interface ExportedAPI {
    /** Autoprefixer data */
    data: {
      browsers: { [browser: string]: object | undefined ***REMOVED***
      prefixes: { [prefixName: string]: object | undefined ***REMOVED***
    ***REMOVED***
    ...
    info(options?: { from?: string ***REMOVED***): string
