 ...
 * @param {string***REMOVED*** prop property name to analyze
 * @returns {string***REMOVED*** valid JS property name
 */
...
module.exports = { SAFE_IDENTIFIER, RESERVED_IDENTIFIER, propertyName ***REMOVED***;
