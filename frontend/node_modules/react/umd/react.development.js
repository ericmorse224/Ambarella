...
***REMOVED***(this, (function (exports) { 'use strict';
  ...
  function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED*** else if (type === 'object') {
        ...
        throw new Error("Objects are not valid as a React child (found: " + (childrenString === '[object Object]' ? 'object with keys {' + Object.keys(children).join(', ') + '***REMOVED***' : childrenString) + "). " + 'If you meant to render a collection of children, use an array ' + 'instead.');
      ***REMOVED***
    ***REMOVED***
    ...
    while (index < halfLength) {
      ...
      if (compare(left, node) < 0) {
        ...
        ***REMOVED*** else {
          ...
          index = leftIndex;
        ***REMOVED***
      ***REMOVED*** else if (rightIndex < length && compare(right, node) < 0) {
        heap[index] = right;
        heap[rightIndex] = node;
        index = rightIndex;
      ***REMOVED*** else {
  ...
  ***REMOVED***;
  ...
  if (typeof localSetImmediate === 'function') {
    ...
    ***REMOVED***;
  ***REMOVED*** else if (typeof MessageChannel !== 'undefined') {
