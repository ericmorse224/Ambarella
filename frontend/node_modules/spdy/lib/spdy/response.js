...
exports.writeHead = function writeHead (statusCode, reason, obj) {
  ...
  ***REMOVED***
  ...
  if (this.socket._handle) { this.socket._handle._spdyState.stream.respond(this.statusCode, headers) ***REMOVED***
***REMOVED***
...
exports.writeContinue = function writeContinue (callback) {
  if (this.socket._handle) {
    this.socket._handle._spdyState.stream.respond(100, {***REMOVED***, callback)
  ***REMOVED***
***REMOVED***
