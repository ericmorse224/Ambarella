...
declare module "timers/promises" {
    ...
    interface Scheduler {
         ...
         *
         * ```js
         * import { scheduler ***REMOVED*** from 'node:timers/promises';
         *
         ...
         * promise.
         */
        wait(delay: number, options?: { signal?: AbortSignal ***REMOVED***): Promise<void>;
        /**
         * An experimental API defined by the [Scheduling APIs](https://github.com/WICG/scheduling-apis) draft specification
         * being developed as a standard Web Platform API.
         *
