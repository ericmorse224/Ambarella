    ...
    ***REMOVED***,
    ...
    create(context) {
        ...
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** if the node is inside an ObjectPattern
         * @private
         */
        ...
        ***REMOVED***
         ...
         *
         * For examples:
         *    ({a: b.foo***REMOVED*** = c);  // => true for `foo`
         *    ([a.foo] = b);     // => true for `foo`
         *    ([a.foo = 1] = b); // => true for `foo`
         *    ({...a.foo***REMOVED*** = b);  // => true for `foo`
         * @param {ASTNode***REMOVED*** node An Identifier node to check
         * @returns {boolean***REMOVED*** True if the node is an assignment target property in destructuring.
         */
        ...
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** `true` if the node is a reference to a global variable.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node `Identifier` node to check.
         * @returns {boolean***REMOVED*** `true` if the node is a property name of an object literal expression
         */
        ...
        ***REMOVED***
        ...
        function report(node) {
            if (!reported.includes(node)) {
                reported.push(node);
                context.report({ node, messageId: "notCamelCase", data: { name: node.name ***REMOVED*** ***REMOVED***);
            ***REMOVED***
        ***REMOVED***
            ...
            Identifier(node) {
                ...
                ***REMOVED***
                ...
                if (node.parent.type === "MemberExpression") {
                    ...
                    ***REMOVED*** else if (effectiveParent.type === "AssignmentExpression" && nameIsUnderscored && (effectiveParent.right.type !== "MemberExpression" || effectiveParent.left.type === "MemberExpression" && effectiveParent.left.property.name === node.name)) {
                        report(node);

                    ***REMOVED*** else if (isAssignmentTargetPropertyInDestructuring(node) && nameIsUnderscored) {
                        report(node);
                    ***REMOVED***
                 ...
                 * e.g.: const { no_camelcased = false ***REMOVED*** = bar;
                 */
                ***REMOVED*** else if (node.parent.type === "Property" || node.parent.type === "AssignmentPattern") {
                ...
                ***REMOVED*** else if (["ImportSpecifier", "ImportNamespaceSpecifier", "ImportDefaultSpecifier"].includes(node.parent.type)) {
                ...
                ***REMOVED*** else if (nameIsUnderscored && !ALLOWED_PARENT_TYPES.has(effectiveParent.type)) {
                    report(node);
                ***REMOVED***
            ***REMOVED***
