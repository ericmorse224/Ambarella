...
const { SourceMapConsumer ***REMOVED*** = require('source-map');
const pathutils = require('./pathutils');
const { SourceMapTransformer ***REMOVED*** = require('./transformer');
...
class MapStore {
    /**
     * @param {Object***REMOVED*** opts [opts=undefined] options.
     * @param {Boolean***REMOVED*** opts.verbose [opts.verbose=false] verbose mode
     * @param {String***REMOVED*** opts.baseDir [opts.baseDir=null] alternate base directory
     *  to resolve sourcemap files
     * @param {Class***REMOVED*** opts.SourceStore [opts.SourceStore=Map] class to use for
     * SourceStore.  Must support `get`, `set` and `clear` methods.
     * @param {Array***REMOVED*** opts.sourceStoreOpts [opts.sourceStoreOpts=[]] arguments
    ...
    registerURL(transformedFilePath, sourceMapUrl) {
        ...
        if (
            ...
            if (pos > 0) {
                ...
                ***REMOVED***;
            ***REMOVED*** else {
                debug(`Unable to interpret source map URL: ${sourceMapUrl***REMOVED***`);
            ***REMOVED***
        ...
        ***REMOVED***
        ...
        this.data[transformedFilePath] = { type: 'file', data: file ***REMOVED***;
    ***REMOVED***
    ...
    ***REMOVED***
     ...
     * @returns {Object***REMOVED*** a parsed source map object
     */
    ...
    ***REMOVED***
     ...
     * @param {CoverageMap***REMOVED*** coverageMap - the coverage map to transform
     * @returns {Promise<CoverageMap>***REMOVED*** the transformed coverage map
     */
...
module.exports = { MapStore ***REMOVED***;
