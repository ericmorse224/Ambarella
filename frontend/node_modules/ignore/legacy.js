...
var define = function define(object, key, value) {
  return Object.defineProperty(object, key, { value ***REMOVED***);
***REMOVED***;
...
/\[([^\]/]*)($|\])/g, function (match, p1, p2) {
  return p2 === ']' ? `[${sanitizeRange(p1)***REMOVED***]` : `\\${match***REMOVED***`;
***REMOVED***], [
...
function (match) {
  return `${match***REMOVED***(?=$|\\/)`;
***REMOVED***]], DEFAULT_REPLACER_SUFFIX);
...
var IgnoreBase = function () {
  function IgnoreBase() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {***REMOVED***,
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    ...
    // @returns {Boolean***REMOVED*** true if a file is NOT ignored
