...
const {
    ...
    LEAST_UPPER_BOUND
***REMOVED*** = require('source-map').SourceMapConsumer;
 ...
 * @param  {SourceMapConsumer***REMOVED*** sourceMap the source map
 * @param  {Object***REMOVED*** generatedLocation the original location Object
 * @returns {Object***REMOVED*** the remapped location Object
 */
