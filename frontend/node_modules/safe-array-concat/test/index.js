...
test('safe-array-concat', function (t) {
	...
	t.deepEqual(
		...
		safeConcat(/** @type {(string | number | number[])[]***REMOVED*** */ ([1, 2]), [3, 4], 'foo', 5, 6, [[7]]),
		[1, 2, 3, 4, 'foo', 5, 6, [7]],
	...
	***REMOVED***;
	...
	t.test('has Symbol.species', { skip: !species ***REMOVED***, function (st) {
		var speciesArr = [1, 2];
		// @ts-expect-error ts(2740) TS's `constructor` type requires a function
		speciesArr.constructor = {***REMOVED***;
	...
	***REMOVED***);
	...
	t.test('has isConcatSpreadable', { skip: !isConcatSpreadable ***REMOVED***, function (st) {
		// TS can't type narrow from tape's `skip`
		if (isConcatSpreadable) {
			st.teardown(mockProperty(
				// eslint-disable-next-line no-extra-parens
				/** @type {Record<PropertyKey, unknown>***REMOVED*** */ (/** @type {unknown***REMOVED*** */ (String.prototype)),
				isConcatSpreadable,
				{ value: true ***REMOVED***
			));
			...
			st.teardown(mockProperty(Array.prototype, isConcatSpreadable, { value: false ***REMOVED***));
