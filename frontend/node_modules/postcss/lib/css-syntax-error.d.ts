import { FilePosition ***REMOVED*** from './input.js'
...
declare namespace CssSyntaxError {
  ...
  ***REMOVED***
  ...
  export { CssSyntaxError_ as default ***REMOVED***
***REMOVED***
...
declare class CssSyntaxError_ extends Error {
   ...
   * error.input.source //=> 'a b { ***REMOVED***'
   * ```
   */
  source?: string
...
declare class CssSyntaxError extends CssSyntaxError_ {***REMOVED***
