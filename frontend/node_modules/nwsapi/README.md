...
#### `configure( { <configuration-flag>: [ true | false ] ***REMOVED*** )`

Disable logging errors/warnings to console, disallow duplicate ids. Example:

```js
NW.Dom.configure( { LOGERRORS: false, IDS_DUPES: false ***REMOVED*** );
```
...
```js
NW.Dom.registerOperator( '!=', { p1: '^', p2: '$', p3: 'false' ***REMOVED*** );
```
...
NW.Dom.registerSelector('Controls', /^\:(control)(.*)/i,
  (function(global) {
    return function(match, source, mode, callback) {
      var status = true;
      source = 'if(/^(button|input|select|textarea)/i.test(e.nodeName)){' + source + '***REMOVED***';
      return { 'source': source, 'status': status ***REMOVED***;
    ***REMOVED***;
  ***REMOVED***)(this));
```
