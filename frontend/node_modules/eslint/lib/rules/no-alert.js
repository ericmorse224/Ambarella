 ...
 * @returns {boolean***REMOVED*** Whether or not the name is prohibited.
 */
 ...
 * @param {string***REMOVED*** node The identifier node to check
 ...
 * @param {Object***REMOVED*** scope The current scope.
 * @param {string***REMOVED*** node The identifier node to check
 * @returns {boolean***REMOVED*** Whether or not the node is a reference to the global object.
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unexpected: "Unexpected {{name***REMOVED******REMOVED***."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
        return {
            CallExpression(node) {
                ...
                ***REMOVED*** else if (callee.type === "MemberExpression" && isGlobalThisReferenceOrGlobalWindow(currentScope, callee.object)) {
