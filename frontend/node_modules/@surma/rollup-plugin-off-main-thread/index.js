...
const { join ***REMOVED*** = require("path");
...
module.exports = function(opts = {***REMOVED***) {
  opts = Object.assign({***REMOVED***, defaultOpts, opts);
  ...
  let workerFiles;
  let isEsmOutput = () => { throw new Error("outputOptions hasn't been called yet") ***REMOVED***;
  return {
    ...
    ***REMOVED***,
    ...
    async resolveId(id, importer) {
      ...
      if (!resolved)
        throw Error(`Cannot find module '${path***REMOVED***' from '${importer***REMOVED***'`);
    ...
    ***REMOVED***,
    ...
    load(id) {
      ...
      const chunkRef = this.emitFile({ id: realId, type: "chunk" ***REMOVED***);
      return `export default import.meta.ROLLUP_FILE_URL_${chunkRef***REMOVED***;`;
    ***REMOVED***,
    ...
    async transform(code, id) {
      ...
      for (const match of matchAll(code, workerRegexpForTransform)) {
        ...
        ***REMOVED*** else {
          ...
          if (directWorkerFile) {
            const fullMatchWithOpts = `${fullMatch***REMOVED***, …)`;
            const fullReplacement = `new Worker(new URL(${directWorkerFile***REMOVED***, import.meta.url), …)`;

            if (!longWarningAlreadyShown) {
              this.warn(
                `rollup-plugin-off-main-thread:
\`${fullMatchWithOpts***REMOVED***\` suggests that the Worker should be relative to the document, not the script.
...
This will become a hard error in the future.`,
            ...
            ***REMOVED*** else {
              this.warn(
                `rollup-plugin-off-main-thread: Treating \`${fullMatchWithOpts***REMOVED***\` as \`${fullReplacement***REMOVED***\``,
                matchIndex
              );
            ***REMOVED***
          ...
          ***REMOVED***
          ...
          if (!/^\.{1,2***REMOVED***\//.test(workerFile)) {
            let isError = false;
            if (directWorkerFile) {
            ...
            ***REMOVED*** else {
              ...
              ***REMOVED*** else {
                ...
                workerFile = `./${workerFile***REMOVED***`;
              ***REMOVED***
            ***REMOVED***
            if (isError) {
              this.warn(
                `Paths passed to the Worker constructor must be relative to the current file, i.e. start with ./ or ../ (just like dynamic import!). Ignoring "${workerFile***REMOVED***".`,
                matchIndex
              );
              continue;
            ***REMOVED***
          ...
          (async () => {
            ...
            ***REMOVED***);
            ...
            ms.overwrite(
              ...
              `new URL(import.meta.ROLLUP_FILE_URL_${chunkRefId***REMOVED***, import.meta.url)`
            );
          ***REMOVED***)()
        );
      ***REMOVED***
      ...
      ***REMOVED***
      ...
      return {
        code: ms.toString(),
        map: ms.generateMap({ hires: true ***REMOVED***)
      ***REMOVED***;
    ***REMOVED***,
    ...
    outputOptions({ format ***REMOVED***) {
      if (format === "esm" || format === "es") {
        ...
        ***REMOVED***
        ...
        isEsmOutput = () => true;
      ***REMOVED*** else if (format !== "amd") {
        this.error(
          `\`output.format\` must either be "amd" or "esm", got "${format***REMOVED***"`
        );
      ***REMOVED*** else {
        isEsmOutput = () => false;
      ***REMOVED***
    ...
    renderChunk(code, chunk, outputOptions) {
      ...
      ***REMOVED***
      ...
      for (const match of matchAll(code, workerRegexpForOutput)) {
        ...
        ***REMOVED***
        ...
        optionsWithCommaStr = optionsStr === "{***REMOVED***" ? "" : `, ${optionsStr***REMOVED***`;
        ms.overwrite(
          replacementStart,
          replacementEnd,
          optionsWithCommaStr
      ...
      ***REMOVED***
      ...
      if (!code.startsWith("define([")) {
        ms.prepend("[],");
      ***REMOVED***
      ms.prepend(`${opts.amdFunctionName***REMOVED***(`);
      ...
      ***REMOVED***
      ...
      return {
        ...
        map: hasCodeChanged ? ms.generateMap({ hires: true ***REMOVED***) : null
      ***REMOVED***;
    ***REMOVED***
  ***REMOVED***;
***REMOVED***;
