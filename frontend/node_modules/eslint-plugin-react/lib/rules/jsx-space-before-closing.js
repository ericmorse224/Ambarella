    ...
    return {
      JSXOpeningElement(node) {
        ...
        ***REMOVED***
        ...
        const closingSlash = /** @type {import('eslint').AST.Token***REMOVED*** */ (sourceCode.getTokenAfter(leftToken));
        ...
        ***REMOVED***
        ...
        if (configuration === 'always' && !sourceCode.isSpaceBetweenTokens(leftToken, closingSlash)) {
          report(context, messages.needSpaceBeforeClose, 'needSpaceBeforeClose', {
            ...
            ***REMOVED***,
          ***REMOVED***);
        ***REMOVED*** else if (configuration === 'never' && sourceCode.isSpaceBetweenTokens(leftToken, closingSlash)) {
