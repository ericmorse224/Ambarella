"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj ***REMOVED***; ***REMOVED***var _types = require('../parser/tokenizer/types');
...
***REMOVED*** exports.default = getTSImportedNames;
  ...
  while (true) {
    ...
    ***REMOVED***
    ...
    if (tokens.matches2AtIndex(index, _types.TokenType.comma, _types.TokenType.braceR)) {
      return;
    ***REMOVED*** else if (tokens.matches1AtIndex(index, _types.TokenType.braceR)) {
      return;
    ***REMOVED*** else if (tokens.matches1AtIndex(index, _types.TokenType.comma)) {
      index++;
    ***REMOVED*** else {
      throw new Error(`Unexpected token: ${JSON.stringify(tokens.tokens[index])***REMOVED***`);
    ***REMOVED***
  ***REMOVED***
***REMOVED***
