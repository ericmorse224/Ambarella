...
test('getSideChannelMap', { skip: typeof WeakMap !== 'function' && typeof Map !== 'function' ***REMOVED***, function (t) {
	...
	***REMOVED***);
	...
	t.test('assert', function (st) {
		var channel = getSideChannel();
		st['throws'](
			function () { channel.assert({***REMOVED***); ***REMOVED***,
			TypeError,
		...
		var o = {***REMOVED***;
		channel.set(o, 'data');
		st.doesNotThrow(function () { channel.assert(o); ***REMOVED***, 'existent value noops');
	...
	***REMOVED***);
	...
	t.test('delete', function (st) {
		var channel = getSideChannel();
		var o = {***REMOVED***;
		st.equal(channel['delete']({***REMOVED***), false, 'nonexistent value yields false');

		channel.set(o, 42);
		st.equal(channel.has(o), true, 'value is set');

		st.equal(channel['delete']({***REMOVED***), false, 'nonexistent value still yields false');
...
test('getSideChannelMap, no WeakMaps and/or Maps', { skip: typeof WeakMap === 'function' || typeof Map === 'function' ***REMOVED***, function (t) {
