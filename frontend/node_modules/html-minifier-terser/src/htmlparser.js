    ...
    ***REMOVED***
    ...
    async function handleStartTag(match) {
      ...
      if (handler.html5) {
        ...
        ***REMOVED***
        if (tagName === 'col' && findTag('colgroup') < 0) {
          lastTag = 'colgroup';
          stack.push({ tag: lastTag, attrs: [] ***REMOVED***);
          if (handler.start) {
      ...
      ***REMOVED***
      ...
      var attrs = match.attrs.map(function(args) {
        ...
        if (IS_REGEX_CAPTURING_BROKEN && args[0].indexOf('""') === -1) {
          if (args[3] === '') { delete args[3]; ***REMOVED***
          if (args[4] === '') { delete args[4]; ***REMOVED***
          if (args[5] === '') { delete args[5]; ***REMOVED***
        ***REMOVED***
      ...
      ***REMOVED***);
      ...
      if (!unary) {
        stack.push({ tag: tagName, attrs: attrs ***REMOVED***);
        lastTag = tagName;
        unarySlash = '';
      ***REMOVED***
