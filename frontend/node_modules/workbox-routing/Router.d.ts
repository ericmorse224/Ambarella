import { RouteHandler, RouteHandlerCallbackOptions, RouteMatchCallbackOptions ***REMOVED*** from 'workbox-core/types.js';
...
declare class Router {
    ...
    ***REMOVED***): Promise<Response> | undefined;
     ...
     *     otherwise.
     */
    findMatchingRoute({ url, sameOrigin, request, event, ***REMOVED***: RouteMatchCallbackOptions): {
        route?: Route;
