...
var foo = Object(function foo() {***REMOVED***);
var anon = Object(function () {***REMOVED***);
...
module.exports = function (getName, t) {
	...
	***REMOVED***);
	...
	t.test('arrow functions', { skip: arrows.length === 0 ***REMOVED***, function (st) {
	...
	***REMOVED***);
	...
	t.test('generators', { skip: generators.length === 0 ***REMOVED***, function (st) {
	...
	***REMOVED***);
	...
	t.test('asyncs', { skip: asyncs.length === 0 ***REMOVED***, function (st) {
	...
	***REMOVED***);
	...
	t.test('Function.prototype.name', function (st) {
		st.equal(getName(function before() {***REMOVED***), 'before', 'function prior to accessing Function.prototype has the right name');
		...
		st.equal(getName(function after() {***REMOVED***), 'after', 'function after accessing Function.prototype has the right name');
	...
	***REMOVED***);
	...
	t.test('DOM', function (st) {
		...
		st.test('document.all', { skip: typeof document !== 'object' ***REMOVED***, function (s2t) {
			s2t['throws'](
				function () { getName(document.all); ***REMOVED***,
				TypeError,
		...
		***REMOVED***);
		...
		forEach([
			...
			st.test(name, { skip: !constructor ***REMOVED***, function (s2t) {
				...
				***REMOVED*** else {
					s2t['throws'](
						function () { getName(constructor); ***REMOVED***,
						TypeError,
