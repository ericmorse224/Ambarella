...
const { findVariable ***REMOVED*** = require("@eslint-community/eslint-utils");
 ...
 * @returns {boolean***REMOVED*** `true` if the node is LHS.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is the operand of mutation unary operator.
 */
function isOperandOfMutationUnaryOperator(node) {
    const argumentNode = node.parent.type === "ChainExpression"
        ? node.parent
        : node;
    const { parent ***REMOVED*** = argumentNode;
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is the iteration variable.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @param {Scope***REMOVED*** scope A `escope.Scope` object to find variable (whichever).
 * @returns {boolean***REMOVED*** `true` if the node is at the first argument of a well-known mutation function.
 */
 ...
 * @param {ASTNode***REMOVED*** id The Identifier node to check.
 * @param {Scope***REMOVED*** scope A `escope.Scope` object to find variable (whichever).
 * @returns {boolean***REMOVED*** `true` if the member of `id` was updated.
 */
function isMemberWrite(id, scope) {
    const { parent ***REMOVED*** = id;
 ...
 * @param {ASTNode***REMOVED*** id The Identifier node to get.
 * @returns {ASTNode***REMOVED*** The mutation node.
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            readonly: "'{{name***REMOVED******REMOVED***' is read-only.",
            readonlyMember: "The members of '{{name***REMOVED******REMOVED***' are read-only."
        ***REMOVED***
    ***REMOVED***,
                        ...
                        ***REMOVED***
                        ...
                        if (reference.isWrite()) {
                            context.report({
                                ...
                                messageId: "readonly",
                                data: { name: idNode.name ***REMOVED***
                            ***REMOVED***);
                        ***REMOVED*** else if (shouldCheckMembers && isMemberWrite(idNode, scope)) {
                            context.report({
                                node: getWriteNode(idNode),
