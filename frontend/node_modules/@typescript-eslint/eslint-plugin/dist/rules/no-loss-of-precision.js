...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        ...
        schema: [],
        messages: (_a = baseRule === null || baseRule === void 0 ? void 0 : baseRule.meta.messages) !== null && _a !== void 0 ? _a : { noLossOfPrecision: '' ***REMOVED***,
    ***REMOVED***,
    defaultOptions: [],
    create(context) {
        ...
        ***REMOVED***
        return {
            Literal(node) {
                rules.Literal(Object.assign(Object.assign({***REMOVED***, node), { raw: isSeparatedNumeric(node) ? node.raw.replace(/_/g, '') : node.raw ***REMOVED***));
            ***REMOVED***,
        ***REMOVED***;
    ***REMOVED***,
***REMOVED***);
