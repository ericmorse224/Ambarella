...
import { Configuration, DetailedArguments ***REMOVED*** from "yargs-parser";
...
declare namespace yargs {
    ...
    ***REMOVED***;
    ...
    interface Argv<T = {***REMOVED***> {
         ...
         */
        argv:
            | { [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***
            | Promise<{ [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***>;
         ...
         */
        array<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: ToArray<T[key]> ***REMOVED***>;
        array<K extends string>(
            key: K | readonly K[],
        ): Argv<T & { [key in K]: Array<string | number> | undefined ***REMOVED***>;
         ...
         */
        boolean<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: boolean | undefined ***REMOVED***>;
        boolean<K extends string>(key: K | readonly K[]): Argv<T & { [key in K]: boolean | undefined ***REMOVED***>;
         ...
         */
        check(func: (argv: Arguments<T>, aliases: { [alias: string]: string ***REMOVED***) => any, global?: boolean): Argv<T>;
        ...
        choices<K extends keyof T, C extends readonly any[]>(
            key: K,
            values: C,
        ): Argv<Omit<T, K> & { [key in K]: C[number] | undefined ***REMOVED***>;
        choices<K extends string, C extends readonly any[]>(
            key: K,
            values: C,
        ): Argv<T & { [key in K]: C[number] | undefined ***REMOVED***>;
        choices<C extends { [key: string]: readonly any[] ***REMOVED***>(
            choices: C,
        ): Argv<Omit<T, keyof C> & { [key in keyof C]: C[key][number] | undefined ***REMOVED***>;
        ...
        coerce<K extends keyof T, V>(
            key: K | readonly K[],
            func: (arg: any) => V,
        ): Argv<Omit<T, K> & { [key in K]: V | undefined ***REMOVED***>;
        coerce<K extends string, V>(
            key: K | readonly K[],
            func: (arg: any) => V,
        ): Argv<T & { [key in K]: V | undefined ***REMOVED***>;
        coerce<O extends { [key: string]: (arg: any) => any ***REMOVED***>(
            opts: O,
        ): Argv<Omit<T, keyof O> & { [key in keyof O]: ReturnType<O[key]> | undefined ***REMOVED***>;
        ...
        command<O extends { [key: string]: Options ***REMOVED***>(
            command: string | readonly string[],
            description: string,
            builder?: O,
        ...
        conflicts(conflicts: { [key: string]: string | readonly string[] ***REMOVED***): Argv<T>;
         ...
         */
        count<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: number ***REMOVED***>;
        count<K extends string>(key: K | readonly K[]): Argv<T & { [key in K]: number ***REMOVED***>;
         ...
         */
        default<K extends keyof T, V>(key: K, value: V, description?: string): Argv<Omit<T, K> & { [key in K]: V ***REMOVED***>;
        default<K extends string, V>(key: K, value: V, description?: string): Argv<T & { [key in K]: V ***REMOVED***>;
        default<D extends { [key: string]: any ***REMOVED***>(defaults: D, description?: string): Argv<Omit<T, keyof D> & D>;
        ...
        demand<K extends string>(key: K | readonly K[], msg?: string | true): Argv<T & { [key in K]: unknown ***REMOVED***>;
        ...
        demandOption<K extends string>(
            key: K | readonly K[],
            msg?: string | true,
        ): Argv<T & { [key in K]: unknown ***REMOVED***>;
        ...
        describe(descriptions: { [key: string]: string ***REMOVED***): Argv<T>;
        ...
        implies(implies: { [key: string]: string | readonly string[] ***REMOVED***): Argv<T>;
        ...
        nargs(nargs: { [key: string]: number ***REMOVED***): Argv<T>;

        /** The key provided represents a path and should have `path.normalize()` applied. */
        normalize<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: ToString<T[key]> ***REMOVED***>;
        normalize<K extends string>(key: K | readonly K[]): Argv<T & { [key in K]: string | undefined ***REMOVED***>;
         ...
         */
        number<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: ToNumber<T[key]> ***REMOVED***>;
        number<K extends string>(key: K | readonly K[]): Argv<T & { [key in K]: number | undefined ***REMOVED***>;
        ...
        option<K extends keyof T, O extends Options>(
            key: K,
            options: O,
        ): Argv<Omit<T, K> & { [key in K]: InferredOptionType<O> ***REMOVED*** & Alias<O>>;
        option<K extends string, O extends Options>(
            key: K,
            options: O,
        ): Argv<T & { [key in K]: InferredOptionType<O> ***REMOVED*** & Alias<O>>;
        option<O extends { [key: string]: Options ***REMOVED***>(
            options: O,
        ...
        options<K extends keyof T, O extends Options>(
            key: K,
            options: O,
        ): Argv<Omit<T, K> & { [key in K]: InferredOptionType<O> ***REMOVED***>;
        options<K extends string, O extends Options>(
            key: K,
            options: O,
        ): Argv<T & { [key in K]: InferredOptionType<O> ***REMOVED***>;
        options<O extends { [key: string]: Options ***REMOVED***>(options: O): Argv<Omit<T, keyof O> & InferredOptionTypes<O>>;
        ...
        parse(
            ...
            | { [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***
            | Promise<{ [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***>;
        parseSync(): { [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***;
        parseSync(
            arg: string | readonly string[],
            context?: object,
            parseCallback?: ParseCallback<T>,
        ): { [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***;
        parseAsync(): Promise<{ [key in keyof Arguments<T> as key | CamelCaseKey<key>]: Arguments<T>[key] ***REMOVED***>;
        parseAsync(
            arg: string | readonly string[],
            context?: object,
            parseCallback?: ParseCallback<T>,
         ...
         */
        string<K extends keyof T>(key: K | readonly K[]): Argv<Omit<T, K> & { [key in K]: ToString<T[key]> ***REMOVED***>;
        string<K extends string>(key: K | readonly K[]): Argv<T & { [key in K]: string | undefined ***REMOVED***>;

        // Intended to be used with '.wrap()'
        terminalWidth(): number;

        updateLocale(obj: { [key: string]: string ***REMOVED***): Argv<T>;
         ...
         */
        updateStrings(obj: { [key: string]: string ***REMOVED***): Argv<T>;
        ...
        usage<O extends { [key: string]: Options ***REMOVED***>(
            command: string | readonly string[],
            description: string,
            builder?: O,
            handler?: (args: ArgumentsCamelCase<InferredOptionTypes<O>>) => void | Promise<void>,
    ...
    ***REMOVED***;
    ...
    type ArgumentsCamelCase<T = {***REMOVED***> = { [key in keyof T as key | CamelCaseKey<key>]: T[key] ***REMOVED*** & {
        /** Non-option arguments */
        _: Array<string | number>;
        /** The script name or node command */
        $0: string;
    ...
    ***REMOVED***
    ...
    interface Options {
        ...
        conflicts?: string | readonly string[] | { [key: string]: string | readonly string[] ***REMOVED*** | undefined;
        ...
        implies?: string | readonly string[] | { [key: string]: string | readonly string[] ***REMOVED*** | undefined;
    ...
    ***REMOVED***
    ...
    type PascalCase<S extends string> = string extends S ? string
        : S extends `${infer T***REMOVED***-${infer U***REMOVED***` ? `${Capitalize<T>***REMOVED***${PascalCase<U>***REMOVED***`
        : Capitalize<S>;

    /** Convert literal string types like 'foo-bar' to 'fooBar' */
    type CamelCase<S extends string> = string extends S ? string
        : S extends `${infer T***REMOVED***-${infer U***REMOVED***` ? `${T***REMOVED***${PascalCase<U>***REMOVED***`
        : S;
    ...
    /** Remove keys K in T */
    type Omit<T, K> = { [key in Exclude<keyof T, K>]: T[key] ***REMOVED***;

    /** Remove undefined as a possible value for keys K in T */
    type Defined<T, K extends keyof T> = Omit<T, K> & { [key in K]: Exclude<T[key], undefined> ***REMOVED***;
    ...
    type InferredOptionType<O extends Options | PositionalOptions> =
        ...
        O extends ({ coerce: (arg: any) => infer T ***REMOVED***) ? IsRequiredOrHasDefault<O> extends true ? T : T | undefined
            : O extends (
                | { type: "count"; default: infer D ***REMOVED***
                | { count: true; default: infer D ***REMOVED***
            ...
            : O extends ({ default: infer D ***REMOVED***) ? Exclude<D, undefined>
            : unknown;

    type Alias<O extends Options | PositionalOptions> = O extends { alias: infer T ***REMOVED***
        ? T extends Exclude<string, T> ? { [key in T]: InferredOptionType<O> ***REMOVED*** : {***REMOVED***
        : {***REMOVED***;

    // prettier-ignore
    type IsRequiredOrHasDefault<O extends Options | PositionalOptions> = O extends (
        | { required: string | true ***REMOVED***
        | { require: string | true ***REMOVED***
        | { demand: string | true ***REMOVED***
        | { demandOption: string | true ***REMOVED***
    ...
    // prettier-ignore
    type InferredOptionTypePrimitive<O extends Options | PositionalOptions> = O extends { default: infer D ***REMOVED***
    ...
    type InferredOptionTypeInner<O extends Options | PositionalOptions> = O extends
        { type: "array"; choices: ReadonlyArray<infer C> ***REMOVED*** ? C[]
        : O extends { type: "array"; string: true ***REMOVED*** ? string[]
        : O extends { type: "array"; number: true ***REMOVED*** ? number[]
        : O extends { type: "array"; normalize: true ***REMOVED*** ? string[]
        : O extends { array: true; choices: ReadonlyArray<infer C> ***REMOVED*** ? C[]
        : O extends { array: true; type: "string" ***REMOVED*** ? string[]
        : O extends { array: true; type: "number" ***REMOVED*** ? number[]
        : O extends { array: true; string: true ***REMOVED*** ? string[]
        : O extends { array: true; number: true ***REMOVED*** ? number[]
        : O extends { array: true; normalize: true ***REMOVED*** ? string[]
        : O extends { choices: ReadonlyArray<infer C> ***REMOVED*** ? C
        : O extends { type: "array" ***REMOVED*** ? Array<string | number>
        : O extends { type: "boolean" ***REMOVED*** ? boolean
        : O extends { type: "number" ***REMOVED*** ? number
        : O extends { type: "string" ***REMOVED*** ? string
        : O extends { array: true ***REMOVED*** ? Array<string | number>
        : O extends { boolean: true ***REMOVED*** ? boolean
        : O extends { number: true ***REMOVED*** ? number
        : O extends { string: true ***REMOVED*** ? string
        : O extends { normalize: true ***REMOVED*** ? string
        : unknown;

    type InferredOptionTypes<O extends { [key: string]: Options ***REMOVED***> = { [key in keyof O]: InferredOptionType<O[key]> ***REMOVED***;

    interface CommandModule<T = {***REMOVED***, U = {***REMOVED***> {
    ...
    ***REMOVED***
    ...
    type ParseCallback<T = {***REMOVED***> = (
        err: Error | undefined,
        argv: ArgumentsCamelCase<T>,
        output: string,
    ) => void | Promise<void>;
    type CommandBuilder<T = {***REMOVED***, U = {***REMOVED***> =
        | { [key: string]: Options ***REMOVED***
        | ((args: Argv<T>) => Argv<U>)
    ...
    type MiddlewareFunction<T = {***REMOVED***> = (args: ArgumentsCamelCase<T>) => void | Promise<void>;
    ...
    type BuilderArguments<T extends (...args: any) => R, R = ReturnType<T>> = R extends Argv<infer X>
        ...
        : {***REMOVED*** | R extends PromiseLike<Argv<infer X>> ? ArgumentsCamelCase<X>
        : {***REMOVED***;
***REMOVED***
