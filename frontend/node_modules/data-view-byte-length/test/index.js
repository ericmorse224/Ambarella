...
test('dataViewByteLength', function (t) {
	forEach(
		...
		/** @type {[...typeof v.primitives, ...typeof v.objects]***REMOVED*** */ ([].concat(v.primitives, v.objects)),
		function (nonDV) {
			t['throws'](function () { dataViewByteLength(nonDV); ***REMOVED***, TypeError, inspect(nonDV) + ' is not a DataView');
		***REMOVED***
	);

	t.test('DataView', { skip: typeof DataView !== 'function' ***REMOVED***, function (st) {
