...
import type {EventEmitter***REMOVED*** from 'events';
import type {ForkOptions***REMOVED*** from 'child_process';
import type {ResourceLimits***REMOVED*** from 'worker_threads';
...
***REMOVED***
export {Worker_2 as Worker***REMOVED***;
