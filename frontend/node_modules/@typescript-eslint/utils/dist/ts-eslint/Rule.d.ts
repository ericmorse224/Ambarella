import type { JSONSchema4 ***REMOVED*** from '../json-schema';
import type { ParserServices, TSESTree ***REMOVED*** from '../ts-estree';
import type { AST ***REMOVED*** from './AST';
import type { Linter ***REMOVED*** from './Linter';
import type { Scope ***REMOVED*** from './Scope';
import type { SourceCode ***REMOVED*** from './SourceCode';
