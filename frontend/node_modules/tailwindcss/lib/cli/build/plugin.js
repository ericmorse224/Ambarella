 ...
 */ async function loadPostCssPlugins(customPostCssPath) {
    let config = customPostCssPath ? await (async ()=>{
        ...
        // @ts-ignore
        let { config ={***REMOVED***  ***REMOVED*** = await (0, _lilconfig.lilconfig)("postcss").load(file);
...
***REMOVED***
let state = {
    /** @type {any***REMOVED*** */ context: null,
    /** @type {ReturnType<typeof createWatcher> | null***REMOVED*** */ watcher: null,
    /** @type {{content: string, extension: string***REMOVED***[]***REMOVED*** */ changedContent: [],
    /** @type {ReturnType<typeof load> | null***REMOVED*** */ configBag: null,
    contextDependencies: new Set(),
    /** @type {import('../../lib/content.js').ContentPath[]***REMOVED*** */ contentPaths: [],
    refreshContentPaths () {
        var _this_context;
...
async function createProcessor(args, cliConfigPath) {
    ...
    ***REMOVED***
    ...
    let content = (_args_content_split = (_args_content = args["--content"]) === null || _args_content === void 0 ? void 0 : _args_content.split(/(?<!{[^***REMOVED***]+),/)) !== null && _args_content_split !== void 0 ? _args_content_split : [];
    let tailwindPlugin = ()=>{
        return {
            postcssPlugin: "tailwindcss",
            async Once (root, { result  ***REMOVED***) {
                _sharedState.env.DEBUG && console.time("Compiling CSS");
                await (0, _processTailwindFeatures.default)(({ createContext  ***REMOVED***)=>{
                    console.error();
    ...
    ***REMOVED***;
    ...
    /** @type {import('postcss').Processor***REMOVED*** */ // @ts-ignore
