...
import { getContext, getFileModifiedMap ***REMOVED*** from './setupContextUtils'
import parseDependency from '../util/parseDependency'
import { validateConfig ***REMOVED*** from '../util/validateConfig.js'
import { parseCandidateFiles, resolvedChangedContent ***REMOVED*** from './content.js'
import { loadConfig ***REMOVED*** from '../lib/load-config'
import getModuleDependencies from './getModuleDependencies'

let configPathCache = new LRU({ maxSize: 100 ***REMOVED***)
...
function getTailwindConfig(configOrPath) {
  ...
  ***REMOVED***
  ...
  let newConfig = resolveConfig(configOrPath?.config ?? configOrPath ?? {***REMOVED***)
...
export default function setupTrackingContext(configOrPath) {
  return ({ tailwindDirectives, registerDependency ***REMOVED***) => {
    return (root, result) => {
      ...
      ***REMOVED***
      ...
      for (let file of configDependencies) {
        registerDependency({ type: 'dependency', file ***REMOVED***)
      ***REMOVED***
