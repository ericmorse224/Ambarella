...
exports._convertInherit = (obj, ret, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
...

  {
    ...
    if (value !== undefined) {
      value = conversions["USVString"](value, { context: context + " has member 'newURL' that" ***REMOVED***);
  ...
  ***REMOVED***

  {
    ...
    let value = obj === undefined || obj === null ? undefined : obj[key];
    if (value !== undefined) {
      value = conversions["USVString"](value, { context: context + " has member 'oldURL' that" ***REMOVED***);
