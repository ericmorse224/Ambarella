...
for (let currentModule = module;;) {
    if (!eslintrcBundlePath) {
        if (currentModule.filename.endsWith('eslintrc.cjs')) {
            ...
            try {
                const eslintrcFolderPath = path_1.default.dirname(require.resolve('@eslint/eslintrc/package.json', { paths: [currentModule.path] ***REMOVED***));
            ...
            try {
                ...
                ***REMOVED***));
                ...
                if (resolvedConfigArrayFactoryPath === currentModule.filename) {
                    ...
                    moduleResolverPath = `${eslintrcFolder***REMOVED***/lib/shared/relative-module-resolver`;
                    namingPath = `${eslintrcFolder***REMOVED***/lib/shared/naming`;
                ***REMOVED***
            ***REMOVED***
            catch (ex) {
                // Module resolution failures are expected, as we're walking
...
if (!eslintFolder) {
    ...
    for (let currentModule = module;;) {
        ...
        if (/[\\/]eslint[\\/]lib[\\/]cli-engine[\\/]config-array-factory\.js$/i.test(currentModule.filename)) {
            ...
            configArrayFactoryPath = `${eslintFolder***REMOVED***/lib/cli-engine/config-array-factory`;
            moduleResolverPath = `${eslintFolder***REMOVED***/lib/shared/relative-module-resolver`;
            ...
            ***REMOVED***
                ...
                ***REMOVED***
            ***REMOVED***
            namingPath = `${eslintrcFolder !== null && eslintrcFolder !== void 0 ? eslintrcFolder : eslintFolder***REMOVED***/lib/shared/naming`;
            break;
        ***REMOVED***
        if (!currentModule.parent) {
...
const eslintPackageJsonPath = `${eslintFolder***REMOVED***/package.json`;
...
if (isNaN(ESLINT_MAJOR_VERSION)) {
    throw new Error(`Unable to parse ESLint version "${exports.eslintPackageVersion***REMOVED***" in file "${eslintPackageJsonPath***REMOVED***"`);
***REMOVED***
if (!(ESLINT_MAJOR_VERSION >= 6 && ESLINT_MAJOR_VERSION <= 9)) {
    throw new Error('The ESLint patch script has only been tested with ESLint version 6.x, 7.x, 8.x, and 9.x.' +
        ` (Your version: ${exports.eslintPackageVersion***REMOVED***)\n` +
