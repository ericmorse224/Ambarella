    ...
    if (node.type === _experimentalUtils.AST_NODE_TYPES.ExpressionStatement) {
      ...
      if (node.expression.type === _experimentalUtils.AST_NODE_TYPES.CallExpression) {
        ...
        ***REMOVED***
        ...
        if ((0, _utils.isExpectCall)(leftMostCall) && leftMostCall.arguments.length > 0 && (0, _utils.isIdentifier)(leftMostCall.arguments[0], name)) {
          const {
            modifier
          ***REMOVED*** = (0, _utils.parseExpectCall)(leftMostCall);
      ...
      ***REMOVED***
      ...
      if (node.expression.type === _experimentalUtils.AST_NODE_TYPES.AwaitExpression && isPromiseMethodThatUsesValue(node.expression, identifier)) {
        return true;
      ***REMOVED*** // (re)assignment changes the runtime value, so if we've not found an
      ...
      if (node.expression.type === _experimentalUtils.AST_NODE_TYPES.AssignmentExpression) {
        ...
        if ((0, _utils.isIdentifier)(node.expression.left, name) && (_getNodeName = (0, _utils.getNodeName)(node.expression.right)) !== null && _getNodeName !== void 0 && _getNodeName.startsWith(`${name***REMOVED***.`) && isPromiseChainCall(node.expression.right)) {
          continue;
        ***REMOVED***
    ...
    return {
      CallExpression(node) {
        ...
        if (isTestCaseCallWithCallbackArg(node)) {
          ...
          return;
        ***REMOVED*** // if this call expression is a promise chain, add it to the stack with
        ...
        if (isPromiseChainCall(node)) {
          ...
          return;
        ***REMOVED*** // if we're within a promise chain, and this call expression looks like
      ...
      ***REMOVED***,
      ...
      'CallExpression:exit'(node) {
        ...
        ***REMOVED***
        ...
        if (!isPromiseChainCall(node)) {
          return;
        ***REMOVED*** // since we're exiting this call expression (which is a promise chain)
        ...
        ***REMOVED***
        ...
        const {
          parent
        ***REMOVED*** = findTopMostCallExpression(node); // if we don't have a parent (which is technically impossible at runtime)
