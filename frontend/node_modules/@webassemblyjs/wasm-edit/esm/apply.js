...
import { encodeNode ***REMOVED*** from "@webassemblyjs/wasm-gen";
import { encodeU32 ***REMOVED*** from "@webassemblyjs/wasm-gen/lib/encoder";
import { isFunc, isGlobal, assertHasLoc, orderedInsertNode, getSectionMetadata, traverse, getEndOfSection ***REMOVED*** from "@webassemblyjs/ast";
import { resizeSectionByteSize, resizeSectionVecSize, createEmptySection, removeSections ***REMOVED*** from "@webassemblyjs/helper-wasm-section";
import { overrideBytesInBuffer ***REMOVED*** from "@webassemblyjs/helper-buffer";
import { getSectionForNode ***REMOVED*** from "@webassemblyjs/helper-wasm-bytecode";
    ...
    traverse(ast, {
      Func: function Func(_ref3) {
        ...
        var funcHasThisIntr = node.body.find(function (n) {
          return n === newNode;
        ***REMOVED***) !== undefined; // Update func's body size if needed
  ...
  ***REMOVED***
  ...
  newNode.loc = {
    ...
    ***REMOVED***,
      ...
      column: -1
    ***REMOVED***
  ***REMOVED***; // Update new node end position
...
function applyDelete(ast, uint8Buffer, node) {
  ...
  if (sectionName === "start") {
    ...
    return {
      ...
      deltaElements: deltaElements
    ***REMOVED***;
  ***REMOVED*** // replacement is nothing
...
function applyAdd(ast, uint8Buffer, node) {
  ...
  ***REMOVED***
  ...
  node.loc = {
    ...
    ***REMOVED***
  ***REMOVED***; // for func add the additional metadata in the AST
