...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            invalidVoidForGeneric: '{{ generic ***REMOVED******REMOVED*** may not have void as a type argument.',
    ...
    ***REMOVED***,
    defaultOptions: [
        { allowInGenericTypeArguments: true, allowAsThisParameter: false ***REMOVED***,
    ],
    create(context, [{ allowInGenericTypeArguments, allowAsThisParameter ***REMOVED***]) {
        const validParents = [
            ...
            if (Array.isArray(allowInGenericTypeArguments)) {
                ...
                if (!allowInGenericTypeArguments
                    ...
                    context.report({
                        ...
                        data: { generic: fullyQualifiedName ***REMOVED***,
                        node,
                    ***REMOVED***);
                ***REMOVED***
                return;
