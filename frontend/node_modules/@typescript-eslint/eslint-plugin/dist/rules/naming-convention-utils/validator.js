...
function createValidator(type, context, allConfigs) {
    ...
    ***REMOVED***;
    ...
    function formatReportData({ affixes, formats, originalName, processedName, position, custom, count, ***REMOVED***) {
        var _a;
        return {
...
function isCorrectType(node, config, context, selector) {
    ...
    ***REMOVED***
    if ((SelectorsAllowedToHaveTypes & selector) === 0) {
        return true;
    ***REMOVED***
    const { esTreeNodeToTSNodeMap, program ***REMOVED*** = util.getParserServices(context);
