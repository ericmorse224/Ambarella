const {transform***REMOVED*** = require("../dist");
...
function create(createOptions) {
  const {nodeModuleEmitKind***REMOVED*** = createOptions;
  const {
    module,
    jsx,
    jsxFactory,
  ...
  ***REMOVED*** = createOptions.service.config.options;

  return {
    transpile(input, transpileOptions) {
      const {fileName***REMOVED*** = transpileOptions;
      const transforms = [];
      ...
      ***REMOVED***
      ...
      const {code, sourceMap***REMOVED*** = transform(input, {
        transforms,
        ...
        sourceMapOptions: {compiledFilename: fileName***REMOVED***,
        filePath: fileName,
      ***REMOVED***);
      return {
        outputText: code,
