...
```js
import 'foo'
function x() { return 42 ***REMOVED***
```

```js
export function x() { return 42 ***REMOVED***
```

```js
(function x() { return 42 ***REMOVED***)()
export {***REMOVED*** // simple way to mark side-effects-only file as 'module' without any imports/exports
```
