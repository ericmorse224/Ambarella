...
import { SendOptions ***REMOVED*** from "send";

declare global {
    namespace Express {
        // These open interfaces may be extended in an application-specific manner via declaration merging.
        // See for example method-override.d.ts (https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/method-override/index.d.ts)
        interface Request {***REMOVED***
        interface Response {***REMOVED***
        interface Locals {***REMOVED***
        interface Application {***REMOVED***
    ***REMOVED***
***REMOVED***

import { EventEmitter ***REMOVED*** from "events";
import * as http from "http";
import { ParsedQs ***REMOVED*** from "qs";
import { Options as RangeParserOptions, Ranges as RangeParserRanges, Result as RangeParserResult ***REMOVED*** from "range-parser";
...
export interface NextFunction {
    (err?: any): void;
    /**
     * "Break-out" of a router by calling {next('router')***REMOVED***;
     * @see {https://expressjs.com/en/guide/using-middleware.html#middleware.router***REMOVED***
     */
    (deferToNext: "router"): void;
    /**
     * "Break-out" of a route by calling {next('route')***REMOVED***;
     * @see {https://expressjs.com/en/guide/using-middleware.html#middleware.application***REMOVED***
     */
...
export interface Locals extends Express.Locals {***REMOVED***
...
type RemoveTail<S extends string, Tail extends string> = S extends `${infer P***REMOVED***${Tail***REMOVED***` ? P : S;
type GetRouteParameter<S extends string> = RemoveTail<
    RemoveTail<RemoveTail<S, `/${string***REMOVED***`>, `-${string***REMOVED***`>,
    `.${string***REMOVED***`
>;

// prettier-ignore
export type RouteParameters<Route extends string> = Route extends `${infer Required***REMOVED***{${infer Optional***REMOVED******REMOVED***${infer Next***REMOVED***`
...
type ParseRouteParameters<Route extends string> = string extends Route ? ParamsDictionary
    : Route extends `${string***REMOVED***(${string***REMOVED***` ? ParamsDictionary // TODO: handling for regex parameters
    : Route extends `${string***REMOVED***:${infer Rest***REMOVED***` ?
            & (
                GetRouteParameter<Rest> extends never ? ParamsDictionary
                    : GetRouteParameter<Rest> extends `${infer ParamName***REMOVED***?` ? { [P in ParamName]?: string ***REMOVED*** // TODO: Remove old `?` handling when Express 5 is promoted to "latest"
                    : { [P in GetRouteParameter<Rest>]: string ***REMOVED***
            )
            & (Rest extends `${GetRouteParameter<Rest>***REMOVED***${infer Next***REMOVED***` ? RouteParameters<Next> : unknown)
    : {***REMOVED***;
...
export interface Router extends IRouter {***REMOVED***
...
export interface RequestRanges extends RangeParserRanges {***REMOVED***
...
> extends http.IncomingMessage, Express.Request {
    ...
    // body: { username: string; password: string; remember: boolean; title: string; ***REMOVED***;
    body: ReqBody;

    // cookies: { string; remember: boolean; ***REMOVED***;
    cookies: any;
...
> extends http.ServerResponse, Express.Response {
     ...
     *    res.cookie('rememberme', '1', { expires: new Date(Date.now() + 900000), httpOnly: true ***REMOVED***);
     *
     *    // save as above
...
export interface Handler extends RequestHandler {***REMOVED***
...
> extends EventEmitter, IRouter, Express.Application {
     ...
     * Example:
     *
     *    app.render('email', { name: 'Tobi' ***REMOVED***, function(err, html){
     *      // ...
     *    ***REMOVED***)
     */
     ...
     *    https.createServer({ ... ***REMOVED***, app).listen(443);
     */
