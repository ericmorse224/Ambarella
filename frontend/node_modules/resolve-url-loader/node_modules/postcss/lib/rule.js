 ...
 *
 * @example
 * const root = postcss.parse('a{***REMOVED***')
 * const rule = root.first
 * rule.type       //=> 'rule'
 * rule.toString() //=> 'a{***REMOVED***'
 */
var Rule = /*#__PURE__*/function (_Container) {
  ...
  ***REMOVED***
   ...
   *
   * @example
   * const root = postcss.parse('a, b { ***REMOVED***')
   * const rule = root.first
   *
   * rule.selector  //=> 'a, b'
   * rule.selectors //=> ['a', 'b']
  ...
  _createClass(Rule, [{
    ...
    ***REMOVED***
    /**
     * @memberof Rule#
     * @member {string***REMOVED*** selector The rule’s full selector represented
     *                           as a string.
     *
     * @example
     * const root = postcss.parse('a, b { ***REMOVED***')
