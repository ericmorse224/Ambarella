...
const NM = `${node_path_1.sep***REMOVED***node_modules${node_path_1.sep***REMOVED***`;
const STORE = `.store${node_path_1.sep***REMOVED***`;
const PKG = `${node_path_1.sep***REMOVED***package${node_path_1.sep***REMOVED***`;
const DIST = `${node_path_1.sep***REMOVED***dist${node_path_1.sep***REMOVED***`;
/**
 ...
 * ```ts
 * // src/index.ts
 * import { findPackageJson ***REMOVED*** from 'package-json-from-dist'
 *
...
const findPackageJson = (from, pathFromSrc = '../package.json') => {
    ...
    if (nms !== -1) {
        ...
        // '.../node_modules/.store/${id***REMOVED***-${hash***REMOVED***/package/...'
 ...
 * ```ts
 * // src/index.ts
 * import { loadPackageJson ***REMOVED*** from 'package-json-from-dist'
 *
 * const pj = loadPackageJson(import.meta.url)
 * console.log(`Hello from ${pj.name***REMOVED***@${pj.version***REMOVED***`)
 * ```
 *
 * If the caller is deeper within the project source, then you must provide
 * the appropriate fallback path:
