...
function requestErrorSteps(xhr, event, exception) {
  const { flag, properties, upload ***REMOVED*** = xhr;
  ...
  ***REMOVED***
  ...
  if (!properties.uploadComplete) {
    ...
    if (properties.uploadListener) {
      fireAnEvent(event, upload, ProgressEvent, { loaded: 0, total: 0, lengthComputable: false ***REMOVED***);
      fireAnEvent("loadend", upload, ProgressEvent, { loaded: 0, total: 0, lengthComputable: false ***REMOVED***);
    ***REMOVED***
  ***REMOVED***

  fireAnEvent(event, xhr, ProgressEvent, { loaded: 0, total: 0, lengthComputable: false ***REMOVED***);
  fireAnEvent("loadend", xhr, ProgressEvent, { loaded: 0, total: 0, lengthComputable: false ***REMOVED***);
***REMOVED***
...
function setResponseToNetworkError(xhr) {
  ...
  properties.responseHeaders = {***REMOVED***;
  xhr.status = 0;
  xhr.statusText = "";
***REMOVED***
...
function createClient(xhr) {
  ...
  const { requestManager ***REMOVED*** = flag;
  ...
  if (urlObj.protocol === "file:") {
    ...
    const readableStream = fs.createReadStream(filePath, { encoding: null ***REMOVED***);
  ...
  ***REMOVED***
  ...
  if (urlObj.protocol === "data:") {
    ...
    try {
      ...
      response.headers = { "content-type": contentType ***REMOVED***;
    ***REMOVED*** catch (err) {
  ...
  ***REMOVED***
  ...
  const options = { rejectUnauthorized: flag.strictSSL, agents, followRedirects: true ***REMOVED***;
  if (flag.auth) {
  ...
  function doRequest() {
    try {
      ...
      if (hasBody) {
        if (flag.formData) {
          ...
          ***REMOVED***
          ...
          requestHeaders["Content-Type"] = `multipart/form-data; boundary=${requestBody.getBoundary()***REMOVED***`;
        ***REMOVED*** else {
      ...
      ***REMOVED***
      ...
      const requestClient = new Request(uri, options, { method: flag.method, headers: requestHeaders ***REMOVED***);
      if (hasBody) {
        if (flag.formData) {
    ...
    ***REMOVED*** catch (e) {
      ...
      eventEmitterclient.end = () => {***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (crossOrigin && (!simpleMethods.has(ucMethod) || nonSimpleHeaders.length > 0 || properties.uploadListener)) {
    ...
    const preflightRequestHeaders = {***REMOVED***;
    ...
    ***REMOVED***
    ...
    const preflightClient = new Request(
      uri,
      { agents, followRedirects: false ***REMOVED***,
      { method: "OPTIONS", headers: preflightRequestHeaders, rejectUnauthorized ***REMOVED***
    );
