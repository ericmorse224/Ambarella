...
test('isFinalizationRegistry', function (t) {
	...
	var nonFinalizationRegistries = [undefined, null, true, false, 42, 0, Infinity, NaN, /a/g, function () {***REMOVED***, {***REMOVED***, []];
	...
	***REMOVED***);
	...
	t.test('actual FinalizationRegistry instances', { skip: typeof FinalizationRegistry === 'undefined' ***REMOVED***, function (st) {
