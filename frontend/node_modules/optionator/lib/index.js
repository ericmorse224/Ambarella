...
(function(){
  ...
  camelizeKeys = function(obj){
    var key, value, resultObj$ = {***REMOVED***;
    for (key in obj) {
      value = obj[key];
  ...
  ***REMOVED***;
  main = function(libOptions){
    ...
    ***REMOVED***
    ...
    libOptions.typeAliases == null && (libOptions.typeAliases = {***REMOVED***);
    libOptions.defaults == null && (libOptions.defaults = {***REMOVED***);
          ...
          ***REMOVED***
          ...
          if (option.concatRepeatedArrays != null) {
            ...
            if ('Boolean' === toString$.call(cra).slice(8, -1)) {
              option.concatRepeatedArrays = [cra, {***REMOVED***];
            ***REMOVED*** else if (cra.length === 1) {
              option.concatRepeatedArrays = [cra[0], {***REMOVED***];
            ***REMOVED*** else if (cra.length !== 2) {
    ...
    parse = function(input, arg$){
      ...
      setValue = function(name, value){
        ...
        ***REMOVED*** else {
          ...
          ***REMOVED***, opt.parsedPossibilities)) {
        ...
        ***REMOVED***
        ...
        if (obj[name] != null) {
          ...
          ***REMOVED*** else if (opt.mergeRepeatedObjects && currentType === 'Object') {
            import$(obj[name], val);
          ***REMOVED*** else {
            obj[name] = val;
          ***REMOVED***
      ...
      ***REMOVED***
      for (i$ = 0, len$ = args.length; i$ < len$; ++i$) {
        ...
        if (arg === '--') {
          restPositional = true;
        ***REMOVED*** else if (restPositional) {
          positional.push(arg);
        ***REMOVED*** else {
          if (that = arg.match(/^(--?)([a-zA-Z][-a-zA-Z0-9]*)(=)?(.*)?$/)) {
            ...
            ***REMOVED*** else {
              ...
              ***REMOVED***
            ***REMOVED***
          ***REMOVED*** else if (that = arg.match(/^-([0-9]+(?:\.[0-9]+)?)$/)) {
            opt = opts.NUM;
            if (!opt) {
  ...
  ***REMOVED***;
  ...
  function import$(obj, src){
    var own = {***REMOVED***.hasOwnProperty;
