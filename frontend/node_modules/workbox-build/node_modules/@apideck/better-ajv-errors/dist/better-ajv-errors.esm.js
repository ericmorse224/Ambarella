...
var betterAjvErrors = function betterAjvErrors(_ref) {
  var errors = _ref.errors,
      ...
      basePath = _ref$basePath === void 0 ? '{base***REMOVED***' : _ref$basePath;
    ...
    switch (error.keyword) {
          ...
          ***REMOVED***),
          ...
          validationError = {
            ...
            suggestion: getSuggestion({
              ...
              suggestions: Object.keys(properties != null ? properties : {***REMOVED***),
      ...
      case 'enum':
        {
          ...
          ***REMOVED***);
          validationError = {
            ...
            ***REMOVED***),
            path: path,
            context: _extends({***REMOVED***, defaultContext, {
      ...
      default:
        return {
          ...
          context: defaultContext
        ***REMOVED***;
    ***REMOVED*** // Remove empty properties
...
export { betterAjvErrors ***REMOVED***;
