...
exports.attrsGroupsDefaults = {
    core: {'xml:space': 'preserve'***REMOVED***,
    filterPrimitive: {x: '0', y: '0', width: '100%', height: '100%'***REMOVED***,
    presentation: {
        clip: 'auto',
        'clip-path': 'none',
        'clip-rule': 'nonzero',
    ...
    ***REMOVED***,
    transferFunction: {slope: '1', intercept: '0', amplitude: '1', exponent: '1', offset: '0'***REMOVED***
***REMOVED***;
