...
declare function templateElement(value: {
    raw: string;
    cooked?: string;
***REMOVED***, tail?: boolean): TemplateElement;
...
***REMOVED*** | {
    shapeOf: {
        [x: string]: FieldOptions;
    ***REMOVED***;
***REMOVED*** | object) & ((node: Node, key: string | {
    toString(): string;
...
declare function is<T extends Node["type"], P extends Extract<Node, {
    type: T;
***REMOVED***>>(type: T, n: Node | null | undefined, required: Partial<P>): n is P;
