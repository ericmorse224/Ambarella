...
function isHook(node) {
  ...
  ***REMOVED*** else if (node.type === 'MemberExpression' && !node.computed && isHook(node.property)) {
    var obj = node.object;
      ...
      ***REMOVED***,
      ...
      onCodePathEnd: function (codePath, codePathNode) {
        ...
        if (reactHooksMap.size === 0) {
          return;
        ***REMOVED*** // All of the segments which are cyclic are recorded in this set.
        ...
        function countPathsFromStart(segment, pathHistory) {
          ...
          if (pathList.has(segment.id)) {
            ...
            ***REMOVED***
            ...
            return BigInt('0');
          ***REMOVED*** // add the current segment to pathList
          ...
          ***REMOVED***
          ...
          if (codePath.thrownSegments.includes(segment)) {
            paths = BigInt('0');
          ***REMOVED*** else if (segment.prevSegments.length === 0) {
            paths = BigInt('1');
          ***REMOVED*** else {
            paths = BigInt('0');
            ...
            ***REMOVED*** finally {
              _iterator2.f();
            ***REMOVED***
          ***REMOVED*** // If our segment is reachable then there should be at least one path
        ...
        ***REMOVED***
        ...
        function countPathsToEnd(segment, pathHistory) {
          ...
          ***REMOVED***
          ...
          if (codePath.thrownSegments.includes(segment)) {
            paths = BigInt('0');
          ***REMOVED*** else if (segment.nextSegments.length === 0) {
            paths = BigInt('1');
          ***REMOVED*** else {
            paths = BigInt('0');
        ...
        ***REMOVED***
        ...
        function shortestPathLengthToStart(segment) {
          ...
          if (length === null) {
            return Infinity;
          ***REMOVED*** // We have a cached `length`. Return it.


          if (length !== undefined) {
            return length;
          ***REMOVED*** // Compute `length` and cache it. Guarding against cycles.
        ...
        ***REMOVED***
        ...
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            ...
            ***REMOVED***
          ***REMOVED*** // Make sure all React Hooks pass our lint invariants. Log warnings
          // if not.
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            if (!segment.reachable) {
              continue;
            ***REMOVED*** // If there are any final segments with a shorter path to start then
            ...
            try {
              for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                ...
                if (cycled) {
                  ...
                  ***REMOVED***);
                ***REMOVED*** // If this is not a valid code path for React hooks then we need to
                ...
                if (isDirectlyInsideComponentOrHook) {
                  ...
                  if (!cycled && pathsFromStartToEnd !== allPathsFromStartToEnd) {
                    ...
                    ***REMOVED***);
                  ***REMOVED***
                ***REMOVED*** else if (codePathNode.parent && (codePathNode.parent.type === 'MethodDefinition' || codePathNode.parent.type === 'ClassProperty') && codePathNode.parent.value === codePathNode) {
                  ...
                  context.report({
                    ...
                    message: _message
                  ***REMOVED***);
                ***REMOVED*** else if (codePathFunctionName) {
                  ...
                  context.report({
                    ...
                    message: _message2
                  ***REMOVED***);
                ***REMOVED*** else if (codePathNode.type === 'Program') {
...
function getFunctionName(node) {
  if (node.type === 'FunctionDeclaration' || node.type === 'FunctionExpression' && node.id) {
    // function useHook() {***REMOVED***
    // const whatever = function useHook() {***REMOVED***;
    //
    // Function declaration or function expression names win over any
    // assignment statements or other renames.
    return node.id;
  ***REMOVED*** else if (node.type === 'FunctionExpression' || node.type === 'ArrowFunctionExpression') {
    if (node.parent.type === 'VariableDeclarator' && node.parent.init === node) {
      // const useHook = () => {***REMOVED***;
      return node.parent.id;
    ***REMOVED*** else if (node.parent.type === 'AssignmentExpression' && node.parent.right === node && node.parent.operator === '=') {
      // useHook = () => {***REMOVED***;
      return node.parent.left;
    ***REMOVED*** else if (node.parent.type === 'Property' && node.parent.value === node && !node.parent.computed) {
      // {useHook: () => {***REMOVED******REMOVED***
      // {useHook() {***REMOVED******REMOVED***
      return node.parent.key; // NOTE: We could also support `ClassProperty` and `MethodDefinition`
      // here to be pedantic. However, hooks in a class are an anti-pattern. So
      // we don't allow it to error early.
      //
      // class {useHook = () => {***REMOVED******REMOVED***
      // class {useHook() {***REMOVED******REMOVED***
    ***REMOVED*** else if (node.parent.type === 'AssignmentPattern' && node.parent.right === node && !node.parent.computed) {
      // const {useHook = () => {***REMOVED******REMOVED*** = {***REMOVED***;
      // ({useHook = () => {***REMOVED******REMOVED*** = {***REMOVED***);
      //
    ...
    function visitFunctionWithDependencies(node, declaredDependenciesNode, reactiveHook, reactiveHookName, isEffect) {
      ...
      ***REMOVED*** // Get the current scope.
      ...
      var componentScope = null;
      {
        ...
        ***REMOVED*** // If there is no parent function scope then there are no pure scopes.
      ...
      ***REMOVED***
      ...
      function isStableKnownHookValue(resolved) {
        ...
        ***REMOVED*** // Detect primitive constants
        // const foo = 42
        ...
        ***REMOVED***
        ...
        if (declaration.kind === 'const' && init.type === 'Literal' && (typeof init.value === 'string' || typeof init.value === 'number' || init.value === null)) {
          // Definitely stable
          return true;
        ***REMOVED*** // Detect known Hook calls
        ...
        ***REMOVED***
        ...
        if (name === 'useRef' && id.type === 'Identifier') {
          ...
          return true;
        ***REMOVED*** else if (name === 'useState' || name === 'useReducer') {
          ...
          if (id.type === 'ArrayPattern' && id.elements.length === 2 && isArray(resolved.identifiers)) {
            ...
            if (id.elements[1] === resolved.identifiers[0]) {
              if (name === 'useState') {
                ...
                ***REMOVED***
              ***REMOVED*** // Setter is stable.


              return true;
            ***REMOVED*** else if (id.elements[0] === resolved.identifiers[0]) {
              if (name === 'useState') {
                ...
                ***REMOVED***
              ***REMOVED*** // State variable itself is dynamic.


              return false;
            ***REMOVED***
          ***REMOVED***
        ***REMOVED*** else if (name === 'useTransition') {
          // Only consider second value in initializing tuple stable.
          if (id.type === 'ArrayPattern' && id.elements.length === 2 && Array.isArray(resolved.identifiers)) {
            ...
            ***REMOVED***
          ***REMOVED***
        ***REMOVED*** // By default assume it's dynamic.


        return false;
      ***REMOVED*** // Some are just functions that don't reference anything dynamic.
      ...
      function isFunctionWithoutCapturedValues(resolved) {
        ...
        ***REMOVED***
        ...
        if (def.node == null || def.node.id == null) {
          return false;
        ***REMOVED*** // Search the direct component subscopes for
        ...
        for (i = 0; i < childScopes.length; i++) {
          ...
          if ( // function handleChange() {***REMOVED***
          fnNode.type === 'FunctionDeclaration' && childScopeBlock === fnNode || // const handleChange = () => {***REMOVED***
          // const handleChange = function() {***REMOVED***
        ...
        ***REMOVED***
        ...
        if (fnScope == null) {
          return false;
        ***REMOVED*** // Does this function capture any values
        ...
        for (i = 0; i < fnScope.through.length; i++) {
          ...
          ***REMOVED***
          ...
          !memoizedIsStableKnownHookValue(ref.resolved)) {
            return false;
          ***REMOVED***
        ***REMOVED*** // If we got here, this function doesn't capture anything
        // from render--or everything it captures is known stable.


        return true;
      ***REMOVED*** // Remember such values. Avoid re-running extra checks on them.
      ...
      ***REMOVED*** // Get dependencies from all our resolved references in pure scopes.
      ...
      function gatherDependenciesRecursively(currentScope) {
          ...
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            ***REMOVED***
            ...
            if (!pureScopes.has(reference.resolved.scope)) {
              continue;
            ***REMOVED*** // Narrow the scope of a dependency if it is, say, a member expression.
            ...
            ***REMOVED***
            ...
            if (def == null) {
              continue;
            ***REMOVED*** // Ignore references to the function itself as it's not defined yet.


            if (def.node != null && def.node.init === node.parent) {
              continue;
            ***REMOVED*** // Ignore Flow type parameters


            if (def.type === 'TypeParameter') {
              continue;
            ***REMOVED*** // Add the dependency to a map so we can make sure it is referenced
        ...
        ***REMOVED*** finally {
          _iterator2.f();
        ***REMOVED***
      ***REMOVED*** // Warn about accessing .current in cleanup effects.
      ...
      currentRefsInEffectCleanup.forEach(function (_ref, dependency) {
        ...
        for (var i = 0; i < references.length; i++) {
          ...
          parent.parent.type === 'AssignmentExpression' && parent.parent.left === parent) {
            ...
            break;
          ***REMOVED***
        ***REMOVED*** // We only want to warn about React-managed refs.
        ...
        ***REMOVED***);
      ***REMOVED***); // Warn about assigning to variables in the outer scope.
      ...
      function reportStaleAssignment(writeExpr, key) {
        ...
        ***REMOVED***);
      ***REMOVED*** // Remember which deps are stable and report bad usage first.
      ...
      ***REMOVED*** else {
        declaredDependenciesNode.elements.forEach(function (declaredDependencyNode) {
          ...
          if (declaredDependencyNode === null) {
            return;
          ***REMOVED*** // If we see a spread element then add a special warning.
          ...
          if (declaredDependencyNode.type === 'SpreadElement') {
            ...
            ***REMOVED***);
            return;
          ***REMOVED*** // Try to normalize the declared dependency. If we can't then an error
          ...
          ***REMOVED***); // Add the dependency to our declared dependency map.
      ...
      ***REMOVED***),
      ...
      if (problemCount === 0) {
        ...
        constructions.forEach(function (_ref4) {
          ...
          depType === 'function') {
            suggest = [{
              ...
              fix: function (fixer) {
                var _ref5 = wrapperHook === 'useMemo' ? ["useMemo(() => { return ", '; ***REMOVED***)'] : ['useCallback(', ')'],
                    before = _ref5[0],
                    after = _ref5[1];
              ...
              ***REMOVED***
            ***REMOVED***];
          ***REMOVED*** // TODO: What if the function needs to change on every render anyway?
        ...
        ***REMOVED***);
        return;
      ***REMOVED*** // If we're going to report a missing dependency,
      ...
      if (!isEffect && missingDependencies.size > 0) {
        suggestedDeps = collectRecommendations({
          ...
          externalDependencies: externalDependencies,
          isEffect: isEffect
        ***REMOVED***).suggestedDependencies;
      ***REMOVED*** // Alphabetize the suggestions, but only if deps were already alphabetized.
      ...
      ***REMOVED***
      ...
      if (areDeclaredDepsAlphabetized()) {
        suggestedDeps.sort();
      ***REMOVED*** // Most of our algorithm deals with dependency paths with optional chaining stripped.
      ...
      ***REMOVED***
      ...
      function getWarningMessage(deps, singlePrefix, label, fixVerb) {
        ...
        ***REMOVED***)) + (". Either " + fixVerb + " " + (deps.size > 1 ? 'them' : 'it') + " or remove the dependency array.");
      ***REMOVED***
      ...
      if (unnecessaryDependencies.size > 0) {
        ...
        ***REMOVED*** else if (externalDependencies.size > 0) {
          ...
          ***REMOVED***
        ***REMOVED***
      ***REMOVED*** // `props.foo()` marks `props` as a dependency because it has
      ...
      if (!extraWarning && missingDependencies.size > 0) {
        ...
        missingDependencies.forEach(function (missingDep) {
          if (missingCallbackDep) {
            return;
          ***REMOVED*** // Is this a variable from top scope?
          ...
          if (usedDep.references[0].resolved !== topScopeRef) {
            return;
          ***REMOVED*** // Is this a destructured prop?
          ...
          if (def == null || def.name == null || def.type !== 'Parameter') {
            return;
          ***REMOVED*** // Was it called in at least one case? Then it's a function.
          ...
          ***REMOVED***
          ...
          if (!isFunctionCall) {
            return;
          ***REMOVED*** // If it's missing (i.e. in component scope) *and* it's a parameter
                ...
                if (correspondingStateVariable != null) {
                  if (correspondingStateVariable.name === missingDep) {
                    ...
                    setStateRecommendation = {
                      ...
                      form: 'updater'
                    ***REMOVED***;
                  ***REMOVED*** else if (stateVariables.has(id)) {
    ...
    function visitCallExpression(node) {
      ...
      ***REMOVED***
      ...
      if (!callback) {
        ...
        ***REMOVED***);
        return;
      ***REMOVED*** // Check the declared dependencies for this reactive hook. If there is no
      ...
      switch (callback.type) {
        ...
        case 'Identifier':
          if (!declaredDependenciesNode) {
            // No deps, no problems.
            return; // Handled
          ***REMOVED*** // The function passed as a callback is not written inline.
          ...
          ***REMOVED***)) {
            ...
            return; // Handled
          ***REMOVED*** // We'll do our best effort to find it, complain otherwise.
        ...
        default:
          ...
          ***REMOVED***);
          return;
        // Handled
      ***REMOVED*** // Something unusual. Fall back to suggesting to add the body itself as a dep.
...
function collectRecommendations(_ref6) {
  ...
  function createDepTree() {
    ...
    ***REMOVED***;
  ***REMOVED*** // Mark all required nodes first.
  ...
  dependencies.forEach(function (_, key) {
    ...
    ***REMOVED***);
  ***REMOVED***); // Mark all satisfied nodes.
  ...
  ***REMOVED***);
  stableDependencies.forEach(function (key) {
    var node = getOrCreateNodeByPath(depTree, key);
    node.isSatisfiedRecursively = true;
  ***REMOVED***); // Tree manipulation helpers.
  ...
  ***REMOVED***
  ...
  function markAllParentsByPath(rootNode, path, fn) {
    ...
    ***REMOVED*** finally {
      _iterator4.f();
    ***REMOVED***
  ***REMOVED*** // Now we can learn which dependencies are missing or necessary.
  ...
  function scanTreeRecursively(node, missingPaths, satisfyingPaths, keyToPath) {
    node.children.forEach(function (child, key) {
      ...
      if (child.isSatisfiedRecursively) {
        ...
        ***REMOVED*** // It doesn't matter if there's something deeper.
      ...
      ***REMOVED***);
    ***REMOVED***);
  ***REMOVED*** // Collect suggestions in the order they were originally specified.
  ...
  declaredDependencies.forEach(function (_ref8) {
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***); // Then add the missing ones at the end.
  ...
  ***REMOVED***;
***REMOVED*** // If the node will result in constructing a referentially unique value, return
...
function getConstructionExpressionType(node) {
  ...
  ***REMOVED***
  ...
  return null;
***REMOVED*** // Finds variables declared as dependencies
...
function scanForConstructions(_ref9) {
  ...
  var constructions = declaredDependencies.map(function (_ref10) {
    ...
    ***REMOVED***
    ...
    if (node == null) {
      return null;
    ***REMOVED*** // const handleChange = function () {***REMOVED***
    // const handleChange = () => {***REMOVED***
    // const foo = {***REMOVED***
    // const foo = []
    // etc.
    ...
    node.node.init != null) {
      ...
      ***REMOVED***
    ***REMOVED*** // function handleChange() {***REMOVED***


    if (node.type === 'FunctionName' && node.node.type === 'FunctionDeclaration') {
      return [ref, 'function'];
    ***REMOVED*** // class Foo {***REMOVED***
...
function getDependency(node) {
  ...
  ***REMOVED*** else if ( // Note: we don't check OptionalMemberExpression because it can't be LHS.
...
function analyzePropertyChain(node, optionalChains) {
  if (node.type === 'Identifier' || node.type === 'JSXIdentifier') {
    ...
    ***REMOVED***
    ...
    return result;
  ***REMOVED*** else if (node.type === 'MemberExpression' && !node.computed) {
    ...
    return _result;
  ***REMOVED*** else if (node.type === 'OptionalMemberExpression' && !node.computed) {
    ...
    return _result2;
  ***REMOVED*** else if (node.type === 'ChainExpression' && !node.computed) {
...
function getNodeWithoutReactNamespace(node, options) {
  ...
  ***REMOVED***
  ...
  return node;
***REMOVED*** // What's the index of callback that needs to be analyzed for a given Hook?
 ...
 * - agnostic to AST node types, it looks for `{ type: string, ... ***REMOVED***`
 */
...
function joinEnglish(arr) {
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    if (i === 0 && arr.length === 2) {
      s += ' and ';
    ***REMOVED*** else if (i === arr.length - 2 && arr.length > 2) {
      s += ', and ';
    ***REMOVED*** else if (i < arr.length - 1) {
      s += ', ';
    ***REMOVED***
  ***REMOVED***
