...
module.exports = function GetSubstitution(matched, str, position, captures, namedCaptures, replacementTemplate) {
	...
	***REMOVED***
	...
	while (templateRemainder !== '') { // step 5
		...
		***REMOVED*** else if (isPrefixOf('$`', templateRemainder)) { // step 5.c
			ref = '$`'; // step 5.c.i
			refReplacement = substring(str, 0, position); // step 5.c.ii
		***REMOVED*** else if (isPrefixOf('$&', templateRemainder)) { // step 5.d
			ref = '$&'; // step 5.d.i
			refReplacement = matched; // step 5.d.ii
		***REMOVED*** else if (isPrefixOf('$\'', templateRemainder)) { // step 5.e
			ref = '$\''; // step 5.e.i
		...
		***REMOVED*** else if (startsWithDollarDigit(templateRemainder)) { // step 5.f
				...
				if (!found) { // step 5.f.ii.1
					...
					***REMOVED***
					if (index === 0) { // step 5.f.ii.1.f
						refReplacement = ref;
					***REMOVED*** else if (index <= captures.length) { // step 5.f.ii.1.g
						...
						***REMOVED*** else { // step 5.f.ii.1.g.iii
							refReplacement = capture; // step 5.f.ii.1.g.iii.i
						***REMOVED***
					***REMOVED*** else { // step 5.f.ii.1.h
						refReplacement = ref; // step 5.f.ii.1.h.i
					***REMOVED***
				***REMOVED***
			***REMOVED***
		***REMOVED*** else if (isPrefixOf('$<', templateRemainder)) { // step 5.g
			...
			***REMOVED*** else { // step 5.g.iii
				...
				***REMOVED*** else { // step 5.g.iii.6
					refReplacement = ToString(capture); // step 5.g.iii.6.a
				***REMOVED***
			***REMOVED***
		***REMOVED*** else { // step 5.h
