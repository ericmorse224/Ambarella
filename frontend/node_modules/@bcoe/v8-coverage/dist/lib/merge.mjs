import { deepNormalizeScriptCov, normalizeFunctionCov, normalizeProcessCov, normalizeRangeTree, normalizeScriptCov, ***REMOVED*** from "./normalize";
import { RangeTree ***REMOVED*** from "./range-tree";
/**
...
export function mergeScriptCovs(scriptCovs) {
    ...
    ***REMOVED***
    const merged = { scriptId, url, functions ***REMOVED***;
...
function stringifyFunctionRootRange(funcCov) {
    ...
    return `${rootRange.startOffset.toString(10)***REMOVED***;${rootRange.endOffset.toString(10)***REMOVED***`;
***REMOVED***
/**
...
export function mergeFunctionCovs(funcCovs) {
    ...
    ***REMOVED***
    ...
    const merged = { functionName, ranges, isBlockCoverage ***REMOVED***;
    ...
    while (true) {
        ...
        ***REMOVED***
        if (openRange === undefined) {
            ...
            for (const { parentIndex, tree ***REMOVED*** of event.trees) {
                openRangeEnd = Math.max(openRangeEnd, tree.end);
                insertChild(parentToNested, parentIndex, tree);
            ***REMOVED***
            startEventQueue.setPendingOffset(openRangeEnd);
            openRange = { start: event.offset, end: openRangeEnd ***REMOVED***;
        ***REMOVED***
        else {
            for (const { parentIndex, tree ***REMOVED*** of event.trees) {
