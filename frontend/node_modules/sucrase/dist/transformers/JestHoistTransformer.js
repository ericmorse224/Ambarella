"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj ***REMOVED***; ***REMOVED*** function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; ***REMOVED*** if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); ***REMOVED*** else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; ***REMOVED*** ***REMOVED*** return value; ***REMOVED***
 ...
 */
 class JestHoistTransformer extends _Transformer2.default {
    __init() {this.hoistedFunctionNames = []***REMOVED***
  ...
  ***REMOVED***
  ...
  getHoistedCode() {
    if (this.hoistedFunctionNames.length > 0) {
      ...
      return this.hoistedFunctionNames.map((name) => `${name***REMOVED***();`).join("");
    ***REMOVED***
    return "";
  ***REMOVED***
   ...
   */
   extractHoistedCalls() {
    ...
    while (this.tokens.matches3(_types.TokenType.dot, _types.TokenType.name, _types.TokenType.parenL)) {
      ...
      if (shouldHoist) {
        ...
        this.tokens.replaceToken(`function ${hoistedFunctionName***REMOVED***(){${JEST_GLOBAL_NAME***REMOVED***.`);
      ...
      ***REMOVED*** else {
        ...
        ***REMOVED*** else {
          ...
          this.tokens.replaceToken(`${JEST_GLOBAL_NAME***REMOVED***.`);
        ***REMOVED***
        this.tokens.copyToken();
        this.tokens.copyToken();
        this.rootTransformer.processBalancedCode();
    ...
    ***REMOVED***
    ...
    return true;
  ***REMOVED***
***REMOVED*** exports.default = JestHoistTransformer;
