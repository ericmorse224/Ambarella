...
const NodePath_Final = exports.default = class NodePath {
  ...
  ***REMOVED***
  getPathLocation() {
    ...
    do {
      let key = path.key;
      if (path.inList) key = `${path.listKey***REMOVED***[${key***REMOVED***]`;
      parts.unshift(key);
  ...
  ***REMOVED***
  debug(message) {
    ...
    debug(`${this.getPathLocation()***REMOVED*** ${this.type***REMOVED***: ${message***REMOVED***`);
  ***REMOVED***
  toString() {
...
for (const type of t.TYPES) {
  const typeKey = `is${type***REMOVED***`;
  const fn = t[typeKey];
  NodePath_Final.prototype[typeKey] = function (opts) {
    return fn(this.node, opts);
  ***REMOVED***;
  NodePath_Final.prototype[`assert${type***REMOVED***`] = function (opts) {
    if (!fn(this.node, opts)) {
      throw new TypeError(`Expected node path of type ${type***REMOVED***`);
    ***REMOVED***
  ***REMOVED***;
***REMOVED***
