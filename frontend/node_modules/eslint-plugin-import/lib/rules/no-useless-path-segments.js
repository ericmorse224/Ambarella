...
/**
                                                                                                                                                                                       ...
                                                                                                                                                                                       * foo/bar -> ./foo/bar
                                                                                                                                                                                       *
                                                                                                                                                                                       * @param relativePath {string***REMOVED*** relative posix path potentially missing leading './'
                                                                                                                                                                                       * @returns {string***REMOVED*** relative posix path that always starts with a ./
                                                                                                                                                                                       **/ /**
...
function countRelativeParents(pathSegments) {
  return pathSegments.filter(function (x) {return x === '..';***REMOVED***).length;
***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-useless-path-segments') ***REMOVED***,
    ...
    schema: [
    {
      type: 'object',
      properties: {
        commonjs: { type: 'boolean' ***REMOVED***,
        noUselessIndex: { type: 'boolean' ***REMOVED*** ***REMOVED***,
      ...
      function checkSourceValue(source) {var
        ...
        function reportWithProposedPath(proposedPath) {
          context.report({
            ...
            fix: function () {function fix(fixer) {return proposedPath && fixer.replaceText(source, JSON.stringify(proposedPath));***REMOVED***return fix;***REMOVED***() ***REMOVED***);
