...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unexpectedComment: "Unexpected '{{matchedTerm***REMOVED******REMOVED***' comment: '{{comment***REMOVED******REMOVED***'."
        ***REMOVED***
    ***REMOVED***,

    create(context) {
        const sourceCode = context.getSourceCode(),
            configuration = context.options[0] || {***REMOVED***,
        ...
        function convertToRegExp(term) {
            ...
            const eitherOrWordBoundary = `|${wordBoundary***REMOVED***`;
            let prefix;
            ...
            ***REMOVED***
            ...
            matches.forEach(matchedTerm => {
                ...
                for (const c of comment.trim().split(/\s+/u)) {
                    const tmp = commentToDisplay ? `${commentToDisplay***REMOVED*** ${c***REMOVED***` : c;
                ...
                ***REMOVED***
                ...
                context.report({
                    ...
                    data: {
                        matchedTerm,
                        comment: `${commentToDisplay***REMOVED***${
                            truncated ? "..." : ""
                        ***REMOVED***`
                    ***REMOVED***
                ***REMOVED***);
