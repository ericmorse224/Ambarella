...
const { CALL, CONSTRUCT, ReferenceTracker, findVariable ***REMOVED*** = require("@eslint-community/eslint-utils");
const { RegExpValidator, visitRegExpAST, RegExpParser ***REMOVED*** = require("@eslint-community/regexpp");
const { canTokensBeAdjacent ***REMOVED*** = require("./utils/ast-utils");
const { REGEXPP_LATEST_ECMA_VERSION ***REMOVED*** = require("./utils/regular-expressions");
 ...
 * @param {ASTNode***REMOVED*** node Node to check.
 * @returns {boolean***REMOVED*** True if the node is a regex literal.
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            ...
            replaceWithLiteralAndFlags: "Replace with an equivalent regular expression literal with flags '{{ flags ***REMOVED******REMOVED***'.",
            replaceWithIntendedLiteralAndFlags: "Replace with a regular expression literal with flags '{{ flags ***REMOVED******REMOVED***'.",
    ...
    ***REMOVED***,
    ...
    create(context) {
        const [{ disallowRedundantWrapping = false ***REMOVED*** = {***REMOVED***] = context.options;
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node Node to check.
         * @returns {boolean***REMOVED*** True if the node is String.raw`` with a static template.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The node to get the string of.
         * @returns {string|null***REMOVED*** The value of the node.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node Node to check.
         * @returns {boolean***REMOVED*** True if the node is a static string.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node Node to check.
         * @returns {boolean***REMOVED*** True if all arguments are static strings.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node Node to check.
         * @returns {boolean***REMOVED*** True if the node already contains a regex literal argument.
         */
        ...
        ***REMOVED***
         ...
         * @param {number***REMOVED*** ecmaVersion The ecmaVersion to convert.
         * @returns {import("@eslint-community/regexpp/ecma-versions").EcmaVersion***REMOVED*** The resulting ecmaVersion compatible for regexpp.
         */
        ...
        ***REMOVED***
         ...
         * @param {string***REMOVED*** character The character to escape.
         * @returns {string***REMOVED*** The resulting escaped character.
         */
        ...
        ***REMOVED***
         ...
         * @param {string***REMOVED*** pattern The regex pattern to check.
         * @param {string | undefined***REMOVED*** flags The regex flags to check.
         * @returns {boolean***REMOVED*** True if the given regex pattern and flags are valid for the ecma version.
         */
        function isValidRegexForEcmaVersion(pattern, flags) {
            const validator = new RegExpValidator({ ecmaVersion: regexppEcmaVersion ***REMOVED***);
        ...
        ***REMOVED***
         ...
         * @param {string***REMOVED*** flagsA The regex flags.
         * @param {string***REMOVED*** flagsB The regex flags.
         * @returns {boolean***REMOVED*** True if two regex flags contain same flags.
         */
        ...
        ***REMOVED***
         ...
         * @param {string***REMOVED*** flagsA The regex flags.
         * @param {string***REMOVED*** flagsB The regex flags.
         * @returns {string***REMOVED*** The merged regex flags.
         */
        ...
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** True if a node can be fixed to the given regex pattern and flags.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The regex node.
         * @param {string***REMOVED*** newRegExpValue The new regex expression value.
         * @returns {string***REMOVED*** The output code.
         */
        ...
        return {
            Program(node) {
                ...
                ***REMOVED***;
                ...
                for (const { node: refNode ***REMOVED*** of tracker.iterateGlobalReferences(traceMap)) {
                        ...
                        if (refNode.arguments.length === 2) {
                            ...
                            ***REMOVED***
                            ...
                            context.report({
                                ...
                                suggest: suggests.map(({ flags, pattern, messageId ***REMOVED***) => ({
                                    messageId,
                                    data: {
                                        flags
                                    ***REMOVED***,
                                    fix(fixer) {
                                        return fixer.replaceText(refNode, getSafeOutput(refNode, `/${pattern***REMOVED***/${flags***REMOVED***`));
                                    ***REMOVED***
                                ***REMOVED***))
                            ***REMOVED***);
                        ***REMOVED*** else {
                            ...
                            ***REMOVED***);
                        ***REMOVED***
                    ***REMOVED*** else if (hasOnlyStaticStringArguments(refNode)) {
                        ...
                        ***REMOVED***
                        ...
                        if (regexContent && !noFix) {
                            ...
                            const ast = new RegExpParser({ ecmaVersion: regexppEcmaVersion ***REMOVED***).parsePattern(regexContent, 0, regexContent.length, {
                                unicode: flags ? flags.includes("u") : false,
                                unicodeSets: flags ? flags.includes("v") : false
                            ***REMOVED***);
                        ...
                        ***REMOVED***
                        ...
                        const newRegExpValue = `/${regexContent || "(?:)"***REMOVED***/${flags || ""***REMOVED***`;
