...
proto._init = function _init (base, options) {
  ...
  state.options = options.spdy || {***REMOVED***
  ...
  socket.on(state.secure ? 'secureConnect' : 'connect', function () {
    ...
    ***REMOVED***
    ...
    var connection = transport.connection.create(socket, Object.assign({
      ...
      isServer: false
    ***REMOVED***, state.options.connection || {***REMOVED***))
    ...
    ***REMOVED***)
    ...
    if (protocol === 'h2') {
      connection.start(4)
    ***REMOVED*** else if (protocol === 'spdy/3.1') {
      connection.start(3.1)
    ***REMOVED*** else if (protocol === 'spdy/3') {
      connection.start(3)
    ***REMOVED*** else if (protocol === 'spdy/2') {
      connection.start(2)
    ***REMOVED*** else {
      socket.destroy()
...
proto._createSocket = function _createSocket (req, options, callback) {
  var state = this._spdyState
  if (state.fallback) { return state.createSocket(req, options) ***REMOVED***
...
exports.create = function create (base, options) {
  ...
  ***REMOVED*** else { return exports.Agent.create(options) ***REMOVED***
***REMOVED***
