...
class LinkResolver {
	...
	***REMOVED***
	...
	/**
	 * @param {string***REMOVED*** file path to file or directory
	 * @returns {string[]***REMOVED*** array of file and all symlinks contributed in the resolving process (first item is the resolved file)
	 */
	resolve(file) {
		...
		***REMOVED***
		...
		try {
			...
			***REMOVED*** else if (parentResolved.length > 1) {
			...
			***REMOVED*** else if (linkResolved.length > 1) {
