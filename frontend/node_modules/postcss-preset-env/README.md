...
```js
postcssPresetEnv({ stage: 0 ***REMOVED***)
```
...
```js
postcssPresetEnv({ minimumVendorImplementations: 2 ***REMOVED***)
```
...
postcssPresetEnv({
  ...
  stage: 3,
  features: {
    'color-mod-function': { unresolved: 'warn' ***REMOVED***
  ***REMOVED***
***REMOVED***)
```
...
```js
postcssPresetEnv({ browsers: 'last 2 versions' ***REMOVED***)
```
...
```js
postcssPresetEnv({
  autoprefixer: { grid: true ***REMOVED***
***REMOVED***)
```
...
postcssPresetEnv({
  importFrom: [
    ...
    */
    ...
    /* module.exports = {
      customMedia: { '--small-viewport': '(max-width: 30em)' ***REMOVED***,
      customProperties: { '--color': 'red' ***REMOVED***,
      customSelectors: { ':--heading': 'h1, h2, h3' ***REMOVED***,
      environmentVariables: { '--branding-padding': '20px' ***REMOVED***
    ***REMOVED*** */
    'and/then/this.js',

    /* {
      "custom-media": { "--small-viewport": "(max-width: 30em)" ***REMOVED***
      "custom-properties": { "--color": "red" ***REMOVED***,
      "custom-selectors": { ":--heading": "h1, h2, h3" ***REMOVED***,
      "environment-variables": { "--branding-padding": "20px" ***REMOVED***
    ***REMOVED*** */
    'and/then/that.json',
    ...
    ***REMOVED***,
    () => {
      ...
      const customProperties = { '--color': 'red' ***REMOVED***;
      const customSelectors = { ':--heading': 'h1, h2, h3' ***REMOVED***;
      const environmentVariables = { '--branding-padding': '20px' ***REMOVED***;

      return { customMedia, customProperties, customSelectors, environmentVariables ***REMOVED***;
    ***REMOVED***
  ]
***REMOVED***);
```
