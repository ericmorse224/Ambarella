...
import { AtRuleProps ***REMOVED*** from './at-rule.js'
import Comment, { CommentProps ***REMOVED*** from './comment.js'
import Container, { NewChild ***REMOVED*** from './container.js'
import CssSyntaxError from './css-syntax-error.js'
import Declaration, { DeclarationProps ***REMOVED*** from './declaration.js'
import Document from './document.js'
import Input from './input.js'
import { Stringifier, Syntax ***REMOVED*** from './postcss.js'
import Result from './result.js'
import Root from './root.js'
import Rule, { RuleProps ***REMOVED*** from './rule.js'
import Warning, { WarningOptions ***REMOVED*** from './warning.js'
...
declare namespace Node {
  ...
  ***REMOVED***
  ...
  /**
   * Source represents an interface for the {@link Node.source***REMOVED*** property.
   */
  ...
  ***REMOVED***
  ...
  class Node extends Node_ {***REMOVED***
  export { Node as default ***REMOVED***
***REMOVED***
...
declare abstract class Node_ {
   ...
   *
   * ```js
   * decl.assign({ prop: 'word-wrap', value: 'break-word' ***REMOVED***)
   * ```
   *
   ...
   * ```js
   * if (!variables[name]) {
   *   throw decl.error(`Unknown variable ${name***REMOVED***`, { word: name ***REMOVED***)
   ...
   *
   * ```js
   * new Rule({ selector: 'a' ***REMOVED***).toString() //=> "a {***REMOVED***"
   * ```
   *
  ...
  /**
   * It is a wrapper for {@link Result#warn***REMOVED***, providing convenient
   * way of generating warnings.
   *
   * ```js
   *   Declaration: {
   *     bad: (decl, { result ***REMOVED***) => {
   ...
   * indicates to the LazyResult processor that the {@link Root***REMOVED*** has been
...
declare class Node extends Node_ {***REMOVED***
