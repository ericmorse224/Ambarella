...
function wrapInterop(programPath, expr, type) {
  ...
  ***REMOVED*** else if (type === "node-default") {
    return null;
  ***REMOVED***
  let helper;
  if (type === "default") {
    helper = "interopRequireDefault";
  ***REMOVED*** else if (type === "namespace") {
    helper = "interopRequireWildcard";
  ***REMOVED*** else {
    throw new Error(`Unknown interop: ${type***REMOVED***`);
  ***REMOVED***
...
const ReexportTemplate = {
  constant: ({
    ...
    exportName,
    namespaceImport
  ***REMOVED***) => _core.template.statement.ast`
      ${exports***REMOVED***.${exportName***REMOVED*** = ${namespaceImport***REMOVED***;
    `,
  constantComputed: ({
    exports,
    exportName,
  ...
  ***REMOVED***) => _core.template.statement.ast`
  ...
  spec: ({
    ...
    namespaceImport
  ***REMOVED***) => _core.template.statement.ast`
      Object.defineProperty(${exports***REMOVED***, "${exportName***REMOVED***", {
        enumerable: true,
        get: function() {
          return ${namespaceImport***REMOVED***;
        ***REMOVED***,
      ***REMOVED***);
    `
***REMOVED***;
function buildReexportsFromMeta(meta, metadata, constantReexports, wrapReference) {
  ...
  ***REMOVED*** = meta;
  return Array.from(metadata.reexports, ([exportName, importName]) => {
    ...
    if (importName === "default" && metadata.interop === "node-default") {***REMOVED*** else if (stringSpecifiers.has(importName)) {
...
const InitTemplate = {
  computed: ({
    ...
    name,
    value
  ***REMOVED***) => _core.template.expression.ast`${exports***REMOVED***["${name***REMOVED***"] = ${value***REMOVED***`,
  default: ({
    exports,
    name,
    value
  ***REMOVED***) => _core.template.expression.ast`${exports***REMOVED***.${name***REMOVED*** = ${value***REMOVED***`,
  define: ({
    ...
    name,
    value
  ***REMOVED***) => _core.template.expression.ast`
      Object.defineProperty(${exports***REMOVED***, "${name***REMOVED***", {
        enumerable: true,
        value: void 0,
        writable: true
