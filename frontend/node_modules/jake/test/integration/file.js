...
let file = require(`${PROJECT_DIR***REMOVED***/lib/utils/file`);
...
suite('fileUtils', function () {
  ...
  ***REMOVED***);
  ...
  test('cpR keeps file mode', function () {
    fs.writeFileSync('bar.txt', 'w00t', {mode: 0o750***REMOVED***);
    fs.writeFileSync('bar1.txt', 'w00t!', {mode: 0o744***REMOVED***);
    file.cpR('bar.txt', 'baz.txt');
  ...
  ***REMOVED***);
  ...
  test('cpR keeps file mode when overwriting with preserveMode', function () {
    fs.writeFileSync('bar.txt', 'w00t', {mode: 0o755***REMOVED***);
    fs.writeFileSync('baz.txt', 'w00t!', {mode: 0o744***REMOVED***);
    file.cpR('bar.txt', 'baz.txt', {silent: true, preserveMode: true***REMOVED***);
  ...
  ***REMOVED***);
  ...
  test('cpR does not keep file mode when overwriting', function () {
    fs.writeFileSync('bar.txt', 'w00t', {mode: 0o766***REMOVED***);
    fs.writeFileSync('baz.txt', 'w00t!', {mode: 0o744***REMOVED***);
    file.cpR('bar.txt', 'baz.txt');
  ...
  ***REMOVED***);
  ...
  test('cpR copies file mode recursively', function () {
    fs.mkdirSync('foo');
    fs.writeFileSync('foo/bar.txt', 'w00t', {mode: 0o740***REMOVED***);
    file.cpR('foo', 'baz');
  ...
  ***REMOVED***);
  ...
  test('cpR keeps file mode recursively', function () {
    ...
    fs.writeFileSync('baz/foo/bar.txt', 'w00t!', {mode: 0o755***REMOVED***);
    file.cpR('foo', 'baz', {silent: true, preserveMode: true***REMOVED***);
