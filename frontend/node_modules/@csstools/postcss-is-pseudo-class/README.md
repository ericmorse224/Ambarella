...
```js
postcss([
  postcssIsPseudoClass({ preserve: true ***REMOVED***)
]).process(YOUR_CSS /*, processOptions */);
```
...
```js
postcss([
  postcssIsPseudoClass({ specificityMatchingName: 'something-random' ***REMOVED***)
]).process(YOUR_CSS /*, processOptions */);
```
...
```js
postcss([
  postcssIsPseudoClass({ onComplexSelector: 'warning' ***REMOVED***)
]).process(YOUR_CSS /*, processOptions */);
```
...
```js
postcss([
  postcssIsPseudoClass({ onPseudoElement: 'warning' ***REMOVED***)
]).process(YOUR_CSS /*, processOptions */);
```
