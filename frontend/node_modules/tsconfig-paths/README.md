  ...
  "configurations": [
    {
      ...
      "runtimeArgs": [
        "-r",
        "${workspaceFolder***REMOVED***/functions/node_modules/ts-node/register",
        "-r",
        "${workspaceFolder***REMOVED***/functions/node_modules/tsconfig-paths/register"
      ],
      "args": ["${workspaceFolder***REMOVED***/functions/src/index.ts"],
      "cwd": "${workspaceFolder***REMOVED***",
      "protocol": "inspector",
      "env": {
        "NODE_ENV": "development",
        "TS_NODE_PROJECT": "${workspaceFolder***REMOVED***/functions/tsconfig.json"
      ***REMOVED***,
      "outFiles": ["${workspaceFolder***REMOVED***/functions/lib/**/*.js"]
    ***REMOVED***
  ]
***REMOVED***
```
...
export interface ExplicitParams {
  baseUrl: string;
  paths: { [key: string]: Array<string> ***REMOVED***;
