...
```js
postcssCustomMedia({ preserve: true ***REMOVED***)
```
...
```js
const cachedObject = { customMedia: {***REMOVED*** ***REMOVED***;

postcssCustomMedia({
	exportTo: [
		'path/to/file.css',   // @custom-media --small-viewport (max-width: 30em);
		'and/then/this.js',   // module.exports = { customMedia: { '--small-viewport': '(max-width: 30em)' ***REMOVED*** ***REMOVED***
		'and/then/this.mjs',  // export const customMedia = { '--small-viewport': '(max-width: 30em)' ***REMOVED*** ***REMOVED***
		'and/then/that.json', // { "custom-media": { "--small-viewport": "(max-width: 30em)" ***REMOVED*** ***REMOVED***
		cachedObject,
		customMedia => {
			customMedia    // { '--small-viewport': '(max-width: 30em)' ***REMOVED***
		***REMOVED***
