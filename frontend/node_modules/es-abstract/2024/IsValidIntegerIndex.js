...
module.exports = function IsValidIntegerIndex(O, index) {
	...
	***REMOVED***
	...
	if (IsDetachedBuffer(buffer)) { return false; ***REMOVED*** // step 1

	if (!IsIntegralNumber(index)) { return false; ***REMOVED*** // step 2

	if (isNegativeZero(index)) { return false; ***REMOVED*** // step 3
	...
	***REMOVED***
	...
	if (index < 0 || index >= length) { return false; ***REMOVED*** // step 8
