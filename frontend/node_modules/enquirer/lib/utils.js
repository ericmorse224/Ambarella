...
exports.wordWrap = (str, options = {***REMOVED***) => {
  if (!str) return str;

  if (typeof options === 'number') {
    options = { width: options ***REMOVED***;
  ***REMOVED***

  let { indent = '', newline = ('\n' + indent), width = 80 ***REMOVED*** = options;
  let spaces = (newline + indent).match(/[^\S\n]/g) || [];
  width -= spaces.length;
  let source = `.{1,${width***REMOVED******REMOVED***([\\s\\u200B]+|$)|[^\\s\\u200B]+?([\\s\\u200B]+|$)`;
  let output = str.trim();
...
exports.set = (obj = {***REMOVED***, prop = '', val) => {
  return prop.split('.').reduce((acc, k, i, arr) => {
    let value = arr.length - 1 > i ? (acc[k] || {***REMOVED***) : val;
    if (!exports.isObject(value) && i < arr.length - 1) value = {***REMOVED***;
    return (acc[k] = value);
  ***REMOVED***, obj);
***REMOVED***;
...
exports.get = (obj = {***REMOVED***, prop = '', fallback) => {
    ...
    if (hasOwnProperty.call(desc, 'value')) {
      if (hasOwnProperty.call(target, key) && isObject(desc.value)) {
        ...
        if (isObject(existing.value) && existing.value !== desc.value) {
          target[key] = exports.merge({***REMOVED***, target[key], b[key]);
        ***REMOVED*** else {
...
exports.define = (obj, key, value) => {
  Reflect.defineProperty(obj, key, { value ***REMOVED***);
***REMOVED***;
