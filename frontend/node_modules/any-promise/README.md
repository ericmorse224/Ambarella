...
require('any-promise/register')('bluebird', {Promise: require('bluebird')***REMOVED***)
```
...
```javascript
require('../register')('es6-promise', {Promise: require('es6-promise').Promise, global: false***REMOVED***)
```
