          ...
          promise
            .then(async () => {
              if (watcher.isInterrupted()) {
                throw new CancelRun();
              ***REMOVED*** // Remove `if(onStart)` in Jest 27
              ...
              ***REMOVED*** // `deepCyclicCopy` used here to avoid mem-leak
  ...
  ***REMOVED***
  ...
  async _createParallelTestRun(tests, watcher, onStart, onResult, onFailure) {
    ...
    ***REMOVED***);
    ...
    const cleanup = async () => {
      const {forceExited***REMOVED*** = await worker.end();
