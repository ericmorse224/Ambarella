...
test('#62: deep module references and the pathFilter', function (t) {
    t.test('deep/ref.js', function (st) {
        ...
        resolve('deep/ref', { basedir: resolverDir ***REMOVED***, function (err, res, pkg) {
            if (err) st.fail(err);
        ...
        ***REMOVED***);
        ...
        var res = resolve.sync('deep/ref', { basedir: resolverDir ***REMOVED***);
        st.equal(res, path.join(resolverDir, 'node_modules/deep/ref.js'));
    ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    t.test('deep/ref alt', function (st) {
        ...
        var res = resolve.sync(
            'deep/ref',
            { basedir: resolverDir, pathFilter: pathFilter ***REMOVED***
        );
