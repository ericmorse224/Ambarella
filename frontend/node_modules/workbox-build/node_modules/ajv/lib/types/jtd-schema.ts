...
export type SomeJTDSchemaType = (
  ...
  {ref: string***REMOVED***
  // primitives
  | {type: NumberType | StringType | "boolean"***REMOVED***
  // enum
  | {enum: string[]***REMOVED***
  // elements
  | {elements: SomeJTDSchemaType***REMOVED***
  // values
  | {values: SomeJTDSchemaType***REMOVED***
  // properties
  | {
  ...
  | {
    ...
    ***REMOVED***
  // discriminator
  | {discriminator: string; mapping: Record<string, SomeJTDSchemaType>***REMOVED***
  // empty
  // NOTE see the end of
...
export type JTDSchemaType<T, D extends Record<string, unknown> = Record<string, never>> = (
  ...
  (null extends EnumString<keyof D>
      ? never
      :
          | ({[K in keyof D]: [T] extends [D[K]] ? {ref: K***REMOVED*** : never***REMOVED***[keyof D] & {nullable?: false***REMOVED***)
  ...
  | ((true extends NullTypeEquality<T, number>
      ...
      ? {enum: EnumString<Exclude<T, null>>[]***REMOVED***
      ...
      ?
          | {properties: Record<string, never>; optionalProperties?: Record<string, never>***REMOVED***
          | {optionalProperties: Record<string, never>***REMOVED***
      : // values
      ...
      ? ([RequiredKeys<Exclude<T, null>>] extends [never]
          ? {
            ...
            ***REMOVED***
          : {
              properties: {[K in RequiredKeys<T>]: JTDSchemaType<T[K], D>***REMOVED***
            ***REMOVED***) &
  ...
  definitions?: {[K in keyof D]: JTDSchemaType<D[K], D>***REMOVED***
***REMOVED***

type JTDDataDef<S, D extends Record<string, unknown>> =
  | // ref
  (S extends {ref: string***REMOVED***
      ? D extends {[K in S["ref"]]: infer V***REMOVED***
        ? JTDDataDef<V, D>
        : never
      : // type
      S extends {type: NumberType***REMOVED***
      ? number
      : S extends {type: "boolean"***REMOVED***
      ? boolean
      : S extends {type: "string"***REMOVED***
      ? string
      : S extends {type: "timestamp"***REMOVED***
      ? string | Date
      : // enum
      S extends {enum: readonly (infer E)[]***REMOVED***
      ? string extends E
        ? never
        : [E] extends [string]
        ? E
        : never
      : // elements
      S extends {elements: infer E***REMOVED***
      ? JTDDataDef<E, D>[]
      : // properties
      S extends {
          ...
          additionalProperties?: boolean
        ***REMOVED***
      ? {-readonly [K in keyof S["properties"]]-?: JTDDataDef<S["properties"][K], D>***REMOVED*** & {
          -readonly [K in keyof S["optionalProperties"]]+?: JTDDataDef<
            S["optionalProperties"][K],
            D
          >
        ***REMOVED*** & ([S["additionalProperties"]] extends [true] ? Record<string, unknown> : unknown)
      : S extends {
          properties?: Record<string, unknown>
          optionalProperties: Record<string, unknown>
          additionalProperties?: boolean
      ...
      ? {-readonly [K in keyof S["properties"]]-?: JTDDataDef<S["properties"][K], D>***REMOVED*** & {
        ...
        ***REMOVED*** & ([S["additionalProperties"]] extends [true] ? Record<string, unknown> : unknown)
      : // values
      S extends {values: infer V***REMOVED***
      ? Record<string, JTDDataDef<V, D>>
      : // discriminator
      S extends {discriminator: infer M; mapping: Record<string, unknown>***REMOVED***
      ? [M] extends [string]
        ? {
            [K in keyof S["mapping"]]: JTDDataDef<S["mapping"][K], D> & {[KM in M]: K***REMOVED***
          ***REMOVED***[keyof S["mapping"]]
        : never
      : // empty
        unknown)
  | (S extends {nullable: true***REMOVED*** ? null : never)

export type JTDDataType<S> = S extends {definitions: Record<string, unknown>***REMOVED***
