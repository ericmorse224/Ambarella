...
var _arrayIncludes = require('array-includes');var _arrayIncludes2 = _interopRequireDefault(_arrayIncludes);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***

/*
                                                                                                                                                                                                            Notes on TypeScript namespaces aka TSModuleDeclaration:
                                                                                                                                                                                                            
                                                                                                                                                                                                            There are two forms:
                                                                                                                                                                                                            - active namespaces: namespace Foo {***REMOVED*** / module Foo {***REMOVED***
                                                                                                                                                                                                            - ambient modules; declare module "eslint-plugin-import" {***REMOVED***
                                                                                                                                                                                                            
                                                                                                                                                                                                            active namespaces:
                                                                                                                                                                                                            - cannot contain a default export
                                                                                                                                                                                                            - cannot contain an export all
                                                                                                                                                                                                            - cannot contain a multi name export (export { a, b ***REMOVED***)
...
/**
                             ...
                             * ```
                             * @param {Set<Object>***REMOVED*** nodes
                             */
...
/**
   ...
   * ```ts
   * export class Foo { ***REMOVED***
   * export namespace Foo { ***REMOVED***
   * ```
   * @param {Set<Object>***REMOVED*** nodes
   * @returns {boolean***REMOVED***
   */
function isTypescriptNamespaceMerging(nodes) {
  var types = new Set(Array.from(nodes, function (node) {return node.parent.type;***REMOVED***));
  var noNamespaceNodes = Array.from(nodes).filter(function (node) {return node.parent.type !== 'TSModuleDeclaration';***REMOVED***);
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('export') ***REMOVED***,
      ...
      ***REMOVED***
      ...
      return {
        ...
        ExportSpecifier: function () {function ExportSpecifier(node) {
          ...
          ***REMOVED***return ExportSpecifier;***REMOVED***(),

        ExportNamedDeclaration: function () {function ExportNamedDeclaration(node) {
            if (node.declaration == null) {return;***REMOVED***
            ...
            ***REMOVED***
            ...
            if (node.declaration.declarations != null) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
                for (var _iterator = node.declaration.declarations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var declaration = _step.value;
                  (0, _patternCapture2['default'])(declaration.id, function (v) {addNamed(v.name, v, parent, isTypeVariableDecl);***REMOVED***);
            ...
            ***REMOVED***
          ***REMOVED***return ExportNamedDeclaration;***REMOVED***(),

        ExportAllDeclaration: function () {function ExportAllDeclaration(node) {
            if (node.source == null) {return;***REMOVED*** // not sure if this is ever true

            // `export * as X from 'path'` does not conflict
            if (node.exported && node.exported.name) {return;***REMOVED***

            var remoteExports = _builder2['default'].get(node.source.value, context);
            if (remoteExports == null) {return;***REMOVED***
            ...
            ***REMOVED***
          ***REMOVED***return ExportAllDeclaration;***REMOVED***(),
        ...
        'Program:exit': function () {function ProgramExit() {var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
              for (var _iterator2 = namespace[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var _ref = _step2.value;var _ref2 = _slicedToArray(_ref, 2);var named = _ref2[1];var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
                  for (var _iterator3 = named[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var _ref3 = _step3.value;var _ref4 = _slicedToArray(_ref3, 2);var name = _ref4[0];var nodes = _ref4[1];
                    ...
                    if (nodes.size <= 1) {continue;***REMOVED***

                    if (isTypescriptNamespaceMerging(nodes)) {continue;***REMOVED***var _iteratorNormalCompletion4 = true;var _didIteratorError4 = false;var _iteratorError4 = undefined;try {
                      ...
                      for (var _iterator4 = nodes[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {var node = _step4.value;
                        if (shouldSkipTypescriptNamespace(node, nodes)) {continue;***REMOVED***
                        ...
                        ***REMOVED***
                      ***REMOVED******REMOVED*** catch (err) {_didIteratorError4 = true;_iteratorError4 = err;***REMOVED*** finally {try {if (!_iteratorNormalCompletion4 && _iterator4['return']) {_iterator4['return']();***REMOVED******REMOVED*** finally {if (_didIteratorError4) {throw _iteratorError4;***REMOVED******REMOVED******REMOVED***
