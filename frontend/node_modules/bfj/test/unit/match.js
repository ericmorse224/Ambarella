...
suite('match:', () => {
  ...
  ***REMOVED***)
  ...
  suite('require, results.push returns true:', () => {
    ...
    setup(() => {
      log = {***REMOVED***
      resume = spooks.fn({ name: 'resume', log ***REMOVED***)
      results = {
        walk: [
          {
            on: spooks.fn({ name: 'on', log: log ***REMOVED***),
            pause: spooks.fn({ name: 'pause', log: log, results: [ resume ] ***REMOVED***)
          ***REMOVED***
        ],
        push: [ true ]
      ***REMOVED***
      match = proxyquire(modulePath, {
        ...
        ***REMOVED***),
        './datastream': spooks.ctor({
          name: 'DataStream',
          log: log,
          archetype: { instance: { push: () => {***REMOVED***, emit: () => {***REMOVED*** ***REMOVED*** ***REMOVED***,
          results: results
        ***REMOVED***)
      ***REMOVED***)
    ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    test('match does not throw with match function', () => {
      assert.doesNotThrow(() => match(null, () => {***REMOVED***))
    ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    test('match throws with invalid match arg', () => {
      assert.throws(() => match(null, {***REMOVED***))
    ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with predicate returning true:', () => {
      ...
      setup(() => {
        stream = {***REMOVED***
        predicate = spooks.fn({ name: 'predicate', log, results: [ true ] ***REMOVED***)
        options = { foo: 'bar', highWaterMark: 42 ***REMOVED***
      ...
      ***REMOVED***)
      ...
      test('DataStream was called correctly', () => {
        ...
        assert.deepEqual(log.args.DataStream[0][1], { highWaterMark: 42 ***REMOVED***)
      ***REMOVED***)
                      ...
                      suite('endObject event:', () => {
                        ...
                        ***REMOVED***)
                        ...
                        test('predicate was called correctly', () => {
                          ...
                          assert.deepEqual(log.args.predicate[2][1], {***REMOVED***)
                        ...
                        ***REMOVED***)
                        ...
                        test('results.push was called correctly', () => {
                          assert.deepEqual(log.args.push[2][0], {***REMOVED***)
                        ***REMOVED***)
                        ...
                        suite('endObject event:', () => {
                          ...
                          ***REMOVED***)
                          ...
                          test('predicate was called correctly', () => {
                            ...
                            assert.deepEqual(log.args.predicate[3][1], { bar: 'baz', nested: {***REMOVED*** ***REMOVED***)
                          ...
                          ***REMOVED***)
                          ...
                          test('results.push was called correctly', () => {
                            assert.deepEqual(log.args.push[3][0], { bar: 'baz', nested: {***REMOVED*** ***REMOVED***)
                          ***REMOVED***)
        ...
        suite('all events then read:', () => {
          ...
          ***REMOVED***)
          ...
          test('predicate was called correctly second time', () => {
            ...
            assert.deepEqual(log.args.predicate[1][1], { foo: 'bar' ***REMOVED***)
            assert.strictEqual(log.args.predicate[1][2], 1)
          ***REMOVED***)
          ...
          ***REMOVED***)
          ...
          test('predicate was called correctly sixth time', () => {
            ...
            assert.deepEqual(log.args.predicate[5][1], [ { foo: 'bar' ***REMOVED***, '', 0, null, false ])
    ...
    ***REMOVED***)
    ...
    suite('match with predicate returning false:', () => {
      ...
      setup(() => {
        predicate = spooks.fn({ name: 'predicate', log, results: [ false ] ***REMOVED***)
        result = match({***REMOVED***, predicate, {***REMOVED***)
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with string:', () => {
      ...
      setup(() => {
        result = match({***REMOVED***, 'foo', {***REMOVED***)
      ***REMOVED***)
      ...
      ***REMOVED***)
      ...
      suite('read events:', () => {
        setup(() => {
          log.args.DataStream[0][0]()
          // { "foo": "bar", "baz": "qux", "foo": "wibble" ***REMOVED***
          log.args.on[1][1]()
          log.args.on[2][1]('foo')
          log.args.on[5][1]('bar')
          log.args.on[2][1]('baz')
    ...
    ***REMOVED***)
    ...
    suite('match with regular expression:', () => {
      ...
      setup(() => {
        result = match({***REMOVED***, /oo/, {***REMOVED***)
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with jsonpath expression:', () => {
      ...
      setup(() => {
        result = match({***REMOVED***, '$.foo.bar[*]', {***REMOVED***)
      ***REMOVED***)
      ...
      ***REMOVED***)
      ...
      suite('read events:', () => {
        setup(() => {
          log.args.DataStream[0][0]()
          // { "foo": { "bar": [ "baz", "qux" ], "wibble": "blee" ***REMOVED*** ***REMOVED***
          log.args.on[1][1]()
          log.args.on[2][1]('foo')
          log.args.on[1][1]()
          log.args.on[2][1]('bar')
    ...
    ***REMOVED***)
    ...
    suite('match with numbers=true:', () => {
      ...
      setup(() => {
        result = match({***REMOVED***, '1', { numbers: true ***REMOVED***)
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with bufferLength=3:', () => {
      ...
      setup(() => {
        result = match({***REMOVED***, 'foo', { bufferLength: 3 ***REMOVED***)
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with minDepth=1:', () => {
      ...
      setup(() => {
        predicate = spooks.fn({ name: 'predicate', log, results: [ true ] ***REMOVED***)
        result = match({***REMOVED***, predicate, { minDepth: 1 ***REMOVED***)
      ***REMOVED***)
      ...
      ***REMOVED***)
      ...
      suite('read events:', () => {
        setup(() => {
          log.args.DataStream[0][0]()
          // { "foo": { "bar": { "baz": "qux" ***REMOVED*** ***REMOVED*** ***REMOVED***
          log.args.on[1][1]()
          log.args.on[2][1]('foo')
          log.args.on[1][1]()
          log.args.on[2][1]('bar')
        ...
        ***REMOVED***)
        ...
        test('results.push was called correctly second time', () => {
          ...
          assert.lengthOf(args, 1)
          assert.deepEqual(args[0], { baz: 'qux' ***REMOVED***)
        ***REMOVED***)

        test('results.push was called correctly third time', () => {
          const args = log.args.push[2]
          assert.lengthOf(args, 1)
          assert.deepEqual(args[0], { bar: { baz: 'qux' ***REMOVED*** ***REMOVED***)
        ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('match with minDepth=2:', () => {
      ...
      setup(() => {
        predicate = spooks.fn({ name: 'predicate', log, results: [ true ] ***REMOVED***)
        result = match({***REMOVED***, predicate, { minDepth: 2 ***REMOVED***)
      ***REMOVED***)
