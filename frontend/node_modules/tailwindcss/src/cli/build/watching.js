...
import { readFileWithRetries ***REMOVED*** from './utils.js'
 ...
 *
 * @param {****REMOVED*** args
 * @param {{ state, rebuild(changedFiles: any[]): Promise<any> ***REMOVED******REMOVED*** param1
 * @returns {{
 *   fswatcher: import('chokidar').FSWatcher,
 *   refreshWatchedFiles(): void,
 * ***REMOVED******REMOVED***
 */
export function createWatcher(args, { state, rebuild ***REMOVED***) {
  ...
  ***REMOVED***)
   ...
   *
   * @type {{file: string, content: () => Promise<string>, extension: string***REMOVED***[]***REMOVED***
   */
  let changedContent = []
  ...
  ***REMOVED***
   ...
   *
   * @param {****REMOVED*** file
   * @param {(() => Promise<string>) | null***REMOVED*** content
   * @param {boolean***REMOVED*** skipPendingCheck
