...
const { matchesDontThrow ***REMOVED*** = require("./selectors");

const { forEach, indexOf ***REMOVED*** = Array.prototype;
    ...
    forEach.call(sheet.cssRules, rule => {
      if (rule.media) {
        if (indexOf.call(rule.media, "screen") !== -1) {
          ...
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED*** else if (matches(rule, elementImpl)) {
        handleRule(rule);
      ***REMOVED***
    ***REMOVED***);
  ***REMOVED***
...
function getSpecifiedValue(element, property) {
  ...
  ***REMOVED***
  ...
  // Defaulting
  const { initial, inherited ***REMOVED*** = exports.propertiesWithResolvedValueImplemented[property];
...
function getComputedValue(element, property) {
  const { computedValue ***REMOVED*** = exports.propertiesWithResolvedValueImplemented[property];
  if (computedValue === "as-specified") {
    return getSpecifiedValue(element, property);
  ***REMOVED***

  throw new TypeError(`Internal error: unrecognized computed value instruction '${computedValue***REMOVED***'`);
***REMOVED***
