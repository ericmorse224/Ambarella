...
import { decodeInt32, decodeUInt32, MAX_NUMBER_OF_BYTE_U32, decodeInt64, decodeUInt64, MAX_NUMBER_OF_BYTE_U64 ***REMOVED*** from "@webassemblyjs/leb128";
...
export function decode(ab, opts) {
      ...
      if (descrType === "func") {
        ...
        ***REMOVED***
        ...
        state.functionsInModule.push({
          ...
          isExternal: true
        ***REMOVED***);
      ***REMOVED*** else if (descrType === "global") {
        importDescr = parseGlobalType();
        var globalNode = t.global(importDescr, []);
        state.globalsInModule.push(globalNode);
      ***REMOVED*** else if (descrType === "table") {
        importDescr = parseTableType(i);
      ***REMOVED*** else if (descrType === "memory") {
  ...
  ***REMOVED*** // Function section
  ...
  function parseFuncSection(numberOfFunctions) {
    ...
    for (var i = 0; i < numberOfFunctions; i++) {
      ...
      if (typeof signature === "undefined") {
        throw new CompileError("function signature not found (".concat(typeindex, ")"));
      ***REMOVED*** // preserve anonymous, a name might be resolved later
  ...
  ***REMOVED*** // Export section
  ...
  function parseExportSection(numberOfExport) {
    ...
    for (var i = 0; i < numberOfExport; i++) {
      ...
      ***REMOVED*** else if (constants.exportTypes[typeIndex] === "Table") {
        ...
        ***REMOVED***
        ...
        id = t.numberLiteralFromRaw(index, String(index));
        signature = null;
      ***REMOVED*** else if (constants.exportTypes[typeIndex] === "Memory") {
        ...
        ***REMOVED***
        ...
        id = t.numberLiteralFromRaw(index, String(index));
        signature = null;
      ***REMOVED*** else if (constants.exportTypes[typeIndex] === "Global") {
  ...
  ***REMOVED***
  ...
  function parseInstructionBlock(code) {
    while (true) {
      ...
      ***REMOVED*** else if (instruction.name === "if") {
        ...
        ***REMOVED***();
        ...
        code.push(ifNode);
        instructionAlreadyCreated = true;
      ***REMOVED*** else if (instruction.name === "block") {
        ...
        ***REMOVED***();
        ...
        code.push(blockNode);
        instructionAlreadyCreated = true;
      ***REMOVED*** else if (instruction.name === "call") {
        var indexu32 = readU32();
        var index = indexu32.value;
        eatBytes(indexu32.nextIndex);
        dump([index], "index");
        ...
        ***REMOVED***();
        ...
        code.push(callNode);
        instructionAlreadyCreated = true;
      ***REMOVED*** else if (instruction.name === "call_indirect") {
        ...
        ***REMOVED***());
        instructionAlreadyCreated = true;
      ***REMOVED*** else if (instruction.name === "br_table") {
        ...
        ***REMOVED***
      ***REMOVED*** else if (instructionByte >= 0x28 && instructionByte <= 0x40) {
        /**
         * Memory instructions
         */
        ...
        ***REMOVED*** else {
          ...
          if (namedArgs === undefined) namedArgs = {***REMOVED***;
          namedArgs.offset = t.numberLiteralFromRaw(_offset2);
        ***REMOVED***
      ***REMOVED*** else if (instructionByte >= 0x41 && instructionByte <= 0x44) {
        /**
        ...
        ***REMOVED***
      ***REMOVED*** else if (instructionByte >= 0xfe00 && instructionByte <= 0xfeff) {
        /**
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED*** // https://webassembly.github.io/spec/core/binary/types.html#limits
  ...
  ***REMOVED*** // https://webassembly.github.io/spec/core/binary/types.html#binary-tabletype
  ...
  ***REMOVED*** // https://webassembly.github.io/spec/binary/types.html#global-types
  ...
  ***REMOVED*** // function parseNameModule() {
  ...
  ***REMOVED***
  ...
  function parseNameSectionLocals() {
    ...
    ***REMOVED***
    ...
    return localNames;
  ***REMOVED*** // this is a custom section used for name resolution
  ...
  function parseNameSection(remainingBytes) {
    ...
    ***REMOVED***
    ...
    return nameMetadata;
  ***REMOVED*** // this is a custom section used for information about the producers
  ...
  function parseElemSection(numberOfElements) {
    ...
    for (var i = 0; i < numberOfElements; i++) {
      ...
      ***REMOVED*** else if (bitfield === 1) {
        ...
        ***REMOVED*** // TODO: emit a AST node, for now just make it parse.

      ***REMOVED*** else if (bitfield === 2) {
        var u32 = readU32();
    ...
    ***REMOVED***
    ...
    return elems;
  ***REMOVED*** // https://webassembly.github.io/spec/core/binary/types.html#memory-types


  function parseMemoryType(i) {
    var limits = parseLimits();
    return t.memory(limits, t.indexLiteral(i));
  ***REMOVED*** // https://webassembly.github.io/spec/binary/modules.html#table-section
  ...
  function parseTableSection(numberOfElements) {
    ...
    ***REMOVED***
    ...
    return tables;
  ***REMOVED*** // https://webassembly.github.io/spec/binary/modules.html#memory-section
  ...
  function parseMemorySection(numberOfElements) {
    ...
    ***REMOVED***
    ...
    return memories;
  ***REMOVED*** // https://webassembly.github.io/spec/binary/modules.html#binary-startsec
  ...
  function parseStartSection() {
    ...
    ***REMOVED***();
  ***REMOVED*** // https://webassembly.github.io/spec/binary/modules.html#data-section
  ...
  function parseDataSection(numberOfElements) {
    ...
    ***REMOVED***
    ...
    return dataEntries;
  ***REMOVED*** // https://webassembly.github.io/spec/binary/modules.html#binary-section
      ...
      case constants.sections.custom:
        {
          ...
          if (sectionName.value === "name") {
            ...
            ***REMOVED***
          ***REMOVED*** else if (sectionName.value === "producers") {
  ...
  ***REMOVED***;
  ...
  while (offset < buf.length) {
    ...
    metadataArray.forEach(function (metadataItem) {
      ...
      ***REMOVED*** else if (metadataItem.type === "LocalNameMetadata") {
        moduleMetadata.localNames.push(metadataItem); // $FlowIgnore
      ***REMOVED*** else if (metadataItem.type === "ProducersSectionMetadata") {
        moduleMetadata.producers.push(metadataItem);
      ***REMOVED*** else {
        moduleMetadata.sections.push(metadataItem);
      ***REMOVED***
    ***REMOVED***); // Ignore custom section
  ...
  ***REMOVED***
  ...
  state.functionsInModule.forEach(function (func) {
    ...
    ***REMOVED*** // Add function position in the binary if possible
