...
const messages = {
  bracketLocation: 'The closing bracket must be {{location***REMOVED******REMOVED***{{details***REMOVED******REMOVED***',
***REMOVED***;
...
module.exports = {
  ...
  ***REMOVED***,
  ...
  create(context) {
    ...
    ***REMOVED*** else if (typeof config === 'object') {
      // [1, {location: 'something'***REMOVED***] (back-compat)
      if (has(config, 'location')) {
        options.nonEmpty = config.location;
        options.selfClosing = config.location;
      ***REMOVED***
      // [1, {nonEmpty: 'something'***REMOVED***]
      if (has(config, 'nonEmpty')) {
        options.nonEmpty = config.nonEmpty;
      ***REMOVED***
      // [1, {selfClosing: 'something'***REMOVED***]
    ...
    ***REMOVED***
     ...
     * @param {Object***REMOVED*** tokens Locations of the opening bracket, closing bracket and last prop
     * @return {string***REMOVED*** Expected location for the closing bracket
     */
    function getExpectedLocation(tokens) {
      ...
      ***REMOVED*** else if (tokens.opening.line === tokens.lastProp.lastLine) {
    ...
    ***REMOVED***
     ...
     * expected location.
     * @param {Object***REMOVED*** tokens Locations of the opening bracket, closing bracket and last prop
     * @param {string***REMOVED*** expectedLocation Expected location for the closing bracket
     * @return {?Number***REMOVED*** The correct column for the closing bracket, or null
     */
    ...
    ***REMOVED***
     ...
     * @param {Object***REMOVED*** tokens Locations of the opening bracket, closing bracket and last prop
     * @param {string***REMOVED*** expectedLocation Expected location for the closing bracket
     * @return {boolean***REMOVED*** True if the closing bracket is correctly located, false if not
     */
    ...
    ***REMOVED***
     ...
     * @param {Object***REMOVED*** tokens Locations of the opening bracket, closing bracket and last prop
     * @param {string***REMOVED*** expectedLocation Expected location for the closing bracket
     * @param {number***REMOVED*** [correctColumn] Expected column for the closing bracket. Default to 0
     * @return {string***REMOVED*** The characters used for indentation
     */
    ...
    ***REMOVED***
     ...
     * @return {Object***REMOVED*** Locations of the opening bracket, closing bracket, last
    ...
    ***REMOVED***
     ...
     * @returns {string***REMOVED*** Unique ID (based on its range)
     */
    function getOpeningElementId(node) {
      return node.range.join(':');
    ***REMOVED***

    const lastAttributeNode = {***REMOVED***;
      ...
      'JSXOpeningElement:exit'(node) {
        ...
        ***REMOVED***;
        ...
        if (correctColumn !== null) {
          ...
          data.details = ` (expected column ${correctColumn + 1***REMOVED***${expectedNextLine ? ' on the next line)' : ')'***REMOVED***`;
        ***REMOVED***
        ...
        report(context, messages.bracketLocation, 'bracketLocation', {
          ...
          fix(fixer) {
            ...
            switch (expectedLocation) {
              ...
              case 'line-aligned':
                return fixer.replaceTextRange([cachedLastAttributeEndPos, node.range[1]],
                  `\n${getIndentation(tokens, expectedLocation, correctColumn)***REMOVED***${closingTag***REMOVED***`);
              default:
                return true;
            ***REMOVED***
          ***REMOVED***,
