...
// Adding export {***REMOVED*** here to shut off automatic exporting from index.d.ts. There
...
export type LiteralUnion<T extends U, U = string> = T | (Pick<U, never> & { _?: never | undefined ***REMOVED***);
...
type ArrayProperties<T> = { [K in keyof T]: NonNullable<T[K]> extends any[] ? K : never ***REMOVED***[keyof T];

// A union of the properties of the given array T that can be used to index it.
// If the array is a tuple, then that's going to be the explicit indices of the
// array, otherwise it's going to just be number.
type IndexProperties<T extends { length: number ***REMOVED***> = IsTuple<T> extends true
...
export interface Options extends Partial<RequiredOptions> {***REMOVED***
...
export interface Plugin<T = any> {
    ...
    parsers?: { [parserName: string]: Parser<T> ***REMOVED*** | undefined;
    printers?: { [astFormat: string]: Printer<T> ***REMOVED*** | undefined;
    options?: SupportOptions | undefined;
    defaultOptions?: Partial<RequiredOptions> | undefined;
***REMOVED***

export interface Parser<T = any> {
    parse: (text: string, parsers: { [parserName: string]: Parser ***REMOVED***, options: ParserOptions<T>) => T;
    astFormat: string;
...
export interface BaseSupportOption<Type extends SupportOptionType> {
    ...
    since: string;
    /**
     * Usually you can use {@link CoreCategoryType***REMOVED***
     */
    category: string;
    /**
     ...
     * treated as taking any string as argument, and `--option <${type***REMOVED***>` will
...
export interface IntArraySupportOption extends BaseSupportOption<'int'> {
    default?: Array<{ value: number[] ***REMOVED***> | undefined;
    array: true;
***REMOVED***
...
export interface StringArraySupportOption extends BaseSupportOption<'string'> {
    default?: Array<{ value: string[] ***REMOVED***> | undefined;
    array: true;
***REMOVED***
...
export interface BooleanArraySupportOption extends BaseSupportOption<'boolean'> {
    default?: Array<{ value: boolean[] ***REMOVED***> | undefined;
    array: true;
***REMOVED***

export interface ChoiceSupportOption<Value = any> extends BaseSupportOption<'choice'> {
    default?: Value | Array<{ since: string; value: Value ***REMOVED***> | undefined;
    description: string;
    choices: Array<{
        since?: string | undefined;
        value: Value;
...
export interface SupportOptions extends Record<string, SupportOption> {***REMOVED***
...
export namespace doc {
    namespace builders {
        ...
        interface Align {
            type: 'align';
            contents: Doc;
            n: number | string | { type: 'root' ***REMOVED***;
        ***REMOVED***
        ...
        ***REMOVED***
        ...
        function ifBreak(ifBreak: Doc, noBreak?: Doc, options?: { groupId?: symbol | undefined ***REMOVED***): IfBreak;
        ...
        function indentIfBreak(doc: Doc, opts: { groupId: symbol; negate?: boolean | undefined ***REMOVED***): IndentIfBreak;
