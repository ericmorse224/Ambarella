 ...
 * @param {bigint[]***REMOVED*** masks The module masks to intersect
 * @returns {bigint***REMOVED*** The intersection of all masks
 */
 ...
 * @param {bigint***REMOVED*** mask the module mask
 * @param {Module[]***REMOVED*** ordinalModules the modules in the order they were added to the mask (LSB is index 0)
 * @returns {Generator<Module>***REMOVED*** the modules represented by the mask
 */
...
class RemoveParentModulesPlugin {
	...
	apply(compiler) {
		compiler.hooks.compilation.tap(PLUGIN_NAME, compilation => {
			 ...
			 * @param {ChunkGroup[]***REMOVED*** chunkGroups the chunk groups
			 */
			const handler = (chunks, chunkGroups) => {
				 ...
				 * @param {Module***REMOVED*** mod the module to get the mask for
				 * @returns {bigint***REMOVED*** the module mask to uniquely identify the module
				 */
