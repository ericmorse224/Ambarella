  ...
  return {
    getMetadata: function (key) {
      ...
      ***REMOVED*** else if (kind === 2) {
        ...
        ***REMOVED***
      ***REMOVED*** else if (Object.hasOwnProperty.call(metadataForKey, "constructor")) {
    ...
    ***REMOVED***,
    setMetadata: function (key, value) {
      ...
      if (metadataForKey === void 0) {
        metadataForKey = metadataMap[key] = {***REMOVED***;
      ***REMOVED***
      if (kind === 1) {
        var pub = metadataForKey.public;
        if (pub === void 0) {
          pub = metadataForKey.public = {***REMOVED***;
        ***REMOVED***
        pub[property] = value;
      ***REMOVED*** else if (kind === 2) {
        ...
        ***REMOVED***
        if (newInit !== void 0) {
          if (initializer === void 0) {
            initializer = newInit;
          ***REMOVED*** else if (typeof initializer === "function") {
    ...
    for (var i = classDecs.length - 1; i >= 0; i--) {
      ...
      ***REMOVED***;
      try {
        ...
        ***REMOVED***, old_createMetadataMethodsForProperty(metadataMap, 0, name, decoratorFinishedRef));
...
function applyDecs(targetClass, memberDecs, classDecs) {
  var ret = [];
  var staticMetadataMap = {***REMOVED***;
  var protoMetadataMap = {***REMOVED***;
