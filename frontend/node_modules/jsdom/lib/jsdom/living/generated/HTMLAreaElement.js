...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'HTMLAreaElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(HTMLAreaElement.prototype, {
    alt: { enumerable: true ***REMOVED***,
    coords: { enumerable: true ***REMOVED***,
    shape: { enumerable: true ***REMOVED***,
    target: { enumerable: true ***REMOVED***,
    rel: { enumerable: true ***REMOVED***,
    relList: { enumerable: true ***REMOVED***,
    noHref: { enumerable: true ***REMOVED***,
    href: { enumerable: true ***REMOVED***,
    toString: { enumerable: true ***REMOVED***,
    origin: { enumerable: true ***REMOVED***,
    protocol: { enumerable: true ***REMOVED***,
    username: { enumerable: true ***REMOVED***,
    password: { enumerable: true ***REMOVED***,
    host: { enumerable: true ***REMOVED***,
    hostname: { enumerable: true ***REMOVED***,
    port: { enumerable: true ***REMOVED***,
    pathname: { enumerable: true ***REMOVED***,
    search: { enumerable: true ***REMOVED***,
    hash: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "HTMLAreaElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
