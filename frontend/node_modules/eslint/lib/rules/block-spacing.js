...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {ASTNode***REMOVED*** node A BlockStatement/SwitchStatement node to get.
        ...
        ***REMOVED***
        ...
        function checkSpacingInsideBraces(node) {
            ...
            const firstToken = sourceCode.getTokenAfter(openBrace, { includeComments: true ***REMOVED***);
            const lastToken = sourceCode.getTokenBefore(closeBrace, { includeComments: true ***REMOVED***);
