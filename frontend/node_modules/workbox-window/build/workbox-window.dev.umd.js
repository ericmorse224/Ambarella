(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.workbox = {***REMOVED***));
***REMOVED***(this, (function (exports) { 'use strict';
    ...
    */
    ...
    function dontWaitFor(promise) {
      // Effective no-op.
      void promise.then(function () {***REMOVED***);
    ***REMOVED***
    ...
    var Workbox = /*#__PURE__*/function (_WorkboxEventTarget) {
      ...
      function Workbox(scriptURL, registerOptions) {
        ...
        if (registerOptions === void 0) {
          registerOptions = {***REMOVED***;
        ***REMOVED***

        _this = _WorkboxEventTarget.call(this) || this;
        _this._registerOptions = {***REMOVED***;
        ...
        _this._onMessage = _async(function (originalEvent) {
          ...
          return _await(_this.getSW(), function () {
            if (_this._ownSWs.has(source)) {
              ...
              ***REMOVED***));
            ***REMOVED***
          ***REMOVED***); // If the service worker that sent the message is in the list of own
      ...
      ***REMOVED***
      ...
      _proto.register = function register(_temp) {
        var _ref = _temp === void 0 ? {***REMOVED*** : _temp,
    ...
    ***REMOVED***(WorkboxEventTarget);
    ...
    function _invoke(body, then) {
      ...
      ***REMOVED***
      ...
      return then(result);
    ***REMOVED*** // The jsdoc comments below outline the events this instance may dispatch:
    // -----------------------------------------------------------------------
