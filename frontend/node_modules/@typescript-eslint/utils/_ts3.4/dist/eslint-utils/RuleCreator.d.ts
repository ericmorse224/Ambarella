import { RuleContext, RuleListener, RuleMetaData, RuleMetaDataDocs, RuleModule ***REMOVED*** from '../ts-eslint/Rule';
...
***REMOVED*** & Pick<RuleMetaData<TMessageIds>, Exclude<keyof RuleMetaData<TMessageIds>, 'docs'>>;
 ...
 */
declare function createRule<TOptions extends readonly unknown[], TMessageIds extends string, TRuleListener extends RuleListener = RuleListener>({ create, defaultOptions, meta, ***REMOVED***: Readonly<RuleWithMeta<TOptions, TMessageIds, TRuleListener>>): RuleModule<TMessageIds, TOptions, TRuleListener>;
export {***REMOVED***;
