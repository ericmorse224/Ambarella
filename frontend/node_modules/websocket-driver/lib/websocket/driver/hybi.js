...
var Hybi = function(request, url, options) {
  ...
  if (protos !== undefined) {
    ...
    this.protocol = protos.filter(function(p) { return supported.indexOf(p) >= 0 ***REMOVED***)[0];
  ***REMOVED***
...
var instance = {
  ...
  ***REMOVED***,
  ...
  UTF8_MATCH: /^([\x00-\x7F]|[\xC2-\xDF][\x80-\xBF]|\xE0[\xA0-\xBF][\x80-\xBF]|[\xE1-\xEC\xEE\xEF][\x80-\xBF]{2***REMOVED***|\xED[\x80-\x9F][\x80-\xBF]|\xF0[\x90-\xBF][\x80-\xBF]{2***REMOVED***|[\xF1-\xF3][\x80-\xBF]{3***REMOVED***|\xF4[\x80-\x8F][\x80-\xBF]{2***REMOVED***)*$/,
  ...
  ***REMOVED***,
  ...
  close: function(reason, code) {
    ...
    if (this.readyState <= 0) {
      ...
      return true;
    ***REMOVED*** else if (this.readyState === 1) {
      this.readyState = 2;
      this._extensions.close(function() { this.frame(reason, 'close', code) ***REMOVED***, this);
      return true;
    ***REMOVED*** else {
      return false;
    ***REMOVED***
