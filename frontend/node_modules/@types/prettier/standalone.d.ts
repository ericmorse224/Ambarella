import { CursorOptions, CursorResult, Options, SupportInfo ***REMOVED*** from './';
 ...
 *
 * ```js
 * prettier.formatWithCursor(" 1", { cursorOffset: 2, parser: "babel" ***REMOVED***);
 * ```
 * `-> { formatted: '1;\n', cursorOffset: 1 ***REMOVED***`
 */
