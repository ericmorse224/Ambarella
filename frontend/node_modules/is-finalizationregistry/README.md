...
assert(!isFinalizationRegistry(function () {***REMOVED***));
assert(!isFinalizationRegistry(null));
assert(!isFinalizationRegistry(function* () { yield 42; return Infinity; ***REMOVED***);
...
assert(!isFinalizationRegistry(new WeakRef({***REMOVED***)));

assert(isFinalizationRegistry(new FinalizationRegistry(function () {***REMOVED***)));

class MyFinalizationRegistry extends FinalizationRegistry {***REMOVED***
assert(isFinalizationRegistry(new MyFinalizationRegistry(function () {***REMOVED***)));
```
