...
function ArgumentParser(options) {
  ...
  ***REMOVED***
  ...
  this._positionals = this.addArgumentGroup({ title: 'Positional arguments' ***REMOVED***);
  this._optionals = this.addArgumentGroup({ title: 'Optional arguments' ***REMOVED***);
...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  ***REMOVED***);
  ...
  var optionStringIndices = {***REMOVED***;
  ...
  ***REMOVED***);
  ...
  while (startIndex <= maxOptionStringIndex) {
    ...
    for (position in optionStringIndices) {
      if (!optionStringIndices.hasOwnProperty(position)) { continue; ***REMOVED***
...
ArgumentParser.prototype._parseOptional = function (argString) {
  ...
  ***REMOVED*** else if (optionTuples.length === 1) {
...
ArgumentParser.prototype._getOptionTuples = function (optionString) {
  ...
  // separate
  ***REMOVED*** else if (chars.indexOf(optionString[0]) >= 0 && chars.indexOf(optionString[1]) < 0) {
    optionPrefix = optionString;
    argExplicit = null;
    ...
    for (actionOptionString in this._optionStringActions) {
      ...
      ***REMOVED*** else if (actionOptionString.substr(0, optionPrefix.length) === optionPrefix) {
        result.push([ action, actionOptionString, argExplicit ]);
      ***REMOVED***
    ***REMOVED***
...
ArgumentParser.prototype._getValues = function (action, argStrings) {
  ...
  ***REMOVED*** else if (action.nargs === c.REMAINDER) {
    value = argStrings.map(function (v) {
      return self._getValue(action, v);
    ***REMOVED***);

  // PARSER arguments convert all values, but check only the first
  ***REMOVED*** else if (action.nargs === c.PARSER) {
    value = argStrings.map(function (v) {
      return self._getValue(action, v);
    ***REMOVED***);
...
ArgumentParser.prototype._checkValue = function (action, value) {
  ...
  if (choices) {
    ...
    ***REMOVED*** else if (Array.isArray(choices)) {
...
ArgumentParser.prototype._getFormatter = function () {
  ...
  var formatter = new FormatterClass({ prog: this.prog ***REMOVED***);
  return formatter;
***REMOVED***;
