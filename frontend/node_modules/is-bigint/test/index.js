...
test('non-BigInt values', function (t) {
	/** @type {(typeof v.primitives[number] | object)[]***REMOVED*** */
...
test('faked BigInt values', function (t) {
	t.test('real BigInt valueOf', { skip: !hasBigInts ***REMOVED***, function (st) {
		var fakeBigInt = { valueOf: function () { return BigInt(42); ***REMOVED*** ***REMOVED***;
		st.equal(false, isBigInt(fakeBigInt), 'object with valueOf returning a BigInt is not a BigInt');
		st.end();
	***REMOVED***);

	t.test('faked @@toStringTag', { skip: !hasBigInts || !hasToStringTag ***REMOVED***, function (st) {
		/** @type {{ valueOf(): unknown; [Symbol.toStringTag]?: unknown ***REMOVED******REMOVED*** */
		var fakeBigInt = { valueOf: function () { return BigInt(42); ***REMOVED*** ***REMOVED***;
		...
		/** @type {{ valueOf(): unknown; [Symbol.toStringTag]?: unknown ***REMOVED******REMOVED*** */
		var notSoFakeBigInt = { valueOf: function () { return 42; ***REMOVED*** ***REMOVED***;
	...
	***REMOVED***);
	...
	var fakeBigIntString = { toString: function () { return '42n'; ***REMOVED*** ***REMOVED***;
	t.equal(false, isBigInt(fakeBigIntString), 'object with toString returning 42n is not a BigInt');

	t.end();
***REMOVED***);

test('BigInt support', { skip: !hasBigInts ***REMOVED***, function (t) {
