  ...
  return {
    Identifier(node) {
      ...
      if (match !== null && match.groups !== null && match.groups !== undefined) {
        const {
          internalTypeName
        ***REMOVED*** = match.groups;

        if (ReactComponents.includes(internalTypeName)) {
          const validName = `React.${internalTypeName***REMOVED***`;
          context.report({
            data: {
              invalidName: node.name,
              validName
            ***REMOVED***,
            message: 'Type identifier \'{{invalidName***REMOVED******REMOVED***\' is not allowed. Use \'{{validName***REMOVED******REMOVED***\' instead.',
            node
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***
