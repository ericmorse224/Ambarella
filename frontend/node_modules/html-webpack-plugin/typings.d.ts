import { AsyncSeriesWaterfallHook ***REMOVED*** from "tapable";
import { Compiler, Compilation ***REMOVED*** from "webpack";
import { Options as HtmlMinifierOptions ***REMOVED*** from "html-minifier-terser";
...
declare class HtmlWebpackPlugin {
  ...
  static createHtmlTagObject(
    tagName: string,
    attributes?: { [attributeName: string]: string | boolean ***REMOVED***,
    innerHTML?: string,
...
declare namespace HtmlWebpackPlugin {
  ...
  interface Options {
    ...
    meta?:
      ...
      | {
          [name: string]:
            | string
            | false // name content pair e.g. {viewport: 'width=device-width, initial-scale=1, shrink-to-fit=no'***REMOVED***`
            | { [attributeName: string]: string | boolean ***REMOVED***; // custom properties e.g. { name:"viewport" content:"width=500, initial-scale=1" ***REMOVED***
        ***REMOVED***;
    /**
     ...
     * {@link https://github.com/kangax/html-minifier#options-quick-reference***REMOVED***
     */
    ...
    templateParameters?:
      ...
      | ((
        ...
        ) => { [option: string]: any ***REMOVED*** | Promise<{ [option: string]: any ***REMOVED***>)
      | { [option: string]: any ***REMOVED***;
    /**
  ...
  ***REMOVED***
  ...
  interface HtmlTagObject {
     ...
     * E.g. `{'disabled': true, 'value': 'demo'***REMOVED***`
     */
    attributes: {
    ...
    ***REMOVED***;
     ...
     * E.g. `{'plugin': 'html-webpack-plugin'***REMOVED***`
     */
    meta: {
      plugin?: string;
