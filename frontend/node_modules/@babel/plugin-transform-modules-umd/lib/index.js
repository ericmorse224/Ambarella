...
const buildPrerequisiteAssignment = (0, _core.template)(`
  GLOBAL_REFERENCE = GLOBAL_REFERENCE || {***REMOVED***
`);
const buildWrapper = (0, _core.template)(`
  (function (global, factory) {
    ...
    ***REMOVED*** else {
      var mod = { exports: {***REMOVED*** ***REMOVED***;
  ...
  function buildBrowserInit(browserGlobals, exactGlobals, filename, moduleName) {
    ...
    if (exactGlobals) {
      ...
      if (globalName) {
        ...
        ***REMOVED***, _core.types.memberExpression(_core.types.identifier("global"), _core.types.identifier(members[0])));
      ***REMOVED***
    ***REMOVED***
    ...
    visitor: {
      Program: {
        exit(path) {
          ...
          const browserGlobals = globals || {***REMOVED***;
          ...
          const {
            meta,
            headers
          ***REMOVED*** = (0, _helperModuleTransforms.rewriteModuleStatementsAndPrepareHeader)(path, {
            constantReexports,
