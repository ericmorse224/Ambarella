...
<http://www.wolframalpha.com/input/?i=Sum%5B1000*x^k%2C+{k%2C+0%2C+9***REMOVED***%5D+%3D+5+*+60+*+1000>
...
retry.wrap(obj, {retries: 3***REMOVED***)

retry.wrap(obj, {retries: 3***REMOVED***, ['method1', 'method2'])
```
