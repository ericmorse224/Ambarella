...
function batchedSingleLineTests(options) {
    ...
    return options.code
        ...
        const errors = 'errors' in options
            ...
            : [];
        const returnVal = Object.assign(Object.assign({***REMOVED***, options), { code, errors: errors.map(e => (Object.assign(Object.assign({***REMOVED***, e), { line: 1 ***REMOVED***))) ***REMOVED***);
        if (output === null || output === void 0 ? void 0 : output[i]) {
            return Object.assign(Object.assign({***REMOVED***, returnVal), { output: output[i] ***REMOVED***);
        ***REMOVED***
        return returnVal;
    ***REMOVED***);
***REMOVED***
