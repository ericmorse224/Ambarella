...
function testEvents(src) {
    ...
    ***REMOVED***
        ...
        return { events, error: error ?? e ***REMOVED***;
    ***REMOVED***
    events.push('-STR');
    return { events, error ***REMOVED***;
***REMOVED***
    ...
    if (anchor) {
        if (/\d$/.test(anchor)) {
            ...
            if (anchorExists(doc, alt))
                anchor = alt;
        ***REMOVED***
        props = ` &${anchor***REMOVED***`;
    ***REMOVED***
    if (identity.isNode(node) && node.tag)
        props += ` <${node.tag***REMOVED***>`;
    if (identity.isMap(node)) {
        const ev = node.flow ? '+MAP {***REMOVED***' : '+MAP';
        events.push(`${ev***REMOVED***${props***REMOVED***`);
        node.items.forEach(({ key, value ***REMOVED***) => {
    ...
    ***REMOVED***
        ...
        if (alias && /\d$/.test(alias)) {
            ...
            if (anchorExists(doc, alt))
                alias = alt;
        ***REMOVED***
        events.push(`=ALI${props***REMOVED*** *${alias***REMOVED***`);
    ***REMOVED***
    else {
        ...
        const value = node.source
            ...
            .replace(/\r/g, '\\r')
            .replace(/\x1b/g, '\\e');
        events.push(`=VAL${props***REMOVED*** ${scalar***REMOVED***${value***REMOVED***`);
    ***REMOVED***
***REMOVED***
