...
declare namespace QueryString {
    ...
    ***REMOVED***
    ...
    type IStringifyDynamicOptions<AllowDots extends BooleanOptional> = AllowDots extends true
        ? { allowDots?: AllowDots; encodeDotInKeys?: boolean ***REMOVED***
        : { allowDots?: boolean; encodeDotInKeys?: false ***REMOVED***;
    ...
    ***REMOVED***
    ...
    type IParseDynamicOptions<AllowDots extends BooleanOptional> = AllowDots extends true
        ? { allowDots?: AllowDots; decodeDotInKeys?: boolean ***REMOVED***
        : { allowDots?: boolean; decodeDotInKeys?: false ***REMOVED***;
    ...
    ***REMOVED***
    ...
    function parse(str: string, options?: IParseOptions<BooleanOptional> & { decoder?: never | undefined ***REMOVED***): ParsedQs;
    function parse(
