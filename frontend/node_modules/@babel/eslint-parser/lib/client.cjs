  ...
  constructor() {
    super((action, payload) => {
      ...
      _classPrivateFieldGet(_worker, this).postMessage({
        ...
        action,
        payload
      ***REMOVED***, [subChannel.port1]);
      Atomics.wait(signal, 0, 0);
      const {
        message
      ***REMOVED*** = _get_worker_threads(WorkerClient).receiveMessageOnPort(subChannel.port2);
...
***REMOVED***;
{
  ...
  exports.LocalClient = (_LocalClient = class LocalClient extends Client {
    constructor() {
      ...
      ***REMOVED***);
    ***REMOVED***
  ***REMOVED***, _handleMessage = {
    _: void 0
  ***REMOVED***, _LocalClient);
***REMOVED***
