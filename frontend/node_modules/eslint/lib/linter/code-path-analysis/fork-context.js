 ...
 * `b`, `d`, and `f`.
 * @param {ForkContext***REMOVED*** context An instance from which the previous segments
 *      will be obtained.
 * @param {number***REMOVED*** startIndex The index of the first segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param {number***REMOVED*** endIndex The index of the last segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param {Function***REMOVED*** create A function that creates new `CodePathSegment`
 *      instances in a particular way. See the `CodePathSegment.new*` methods.
 * @returns {Array<CodePathSegment>***REMOVED*** An array of the newly-created segments.
 */
function createSegments(context, startIndex, endIndex, create) {

    /** @type {Array<Array<CodePathSegment>>***REMOVED*** */
 ...
 * @param {ForkContext***REMOVED*** context The fork context to work on.
 * @param {Array<CodePathSegment>***REMOVED*** segments Segments to merge.
 * @returns {Array<CodePathSegment>***REMOVED*** The merged segments.
 */
...
class ForkContext {
     ...
     * @param {IdGenerator***REMOVED*** idGenerator An identifier generator for segments.
     * @param {ForkContext|null***REMOVED*** upper The preceding fork context.
     * @param {number***REMOVED*** count The number of parallel segments in each element
     *      of `segmentsList`.
     */
    ...
    ***REMOVED***
     ...
     * @param {Array<CodePathSegment>***REMOVED*** segments The segments to add.
     * @returns {void***REMOVED***
     */
    add(segments) {
        assert(segments.length >= this.count, `${segments.length***REMOVED*** >= ${this.count***REMOVED***`);
    ...
    ***REMOVED***
     ...
     * @param {Array<CodePathSegment>***REMOVED*** replacementHeadSegments The new head segments.
     * @returns {void***REMOVED***
     */
    replaceHead(replacementHeadSegments) {
        assert(
            replacementHeadSegments.length >= this.count,
            `${replacementHeadSegments.length***REMOVED*** >= ${this.count***REMOVED***`
        );
    ...
    ***REMOVED***
     ...
     * @param {ForkContext***REMOVED*** otherForkContext The fork context to add from.
     * @returns {void***REMOVED***
     */
    ...
    ***REMOVED***
     ...
     * fork contexts.
     * @param {IdGenerator***REMOVED*** idGenerator An identifier generator for segments.
     * @returns {ForkContext***REMOVED*** New fork context.
     */
    ...
    ***REMOVED***
     ...
     * @param {ForkContext***REMOVED*** parentContext The parent fork context.
     * @param {boolean***REMOVED*** shouldForkLeavingPath Indicates that we are inside of
