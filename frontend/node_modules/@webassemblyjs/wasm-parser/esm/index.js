...
***REMOVED***; // traverses the AST, locating function name metadata, which is then
...
function restoreModuleName(ast) {
  t.traverse(ast, {
    ...
    ***REMOVED***(function (moduleNameMetadataPath) {
      // update module
      t.traverse(ast, {
...
export function decode(buf, customOpts) {
  var opts = Object.assign({***REMOVED***, defaultDecoderOpts, customOpts);
