...
exports.default = (0, create_testing_library_rule_1.createTestingLibraryRule)({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            preferExplicitAssert: 'Wrap stand-alone `{{queryType***REMOVED******REMOVED***` query with `expect` function for better explicit assertion',
            preferExplicitAssertAssertion: '`getBy*` queries must be asserted with `{{assertion***REMOVED******REMOVED***`',
        ***REMOVED***,
        schema: [
            {
                type: 'object',
                ...
                properties: {
                    ...
                    ***REMOVED***,
                    includeFindQueries: { type: 'boolean' ***REMOVED***,
                ***REMOVED***,
            ***REMOVED***,
        ],
    ***REMOVED***,
    defaultOptions: [{ includeFindQueries: true ***REMOVED***],
    create(context, [options], helpers) {
        const { assertion, includeFindQueries ***REMOVED*** = options;
        const getQueryCalls = [];
