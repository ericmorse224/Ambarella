...
function getDeprecated(pragma) {
  ...
  // 0.12.0
  deprecated[`${pragma***REMOVED***.renderComponent`] = ['0.12.0', `${pragma***REMOVED***.render`];
  deprecated[`${pragma***REMOVED***.renderComponentToString`] = ['0.12.0', `${pragma***REMOVED***.renderToString`];
  deprecated[`${pragma***REMOVED***.renderComponentToStaticMarkup`] = ['0.12.0', `${pragma***REMOVED***.renderToStaticMarkup`];
  deprecated[`${pragma***REMOVED***.isValidComponent`] = ['0.12.0', `${pragma***REMOVED***.isValidElement`];
  deprecated[`${pragma***REMOVED***.PropTypes.component`] = ['0.12.0', `${pragma***REMOVED***.PropTypes.element`];
  deprecated[`${pragma***REMOVED***.PropTypes.renderable`] = ['0.12.0', `${pragma***REMOVED***.PropTypes.node`];
  deprecated[`${pragma***REMOVED***.isValidClass`] = ['0.12.0'];
  deprecated['this.transferPropsTo'] = ['0.12.0', 'spread operator ({...***REMOVED***)'];
  // 0.13.0
  deprecated[`${pragma***REMOVED***.addons.classSet`] = ['0.13.0', 'the npm module classnames'];
  deprecated[`${pragma***REMOVED***.addons.cloneWithProps`] = ['0.13.0', `${pragma***REMOVED***.cloneElement`];
  // 0.14.0
  deprecated[`${pragma***REMOVED***.render`] = ['0.14.0', 'ReactDOM.render'];
  deprecated[`${pragma***REMOVED***.unmountComponentAtNode`] = ['0.14.0', 'ReactDOM.unmountComponentAtNode'];
  deprecated[`${pragma***REMOVED***.findDOMNode`] = ['0.14.0', 'ReactDOM.findDOMNode'];
  deprecated[`${pragma***REMOVED***.renderToString`] = ['0.14.0', 'ReactDOMServer.renderToString'];
  deprecated[`${pragma***REMOVED***.renderToStaticMarkup`] = ['0.14.0', 'ReactDOMServer.renderToStaticMarkup'];
  // 15.0.0
  deprecated[`${pragma***REMOVED***.addons.LinkedStateMixin`] = ['15.0.0'];
  ...
  // 15.5.0
  deprecated[`${pragma***REMOVED***.createClass`] = ['15.5.0', 'the npm module create-react-class'];
  deprecated[`${pragma***REMOVED***.addons.TestUtils`] = ['15.5.0', 'ReactDOM.TestUtils'];
  deprecated[`${pragma***REMOVED***.PropTypes`] = ['15.5.0', 'the npm module prop-types'];
  // 15.6.0
  deprecated[`${pragma***REMOVED***.DOM`] = ['15.6.0', 'the npm module react-dom-factories'];
  // 16.9.0
...
const messages = {
  deprecated: '{{oldMethod***REMOVED******REMOVED*** is deprecated since React {{version***REMOVED******REMOVED***{{newMethod***REMOVED******REMOVED***{{refs***REMOVED******REMOVED***',
***REMOVED***;
  ...
  create(context) {
    ...
    function isDeprecated(method) {
      return (
        ...
        && deprecated[method]
        && deprecated[method][0]
        && testReactVersion(context, `>= ${deprecated[method][0]***REMOVED***`)
      );
    ***REMOVED***
      ...
      ***REMOVED***
      ...
      report(context, messages.deprecated, 'deprecated', {
        ...
        data: {
          ...
          version,
          newMethod: newMethod ? `, use ${newMethod***REMOVED*** instead` : '',
          refs: refs ? `, see ${refs***REMOVED***` : '',
        ***REMOVED***,
      ***REMOVED***);
    ***REMOVED***
      ...
      ImportDeclaration(node) {
        ...
        ***REMOVED***
        node.specifiers.filter(((s) => 'imported' in s && s.imported)).forEach((specifier) => {
          ...
          checkDeprecation(node, 'imported' in specifier && 'name' in specifier.imported && `${MODULES[node.source.value][0]***REMOVED***.${specifier.imported.name***REMOVED***`, specifier);
        ***REMOVED***);
      ***REMOVED***,
      ...
      VariableDeclarator(node) {
        ...
        ***REMOVED***
        ...
        ('properties' in node.id ? node.id.properties : undefined).filter((p) => p.type !== 'RestElement' && p.key).forEach((property) => {
          checkDeprecation(
            node,
            'key' in property && 'name' in property.key && `${reactModuleName || pragma***REMOVED***.${property.key.name***REMOVED***`,
            property
          );
        ***REMOVED***);
      ***REMOVED***,
