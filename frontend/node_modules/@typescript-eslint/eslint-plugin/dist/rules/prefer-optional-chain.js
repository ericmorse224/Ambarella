                    ...
                    suggest: [
                        {
                            ...
                            fix: (fixer) => {
                                ...
                                const maybeWrappedLeftNode = isLeftSideLowerPrecedence()
                                    ? `(${leftNodeText***REMOVED***)`
                                    : leftNodeText;
                                const propertyToBeOptionalText = sourceCode.getText(parentNode.property);
                                const maybeWrappedProperty = parentNode.computed
                                    ? `[${propertyToBeOptionalText***REMOVED***]`
                                    : propertyToBeOptionalText;
                                return fixer.replaceTextRange(parentNode.range, `${maybeWrappedLeftNode***REMOVED***?.${maybeWrappedProperty***REMOVED***`);
                            ***REMOVED***,
                        ***REMOVED***,
                    ],
                ***REMOVED***);
                ...
                ***REMOVED***
                ...
                while (current.type === utils_1.AST_NODE_TYPES.LogicalExpression) {
                    if (current.right.type !== utils_1.AST_NODE_TYPES.UnaryExpression ||
                        ...
                        break;
                    ***REMOVED***
                    const { rightText, shouldBreak ***REMOVED*** = breakIfInvalid({
                    ...
                    ***REMOVED***
                    ...
                    ({
                        ...
                        previous,
                        current,
                    ***REMOVED*** = normalizeRepeatingPatterns(rightText, expressionCount, previousLeftText, optionallyChainedCode, previous, current));
        ...
        function getText(node) {
            ...
            ***REMOVED***
            if (node.type === utils_1.AST_NODE_TYPES.CallExpression) {
                ...
                return `${calleeText***REMOVED***${argumentsText***REMOVED***`;
            ***REMOVED***
            ...
            ***REMOVED***
            if (node.type === utils_1.AST_NODE_TYPES.MetaProperty) {
                return `${node.meta.name***REMOVED***.${node.property.name***REMOVED***`;
            ***REMOVED***
            ...
            if (node.computed) {
                ...
                switch (node.property.type) {
                    ...
                    default:
                        return '';
                ***REMOVED***
                return `${objectText***REMOVED***${node.optional ? '?.' : ''***REMOVED***[${propertyText***REMOVED***]`;
            ***REMOVED***
            else {
...
function reportIfMoreThanOne({ expressionCount, previous, optionallyChainedCode, sourceCode, context, shouldHandleChainedAnds, ***REMOVED***) {
    if (expressionCount > 1) {
        if (shouldHandleChainedAnds &&
            ...
            ***REMOVED***
            ...
            optionallyChainedCode += ` ${operator***REMOVED*** ${sourceCode.getText(previous.right.right)***REMOVED***`;
        ***REMOVED***
        context.report({
            node: previous,
            ...
            suggest: [
                {
                    messageId: 'optionalChainSuggest',
                    fix: (fixer) => [
                        fixer.replaceText(previous, `${shouldHandleChainedAnds ? '' : '!'***REMOVED***${optionallyChainedCode***REMOVED***`),
                    ],
                ***REMOVED***,
            ],
        ***REMOVED***);
...
function normalizeRepeatingPatterns(rightText, expressionCount, previousLeftText, optionallyChainedCode, previous, current) {
    ...
    if (rightText !== previousLeftText) {
        ...
        ***REMOVED***
            ...
            optionallyChainedCode += `?${needsDot ? '.' : ''***REMOVED***${diff***REMOVED***`;
        ***REMOVED***
    ***REMOVED***
    previous = current;
