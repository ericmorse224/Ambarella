    ...
    constructor(context, opts) {
        ...
        ***REMOVED***;
        ...
        this.prepareProxyRequest = async (req) => {
            ...
            const newProxyOptions = Object.assign({***REMOVED***, this.proxyOptions);
            // Apply in order:
            // 1. option.router
        ...
        ***REMOVED***;
        this.logError = (err, req, res, target) => {
            ...
            const requestHref = `${hostname***REMOVED***${req.url***REMOVED***`;
            const targetHref = `${target === null || target === void 0 ? void 0 : target.href***REMOVED***`; // target is undefined when websocket errors
        ...
        ***REMOVED***;
        ...
        // create proxy
        this.proxy = httpProxy.createProxyServer({***REMOVED***);
        this.logger.info(`[HPM] Proxy created: ${this.config.context***REMOVED***  -> ${this.proxyOptions.target***REMOVED***`);
