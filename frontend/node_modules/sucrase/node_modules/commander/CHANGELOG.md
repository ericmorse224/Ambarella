...
* Add option to specify executable file name ([#999])
  * e.g. `.command('clone', 'clone description', { executableFile: 'myClone' ***REMOVED***)`
...
```js
program
  .command('action1', undefined, { noHelp: true ***REMOVED***) // No longer valid
  .command('action2', { noHelp: true ***REMOVED***) // Correct
```
