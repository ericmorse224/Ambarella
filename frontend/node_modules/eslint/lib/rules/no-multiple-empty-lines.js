		...
		***REMOVED***,
		...
		messages: {
			blankBeginningOfFile:
				"Too many blank lines at the beginning of file. Max of {{max***REMOVED******REMOVED*** allowed.",
			blankEndOfFile:
				"Too many blank lines at the end of file. Max of {{max***REMOVED******REMOVED*** allowed.",
			consecutiveBlank:
				"More than {{max***REMOVED******REMOVED*** blank {{pluralizedLines***REMOVED******REMOVED*** not allowed.",
		***REMOVED***,
	***REMOVED***,
