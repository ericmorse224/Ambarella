...
export const trimAndFormatPath = (pad, config, testPath, columns) => {
  ...
  ***REMOVED*** // we can fit trimmed dirname and full basename
  ...
  if (basenameLength + 4 < maxLength) {
    ...
    dirname = `${TRIMMING_DOTS***REMOVED***${dirname.slice(dirname.length - dirnameLength, dirname.length)***REMOVED***`;
    return slash(chalk.dim(dirname + path.sep) + chalk.bold(basename));
  ***REMOVED***

  if (basenameLength + 4 === maxLength) {
    return slash(chalk.dim(`${TRIMMING_DOTS***REMOVED***${path.sep***REMOVED***`) + chalk.bold(basename));
  ***REMOVED*** // can't fit dirname, but can fit trimmed basename


  return slash(chalk.bold(`${TRIMMING_DOTS***REMOVED***${basename.slice(-maxLength + 3)***REMOVED***`));
***REMOVED***;
...
export const highlight = (rawPath, filePath, pattern) => {
  ...
  ***REMOVED*** else if (strippedFilePath.startsWith(relativePathHead)) {
