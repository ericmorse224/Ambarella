import { Document, scalarOptions ***REMOVED*** from './index'
import { CST ***REMOVED*** from './parse-cst'
...
export class Schema {
  ...
  ***REMOVED***
   ...
   *
   * @param ctx To not wrap scalars, use a context `{ wrapScalars: false ***REMOVED***`
   */
