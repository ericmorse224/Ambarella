"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj ***REMOVED***; ***REMOVED***/* eslint-disable no-console */
  ...
  for (const child of await _fs.readdir.call(void 0, srcDirPath)) {
    ...
    ***REMOVED***
    ...
    if ((await _fs.stat.call(void 0, srcChildPath)).isDirectory()) {
      const innerOptions = {...options***REMOVED***;
    ...
    ***REMOVED*** else if (extensions.some((ext) => srcChildPath.endsWith(ext))) {
      const outPath = outChildPath.replace(/\.\w+$/, `.${options.outExtension***REMOVED***`);
      outArr.push({
...
async function runGlob(options) {
  ...
  ***REMOVED*** catch (err) {
    ...
    console.error(`  --project=${options.project***REMOVED***`);
    console.error(err);
    process.exit(1);
  ***REMOVED***
  ...
  if (files) {
    for (const file of files) {
      ...
      ***REMOVED***
      ...
      const outPath = outFile.replace(/\.\w+$/, `.${options.outExtension***REMOVED***`);
...
async function buildDirectory(options) {
  ...
  ***REMOVED*** else if (options.project) {
...
async function buildFile(srcPath, outPath, options) {
  if (!options.quiet) {
    console.log(`${srcPath***REMOVED*** -> ${outPath***REMOVED***`);
  ***REMOVED***
  const code = (await _fs.readFile.call(void 0, srcPath)).toString();
  const transformedCode = _index.transform.call(void 0, code, {...options.sucraseOptions, filePath: srcPath***REMOVED***).code;
