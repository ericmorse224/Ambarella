...
```js
import { babel ***REMOVED*** from '@rollup/plugin-babel';
...
const config = {
  ...
  output: {
    ...
    format: 'esm'
  ***REMOVED***,
  plugins: [babel({ babelHelpers: 'bundled' ***REMOVED***)]
***REMOVED***;
...
const config = {
  ...
  plugins: [
    commonjs(),
    babel({ babelHelpers: 'bundled' ***REMOVED***)
  ],
***REMOVED***;
```
...
const filter = createFilter(include, exclude, {***REMOVED***);
```
...
```js
// rollup.config.js
import { getBabelOutputPlugin ***REMOVED*** from '@rollup/plugin-babel';
...
export default {
  ...
  output: [
    { file: 'bundle.cjs.js', format: 'cjs' ***REMOVED***,
    { file: 'bundle.esm.js', format: 'esm' ***REMOVED***
  ]
***REMOVED***;
```
...
export default {
  input: 'main.js',
  output: [
    { file: 'bundle.js', format: 'esm' ***REMOVED***,
    {
      file: 'bundle.es5.js',
      format: 'esm',
      plugins: [getBabelOutputPlugin({ presets: ['@babel/preset-env'] ***REMOVED***)]
    ***REMOVED***
  ]
***REMOVED***;
```
...
```js
// rollup.config.js
import babel, { getBabelOutputPlugin ***REMOVED*** from '@rollup/plugin-babel';

export default {
  input: 'main.js',
  plugins: [babel({ presets: ['@babel/preset-react'] ***REMOVED***)],
  output: [
    {
      file: 'bundle.js',
      format: 'esm',
...
```
presets: [['@babel/preset-env', { modules: 'umd' ***REMOVED***], ...]
```
...
.then(bundle => bundle.generate({
  ...
  plugins: [getBabelOutputPlugin({
    presets: ['@babel/preset-env'],
    plugins: [['@babel/plugin-transform-runtime', { useESModules: true ***REMOVED***]]
  ***REMOVED***)]
***REMOVED***))
```
...
.then(bundle => bundle.generate({
  ...
  plugins: [getBabelOutputPlugin({
    presets: ['@babel/preset-env'],
    plugins: [['@babel/plugin-transform-runtime', { useESModules: false ***REMOVED***]]
  ***REMOVED***)]
***REMOVED***))
```
...
```js
import { createBabelInputPluginFactory ***REMOVED*** from '@rollup/plugin-babel';
...
export default createBabelInputPluginFactory((babelCore) => {
  ...
  ***REMOVED***
  ...
  return {
    ...
    options({ opt1, opt2, ...pluginOptions ***REMOVED***) {
      return {
        // Pull out any custom options that the plugin might have.
        customOptions: { opt1, opt2 ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    config(cfg /* Passed Babel's 'PartialConfig' object. */, { code, customOptions ***REMOVED***) {
    ...
    ***REMOVED***,
    ...
    result(result, { code, customOptions, config, transformOptions ***REMOVED***) {
      return {
        ...result,
