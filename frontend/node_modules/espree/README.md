...
```
Token { type: 'Keyword', value: 'let', start: 0, end: 3 ***REMOVED***,
Token { type: 'Identifier', value: 'foo', start: 4, end: 7 ***REMOVED***,
Token { type: 'Punctuator', value: '=', start: 8, end: 9 ***REMOVED***,
Token { type: 'String', value: '"bar"', start: 10, end: 15 ***REMOVED***
```
