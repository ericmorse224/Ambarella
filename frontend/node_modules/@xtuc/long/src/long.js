 ...
 * @param {boolean=***REMOVED*** unsigned Whether unsigned or not, defaults to signed
 * @constructor
 */
...
Object.defineProperty(Long.prototype, "__isLong__", { value: true ***REMOVED***);
 ...
 * @param {(boolean|number)=***REMOVED*** unsigned Whether unsigned or not, defaults to signed
...
/**
 * Tests if this Long's value equals zero. This is an alias of {@link Long#isZero***REMOVED***.
 * @returns {boolean***REMOVED***
 */
 ...
 * @this {!Long***REMOVED***
 * @param {number|!Long***REMOVED*** numBits Number of bits
 * @returns {!Long***REMOVED*** Rotated Long
 */
...
***REMOVED***
/**
 * Returns this Long with bits rotated to the left by the given amount. This is an alias of {@link Long#rotateLeft***REMOVED***.
 * @function
 * @param {number|!Long***REMOVED*** numBits Number of bits
 * @returns {!Long***REMOVED*** Rotated Long
 */
...
***REMOVED***
/**
 * Returns this Long with bits rotated to the right by the given amount. This is an alias of {@link Long#rotateRight***REMOVED***.
 * @function
 * @param {number|!Long***REMOVED*** numBits Number of bits
 * @returns {!Long***REMOVED*** Rotated Long
 */
 ...
 * @param {!Array.<number>***REMOVED*** bytes Byte representation
 * @param {boolean=***REMOVED*** unsigned Whether unsigned or not, defaults to signed
 * @param {boolean=***REMOVED*** le Whether little or big endian, defaults to big endian
 * @returns {Long***REMOVED*** The corresponding Long value
 */
 ...
 * @param {!Array.<number>***REMOVED*** bytes Little endian byte representation
 * @param {boolean=***REMOVED*** unsigned Whether unsigned or not, defaults to signed
 * @returns {Long***REMOVED*** The corresponding Long value
 */
 ...
 * @param {!Array.<number>***REMOVED*** bytes Big endian byte representation
 * @param {boolean=***REMOVED*** unsigned Whether unsigned or not, defaults to signed
 * @returns {Long***REMOVED*** The corresponding Long value
 */
