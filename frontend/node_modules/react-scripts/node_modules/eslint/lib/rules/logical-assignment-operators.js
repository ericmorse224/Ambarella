 ...
 * @param {ASTNode***REMOVED*** expression Expression to check
 * @param {import('eslint-scope').Scope***REMOVED*** scope Scope of the expression
 * @returns {boolean***REMOVED*** True iff "undefined" or "void ..."
 */
 ...
 * @param {ASTNode***REMOVED*** expression Expression to check
 * @returns {boolean***REMOVED*** True for identifiers and member expressions
 */
 ...
 * @param {ASTNode***REMOVED*** expression Test condition
 * @param {import('eslint-scope').Scope***REMOVED*** scope Scope of the expression
 * @returns {boolean***REMOVED*** True iff implicit nullish comparison
 */
 ...
 * @param {ASTNode***REMOVED*** expression Condition
 * @returns {boolean***REMOVED*** True iff matches ? === ? || ? === ?
 */
 ...
 * @param {ASTNode***REMOVED*** expression Test condition
 * @param {import('eslint-scope').Scope***REMOVED*** scope Scope of the expression
 * @returns {boolean***REMOVED*** True iff explicit nullish comparison
 */
 ...
 * @param {ASTNode***REMOVED*** expression Test condition
 * @param {import('eslint-scope').Scope***REMOVED*** scope Scope of the expression
 * @returns {boolean***REMOVED*** Whether the expression is a boolean cast
 */
 ...
 * @param {ASTNode***REMOVED*** expression Test condition
 * @param {import('eslint-scope').Scope***REMOVED*** scope Scope of the expression
 * @returns {?{ reference: ASTNode, operator: '??'|'||'|'&&'***REMOVED******REMOVED*** Null if not a known existence
 */
function getExistence(expression, scope) {
    ...
    switch (true) {
        case isReference(base):
            return { reference: base, operator: isNegated ? "||" : "&&" ***REMOVED***;
        case base.type === "UnaryExpression" && base.operator === "!" && isReference(base.argument):
            return { reference: base.argument, operator: "&&" ***REMOVED***;
        case isBooleanCast(base, scope) && isReference(base.arguments[0]):
            return { reference: base.arguments[0], operator: isNegated ? "||" : "&&" ***REMOVED***;
        case isImplicitNullishComparison(expression, scope):
            return { reference: isReference(expression.left) ? expression.left : expression.right, operator: "??" ***REMOVED***;
        case isExplicitNullishComparison(expression, scope):
            return { reference: isReference(expression.left.left) ? expression.left.left : expression.left.right, operator: "??" ***REMOVED***;
        default: return null;
    ***REMOVED***
***REMOVED***
 ...
 * @returns {boolean***REMOVED*** True iff passed node is inside a with block
 */
 ...
 * @param {LogicalExpression***REMOVED*** node LogicalExpression
 * @returns {Expression***REMOVED*** Leftmost operand
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        hasSuggestions: true,
        messages: {
            assignment: "Assignment (=) can be replaced with operator assignment ({{operator***REMOVED******REMOVED***).",
            useLogicalOperator: "Convert this assignment to use the operator {{ operator ***REMOVED******REMOVED***.",
            logical: "Logical expression can be replaced with an assignment ({{ operator ***REMOVED******REMOVED***).",
            convertLogical: "Replace this logical expression with an assignment with the operator {{ operator ***REMOVED******REMOVED***.",
            if: "'if' statement can be replaced with a logical operator assignment with operator {{ operator ***REMOVED******REMOVED***.",
            convertIf: "Replace this 'if' statement with a logical assignment with operator {{ operator ***REMOVED******REMOVED***.",
            unexpected: "Unexpected logical operator assignment ({{operator***REMOVED******REMOVED***) shorthand.",
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {ASTNode***REMOVED*** node Assignment expression
         * @returns {boolean***REMOVED*** True iff the fix is safe
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node reference
         * @returns {boolean***REMOVED*** True iff a single property is accessed
         */
        ...
        ***REMOVED***
         ...
         * @param {{ messageId: string, node: ASTNode ***REMOVED******REMOVED*** descriptor Report descriptor without fix or suggest
         * @param {{ messageId: string, fix: Function ***REMOVED******REMOVED*** suggestion Adds the fix or the whole suggestion as only element in "suggest" to suggestion
         * @param {boolean***REMOVED*** shouldBeFixed Fix iff the condition is true
         * @returns {Object***REMOVED*** Descriptor with either an added fix or suggestion
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node AssignmentExpression or BinaryExpression
         * @returns {import('eslint').AST.Token***REMOVED*** Operator token between the left and right expression
         */
                ...
                "AssignmentExpression"(assignment) {
                    ...
                    ***REMOVED***
                    ...
                    const descriptor = {
                        ...
                        node: assignment,
                        data: { operator: assignment.operator ***REMOVED***
                    ***REMOVED***;
                    const suggestion = {
                        messageId: "separate",
                        *fix(ruleFixer) {
                            ...
                            ***REMOVED***
                            ...
                            // -> foo = foo || bar
                            yield ruleFixer.insertTextAfter(operatorToken, ` ${assignmentText***REMOVED*** ${operator***REMOVED***`);

                            const precedence = astUtils.getPrecedence(assignment.right) <= astUtils.getPrecedence({ type: "LogicalExpression", operator ***REMOVED***);
            ...
            "AssignmentExpression[operator='='][right.type='LogicalExpression']"(assignment) {
                ...
                ***REMOVED***
                ...
                const descriptor = {
                    ...
                    node: assignment,
                    data: { operator: `${assignment.right.operator***REMOVED***=` ***REMOVED***
                ***REMOVED***;
                const suggestion = {
            ...
            'LogicalExpression[right.type="AssignmentExpression"][right.operator="="]'(logical) {
                ...
                if (isReference(logical.left) && astUtils.isSameReference(logical.left, logical.right.left)) {
                    const descriptor = {
                        messageId: "logical",
                        node: logical,
                        data: { operator: `${logical.operator***REMOVED***=` ***REMOVED***
                    ***REMOVED***;
                    const suggestion = {
                        ...
                        *fix(ruleFixer) {
                            ...
                            ***REMOVED***
                            ...
                            const requiresOuterParenthesis = logical.parent.type !== "ExpressionStatement" && (
                                parentPrecedence === -1 ||
                                astUtils.getPrecedence({ type: "AssignmentExpression" ***REMOVED***) < parentPrecedence
                            );
                ...
                ***REMOVED***
                ...
                if (
                    ...
                    const descriptor = {
                        messageId: "if",
                        node: ifNode,
                        data: { operator: `${existence.operator***REMOVED***=` ***REMOVED***
                    ***REMOVED***;
                    const suggestion = {
                        messageId: "convertIf",
                        data: { operator: `${existence.operator***REMOVED***=` ***REMOVED***,
