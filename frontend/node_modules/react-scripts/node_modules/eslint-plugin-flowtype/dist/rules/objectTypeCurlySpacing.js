        ...
        if (never && spacesBefore) {
          context.report({
            ...
            ***REMOVED***,
            ...
            message: 'There must be no space after "{{token***REMOVED******REMOVED***".',
            node
          ***REMOVED***);
        ***REMOVED*** else if (!never && !spacesBefore) {
          context.report({
            data: {
              token: opener.value
            ***REMOVED***,
            fix: _utilities.spacingFixers.addSpaceAfter(opener),
            message: 'A space is required after "{{token***REMOVED******REMOVED***".',
            node
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED*** // Check the closing brace
        ...
        if (never && spacesAfter) {
          context.report({
            ...
            ***REMOVED***,
            ...
            message: 'There must be no space before "{{token***REMOVED******REMOVED***".',
            node
          ***REMOVED***);
        ***REMOVED*** else if (!never && !spacesAfter) {
          context.report({
            data: {
              token: closer.value
            ***REMOVED***,
            fix: _utilities.spacingFixers.addSpaceAfter(lastInnerToken),
            message: 'A space is required before "{{token***REMOVED******REMOVED***".',
            node
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***
