...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {string[]***REMOVED*** names Array of variable names.
         * @param {eslint-scope.Scope***REMOVED*** scope Function scope or a function's inner scope.
         * @returns {boolean***REMOVED*** True if all names can be safely declared, false otherwise.
         */
        function isSafeToDeclare(names, scope) {
            ...
            ***REMOVED***
             ...
             */
            const declaredVariables = scope.variables.filter(({ defs ***REMOVED***) => defs.length > 0);

            if (declaredVariables.some(({ name ***REMOVED***) => names.includes(name))) {
                return false;
            ***REMOVED***

            // Redeclaring a catch variable would also cause a syntax error.
            if (scope !== functionScope && scope.upper.type === "catch") {
                if (scope.upper.variables.some(({ name ***REMOVED***) => names.includes(name))) {
                    return false;
                ***REMOVED***
            ***REMOVED***
             ...
             * and modify behavior.
             */
            const usedImplicitVariables = scope.variables.filter(({ defs, references ***REMOVED***) =>
                defs.length === 0 && references.length > 0);

            if (usedImplicitVariables.some(({ name ***REMOVED***) => names.includes(name))) {
                return false;
            ***REMOVED***
            ...
            ***REMOVED***
             ...
             * function foo() { if (bar) { let a; if (baz) { var a; ***REMOVED*** ***REMOVED*** ***REMOVED***
             */
            if (scope !== functionScope) {
                const scopeNodeRange = scope.block.range;
                const variablesToCheck = functionScope.variables.filter(({ name ***REMOVED***) => names.includes(name));

                if (variablesToCheck.some(v => v.defs.some(({ node: { range ***REMOVED*** ***REMOVED***) =>
        ...
        ***REMOVED***
         ...
         * @param {Node***REMOVED*** node The 'else' node.
         * @param {eslint-scope.Scope***REMOVED*** scope The scope in which the node and the whole 'if' statement is.
         * @returns {boolean***REMOVED*** True if it is safe, false otherwise.
         */
        function isSafeFromNameCollisions(node, scope) {
            ...
            ***REMOVED***
            ...
            const elseBlockScope = scope.childScopes.find(({ block ***REMOVED***) => block === node);
            ...
            ***REMOVED***
             ...
             */
            const namesToCheck = elseBlockScope.variables.map(({ name ***REMOVED***) => name);
        ...
        ***REMOVED***
         ...
         * @param {Node***REMOVED*** elseNode The 'else' node
                ...
                fix(fixer) {
                    ...
                    ***REMOVED***
                    ...
                    if (lastTokenOfElseBlock.value !== ";") {
                         ...
                         */
                        if (nextTokenUnsafe || (nextTokenOnSameLine && nextToken.value !== "***REMOVED***")) {
                            return null;
                        ***REMOVED***
                    ***REMOVED***
        ...
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** True if node is a return
         */
        ...
        ***REMOVED***
         ...
         * @param {Node***REMOVED*** node The consequent/alternate node
         * @returns {boolean***REMOVED*** True if it has a return
         */
        ...
        ***REMOVED***
         ...
         * @param {Node***REMOVED*** node The consequent node
         * @returns {boolean***REMOVED*** True if this is a nested rule violation
         */
        ...
        ***REMOVED***
         ...
         * code paths.
         * @param {Node***REMOVED*** node The consequent or body node
         * @returns {boolean***REMOVED*** `true` if it is a Return/If node that always returns.
         */
        ...
        ***REMOVED***
         ...
         * @param {Node***REMOVED*** node The node to be checked
         * @returns {boolean***REMOVED*** `true` if it returns on every codepath.
         */
        ...
        ***REMOVED***
         ...
         * @returns {void***REMOVED***
         * @param {Node***REMOVED*** node The node for the if statement to check
         * @private
         */
