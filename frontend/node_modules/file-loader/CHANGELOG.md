...
* **index:** don't append `outputPath` to the original `url` (`options.outputPath` `{Function***REMOVED***`) ([4c1ccaa](https://github.com/webpack/file-loader/commit/4c1ccaa))
...
* **schema:** allow `name` to be a `{Function***REMOVED***` (`options.name`) ([#216](https://github.com/webpack/file-loader/issues/216)) ([fbfb160](https://github.com/webpack/file-loader/commit/fbfb160))
