...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			expected: "Expected line break before `{{callee***REMOVED******REMOVED***`.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {ASTNode***REMOVED*** node A MemberExpression node to get
		 * @returns {string***REMOVED*** The prefix of the node.
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A MemberExpression node to get.
		 * @returns {string***REMOVED*** The property text of the node.
		 */
