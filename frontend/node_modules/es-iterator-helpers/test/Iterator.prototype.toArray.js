...
module.exports = {
	tests: function (toArray, name, t) {
		t['throws'](
			function () { return new toArray(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			t['throws'](
				function () { iterate(toArray(nonIterator)); ***REMOVED***,
				TypeError,
			...
			t['throws'](
				function () { iterate(toArray(badNext)); ***REMOVED***,
				TypeError,
		...
		***REMOVED***);
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			...
			st['throws'](
				function () { return new toArray(iterator()); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
