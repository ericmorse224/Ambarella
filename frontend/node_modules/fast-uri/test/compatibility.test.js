...
test('compatibility serialize', (t) => {
  const toSerialize = [
    { host: '10.10.10.10.example.com' ***REMOVED***,
    { host: '2001:db8::7' ***REMOVED***,
    { host: '::ffff:129.144.52.38' ***REMOVED***,
    { host: '2606:2800:220:1:248:1893:25c8:1946' ***REMOVED***,
    { host: '10.10.10.10.example.com' ***REMOVED***,
    { host: '10.10.10.10' ***REMOVED***,
    { path: '?query' ***REMOVED***,
    { path: 'foo:bar' ***REMOVED***,
    { path: '//path' ***REMOVED***,
    {
      scheme: 'uri',
      host: 'example.com',
    ...
    ***REMOVED***,
    {
      ...
      fragment: undefined
    ***REMOVED***,
    { host: 'fe80::a%en1' ***REMOVED***,
    { host: 'fe80::a%25en1' ***REMOVED***,
    {
      scheme: 'ws',
      host: 'example.com',
