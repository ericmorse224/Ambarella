...
const { createElement, internalCreateElementNSSteps ***REMOVED*** = require("../helpers/create-element");
...
class DOMImplementationImpl {
  ...
  ***REMOVED***
  ...
  createDocument(namespace, qualifiedName, doctype) {
    ...
    ***REMOVED*** else if (namespace === SVG_NS) {
    ...
    ***REMOVED***);
    ...
    let element = null;
    if (qualifiedName !== "") {
      element = internalCreateElementNSSteps(document, namespace, qualifiedName, {***REMOVED***);
    ***REMOVED***
