...
const { XML_NS, XMLNS_NS ***REMOVED*** = require("../helpers/namespaces");
...
exports.name = function (globalObject, name) {
  ...
  if (!result.success) {
    throw DOMException.create(globalObject, [
      `"${name***REMOVED***" did not match the Name production: ${result.error***REMOVED***`,
...
exports.qname = function (globalObject, qname) {
  ...
  if (!result.success) {
    throw DOMException.create(globalObject, [
      `"${qname***REMOVED***" did not match the QName production: ${result.error***REMOVED***`,
      "InvalidCharacterError"
    ]);
  ***REMOVED***
***REMOVED***;
...
exports.validateAndExtract = function (globalObject, namespace, qualifiedName) {
  ...
  ***REMOVED***
  ...
  return { namespace, prefix, localName ***REMOVED***;
***REMOVED***;
