...
declare namespace axe {
  ...
  type LabelledShadowDomSelector = { fromShadowDom: ShadowDomSelector ***REMOVED***;
  ...
  type LabelledFramesSelector = { fromFrames: MultiArray<FramesSelector[0]> ***REMOVED***;
  /**
  ...
  ***REMOVED***
  interface CheckMessages {
    pass: string | { [key: string]: string ***REMOVED***;
    fail: string | { [key: string]: string ***REMOVED***;
    incomplete?: string | { [key: string]: string ***REMOVED***;
  ***REMOVED***
  ...
  ***REMOVED***
  interface HtmlElmsVariant {
    ...
    noAriaAttrs?: boolean;
    shadowRoot?: boolean;
    implicitAttrs?: { [key: string]: string ***REMOVED***;
    namingMethods?: string[];
  ***REMOVED***
  interface HtmlElms extends HtmlElmsVariant {
    variant?: { [key: string]: HtmlElmsVariant ***REMOVED***;
  ***REMOVED***
  interface Standards {
    ariaAttrs?: { [key: string]: AriaAttrs ***REMOVED***;
    ariaRoles?: { [key: string]: AriaRoles ***REMOVED***;
    htmlElms?: { [key: string]: HtmlElms ***REMOVED***;
    cssColors?: { [key: string]: number[] ***REMOVED***;
  ***REMOVED***
  interface Spec {
  ...
  ***REMOVED***
  ...
  interface VirtualNode {
    ...
    props: { [key: string]: unknown ***REMOVED***;
  ...
  ***REMOVED***
  ...
  interface Utils {
    ...
    DqElement: new (
      elm: Element,
      options?: { absolutePaths?: boolean ***REMOVED***
    ) => DqElement;
    uuid: (
      options?: { random?: Uint8Array | Array<number> ***REMOVED***,
  ...
  ***REMOVED***
   ...
   *
   * @param   {ElementContext***REMOVED*** context  Optional The `Context` specification object @see Context
   * @param   {RunOptions***REMOVED***     options  Optional Options passed into rules or checks, temporarily modifying them.
   * @param   {RunCallback***REMOVED***    callback Optional The function to invoke when analysis is complete.
   * @returns {Promise<AxeResults>|void***REMOVED*** If the callback was not defined, axe will return a Promise.
   */
   ...
   * @param  {Spec***REMOVED***       Spec Object with valid `branding`, `reporter`, `checks` and `rules` data
   */
   ...
   * @param   {ElementContext***REMOVED*** context  Optional The `Context` specification object @see Context
   * @param   {RunOptions***REMOVED***     options  Optional Options passed into rules or checks, temporarily modifying them.
   * @returns {Promise<PartialResult>***REMOVED***  Partial result, for use in axe.finishRun.
   */
  function runPartial(
    context: ElementContext,
    options: RunOptions
   ...
   * @param   {PartialResult[]***REMOVED***     partialResults  Results from axe.runPartial, calls in different frames on the page.
   * @param   {RunOptions***REMOVED***     options  Optional Options passed into rules or checks, temporarily modifying them.
   */
  function finishRun(
   ...
   * @param  {Array***REMOVED***  tags  Optional array of tags
   * @return {Array***REMOVED***  Array of rules
   */
   ...
   * @param  {Object***REMOVED***    plugin    A plugin configuration object
   */
  ...
  ***REMOVED***;
  ...
  type TopicData = { topic: string ***REMOVED*** & ReplyData;
  type ReplyData = { channelId: string; message: any; keepalive: boolean ***REMOVED***;
***REMOVED***
