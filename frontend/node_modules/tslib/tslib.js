...
(function (factory) {
    var root = typeof global === "object" ? global : typeof self === "object" ? self : typeof this === "object" ? this : {***REMOVED***;
    if (typeof define === "function" && define.amd) {
        define("tslib", ["exports"], function (exports) { factory(createExporter(root, createExporter(exports))); ***REMOVED***);
    ***REMOVED***
    ...
    ***REMOVED***
    function createExporter(exports, previous) {
        if (exports !== root) {
            ...
            ***REMOVED***
        ***REMOVED***
        return function (id, v) { return exports[id] = previous ? previous(id, v) : v; ***REMOVED***;
    ***REMOVED***
***REMOVED***)
(function (exporter) {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] ***REMOVED*** instanceof Array && function (d, b) { d.__proto__ = b; ***REMOVED***) ||
        function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; ***REMOVED***;
    ...
    ***REMOVED***;
    ...
    __esDecorate = function (ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {
        function accept(f) { if (f !== void 0 && typeof f !== "function") throw new TypeError("Function expected"); return f; ***REMOVED***
        var kind = contextIn.kind, key = kind === "getter" ? "get" : kind === "setter" ? "set" : "value";
        var target = !descriptorIn && ctor ? contextIn["static"] ? ctor : ctor.prototype : null;
        var descriptor = descriptorIn || (target ? Object.getOwnPropertyDescriptor(target, contextIn.name) : {***REMOVED***);
        var _, done = false;
        for (var i = decorators.length - 1; i >= 0; i--) {
            var context = {***REMOVED***;
            for (var p in contextIn) context[p] = p === "access" ? {***REMOVED*** : contextIn[p];
            for (var p in contextIn.access) context.access[p] = contextIn.access[p];
            context.addInitializer = function (f) { if (done) throw new TypeError("Cannot add initializers after decoration has completed"); extraInitializers.push(accept(f || null)); ***REMOVED***;
            var result = (0, decorators[i])(kind === "accessor" ? { get: descriptor.get, set: descriptor.set ***REMOVED*** : descriptor[key], context);
            if (kind === "accessor") {
    ...
    ***REMOVED***;
    ...
    __setFunctionName = function (f, name, prefix) {
        ...
        return Object.defineProperty(f, "name", { configurable: true, value: prefix ? "".concat(prefix, " ", name) : name ***REMOVED***);
    ***REMOVED***;
    ...
    ***REMOVED***;
    ...
    __generator = function (thisArg, body) {
        var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; ***REMOVED***, trys: [], ops: [] ***REMOVED***, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
        return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; ***REMOVED***), g;
    ...
    ***REMOVED***;
    ...
    __asyncGenerator = function (thisArg, _arguments, generator) {
        ...
        return i = Object.create((typeof AsyncIterator === "function" ? AsyncIterator : Object).prototype), verb("next"), verb("throw"), verb("return", awaitReturn), i[Symbol.asyncIterator] = function () { return this; ***REMOVED***, i;
        function awaitReturn(f) { return function (v) { return Promise.resolve(v).then(f, reject); ***REMOVED***; ***REMOVED***
        function verb(n, f) { if (g[n]) { i[n] = function (v) { return new Promise(function (a, b) { q.push([n, v, a, b]) > 1 || resume(n, v); ***REMOVED***); ***REMOVED***; if (f) i[n] = f(i[n]); ***REMOVED*** ***REMOVED***
    ...
    ***REMOVED***;
    ...
    __asyncDelegator = function (o) {
        ...
        function verb(n, f) { i[n] = o[n] ? function (v) { return (p = !p) ? { value: __await(o[n](v)), done: false ***REMOVED*** : f ? f(v) : v; ***REMOVED*** : f; ***REMOVED***
    ***REMOVED***;
    ...
    __addDisposableResource = function (env, value, async) {
        if (value !== null && value !== void 0) {
            ...
            ***REMOVED***
            ...
            if (inner) dispose = function() { try { inner.call(this); ***REMOVED*** catch (e) { return Promise.reject(e); ***REMOVED*** ***REMOVED***;
            env.stack.push({ value: value, dispose: dispose, async: async ***REMOVED***);
        ***REMOVED***
        else if (async) {
            env.stack.push({ async: true ***REMOVED***);
        ***REMOVED***
        return value;
    ***REMOVED***;
            ...
            while (r = env.stack.pop()) {
                try {
                    ...
                    if (r.dispose) {
                        ...
                        if (r.async) return s |= 2, Promise.resolve(result).then(next, function(e) { fail(e); return next(); ***REMOVED***);
                    ***REMOVED***
                    else s |= 1;
                ***REMOVED***
                catch (e) {
