'use strict';var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;***REMOVED*** : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;***REMOVED***;
...
var _docsUrl = require('../docsUrl');var _docsUrl2 = _interopRequireDefault(_docsUrl);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***function _toConsumableArray(arr) {if (Array.isArray(arr)) {for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) {arr2[i] = arr[i];***REMOVED***return arr2;***REMOVED*** else {return Array.from(arr);***REMOVED******REMOVED*** /**
...
/**
   ...
   * @param {string***REMOVED*** src path to the src root
   * @param {string[]***REMOVED*** extensions list of supported extensions
   * @returns {{ filename: string, ignored: boolean ***REMOVED***[]***REMOVED*** list of files to operate on
   */
function listFilesUsingFileEnumerator(FileEnumerator, src, extensions) {
  ...
  return Array.from(
  e.iterateFiles(src),
  function (_ref) {var filePath = _ref.filePath,ignored = _ref.ignored;return { filename: filePath, ignored: ignored ***REMOVED***;***REMOVED***);
...
/**
   ...
   * @param {string***REMOVED*** src path to the src root
   * @param {string[]***REMOVED*** extensions list of supported extensions
   * @returns {string[]***REMOVED*** list of files to operate on
   */
function listFilesWithLegacyFunctions(src, extensions) {
  ...
  ***REMOVED*** catch (e) {
    ...
    ***REMOVED***
    ...
    src,
    function (pattern) {return extensions.map(function (extension) {return (/\*\*|\*\./.test(pattern) ? pattern : String(pattern) + '/**/*' + String(extension));***REMOVED***);***REMOVED***));
...
/**
   ...
   * @param {string[]***REMOVED*** srcPaths array of source paths (for flat config this should just be a singular root (e.g. cwd))
   * @param {string[]***REMOVED*** extensions list of supported extensions
   * @param {{ isDirectoryIgnored: (path: string) => boolean, isFileIgnored: (path: string) => boolean ***REMOVED******REMOVED*** session eslint context session object
   * @returns {string[]***REMOVED*** list of files to operate on
   */
  ...
  i) {
    ...
    var entries = (0, _fsWalk.walkSync)(src, {
      deepFilter: function () {function deepFilter(entry) {
        ...
        ***REMOVED***return deepFilter;***REMOVED***(),
      entryFilter: function () {function entryFilter(entry) {
          ...
          return (
            ...
            extensions.find(function (extension) {return entry.path.endsWith(extension);***REMOVED***));

        ***REMOVED***return entryFilter;***REMOVED***() ***REMOVED***);


    // Filter out directories and map entries to their paths
    files.push.apply(files, _toConsumableArray(
    entries.
    filter(function (entry) {return !entry.dirent.isDirectory();***REMOVED***).
    map(function (entry) {return entry.path;***REMOVED***)));***REMOVED***;for (var i = 0; i < srcPaths.length; i++) {_loop(i);
...
/**
   ...
   * with this rule.
   * @param {string***REMOVED*** src - file, directory, or glob pattern of files to act on
   * @param {string[]***REMOVED*** extensions - list of supported file extensions
   * @param {import('eslint').Rule.RuleContext***REMOVED*** context - the eslint context object
   * @returns {string[] | { filename: string, ignored: boolean ***REMOVED***[]***REMOVED*** the list of files that this rule will evaluate.
   */
...
function forEachDeclarationIdentifier(declaration, cb) {
  if (declaration) {
    ...
    ***REMOVED*** else if (declaration.type === VARIABLE_DECLARATION) {
      declaration.declarations.forEach(function (_ref2) {var id = _ref2.id;
        if (id.type === OBJECT_PATTERN) {
          (0, _patternCapture2['default'])(id, function (pattern) {
            ...
            ***REMOVED***
          ***REMOVED***);
        ***REMOVED*** else if (id.type === ARRAY_PATTERN) {
...
/**
   ...
   *
   *   import { o2 ***REMOVED*** from './bar.js';
   *
   * Then we will have a structure that looks like:
   *
   *   Map { 'foo.js' => Map { 'bar.js' => Set { 'o2' ***REMOVED*** ***REMOVED*** ***REMOVED***
   *
...
/**
                             ...
                             * Then we will have a structure that looks like:
                             *
                             *   Map { 'bar.js' => Map { 'o2' => { whereUsed: Set { 'foo.js' ***REMOVED*** ***REMOVED*** ***REMOVED*** ***REMOVED***
                             *
                             * @type {Map<string, Map<string, object>>***REMOVED***
                             */
...
var isNodeModule = function isNodeModule(path) {return (/\/(node_modules)\//.test(path));***REMOVED***;

/**
                                                                                             * read all files matching the patterns in src and ignoreExports
                                                                                             *
                                                                                             * return all files matching src pattern, which are not matching the ignoreExports pattern
                                                                                             * @type {(src: string, ignoreExports: string, context: import('eslint').Rule.RuleContext) => Set<string>***REMOVED***
                                                                                             */
function resolveFiles(src, ignoreExports, context) {
  ...
  if (ignoredFilesList.length && typeof ignoredFilesList[0] === 'string') {
    ignoredFilesList.forEach(function (filename) {return ignoredFiles.add(filename);***REMOVED***);
  ***REMOVED*** else {
    ignoredFilesList.forEach(function (_ref4) {var filename = _ref4.filename;return ignoredFiles.add(filename);***REMOVED***);
  ***REMOVED***

  // prepare list of source files, don't consider files from node_modules
  var resolvedFiles = srcFileList.length && typeof srcFileList[0] === 'string' ?
  srcFileList.filter(function (filePath) {return !isNodeModule(filePath);***REMOVED***) :
  (0, _arrayPrototype2['default'])(srcFileList, function (_ref5) {var filename = _ref5.filename;return isNodeModule(filename) ? [] : filename;***REMOVED***);
    ...
    if (currentExports) {var
      ...
      ***REMOVED***);
      ...
      reexports.forEach(function (value, key) {
        if (key === DEFAULT) {
          exports.set(IMPORT_DEFAULT_SPECIFIER, { whereUsed: new Set() ***REMOVED***);
        ***REMOVED*** else {
          exports.set(key, { whereUsed: new Set() ***REMOVED***);
        ***REMOVED***
      ...
      ***REMOVED***);
    ***REMOVED***
    exports.set(EXPORT_ALL_DECLARATION, { whereUsed: new Set() ***REMOVED***);
    exports.set(IMPORT_NAMESPACE_SPECIFIER, { whereUsed: new Set() ***REMOVED***);
    ...
    listValue.forEach(function (value, key) {
      ...
      if (typeof exports !== 'undefined') {
        value.forEach(function (currentImport) {
          ...
          ***REMOVED*** else if (currentImport === IMPORT_DEFAULT_SPECIFIER) {
          ...
          ***REMOVED***
          if (typeof specifier !== 'undefined') {
            ...
            if (typeof exportStatement !== 'undefined') {var
              ...
              exports.set(specifier, { whereUsed: whereUsed ***REMOVED***);
            ***REMOVED***
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED***
...
var doPreparation = function doPreparation(src, ignoreExports, context) {
  var prepareKey = JSON.stringify({
    ...
    extensions: Array.from((0, _ignore.getFileExtensions)(context.settings)).sort() ***REMOVED***);
...
var newNamespaceImportExists = function newNamespaceImportExists(specifiers) {return specifiers.some(function (_ref7) {var type = _ref7.type;return type === IMPORT_NAMESPACE_SPECIFIER;***REMOVED***);***REMOVED***;

var newDefaultImportExists = function newDefaultImportExists(specifiers) {return specifiers.some(function (_ref8) {var type = _ref8.type;return type === IMPORT_DEFAULT_SPECIFIER;***REMOVED***);***REMOVED***;

var fileIsInPkg = function fileIsInPkg(file) {var _readPkgUp =
  (0, _readPkgUp3['default'])({ cwd: file ***REMOVED***),path = _readPkgUp.path,pkg = _readPkgUp.pkg;
  ...
  ***REMOVED***;
  ...
  var checkPkgFieldObject = function checkPkgFieldObject(pkgField) {
    var pkgFieldFiles = (0, _arrayPrototype2['default'])((0, _object2['default'])(pkgField), function (value) {return typeof value === 'boolean' ? [] : (0, _path.join)(basePath, value);***REMOVED***);
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-unused-modules') ***REMOVED***,
    ...
    schema: [{
      ...
      {
        properties: {
          unusedExports: { 'enum': [true] ***REMOVED***,
          src: {
            minItems: 1 ***REMOVED*** ***REMOVED***,


        required: ['unusedExports'] ***REMOVED***,

      {
        properties: {
          missingExports: { 'enum': [true] ***REMOVED*** ***REMOVED***,

        required: ['missingExports'] ***REMOVED***] ***REMOVED***] ***REMOVED***,
  ...
  create: function () {function create(context) {var _ref9 =
      ...
      context.options[0] || {***REMOVED***,src = _ref9.src,_ref9$ignoreExports = _ref9.ignoreExports,ignoreExports = _ref9$ignoreExports === undefined ? [] : _ref9$ignoreExports,missingExports = _ref9.missingExports,unusedExports = _ref9.unusedExports,ignoreUnusedTypeExports = _ref9.ignoreUnusedTypeExports;
      ...
      ***REMOVED***
      ...
      var checkExportPresence = function () {function checkExportPresence(node) {
        ...
        ***REMOVED***return checkExportPresence;***REMOVED***();
      ...
      var checkUsage = function () {function checkUsage(node, exportedValue, isTypeExport) {
          ...
          ***REMOVED***
        ***REMOVED***return checkUsage;***REMOVED***();
      ...
      var updateExportUsage = function () {function updateExportUsage(node) {
          ...
          ***REMOVED***);
          ...
          newExportIdentifiers.forEach(function (key) {
            if (!exports.has(key)) {
              newExports.set(key, { whereUsed: new Set() ***REMOVED***);
            ***REMOVED***
          ***REMOVED***);
          ...
          if (typeof namespaceImports === 'undefined') {
            namespaceImports = { whereUsed: new Set() ***REMOVED***;
          ***REMOVED***

          newExports.set(EXPORT_ALL_DECLARATION, exportAll);
          newExports.set(IMPORT_NAMESPACE_SPECIFIER, namespaceImports);
          exportList.set(file, newExports);
        ***REMOVED***return updateExportUsage;***REMOVED***();
          ...
          ***REMOVED***
          ...
          (0, _visit2['default'])(node, visitorKeyMap.get(file), {
            ImportExpression: function () {function ImportExpression(child) {
              ...
              ***REMOVED***return ImportExpression;***REMOVED***(),
          ...
          node.body.forEach(function (astNode) {
            ...
            // support for export { value ***REMOVED*** from 'module'
            ...
            ***REMOVED***
            ...
            if (astNode.type === IMPORT_DECLARATION) {
              ...
              ***REMOVED***
              ...
              astNode.specifiers.
              filter(function (specifier) {return specifier.type !== IMPORT_DEFAULT_SPECIFIER && specifier.type !== IMPORT_NAMESPACE_SPECIFIER;***REMOVED***).
          ...
          newExportAll.forEach(function (value) {
            if (!oldExportAll.has(value)) {
              ...
              ***REMOVED*** else {
                ...
                whereUsed.add(file);
                _exports.set(EXPORT_ALL_DECLARATION, { whereUsed: whereUsed ***REMOVED***);
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***);
          ...
          newDefaultImports.forEach(function (value) {
            if (!oldDefaultImports.has(value)) {
              ...
              ***REMOVED*** else {
                var whereUsed = new Set();
                whereUsed.add(file);
                _exports3.set(IMPORT_DEFAULT_SPECIFIER, { whereUsed: whereUsed ***REMOVED***);
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***);
          ...
          newNamespaceImports.forEach(function (value) {
            if (!oldNamespaceImports.has(value)) {
              ...
              ***REMOVED*** else {
                var whereUsed = new Set();
                whereUsed.add(file);
                _exports5.set(IMPORT_NAMESPACE_SPECIFIER, { whereUsed: whereUsed ***REMOVED***);
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***);
          ...
          newImports.forEach(function (value, key) {
            if (!oldImports.has(key)) {
              ...
              ***REMOVED*** else {
                var whereUsed = new Set();
                whereUsed.add(file);
                _exports7.set(key, { whereUsed: whereUsed ***REMOVED***);
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***);
          ...
          oldImports.forEach(function (value, key) {
            ...
            ***REMOVED***
          ***REMOVED***);
        ***REMOVED***return updateImportUsage;***REMOVED***();
      ...
      return {
        'Program:exit': function () {function ProgramExit(node) {
          ...
          ***REMOVED***return ProgramExit;***REMOVED***(),
        ExportDefaultDeclaration: function () {function ExportDefaultDeclaration(node) {
            checkUsage(node, IMPORT_DEFAULT_SPECIFIER, false);
          ***REMOVED***return ExportDefaultDeclaration;***REMOVED***(),
