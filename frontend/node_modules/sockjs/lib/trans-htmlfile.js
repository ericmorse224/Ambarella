...
(function() {
  ...
  iframe_template = "<!doctype html>\n<html><head>\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" />\n  <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n</head><body><h2>Don't panic!</h2>\n  <script>\n    document.domain = document.domain;\n    var c = parent.{{ callback ***REMOVED******REMOVED***;\n    c.start();\n    function p(d) {c.message(d);***REMOVED***;\n    window.onload = function() {c.stop();***REMOVED***;\n  </script>";
  ...
  exports.app = {
    htmlfile: function(req, res) {
      ...
      ***REMOVED***
      ...
      res.writeHead(200);
      res.write(iframe_template.replace(/{{ callback ***REMOVED******REMOVED***/g, callback));
