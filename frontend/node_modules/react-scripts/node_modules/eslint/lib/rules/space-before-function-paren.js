...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
        ...
        const overrideConfig = typeof context.options[0] === "object" ? context.options[0] : {***REMOVED***;
        ...
        ***REMOVED***
        ...
        function getConfigForFunction(node) {
            if (node.type === "ArrowFunctionExpression") {
                ...
                if (node.async && astUtils.isOpeningParenToken(sourceCode.getFirstToken(node, { skip: 1 ***REMOVED***))) {
                    return overrideConfig.asyncArrow || baseConfig;
                ***REMOVED***
            ***REMOVED*** else if (isNamedFunction(node)) {
                return overrideConfig.named || baseConfig;

            // `generator-star-spacing` should warn anonymous generators. E.g. `function* () {***REMOVED***`
            ***REMOVED*** else if (!node.generator) {
            ...
            ***REMOVED***
            ...
            if (hasSpacing && functionConfig === "never") {
                context.report({
                    ...
                    ***REMOVED***
                ***REMOVED***);
            ***REMOVED*** else if (!hasSpacing && functionConfig === "always") {
                context.report({
                    node,
                    loc: rightToken.loc,
