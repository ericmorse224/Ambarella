...
import type { Definition ***REMOVED*** from '../definition';
import type { ReferenceImplicitGlobal ***REMOVED*** from '../referencer/Reference';
import { Reference, ReferenceFlag ***REMOVED*** from '../referencer/Reference';
...
declare abstract class ScopeBase<TType extends ScopeType, TBlock extends TSESTree.Node, TUpper extends Scope | null> {
    ...
    /**
     * Any variable {@link Reference***REMOVED*** found in this scope.
    ...
    /**
     * The {@link Reference***REMOVED***s that are not resolved with this scope.
     * @public
     */
    ...
    readonly type: TType;
    /**
     * Reference to the parent {@link Scope***REMOVED***.
     * @public
     */
    readonly upper: TUpper;
    /**
     * The scoped {@link Variable***REMOVED***s of this scope.
