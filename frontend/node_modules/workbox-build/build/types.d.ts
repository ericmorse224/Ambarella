import { PackageJson ***REMOVED*** from 'type-fest';
import { BroadcastCacheUpdateOptions ***REMOVED*** from 'workbox-broadcast-update/BroadcastCacheUpdate';
import { GoogleAnalyticsInitializeOptions ***REMOVED*** from 'workbox-google-analytics/initialize';
import { HTTPMethod ***REMOVED*** from 'workbox-routing/utils/constants';
import { QueueOptions ***REMOVED*** from 'workbox-background-sync/Queue';
import { RouteHandler, RouteMatchCallback ***REMOVED*** from 'workbox-core/types';
import { CacheableResponseOptions ***REMOVED*** from 'workbox-cacheable-response/CacheableResponse';
import { ExpirationPluginOptions ***REMOVED*** from 'workbox-expiration/ExpirationPlugin';
import { WorkboxPlugin ***REMOVED*** from 'workbox-core/types';
...
export interface RuntimeCaching {
     ...
     * To use one of the built-in {@link workbox-strategies***REMOVED***, provide its name,
     * like `'NetworkFirst'`.
     * Alternatively, this can be a {@link workbox-core.RouteHandler***REMOVED*** callback
    ...
    options?: {
         ...
         * {@link workbox-background-sync.BackgroundSyncPlugin***REMOVED*** instance to the
         * {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        backgroundSync?: {
            name: string;
        ...
        ***REMOVED***;
        /**
         * Configuring this will add a
         * {@link workbox-broadcast-update.BroadcastUpdatePlugin***REMOVED*** instance to the
         * {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        broadcastUpdate?: {
            channelName?: string;
        ...
        ***REMOVED***;
        /**
         * Configuring this will add a
         * {@link workbox-cacheable-response.CacheableResponsePlugin***REMOVED*** instance to
         * the {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        ...
        /**
         * Configuring this will add a
         * {@link workbox-expiration.ExpirationPlugin***REMOVED*** instance to
         * the {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        expiration?: ExpirationPluginOptions;
        /**
         * If provided, this will set the `networkTimeoutSeconds` property of the
         * {@link workbox-strategies***REMOVED*** configured in `handler`. Note that only
         ...
         * {@link workbox-expiration.ExpirationPlugin***REMOVED***). The plugins provided here
         * will be added to the {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        plugins?: Array<WorkboxPlugin>;
        /**
         * Configuring this will add a
         * {@link workbox-precaching.PrecacheFallbackPlugin***REMOVED*** instance to
         * the {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
        precacheFallback?: {
            fallbackURL: string;
        ***REMOVED***;
         ...
         * {@link workbox-range-requests.RangeRequestsPlugin***REMOVED*** instance to
         * the {@link workbox-strategies***REMOVED*** configured in `handler`.
         */
    ...
    ***REMOVED***;
     ...
     * {@link workbox-routing.registerRoute***REMOVED***. It's recommended to use a
     * {@link workbox-core.RouteMatchCallback***REMOVED*** function for greatest flexibility.
     */
...
export type ManifestTransform = (manifestEntries: Array<ManifestEntry & {
    size: number;
***REMOVED***>, compilation?: unknown) => Promise<ManifestTransformResult> | ManifestTransformResult;
...
export interface GeneratePartial {
     ...
     * translated to {@link workbox-routing.registerRoute***REMOVED*** calls using the match
     * and handler configuration you define.
     *
     * For all of the options, see the {@link workbox-build.RuntimeCaching***REMOVED***
     * documentation. The example below shows a typical configuration, with two
     * runtime routes defined:
     *
     * @example
     * runtimeCaching: [{
     *   urlPattern: ({url***REMOVED***) => url.origin === 'https://api.example.com',
     *   handler: 'NetworkFirst',
     *   options: {
     *     cacheName: 'api-cache',
     *   ***REMOVED***,
     * ***REMOVED***, {
     *   urlPattern: ({request***REMOVED***) => request.destination === 'image',
     ...
     * calling `postMessage({type: 'SKIP_WAITING'***REMOVED***)` on a waiting service worker.
     * @default false
     */
    skipWaiting?: boolean;
    /**
