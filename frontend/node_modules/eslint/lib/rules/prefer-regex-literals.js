...
const {
	...
	visitRegExpAST,
	RegExpParser,
***REMOVED*** = require("@eslint-community/regexpp");
...
module.exports = {
		...
		***REMOVED***,
		...
		messages: {
			...
			replaceWithLiteralAndFlags:
				"Replace with an equivalent regular expression literal with flags '{{ flags ***REMOVED******REMOVED***'.",
			replaceWithIntendedLiteralAndFlags:
				"Replace with a regular expression literal with flags '{{ flags ***REMOVED******REMOVED***'.",
	...
	***REMOVED***,
	...
	create(context) {
		const [{ disallowRedundantWrapping ***REMOVED***] = context.options;
							...
							***REMOVED***
							...
							context.report({
								...
								suggest: suggests.map(
									({ flags, pattern, messageId ***REMOVED***) => ({
										messageId,
										data: {
											flags,
										***REMOVED***,
