...
```js
postcssCustomProperties({
  importFrom: 'path/to/file.css' // => :root { --color: red ***REMOVED***
***REMOVED***);
```
...
postcssCustomProperties({
  importFrom: [
    'path/to/file.css',   // :root { --color: red; ***REMOVED***
    'and/then/this.js',   // module.exports = { customProperties: { '--color': 'red' ***REMOVED*** ***REMOVED***
    'and/then/that.json', // { "custom-properties": { "--color": "red" ***REMOVED*** ***REMOVED***
    {
...
```js
postcssCustomProperties({
  exportTo: 'path/to/file.css' // :root { --color: red; ***REMOVED***
***REMOVED***);
```
...
```js
const cachedObject = { customProperties: {***REMOVED*** ***REMOVED***;

postcssCustomProperties({
  exportTo: [
    'path/to/file.css',   // :root { --color: red; ***REMOVED***
    'and/then/this.js',   // module.exports = { customProperties: { '--color': 'red' ***REMOVED*** ***REMOVED***
    'and/then/this.mjs',  // export const customProperties = { '--color': 'red' ***REMOVED*** ***REMOVED***
    'and/then/that.json', // { "custom-properties": { "--color": "red" ***REMOVED*** ***REMOVED***
