...
module.exports = {
	tests: function (zip, name, t) {
		t['throws'](
			function () { return new zip(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
			'`' + name + '` itself is not a constructor'
		);
		t['throws'](
			function () { return new zip({***REMOVED***); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			t['throws'](
				function () { zip(nonIterator, []); ***REMOVED***,
				TypeError,
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			forEach(v.nonFunctions, function (nonFunction) {
				if (nonFunction != null) {
					...
					st['throws'](
						function () { zip([[], badIterable, []]).next(); ***REMOVED***,
						TypeError,
