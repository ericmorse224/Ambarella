import type { CorePluginList ***REMOVED*** from './generated/corePluginList'
import type { DefaultColors ***REMOVED*** from './generated/colors'

// Helpers
type Expand<T> = T extends object
  ? T extends infer O
    ? { [K in keyof O]: Expand<O[K]> ***REMOVED***
    : never
  : T
...
interface PluginUtils {
  ...
  rgb(arg: string): (arg: Partial<{ opacityVariable: string; opacityValue: number ***REMOVED***>) => string
  hsl(arg: string): (arg: Partial<{ opacityVariable: string; opacityValue: number ***REMOVED***>) => string
***REMOVED***

// Content related config
type FilePath = string
type RawFile = { raw: string; extension?: string ***REMOVED***
...
type ContentConfig =
  ...
  | {
      ...
      relative?: boolean
      extract?: ExtractorFn | { [extension: string]: ExtractorFn ***REMOVED***
      transform?: TransformerFn | { [extension: string]: TransformerFn ***REMOVED***
    ***REMOVED***
...
type SafelistConfig = string | { pattern: RegExp; variants?: string[] ***REMOVED***
...
type Screen = { raw: string ***REMOVED*** | { min: string ***REMOVED*** | { max: string ***REMOVED*** | { min: string; max: string ***REMOVED***
...
export interface PluginAPI {
  ...
  matchUtilities<T = string, U = string>(
    utilities: KeyValuePair<
      string,
      (value: T | string, extra: { modifier: U | string | null ***REMOVED***) => CSSRuleObject | null
    >,
    options?: Partial<{
      respectPrefix: boolean
      respectImportant: boolean
  ...
  matchVariant<T = string>(
    name: string,
    cb: (value: T | string, extra: { modifier: string | null ***REMOVED***) => string | string[],
    options?: {
      values?: KeyValuePair<string, T>
      sort?(
        a: { value: T | string; modifier: string | null ***REMOVED***,
        b: { value: T | string; modifier: string | null ***REMOVED***
      ): number
    ***REMOVED***
  ): void
...
export type PluginsConfig = (
  | PluginCreator
  | { handler: PluginCreator; config?: Partial<Config> | undefined ***REMOVED***
  | {
      (options: any): {
...
interface OptionalConfig {
  ...
  theme: Partial<CustomThemeConfig & { extend: Partial<CustomThemeConfig> ***REMOVED***>
