 ...
 */
declare module "vm" {
    import { ImportAttributes ***REMOVED*** from "node:module";
    interface Context extends NodeJS.Dict<any> {***REMOVED***
    ...
    ***REMOVED***
    ...
    class Script {
         ...
         *
         * console.log(context);
         * // Prints: { animal: 'cat', count: 12, name: 'kitty' ***REMOVED***
         * ```
         *
         ...
         *
         * const contexts = [{***REMOVED***, {***REMOVED***, {***REMOVED***];
         * contexts.forEach((context) => {
         *   script.runInNewContext(context);
         * ***REMOVED***);
         *
         * console.log(contexts);
         * // Prints: [{ globalVar: 'set' ***REMOVED***, { globalVar: 'set' ***REMOVED***, { globalVar: 'set' ***REMOVED***]
         *
         ...
         * global.globalVar = 0;
         *
         * const script = new vm.Script('globalVar += 1', { filename: 'myfile.vm' ***REMOVED***);
         *
    ...
    ***REMOVED***
     ...
     * and return a reference to it so that it can be used in calls to {@link runInContext***REMOVED*** or
     ...
     * global.globalVar = 3;
     *
     * const context = { globalVar: 1 ***REMOVED***;
     * vm.createContext(context);
     *
     * vm.runInContext('globalVar *= 2;', context);
     *
     * console.log(context);
     * // Prints: { globalVar: 2 ***REMOVED***
     *
    ...
    /**
     * Returns `true` if the given `object` object has been contextified using {@link createContext***REMOVED***,
     ...
     * previously `contextified` using the {@link createContext***REMOVED*** method.
     *
     ...
     * import vm from 'node:vm';
     *
     * const contextObject = { globalVar: 1 ***REMOVED***;
     ...
     * console.log(contextObject);
     * // Prints: { animal: 'cat', count: 3, name: 'kitty' ***REMOVED***
     *
     * // This would throw if the context is created from a contextified object.
     ...
     * console.log(`vmResult: '${vmResult***REMOVED***', localVar: '${localVar***REMOVED***'`);
     * // Prints: vmResult: 'vm', localVar: 'initial value'
     *
     * const evalResult = eval('localVar = "eval";');
     * console.log(`evalResult: '${evalResult***REMOVED***', localVar: '${localVar***REMOVED***'`);
     ...
     *
     * When using either `script.runInThisContext()` or {@link runInThisContext***REMOVED***, the code is executed within the current V8 global
     ...
     *     response.writeHead(200, { 'Content-Type': 'text/plain' ***REMOVED***);
    ...
    ***REMOVED***;
     ...
     * vm.measureMemory({ mode: 'summary' ***REMOVED***)
     ...
     *   ***REMOVED***);
     *
     * const context = vm.createContext({ a: 1 ***REMOVED***);
     * vm.measureMemory({ mode: 'detailed', execution: 'eager' ***REMOVED***)
     *   .then((result) => {
    ...
    ***REMOVED***
     ...
     *   s;
     *   print(s);
     * `, { context: contextifiedObject ***REMOVED***);
     *
     * // Step 2
     * //
     ...
     *     `, { context: referencingModule.context ***REMOVED***);
     *
     *     // Using `contextifiedObject` instead of `referencingModule.context`
     *     // here would work as well.
     *   ***REMOVED***
     *   throw new Error(`Unable to resolve dependency: ${specifier***REMOVED***`);
     * ***REMOVED***
    ...
    ***REMOVED***
    ...
    namespace constants {
         ...
         * one.
         *
         * When `vm.constants.DONT_CONTEXTIFY` is used as the `contextObject` argument to {@link createContext***REMOVED***,
