...
/** @template {true***REMOVED*** T @template U @typedef {T extends U ? T : never***REMOVED*** AssertType */
...
test('callBound', function (t) {
	...
	t['throws'](
		// @ts-expect-error
		function () { callBound('does not exist'); ***REMOVED***,
		SyntaxError,
		'nonexistent intrinsic throws'
	);
	t['throws'](
		// @ts-expect-error
		function () { callBound('does not exist', true); ***REMOVED***,
		SyntaxError,
		'allowMissing arg still throws for unknown intrinsic'
	);

	t.test('real but absent intrinsic', { skip: typeof WeakRef !== 'undefined' ***REMOVED***, function (st) {
		st['throws'](
			function () { callBound('WeakRef'); ***REMOVED***,
			TypeError,
