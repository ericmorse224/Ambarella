...
deflate.outgoing({ data: large ***REMOVED***, function() {
  console.log(1, 'large');
***REMOVED***);

deflate.outgoing({ data: small ***REMOVED***, function() {
  console.log(2, 'small');
***REMOVED***);
...
var stream  = require('stream'),
    session = new stream.Transform({ objectMode: true ***REMOVED***);
...
functor.call({ data: large ***REMOVED***, function() {
  console.log(1, 'large');
***REMOVED***);

functor.call({ data: small ***REMOVED***, function() {
  console.log(2, 'small');
***REMOVED***);
