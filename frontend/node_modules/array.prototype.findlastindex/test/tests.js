...
var trueThunk = function () { return true; ***REMOVED***;
var falseThunk = function () { return false; ***REMOVED***;

var canDistinguishSparseFromUndefined = 0 in [undefined]; // IE 6 - 8 have a bug where this returns false.
var undefinedIfNoSparseBug = canDistinguishSparseFromUndefined ? undefined : { valueOf: function () { return 0; ***REMOVED*** ***REMOVED***;
...
module.exports = function (findLastIndex, t) {
	forEach(v.nonArrays, function (nonArray) {
		if (nonArray != null) { // eslint-disable-line eqeqeq
			t.equal(
				findLastIndex(nonArray, function () { return true; ***REMOVED***),
	...
	***REMOVED***);
	...
	t.test('throws on a non-callable predicate', function (st) {
		forEach(v.nonFunctions, function (nonFunction) {
			st['throws'](
				function () { findLastIndex([], nonFunction); ***REMOVED***,
				TypeError,
	...
	***REMOVED***);
	...
	t.test('sets the right context when given none', function (st) {
		var context;
		findLastIndex([1], function () { context = this; ***REMOVED***);
		st.equal(context, global, 'receiver is global object in sloppy mode');

		st.test('strict mode', { skip: !hasStrictMode ***REMOVED***, function (sst) {
	...
	***REMOVED***);
	...
	t.test('empty array', function (st) {
		...
		var counter = 0;
		var callback = function () { counter += 1; ***REMOVED***;
	...
	t.test('stopping after N elements', function (st) {
		st.test('no context', function (sst) {
			...
			findLastIndex(getTestArr(), function (obj, index) {
				...
				return count === 4;
			***REMOVED***);
			sst.deepEqual(actual, { 4: true, 5: undefinedIfNoSparseBug, 6: undefined, 7: 2 ***REMOVED***);
			sst.end();
		***REMOVED***);

		st.test('with context', function (sst) {
			var actual = {***REMOVED***;
			var context = { actual: actual ***REMOVED***;
			var count = 0;
			findLastIndex(getTestArr(), function (obj, index) {
	...
	***REMOVED***);
	...
	t.test('maximum index', function (st) {
		...
		var arrayLike = { length: Number.MAX_VALUE ***REMOVED***;
		var calledWithIndex = [];
