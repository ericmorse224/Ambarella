...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            outOfScope: "'{{name***REMOVED******REMOVED***' declared on line {{definitionLine***REMOVED******REMOVED*** column {{definitionColumn***REMOVED******REMOVED*** is used outside of binding context."
        ***REMOVED***
    ***REMOVED***,
