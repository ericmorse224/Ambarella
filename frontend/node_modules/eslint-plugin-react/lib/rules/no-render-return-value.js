...
const messages = {
  noReturnValue: 'Do not depend on the return value from {{node***REMOVED******REMOVED***.render',
***REMOVED***;
...
module.exports = {
  ...
  ***REMOVED***,
  ...
  create(context) {
    ...
    ***REMOVED*** else if (testReactVersion(context, '^0.14.0')) {
      calleeObjectName = /^React(DOM)?$/;
    ***REMOVED*** else if (testReactVersion(context, '^0.13.0')) {
