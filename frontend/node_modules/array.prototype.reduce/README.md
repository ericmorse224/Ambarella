...
assert.equal(reduce([1, 2, 3], function (prev, x) { return prev + x; ***REMOVED***), 6);
assert.equal(reduce([1, 2, 3], function (prev, x) { return prev + x; ***REMOVED***, 1), 7);
```
...
var arr = [1, 2, 3];
var sum = function (a, b) { return a + b; ***REMOVED***;
