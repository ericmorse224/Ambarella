...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            unsafeReturn: 'Unsafe return of an `{{type***REMOVED******REMOVED***` typed value.',
            unsafeReturnThis: [
                'Unsafe return of an `{{type***REMOVED******REMOVED***` typed value. `this` is typed as `any`.',
                'You can try to fix this by turning on the `noImplicitThis` compiler option, or adding a `this` parameter to the function.',
            ].join('\n'),
            unsafeReturnAssignment: 'Unsafe return of type `{{sender***REMOVED******REMOVED***` from function with return type `{{receiver***REMOVED******REMOVED***`.',
        ***REMOVED***,
        schema: [],
    ***REMOVED***,
    defaultOptions: [],
