 ...
 * @returns {boolean***REMOVED*** `true` if the node is a looping target.
 */
 ...
 * @returns {Array***REMOVED*** a new array that represents `arrA \ arrB`.
 */
...
module.exports = {
	...
	***REMOVED***,
	...
	create(context) {
		const [{ ignore: ignoredLoopTypes ***REMOVED***] = context.options;
			...
			***REMOVED***,
			...
			"Program:exit"() {
				loopsToReport.forEach(node =>
					context.report({ node, messageId: "invalid" ***REMOVED***),
				);
			***REMOVED***,
		***REMOVED***;
	***REMOVED***,
