 ...
 *
 * @example
 * const root = postcss.parse('a{color:black***REMOVED*** b{z-index:2***REMOVED***')
 * root.type         //=> 'root'
 * root.nodes.length //=> 2
 */
var Root = /*#__PURE__*/function (_Container) {
  ...
  ***REMOVED***
  /**
   * Returns a {@link Result***REMOVED*** instance representing the root’s CSS.
   *
   * @param {processOptions***REMOVED*** [opts] Options with only `to` and `map` keys.
   *
   * @return {Result***REMOVED*** Result with current root’s CSS.
   *
   * @example
   * const root1 = postcss.parse(css1, { from: 'a.css' ***REMOVED***)
   * const root2 = postcss.parse(css2, { from: 'b.css' ***REMOVED***)
   * root1.append(root2)
   * const result = root1.toResult({ to: 'all.css', map: true ***REMOVED***)
   */
  ;
  ...
  ***REMOVED***
   ...
   * postcss.parse('a {***REMOVED***').raws   //=> { after: '' ***REMOVED***
   */
  ;
