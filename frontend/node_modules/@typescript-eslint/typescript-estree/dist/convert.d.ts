...
import type { TSError ***REMOVED*** from './node-utils';
import type { ParserWeakMap, ParserWeakMapESTreeToTSNode ***REMOVED*** from './parser-options';
import type { SemanticOrSyntacticError ***REMOVED*** from './semantic-or-syntactic-errors';
import type { TSESTree, TSNode ***REMOVED*** from './ts-estree';
