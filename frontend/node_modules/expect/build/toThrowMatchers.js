...
const createMatcher = (matcherName, fromPromise) =>
  function (received, expected) {
    ...
    ***REMOVED*** else if (typeof expected === 'function') {
      return toThrowExpectedClass(matcherName, options, thrown, expected);
    ***REMOVED*** else if (typeof expected === 'string') {
      return toThrowExpectedString(matcherName, options, thrown, expected);
    ***REMOVED*** else if (expected !== null && typeof expected.test === 'function') {
    ...
    ***REMOVED*** else if (expected !== null && typeof expected === 'object') {
      ...
      throw new Error(
        (0, _jestMatcherUtils.matcherErrorMessage)(
          ...
          `${(0, _jestMatcherUtils.EXPECTED_COLOR)(
            'expected'
          )***REMOVED*** value must be a string or regular expression or class or error`,
          (0, _jestMatcherUtils.printWithType)(
            'Expected',
            expected,
  ...
  ***REMOVED***
  ...
  if (key === 'message') {
    ...
    if (typeof expected === 'string') {
      ...
      ***REMOVED***
    ***REMOVED*** else if (expected instanceof RegExp) {
      return (
        label +
