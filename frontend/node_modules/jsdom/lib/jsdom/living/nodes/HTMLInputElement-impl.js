...
const { domSymbolTree, cloningSteps ***REMOVED*** = require("../helpers/internal-constants");
...
const {
  ...
  isValidAbsoluteURL,
  sanitizeValueByType
***REMOVED*** = require("../helpers/form-controls");
const {
  asciiCaseInsensitiveMatch,
  asciiLowercase,
  parseFloatingPointNumber,
  splitOnCommas
***REMOVED*** = require("../helpers/strings");
const { isDate ***REMOVED*** = require("../helpers/dates-and-times");
const {
  convertStringToNumberByType,
  convertStringToDateByType,
  serializeDateByType,
  convertNumberToStringByType
***REMOVED*** = require("../helpers/number-and-date-inputs");
  ...
  ***REMOVED***
  ...
  _legacyPreActivationBehavior() {
    if (this.type === "checkbox") {
      ...
      this.indeterminate = false;
    ***REMOVED*** else if (this.type === "radio") {
  ...
  _activationBehavior() {
    ...
    ***REMOVED***
    ...
    if (this.type === "checkbox" || (this.type === "radio" && !this._preCheckedRadioState)) {
      if (this.isConnected) {
        fireAnEvent("input", this, undefined, { bubbles: true ***REMOVED***);
        fireAnEvent("change", this, undefined, { bubbles: true ***REMOVED***);
      ***REMOVED***
    ***REMOVED*** else if (form && this.type === "submit") {
      form._doSubmit();
    ***REMOVED*** else if (form && this.type === "reset") {
      form._doReset();
    ***REMOVED***
  ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (name === "type") {
      ...
      if (prevType !== curType) {
        ...
        ***REMOVED*** else if (prevValueMode !== "value" && curValueMode === "value") {
          this._value = this.getAttributeNS(null, "value") || "";
          this._dirtyValue = false;
        ***REMOVED*** else if (prevValueMode !== "filename" && curValueMode === "filename") {
          this._value = "";
        ***REMOVED***
  ...
  ***REMOVED***
  ...
  _stepUpdate(n, isUp) {
    ...
    if (!this._idlMemberApplies(methodName)) {
      throw DOMException.create(this._globalObject, [
        `Failed to invoke '${methodName***REMOVED***' method on 'HTMLInputElement': ` +
  ...
  ***REMOVED***
  ...
  get list() {
    ...
    ***REMOVED***
    ...
    const el = this.getRootNode({***REMOVED***).getElementById(id);
