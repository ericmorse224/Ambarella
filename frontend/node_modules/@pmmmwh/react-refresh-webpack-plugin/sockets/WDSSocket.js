 ...
 * @param {function(*): void***REMOVED*** messageHandler A handler to consume Webpack compilation messages.
 * @param {string***REMOVED*** [resourceQuery] Webpack's `__resourceQuery` string.
...
module.exports = { init: initWDSSocket ***REMOVED***;
