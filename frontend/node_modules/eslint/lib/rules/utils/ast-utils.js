...
const { KEYS: eslintVisitorKeys ***REMOVED*** = require("eslint-visitor-keys");
 ...
 * @type {Record<string,boolean>***REMOVED*** Key is the name of the variable. Value is `true` if the variable is considered writable, `false` otherwise.
 */
const ECMASCRIPT_GLOBALS = globals[`es${LATEST_ECMA_VERSION***REMOVED***`];
 ...
 * @param {ASTNode***REMOVED*** node A node to check.
 * @returns {boolean***REMOVED*** Whether or not the node is a method which expects a function as a first argument, and `thisArg` as a second argument.
 */
 ...
 * @param {ASTNode***REMOVED*** node The SwitchCase node to get.
 * @param {SourceCode***REMOVED*** sourceCode The source code object to get tokens.
 * @returns {Token***REMOVED*** The colon token of the node.
 */
 ...
 * @param {ASTNode***REMOVED*** node `Identifier` or string `Literal` node in a position
 * that represents a module export name:
 *   - `ImportSpecifier#imported`
 *   - `ExportSpecifier#local` (if it is a re-export from another module)
 *   - `ExportSpecifier#exported`
 *   - `ExportAllDeclaration#exported`
 * @returns {string***REMOVED*** The module export name.
 */
 ...
 * @param {ASTNode***REMOVED*** node any `Literal` node
 * @returns {boolean | null***REMOVED*** `true` when node is truthy, `false` when node is falsy,
 ...
 * @param {ASTNode***REMOVED*** node The branch of main condition which needs to be checked
 * @param {string***REMOVED*** operator The operator of the main LogicalExpression.
 * @returns {boolean***REMOVED*** true when condition short circuits whole condition
 */
 ...
 * @param {Scope***REMOVED*** scope The scope in which the identifier is referenced.
 * @param {ASTNode***REMOVED*** node An identifier node to check.
 ...
 * @param {Scope***REMOVED*** scope Scope in which the node appears.
 * @param {ASTNode***REMOVED*** node The AST node to check.
 * @param {boolean***REMOVED*** inBooleanPosition `true` if checking the test of a
 * condition. `false` in all other cases. When `false`, checks if -- for
 * both string and number -- if coerced to that type, the value will
 * be constant.
 * @returns {boolean***REMOVED*** true when node's truthiness is constant
 * @private
 */
	...
	***REMOVED***
	switch (node.type) {
		...
		case "ObjectExpression":
			 ...
			 * Or a classes like:
			 *
			 * `class { static toString() { return a ***REMOVED*** ***REMOVED***`
			 * `class { static valueOf() { return a ***REMOVED*** ***REMOVED***`
			 *
 ...
 * directive.
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** Whether or not the node is an ExpressionStatement at the top level of a
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** `true` if the node is a part of directive prologue.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** Whether the node appears at the beginning of an ancestor ExpressionStatement node.
 */
 ...
 * @type {(sourceCode: SourceCode, node: ASTNode) => boolean***REMOVED***
 * @param {SourceCode***REMOVED*** sourceCode The source code object.
 * @param {ASTNode***REMOVED*** node A node at the position where an opening parenthesis or bracket will be inserted.
 * @returns {boolean***REMOVED*** Whether a semicolon is required before the opening parenthesis or bracket.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @returns {boolean***REMOVED*** Whether the node is used as an import attribute key.
 */
function isImportAttributeKey(node) {
	const { parent ***REMOVED*** = node;
...
module.exports = {
	...
	***REMOVED***,
	 ...
	 * @param {ASTNode***REMOVED*** node A function node to check. It also can be an implicit function, like `StaticBlock`
		...
		while (currentNode) {
			...
			switch (parent.type) {
				...
				***REMOVED***
				 ...
				 *   class A { foo = function() { ... ***REMOVED*** ***REMOVED***
				 */
				case "Property":
				case "PropertyDefinition":
				case "MethodDefinition":
	...
	***REMOVED***,
	 ...
	 * @returns {number***REMOVED*** precedence level
	 * @private
	 */
	getPrecedence(node) {
		switch (node.type) {
	...
	***REMOVED***,
	 ...
	 * - `class A { foo = () => {***REMOVED***; ***REMOVED***`  .......... `method 'foo'`
	 * - `class A { foo = function() {***REMOVED***; ***REMOVED***`  ..... `method 'foo'`
	 * - `class A { foo = function bar() {***REMOVED***; ***REMOVED***`  . `method 'foo'`
	 * - `class A { static foo = () => {***REMOVED***; ***REMOVED***`  ... `static method 'foo'`
	 * - `class A { '#foo' = () => {***REMOVED***; ***REMOVED***`  ....... `method '#foo'`
	 * - `class A { #foo = () => {***REMOVED***; ***REMOVED***`  ......... `private method #foo`
	 * - `class A { static #foo = () => {***REMOVED***; ***REMOVED***`  .. `static private method #foo`
	 * - `class A { '#foo'() {***REMOVED*** ***REMOVED***`  .............. `method '#foo'`
	 * - `class A { #foo() {***REMOVED*** ***REMOVED***`  ................ `private method #foo`
	 * - `class A { static #foo() {***REMOVED*** ***REMOVED***`  ......... `static private method #foo`
	 * @param {ASTNode***REMOVED*** node The function node to get.
		...
		***REMOVED***
		...
		if (parent.type === "Property" || parent.type === "MethodDefinition") {
			...
			***REMOVED*** else {
				tokens.push("method");
			***REMOVED***
		***REMOVED*** else if (parent.type === "PropertyDefinition") {
			tokens.push("method");
		***REMOVED*** else {
	...
	***REMOVED***,
	 ...
	 * - `class A { foo = function() {***REMOVED*** ***REMOVED***`
	 *              ^^^^^^^^^^^^^^
	 * - `class A { static foo = function() {***REMOVED*** ***REMOVED***`
	 *              ^^^^^^^^^^^^^^^^^^^^^
	 * - `class A { foo = (a, b) => {***REMOVED*** ***REMOVED***`
	 *              ^^^^^^
	 * @param {ASTNode***REMOVED*** node The function node to get.
	 * @param {SourceCode***REMOVED*** sourceCode The source code object to get tokens.
	...
	***REMOVED***,
	 ...
	 * @returns {boolean***REMOVED*** True if the node is a template literal without expressions.
	 */
	...
	***REMOVED***,
	 ...
	 *     else
	 *         bar();
	 * @param {ASTNode***REMOVED*** node `BlockStatement` body with exactly one statement directly inside. The statement can have its own nested statements.
	 * @param {SourceCode***REMOVED*** sourceCode The source code
	 * @returns {boolean***REMOVED*** `true` if the braces are necessary - removing them (replacing the given `BlockStatement` body with its single statement content)
	 * would change the semantics of the code or produce a syntax error.
	 */
	areBracesNecessary(node, sourceCode) {
		/**
		 * Determines if the given node is a lexical declaration (let, const, function, or class)
		 * @param {ASTNode***REMOVED*** nodeToCheck The node to check
		 * @returns {boolean***REMOVED*** True if the node is a lexical declaration
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @param {Token***REMOVED*** token The token to check.
		 * @returns {boolean***REMOVED*** `true` if the token is an `else` token.
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** nodeToCheck The node to check.
		 * @returns {boolean***REMOVED*** `true` if the node is followed by an `else` keyword token.
		 */
		...
		***REMOVED***
		 ...
		 *        else
		 *            bar();
		 * @param {ASTNode***REMOVED*** nodeToCheck Node representing the code to check.
		 * @returns {boolean***REMOVED*** `true` if an `if` statement within the code would become associated with an `else` appended to that code.
		 */
