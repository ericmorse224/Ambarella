...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function logMissing(missingDeps) {***REMOVED***

// eslint-disable-next-line @typescript-eslint/no-unused-vars
function laterLogMissing(missingDeps) {***REMOVED***
    ...
    ***REMOVED***,
    assertDependency(name, version = "*") {
      ...
      ***REMOVED***
      ...
      const found = missingDependencies.all ? false : mapGetOr(depsCache, `${name***REMOVED*** :: ${dirname***REMOVED***`, () => has());
      if (!found) {
