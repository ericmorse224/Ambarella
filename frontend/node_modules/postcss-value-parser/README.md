  ...
  nodes: [
    {
      ...
      after: '',
      nodes: [
        { type: 'word', value: '233' ***REMOVED***,
        { type: 'div', value: ',', before: '', after: ' ' ***REMOVED***,
        { type: 'word', value: '45' ***REMOVED***,
        { type: 'div', value: ',', before: '', after: ' ' ***REMOVED***,
        { type: 'word', value: '66' ***REMOVED***,
        { type: 'div', value: ',', before: ' ', after: '' ***REMOVED***,
        { type: 'word', value: '.5' ***REMOVED***
      ]
    ***REMOVED***
  ]
***REMOVED***
...
[
  {
    ...
    nodes: [
      { type: 'word', value: 'min-width' ***REMOVED***,
      { type: 'div', value: ':', before: '', after: ' ' ***REMOVED***,
      { type: 'word', value: '700px' ***REMOVED***
    ]
  ***REMOVED***
]
```
...
{ type: 'function', sourceIndex: 0, value: 'url', before: ' ', after: ' ', nodes: [
    { type: 'word', sourceIndex: 5, value: '/gfx/img/bg.jpg' ***REMOVED***
] ***REMOVED***
```
