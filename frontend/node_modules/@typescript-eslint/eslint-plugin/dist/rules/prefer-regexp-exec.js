...
***REMOVED***)(ArgumentType || (ArgumentType = {***REMOVED***));
                    ...
                    ***REMOVED***
                    return context.report({
                        ...
                        fix: (0, util_1.getWrappingFixer)({
                            ...
                            wrap: objectCode => `${regExp.toString()***REMOVED***.exec(${objectCode***REMOVED***)`,
                        ***REMOVED***),
                    ***REMOVED***);
                ***REMOVED***
                    ...
                    case ArgumentType.RegExp:
                        return context.report({
                            ...
                            fix: (0, util_1.getWrappingFixer)({
                                ...
                                wrap: (objectCode, argumentCode) => `${argumentCode***REMOVED***.exec(${objectCode***REMOVED***)`,
                            ***REMOVED***),
                        ***REMOVED***);
                    case ArgumentType.String:
                        return context.report({
                            ...
                            fix: (0, util_1.getWrappingFixer)({
                                ...
                                node: callNode,
                                innerNode: [objectNode, argumentNode],
                                wrap: (objectCode, argumentCode) => `RegExp(${argumentCode***REMOVED***).exec(${objectCode***REMOVED***)`,
                            ***REMOVED***),
                        ***REMOVED***);
                ***REMOVED***
            ***REMOVED***,
