...
test('symlink', function (t) {
    ...
    resolve('foo', { basedir: symlinkDir, preserveSymlinks: false ***REMOVED***, function (err, res, pkg) {
        t.error(err);
...
test('sync symlink when preserveSymlinks = true', function (t) {
    ...
    resolve('foo', { basedir: symlinkDir ***REMOVED***, function (err, res, pkg) {
...
test('sync symlink', function (t) {
    ...
    t.doesNotThrow(function () {
        t.equal(
            resolve.sync('foo', { basedir: symlinkDir, preserveSymlinks: false ***REMOVED***),
...
test('sync symlink when preserveSymlinks = true', function (t) {
    t.throws(function () {
        resolve.sync('foo', { basedir: symlinkDir ***REMOVED***);
...
test('sync symlink from node_modules to other dir when preserveSymlinks = false', function (t) {
    ...
    var fn = resolve.sync('package', { basedir: basedir, preserveSymlinks: false ***REMOVED***);
...
test('async symlink from node_modules to other dir when preserveSymlinks = false', function (t) {
    t.plan(2);
    var basedir = path.join(__dirname, 'resolver', 'symlinked', '_');
    resolve('package', { basedir: basedir, preserveSymlinks: false ***REMOVED***, function (err, result) {
