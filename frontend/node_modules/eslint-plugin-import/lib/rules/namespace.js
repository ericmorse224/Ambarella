...
function processBodyStatement(context, namespaces, declaration) {
  if (declaration.type !== 'ImportDeclaration') {return;***REMOVED***

  if (declaration.specifiers.length === 0) {return;***REMOVED***

  var imports = _builder2['default'].get(declaration.source.value, context);
  if (imports == null) {return null;***REMOVED***
  ...
  declaration.specifiers.forEach(function (specifier) {
    switch (specifier.type) {
      ...
      case 'ImportSpecifier':{
          ...
          if (!meta || !meta.namespace) {break;***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('namespace') ***REMOVED***,
  ...
  create: function () {function namespaceRule(context) {
      ...
      context.options[0] || {***REMOVED***,_ref$allowComputed = _ref.allowComputed,allowComputed = _ref$allowComputed === undefined ? false : _ref$allowComputed;
      ...
      ***REMOVED***
      ...
      return {
        ...
        Program: function () {function Program(_ref2) {var body = _ref2.body;
            body.forEach(function (x) {processBodyStatement(context, namespaces, x);***REMOVED***);
          ***REMOVED***return Program;***REMOVED***(),
        ...
        ExportNamespaceSpecifier: function () {function ExportNamespaceSpecifier(namespace) {
            ...
            ***REMOVED***
          ***REMOVED***return ExportNamespaceSpecifier;***REMOVED***(),

        // todo: check for possible redefinition

        MemberExpression: function () {function MemberExpression(dereference) {
            if (dereference.object.type !== 'Identifier') {return;***REMOVED***
            if (!namespaces.has(dereference.object.name)) {return;***REMOVED***
            if ((0, _declaredScope2['default'])(context, dereference.object.name, dereference) !== 'module') {return;***REMOVED***
            ...
            ***REMOVED***
            ...
            while (namespace instanceof _exportMap2['default'] && dereference.type === 'MemberExpression') {
              ...
              ***REMOVED***
              ...
              if (exported == null) {return;***REMOVED***
            ...
            ***REMOVED***
          ***REMOVED***return MemberExpression;***REMOVED***(),

        VariableDeclarator: function () {function VariableDeclarator(_ref3) {var id = _ref3.id,init = _ref3.init;
            if (init == null) {return;***REMOVED***
            if (init.type !== 'Identifier') {return;***REMOVED***
            if (!namespaces.has(init.name)) {return;***REMOVED***

            // check for redefinition in intermediate scopes
            if ((0, _declaredScope2['default'])(context, init.name, init) !== 'module') {return;***REMOVED***

            // DFS traverse child namespaces
            function testKey(pattern, namespace) {var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [init.name];
              if (!(namespace instanceof _exportMap2['default'])) {return;***REMOVED***

              if (pattern.type !== 'ObjectPattern') {return;***REMOVED***var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
                ...
                for (var _iterator = pattern.properties[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var property = _step.value;
                  ...
                  ***REMOVED***
                  ...
                  if (property.key.type !== 'Identifier') {
                    context.report({
                      node: property,
                      message: 'Only destructure top-level names.' ***REMOVED***);
                  ...
                  ***REMOVED***
                  ...
                  if (!namespace.has(property.key.name)) {
                    context.report({
                      node: property,
                      message: makeMessage(property.key, path) ***REMOVED***);
          ...
          ***REMOVED***return VariableDeclarator;***REMOVED***(),

        JSXMemberExpression: function () {function JSXMemberExpression(_ref4) {var object = _ref4.object,property = _ref4.property;
            if (!namespaces.has(object.name)) {return;***REMOVED***
            var namespace = namespaces.get(object.name);
            if (!namespace.has(property.name)) {
              context.report({
                node: property,
                message: makeMessage(property, [object.name]) ***REMOVED***);

            ***REMOVED***
          ***REMOVED***return JSXMemberExpression;***REMOVED***() ***REMOVED***;

    ***REMOVED***return namespaceRule;***REMOVED***() ***REMOVED***;
