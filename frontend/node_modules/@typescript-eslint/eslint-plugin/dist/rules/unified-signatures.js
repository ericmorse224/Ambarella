...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        type: 'suggestion',
        messages: {
            omittingRestParameter: '{{failureStringStart***REMOVED******REMOVED*** with a rest parameter.',
            omittingSingleParameter: '{{failureStringStart***REMOVED******REMOVED*** with an optional parameter.',
            singleParameterDifference: '{{failureStringStart***REMOVED******REMOVED*** taking `{{type1***REMOVED******REMOVED*** | {{type2***REMOVED******REMOVED***`.',
        ***REMOVED***,
        schema: [
            {
    ...
    ***REMOVED***,
    ...
    create(context, [{ ignoreDifferentlyNamedParameters ***REMOVED***]) {
        ...
        function failureStringStart(otherLine) {
            ...
            const overloads = otherLine === undefined
                ? 'These overloads'
                : `This overload and the one on line ${otherLine***REMOVED***`;
            return `${overloads***REMOVED*** can be combined into one signature`;
        ***REMOVED***
        function addFailures(failures) {
            for (const failure of failures) {
                const { unify, only2 ***REMOVED*** = failure;
                switch (unify.kind) {
                    case 'single-parameter-difference': {
                        const { p0, p1 ***REMOVED*** = unify;
                    ...
                    ***REMOVED***
                    case 'extra-parameter': {
                        const { extraParameter, otherSignature ***REMOVED*** = unify;
        ...
        function checkOverloads(signatures, typeParameters) {
            ...
            for (const overloads of signatures) {
                forEachPair(overloads, (a, b) => {
                    ...
                    if (unify !== undefined) {
                        result.push({ unify, only2: overloads.length === 2 ***REMOVED***);
                    ***REMOVED***
                ***REMOVED***);
            ***REMOVED***
            return result;
        ...
        function signaturesDifferBySingleParameter(types1, types2) {
            ...
            ***REMOVED***
            ...
            return parametersHaveEqualSigils(a, b) &&
                ...
                ? { kind: 'single-parameter-difference', p0: a, p1: b ***REMOVED***
                : undefined;
        ***REMOVED***
        /**
