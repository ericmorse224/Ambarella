...
function parseOptions(options) {
    ...
    ***REMOVED***
    ...
    return { functions, classes, variables, allowNamedExports ***REMOVED***;
***REMOVED***
 ...
 * @param {ASTNode***REMOVED*** node `ClassBody` node to check static initializers.
 * @param {number***REMOVED*** location A location to check.
 * @returns {boolean***REMOVED*** `true` if the location is inside of a class static initializer.
 */
 ...
 * Static initializers are static blocks and initializers of static fields.
 * @param {eslint-scope.Scope***REMOVED*** scope A scope to check.
 * @returns {boolean***REMOVED*** `true` if the scope is a class static initializer scope.
 */
 ...
 * @returns {boolean***REMOVED*** `true` if the reference is from a separate execution context.
 */
 ...
 *     var C = class { [C]; ***REMOVED***;
 *     var C = class { static foo = C; ***REMOVED***;
 *     var C = class { static { foo = C; ***REMOVED*** ***REMOVED***;
 *     class C extends C {***REMOVED***
 *     class C extends (class { static foo = C; ***REMOVED***) {***REMOVED***
 *     class C { [C]; ***REMOVED***
 * @param {Reference***REMOVED*** reference A reference to check.
 * @returns {boolean***REMOVED*** `true` if the reference is evaluated during the initialization.
 */
    ...
    ***REMOVED***
    ...
    if (definition.type === "ClassName") {
        ...
        return (
             ...
             * For example, `class C { static foo = C; static { bar = C; ***REMOVED*** ***REMOVED***` is valid.
             */
...
module.exports = {
                    ...
                    ***REMOVED***,
                    {
                        ...
                        properties: {
                            ...
                            allowNamedExports: { type: "boolean" ***REMOVED***
                        ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * - allowed by options.
         * @param {eslint-scope.Reference***REMOVED*** reference The reference
         * @returns {boolean***REMOVED*** `true` if the reference should be checked
         */
        function shouldCheck(reference) {
            ...
            ***REMOVED***
            ...
            const { identifier ***REMOVED*** = reference;
        ...
        ***REMOVED***
         ...
         * @param {eslint-scope.Scope***REMOVED*** scope The scope object.
