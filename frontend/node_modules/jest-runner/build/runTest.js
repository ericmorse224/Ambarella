  ...
  testConsole._log = function fakeConsolePush(_type, message) {
    const error = new (_jestUtil().ErrorWithStack)(
      `${_chalk().default.red(
        ...
        )***REMOVED*** Did you forget to wait for something async in your test?`
      )***REMOVED***\nAttempted to log "${message***REMOVED***".`,
      fakeConsolePush
    );
    ...
    process.exitCode = 1;
  ***REMOVED***;
***REMOVED*** // Keeping the core of "runTest" as a separate function (as "runTestInternal")
...
async function runTestInternal(
  ...
  ***REMOVED*** else if (globalConfig.verbose) {
  ...
  ***REMOVED***);
  ...
  if (typeof environment.getVmContext !== 'function') {
    console.error(
      `Test environment found at "${testEnvironment***REMOVED***" does not export a "getVmContext" method, which is mandatory from Jest 27. This method is a replacement for "runScript".`
    );
    process.exit(1);
  ***REMOVED***
  ...
  ***REMOVED***; // For tests
  ...
  if (
    ...
    environment.global.process.exit = function exit(...args) {
      const error = new (_jestUtil().ErrorWithStack)(
        `process.exit called with "${args.join(', ')***REMOVED***"`,
        exit
      );
      const formattedError = (0, _jestMessageUtil().formatExecError)(
        error,
    ...
    ***REMOVED***;
  ***REMOVED*** // if we don't have `getVmContext` on the env skip coverage
  ...
  try {
    ...
    ***REMOVED*** // Delay the resolution to allow log messages to be output.
...
async function runTest(
  ...
  const {leakDetector, result***REMOVED*** = await runTestInternal(
    path,
    globalConfig,
    config,
    resolver,
