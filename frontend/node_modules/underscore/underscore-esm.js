...
function emulatedSet(keys) {
  ...
  return {
    contains: function(key) { return hash[key]; ***REMOVED***,
    push: function(key) {
      hash[key] = true;
...
function baseCreate(prototype) {
  if (!isObject(prototype)) return {***REMOVED***;
...
function clone(obj) {
  ...
  return isArray(obj) ? obj.slice() : extend({***REMOVED***, obj);
***REMOVED***
  ...
  for (var i = 0, length = getLength(array); i < length; i++) {
    ...
    ***REMOVED*** else if (iteratee) {
      if (!contains(seen, computed)) {
        ...
        result.push(value);
      ***REMOVED***
    ***REMOVED*** else if (!contains(result, value)) {
      result.push(value);
    ***REMOVED***
  ***REMOVED***
  return result;
