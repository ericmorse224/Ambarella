 ...
 *
 * @example
 * const root  = postcss.parse(css, { from: file ***REMOVED***)
 * const input = root.source.input
 */

var Input = /*#__PURE__*/function () {
  /**
   * @param {string***REMOVED*** css    Input CSS source.
   * @param {object***REMOVED*** [opts] {@link Processor#process***REMOVED*** options.
   */
  function Input(css, opts) {
    ...
    ***REMOVED***
     ...
     *
     * @example
     * const input = postcss.parse('a{***REMOVED***', { from: file ***REMOVED***).input
     * input.css //=> "a{***REMOVED***"
     */
    ...
    ***REMOVED***
    ...
    if (opts.from) {
      if (/^\w+:\/\//.test(opts.from) || _path.default.isAbsolute(opts.from)) {
         ...
         *
         * @example
         * const root = postcss.parse(css, { from: 'a.css' ***REMOVED***)
  ...
  ***REMOVED***
   ...
   *
   * @param {number***REMOVED*** line   Line in input CSS.
   * @param {number***REMOVED*** column Column in input CSS.
   *
   * @return {filePosition***REMOVED*** Position in input source.
   *
   * @example
   * root.source.input.origin(1, 1) //=> { file: 'a.css', line: 3, column: 1 ***REMOVED***
   */
  ;
  ...
  ***REMOVED***
  /**
   * The CSS source identifier. Contains {@link Input#file***REMOVED*** if the user
   * set the `from` option, or {@link Input#id***REMOVED*** if they did not.
   *
   * @type {string***REMOVED***
   *
   * @example
...
var _default = Input;
/**
 * @typedef  {object***REMOVED*** filePosition
 * @property {string***REMOVED*** file   Path to file.
