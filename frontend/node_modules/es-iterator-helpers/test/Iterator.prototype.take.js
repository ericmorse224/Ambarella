...
module.exports = {
	tests: function (take, name, t) {
		t['throws'](
			function () { return new take(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			t['throws'](
				function () { iterate(take(nonIterator, 1)); ***REMOVED***,
				TypeError,
			...
			if (nonIterator != null && typeof nonIterator !== 'string') {
				...
				t['throws'](
					function () { iterate(take(badNext, 1)); ***REMOVED***,
					TypeError,
		...
		***REMOVED***);
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			...
			st['throws'](
				function () { take(iterator(), -3); ***REMOVED***,
				RangeError,
				'-3 is not >= 0'
			);

			st['throws'](
				function () { return new take(iterator()); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);
			st['throws'](
				function () { return new take(iterator(), 0); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);
