    ...
    constructor(source, uFlag, index, message) {
        if (source) {
            if (!source.startsWith("/")) {
                source = `/${source***REMOVED***/${uFlag ? "u" : ""***REMOVED***`;
            ***REMOVED***
            source = `: ${source***REMOVED***`;
        ***REMOVED***
        super(`Invalid regular expression${source***REMOVED***: ${message***REMOVED***`);
        this.index = index;
    ***REMOVED***
***REMOVED***
...
class RegExpValidator {
    ...
    validateFlags(source, start = 0, end = source.length) {
        ...
        for (let i = start; i < end; ++i) {
            ...
            ***REMOVED***
                ...
                this.raise(`Invalid flag '${source[i]***REMOVED***'`);
            ***REMOVED***
        ***REMOVED***
    ...
    ***REMOVED***
    consumeDisjunction() {
        ...
        ***REMOVED*** while (this.eat(VerticalLine));
    ...
    eatDecimalEscape() {
        ...
        if (cp >= DigitOne && cp <= DigitNine) {
            do {
                ...
                this.advance();
            ***REMOVED*** while ((cp = this.currentCodePoint) >= DigitZero &&
                cp <= DigitNine);
            return true;
        ***REMOVED***
        return false;
...
const DummyPattern = {***REMOVED***;
const DummyFlags = {***REMOVED***;
const DummyCapturingGroup = {***REMOVED***;
...
export { ast as AST, RegExpParser, RegExpValidator, parseRegExpLiteral, validateRegExpLiteral, visitRegExpAST ***REMOVED***;
