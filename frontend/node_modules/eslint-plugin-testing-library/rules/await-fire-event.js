...
exports.default = (0, create_testing_library_rule_1.createTestingLibraryRule)({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            awaitFireEvent: 'Promise returned from `fireEvent.{{ name ***REMOVED******REMOVED***` must be handled',
            fireEventWrapper: 'Promise returned from `{{ name ***REMOVED******REMOVED***` wrapper over fire event method must be handled',
        ***REMOVED***,
        schema: [],
    ***REMOVED***,
    defaultOptions: [],
