 ...
 * @param {string***REMOVED*** totalErrors Total errors
 * @param {string***REMOVED*** totalWarnings Total warnings
 * @returns {number***REMOVED*** The color code (0 = green, 1 = yellow, 2 = red)
 */
 ...
 * @param {number***REMOVED*** parentIndex Index of the parent HTML row.
	...
	return results
		.map(
			(result, index) =>
				...
				***REMOVED***) + renderMessages(result.messages, index, rulesMeta),
		)
		.join("\n");
***REMOVED***
