	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			limited:
				"Unexpected console statement. Only these console methods are allowed: {{ allowed ***REMOVED******REMOVED***.",
			removeConsole: "Remove the console.{{ propertyName ***REMOVED******REMOVED***().",
			removeMethodCall: "Remove the console method call.",
		***REMOVED***,
	***REMOVED***,

	create(context) {
		const [{ allow: allowed = [] ***REMOVED***] = context.options;
		const sourceCode = context.sourceCode;

		/**
		 * Checks whether the given reference is 'console' or not.
		 * @param {eslint-scope.Reference***REMOVED*** reference The reference to check.
		 * @returns {boolean***REMOVED*** `true` if the reference is 'console'.
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node The MemberExpression node to check.
		 * @returns {boolean***REMOVED*** `true` if the property name of the node is allowed.
		 */
		...
		***REMOVED***
		 ...
		 * @param {eslint-scope.Reference***REMOVED*** reference The reference to check.
		 * @returns {boolean***REMOVED*** `true` if the reference is a member access which
		...
		***REMOVED***
		 ...
		 * foo().
		 * @param {ASTNode***REMOVED*** node The ExpressionStatement node to check.
		 * @returns {boolean***REMOVED*** `true` if ASI will break after removing the ExpressionStatement
		 *      node.
		 */
		...
		***REMOVED***
		 ...
		 *     syntax error.
		 *     if (a) { console.log(b) ***REMOVED***, removing console.log() here is acceptable.
		 *
		 ...
		 * @param {ASTNode***REMOVED*** node The MemberExpression node to check.
		 * @returns {boolean***REMOVED*** `true` if a suggestion can be provided for a node.
		 */
		...
		***REMOVED***
		 ...
		 * @param {eslint-scope.Reference***REMOVED*** reference The reference to report.
		...
		function report(reference) {
			...
			if (canProvideSuggestions(node)) {
				...
				***REMOVED*** else {
					...
					suggestion.data = { propertyName: node.property.name ***REMOVED***;
				***REMOVED***
			...
			***REMOVED***
			context.report({
				...
				data: { allowed: allowed.join(", ") ***REMOVED***,
				suggest,
			***REMOVED***);
		***REMOVED***
