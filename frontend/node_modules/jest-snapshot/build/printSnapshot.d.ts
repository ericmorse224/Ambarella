...
import type { MatchSnapshotConfig ***REMOVED*** from './types';
...
export declare const matcherHintFromConfig: ({ context: { isNot, promise ***REMOVED***, hint, inlineSnapshot, matcherName, properties, ***REMOVED***: MatchSnapshotConfig, isUpdatable: boolean) => string;
