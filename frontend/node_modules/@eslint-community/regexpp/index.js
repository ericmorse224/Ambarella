...
function newRegExpSyntaxError(srcCtx, flags, index, message) {
    ...
    if (srcCtx.kind === "literal") {
        ...
        if (literal) {
            source = `: ${literal***REMOVED***`;
        ***REMOVED***
    ***REMOVED***
    else if (srcCtx.kind === "pattern") {
        const pattern = srcCtx.source.slice(srcCtx.start, srcCtx.end);
        const flagsText = `${flags.unicode ? "u" : ""***REMOVED***${flags.unicodeSets ? "v" : ""***REMOVED***`;
        source = `: /${pattern***REMOVED***/${flagsText***REMOVED***`;
    ***REMOVED***
    return new RegExpSyntaxError(`Invalid regular expression${source***REMOVED***: ${message***REMOVED***`, index);
***REMOVED***
...
class RegExpValidator {
    constructor(options) {
        ...
        ***REMOVED***;
        ...
        this._srcCtx = null;
        this._options = options !== null && options !== void 0 ? options : {***REMOVED***;
    ...
    ***REMOVED***
    validateLiteral(source, start = 0, end = source.length) {
        this._srcCtx = { source, start, end, kind: "literal" ***REMOVED***;
        ...
        ***REMOVED***
            ...
            this.raise(`Unexpected character '${c***REMOVED***'`);
        ***REMOVED***
        this.onLiteralLeave(start, end);
    ***REMOVED***
    validateFlags(source, start = 0, end = source.length) {
        this._srcCtx = { source, start, end, kind: "flags" ***REMOVED***;
        this.validateFlagsInternal(source, start, end);
    ***REMOVED***
    validatePattern(source, start = 0, end = source.length, uFlagOrFlags = undefined) {
        this._srcCtx = { source, start, end, kind: "pattern" ***REMOVED***;
    ...
    ***REMOVED***
    _parseFlagsOptionToMode(uFlagOrFlags, sourceEnd) {
        ...
        ***REMOVED***
        ...
        return { unicodeMode, nFlag, unicodeSetsMode ***REMOVED***;
    ***REMOVED***
    get strict() {
    ...
    ***REMOVED***
    raise(message, context) {
        ...
        ***REMOVED***, (_c = context === null || context === void 0 ? void 0 : context.index) !== null && _c !== void 0 ? _c : this.index, message);
    ***REMOVED***
    eatRegExpBody() {
        ...
        for (;;) {
            ...
            if (cp === -1 || isLineTerminator(cp)) {
                ...
                this.raise(`Unterminated ${kind***REMOVED***`);
            ***REMOVED***
            if (escaped) {
                escaped = false;
            ***REMOVED***
    ...
    ***REMOVED***
    consumeDisjunction() {
        ...
        ***REMOVED*** while (this.eat(VERTICAL_LINE));
    ...
    ***REMOVED***
    consumeQuantifier(noConsume = false) {
        ...
        ***REMOVED***
            ...
            ({ min, max ***REMOVED*** = this._lastRange);
        ***REMOVED***
        else {
            return false;
        ***REMOVED***
            ...
            if (this.eatDecimalDigits()) {
                ...
                ***REMOVED***
                if (this.eat(RIGHT_CURLY_BRACKET)) {
                    if (!noError && max < min) {
                        this.raise("numbers out of order in {***REMOVED*** quantifier");
                    ***REMOVED***
                    this._lastRange = { min, max ***REMOVED***;
                    return true;
                ***REMOVED***
            ***REMOVED***
            ...
            ***REMOVED***
            ...
            for (const [flagName] of Object.entries(modifiers).filter(([, enable]) => enable)) {
                if (addModifiers[flagName]) {
                    this.raise(`Duplicated flag '${String.fromCodePoint(FLAG_PROP_TO_CODEPOINT[flagName])***REMOVED***'`);
                ***REMOVED***
            ***REMOVED***
        ...
        if (this._unicodeMode &&
            ...
            if (this.eat(LEFT_CURLY_BRACKET) &&
                ...
                ***REMOVED***
                ...
                return { mayContainStrings: result.strings ***REMOVED***;
            ***REMOVED***
            this.raise("Invalid property name");
        ***REMOVED***
        return null;
    ...
    consumeClassSetExpression() {
        ...
        if (this.consumeClassSetCharacter()) {
            if (this.consumeClassSetRangeFromOperator(start)) {
                this.consumeClassUnionRight({***REMOVED***);
                return {***REMOVED***;
            ***REMOVED***
            ...
            while (this.currentCodePoint !== AMPERSAND &&
                ...
                ***REMOVED***
                if (this.eat2(AMPERSAND, AMPERSAND)) {
                    continue;
                ***REMOVED***
                return { mayContainStrings ***REMOVED***;
            ***REMOVED***
            this.raise("Invalid character in character class");
        ***REMOVED***
        if (this.eat2(HYPHEN_MINUS, HYPHEN_MINUS)) {
            ...
            ***REMOVED***
            this.raise("Invalid character in character class");
        ***REMOVED***
        return this.consumeClassUnionRight({ mayContainStrings ***REMOVED***);
    ***REMOVED***
    ...
    ***REMOVED***
    consumeClassString(i) {
        ...
        ***REMOVED***
        ...
        return { mayContainStrings: count !== 1 ***REMOVED***;
    ***REMOVED***
    ...
    eatDecimalEscape() {
        ...
        if (cp >= DIGIT_ONE && cp <= DIGIT_NINE) {
            do {
                ...
                this.advance();
            ***REMOVED*** while ((cp = this.currentCodePoint) >= DIGIT_ZERO &&
                cp <= DIGIT_NINE);
            return true;
        ***REMOVED***
        return false;
    ...
    ***REMOVED***
    parseModifiers(start, end) {
        const { ignoreCase, multiline, dotAll ***REMOVED*** = this.parseFlags(this._reader.source, start, end);
        return { ignoreCase, multiline, dotAll ***REMOVED***;
    ***REMOVED***
        ...
        ***REMOVED***
        for (let i = start; i < end; ++i) {
            ...
            if (validFlags.has(flag)) {
                ...
                if (flags[prop]) {
                    this.raise(`Duplicated flag '${source[i]***REMOVED***'`, {
                        index: start,
                    ***REMOVED***);
                ***REMOVED***
                flags[prop] = true;
            ***REMOVED***
                ...
                this.raise(`Invalid flag '${source[i]***REMOVED***'`, { index: start ***REMOVED***);
            ***REMOVED***
        ***REMOVED***
        return flags;
    ***REMOVED***
...
const DUMMY_PATTERN = {***REMOVED***;
const DUMMY_FLAGS = {***REMOVED***;
const DUMMY_CAPTURING_GROUP = {***REMOVED***;
...
class RegExpParserState {
    ...
    ***REMOVED***
    get flags() {
        ...
        ***REMOVED***
        return this._flags;
    ***REMOVED***
    onRegExpFlags(start, end, { global, ignoreCase, multiline, unicode, sticky, dotAll, hasIndices, unicodeSets, ***REMOVED***) {
        this._flags = {
            type: "Flags",
            parent: null,
            start,
    ...
    ***REMOVED***
    onModifiersLeave(start, end) {
        ...
        ***REMOVED***
        ...
        this._node = node.parent;
    ***REMOVED***
    onAddModifiers(start, end, { ignoreCase, multiline, dotAll, ***REMOVED***) {
        const parent = this._node;
        ...
        ***REMOVED***;
    ***REMOVED***
    onRemoveModifiers(start, end, { ignoreCase, multiline, dotAll, ***REMOVED***) {
        const parent = this._node;
        if (parent.type !== "Modifiers") {
            throw new Error("UnknownError");
        ***REMOVED***
        ...
        ***REMOVED***;
        if (strings) {
            if ((parent.type === "CharacterClass" && !parent.unicodeSets) ||
                ...
                throw new Error("UnknownError");
            ***REMOVED***
            parent.elements.push(Object.assign(Object.assign({***REMOVED***, base), { parent, strings, value, negate ***REMOVED***));
        ***REMOVED***
        else {
            parent.elements.push(Object.assign(Object.assign({***REMOVED***, base), { parent, strings, value, negate ***REMOVED***));
        ***REMOVED***
    ...
    ***REMOVED***
    onCharacterClassEnter(start, negate, unicodeSets) {
        ...
        ***REMOVED***;
        if (parent.type === "Alternative") {
            const node = Object.assign(Object.assign({***REMOVED***, base), { parent ***REMOVED***);
            this._node = node;
            parent.elements.push(node);
        ***REMOVED***
            ...
            parent.unicodeSets &&
            unicodeSets) {
            const node = Object.assign(Object.assign({***REMOVED***, base), { parent,
                unicodeSets ***REMOVED***);
            this._node = node;
            parent.elements.push(node);
        ***REMOVED***
    ...
    visit(node) {
        switch (node.type) {
            ...
            case "StringAlternative":
                ...
                break;
            default:
                throw new Error(`Unknown type: ${node.type***REMOVED***`);
        ***REMOVED***
    ***REMOVED***
