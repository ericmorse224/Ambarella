...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'HTMLHRElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(HTMLHRElement.prototype, {
    ...
    color: { enumerable: true ***REMOVED***,
    noShade: { enumerable: true ***REMOVED***,
    size: { enumerable: true ***REMOVED***,
    width: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "HTMLHRElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
