 ...
 * @returns {boolean***REMOVED*** `true` if the node is function body.
 */
    ...
    ***REMOVED***,
    ...
    create(context) {
        ...
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** precedingToken first token before the block.
         * @param {ASTNode|Token***REMOVED*** node `BlockStatement` node or `{` token of a `SwitchStatement` node.
         * @returns {boolean***REMOVED*** `true` if requiring or disallowing spaces before the given block could produce conflicts with other rules.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode|Token***REMOVED*** node The AST node of a BlockStatement.
        ...
        function checkPrecedingSpace(node) {
            ...
            if (precedingToken && !isConflicted(precedingToken, node) && astUtils.isTokenOnSameLine(precedingToken, node)) {
                ...
                ***REMOVED*** else if (node.type === "ClassBody") {
                ...
                ***REMOVED***
                ...
                if (requireSpace && !hasSpace) {
                    context.report({
                        ...
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED*** else if (requireNoSpace && hasSpace) {
                    context.report({
                        node,
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The node of a SwitchStatement.
         * @returns {void***REMOVED*** undefined.
         */
