  ...
  rules: [
    {
      ...
      use: {
        ...
        options: {
          presets: [
            ['@babel/preset-env', { targets: "defaults" ***REMOVED***]
          ]
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
...
* `cacheDirectory`: Default `false`. When set, the given directory will be used to cache the results of the loader. Future webpack builds will attempt to read from the cache to avoid needing to run the potentially expensive Babel recompilation process on each run. If the value is set to `true` in options (`{cacheDirectory: true***REMOVED***`), the loader will use the default cache directory in `node_modules/.cache/babel-loader` or fallback to the default OS temporary file directory if no `node_modules` folder could be found in any root directory.
...
```javascript
{
    ...
    ***REMOVED***,
    use: {
      ...
      options: {
        presets: [
          ['@babel/preset-env', { targets: "ie 11" ***REMOVED***]
        ]
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
...
module.exports = require("babel-loader").custom(babel => {
  ...
  ***REMOVED***
  ...
  return {
    ...
    customOptions({ opt1, opt2, ...loader ***REMOVED***) {
      return {
        // Pull out any custom options that the loader might have.
        custom: { opt1, opt2 ***REMOVED***,
...
### `customOptions(options: Object): { custom: Object, loader: Object ***REMOVED***`
