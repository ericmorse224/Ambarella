...
const minify = (input, sourceMap, minimizerOptions, extractsComments) => {
  ...
  const { map, code ***REMOVED*** = require("uglify-module") // Or require('./path/to/uglify-module')
    .minify(input, {
      /* Your options for minification */
    ***REMOVED***);

  return { map, code, warnings: [], errors: [], extractedComments: [] ***REMOVED***;
***REMOVED***;
      ...
      new TerserPlugin({
        extractComments: {
          ...
          filename: (fileData) => {
            ...
            return `${fileData.filename***REMOVED***.LICENSE.txt${fileData.query***REMOVED***`;
          ***REMOVED***,
          banner: (licenseFile) => {
            return `License information can be found in ${licenseFile***REMOVED***`;
          ***REMOVED***,
        ***REMOVED***,
      ***REMOVED***),
    ],
...
Default: `/*! For license information please see ${commentsFile***REMOVED*** */`
    ...
    minimizer: [
      new TerserPlugin({
        extractComments: {
          ...
          ***REMOVED***,
          banner: (commentsFile) => {
            return `My custom banner about license information ${commentsFile***REMOVED***`;
          ***REMOVED***,
        ***REMOVED***,
      ***REMOVED***),
    ],
...
```ts
import type { JsMinifyOptions as SwcOptions ***REMOVED*** from "@swc/core";
import type { MinifyOptions as UglifyJSOptions ***REMOVED*** from "uglify-js";
import type { TransformOptions as EsbuildOptions ***REMOVED*** from "esbuild";
import type { MinifyOptions as TerserOptions ***REMOVED*** from "terser";
