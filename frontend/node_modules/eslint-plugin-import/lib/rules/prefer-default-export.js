...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('prefer-default-export') ***REMOVED***,
    ...
    schema: [{
      ...
      properties: {
        target: {
          type: 'string',
          'enum': ['single', 'any'],
          'default': 'single' ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      var _ref = context.options[0] || {***REMOVED***,_ref$target = _ref.target,target = _ref$target === undefined ? 'single' : _ref$target;
      function captureDeclaration(identifierOrPattern) {
        if (identifierOrPattern && identifierOrPattern.type === 'ObjectPattern') {
          ...
          ***REMOVED***);
        ***REMOVED*** else if (identifierOrPattern && identifierOrPattern.type === 'ArrayPattern') {
      ...
      ***REMOVED***
      ...
      return {
        ExportDefaultSpecifier: function () {function ExportDefaultSpecifier() {
          ...
          ***REMOVED***return ExportDefaultSpecifier;***REMOVED***(),
        ...
        ExportNamedDeclaration: function () {function ExportNamedDeclaration(node) {
            ...
            if (!node.declaration) {return;***REMOVED***var
            ...
            ***REMOVED***
            ...
            if (node.declaration.declarations) {
              ...
              ***REMOVED***);
            ***REMOVED*** else {
              // captures 'export function foo() {***REMOVED***' syntax
              specifierExportCount++;
            ***REMOVED***
        ...
        'Program:exit': function () {function ProgramExit() {
            ...
            ***REMOVED*** else if (target === 'any' && specifierExportCount > 0) {
