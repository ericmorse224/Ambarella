...
async function loader(content, map, meta) {
  ...
  if (this._compiler && this._compiler.options && this._compiler.options.experiments && this._compiler.options.experiments.css && this._module && (this._module.type === "css" || this._module.type === "css/auto" || this._module.type === "css/global" || this._module.type === "css/module")) {
    this.emitWarning(new Error('You can\'t use `experiments.css` (`experiments.futureDefaults` enable built-in CSS support by default) and `css-loader` together, please set `experiments.css` to `false` or set `{ type: "javascript/auto" ***REMOVED***` for rules with `css-loader` in your webpack config (now css-loader does nothing).'));
  ...
  ***REMOVED***
  ...
  if (meta) {
    const {
      ast
    ***REMOVED*** = meta;
    if (ast && ast.type === "postcss" && (0, _semver.satisfies)(ast.version, `^${_package.default.version***REMOVED***`)) {
  ...
  ***REMOVED***
  ...
  callback(null, `${importCode***REMOVED***${moduleCode***REMOVED***${exportCode***REMOVED***`);
***REMOVED***