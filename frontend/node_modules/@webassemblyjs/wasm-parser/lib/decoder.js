  ...
  ***REMOVED*** // Export section
  ...
  function parseExportSection(numberOfExport) {
    ...
    for (var i = 0; i < numberOfExport; i++) {
      ...
      ***REMOVED*** else if (_helperWasmBytecode["default"].exportTypes[typeIndex] === "Table") {
        ...
        ***REMOVED***
        ...
        id = t.numberLiteralFromRaw(index, String(index));
        signature = null;
      ***REMOVED*** else if (_helperWasmBytecode["default"].exportTypes[typeIndex] === "Memory") {
        ...
        ***REMOVED***
        ...
        id = t.numberLiteralFromRaw(index, String(index));
        signature = null;
      ***REMOVED*** else if (_helperWasmBytecode["default"].exportTypes[typeIndex] === "Global") {
