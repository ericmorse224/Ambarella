...
/// <reference types="node" />
import { Volume, TData, TMode, TFlags, TFlagsCopy, TTime, IOptions, IAppendFileOptions, IMkdirOptions, IReaddirOptions, IReadFileOptions, IRealpathOptions, IWriteFileOptions, IStatOptions, IRmOptions, IFStatOptions ***REMOVED*** from './volume';
import Stats from './Stats';
import Dirent from './Dirent';
import { TDataOut ***REMOVED*** from './encoding';
import { PathLike, symlink ***REMOVED*** from 'fs';
