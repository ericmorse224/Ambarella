...
exports.everyProtocol = function everyProtocol (body) {
  var protocols = [
    { protocol: 'http2', alpn: 'h2', version: 4 ***REMOVED***,
    { protocol: 'spdy', alpn: 'spdy/3.1', version: 3.1 ***REMOVED***,
    { protocol: 'spdy', alpn: 'spdy/3', version: 3 ***REMOVED***,
    { protocol: 'spdy', alpn: 'spdy/2', version: 2 ***REMOVED***
  ]
