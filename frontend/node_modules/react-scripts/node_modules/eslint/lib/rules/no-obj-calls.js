...
const { CALL, CONSTRUCT, ReferenceTracker ***REMOVED*** = require("@eslint-community/eslint-utils");
        ...
        return {
            Program(node) {
                ...
                ***REMOVED***
                ...
                for (const { node: refNode, path ***REMOVED*** of tracker.iterateGlobalReferences(traceMap)) {
                    const name = getReportNodeName(refNode.callee);
                    const ref = path[0];
                    const messageId = name === ref ? "unexpectedCall" : "unexpectedRefCall";

                    context.report({ node: refNode, messageId, data: { name, ref ***REMOVED*** ***REMOVED***);
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***;
    ***REMOVED***
