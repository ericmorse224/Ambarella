...
var _util = require('./util');
 ...
 function parseTopLevel() {
  ...
  if (_base.state.scopeDepth !== 0) {
    throw new Error(`Invalid scope depth at end of file: ${_base.state.scopeDepth***REMOVED***`);
  ***REMOVED***
  return new (0, _index.File)(_base.state.tokens, _base.state.scopes);
***REMOVED*** exports.parseTopLevel = parseTopLevel;
...
***REMOVED*** exports.parseStatement = parseStatement;
    ...
    ***REMOVED***
    case _types.TokenType.name:
      ...
      ***REMOVED*** else if (
        ...
        return;
      ***REMOVED*** else if (startsAwaitUsing()) {
 ...
 * await using foo = bar();
 * for (await using a of b) {***REMOVED***
 *
 * Examples returning false:
 * await using
 * await using + 1
 * await using instanceof T
 * for (await using;;) {***REMOVED***
 *
...
***REMOVED***
 ...
 function parseDecorators() {
  while (_tokenizer.match.call(void 0, _types.TokenType.at)) {
    parseDecorator();
  ***REMOVED***
***REMOVED*** exports.parseDecorators = parseDecorators;
...
***REMOVED***
  ...
  ***REMOVED***
***REMOVED*** exports.baseParseMaybeDecoratorArguments = baseParseMaybeDecoratorArguments;
...
***REMOVED***
 ...
 function parseVarStatement(isBlockScope) {
  ...
  _util.semicolon.call(void 0, );
***REMOVED*** exports.parseVarStatement = parseVarStatement;
...
// Parse a semicolon-enclosed block of statements.
  ...
  ***REMOVED***
  ...
  _base.state.scopeDepth--;
***REMOVED*** exports.parseBlock = parseBlock;

 function parseBlockBody(end) {
  while (!_tokenizer.eat.call(void 0, end) && !_base.state.error) {
    parseStatement(true);
  ***REMOVED***
***REMOVED*** exports.parseBlockBody = parseBlockBody;
...
// `isStatement` parameter).
  ...
  ***REMOVED***
  ...
  if (nameScopeStartTokenIndex !== null) {
    ...
    _base.state.scopeDepth--;
  ***REMOVED***
***REMOVED*** exports.parseFunction = parseFunction;
  ...
  ***REMOVED***
  ...
  if (funcContextId) {
    _base.state.tokens[_base.state.tokens.length - 1].contextId = funcContextId;
  ***REMOVED***
***REMOVED*** exports.parseFunctionParams = parseFunctionParams;
...
// `isStatement` parameter).
  ...
  ***REMOVED***
  ...
  if (nameScopeStartTokenIndex !== null) {
    ...
    _base.state.scopeDepth--;
  ***REMOVED***
***REMOVED*** exports.parseClass = parseClass;
  ...
  ***REMOVED***
  ...
  if (_tokenizer.match.call(void 0, _types.TokenType.name) && _base.state.contextualKeyword === _keywords.ContextualKeyword._static) {
    ...
    if (isClassMethod()) {
      ...
      return;
    ***REMOVED*** else if (isClassProperty()) {
      parseClassProperty();
      return;
    ***REMOVED***
...
function parseClassMemberWithIsStatic(
  ...
  ***REMOVED*** else if (isClassProperty()) {
    parseClassProperty();
  ***REMOVED*** else if (token.contextualKeyword === _keywords.ContextualKeyword._async && !_util.isLineTerminator.call(void 0, )) {
  ...
  ***REMOVED*** else if (
    ...
    ***REMOVED***
    ...
    parseClassPropertyName(classContextId);
    parseClassMethod(memberStart, /* isConstructor */ false);
  ***REMOVED*** else if (token.contextualKeyword === _keywords.ContextualKeyword._accessor && !_util.isLineTerminator.call(void 0, )) {
    parseClassPropertyName(classContextId);
    parseClassProperty();
  ***REMOVED*** else if (_util.isLineTerminator.call(void 0, )) {
...
***REMOVED*** exports.parseClassPropertyName = parseClassPropertyName;
  ...
  ***REMOVED***
***REMOVED*** exports.parsePostMemberNameModifiers = parsePostMemberNameModifiers;
  ...
  ***REMOVED***
  _util.semicolon.call(void 0, );
***REMOVED*** exports.parseClassProperty = parseClassProperty;
...
// Parses module export declaration.
  ...
  ***REMOVED***
  ...
  if (shouldParseExportStar()) {
    parseExportStar();
  ***REMOVED*** else if (isExportDefaultSpecifier()) {
    // export default from
    _expression.parseIdentifier.call(void 0, );
    ...
    ***REMOVED***
    parseExportFrom();
  ***REMOVED*** else if (_tokenizer.eat.call(void 0, _types.TokenType._default)) {
    // export default ...
    parseExportDefaultExpression();
  ***REMOVED*** else if (shouldParseExportDeclaration()) {
...
***REMOVED*** exports.parseExport = parseExport;
...
function parseExportDefaultExpression() {
  ...
  ***REMOVED*** else if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._async) && _tokenizer.lookaheadType.call(void 0, ) === _types.TokenType._function) {
    ...
    parseFunction(functionStart, true, true);
  ***REMOVED*** else if (_tokenizer.match.call(void 0, _types.TokenType._class)) {
    parseClass(true, true);
  ***REMOVED*** else if (_tokenizer.match.call(void 0, _types.TokenType.at)) {
    parseDecorators();
    parseClass(true, true);
  ***REMOVED*** else {
    _expression.parseMaybeAssign.call(void 0, );
...
function isExportDefaultSpecifier() {
  if (_base.isTypeScriptEnabled && _typescript.tsIsDeclarationStart.call(void 0, )) {
    return false;
  ***REMOVED*** else if (_base.isFlowEnabled && _flow.flowShouldDisallowExportDefaultSpecifier.call(void 0, )) {
    return false;
  ***REMOVED***
  if (_tokenizer.match.call(void 0, _types.TokenType.name)) {
...
***REMOVED***
  ...
  ***REMOVED***
  _util.semicolon.call(void 0, );
***REMOVED*** exports.parseExportFrom = parseExportFrom;
...
***REMOVED***
  ...
  ***REMOVED*** else {
    parseExportFrom();
  ***REMOVED***
***REMOVED*** exports.baseParseExportStar = baseParseExportStar;
...
// Parses a comma-separated list of module exports.
  ...
  ***REMOVED***
***REMOVED*** exports.parseExportSpecifiers = parseExportSpecifiers;
 ...
 * import module, {bar***REMOVED*** from "foo";
 */
function isImportReflection() {
  ...
  if (_util.eatContextual.call(void 0, _keywords.ContextualKeyword._from)) {
    ...
    ***REMOVED*** else {
      ...
      return false;
    ***REMOVED***
  ***REMOVED*** else if (_tokenizer.match.call(void 0, _types.TokenType.comma)) {
    _base.state.restoreFromSnapshot(snapshot);
    return false;
  ***REMOVED*** else {
    _base.state.restoreFromSnapshot(snapshot);
...
// Parses import declaration.
  ...
  ***REMOVED***
  if (_base.isTypeScriptEnabled && _util.isContextual.call(void 0, _keywords.ContextualKeyword._type)) {
    ...
    ***REMOVED*** else if (lookahead.type === _types.TokenType.star || lookahead.type === _types.TokenType.braceL) {
  ...
  ***REMOVED***
  maybeParseImportAttributes();
  _util.semicolon.call(void 0, );
***REMOVED*** exports.parseImport = parseImport;
...
/**
 * Parse import attributes like `with {type: "json"***REMOVED***`, or the legacy form
 * `assert {type: "json"***REMOVED***`.
 *
