...
class UIEventImpl extends EventImpl {
  constructor(globalObject, args, privateData) {
    ...
    if (eventInitDict && eventInitDict.view !== null && eventInitDict.view !== undefined) {
      if (!isWindow(eventInitDict.view)) {
        throw new TypeError(`Failed to construct '${new.target.name.replace(/Impl$/, "")***REMOVED***': member view is not of ` +
                            "type Window.");
      ***REMOVED***
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  initUIEvent(type, bubbles, cancelable, view, detail) {
    if (view !== null) {
      if (!isWindow(view)) {
        throw new TypeError(`Failed to execute 'initUIEvent' on '${this.constructor.name.replace(/Impl$/, "")***REMOVED***': ` +
