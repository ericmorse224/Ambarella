...
interface ReadableWritablePair<R = any, W = any> {
    ...
    /**
     * Provides a convenient, chainable way of piping this readable stream through a transform stream (or any other { writable, readable ***REMOVED*** pair). It simply pipes the stream into the writable side of the supplied pair, and returns the readable side for further use.
     *
...
type NodeFilter = ((node: Node) => number) | { acceptNode(node: Node): number; ***REMOVED***;
...
type XPathNSResolver = ((prefix: string | null) => string | null) | { lookupNamespaceURI(prefix: string | null): string | null; ***REMOVED***;
...
declare var ReadableStream: {
    ...
    new(underlyingSource: UnderlyingByteSource, strategy?: { highWaterMark?: number ***REMOVED***): ReadableStream<Uint8Array>;
...
interface TextDecoder extends TextDecoderCommon {
     ...
     *   string += decoder.decode(buffer, {stream:true***REMOVED***);
     * ***REMOVED***
