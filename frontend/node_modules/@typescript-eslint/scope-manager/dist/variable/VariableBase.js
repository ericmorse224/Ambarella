...
class VariableBase {
    constructor(name, scope) {
        ...
        this.identifiers = [];
        /**
         * List of {@link Reference***REMOVED*** of this variable (excluding parameter entries)  in its defining scope and all nested scopes.
         * For defining occurrences only see {@link Variable#defs***REMOVED***.
         * @public
         */
        this.references = [];
        this.name = name;
