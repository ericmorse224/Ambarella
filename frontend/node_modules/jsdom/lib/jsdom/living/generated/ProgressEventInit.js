...
exports._convertInherit = (obj, ret, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
...

  {
    ...
    if (value !== undefined) {
      value = conversions["boolean"](value, { context: context + " has member 'lengthComputable' that" ***REMOVED***);
  ...
  ***REMOVED***

  {
    ...
    let value = obj === undefined || obj === null ? undefined : obj[key];
    if (value !== undefined) {
      value = conversions["unsigned long long"](value, { context: context + " has member 'loaded' that" ***REMOVED***);
  ...
  ***REMOVED***

  {
    ...
    let value = obj === undefined || obj === null ? undefined : obj[key];
    if (value !== undefined) {
      value = conversions["unsigned long long"](value, { context: context + " has member 'total' that" ***REMOVED***);
