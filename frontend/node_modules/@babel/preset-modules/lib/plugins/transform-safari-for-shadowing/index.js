 ...
 *
 * @example
 *   e => { for (let e of []) e ***REMOVED***   // throws
 *   e => { for (let _e of []) _e ***REMOVED***   // works
 */
function handle(declaration) {
  ...
  const {
    name
  ***REMOVED*** = declaration.node.declarations[0].id; // check if there is a shadowed binding coming from a parameter
