...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('first') ***REMOVED***,

    fixable: 'code',
    schema: [
    {
      type: 'string',
      'enum': ['absolute-first', 'disable-absolute-first'] ***REMOVED***] ***REMOVED***,
        ...
        Program: function () {function Program(n) {
            ...
            ***REMOVED***
            ...
            body.forEach(function (node, index) {
              ...
              if (node.type === 'ImportDeclaration' || node.type === 'TSImportEqualsDeclaration') {
                if (absoluteFirst) {
                  if (/^\./.test(getImportValue(node))) {
                    anyRelative = true;
                  ***REMOVED*** else if (anyRelative) {
                    context.report({
                      node: node.type === 'ImportDeclaration' ? node.source : node.moduleReference,
                      message: 'Absolute imports should come before relative imports.' ***REMOVED***);
                ...
                ***REMOVED***
                if (nonImportCount > 0) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
                  ...
                  errorInfos.push({
                    node: node,
                    range: [body[index - 1].range[1], node.range[1]] ***REMOVED***);
              ...
              ***REMOVED***
            ***REMOVED***);
            if (!errorInfos.length) {return;***REMOVED***
            errorInfos.forEach(function (errorInfo, index) {
              ...
              if (index < lastSortNodesIndex) {
                ...
                ***REMOVED***;
              ***REMOVED*** else if (index === lastSortNodesIndex) {
