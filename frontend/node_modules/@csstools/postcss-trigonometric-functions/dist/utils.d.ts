import type { FunctionNode, WordNode, Node ***REMOVED*** from 'postcss-value-parser';
 ...
 * - `{Number***REMOVED*** {Operation***REMOVED*** {Number***REMOVED*** ...`
 *
 ...
 *
 *
 * @param {FunctionNode***REMOVED*** nodes Nodes to be parsed
 * @param {Boolean***REMOVED*** ignoreUnit Whether units are ignored or converted to radians
 * @return {FunctionNode***REMOVED*** Returns the node, if it managed to calculate, it will
 ...
 *
 * @param {Number***REMOVED*** number Number to be formatted
 * @param {Number***REMOVED*** decimals Precision of decimals, CSS doesn't usually handle further than 5.
 */
