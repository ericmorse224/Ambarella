...
const ERROR_MESSAGE = `Do not set the parser at the test level unless you want to use a parser other than ${TS_ESLINT_PARSER***REMOVED***`;
...
class RuleTester extends BaseRuleTester.RuleTester {
    ...
    static get afterAll() {
        var _b;
        return ((_b = __classPrivateFieldGet(this, _a, "f", _RuleTester_afterAll)) !== null && _b !== void 0 ? _b : (typeof afterAll === 'function' ? afterAll : () => { ***REMOVED***));
    ***REMOVED***
    ...
    ***REMOVED***
    constructor(baseOptions) {
        ...
        const { dependencyConstraints: _ ***REMOVED*** = baseOptions, baseOptionsSafeForESLint = __rest(baseOptions, ["dependencyConstraints"]);
        super(Object.assign(Object.assign({***REMOVED***, baseOptionsSafeForESLint), { parserOptions: Object.assign(Object.assign({***REMOVED***, baseOptions.parserOptions), { warnOnUnsupportedTypeScriptVersion: (_c = (_b = baseOptions.parserOptions) === null || _b === void 0 ? void 0 : _b.warnOnUnsupportedTypeScriptVersion) !== null && _c !== void 0 ? _c : false ***REMOVED***), 
            // as of eslint 6 you have to provide an absolute path to the parser
            // but that's not as clean to type, this saves us trying to manually enforce
            // that contributors require.resolve everything
            parser: require.resolve(baseOptions.parser) ***REMOVED***));
    ...
    ***REMOVED***
    getFilename(testOptions) {
        ...
        const filename = `file.ts${((_b = resolvedOptions.ecmaFeatures) === null || _b === void 0 ? void 0 : _b.jsx) ? 'x' : ''***REMOVED***`;
    ...
    run(name, rule, testsReadonly) {
        if (__classPrivateFieldGet(this, _RuleTester_baseOptions, "f").dependencyConstraints &&
            ...
            if (isDescribeWithSkip(this.staticThis.describe)) {
                ...
                this.staticThis.describe.skip(name, () => {
                    this.staticThis.it('All tests skipped due to unsatisfied constructor dependency constraints', () => { ***REMOVED***);
                ***REMOVED***);
            ***REMOVED***
            else {
        ...
        */
        const normalizeTest = (_b) => {
            var { dependencyConstraints: _ ***REMOVED*** = _b, test = __rest(_b, ["dependencyConstraints"]);
            if (test.parser === TS_ESLINT_PARSER) {
                throw new Error(ERROR_MESSAGE);
            ***REMOVED***
            if (!test.filename) {
                return Object.assign(Object.assign({***REMOVED***, test), { filename: this.getFilename(test.parserOptions) ***REMOVED***);
            ***REMOVED***
            return test;
        ***REMOVED***;
                ...
                if (semver.satisfies(package_json_1.version, '>=7.29.0')) {
                    ...
                    */
                    const maybeMarkAsOnly = (test) => {
                        return Object.assign(Object.assign({***REMOVED***, test), { only: (0, dependencyConstraints_1.satisfiesAllDependencyConstraints)(test.dependencyConstraints) ***REMOVED***);
                    ***REMOVED***;
