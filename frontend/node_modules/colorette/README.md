...
```js
import { blue, bold, underline ***REMOVED*** from "colorette"
...
```js
console.log(`
  There's a ${underline(blue("house"))***REMOVED***,
  With a ${bold(blue("window"))***REMOVED***,
  And a ${blue("corvette")***REMOVED***
...
```js
console.log(bold(`I'm ${blue(`da ba ${underline("dee")***REMOVED*** da ba`)***REMOVED*** daa`))
```

Need to override terminal color detection? You can do that too.

```js
import { createColors ***REMOVED*** from "colorette"

const { blue ***REMOVED*** = createColors({ useColor: false ***REMOVED***)
...
```js
import { blue ***REMOVED*** from "colorette"
...
Override terminal color detection via `createColors({ useColor ***REMOVED***)`.
