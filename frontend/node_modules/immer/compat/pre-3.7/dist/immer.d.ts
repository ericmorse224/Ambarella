...
export type Draft<T> = T extends PrimitiveType
	...
	? DraftSet<V>
	: T extends object
	? {-readonly [K in keyof T]: Draft<T[K]>***REMOVED***
	: T

// Inline these in ts 3.7
interface DraftMap<K, V> extends Map<Draft<K>, Draft<V>> {***REMOVED***

// Inline these in ts 3.7
interface DraftSet<V> extends Set<Draft<V>> {***REMOVED***
...
export type Immutable<T> = T extends PrimitiveType
	...
	? ImmutableSet<V>
	: T extends object
	? {readonly [K in keyof T]: Immutable<T[K]>***REMOVED***
	: T

interface ImmutableMap<K, V> extends Map<Immutable<K>, Immutable<V>> {***REMOVED***

interface ImmutableSet<V> extends Set<Immutable<V>> {***REMOVED***
...
export interface ImmerState<T = any> {
	...
	base: T
	copy: T
	assigned: {[prop: string]: boolean; [index: number]: boolean***REMOVED***
***REMOVED***

// Backward compatibility with --target es5
declare global {
	interface Set<T> {***REMOVED***
	interface Map<K, V> {***REMOVED***
	interface WeakSet<T> {***REMOVED***
	interface WeakMap<K extends object, V> {***REMOVED***
***REMOVED***
