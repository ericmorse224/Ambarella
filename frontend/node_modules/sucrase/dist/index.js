"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj ***REMOVED***; ***REMOVED***var _CJSImportProcessor = require('./CJSImportProcessor'); var _CJSImportProcessor2 = _interopRequireDefault(_CJSImportProcessor);
...
;
 ...
 function getVersion() {
  ...
  return "3.35.0";
***REMOVED*** exports.getVersion = getVersion;
 ...
 function transform(code, options) {
  ...
  try {
    ...
    let result = {code: transformerResult.code***REMOVED***;
  ...
  ***REMOVED*** catch (e) {
    if (options.filePath) {
      e.message = `Error transforming ${options.filePath***REMOVED***: ${e.message***REMOVED***`;
    ***REMOVED***
    throw e;
  ***REMOVED***
***REMOVED*** exports.transform = transform;
...
***REMOVED*** exports.getFormattedTokens = getFormattedTokens;
...
function getSucraseContext(code, options) {
  ...
  if (options.transforms.includes("imports")) {
    ...
    ***REMOVED***
  ***REMOVED*** else if (options.transforms.includes("typescript") && !options.keepUnusedImports) {
  ...
  ***REMOVED***
  return {tokenProcessor, scopes, nameManager, importProcessor, helperManager***REMOVED***;
***REMOVED***
