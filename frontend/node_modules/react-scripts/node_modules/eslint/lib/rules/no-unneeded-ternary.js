...
***REMOVED***;
const OR_PRECEDENCE = astUtils.getPrecedence({ type: "LogicalExpression", operator: "||" ***REMOVED***);
...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @returns {boolean***REMOVED*** True if the its a boolean literal
         * @private
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node A node representing an expression
         * @returns {string***REMOVED*** A string representing an inverted expression
         */
        function invertExpression(node) {
            ...
            ***REMOVED***
            ...
            if (astUtils.getPrecedence(node) < astUtils.getPrecedence({ type: "UnaryExpression" ***REMOVED***)) {
                return `!(${astUtils.getParenthesisedText(sourceCode, node)***REMOVED***)`;
            ***REMOVED***
            return `!${astUtils.getParenthesisedText(sourceCode, node)***REMOVED***`;
        ***REMOVED***
         ...
         * @returns {boolean***REMOVED*** True if it is determined that the node will always evaluate to a boolean value
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node The ConditionalExpression to check.
         * @returns {boolean***REMOVED*** True if the pattern is matched, and false otherwise
         * @private
         */
                    ...
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            ***REMOVED***
                            ...
                            return fixer.replaceText(node, isBooleanExpression(node.test) ? astUtils.getParenthesisedText(sourceCode, node.test) : `!${invertExpression(node.test)***REMOVED***`);
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED*** else if (!defaultAssignment && matchesDefaultAssignment(node)) {
                    context.report({
                        node,
