import { ParserServices, TSESTreeOptions ***REMOVED*** from './parser-options';
...
***REMOVED*** : EmptyObject) & (T['comment'] extends true ? {
...
export { AST, parse, parseAndGenerateServices, parseWithNodeMaps, ParseAndGenerateServicesResult, ParseWithNodeMapsResult, clearProgramCache, clearParseAndGenerateServicesCalls, ***REMOVED***;
