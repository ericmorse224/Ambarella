...
*/
import {setCatchHandler***REMOVED*** from 'workbox-routing/setCatchHandler.js';
import {matchPrecache***REMOVED*** from 'workbox-precaching/matchPrecache.js';
import {RouteHandler, RouteHandlerCallbackOptions***REMOVED*** from 'workbox-core/types.js';
 ...
 */
function offlineFallback(options: OfflineFallbackOptions = {***REMOVED***): void {
...
export {offlineFallback***REMOVED***;
