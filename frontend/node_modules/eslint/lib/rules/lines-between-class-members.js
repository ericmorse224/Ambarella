...
module.exports = {
                        ...
                        properties: {
                            enforce: {
                                ...
                                items: {
                                    type: "object",
                                    properties: {
                                        blankLine: { enum: ["always", "never"] ***REMOVED***,
                                        prev: { enum: ["method", "field", "*"] ***REMOVED***,
                                        next: { enum: ["method", "field", "*"] ***REMOVED***
                                    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    create(context) {
        ...
        const configureList = typeof options[0] === "object" ? options[0].enforce : [{ blankLine: options[0], prev: "*", next: "*" ***REMOVED***];
        ...
        ***REMOVED***
        ...
        function findLastConsecutiveTokenAfter(prevLastToken, nextFirstToken, maxLine) {
            const after = sourceCode.getTokenAfter(prevLastToken, { includeComments: true ***REMOVED***);
        ...
        ***REMOVED***
        ...
        function findFirstConsecutiveTokenBefore(nextFirstToken, prevLastToken, maxLine) {
            const before = sourceCode.getTokenBefore(nextFirstToken, { includeComments: true ***REMOVED***);
        ...
        ***REMOVED***
        ...
        function hasTokenOrCommentBetween(before, after) {
            return sourceCode.getTokensBetween(before, after, { includeComments: true ***REMOVED***).length !== 0;
        ***REMOVED***
        ...
        return {
            ClassBody(node) {
                ...
                for (let i = 0; i < body.length - 1; i++) {
                    ...
                    const { curLast, nextFirst ***REMOVED*** = getBoundaryTokens(body[i], body[i + 1]);
