...
class ChangeBuffer {
  ...
  ***REMOVED*** // Minor input to buffer.

  pushDiff(diff) {
    this.line.push(diff);
  ***REMOVED*** // Main input to buffer.
    ...
    if (string.includes('\n')) {
      ...
      substrings.forEach((substring, i) => {
        if (i < iLast) {
          ...
          this.pushLine();
        ***REMOVED*** else if (substring.length !== 0) {
  ...
  ***REMOVED*** // Output from buffer.
  ...
  moveLinesTo(lines) {
    ...
    ***REMOVED***
    ...
    this.lines.length = 0;
  ***REMOVED***
***REMOVED*** // Encapsulate common and change lines.
...
class CommonBuffer {
  ...
  ***REMOVED*** // Output from buffer.
  ...
  getLines() {
    ...
    return this.lines;
  ***REMOVED***
***REMOVED*** // Given diffs from expected and received strings,
