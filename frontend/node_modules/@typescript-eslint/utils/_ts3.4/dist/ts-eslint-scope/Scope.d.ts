...
import { Definition ***REMOVED*** from './Definition';
import { Reference, ReferenceFlag ***REMOVED*** from './Reference';
import { ScopeManager ***REMOVED*** from './ScopeManager';
import { Variable ***REMOVED*** from './Variable';
...
interface Scope {
     ...
     * @returns {boolean***REMOVED*** arguments materialized
     */
...
export { ScopeType, Scope, GlobalScope, ModuleScope, FunctionExpressionNameScope, CatchScope, WithScope, BlockScope, SwitchScope, FunctionScope, ForScope, ClassScope, ***REMOVED***;
