...
module.exports = {
  ...
  ***REMOVED***,
  ...
  create(context) {
    ...
    /**
     * @param {ASTNode***REMOVED*** expression An Identifier node
    ...
    ***REMOVED***
    ...
    /**
     * @param {object***REMOVED*** node A Identifier node
     */
          ...
          ***REMOVED***
          if (node.arguments[1].type === 'ObjectExpression') {
            ...
            if (style && 'value' in style) {
              ...
              ***REMOVED*** else if (isNonNullaryLiteral(style.value)) {
                report(context, messages.stylePropNotObject, 'stylePropNotObject', {
                  node: style.value,
                ***REMOVED***);
              ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (node.value.type !== 'JSXExpressionContainer' || isNonNullaryLiteral(node.value.expression)) {
          report(context, messages.stylePropNotObject, 'stylePropNotObject', {
            node,
          ***REMOVED***);
        ***REMOVED*** else if (node.value.expression.type === 'Identifier') {
