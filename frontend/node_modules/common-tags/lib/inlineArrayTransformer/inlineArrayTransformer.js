 ...
 * @param  {String***REMOVED*** [opts.separator = ''] - the character that separates each item
 * @param  {String***REMOVED*** [opts.conjunction = '']  - replace the last separator with this
 * @param  {Boolean***REMOVED*** [opts.serial = false] - include the separator before the conjunction? (Oxford comma use-case)
 *
 * @return {Object***REMOVED***                     - a TemplateTag transformer
 */
