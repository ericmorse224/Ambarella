...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-internal-modules') ***REMOVED***,
    ...
    schema: [
    {
...

      {
        ...
        additionalProperties: false ***REMOVED***] ***REMOVED***] ***REMOVED***,
  ...
  create: function () {function noReachingInside(context) {
      ...
      var allowRegexps = (options.allow || []).map(function (p) {return _minimatch2['default'].makeRe(p);***REMOVED***);
      var forbidRegexps = (options.forbid || []).map(function (p) {return _minimatch2['default'].makeRe(p);***REMOVED***);
      ...
      ***REMOVED***
      ...
      function toSteps(somePath) {
        ...
        split('/').
        filter(function (step) {return step && step !== '.';***REMOVED***).
      ...
      ***REMOVED***
      ...
      function reachingAllowed(importPath) {
        return allowRegexps.some(function (re) {return re.test(importPath);***REMOVED***);
      ***REMOVED***

      // test if reaching to this destination is forbidden
      function reachingForbidden(importPath) {
        return forbidRegexps.some(function (re) {return re.test(importPath);***REMOVED***);
      ***REMOVED***

      function isAllowViolation(importPath) {
        var steps = toSteps(importPath);

        var nonScopeSteps = steps.filter(function (step) {return step.indexOf('@') !== 0;***REMOVED***);
        if (nonScopeSteps.length <= 1) {return false;***REMOVED***
        ...
        if (reachingAllowed(justSteps) || reachingAllowed('/' + String(justSteps))) {return false;***REMOVED***
        ...
        if (!resolved || reachingAllowed(normalizeSep(resolved))) {return false;***REMOVED***
      ...
      ***REMOVED***
      ...
      function isForbidViolation(importPath) {
        ...
        if (reachingForbidden(justSteps) || reachingForbidden('/' + String(justSteps))) {return true;***REMOVED***

        // if the import statement doesn't match directly, try to match the
        // resolved path if the import is resolvable
        var resolved = (0, _resolve2['default'])(importPath, context);
        if (resolved && reachingForbidden(normalizeSep(resolved))) {return true;***REMOVED***
      ...
      ***REMOVED***
      ...
      function checkImportForReaching(importPath, node) {
        ...
        isReachViolation(importPath))
        {
          context.report({
            node: node,
            message: 'Reaching to "' + String(importPath) + '" is not allowed.' ***REMOVED***);
      ...
      ***REMOVED***,
      { commonjs: true ***REMOVED***);

    ***REMOVED***return noReachingInside;***REMOVED***() ***REMOVED***;
