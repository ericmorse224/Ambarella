 ...
 * fixed: callback passed as an argument to generators
 * change: `co(function *(){***REMOVED***)` now returns a reusable thunk
 * change: `this` must now be passed through the returned thunk, ex. `co(function *(){***REMOVED***).call(this)`
