...
class Node {
	/**
	 * @param {T***REMOVED*** item the value of the node
	 */
	constructor(item) {
		this.item = item;
		/** @type {Set<Node<T>>***REMOVED*** */
		this.dependencies = new Set();
		this.marker = NO_MARKER;
		/** @type {Cycle<T> | undefined***REMOVED*** */
...
/**
 * @template T
 * @typedef {object***REMOVED*** StackEntry
 * @property {Node<T>***REMOVED*** node
 * @property {Node<T>[]***REMOVED*** openEdges
 */

/**
 * @template T
 * @param {Iterable<T>***REMOVED*** items list of items
 * @param {(item: T) => Iterable<T>***REMOVED*** getDependencies function to get dependencies of an item (items that are not in list are ignored)
 * @returns {Iterable<T>***REMOVED*** graph roots of the items
 */
module.exports = (items, getDependencies) => {
	/** @type {Map<T, Node<T>>***REMOVED*** */
					...
					switch (dependency.marker) {
						...
						***REMOVED***
						...
						case DONE_MAYBE_ROOT_CYCLE_MARKER:
							...
							rootCycles.delete(/** @type {Cycle<T>***REMOVED*** */ (dependency.cycle));
							dependency.marker = DONE_MARKER;
							break;
