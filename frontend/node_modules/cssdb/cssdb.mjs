  ...
  ***REMOVED***,
  {
    ...
    ***REMOVED***,
    "example": "@media (width < 480px) {***REMOVED***\n\n@media (480px <= width < 768px) {***REMOVED***\n\n@media (width >= 768px) {***REMOVED***",
    "interoperable_at": 1679875200,
    "polyfills": [
      {
        "type": "PostCSS Plugin",
