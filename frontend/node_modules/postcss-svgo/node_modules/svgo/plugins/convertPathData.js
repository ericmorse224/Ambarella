...
const { collectStylesheet, computeStyle ***REMOVED*** = require('../lib/style.js');
const { pathElems ***REMOVED*** = require('./_collections.js');
const { path2js, js2path ***REMOVED*** = require('./_path.js');
const { applyTransforms ***REMOVED*** = require('./_applyTransforms.js');
const { cleanupOutData ***REMOVED*** = require('../lib/svgo/tools');
...
const convertToRelative = (pathData) => {
  ...
  for (let i = 0; i < pathData.length; i += 1) {
    ...
    let { command, args ***REMOVED*** = pathItem;
 ...
 * @return {Array***REMOVED*** output path data
 */
function filters(path, params, { maybeHasStrokeAndLinecap, hasMarkerMid ***REMOVED***) {
      ...
      if (
        ...
        var r = roundData([circle.radius])[0],
          ...
          ***REMOVED***,
          ...
          relCircle = { center: relCenter, radius: circle.radius ***REMOVED***,
          arcCurves = [item],
          hasPrev = 0,
          suffix = '',
          nextLonghand;
        ...
        for (
          ...
          if (next.command == 's') {
            nextLonghand = makeLonghand(
              { command: 's', args: next.args.slice() ***REMOVED***,
              path[j - 1].args
            );
        ...
        ***REMOVED***
        ...
        if ((stringify(output) + suffix).length < stringify(arcCurves).length) {
          ...
          ***REMOVED*** else if (arcCurves.length - 1 - hasPrev > 0) {
      ...
      ***REMOVED***
      ...
      if (precision !== false) {
        if (
          ...
          ***REMOVED***
        ***REMOVED*** else if (command == 'h') {
          data[0] += item.base[0] - relSubpoint[0];
        ***REMOVED*** else if (command == 'v') {
          data[0] += item.base[1] - relSubpoint[1];
        ***REMOVED*** else if (command == 'a') {
      ...
      ***REMOVED***
      ...
      if (params.straightCurves) {
        if (
          ...
          command = 'l';
          data = data.slice(-2);
        ***REMOVED*** else if (command === 'q' && isCurveStraightLine(data)) {
        ...
        ***REMOVED*** else if (
          ...
          command = 'l';
          data = data.slice(-2);
        ***REMOVED*** else if (command === 'a' && (data[0] === 0 || data[1] === 0)) {
          command = 'l';
          data = data.slice(-2);
        ***REMOVED***
      ***REMOVED***
 ...
 *
 * @param {Array***REMOVED*** data input path data
 * @return {Boolean***REMOVED*** output
 */
 ...
 *
 * @param {Array***REMOVED*** coords 8 numbers for 4 pairs of coordinates (x,y)
 * @return {Array|undefined***REMOVED*** output coordinate of lines' crosspoint
 */
 ...
 *
 * @param {Array***REMOVED*** data input data array
 * @return {Array***REMOVED*** output data array
 */
 ...
 *
 * @param {Array***REMOVED*** xs array of curve points x-coordinates
 * @param {Array***REMOVED*** ys array of curve points y-coordinates
 ...
 *
 * @param {Object***REMOVED*** item curve to convert
 * @param {Array***REMOVED*** data current curve data
 */
 ...
 *
 * @param {Array***REMOVED*** point1 first point coordinates
 * @param {Array***REMOVED*** point2 second point coordinates
 * @return {Number***REMOVED*** distance
 */
 ...
 *
 * @param {Array***REMOVED*** curve array of curve points coordinates
 * @param {Number***REMOVED*** t parametric position from 0 to 1
 * @return {Array***REMOVED*** Point coordinates
 */
 ...
 *
 * @param {Array***REMOVED*** curve
 * @return {Object|undefined***REMOVED*** circle
 */
...
function findCircle(curve) {
  ...
  if (
    ...
    ***REMOVED***)
    ...
    return { center: center, radius: radius ***REMOVED***;
***REMOVED***

/**
 * Checks if a curve fits the given circle.
 *
 * @param {Object***REMOVED*** circle
 * @param {Array***REMOVED*** curve
 * @return {Boolean***REMOVED***
 */
 ...
 * @param {Array***REMOVED*** curve
 * @param {Object***REMOVED*** relCircle
 * @return {Number***REMOVED*** angle
 */
