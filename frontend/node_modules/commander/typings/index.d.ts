...
***REMOVED***
export { InvalidArgumentError as InvalidOptionArgumentError ***REMOVED***; // deprecated old name
...
export class Command {
   ...
   * program.parseAsync(my-args, { from: 'user' ***REMOVED***); // just user supplied arguments, nothing special about argv[0]
   * ```
   *
   * @returns Promise
   */
  ...
  description(str: string, argsDescription: {[argName: string]: string***REMOVED***): this;
  /**
   * Get the description.
   */
  description(): string;
