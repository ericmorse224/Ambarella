      ...
      ***REMOVED***
      ...
      isResponseCacheable(response) {
        ...
        ***REMOVED***
        ...
        {
          if (!cacheable) {
            logger_js.logger.groupCollapsed(`The request for ` + `'${getFriendlyURL_js.getFriendlyURL(response.url)***REMOVED***' returned a response that does ` + `not meet the criteria for being cached.`);
            ...
            ***REMOVED***);
            ...
            logger_js.logger.log(`Response status: ${response.status***REMOVED***`);
