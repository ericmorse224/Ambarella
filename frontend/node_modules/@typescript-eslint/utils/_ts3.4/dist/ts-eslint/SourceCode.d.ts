import { ParserServices, TSESTree ***REMOVED*** from '../ts-estree';
import { Scope ***REMOVED*** from './Scope';
declare class TokenStore {
    ...
    ***REMOVED***>(offset: number, options?: T): SourceCode.ReturnTypeFromOptions<T> | null;
    /**
...
declare class SourceCodeBase extends TokenStore {
     ...
     * @returns A {line, column***REMOVED*** location object with a 0-indexed column
     */
     ...
     * @param first The first node or token to check between.
     * @param second The second node or token to check between.
     * @returns {boolean***REMOVED*** True if there is a whitespace character between
...
declare namespace SourceCode {
    ...
    ***REMOVED*** ? GetFilterPredicate<TOptions['filter'], TDefault> : GetFilterPredicate<TOptions, TDefault>;
    type ReturnTypeFromOptions<T> = T extends {
        includeComments: true;
    ***REMOVED*** ? GetFilterPredicateFromOptions<T, TSESTree.Token> : GetFilterPredicateFromOptions<T, Exclude<TSESTree.Token, TSESTree.Comment>>;
