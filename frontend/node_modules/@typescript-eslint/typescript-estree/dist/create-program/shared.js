 ...
 */
const DEFAULT_COMPILER_OPTIONS = Object.assign(Object.assign({***REMOVED***, CORE_COMPILER_OPTIONS), { allowNonTsExtensions: true, allowJs: true, checkJs: true ***REMOVED***);
function createDefaultCompilerOptionsFromExtra(parseSettings) {
    if (parseSettings.debugLevel.has('typescript')) {
        return Object.assign(Object.assign({***REMOVED***, DEFAULT_COMPILER_OPTIONS), { extendedDiagnostics: true ***REMOVED***);
    ***REMOVED***
...
function getAstFromProgram(currentProgram, parseSettings) {
    ...
    if (expectedExt !== returnedExt) {
        return undefined;
    ***REMOVED***
    return ast && { ast, program: currentProgram ***REMOVED***;
***REMOVED***
