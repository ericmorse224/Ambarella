...
const buildFailureTestResult = (testPath, err) => ({
  ...
  ***REMOVED***,
  ...
  testResults: []
***REMOVED***); // Add individual test result to an aggregated test result
...
const addResult = (aggregatedResults, testResult) => {
  ...
  ***REMOVED*** else if (testResult.numFailingTests > 0 || testResult.testExecError) {
    aggregatedResults.numFailedTestSuites++;
  ***REMOVED*** else {
    aggregatedResults.numPassedTestSuites++;
  ***REMOVED*** // Snapshot data
