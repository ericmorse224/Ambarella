...
function createTypeScriptVueExtension(configuration) {
    ...
    ***REMOVED***
    function createVueNoScriptEmbeddedSource() {
        return {
            sourceText: 'export default {***REMOVED***;\n',
            extension: '.js',
        ***REMOVED***;
    ***REMOVED***
    function createVueSrcScriptEmbeddedSource(src, lang) {
        ...
        const text = [
            '// @ts-ignore',
            `export { default ***REMOVED*** from '${src***REMOVED***';`,
            '// @ts-ignore',
            `export * from '${src***REMOVED***';`,
        ].join('\n');
        return {
            sourceText: text,
    ...
    ***REMOVED***
    function getVueEmbeddedSource(fileName) {
        ...
        ***REMOVED***
        ...
        const vueSourceText = fs_extra_1.default.readFileSync(fileName, { encoding: 'utf-8' ***REMOVED***);
        let script;
