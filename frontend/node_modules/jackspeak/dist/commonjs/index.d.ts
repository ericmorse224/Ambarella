...
import { inspect, InspectOptions ***REMOVED*** from 'node:util';
/**
 * Defines the type of value that is valid, given a config definition's
 * {@link ConfigType***REMOVED*** and boolean multiple setting
 */
...
***REMOVED*** & (M extends false ? {
    multiple?: false | undefined;
***REMOVED*** : M extends true ? {
    multiple: true;
***REMOVED*** : {
    multiple?: boolean;
***REMOVED***);
/**
 * A set of {@link ConfigOptionMeta***REMOVED*** fields, referenced by their longOption
 * string values.
 */
...
***REMOVED***;
/**
 * Infer {@link ConfigSet***REMOVED*** fields from a given {@link ConfigMetaSet***REMOVED***
 */
...
***REMOVED***;
/**
 * Fields that can be set on a {@link ConfigOptionBase***REMOVED*** or
 * {@link ConfigOptionMeta***REMOVED*** based on whether or not the field is known to be
 * multiple.
 */
...
/**
 * A set of {@link ConfigOptionBase***REMOVED*** objects, referenced by their longOption
 * string values.
 */
...
***REMOVED***;
/**
 * The 'values' field returned by {@link Jack#parse***REMOVED***
 */
...
***REMOVED***;
/**
 * The object retured by {@link Jack#parse***REMOVED***
 */
...
***REMOVED***;
/**
 * A row used when generating the {@link Jack#usage***REMOVED*** string
 */
...
***REMOVED***
/**
 * A heading or description row used when generating the {@link Jack#usage***REMOVED***
 * string
 */
export type TextRow = Heading | Description;
/**
 * Either a {@link TextRow***REMOVED*** or a reference to a {@link ConfigOptionBase***REMOVED***
 */
...
***REMOVED***;
/**
 * Options provided to the {@link Jack***REMOVED*** constructor
 */
 ...
 */
export declare class Jack<C extends ConfigSet = {***REMOVED***> {
    #private;
     ...
     */
    heading(text: string, level?: 1 | 2 | 3 | 4 | 5 | 6, { pre ***REMOVED***?: {
        pre?: boolean;
    ***REMOVED***): Jack<C>;
    /**
     * Add a long-form description to the usage output at this position.
     */
    description(text: string, { pre ***REMOVED***?: {
        pre?: boolean;
    ***REMOVED***): Jack<C>;
    /**
 ...
 */
export declare const jack: (options?: JackOptions) => Jack<{***REMOVED***>;
