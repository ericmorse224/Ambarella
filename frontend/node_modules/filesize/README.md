...
```javascript
filesize(500);                        // "500 B"
filesize(500, {bits: true***REMOVED***);          // "4 kbit"
filesize(265318, {base: 2***REMOVED***);          // "259.1 KiB"
filesize(265318);                     // "265.32 kB"
filesize(265318, {round: 0***REMOVED***);         // "265 kB"
filesize(265318, {output: "array"***REMOVED***);  // [265.32, "kB"]
filesize(265318, {output: "object"***REMOVED***); // {value: 265.32, symbol: "kB", exponent: 1, unit: "kB"***REMOVED***
filesize(1, {symbols: {B: "Б"***REMOVED******REMOVED***);     // "1 Б"
filesize(1024);                       // "1.02 kB"
filesize(1024, {exponent: 0***REMOVED***);        // "1024 B"
filesize(1024, {output: "exponent"***REMOVED***); // 1
filesize(265318, {standard: "jedec"***REMOVED***);  // "259.1 KB"
filesize(265318, {base: 2, fullform: true***REMOVED***); // "259.1 kibibytes"
filesize(12, {fullform: true, fullforms: ["байтов"]***REMOVED***);  // "12 байтов"
filesize(265318, {separator: ","***REMOVED***);   // "265,32 kB"
filesize(265318, {locale: "de"***REMOVED***);   // "265,32 kB"
```
...
```javascript
const size = filesize.partial({base: 2, standard: "jedec"***REMOVED***);
