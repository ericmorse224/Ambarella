...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            prototypeBuildIn: "Do not access Object.prototype method '{{prop***REMOVED******REMOVED***' from target object.",
                    ...
                    suggest: [
                        {
                            ...
                            fix(fixer) {
                                ...
                                ***REMOVED***
                                ...
                                if (astUtils.getPrecedence(callee.object) <= astUtils.getPrecedence({ type: "SequenceExpression" ***REMOVED***)) {
                                ...
                                ***REMOVED***
                                ...
                                const fixes = [
                                    fixer.replaceText(callee, `Object.prototype.${propName***REMOVED***.call`),
