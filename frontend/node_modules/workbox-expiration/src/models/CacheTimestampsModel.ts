...
import {openDB, DBSchema, IDBPDatabase, deleteDB***REMOVED*** from 'idb';
import '../_version.js';
...
interface CacheDbSchema extends DBSchema {
  'cache-entries': {
    ...
    indexes: {cacheName: string; timestamp: number***REMOVED***;
  ***REMOVED***;
***REMOVED***
...
class CacheTimestampsModel {
  ...
  ***REMOVED***
   ...
   *
   * @param {IDBPDatabase<CacheDbSchema>***REMOVED*** db
   *
   * @private
   */
  private _upgradeDb(db: IDBPDatabase<CacheDbSchema>) {
    ...
    const objStore = db.createObjectStore(CACHE_OBJECT_STORE, {keyPath: 'id'***REMOVED***);

    // TODO(philipwalton): once we don't have to support EdgeHTML, we can
    // create a single index with the keyPath `['cacheName', 'timestamp']`
    // instead of doing both these indexes.
    objStore.createIndex('cacheName', 'cacheName', {unique: false***REMOVED***);
    objStore.createIndex('timestamp', 'timestamp', {unique: false***REMOVED***);
  ***REMOVED***
  ...
  ***REMOVED***
   ...
   * @param {number***REMOVED*** timestamp
   *
   * @private
   */
  ...
  ***REMOVED***
   ...
   *
   * @param {number***REMOVED*** minTimestamp
   * @param {number***REMOVED*** maxCount
...
export {CacheTimestampsModel***REMOVED***;
