...
/**
  ...
  @param {String***REMOVED*** name The name of the project
  @param {Function***REMOVED*** definition Defines the list of files containing the tests,
...
let TestTask = function () {
  ...
  ***REMOVED***
  ...
  task(this.testName, prereqs, {async: true***REMOVED***, function () {
  ...
  ***REMOVED***);
  ...
  namespace(self.testName, function () {
    ...
    let runTask = task('run', {async: true***REMOVED***, function (pat) {
      let re;
      let testFiles;
      ...
      testFiles = self.testFiles.toArray()
        .filter(function (f) {
          return (re).test(f);
        ***REMOVED***) // Don't load the same file multiple times -- should this be in FileList?
        .reduce(function (p, c) {
          if (p.indexOf(c) < 0) {
            p.push(c);
          ***REMOVED***
        ...
        ***REMOVED***;
        ...
        testFiles.forEach(function (file) {
          ...
          namespace(file, function () {
            ...
            createTask(testName, function () {***REMOVED***);
