 ...
 *   function f() { return Object`` ***REMOVED***
...
***REMOVED***) => ({
  ...
  visitor: {
    TaggedTemplateExpression(path, state) {
      ...
      ***REMOVED*** // Use the identity function helper to get a reference to the template's Strings.
      // We replace all expressions with `0` ensure Strings has the same shape.
      //   identity`a${0***REMOVED***`
      ...
      //   tag(_t || (_t = Object`a${0***REMOVED***`), 'hello')
