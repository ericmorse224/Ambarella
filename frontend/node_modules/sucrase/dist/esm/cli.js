...
import {glob***REMOVED*** from "glob";
import {exists, mkdir, readdir, readFile, stat, writeFile***REMOVED*** from "mz/fs";
import {dirname, join, relative***REMOVED*** from "path";

import { transform***REMOVED*** from "./index";
...
async function buildFile(srcPath, outPath, options) {
  ...
  ***REMOVED***
  ...
  const transformedCode = transform(code, {...options.sucraseOptions, filePath: srcPath***REMOVED***).code;
