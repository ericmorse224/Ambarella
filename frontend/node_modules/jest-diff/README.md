...
- `const {diff***REMOVED*** = require('jest-diff');` in CommonJS modules
- `import {diff***REMOVED*** from 'jest-diff';` in ECMAScript modules
...
- `const {diffStringsUnified***REMOVED*** = require('jest-diff');` in CommonJS modules
- `import {diffStringsUnified***REMOVED*** from 'jest-diff';` in ECMAScript modules
...
```js
import {format***REMOVED*** from 'pretty-format';
...
const difference = diffLinesUnified2(
  ...
  format(a, {indent: 0***REMOVED***).split('\n'),
  format(b, {indent: 0***REMOVED***).split('\n'),
);
```
...
- `const {DIFF_DELETE, DIFF_EQUAL, DIFF_INSERT, Diff, diffStringsRaw***REMOVED*** = require('jest-diff');` in CommonJS modules
- `import {DIFF_DELETE, DIFF_EQUAL, DIFF_INSERT, Diff, diffStringsRaw***REMOVED*** from 'jest-diff';` in ECMAScript modules
...
```js
import {diffLinesRaw***REMOVED*** from 'jest-diff';
...
```ts
import {DiffOptionsColor***REMOVED*** from 'jest-diff';
```
...
```js
const a = {c: 'c', b: 'b1', a: 'a'***REMOVED***;
const b = {c: 'c', b: 'b2', a: 'a'***REMOVED***;
