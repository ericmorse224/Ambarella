...
const messages = {
  noUnreservedProps: 'A customized reserved first list must only contain a subset of React reserved props. Remove: {{unreservedWords***REMOVED******REMOVED***',
...
let attributeMap;
// attributeMap = { end: endrange, hasComment: true||false if comment in between nodes exists, it needs to be sorted to end ***REMOVED***
 ...
 * @param {Array<JSXSpreadAttribute|JSXAttribute>***REMOVED*** attributes
 * @param {Object***REMOVED*** context The context of the rule
 * @return {Array<Array<JSXAttribute>>***REMOVED***
 */
  ...
  ***REMOVED***
  ...
  for (let i = 0; i < attributes.length; i++) {
    ...
    ***REMOVED***
    if (!attrIsSpread) {
      if (comment.length === 0) {
        attributeMap.set(attribute, { end: attribute.range[1], hasComment: false ***REMOVED***);
      ...
      ***REMOVED*** else {
        ...
        if (comment.length === 1) {
          if (attributeline + 1 === commentline && nextAttribute) {
            attributeMap.set(attribute, { end: nextAttribute.range[1], hasComment: true ***REMOVED***);
            addtoSortableAttributeGroups(attribute);
            i += 1;
          ***REMOVED*** else if (attributeline === commentline) {
            if (firstComment.type === 'Block' && nextAttribute) {
              attributeMap.set(attribute, { end: nextAttribute.range[1], hasComment: true ***REMOVED***);
              i += 1;
            ***REMOVED*** else if (firstComment.type === 'Block') {
              attributeMap.set(attribute, { end: firstComment.range[1], hasComment: true ***REMOVED***);
            ***REMOVED*** else {
              attributeMap.set(attribute, { end: firstComment.range[1], hasComment: false ***REMOVED***);
            ***REMOVED***
            addtoSortableAttributeGroups(attribute);
          ***REMOVED***
        ***REMOVED*** else if (comment.length > 1 && attributeline + 1 === comment[1].loc.start.line && nextAttribute) {
          ...
          if (
            ...
            attributeMap.set(attribute, { end: commentNextAttribute[0].range[1], hasComment: true ***REMOVED***);
          ***REMOVED***
          addtoSortableAttributeGroups(attribute);
          i += 1;
        ***REMOVED***
  ...
  ***REMOVED***;
  ...
  return function fixFunction(fixer) {
    ...
    ***REMOVED***);
    ...
    fixers.forEach((fix) => {
      source = `${source.slice(0, fix.range[0])***REMOVED***${fix.text***REMOVED***${source.slice(fix.range[1])***REMOVED***`;
    ***REMOVED***);
 ...
 * @param {Object***REMOVED*** context The context of the rule
 * @param {boolean | string[]***REMOVED*** reservedFirst The `reservedFirst` option
 * @return {Function | undefined***REMOVED*** If an error is detected, a function to generate the error message, otherwise, `undefined`
 */
 ...
 * @param {Object***REMOVED*** nodeAttribute The node attribute to be reported
 * @param {string***REMOVED*** errorType The error type to be reported
 * @param {Object***REMOVED*** node The parent node for the node attribute
 * @param {Object***REMOVED*** context The context of the rule
 * @param {Array<String>***REMOVED*** reservedList The list of reserved props
 */
          ...
          if (multiline === 'first') {
            ...
            ***REMOVED***
            if (!previousIsMultiline && currentIsMultiline) {
              ...
              return memo;
            ***REMOVED***
          ***REMOVED*** else if (multiline === 'last') {
            if (!previousIsMultiline && currentIsMultiline) {
