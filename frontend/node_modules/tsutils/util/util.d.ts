...
import { NodeWrap ***REMOVED*** from './convert-ast';
...
***REMOVED*** | ts.ExportDeclaration & {
    moduleSpecifier: {***REMOVED***;
***REMOVED*** | ts.CallExpression & {
    expression: ts.Token<ts.SyntaxKind.ImportKeyword> | ts.Identifier & {
        text: 'require';
    ***REMOVED***;
    arguments: [ts.Expression, ...ts.Expression[]];
***REMOVED*** | ts.ImportTypeNode;
...
export declare function formatPseudoBigInt(v: ts.PseudoBigInt): `${string***REMOVED***n` | `-${string***REMOVED***n`;
/**
