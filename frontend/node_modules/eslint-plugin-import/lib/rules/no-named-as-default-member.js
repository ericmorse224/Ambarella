...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-named-as-default-member') ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      function storePropertyLookup(objectName, propName, node) {
        ...
        lookups.push({ node: node, propName: propName ***REMOVED***);
      ...
      ***REMOVED***
      ...
      return {
        ImportDefaultSpecifier: function () {function ImportDefaultSpecifier(node) {
            ...
            if (exportMap == null) {return;***REMOVED***
            ...
            ***REMOVED***
            ...
            fileImports.set(node.local.name, {
              exportMap: exportMap,
              sourcePath: declaration.source.value ***REMOVED***);

          ***REMOVED***return ImportDefaultSpecifier;***REMOVED***(),
        ...
        VariableDeclarator: function () {function VariableDeclarator(node) {
            ...
            if (!isDestructure) {return;***REMOVED***
            ...
            var objectName = node.init.name;var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
              for (var _iterator = node.id.properties[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var _ref = _step.value;var key = _ref.key;
                if (key == null) {continue;***REMOVED*** // true for rest properties
        ...
        'Program:exit': function () {function ProgramExit() {
            allPropertyLookups.forEach(function (lookups, objectName) {
              ...
              if (fileImport == null) {return;***REMOVED***var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
                ...
                for (var _iterator2 = lookups[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var _ref2 = _step2.value;var propName = _ref2.propName,node = _ref2.node;
                  ...
                  if (propName === 'default') {continue;***REMOVED***
                  if (!fileImport.exportMap.namespace.has(propName)) {continue;***REMOVED***

                  context.report({
                    node: node,
                    message: 'Caution: `' + String(objectName) + '` also has a named export `' + String(propName) + '`. Check if you meant to write `import {' + String(propName) + '***REMOVED*** from \'' + String(fileImport.sourcePath) + '\'` instead.' ***REMOVED***);
