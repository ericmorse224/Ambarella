...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-named-as-default') ***REMOVED***,
  ...
  create: function () {function create(context) {
      function checkDefault(nameKey, defaultSpecifier) {
        /**
                                                         * For ImportDefaultSpecifier we're interested in the "local" name (`foo` for `import {bar as foo***REMOVED*** ...`)
                                                         * For ExportDefaultSpecifier we're interested in the "exported" name (`foo` for `export {bar as foo***REMOVED*** ...`)
                                                         */
        var analyzedName = defaultSpecifier[nameKey].name;

        // #566: default is a valid specifier
        if (analyzedName === 'default') {return;***REMOVED***

        var declaration = (0, _importDeclaration2['default'])(context, defaultSpecifier);
        /** @type {import('../exportMap').default | null***REMOVED*** */
        var importedModule = _builder2['default'].get(declaration.source.value, context);
        if (importedModule == null) {return;***REMOVED***
      ...
      ***REMOVED***
      ...
      return {
        ...
        ExportDefaultSpecifier: checkDefault.bind(null, 'exported') ***REMOVED***;
