 ...
 */
export declare function openDB<DBTypes extends DBSchema | unknown = unknown>(name: string, version?: number, { blocked, upgrade, blocking, terminated ***REMOVED***?: OpenDBCallbacks<DBTypes>): Promise<IDBPDatabase<DBTypes>>;
 ...
 * @param name Name of the database.
 */
export declare function deleteDB(name: string, { blocked ***REMOVED***?: DeleteDBCallbacks): Promise<void>;
export { unwrap, wrap ***REMOVED*** from './wrap-idb-value.js';
