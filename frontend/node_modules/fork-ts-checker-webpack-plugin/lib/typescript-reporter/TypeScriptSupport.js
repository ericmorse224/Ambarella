...
function assertTypeScriptSupport(configuration) {
    ...
    ***REMOVED***
    if (semver.lt(typescriptVersion, '2.7.0')) {
        throw new Error([
            `ForkTsCheckerWebpackPlugin cannot use the current typescript version of ${typescriptVersion***REMOVED***.`,
            'The minimum required version is 2.7.0.',
        ].join(os_1.default.EOL));
    ***REMOVED***
    if (configuration.build && semver.lt(typescriptVersion, '3.6.0')) {
        throw new Error([
            `ForkTsCheckerWebpackPlugin cannot use the current typescript version of ${typescriptVersion***REMOVED*** because of the "build" option enabled.`,
    ...
    ***REMOVED***
    if (!fs_extra_1.default.existsSync(configuration.configFile)) {
        throw new Error([
            `Cannot find the "${configuration.configFile***REMOVED***" file.`,
