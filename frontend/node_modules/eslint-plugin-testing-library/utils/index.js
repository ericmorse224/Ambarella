...
const combineQueries = (variants, methods) => {
    ...
    variants.forEach((variant) => {
        ...
        methods.forEach((method) => {
            combinedQueries.push(`${variantPrefix***REMOVED***${method***REMOVED***`);
        ***REMOVED***);
    ***REMOVED***);
    return combinedQueries;
***REMOVED***;
exports.combineQueries = combineQueries;
const getDocsUrl = (ruleName) => `https://github.com/testing-library/eslint-plugin-testing-library/tree/main/docs/rules/${ruleName***REMOVED***.md`;
