...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('named') ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      function checkSpecifiers(key, type, node) {
        ...
        ***REMOVED***
        ...
        if (!node.specifiers.some(function (im) {return im.type === type;***REMOVED***)) {
          ...
          ***REMOVED***
          ...
          if (!deepLookup.found) {
            if (deepLookup.path.length > 1) {
              ...
              map(function (i) {return path.relative(path.dirname((0, _contextCompat.getPhysicalFilename)(context)), i.path);***REMOVED***).
              join(' -> ');
        ...
        variableImports.forEach(function (im) {
          ...
          ***REMOVED***
          ...
          if (!deepLookup.found) {
            if (deepLookup.path.length > 1) {
              var deepPath = deepLookup.path.
              map(function (i) {return path.relative(path.dirname((0, _contextCompat.getFilename)(context)), i.path);***REMOVED***).
              join(' -> ');
      ...
      ***REMOVED***
      ...
      return {
        ...
        VariableDeclarator: checkRequire ***REMOVED***;
