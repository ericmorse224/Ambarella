...
const webPolyfills = {
  "web.timers": {***REMOVED***,
  "web.immediate": {***REMOVED***,
  "web.dom.iterable": {***REMOVED***
***REMOVED***;
const purePolyfills = {
  "es6.parse-float": {***REMOVED***,
  "es6.parse-int": {***REMOVED***,
  "es7.string.at": {***REMOVED***
***REMOVED***;
...
function hasMinVersion(minVersion, runtimeVersion) {
  ...
  if (semver.valid(runtimeVersion)) runtimeVersion = `^${runtimeVersion***REMOVED***`;
  return !semver.intersects(`<${minVersion***REMOVED***`, runtimeVersion) && !semver.intersects(`>=8.0.0`, runtimeVersion);
***REMOVED***
...
***REMOVED***) {
  ...
  ***REMOVED*** = api;
  ...
  const coreJSBase = useBabelRuntime ? `${BABEL_RUNTIME***REMOVED***/core-js` : method === "usage-pure" ? "core-js/library/fn" : "core-js/modules";
  function inject(name, utils) {
    if (typeof name === "string") {
      ...
      if (has(polyfills, name) && shouldInjectPolyfill(name)) {
        debug(name);
        utils.injectGlobalImport(`${coreJSBase***REMOVED***/${name***REMOVED***.js`);
      ***REMOVED***
      return;
    ***REMOVED***
  ...
  ***REMOVED***
  function maybeInjectPure(desc, hint, utils) {
    ...
    ***REMOVED***
    ...
    return utils.injectDefaultImport(`${coreJSBase***REMOVED***/${pure***REMOVED***${ext***REMOVED***`, hint);
  ***REMOVED***
  return {
    name: "corejs2",
    ...
    usagePure(meta, utils, path) {
      if (meta.kind === "in") {
        if (meta.key === "Symbol.iterator") {
          path.replaceWith(t.callExpression(utils.injectDefaultImport(`${coreJSBase***REMOVED***/is-iterable${ext***REMOVED***`, "isIterable"), [path.node.right] // meta.kind === "in" narrows this
          ));
        ***REMOVED***
      ...
      ***REMOVED***)) return;
      if (meta.kind === "property") {
        ...
        if (meta.key === "Symbol.iterator" && shouldInjectPolyfill("es6.symbol") && path.parentPath.isCallExpression({
          callee: path.node
        ***REMOVED***) && path.parentPath.node.arguments.length === 0) {
          path.parentPath.replaceWith(t.callExpression(utils.injectDefaultImport(`${coreJSBase***REMOVED***/get-iterator${ext***REMOVED***`, "getIterator"), [path.node.object]));
          path.skip();
          return;
        ***REMOVED***
      ***REMOVED***
