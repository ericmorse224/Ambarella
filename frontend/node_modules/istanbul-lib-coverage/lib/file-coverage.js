...
const keyFromLoc = ({ start, end ***REMOVED***) =>
    `${start.line***REMOVED***|${start.column***REMOVED***|${end.line***REMOVED***|${end.column***REMOVED***`;
...
const addHits = (aHits, bHits) => {
    if (typeof aHits === 'number' && typeof bHits === 'number') {
        return aHits + bHits;
    ***REMOVED*** else if (Array.isArray(aHits) && Array.isArray(bHits)) {
...
class FileCoverage {
    /**
     * @constructor
     * @param {Object|FileCoverage|String***REMOVED*** pathOrObj is a string that initializes
    ...
    constructor(pathOrObj, reportLogic = false) {
        ...
        ***REMOVED*** else if (pathOrObj instanceof FileCoverage) {
            this.data = pathOrObj.data;
        ***REMOVED*** else if (typeof pathOrObj === 'object') {
            this.data = pathOrObj;
        ***REMOVED*** else {
    ...
    getLineCoverage() {
        ...
        Object.entries(statements).forEach(([st, count]) => {
            ...
            if (!statementMap[st]) {
                return;
            ***REMOVED***
            const { line ***REMOVED*** = statementMap[st].start;
    ...
    ***REMOVED***
     ...
     * @returns {Array***REMOVED*** an array of line numbers for which no hits have been
     *  collected.
     */
    getUncoveredLines() {
    ...
    ***REMOVED***
     ...
     * @returns {Object***REMOVED*** an object keyed by line number. Each object
    ...
    ***REMOVED***
     ...
     * @param {FileCoverage***REMOVED*** other - the coverage object to be merged into this one.
    ...
    ***REMOVED***
    ...
    computeBranchTotals(property) {
        ...
        const ret = { total: 0, covered: 0, skipped: 0 ***REMOVED***;
