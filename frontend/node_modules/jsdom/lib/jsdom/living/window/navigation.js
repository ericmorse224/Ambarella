...
exports.navigate = (window, newURL, flags) => {
  ...
  ***REMOVED***
  ...
  if (!flags.reloadTriggered && urlEquals(currentURL, newURL, { excludeFragments: true ***REMOVED***)) {
...
function navigateToFragment(window, newURL, flags) {
  ...
  ***REMOVED***
  const newEntry = { document, url: newURL ***REMOVED***;
  window._sessionHistory.addEntryAfterCurrentEntry(newEntry);
  window._sessionHistory.traverseHistory(newEntry, { nonBlockingEvents: true, replacement: flags.replacement ***REMOVED***);
***REMOVED***
