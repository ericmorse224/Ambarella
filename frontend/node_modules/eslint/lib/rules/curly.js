    ...
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            ...
            missingCurlyAfterCondition: "Expected { after '{{name***REMOVED******REMOVED***' condition.",
            unexpectedCurlyAfter: "Unnecessary { after '{{name***REMOVED******REMOVED***'.",
            unexpectedCurlyAfterCondition: "Unnecessary { after '{{name***REMOVED******REMOVED***' condition."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
        ...
        ***REMOVED***
         ...
         *        else
         *            bar();
         * @param {ASTNode***REMOVED*** node Node representing the code to check.
                        ...
                        if (this.expected) {
                            context.report({
                                ...
                                data: {
                                    name
                                ***REMOVED***,
                                fix: fixer => fixer.replaceText(body, `{${sourceCode.getText(body)***REMOVED******REMOVED***`)
                            ***REMOVED***);
                        ***REMOVED*** else {
                            context.report({
                                node,
                                ...
                                ***REMOVED***,
                                fix(fixer) {
                                    ...
                                    const needsPrecedingSpace = node.type === "DoWhileStatement" &&
                                        ...
                                        !astUtils.canTokensBeAdjacent("do", sourceCode.getFirstToken(body, { skip: 1 ***REMOVED***));
        ...
        ***REMOVED***
        ...
        function prepareIfChecks(node) {
            ...
            for (let currentNode = node; currentNode; currentNode = currentNode.alternate) {
                preparedChecks.push(prepareCheck(currentNode, currentNode.consequent, "if", { condition: true ***REMOVED***));
        ...
        ***REMOVED***
        ...
        return {
            ...
            ***REMOVED***,
            ...
            WhileStatement(node) {
                prepareCheck(node, node.body, "while", { condition: true ***REMOVED***).check();
            ***REMOVED***,
            ...
            ***REMOVED***,
            ...
            ForStatement(node) {
                prepareCheck(node, node.body, "for", { condition: true ***REMOVED***).check();
            ***REMOVED***,
