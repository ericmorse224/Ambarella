...
function detach(value) {
  ...
  ***REMOVED***
  ...
  throw new TypeError(`jsdom internal error: detaching object of wrong type ${value***REMOVED***`);
***REMOVED***
...
function attach(value, listObject) {
  ...
  ***REMOVED***
  ...
  throw new TypeError(`jsdom internal error: attaching object of wrong type ${value***REMOVED***`);
***REMOVED***
