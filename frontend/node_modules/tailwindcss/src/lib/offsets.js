...
import { remapBitfield ***REMOVED*** from './remap-bitfield.js'

/**
 * @typedef {'base' | 'defaults' | 'components' | 'utilities' | 'variants' | 'user'***REMOVED*** Layer
 */

/**
 * @typedef {object***REMOVED*** VariantOption
 * @property {number***REMOVED*** id An unique identifier to identify `matchVariant`
 * @property {function | undefined***REMOVED*** sort The sort function
 * @property {string|null***REMOVED*** value The value we want to compare
 * @property {string|null***REMOVED*** modifier The modifier that was used (if any)
 * @property {bigint***REMOVED*** variant The variant bitmask
 */

/**
 * @typedef {object***REMOVED*** RuleOffset
 * @property {Layer***REMOVED*** layer The layer that this rule belongs to
 * @property {Layer***REMOVED*** parentLayer The layer that this rule originally belonged to. Only different from layer if this is a variant.
 * @property {bigint***REMOVED*** arbitrary 0n if false, 1n if true
 * @property {bigint***REMOVED*** variants Dynamic size. 1 bit per registered variant. 0n means no variants
 * @property {bigint***REMOVED*** parallelIndex Rule index for the parallel variant. 0 if not applicable.
 * @property {bigint***REMOVED*** index Index of the rule / utility in its given *parent* layer. Monotonically increasing.
 * @property {bigint***REMOVED*** propertyOffset Offset for the arbitrary property. Only valid after sorting.
 * @property {string***REMOVED*** property Name/Value of the arbitrary property.
 * @property {VariantOption[]***REMOVED*** options Some information on how we can sort arbitrary variants
 */
