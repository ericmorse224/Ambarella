...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			mutable:
				"Value of '{{name***REMOVED******REMOVED***' may be overwritten in IE 8 and earlier.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {string***REMOVED*** name parameter name
		 * @returns {boolean***REMOVED*** True is its been shadowed
		 */
				...
				***REMOVED***
				...
				if (paramIsShadowing(scope, node.param.name)) {
					context.report({
						node,
						messageId: "mutable",
						data: { name: node.param.name ***REMOVED***,
					***REMOVED***);
				***REMOVED***
			***REMOVED***,
		***REMOVED***;
