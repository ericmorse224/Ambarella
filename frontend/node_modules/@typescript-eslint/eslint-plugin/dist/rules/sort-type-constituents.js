...
function getGroup(node) {
    switch (node.type) {
        ...
        case utils_1.AST_NODE_TYPES.TSTypePredicate:
            ...
            throw new Error(`Unexpected Type ${node.type***REMOVED***`);
    ***REMOVED***
***REMOVED***
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        ...
        hasSuggestions: true,
        messages: {
            notSorted: '{{type***REMOVED******REMOVED*** type constituents must be sorted.',
            notSortedNamed: '{{type***REMOVED******REMOVED*** type {{name***REMOVED******REMOVED*** constituents must be sorted.',
    ...
    ***REMOVED***,
    ...
    create(context, [{ checkIntersections, checkUnions, groupOrder ***REMOVED***]) {
        ...
        ***REMOVED***);
        function checkSorting(node) {
            ...
            ***REMOVED***
        ***REMOVED***
        return Object.assign(Object.assign({***REMOVED***, (checkIntersections && {
