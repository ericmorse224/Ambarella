 ...
 * @param {Scope***REMOVED*** scope Scope to which the node belongs.
 * @param {string***REMOVED*** objectName Name of the global object.
 * @param {string***REMOVED*** methodName Name of the method.
 * @param {number***REMOVED*** index The given position.
 * @returns {boolean***REMOVED*** `true` if the node is argument at the given position.
 */
 ...
 * @param {ASTNode***REMOVED*** node The node to check.
 * @param {Scope***REMOVED*** scope Scope to which the node belongs.
 * @returns {boolean***REMOVED*** `true` if the node is a setter.
 */
		...
		return {
			...
			ArrowFunctionExpression(node) {
				...
				if (funcInfo.isSetter && node.expression) {
					// { set: foo => bar ***REMOVED*** property descriptor. Report implicit return 'bar' as the equivalent for a return statement.
					report(node.body);
				***REMOVED***
			***REMOVED***,
