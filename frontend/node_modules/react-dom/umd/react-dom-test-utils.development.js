...
(function (global, factory) {
  ...
  (global = global || self, factory(global.ReactTestUtils = {***REMOVED***, global.React, global.ReactDOM));
***REMOVED***(this, (function (exports, React, ReactDOM) { 'use strict';
  ...
  ***REMOVED***;
  ...
  function flushWorkAndMicroTasks(onDone) {
    ...
    ***REMOVED*** catch (err) {
      onDone(err);
    ***REMOVED***
  ***REMOVED*** // we track the 'depth' of the act() calls with this counter,
    ...
    if (result !== null && typeof result === 'object' && typeof result.then === 'function') {
...

      {
        if (typeof Promise !== 'undefined') {
          ...
          Promise.resolve().then(function () {***REMOVED***).then(function () {
            if (called === false) {
              error('You called act(async () => ...) without await. ' + 'This could lead to unexpected testing behaviour, interleaving multiple act ' + 'calls and mixing their scopes. You should - await act(async () => ...);');
            ***REMOVED***
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED*** // in the async case, the returned thenable runs the callback, flushes
        ...
        then: function (resolve, reject) {
          ...
          result.then(function () {
            if (actingUpdatesScopeDepth > 1 || isSchedulerMocked === true && previousIsSomeRendererActing === true) {
              ...
              resolve();
              return;
            ***REMOVED*** // we're about to exit the act() scope,
    ...
    ***REMOVED*** else {
      {
        ...
        ***REMOVED***
      ***REMOVED*** // flush effects until none remain, and cleanup
      ...
      ***REMOVED*** catch (err) {
        onDone();
        throw err;
      ***REMOVED*** // in the sync case, the returned thenable only warns *if* await-ed
    ...
    ***REMOVED***
    ...
    var unwind = function () {
...

      {
        ...
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***; // TODO: This would be way simpler if 1) we required a promise to be
  ...
  function validateClassInstance(inst, methodName) {
    ...
    ***REMOVED***
    ...
    if (Array.isArray(inst)) {
      received = 'an array';
    ***REMOVED*** else if (inst && inst.nodeType === ELEMENT_NODE && inst.tagName) {
      received = 'a DOM node';
    ***REMOVED*** else if (stringified === '[object Object]') {
      received = 'object with keys {' + Object.keys(inst).join(', ') + '***REMOVED***';
    ***REMOVED*** else {
  ...
  ***REMOVED***
   ...
   * @return {array***REMOVED*** an array of all the matches.
   */
  ...
  ***REMOVED***
   ...
   * @return {!ReactDOMComponent***REMOVED*** The one match.
   */
  ...
  ***REMOVED***
   ...
   * and returns that one result, or throws exception if there is any other
   * number of matches besides one.
   * @return {!ReactComponent***REMOVED*** The one match.
   */
  ...
  ***REMOVED***
   ...
   *
   * @param {object***REMOVED*** module the mock function object exported from a
   *                        module that defines the component to be mocked
   * @param {?string***REMOVED*** mockTagName optional dummy root tag name to return
   *                              from render method (overrides
   *                              module.mockTagName if provided)
   * @return {object***REMOVED*** the ReactTestUtils object (for chaining)
   */
  ...
  ***REMOVED***
  ...
  function nativeTouchData(x, y) {
    return {
      ...
      ***REMOVED***]
    ***REMOVED***;
  ***REMOVED*** // Start of inline: the below functions were inlined from
  // EventPropagator.js, as they deviated from ReactDOM's newer
  // implementations.

  /**
   * Dispatch the event to the listener.
   * @param {SyntheticEvent***REMOVED*** event SyntheticEvent to handle
   * @param {function***REMOVED*** listener Application-level callback
   * @param {****REMOVED*** inst Internal component instance
   */
    ...
    if (Array.isArray(dispatchListeners)) {
      for (var i = 0; i < dispatchListeners.length; i++) {
        if (event.isPropagationStopped()) {
          break;
        ***REMOVED*** // Listeners and Instances are two parallel arrays that are always in sync.


        executeDispatch(event, dispatchListeners[i], dispatchInstances[i]);
      ***REMOVED***
    ***REMOVED*** else if (dispatchListeners) {
  ...
  ***REMOVED***
   ...
   *
   * @param {?object***REMOVED*** event Synthetic event to be dispatched.
   * @private
   */
  ...
  ***REMOVED***
  ...
  function accumulateTwoPhaseDispatchesSingle(event) {
    ...
    ***REMOVED***
  ***REMOVED*** // End of inline


  var Simulate = {***REMOVED***;
  ...
  function makeSimulator(eventType) {
    ...
    ***REMOVED***;
  ***REMOVED*** // A one-time snapshot with no plans to update. We'll probably want to deprecate Simulate API.
