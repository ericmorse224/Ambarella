...
function $() {
  ...
  ***REMOVED***, _ = s - c, h = Math.floor, I = String.fromCharCode;
  function v(a) {
...
const A = /* @__PURE__ */ U(J), K = [
  ...
  (e, s) => {
    ...
    if (e.has(o))
      throw new Error(`Multiple rules found for ${s***REMOVED*** (${o***REMOVED***)`);
    return e.set(o, {
      rule: s,
      suffix: c,
      punySuffix: o,
...
***REMOVED***, aa = (e) => e && O(e).domain || null, oa = (e) => {
  const s = O(e);
  return !!(s.domain && s.listed);
***REMOVED***, na = { parse: O, get: aa, isValid: oa ***REMOVED***;
export {
  na as default,
  Y as errorCodes,
  aa as get,
