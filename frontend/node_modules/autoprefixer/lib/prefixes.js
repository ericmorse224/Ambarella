...
class Prefixes {
  constructor(data, browsers, options = {***REMOVED***) {
    this.data = data
        ...
        if (other.type === 'decl') {
          ...
          ***REMOVED***
          ...
          if (this.unprefixed(other.prop) !== unprefixed) {
            break
          ***REMOVED*** else if (callback(other) === true) {
            return true
          ***REMOVED***
  ...
  preprocess(selected) {
    ...
    ***REMOVED***
    for (let name in selected.add) {
      ...
      ***REMOVED*** else if (name === '@resolution') {
        add[name] = new Resolution(name, prefixes, this)
      ***REMOVED*** else if (this.data[name].selector) {
    ...
    ***REMOVED***
    ...
    for (let name in selected.remove) {
      ...
      if (this.data[name].selector) {
        ...
        ***REMOVED***
      ***REMOVED*** else if (name === '@keyframes' || name === '@viewport') {
        for (let prefix of prefixes) {
          let prefixed = `@${prefix***REMOVED***${name.slice(1)***REMOVED***`
          remove[prefixed] = { remove: true ***REMOVED***
        ***REMOVED***
      ***REMOVED*** else if (name === '@resolution') {
            ...
            if (name === 'align-self') {
              ...
              if (a) {
                if (p === '-webkit- 2009' && a.includes('-webkit-')) {
                  continue
                ***REMOVED*** else if (p === '-webkit-' && a.includes('-webkit- 2009')) {
                  continue
                ***REMOVED***
              ***REMOVED***
            ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  select(list) {
    let selected = { add: {***REMOVED***, remove: {***REMOVED*** ***REMOVED***
    ...
    for (let name in list) {
      ...
      let add = data.browsers.map(i => {
        let params = i.split(' ')
        return {
          browser: `${params[0]***REMOVED*** ${params[1]***REMOVED***`,
          note: params[2]
        ***REMOVED***
      ***REMOVED***)
      ...
      let notes = add
        .filter(i => i.note)
        .map(i => `${this.browsers.prefix(i.browser)***REMOVED*** ${i.note***REMOVED***`)
      ...
      add = add
        ...
        .map(i => {
          ...
          if (i.note) {
            return `${prefix***REMOVED*** ${i.note***REMOVED***`
          ***REMOVED*** else {
            return prefix
          ***REMOVED***
        ***REMOVED***)
