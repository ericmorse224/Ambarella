...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('default') ***REMOVED***,
  ...
  create: function () {function create(context) {
      function checkDefault(specifierType, node) {
        ...
        function (specifier) {return specifier.type === specifierType;***REMOVED***);


        if (!defaultSpecifier) {return;***REMOVED***
        var imports = _builder2['default'].get(node.source.value, context);
        if (imports == null) {return;***REMOVED***

        if (imports.errors.length) {
          imports.reportErrors(context, node);
        ***REMOVED*** else if (imports.get('default') === undefined) {
          context.report({
            node: defaultSpecifier,
            message: 'No default export found in imported module "' + String(node.source.value) + '".' ***REMOVED***);
      ...
      ***REMOVED***
      ...
      return {
        ...
        ExportNamedDeclaration: checkDefault.bind(null, 'ExportDefaultSpecifier') ***REMOVED***;
