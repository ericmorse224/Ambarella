...
module.exports = (buffer, { transportLayerEncodingLabel, defaultEncoding = "windows-1252" ***REMOVED*** = {***REMOVED***) => {
    ...
    if (c === 0x3C) {
      ...
      if (c1 === 0x21 && c2 === 0x2D && c3 === 0x2D) {
        ...
        for (; i < l; i++) {
          ...
          ***REMOVED***
        ***REMOVED***
      ***REMOVED*** else if ((c1 === 0x4D || c1 === 0x6D) &&
         (c2 === 0x45 || c2 === 0x65) &&
         (c3 === 0x54 || c3 === 0x74) &&
         (c4 === 0x41 || c4 === 0x61) &&
        ...
        do {
          ...
          if (attrRes.attr && !attributeList.has(attrRes.attr.name)) {
            ...
            ***REMOVED*** else if (attrRes.attr.name === "content" && !charset) {
              charset = extractCharacterEncodingFromMeta(attrRes.attr.value);
              if (charset !== null) {
                needPragma = true;
              ***REMOVED***
            ***REMOVED*** else if (attrRes.attr.name === "charset") {
              charset = whatwgEncoding.labelToName(attrRes.attr.value);
              needPragma = false;
            ***REMOVED***
          ***REMOVED***
          i = attrRes.i;
        ***REMOVED*** while (attrRes.attr);
        ...
        ***REMOVED***
        ...
        return charset;
      ***REMOVED*** else if ((c1 >= 0x41 && c1 <= 0x5A) || (c1 >= 0x61 && c1 <= 0x7A)) {
        // a-z or A-Z
        for (i += 2; i < l; i++) {
          c = buffer[i];
          // space or >
        ...
        ***REMOVED***
        ...
        do {
          ...
          i = attrRes.i;
        ***REMOVED*** while (attrRes.attr);
      ***REMOVED*** else if (c1 === 0x21 || c1 === 0x2F || c1 === 0x3F) {
        // ! or / or ?
        for (i += 2; i < l; i++) {
          c = buffer[i];
          // >
      ...
      if (isSpaceCharacter(c)) {
        for (i++; i < l; i++) {
          ...
          ***REMOVED***
          // not "="
          if (c !== 0x3D) {
            return { attr: { name, value ***REMOVED***, i ***REMOVED***;
          ***REMOVED***
