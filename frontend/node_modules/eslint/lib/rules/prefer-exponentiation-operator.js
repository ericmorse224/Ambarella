...
const { CALL, ReferenceTracker ***REMOVED*** = require("eslint-utils");

//------------------------------------------------------------------------------
// Helpers
//------------------------------------------------------------------------------

const PRECEDENCE_OF_EXPONENTIATION_EXPR = astUtils.getPrecedence({ type: "BinaryExpression", operator: "**" ***REMOVED***);
                ...
                fix(fixer) {
                    ...
                    ***REMOVED***
                    ...
                    const baseReplacement = parenthesizeIfShould(baseText, shouldParenthesizeBase),
                        ...
                        replacement = parenthesizeIfShould(`${baseReplacement***REMOVED*****${exponentReplacement***REMOVED***`, shouldParenthesizeAll);
        ...
        return {
            Program() {
                ...
                ***REMOVED***;
                ...
                for (const { node ***REMOVED*** of tracker.iterateGlobalReferences(trackMap)) {
                    report(node);
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***;
