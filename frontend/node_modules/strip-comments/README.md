...
* `input` **{String***REMOVED*****: string from which to strip comments
* `options` **{Object***REMOVED*****: optional options, passed to [extract-comments](https://github.com/jonschlinkert/extract-comments)  

- `line` **{Boolean***REMOVED*****: if `false` strip only block comments, default `true`
- `block` **{Boolean***REMOVED*****: if `false` strip only line comments, default `true`
- `keepProtected` **{Boolean***REMOVED*****: Keep ignored comments (e.g. `/*!` and `//!`)
- `preserveNewlines` **{Boolean***REMOVED*****: Preserve newlines after comments are stripped
* `returns` **{String***REMOVED*****: modified input
...
* `input` **{String***REMOVED*****: string from which to strip comments
* `options` **{Object***REMOVED*****: pass `opts.keepProtected: true` to keep ignored comments (e.g. `/*!`)
* `returns` **{String***REMOVED*****: modified string
...
* `options` **{Object***REMOVED*****: pass `opts.keepProtected: true` to keep comments with `!`
* `returns` **{String***REMOVED*****

**Example**

```js
const output = strip.first(input, { keepProtected: true ***REMOVED***);
console.log(output);
// => '//! first comment\nfoo; '
```
