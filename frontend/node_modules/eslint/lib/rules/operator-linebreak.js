...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			operatorAtBeginning:
				"'{{operator***REMOVED******REMOVED***' should be placed at the beginning of the line.",
			operatorAtEnd:
				"'{{operator***REMOVED******REMOVED***' should be placed at the end of the line.",
			badLinebreak: "Bad line breaking before and after '{{operator***REMOVED******REMOVED***'.",
			noLinebreak:
				"There should be no line break before or after '{{operator***REMOVED******REMOVED***'.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		...
		const styleOverrides = options.overrides
			? Object.assign({***REMOVED***, options.overrides)
			: {***REMOVED***;
