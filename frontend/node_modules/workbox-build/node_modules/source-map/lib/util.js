...
const PROTOCOL = "http:";
const PROTOCOL_AND_HOST = `${PROTOCOL***REMOVED***//host`;
...
function createSafeHandler(cb) {
  return input => {
    ...
    if (type === "absolute") {
      return result;
    ***REMOVED*** else if (type === "scheme-relative") {
      return result.slice(PROTOCOL.length);
    ***REMOVED*** else if (type === "path-absolute") {
...
function buildSafeBase(str) {
  ...
  let base = `${PROTOCOL_AND_HOST***REMOVED***/`;
 ...
 * @return A normalized URL value.
 */
const normalize = createSafeHandler(url => {***REMOVED***);
