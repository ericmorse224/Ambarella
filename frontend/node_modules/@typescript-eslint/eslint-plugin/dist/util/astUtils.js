...
// Could be export { getNameLocationInGlobalDirectiveComment ***REMOVED*** from 'eslint/lib/rules/utils/ast-utils'
/**
...
function getNameLocationInGlobalDirectiveComment(sourceCode, comment, name) {
    const namePattern = new RegExp(`[\\s,]${(0, escapeRegExp_1.escapeRegExp)(name)***REMOVED***(?:$|[\\s,:])`, 'gu');
