...
class CoverageSummary {
    /**
     * @constructor
     * @param {Object|CoverageSummary***REMOVED*** [obj=undefined] an optional data object or
     * another coverage summary to initialize this object with.
     */
    constructor(obj) {
        if (!obj) {
            this.data = blankSummary();
        ***REMOVED*** else if (obj instanceof CoverageSummary) {
            this.data = obj.data;
        ***REMOVED*** else {
            this.data = obj;
        ***REMOVED***
    ...
    ***REMOVED***
     ...
     * @param {CoverageSummary***REMOVED*** obj - another coverage summary object
     */
    merge(obj) {
        const keys = [
            'lines',
