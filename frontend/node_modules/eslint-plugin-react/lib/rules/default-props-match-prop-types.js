...
const messages = {
  requiredHasDefault: 'defaultProp "{{name***REMOVED******REMOVED***" defined for isRequired propType.',
  defaultHasNoType: 'defaultProp "{{name***REMOVED******REMOVED***" has no corresponding propTypes declaration.',
***REMOVED***;
...
module.exports = {
  ...
  ***REMOVED***,
  ...
  create: Components.detect((context, components) => {
     ...
     * @param  {Object[]***REMOVED*** propTypes    Array of propTypes to check.
