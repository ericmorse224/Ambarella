...
;(function() {
  ...
  ***REMOVED***
  ...
  var assertTypeRegexMap = {***REMOVED***;
  ...
  ***REMOVED***
  ...
  function generateClassStrings(node) {
    ...
    return '\\q{' + generateSequence(generateClassString, node.strings, '|') + '***REMOVED***';
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  function generateQuantifier(node) {
    ...
    if (max == null) {
      if (min == 0) {
        quantifier = '*';
      ***REMOVED*** else if (min == 1) {
        quantifier = '+';
      ***REMOVED*** else {
        quantifier = '{' + min + ',***REMOVED***';
      ***REMOVED***
    ***REMOVED*** else if (min == max) {
      quantifier = '{' + min + '***REMOVED***';
    ***REMOVED*** else if (min == 0 && max == 1) {
      quantifier = '?';
    ***REMOVED*** else {
      quantifier = '{' + min + ',' + max + '***REMOVED***';
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  function generateUnicodePropertyEscape(node) {
    ...
    return '\\' + (node.negative ? 'P' : 'p') + '{' + node.value + '***REMOVED***';
  ***REMOVED***
