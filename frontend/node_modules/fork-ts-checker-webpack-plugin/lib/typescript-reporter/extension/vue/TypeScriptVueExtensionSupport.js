...
function assertTypeScriptVueExtensionSupport(configuration) {
    ...
    ***REMOVED***
        ...
        throw new Error([
            `Could not initialize '${compilerName***REMOVED***'. When you use 'typescript.extensions.vue' option, make sure to install '${compilerName***REMOVED***' and that the version matches that of 'vue'.`,
            `Error details: ${error.message***REMOVED***`,
        ].join('\n'));
    ***REMOVED***
***REMOVED***
