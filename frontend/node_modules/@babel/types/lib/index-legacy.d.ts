...
export interface TemplateElement extends BaseNode {
  ...
  value: { raw: string, cooked?: string ***REMOVED***;
  tail: boolean;
***REMOVED***
...
export { _super as super***REMOVED***
export function taggedTemplateExpression(tag: Expression, quasi: TemplateLiteral): TaggedTemplateExpression;
export function templateElement(value: { raw: string, cooked?: string ***REMOVED***, tail?: boolean): TemplateElement;
...
export { _import as import***REMOVED***
...
export function buildChildren(node: { children: ReadonlyArray<JSXText | JSXExpressionContainer | JSXSpreadChild | JSXElement | JSXFragment | JSXEmptyExpression> ***REMOVED***): JSXElement['children']
...
export function ensureBlock(node: Extract<Node, { body: BlockStatement | Statement | Expression ***REMOVED***>): BlockStatement
export function ensureBlock<K extends keyof Extract<Node, { body: BlockStatement | Statement | Expression ***REMOVED***> = 'body'>(node: Extract<Node, Record<K, BlockStatement | Statement | Expression>>, key: K): BlockStatement
export function toBindingIdentifierName(name: { toString(): string ***REMOVED*** | null | undefined): string
export function toBlock(node: Statement | Expression, parent?: Function | null): BlockStatement
export function toComputedKey<T extends Extract<Node, { computed: boolean | null ***REMOVED***>>(node: T, key?: Expression | Identifier): Expression
...
export function toIdentifier(name: { toString(): string ***REMOVED*** | null | undefined): string
export function toKeyAlias(node: Method | Property, key?: Node): string
export function toSequenceExpression(nodes: ReadonlyArray<Node>, scope: { push(value: { id: LVal; kind: 'var'; init?: Expression***REMOVED***): void; buildUndefinedNode(): Node ***REMOVED***): SequenceExpression | undefined
...
export function removeProperties(
  n: Node,
  opts?: { preserveComments: boolean ***REMOVED*** | null
): void;
...
export function is<T extends Node['type']>(type: T, n: Node | null | undefined, required?: undefined): n is Extract<Node, { type: T ***REMOVED***>
export function is<T extends Node['type'], P extends Extract<Node, { type: T ***REMOVED***>>(type: T, n: Node | null | undefined, required: Partial<P>): n is P
