...
export type Config = {
    type: "element";
***REMOVED*** & import("../../types/rules/jsx-no-literals").ElementConfigProperties & import("../../types/rules/jsx-no-literals").ElementOverrides;
...
export type ElementConfig = {
    type: "element";
***REMOVED*** & import("../../types/rules/jsx-no-literals").ElementConfigProperties;
