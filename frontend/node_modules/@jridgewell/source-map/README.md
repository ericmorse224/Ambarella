...
```typescript
import { SourceMapConsumer ***REMOVED*** from '@jridgewell/source-map';
...
smc.originalPositionFor({ line: 1, column: 0 ***REMOVED***);
```
...
```typescript
const smc = new SourceMapConsumer(map);
smc.allGeneratedpositionsfor({ line: 1, column: 5, source: "baz.ts" ***REMOVED***);
// [
//   { line: 2, column: 8 ***REMOVED***
// ]
```
...
```typescript
const smc = new SourceMapConsumer(map);
smc.generatedPositionFor({ line: 1, column: 5, source: "baz.ts" ***REMOVED***);
// { line: 2, column: 8 ***REMOVED***
```
...
```typescript
import { SourceMapGenerator ***REMOVED*** from '@jridgewell/source-map';
const smg = new SourceMapGenerator({
  file: 'output.js',
...
const smg = new SourceMapGenerator();
smg.addMapping({
  generated: { line: 1, column: 0 ***REMOVED***,
  source: 'input.js',
  original: { line: 1, column: 0 ***REMOVED***,
  name: 'foo',
***REMOVED***);
```
...
```typescript
const smg = new SourceMapGenerator();
smg.toJSON(); // { version: 3, names: [], sources: [], mappings: '' ***REMOVED***
```
...
```typescript
const smg = new SourceMapGenerator();
smg.toDecodedMap(); // { version: 3, names: [], sources: [], mappings: [] ***REMOVED***
```
