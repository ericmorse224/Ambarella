    ...
    ***REMOVED***,
    ...
    create(context) {
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node the node
         * @returns {boolean***REMOVED*** if the node is a logical expression and option is enabled
         */
                        ...
                        fix(fixer) {
                            ...
                            ***REMOVED***
                            ...
                            if (needsParens(parent, node.argument)) {
                                return fixer.replaceText(parent, `(${sourceCode.getText(node.argument)***REMOVED***)`);
                            ***REMOVED***
                            ...
                            if (node.arguments.length === 1) {
                                ...
                                ***REMOVED***
                                ...
                                if (needsParens(node, argument)) {
                                    return fixer.replaceText(node, `(${sourceCode.getText(argument)***REMOVED***)`);
                                ***REMOVED***
