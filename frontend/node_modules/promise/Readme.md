...
var first = new Promise(function (resolve){ setTimeout(resolve, 100, 'quick') ***REMOVED***);
var second = new Promise(function (resolve){ setTimeout(resolve, 500, 'slow') ***REMOVED***);
...
Promise.allSettled([Promise.resolve('a'), Promise.reject('error'), Promise.resolve('c')])
  .then(function (res) {
    res[0] // { status: "fulfilled", value: 'a' ***REMOVED***
    res[1] // { status: "rejected", reason: 'error' ***REMOVED***
    res[2] // { status: "fulfilled", value: 'c' ***REMOVED***
  ***REMOVED***)
```
