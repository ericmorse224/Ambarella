...
If `{ amd: true ***REMOVED***` is provided, dependency paths for AMD-style `define` and `require`
calls will be resolved:

```js
/*eslint import/no-absolute-path: [2, { commonjs: false, amd: true ***REMOVED***]*/
define(['/foo'], function (foo) { /*...*/ ***REMOVED***) // reported
require(['/foo'], function (foo) { /*...*/ ***REMOVED***) // reported
