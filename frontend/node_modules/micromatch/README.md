...
* [brace expansion](https://github.com/micromatch/braces) (`foo/{1..5***REMOVED***.md`, `bar/{a,b,c***REMOVED***.js`)
...
* `list` **{String|Array<string>***REMOVED*****: List of strings to match.
* `patterns` **{String|Array<string>***REMOVED*****: One or more glob patterns to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options)
* `returns` **{Array***REMOVED*****: Returns an array of matches
...
* `pattern` **{String***REMOVED*****: Glob pattern
* `options` **{Object***REMOVED*****
* `returns` **{Function***REMOVED*****: Returns a matcher function.
...
* `str` **{String***REMOVED*****: The string to test.
* `patterns` **{String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `[options]` **{Object***REMOVED*****: See available [options](#options).
* `returns` **{Boolean***REMOVED*****: Returns true if any patterns match `str`
...
* `list` **{Array***REMOVED*****: Array of strings to match.
* `patterns` **{String|Array***REMOVED*****: One or more glob pattern to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Array***REMOVED*****: Returns an array of strings that **do not match** the given patterns.
...
* `str` **{String***REMOVED*****: The string to match.
* `patterns` **{String|Array***REMOVED*****: Glob pattern to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Boolean***REMOVED*****: Returns true if any of the patterns matches any part of `str`.
...
* `object` **{Object***REMOVED*****: The object with keys to filter.
* `patterns` **{String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Object***REMOVED*****: Returns an object with only keys that match the given patterns.
...
const obj = { aa: 'a', ab: 'b', ac: 'c' ***REMOVED***;
...
* `list` **{String|Array***REMOVED*****: The string or array of strings to test. Returns as soon as the first match is found.
* `patterns` **{String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Boolean***REMOVED*****: Returns true if any `patterns` matches any of the strings in `list`
...
* `list` **{String|Array***REMOVED*****: The string or array of strings to test.
* `patterns` **{String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Boolean***REMOVED*****: Returns true if all `patterns` matches all of the strings in `list`
...
* `str` **{String|Array***REMOVED*****: The string to test.
* `patterns` **{String|Array***REMOVED*****: One or more glob patterns to use for matching.
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Boolean***REMOVED*****: Returns true if any patterns match `str`
...
* `glob` **{String***REMOVED*****: Glob pattern to use for matching.
* `input` **{String***REMOVED*****: String to match
* `options` **{Object***REMOVED*****: See available [options](#options) for changing how matches are performed
* `returns` **{Array|null***REMOVED*****: Returns an array of captures if the input matches the glob pattern, otherwise `null`.
...
* `pattern` **{String***REMOVED*****: A glob pattern to convert to regex.
* `options` **{Object***REMOVED*****
* `returns` **{RegExp***REMOVED*****: Returns a regex created from the given pattern.
...
* `pattern` **{String***REMOVED*****
* `options` **{Object***REMOVED*****
* `returns` **{Object***REMOVED*****: Returns an object with
...
* `glob` **{String***REMOVED*****
* `options` **{Object***REMOVED*****
* `returns` **{Object***REMOVED*****: Returns an object with useful properties and output to be used as regex source string.
...
* `pattern` **{String***REMOVED*****: String with brace pattern to process.
* `options` **{Object***REMOVED*****: Any [options](#options) to change how expansion is performed. See the [braces](https://github.com/micromatch/braces) library for all available options.
* `returns` **{Array***REMOVED*****

**Example**

```js
const { braces ***REMOVED*** = require('micromatch');
console.log(braces('foo/{a,b,c***REMOVED***/bar'));
//=> [ 'foo/(a|b|c)/bar' ]

console.log(braces('foo/{a,b,c***REMOVED***/bar', { expand: true ***REMOVED***));
...
| `nobrace`             | `boolean`      | `false`     | Disable brace matching, so that `{a,b***REMOVED***` and `{1..3***REMOVED***` would be treated as literal characters. |
...
| `noquantifiers`       | `boolean`      | `false`     | Disable support for regex quantifiers (like `a{1,2***REMOVED***`) and treat them as brace patterns to be expanded. |
...
micromatch(['a/b.js', 'a/c.md'], '*.js', { basename: true ***REMOVED***);
//=> ['a/b.js']
```
...
console.log(micromatch(files, '[a-c]*', { bash: false ***REMOVED***));
```
...
const regex = micromatch.makeRe('foo/{01..25***REMOVED***/bar', {
  expandRange(a, b) {
    return `(${fill(a, b, { toRegex: true ***REMOVED***)***REMOVED***)`;
  ***REMOVED***
***REMOVED***);
...
const isMatch = picomatch('foo/*.js', { format ***REMOVED***);
...
```js
const isMatch = micromatch.matcher('*', { ignore: 'f*' ***REMOVED***);
...
console.log(micromatch(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)', { noextglob: true ***REMOVED***));
...
micromatch(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**', {noglobstar: true***REMOVED***);
//=> ['a/b']
```
...
```js
const onIgnore = ({ glob, regex, input, output ***REMOVED***) => {
  console.log({ glob, regex, input, output ***REMOVED***);
  // { glob: '*', regex: /^(?:(?!\.)(?=.)[^\/]*?\/?)$/, input: 'foo', output: 'foo' ***REMOVED***
***REMOVED***;

const isMatch = micromatch.matcher('*', { onIgnore, ignore: 'f*' ***REMOVED***);
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
```js
const onMatch = ({ glob, regex, input, output ***REMOVED***) => {
  console.log({ input, output ***REMOVED***);
  // { input: 'some\\path', output: 'some/path' ***REMOVED***
  // { input: 'some\\path', output: 'some/path' ***REMOVED***
  // { input: 'some\\path', output: 'some/path' ***REMOVED***
***REMOVED***;

const isMatch = micromatch.matcher('**', { onMatch, posixSlashes: true ***REMOVED***);
isMatch('some\\path');
isMatch('some\\path');
isMatch('some\\path');
```
...
```js
const onResult = ({ glob, regex, input, output ***REMOVED***) => {
  console.log({ glob, regex, input, output ***REMOVED***);
***REMOVED***;

const isMatch = micromatch('*', { onResult, ignore: 'f*' ***REMOVED***);
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
console.log(micromatch.match(['a\\b\\c'], { posixSlashes: false ***REMOVED***));
//=> ['a\\b\\c']
```
...
console.log(micromatch.match(['abc', 'a\\*c'], 'a\\*c', { unescape: true ***REMOVED***));
//=> ['a*c']
```
...
The pattern `{f,b***REMOVED****/{1..3***REMOVED***/{b,q***REMOVED****` would match any of following strings:
