 ...
 * @property {boolean***REMOVED*** [reportUnusedDisableDirectives] `true` adds reports for unused eslint-disable directives
 ...
 * @param {boolean***REMOVED*** config.reportUnusedDisableDirectives If `true` then it reports unused `eslint-disable` comments.
...
class CLIEngine {
    ...
    ***REMOVED***
     ...
     * @param {string***REMOVED*** name Name of the plugin.
     * @param {Plugin***REMOVED*** pluginObject Plugin configuration object.
     * @returns {void***REMOVED***
     */
    ...
    ***REMOVED***
     ...
     *      custom formatter.
     * @returns {(Function|null)***REMOVED*** The formatter function or null if the `format` is not a string.
     */
    getFormatter(format) {
