...
// ES7 proposal
export { foo as bar ***REMOVED*** from './foo'

// node_modules without jsnext:main are not analyzed by default
// (import/ignore setting)
import { SomeNonsenseThatDoesntExist ***REMOVED*** from 'react'
```
...
```js
// ./baz.js
import { notFoo ***REMOVED*** from './foo'

// ES7 proposal
export { notFoo as defNotBar ***REMOVED*** from './foo'

// will follow 'jsnext:main', if available
import { dontCreateStore ***REMOVED*** from 'redux'
```
...
import { notWhatever ***REMOVED*** from './whatever'
```
