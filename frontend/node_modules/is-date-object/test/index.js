...
test('not Dates', function (t) {
	...
	t.notOk(isDate({***REMOVED***), 'object is not Date');
	t.notOk(isDate(function () {***REMOVED***), 'function is not Date');
...
test('@@toStringTag', { skip: !hasToStringTag ***REMOVED***, function (t) {
	...
	var fakeDate = {
		toString: function () { return String(realDate); ***REMOVED***,
		valueOf: function () { return realDate.getTime(); ***REMOVED***
	***REMOVED***;
