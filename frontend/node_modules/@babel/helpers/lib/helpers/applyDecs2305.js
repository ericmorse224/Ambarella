  ...
  function applyDec(Class, decInfo, decoratorsHaveThis, name, kind, metadata, initializers, ret, isStatic, isPrivate, isField, isAccessor, hasPrivateBrand) {
    ...
    ***REMOVED***
    ...
    for (var i = decs.length - 1; i >= 0; i -= decoratorsHaveThis ? 2 : 1) {
      ...
      var decoratorFinishedRef = {***REMOVED***;
      var ctx = {
        ...
        ***REMOVED***.bind(null, decoratorFinishedRef)
      ***REMOVED***;
      try {
        if (isClass) {
            ...
            if (typeof newValue === "object" && newValue) {
              ...
              ***REMOVED***
              if (_ = assertCallable(newValue.init, "accessor.init")) {
                init.push(_);
              ***REMOVED***
            ***REMOVED*** else if (newValue !== void 0) {
              throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");
            ***REMOVED***
          ***REMOVED*** else if (assertCallable(newValue, (isField ? "field" : "method") + " decorators", "return")) {
            if (isField) {
              init.push(newValue);
            ***REMOVED*** else {
              desc[key] = newValue;
