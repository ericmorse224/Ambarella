...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			unexpectedBefore:
				"Unexpected space before unary operator '{{operator***REMOVED******REMOVED***'.",
			unexpectedAfter:
				"Unexpected space after unary operator '{{operator***REMOVED******REMOVED***'.",
			unexpectedAfterWord:
				"Unexpected space after unary word operator '{{word***REMOVED******REMOVED***'.",
			wordOperator:
				"Unary word operator '{{word***REMOVED******REMOVED***' must be followed by whitespace.",
			operator:
				"Unary operator '{{operator***REMOVED******REMOVED***' must be followed by whitespace.",
			beforeUnaryExpressions:
				"Space is required before unary expressions '{{token***REMOVED******REMOVED***'.",
		***REMOVED***,
	***REMOVED***,
