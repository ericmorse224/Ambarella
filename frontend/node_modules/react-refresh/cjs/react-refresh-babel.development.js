...
function ReactFreshBabelPlugin (babel) {
  var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {***REMOVED***;
  ...
  if (typeof babel.env === 'function') {
    ...
    if (env !== 'development' && !opts.skipEnvCheck) {
      throw new Error('React Refresh Babel transform should only be enabled in development environment. ' + 'Instead, the environment is: "' + env + '". If you want to override this check, pass {skipEnvCheck: true***REMOVED*** as plugin options.');
    ***REMOVED***
  ***REMOVED***
  ...
  function findInnerComponents(inferredName, path, callback) {
    ...
    switch (node.type) {
      case 'Identifier':
        {
          if (!isComponentishName(node.name)) {
            return false;
          ***REMOVED*** // export default hoc(Foo)
          // const X = hoc(Foo)
      ...
      case 'ArrowFunctionExpression':
        {
          if (node.body.type === 'ArrowFunctionExpression') {
            return false;
          ***REMOVED*** // let Foo = () => {***REMOVED***
          // export default hoc1(hoc2(() => {***REMOVED***))
      ...
      case 'FunctionExpression':
        {
          // let Foo = function() {***REMOVED***
          // const Foo = hoc1(forwardRef(function renderFoo() {***REMOVED***))
          // export default memo(function() {***REMOVED***)
          callback(inferredName, node, path);
          return true;
        ***REMOVED***
            ...
            case 'Identifier':
              {
                ...
                if (!foundInside) {
                  return false;
                ***REMOVED*** // const Foo = hoc1(hoc2(() => {***REMOVED***))
                // export default memo(React.forwardRef(function() {***REMOVED***))
      ...
      case 'VariableDeclarator':
        {
            ...
            case 'CallExpression':
              {
                ...
                if (calleeType === 'Import') {
                  return false;
                ***REMOVED*** else if (calleeType === 'Identifier') {
                  if (callee.name.indexOf('require') === 0) {
                    return false;
                  ***REMOVED*** else if (callee.name.indexOf('import') === 0) {
                    return false;
                  ***REMOVED*** // Neither require nor import. Might be a HOC.
                  // Pass through.
          ...
          ***REMOVED***
          ...
          if (_foundInside) {
            return true;
          ***REMOVED*** // See if this identifier is used in JSX. Then it's a component.
          ...
          ***REMOVED***
          ...
          for (var i = 0; i < referencePaths.length; i++) {
            ...
            ***REMOVED*** else if (refParent.type === 'CallExpression') {
  ...
  var HookCallsVisitor = {
    CallExpression: function (path) {
      ...
      ***REMOVED***
      ...
      if (fnScope === null) {
        return;
      ***REMOVED*** // This is a Hook call. Record it.
      ...
      ***REMOVED*** // Some built-in Hooks reset on edits to arguments.
      ...
      ***REMOVED*** else if (name === 'useReducer' && args.length > 1) {
    ...
    visitor: {
      ExportDefaultDeclaration: function (path) {
        ...
        if (decl.type !== 'CallExpression') {
          ...
          // Anonymous direct exports like export default function() {***REMOVED***
          // are currently ignored.
          return;
        ***REMOVED*** // Make sure we're not mutating the same tree twice.
        ...
        ***REMOVED***
        ...
        // export default memo(function Named() {***REMOVED***)
      ...
      FunctionDeclaration: {
        enter: function (path) {
          ...
          switch (path.parent.type) {
            ...
            default:
              return;
          ***REMOVED*** // These types can be nested in typescript namespace
          ...
          ***REMOVED***
          ...
          var innerName = modulePrefix + inferredName; // export function Named() {***REMOVED***
          // function Named() {***REMOVED***
        ...
        ***REMOVED***,
        exit: function (path) {
          ...
          ***REMOVED***); // The signature call is split in two parts. One part is called inside the function.
          ...
          ***REMOVED***
          ...
          if (path.parent.type === 'VariableDeclarator') {
            ...
            ***REMOVED***);
            ...
            if (insertAfterPath === null) {
              return;
            ***REMOVED*** // Special case when a function would get an inferred name:
            // let Foo = () => {***REMOVED***
            // let Foo = function() {***REMOVED***
            ...
            insertAfterPath.insertAfter(t.expressionStatement(t.callExpression(sigCallID, createArgumentsForSignature(path.parent.id, signature, insertAfterPath.scope)))); // Result: let Foo = () => {***REMOVED***; __signature(Foo, ...);
          ***REMOVED*** else {
            // let Foo = hoc(() => {***REMOVED***)
            ...
            ***REMOVED***); // Result: let Foo = __signature(hoc(__signature(() => {***REMOVED***, ...)), ...)
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***,
        ...
        findInnerComponents(innerName, declPath, function (persistentID, targetExpr, targetPath) {
          ...
          ***REMOVED***
          ...
          if (targetPath.parent.type === 'VariableDeclarator') {
            ...
            insertAfterPath.insertAfter(t.expressionStatement(t.assignmentExpression('=', handle, declPath.node.id))); // Result: let Foo = () => {***REMOVED***; _c1 = Foo;
          ***REMOVED*** else {
            // let Foo = hoc(() => {***REMOVED***)
            targetPath.replaceWith(t.assignmentExpression('=', handle, targetExpr)); // Result: let Foo = hoc(_c1 = () => {***REMOVED***)
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED***,
      Program: {
