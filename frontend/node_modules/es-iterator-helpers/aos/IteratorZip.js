			...
			***REMOVED***
			for (var i = 0; i < iterCount; ++i) { // step 3.b.iii
				...
				***REMOVED*** else { // step 2
					...
					***REMOVED*** catch (e) { // step 3.b.iii.2.b
					...
					***REMOVED***
					if (iter['[[Done]]']) { // step 3.b.iii.2.d
						...
						if (mode === 'shortest') { // step 3.b.iii.2.d.ii
							...
							return sentinel;
						***REMOVED*** else if (mode === 'strict') { // step 3.b.iii.2.d.iii
							...
							***REMOVED***
							for (var k = 1; k < iterCount; k += 1) { // step 3.b.iii.2.d.iii.ii
								...
								***REMOVED*** catch (e) { // step 3.b.iii.2.d.iii.ii.iii
								...
								***REMOVED*** else { // step 3.b.iii.2.d.iii.ii.vi
									return IteratorCloseAll(
										openIters,
								...
								***REMOVED***
							***REMOVED***
						***REMOVED*** else { // step 3.b.iii.2.d.iv
							if (mode !== 'longest') {
