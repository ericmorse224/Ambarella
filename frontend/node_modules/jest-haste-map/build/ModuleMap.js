...
class DuplicateHasteCandidatesError extends Error {
  constructor(name, platform, supportsNativePlatform, duplicatesSet) {
    ...
    super(
      `The name \`${name***REMOVED***\` was looked up in the Haste module map. It ` +
        'cannot be resolved, because there exists several different ' +
        'files, or packages, that provide a module for ' +
        `that particular name and platform. ${platformMessage***REMOVED*** You must ` +
        'delete or exclude files until there remains only one of these:\n\n' +
        Array.from(duplicatesSet)
          .map(
            ([dupFilePath, dupFileType]) =>
              `  * \`${dupFilePath***REMOVED***\` (${getTypeMessage(dupFileType)***REMOVED***)\n`
          )
          .sort()
          .join('')
    );
...
function getPlatformMessage(platform) {
  ...
  ***REMOVED***
  ...
  return `The platform extension is \`${platform***REMOVED***\`.`;
***REMOVED***
