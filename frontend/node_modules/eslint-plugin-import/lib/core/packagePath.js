...
getFilePackageName = getFilePackageName;var _path = require('path');var _contextCompat = require('eslint-module-utils/contextCompat');var _pkgUp = require('eslint-module-utils/pkgUp');var _pkgUp2 = _interopRequireDefault(_pkgUp);var _readPkgUp2 = require('eslint-module-utils/readPkgUp');var _readPkgUp3 = _interopRequireDefault(_readPkgUp2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***function getFilePackagePath(filePath) {var fp = (0, _pkgUp2['default'])({ cwd: filePath ***REMOVED***);return (0, _path.dirname)(fp);***REMOVED***function getContextPackagePath(context) {return getFilePackagePath((0, _contextCompat.getPhysicalFilename)(context));***REMOVED***function getFilePackageName(filePath) {var _readPkgUp =
  (0, _readPkgUp3['default'])({ cwd: filePath, normalize: false ***REMOVED***),pkg = _readPkgUp.pkg,path = _readPkgUp.path;
  if (pkg) {
