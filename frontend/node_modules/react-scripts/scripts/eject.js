...
***REMOVED***).then(answer => {
  ...
  ***REMOVED***
  ...
  function verifyAbsent(file) {
    if (fs.existsSync(path.join(appPath, file))) {
      console.error(
        `\`${file***REMOVED***\` already exists in your app folder. We cannot ` +
  ...
  ***REMOVED***, []);
  ...
  console.log();
  console.log(cyan(`Copying files into ${appPath***REMOVED***`));

  folders.forEach(folder => {
    fs.mkdirSync(path.join(appPath, folder), {recursive: true***REMOVED***);
  ***REMOVED***);
    ...
    ***REMOVED***
    content =
      content
        ...
        .trim() + '\n';
    console.log(`  Adding ${cyan(file.replace(ownPath, ''))***REMOVED*** to the project`);
  ...
  ***REMOVED***);
  ...
  if (appPackage.devDependencies) {
    ...
    if (appPackage.devDependencies[ownPackageName]) {
      console.log(`  Removing ${cyan(ownPackageName)***REMOVED*** from devDependencies`);
      delete appPackage.devDependencies[ownPackageName];
    ***REMOVED***
  ***REMOVED***
  appPackage.dependencies = appPackage.dependencies || {***REMOVED***;
  if (appPackage.dependencies[ownPackageName]) {
    console.log(`  Removing ${cyan(ownPackageName)***REMOVED*** from dependencies`);
  ...
  ***REMOVED***
  Object.keys(ownPackage.dependencies).forEach(key => {
    ...
    if (
      ...
      return;
    ***REMOVED***
    console.log(`  Adding ${cyan(key)***REMOVED*** to dependencies`);
    appPackage.dependencies[key] = ownPackage.dependencies[key];
  ***REMOVED***);
  // Sort the deps
  const unsortedDependencies = appPackage.dependencies;
  appPackage.dependencies = {***REMOVED***;
  ...
  Object.keys(appPackage.scripts).forEach(key => {
    Object.keys(ownPackage.bin).forEach(binKey => {
      ...
      ***REMOVED***
      ...
      console.log(
        `  Replacing ${cyan(`"${binKey***REMOVED*** ${key***REMOVED***"`)***REMOVED*** with ${cyan(
          `"node scripts/${key***REMOVED***.js"`
        )***REMOVED***`
      );
    ***REMOVED***);
  ***REMOVED***);
  ...
  // Add Jest config
  console.log(`  Adding ${cyan('Jest')***REMOVED*** configuration`);
  appPackage.jest = jestConfig;

  // Add Babel config
  console.log(`  Adding ${cyan('Babel')***REMOVED*** preset`);
  appPackage.babel = {
    presets: ['react-app'],
  ***REMOVED***;
  ...
  if (!appPackage.eslintConfig) {
    console.log(`  Adding ${cyan('ESLint')***REMOVED*** configuration`);
  ...
  ***REMOVED***
  ...
  if (fs.existsSync(paths.yarnLockFile)) {
    ...
    ***REMOVED***
    ...
    spawnSync('yarnpkg', ['--cwd', process.cwd()], { stdio: 'inherit' ***REMOVED***);
