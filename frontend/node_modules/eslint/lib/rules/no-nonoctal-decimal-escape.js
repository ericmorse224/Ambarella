	...
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			...
			// suggestions
			refactor:
				"Replace '{{original***REMOVED******REMOVED***' with '{{replacement***REMOVED******REMOVED***'. This maintains the current functionality.",
			escapeBackslash:
				"Replace '{{original***REMOVED******REMOVED***' with '{{replacement***REMOVED******REMOVED***' to include the actual backslash character.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {SourceRange***REMOVED*** range The range to replace.
