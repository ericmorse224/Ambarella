import { ContainerWithChildren ***REMOVED*** from './container.js'
...
declare namespace Declaration {
  ...
  ***REMOVED***
  ...
  export { Declaration_ as default ***REMOVED***
***REMOVED***
 ...
 *
 * ```js
 * Once (root, { Declaration ***REMOVED***) {
 *   const color = new Declaration({ prop: 'color', value: 'black' ***REMOVED***)
 *   root.append(color)
 * ***REMOVED***
 * ```
 *
...
declare class Declaration_ extends Node {
   ...
   *
   * ```js
   * const root = postcss.parse(':root { --one: 1 ***REMOVED***')
...
declare class Declaration extends Declaration_ {***REMOVED***
