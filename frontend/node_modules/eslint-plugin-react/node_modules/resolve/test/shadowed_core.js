...
test('shadowed core modules still return core module', function (t) {
    ...
    resolve('util', { basedir: path.join(__dirname, 'shadowed_core') ***REMOVED***, function (err, res) {
        t.ifError(err);
        t.equal(res, 'util');
    ***REMOVED***);
***REMOVED***);
...
test('shadowed core modules still return core module [sync]', function (t) {
    ...
    var res = resolve.sync('util', { basedir: path.join(__dirname, 'shadowed_core') ***REMOVED***);
...
test('shadowed core modules return shadow with `includeCoreModules: false`', function (t) {
    ...
    resolve('util', { basedir: path.join(__dirname, 'shadowed_core'), includeCoreModules: false ***REMOVED***, function (err, res) {
        t.ifError(err);
        t.equal(res, path.join(__dirname, 'shadowed_core/node_modules/util/index.js'));
    ***REMOVED***);
***REMOVED***);
...
test('shadowed core modules return shadow with `includeCoreModules: false` [sync]', function (t) {
    ...
    var res = resolve.sync('util', { basedir: path.join(__dirname, 'shadowed_core'), includeCoreModules: false ***REMOVED***);
