    ...
    async addAssets(compilation) {
        ...
        ***REMOVED***
        if (compilation.getLogger) {
            ...
            logger.info(`The service worker at ${(_a = config.swDest) !== null && _a !== void 0 ? _a : ''***REMOVED*** will precache
        ${config.manifestEntries.length***REMOVED*** URLs, totaling ${(0, pretty_bytes_1.default)(size)***REMOVED***.`);
        ***REMOVED***
    ***REMOVED***
***REMOVED***
