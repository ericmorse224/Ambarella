...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @returns {boolean***REMOVED*** True if the node is known to be side-effect free, false otherwise.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node A node to report. This is a FunctionExpression or
        ...
        ***REMOVED***
         ...
         * method.
         *
         * e.g. `(function() {***REMOVED***.bind(foo))`
         * @param {ASTNode***REMOVED*** node A node to report. This is a FunctionExpression or
         *      an ArrowFunctionExpression.
         * @returns {boolean***REMOVED*** `true` if the node is the callee of `.bind()` method.
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node A node to add. This node is a FunctionExpression
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node A node to remove. This node is a
        ...
        ***REMOVED***
         ...
         * method.
         * @param {ASTNode***REMOVED*** node A node to report. This node is an
