...
const matcherHintFromConfig = (
  {context: {isNot, promise***REMOVED***, hint, inlineSnapshot, matcherName, properties***REMOVED***,
  isUpdatable
) => {
  const options = {
    isNot,
  ...
  ***REMOVED***
  ...
  if (typeof properties === 'object') {
    ...
    ***REMOVED*** else if (typeof inlineSnapshot === 'string') {
...
***REMOVED***; // Given array of diffs, return string:
  ...
  ***REMOVED***;
  ...
  if (typeof received === 'string') {
    if (
      ...
      ***REMOVED*** // Else either string is multiline, so display as unquoted strings.

      a = (0, _utils2.deserializeString)(a); //  hypothetical expected string

      b = received; // not serialized
    ***REMOVED*** // Else expected had custom serialization or was not a string
