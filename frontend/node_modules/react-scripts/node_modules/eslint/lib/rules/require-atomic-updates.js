...
module.exports = {
    meta: {
        ...
        ***REMOVED***],
        ...
        messages: {
            nonAtomicUpdate: "Possible race condition: `{{value***REMOVED******REMOVED***` might be reassigned based on an outdated value of `{{value***REMOVED******REMOVED***`.",
            nonAtomicObjectUpdate: "Possible race condition: `{{value***REMOVED******REMOVED***` might be assigned based on an outdated state of `{{object***REMOVED******REMOVED***`."
        ***REMOVED***
    ***REMOVED***,
