...
const c = 3
export { c as d ***REMOVED***

export class ExportedClass { ***REMOVED***
...
function notGreat() {
  ...
  const { a, b, c ***REMOVED*** = names // also reported, only for 'c'
***REMOVED***
...
```js
/*eslint import/namespace: [2, { allowComputed: false ***REMOVED***]*/
import * as a from './a'
