...
/**
 * @param {Uint32Array***REMOVED*** uint32Array Treated as a long base-0x100000000 number, little endian
 * @param {number***REMOVED*** divisor The divisor
 * @return {number***REMOVED*** Modulo (remainder) of the division
 */
...
function getHashDigest(buffer, algorithm, digestType, maxLength) {
  ...
  ***REMOVED*** else if (algorithm === "native-md4") {
