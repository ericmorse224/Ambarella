...
```js
import { ConfigArray ***REMOVED*** from "@humanwhocodes/config-array";

// or using CommonJS

const { ConfigArray ***REMOVED*** = require("@humanwhocodes/config-array");
```
...
const { default: rawConfigs ***REMOVED*** = await import(configFilename);
