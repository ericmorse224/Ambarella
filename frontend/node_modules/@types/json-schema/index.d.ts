...
export interface JSONSchema4Array extends Array<JSONSchema4Type> {***REMOVED***
...
// Workaround for infinite type recursion
// https://github.com/Microsoft/TypeScript/issues/3496#issuecomment-128553540
export interface JSONSchema6Array extends Array<JSONSchema6Type> {***REMOVED***
...
// Workaround for infinite type recursion
// https://github.com/Microsoft/TypeScript/issues/3496#issuecomment-128553540
export interface JSONSchema7Array extends Array<JSONSchema7Type> {***REMOVED***
 ...
 */
export function validate(instance: {***REMOVED***, schema: JSONSchema4 | JSONSchema6 | JSONSchema7): ValidationResult;
