...
- Added `styles: { '!!null': 'empty' ***REMOVED***` option for dumper
  (serializes `{ foo: null ***REMOVED***` as "`foo: `"), #570.
...
## [2.0.3] - 2013-02-26
### Fixed
- Fixed dumping of empty arrays ans objects. ([] and {***REMOVED*** instead of null)
