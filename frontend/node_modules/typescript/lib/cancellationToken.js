...
function createCancellationToken(args) {
    ...
    ***REMOVED***
    if (!cancellationPipeName) {
        return {
            isCancellationRequested: function () { return false; ***REMOVED***,
            setRequest: function (_requestId) { return void 0; ***REMOVED***,
            resetRequest: function (_requestId) { return void 0; ***REMOVED***
        ***REMOVED***;
    ***REMOVED***
    if (cancellationPipeName.charAt(cancellationPipeName.length - 1) === "*") {
        ...
        ***REMOVED***
        ...
        return {
            isCancellationRequested: function () { return perRequestPipeName_1 !== undefined && pipeExists(perRequestPipeName_1); ***REMOVED***,
    ...
    ***REMOVED***
        ...
        return {
            isCancellationRequested: function () { return pipeExists(cancellationPipeName); ***REMOVED***,
            setRequest: function (_requestId) { return void 0; ***REMOVED***,
            resetRequest: function (_requestId) { return void 0; ***REMOVED***
        ***REMOVED***;
    ***REMOVED***
