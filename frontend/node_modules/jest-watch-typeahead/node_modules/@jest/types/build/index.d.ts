...
import type {Arguments***REMOVED*** from 'yargs';
import type {CoverageMapData***REMOVED*** from 'istanbul-lib-coverage';
import type {ForegroundColor***REMOVED*** from 'chalk';
import type {ReportOptions***REMOVED*** from 'istanbul-reports';
import type {SnapshotFormat***REMOVED*** from '@jest/schemas';
...
declare namespace TestResult {
  export {Milliseconds, AssertionResult, SerializableError***REMOVED***;
***REMOVED***
export {TestResult***REMOVED***;
...
declare namespace TransformTypes {
  export {TransformResult***REMOVED***;
***REMOVED***
export {TransformTypes***REMOVED***;
