...
function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) ***REMOVED*** ***REMOVED***)); ***REMOVED***
...
var TemplateTag = function () {
   ...
   * @param  {...Object***REMOVED*** [...transformers] - an array or arguments list of transformers
   * @return {Function***REMOVED***                    - a template tag
   */
  ...
  ***REMOVED***
   ...
   * @param  {(Function|String|Array<String>)***REMOVED*** strings        - Either a template tag or an array containing template strings separated by identifier
   * @param  {...****REMOVED***                            ...expressions - Optional list of substitution values.
   * @return {(String|Function)***REMOVED***                              - Either an intermediary tag function or the results of processing the template.
   */
  ...
  _createClass(TemplateTag, [{
     ...
     * @param  {Function***REMOVED***        nextTag          - the received template tag
     * @param  {Array<String>***REMOVED***   template         - the template to process
     * @param  {...****REMOVED***            ...substitutions - `substitutions` is an array of all substitutions in the template
     * @return {****REMOVED***                                - the final processed value
     */
    ...
    ***REMOVED***
     ...
     * @param  {Array<*>***REMOVED*** substitutions - an array of all remaining substitutions present in this template
     * @param  {String***REMOVED***   resultSoFar   - this iteration's result string so far
     * @param  {String***REMOVED***   remainingPart - the template chunk after the current substitution
     * @return {String***REMOVED***                 - the result of joining this iteration's processed substitution with the result
     */
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
     ...
     * @param {String***REMOVED***  str - The input string
     * @return {String***REMOVED***     - The final results of processing each transformer
     */
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
     ...
     * @param  {****REMOVED***      substitution - The current substitution
     * @param  {String***REMOVED*** resultSoFar  - The result up to and excluding this substitution.
     * @return {****REMOVED***                   - The final result of applying all substitution transformations.
     */
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
     ...
     * @param  {String***REMOVED*** endResult - The processed template, just before it is returned from the tag
     * @return {String***REMOVED***           - The final results of processing each transformer
     */
