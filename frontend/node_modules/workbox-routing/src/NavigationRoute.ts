...
import {RouteHandler, RouteMatchCallbackOptions***REMOVED*** from 'workbox-core/types.js';
...
class NavigationRoute extends Route {
  ...
  constructor(
    ...
    {allowlist = [/./], denylist = []***REMOVED***: NavigationRouteMatchOptions = {***REMOVED***,
  ) {
  ...
  ***REMOVED***
   ...
   * @private
   */
  private _match({url, request***REMOVED***: RouteMatchCallbackOptions): boolean {
    ...
    ***REMOVED***
    ...
    for (const regExp of this._denylist) {
      if (regExp.test(pathnameAndSearch)) {
        if (process.env.NODE_ENV !== 'production') {
          logger.log(
            `The navigation route ${pathnameAndSearch***REMOVED*** is not ` +
    ...
    ***REMOVED***
    ...
    if (this._allowlist.some((regExp) => regExp.test(pathnameAndSearch))) {
      if (process.env.NODE_ENV !== 'production') {
        logger.debug(
          `The navigation route ${pathnameAndSearch***REMOVED*** ` + `is being used.`,
        );
      ***REMOVED***
      return true;
    ***REMOVED***
