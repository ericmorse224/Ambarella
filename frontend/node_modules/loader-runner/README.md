...
``` js
import { runLoaders ***REMOVED*** from "loader-runner";
...
runLoaders({
	...
	// {loader, options***REMOVED***[]: Absolute paths to the loaders with options object

	context: { minimize: true ***REMOVED***,
	// Additional loader context which is used as base context

	processResource: (loaderContext, resourcePath, callback) => { ... ***REMOVED***,
