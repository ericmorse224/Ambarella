...
module.exports = {
		...
		schema: [
			{
				type: "object",
				properties: {
					allowEmptyReject: { type: "boolean" ***REMOVED***,
				***REMOVED***,
	...
	***REMOVED***,
	...
	create(context) {
		const [{ allowEmptyReject ***REMOVED***] = context.options;
		 ...
		 * @param {ASTNode***REMOVED*** callExpression A CallExpression node which is used to reject a Promise
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node A CallExpression node
		 * @returns {boolean***REMOVED*** `true` if the call is a Promise.reject() call
		 */
		...
		***REMOVED***
		...
		return {
			...
			***REMOVED***,
			...
			/*
			 * Check for `new Promise((resolve, reject) => {***REMOVED***)`, and check for reject() calls.
