 ...
 *
 * A `LazyResult` instance is returned by {@link Processor#process***REMOVED***.
 *
 * @example
...
var LazyResult = /*#__PURE__*/function () {
  function LazyResult(processor, css, opts) {
    ...
    if (typeof css === 'object' && css !== null && css.type === 'root') {
      root = css;
    ***REMOVED*** else if (css instanceof LazyResult || css instanceof _result.default) {
      root = css.root;

      if (css.map) {
        if (typeof opts.map === 'undefined') opts.map = {***REMOVED***;
  ...
  ***REMOVED***
  /**
   * Returns a {@link Processor***REMOVED*** instance, which will be used
   ...
   * and calls {@link Result#warnings()***REMOVED***.
   *
  ...
  ***REMOVED***
  /**
   * Alias for the {@link LazyResult#css***REMOVED*** property.
   *
   * @example
   * lazy + '' === lazy.css
   *
   * @return {string***REMOVED*** Output CSS.
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {onFulfilled***REMOVED*** onFulfilled Callback will be executed
   *                                  when all plugins will finish work.
   * @param {onRejected***REMOVED***  onRejected  Callback will be executed on any error.
   *
   * @return {Promise***REMOVED*** Promise API to make queue.
   *
   * @example
   * postcss([autoprefixer]).process(css, { from: cssPath ***REMOVED***).then(result => {
  ...
  ***REMOVED***
   ...
   * It implements standard Promise API.
   *
   * @param {onFinally***REMOVED*** onFinally Callback will be executed on any error or
   *                              when all plugins will finish work.
   *
   * @return {Promise***REMOVED*** Promise API to make queue.
   *
  ...
  _proto.handleError = function handleError(error, plugin) {
    try {
      ...
      if (error.name === 'CssSyntaxError' && !error.plugin) {
        ...
        error.setMessage();
      ***REMOVED*** else if (plugin.postcssVersion) {
        if (process.env.NODE_ENV !== 'production') {
  ...
  ***REMOVED***;
  ...
  _createClass(LazyResult, [{
    ...
    ***REMOVED***
    /**
     * Options from the {@link Processor#process***REMOVED*** call.
     *
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
     ...
     * to a CSS string and returns {@link Result#css***REMOVED***.
     *
     * This property will only work with synchronous plugins.
     * If the processor contains any asynchronous plugins
     * it will throw an error. This is why this method is only
     * for debug purpose, you should always use {@link LazyResult#then***REMOVED***.
     *
     * @type {string***REMOVED***
     * @see Result#css
     */
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    /**
     * Processes input CSS through synchronous plugins
     * and returns {@link Result#map***REMOVED***.
     *
     * This property will only work with synchronous plugins.
     * If the processor contains any asynchronous plugins
     * it will throw an error. This is why this method is only
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    /**
     * Processes input CSS through synchronous plugins
     * and returns {@link Result#root***REMOVED***.
     *
     * This property will only work with synchronous plugins. If the processor
     * contains any asynchronous plugins it will throw an error.
     *
     * This is why this method is only for debug purpose,
     * you should always use {@link LazyResult#then***REMOVED***.
     *
     * @type {Root***REMOVED***
     * @see Result#root
     */
  ...
  ***REMOVED***, {
    ...
    ***REMOVED***
    /**
     * Processes input CSS through synchronous plugins
     * and returns {@link Result#messages***REMOVED***.
     *
     * This property will only work with synchronous plugins. If the processor
     * contains any asynchronous plugins it will throw an error.
     *
