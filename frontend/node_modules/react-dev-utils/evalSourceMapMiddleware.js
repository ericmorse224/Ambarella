...
function base64SourceMap(source) {
  ...
  return `data:application/json;charset=utf-8;base64,${base64***REMOVED***`;
***REMOVED***
  ...
  return function handleWebpackInternalMiddleware(req, res, next) {
    if (req.url.startsWith('/__get-internal-source')) {
      ...
      ***REMOVED***
      ...
      const sourceMapURL = `//# sourceMappingURL=${base64SourceMap(source)***REMOVED***`;
      const sourceURL = `//# sourceURL=webpack-internal:///${module.id***REMOVED***`;
      res.end(`${source.source()***REMOVED***\n${sourceMapURL***REMOVED***\n${sourceURL***REMOVED***`);
    ***REMOVED*** else {
      next();
    ***REMOVED***
  ***REMOVED***;
