...
var _docsUrl = require('../docsUrl');var _docsUrl2 = _interopRequireDefault(_docsUrl);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED*** /**
    ...
    message: 'Assign array to a variable before exporting as module default' ***REMOVED***,

  ArrowFunctionExpression: {
    option: 'allowArrowFunction',
    description: 'If `false`, will report default export of an arrow function',
    message: 'Assign arrow function to a variable before exporting as module default' ***REMOVED***,
  ...
  ClassDeclaration: {
    ...
    forbid: function () {function forbid(node) {return !node.declaration.id;***REMOVED***return forbid;***REMOVED***() ***REMOVED***,
  ...
  Literal: {
    ...
    message: 'Assign literal to a variable before exporting as module default' ***REMOVED***,

  ObjectExpression: {
    option: 'allowObject',
    description: 'If `false`, will report default export of an object expression',
    message: 'Assign object to a variable before exporting as module default' ***REMOVED***,
  ...
  NewExpression: {
    ...
    message: 'Assign instance to a variable before exporting as module default' ***REMOVED*** ***REMOVED***;
...
var defaults = (0, _object4['default'])((0, _object2['default'])(defs).map(function (def) {return [def.option, (0, _hasown2['default'])(def, 'default') ? def['default'] : false];***REMOVED***));
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-anonymous-default-export') ***REMOVED***,
  ...
  create: function () {function create(context) {
      var options = Object.assign({***REMOVED***, defaults, context.options[0]);
      ...
      return {
        ExportDefaultDeclaration: function () {function ExportDefaultDeclaration(node) {
            ...
            if (def && !options[def.option] && (!def.forbid || def.forbid(node))) {
              context.report({ node: node, message: def.message ***REMOVED***);
            ***REMOVED***
          ***REMOVED***return ExportDefaultDeclaration;***REMOVED***() ***REMOVED***;
