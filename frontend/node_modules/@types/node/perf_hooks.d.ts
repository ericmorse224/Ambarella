 ...
 *
 * ```js
 * import { PerformanceObserver, performance ***REMOVED*** from 'node:perf_hooks';
 *
 * const obs = new PerformanceObserver((items) => {
 *   console.log(items.getEntries()[0].duration);
 *   performance.clearMarks();
 * ***REMOVED***);
 * obs.observe({ type: 'measure' ***REMOVED***);
...
declare module "perf_hooks" {
    import { AsyncResource ***REMOVED*** from "node:async_hooks";
    type EntryType =
        | "dns" // Node.js only
    ...
    ***REMOVED***
    interface Performance {
         ...
         *   obs.disconnect();
         * ***REMOVED***);
         * obs.observe({ entryTypes: ['function'] ***REMOVED***);
         *
    ...
    ***REMOVED***
    class PerformanceObserverEntryList {
         ...
         *   observer.disconnect();
         * ***REMOVED***);
         * obs.observe({ entryTypes: ['mark', 'measure'] ***REMOVED***);
         *
         * performance.mark('test');
         * performance.mark('meow');
         * ```
    ...
    ***REMOVED***
    ...
    class PerformanceObserver extends AsyncResource {
         ...
         *
         * for (let n = 0; n < 3; n++)
         *   performance.mark(`test${n***REMOVED***`);
         * ```
         * @since v8.5.0
         */
        observe(
    ...
    ***REMOVED***
     ...
     *
     * ```js
     * import { monitorEventLoopDelay ***REMOVED*** from 'node:perf_hooks';
     * const h = monitorEventLoopDelay({ resolution: 20 ***REMOVED***);
     * h.enable();
     * // Do something.
     * h.disable();
     * console.log(h.min);
    ...
    ***REMOVED*** from "perf_hooks";
    global {
        /**
         * `PerformanceEntry` is a global reference for `import { PerformanceEntry ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `PerformanceMark` is a global reference for `import { PerformanceMark ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `PerformanceMeasure` is a global reference for `import { PerformanceMeasure ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `PerformanceObserver` is a global reference for `import { PerformanceObserver ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `PerformanceObserverEntryList` is a global reference for `import { PerformanceObserverEntryList ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `PerformanceResourceTiming` is a global reference for `import { PerformanceResourceTiming ***REMOVED*** from 'node:perf_hooks'`
        ...
        ***REMOVED*** ? T
        ...
        /**
         * `performance` is a global reference for `import { performance ***REMOVED*** from 'node:perf_hooks'`
