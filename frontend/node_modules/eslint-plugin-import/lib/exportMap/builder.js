...
function thunkFor(p, context) {
  ...
  return function () {return ExportMapBuilder['for']((0, _childContext2['default'])(p, context));***REMOVED***;
***REMOVED***var

ExportMapBuilder = function () {function ExportMapBuilder() {_classCallCheck(this, ExportMapBuilder);***REMOVED***_createClass(ExportMapBuilder, null, [{ key: 'get', value: function () {function get(
      source, context) {
      ...
      ***REMOVED***return get;***REMOVED***() ***REMOVED***, { key: 'for', value: function () {function _for(
      ...
      context) {var
        ...
        if (exportMap === null) {return null;***REMOVED***
        ...
        ***REMOVED***
        ...
        var content = _fs2['default'].readFileSync(path, { encoding: 'utf8' ***REMOVED***);
        ...
        ***REMOVED***
        return exportMap;
      ***REMOVED***return _for;***REMOVED***() ***REMOVED***, { key: 'parse', value: function () {function parse(
      ...
      path, content, context) {
          ...
          exportMap.imports.set(p, {
            ...
            declarations: new Set([{
              source: {
                ...
                value: source.value,
                loc: source.loc ***REMOVED***,

              importedSpecifiers: importedSpecifiers,
              dynamic: true ***REMOVED***]) ***REMOVED***);
        ...
        ***REMOVED***
        ...
        if (!unambiguouslyESM && !hasDynamicImports) {return null;***REMOVED***

        // attempt to collect module doc
        if (ast.comments) {
          ast.comments.some(function (c) {
            if (c.type !== 'Block') {return false;***REMOVED***
            try {
              var doc = _doctrine2['default'].parse(c.value, { unwrap: true ***REMOVED***);
              if (doc.tags.some(function (t) {return t.title === 'module';***REMOVED***)) {
                exportMap.doc = doc;
                return true;
              ***REMOVED***
            ***REMOVED*** catch (err) {/* ignore */***REMOVED***
            return false;
          ***REMOVED***);
        ***REMOVED***
        ...
        ***REMOVED***);
        ...
        && !exportMap.namespace.has('default') // and default isn't added already
            ...
            exportMap.namespace.set('default', {***REMOVED***); // add default export
          ***REMOVED***
        ...
        ***REMOVED***
        return exportMap;
      ***REMOVED***return parse;***REMOVED***() ***REMOVED***]);return ExportMapBuilder;***REMOVED***();exports['default'] = ExportMapBuilder;
