...
import Node, { NodeProps ***REMOVED*** from './node.js'
...
declare namespace Comment {
  ...
  ***REMOVED***
  ...
  export { Comment_ as default ***REMOVED***
***REMOVED***
 ...
 *
 * ```js
 * Once (root, { Comment ***REMOVED***) {
 *   const note = new Comment({ text: 'Note: …' ***REMOVED***)
 *   root.append(note)
 * ***REMOVED***
 * ```
 *
...
declare class Comment extends Comment_ {***REMOVED***
