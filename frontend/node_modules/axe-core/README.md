    ...
    checks: {
      ...
      ***REMOVED***,
      'aria-errormessage': {
        ...
        fail: 'Der Wert der aria-errormessage ${data.values***REMOVED***` muss eine Technik verwenden, um die Message anzukündigen (z. B., aria-live, aria-describedby, role=alert, etc.).'
      ***REMOVED***
      // ...
    ***REMOVED***
  ***REMOVED***
