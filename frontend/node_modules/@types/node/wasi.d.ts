 ...
 * import { WASI ***REMOVED*** from 'node:wasi';
 * import { argv, env ***REMOVED*** from 'node:process';
 *
 * const wasi = new WASI({
 *   version: 'preview1',
 *   args: argv,
