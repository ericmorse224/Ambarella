...
function hasKeys() {var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {***REMOVED***;
...
function extractDepFields(pkg) {
  return {
    dependencies: pkg.dependencies || {***REMOVED***,
    devDependencies: pkg.devDependencies || {***REMOVED***,
    optionalDependencies: pkg.optionalDependencies || {***REMOVED***,
    peerDependencies: pkg.peerDependencies || {***REMOVED***,
    // BundledDeps should be in the form of an array, but object notation is also supported by
    // `npm`, so we convert it to an array if it is an object
    bundledDependencies: arrayOrKeys(pkg.bundleDependencies || pkg.bundledDependencies || []) ***REMOVED***;
...
function getDependencies(context, packageDir) {
  ...
  try {
    ...
    if (packageDir && packageDir.length > 0) {
      ...
      ***REMOVED*** else {
        paths = packageDir.map(function (dir) {return _path2['default'].resolve(dir);***REMOVED***);
      ***REMOVED***
    ***REMOVED***
  ...
  ***REMOVED*** catch (e) {
    if (paths.length > 0 && e.code === 'ENOENT') {
      context.report({
        ...
        loc: { line: 0, column: 0 ***REMOVED*** ***REMOVED***);
...
function checkDependencyDeclaration(deps, packageName, declarationStatus) {
  ...
  ***REMOVED***);
  ...
  return packageHierarchy.reduce(function (result, ancestorName) {return {
      ...
      isInBundledDeps:
      result.isInBundledDeps || deps.bundledDependencies.indexOf(ancestorName) !== -1 ***REMOVED***;***REMOVED***,
...
function reportIfMissing(context, deps, depsOptions, node, name) {
  ...
  Array.isArray(node.specifiers) && node.specifiers.length && node.specifiers.every(function (specifier) {return specifier.importKind === 'type' || specifier.importKind === 'typeof';***REMOVED***)))
...
function testConfig(config, filename) {
  ...
  ***REMOVED***
  ...
  return config.some(function (c) {return (0, _minimatch2['default'])(filename, c) ||
    (0, _minimatch2['default'])(filename, _path2['default'].join(process.cwd(), c));***REMOVED***);
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-extraneous-dependencies') ***REMOVED***,
    ...
    schema: [
    {
      type: 'object',
      properties: {
        devDependencies: { type: ['boolean', 'array'] ***REMOVED***,
        optionalDependencies: { type: ['boolean', 'array'] ***REMOVED***,
        peerDependencies: { type: ['boolean', 'array'] ***REMOVED***,
        bundledDependencies: { type: ['boolean', 'array'] ***REMOVED***,
        packageDir: { type: ['string', 'array'] ***REMOVED***,
        includeInternal: { type: ['boolean'] ***REMOVED***,
        includeTypes: { type: ['boolean'] ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      var deps = getDependencies(context, options.packageDir) || extractDepFields({***REMOVED***);
