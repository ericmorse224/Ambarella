...
(function Export(global, factory) {
  ...
  ***REMOVED*** else if (typeof define == 'function' && define['amd']) {
    define(factory);
  ***REMOVED*** else {
    global.NW || (global.NW = { ***REMOVED***);
    global.NW.Dom = factory(global, Export);
  ***REMOVED***

***REMOVED***)(this, function Factory(global, Export) {
  /**
  ...
  ***REMOVED***,
  ...
  REX = {
    ...
    RegExpChar: RegExp('(?!\\\\)[\\\\^$.,*+?()[\\]{***REMOVED***|\\/]', 'g'),
    TrimSpaces: RegExp('^' + WSP + '+|' + WSP + '+$|' + VSP, 'g'),
    SplitGroup: RegExp('(\\([^)]*\\)|\\[[^[]*\\]|\\\\.|[^,])+', 'g'),
    CommaGroup: RegExp('(\\s*,\\s*)' + NOT.square_enc + NOT.parens_enc, 'g'),
    FixEscapes: RegExp('\\\\([0-9a-fA-F]{1,6***REMOVED***' + WSP + '?|.)|([\\x22\\x27])', 'g'),
  ...
  ***REMOVED***,
  ...
  GROUPS = {
    ...
    linguistic: '(dir|lang)(?:\\x28\\s?([-\\w]{2,***REMOVED***)\\s?\\x29)',
    ...
    pseudo_dbl: ':(after|before|first\\-letter|first\\-line|selection|placeholder|-webkit-[-a-zA-Z0-9]{2,***REMOVED***)\\b'
  ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  concatList =
    function(list, nodes) {
      ...
      while (l--) { list[list.length] = nodes[++i]; ***REMOVED***
      return list;
    ***REMOVED***,
    ...
    function() {
      ...
      return function(nodeArray) {
        ...
        ***REMOVED***);
        ...
        nodeArray.forEach(function (v, i) { fakeNL[i] = v; ***REMOVED***);
  ...
  compat = {
    '#': function(c, n) { REX.HasEscapes.test(n) && (n = unescapeIdentifier(n)); return function(e, f) { return byId(n, c); ***REMOVED***; ***REMOVED***,
    '*': function(c, n) { REX.HasEscapes.test(n) && (n = unescapeIdentifier(n)); return function(e, f) { return byTag(n, c); ***REMOVED***; ***REMOVED***,
    '|': function(c, n) { REX.HasEscapes.test(n) && (n = unescapeIdentifier(n)); return function(e, f) { return byTagNS(n, c); ***REMOVED***; ***REMOVED***,
    '.': function(c, n) { REX.HasEscapes.test(n) && (n = unescapeIdentifier(n)); return function(e, f) { return byClass(n, c); ***REMOVED***; ***REMOVED***
    ***REMOVED***,
      ...
      ***REMOVED*** else {
        ...
        if ((e = context.firstElementChild)) {
          ...
          ***REMOVED*** else {
            ...
            ***REMOVED*** while ((e = e.nextElementSibling));
          ***REMOVED***
        ***REMOVED*** else nodes = none;
      ***REMOVED***
    ...
    return function(element, dir) {
      ...
      ***REMOVED*** else {
        ...
        for (i = -1, j = 0, k = l - 1; l > j; ++j, --k) {
          if (parents[j] === parent) { i = j; break; ***REMOVED***
          if (parents[k] === parent) { i = k; break; ***REMOVED***
        ***REMOVED***
        if (i < 0) {
          parents[i = l] = parent;
          l = 0; nodes[i] = Array();
          e = parent && parent.firstElementChild || element;
          while (e) { nodes[i][l] = e; if (e === element) j = l; e = e.nextElementSibling; ++l; ***REMOVED***
          set = i; idx = 0; len = l;
          if (l < 2) return l;
        ***REMOVED*** else {
          l = nodes[i].length;
      ...
      ***REMOVED***
      if (element !== nodes[i][j] && element !== nodes[i][j = 0]) {
        for (j = 0, e = nodes[i], k = l - 1; l > j; ++j, --k) {
          if (e[j] === element) { break; ***REMOVED***
          if (e[k] === element) { j = k; break; ***REMOVED***
        ***REMOVED***
      ***REMOVED***
      idx = j + 1; len = l;
      return dir ? l - j : idx;
      ...
      ***REMOVED*** else {
        ...
        ***REMOVED***
        if (i < 0 || !nodes[i][name]) {
          ...
          e = parent && parent.firstElementChild || element;
          while (e) { if (e === element) j = l; if (e.localName == name) { nodes[i][name][l] = e; ++l; ***REMOVED*** e = e.nextElementSibling; ***REMOVED***
          set = i; idx = j; len = l;
          if (l < 2) return l;
        ***REMOVED*** else {
  ...
  ***REMOVED***)(),
  ...
  isFocusable =
    function(node) {
      var doc = node.ownerDocument;
       if (node.contentDocument&&node.localName== 'iframe') { return false; ***REMOVED***
  ...
  configure =
    function(option, clear) {
      if (typeof option == 'string') { return !!Config[option]; ***REMOVED***
      if (typeof option != 'object') { return Config; ***REMOVED***
      for (var i in option) {
        Config[i] = !!option[i];
      ***REMOVED***
      // clear lambda cache
      if (clear) {
        matchResolvers = { ***REMOVED***;
        selectResolvers = { ***REMOVED***;
      ***REMOVED***
      setIdentifierSyntax();
      return true;
    ***REMOVED***,
  ...
  S_TEST = 'if(f(c[k])){break main;***REMOVED***',
  N_TEST = 'if(f(c.item(k))){break main;***REMOVED***',
  M_TEST = 'f(c);',
  ...
  compile =
    function(selector, mode, callback) {
      ...
      switch (mode) {
        case true:
          if (selectLambdas[selector]) { return selectLambdas[selector]; ***REMOVED***
          macro = S_BODY + (callback ? S_TEST : '') + S_TAIL;
          head = S_HEAD;
          loop = S_LOOP;
          break;
        case false:
          if (matchLambdas[selector]) { return matchLambdas[selector]; ***REMOVED***
      ...
      ***REMOVED***
      ...
      loop += mode || mode === null ? '{' + source + '***REMOVED***' : source;
      ...
      ***REMOVED***
      ...
      factory = Function('s', F_INIT + '{' + head + vars + ';' + loop + 'return r;***REMOVED***')(Snapshot);
      ...
      while (selector) {
        ...
        switch (symbol) {
          ...
          case '#':
            ...
            source = 'if((/^' + match[1] + '$/.test(e.getAttribute("id")))){' + source + '***REMOVED***';
            break;
          ...
          case '.':
            ...
            source = 'if((/(^|\\s)' + match[1] + '(\\s|$)/' + compat + ')){' + source + '***REMOVED***';
            break;

          // tag name resolver
          case (/[_a-z]/i.test(symbol) ? symbol : undefined):
            match = selector.match(Patterns.tagName);
            source = 'if((e.localName=="' + match[1] + '")){' + source + '***REMOVED***';
            break;
          ...
          case '|':
            match = selector.match(Patterns.namespace);
                   if (match[1] == '*') {
              source = 'if(true){' + source + '***REMOVED***';
            ***REMOVED*** else if (!match[1]) {
              source = 'if((!e.namespaceURI)){' + source + '***REMOVED***';
            ***REMOVED*** else if (typeof match[1] == 'string' && root.prefix == match[1]) {
              source = 'if((e.namespaceURI=="' + NAMESPACE + '")){' + source + '***REMOVED***';
            ***REMOVED*** else {
          ...
          case '[':
            ...
            ***REMOVED***
            if (match[4] === '') {
              test = match[2] == '~=' ?
                { p1: '^\\s', p2: '+$', p3: 'true' ***REMOVED*** :
                  match[2] in ATTR_STD_OPS && match[2] != '~=' ?
                { p1: '^',    p2: '$',  p3: 'true' ***REMOVED*** : test;
            ***REMOVED*** else if (match[2] == '~=' && match[4].includes(' ')) {
              // whitespace separated list but value contains space
              break;
            ***REMOVED*** else if (match[4]) {
          ...
          case '~':
            ...
            source = 'var N' + k + '=e;while(e&&(e=e.previousElementSibling)){' + source + '***REMOVED***e=N' + k + ';';
            break;
          // *** Adjacent sibling combinator
          // E + F (F adiacent sibling of E)
          case '+':
            match = selector.match(Patterns.adjacent);
            source = 'var N' + k + '=e;if(e&&(e=e.previousElementSibling)){' + source + '***REMOVED***e=N' + k + ';';
            break;
          ...
          case '\x20':
            ...
            source = 'var N' + k + '=e;while(e&&(e=e.parentElement)){' + source + '***REMOVED***e=N' + k + ';';
            break;
          // *** Child combinator
          // E > F (F children of E)
          case '>':
            match = selector.match(Patterns.children);
            source = 'var N' + k + '=e;if(e&&(e=e.parentElement)){' + source + '***REMOVED***e=N' + k + ';';
            break;
          ...
          case ':':
            if ((match = selector.match(Patterns.structural))) {
              ...
              switch (match[1]) {
               case 'scope':
                  ...
                  source = 'if(e===(s.from.nodeType===9?s.root:s.from)){' + source + '***REMOVED***';
                  break;
                case 'root':
                  // there can only be one :root element, so exit the loop once found
                  source = 'if((e===s.root)){' + source + (mode ? 'break main;' : '') + '***REMOVED***';
                  break;
                case 'empty':
                  // matches elements that don't contain elements or text nodes
                  source = 'n=e.firstChild;while(n&&!(/1|3/).test(n.nodeType)){n=n.nextSibling***REMOVED***if(!n){' + source + '***REMOVED***';
                  break;

                // *** child-indexed pseudo-classes
                // :first-child, :last-child, :only-child
                case 'only-child':
                  source = 'if((!e.nextElementSibling&&!e.previousElementSibling)){' + source + '***REMOVED***';
                  break;
                case 'last-child':
                  source = 'if((!e.nextElementSibling)){' + source + '***REMOVED***';
                  break;
                case 'first-child':
                  source = 'if((!e.previousElementSibling)){' + source + '***REMOVED***';
                  break;
                ...
                case 'only-of-type':
                  source = 'o=e.localName;' +
                    ...
                    'n=e;while((n=n.previousElementSibling)&&n.localName!=o);***REMOVED***if(!n){' + source + '***REMOVED***';
                  break;
                case 'last-of-type':
                  source = 'n=e;o=e.localName;while((n=n.nextElementSibling)&&n.localName!=o);if(!n){' + source + '***REMOVED***';
                  break;
                case 'first-of-type':
                  source = 'n=e;o=e.localName;while((n=n.previousElementSibling)&&n.localName!=o);if(!n){' + source + '***REMOVED***';
                  break;
                default:
                  emit('\'' + selector_string + '\'' + qsInvalid);
                  break;
                ...
                case 'nth-last-of-type':
                  ...
                  if (match[1] && match[2]) {
                    ...
                    if (match[2] == 'n') {
                      source = 'if(true){' + source + '***REMOVED***';
                      break;
                    ***REMOVED*** else if (match[2] == '1') {
                      test = type ? 'next' : 'previous';
                      source = expr ? 'n=e;o=e.localName;' +
                        'while((n=n.' + test + 'ElementSibling)&&n.localName!=o);if(!n){' + source + '***REMOVED***' :
                        'if(!e.' + test + 'ElementSibling){' + source + '***REMOVED***';
                      break;
                    ***REMOVED*** else if (match[2] == 'even' || match[2] == '2n0' || match[2] == '2n+0' || match[2] == '2n') {
                      test = 'n%2==0';
                    ***REMOVED*** else if (match[2] == 'odd'  || match[2] == '2n1' || match[2] == '2n+1') {
                      test = 'n%2==1';
                    ***REMOVED*** else {
                      f = /n/i.test(match[2]);
                      n = match[2].split('n');
                    ...
                    ***REMOVED***
                    ...
                    source = 'n=s.nth' + expr + '(e,' + type + ');if((' + test + ')){' + source + '***REMOVED***';
                  ***REMOVED*** else {
                    emit('\'' + selector_string + '\'' + qsInvalid);
                  ***REMOVED***
                  break;
            ...
            ***REMOVED***
            ...
            // :is( s1, [ s2, ... ]), :not( s1, [ s2, ... ])
              ...
              switch (match[1]) {
                ...
                case 'where':
                case 'matches':
                  source = 'if(s.match("' + expr.replace(/\x22/g, '\\"') + '",e)){' + source + '***REMOVED***';
                  break;
                case 'not':
                  source = 'if(!s.match("' + expr.replace(/\x22/g, '\\"') + '",e)){' + source + '***REMOVED***';
                  break;
                case 'has':
                         if (/^\s*[+]/.test(match[2])) {
                    source = 'if(e.parentElement && [].slice.call(e.parentElement.querySelectorAll("*' + expr.replace(/\x22/g, '\\"') + '")).includes(e.nextElementSibling)){' + source + '***REMOVED***';
                  ***REMOVED*** else if (/^\s*[~]/.test(match[2])) {
                    source = 'if([].slice.call(e.parentElement.children).includes(e.nextElementSibling)){' + source + '***REMOVED***';
                  ***REMOVED*** else {
                    source = 'if(e.querySelector(":scope ' + expr.replace(/\x22/g, '\\"') + '")){' + source + '***REMOVED***';
                  ***REMOVED***
                  break;
                default:
                  emit('\'' + selector_string + '\'' + qsInvalid);
            ...
            ***REMOVED***
            ...
            // :any-link, :link, :visited, :target
              ...
              switch (match[1]) {
                case 'any-link':
                  source = 'if((/^a|area$/i.test(e.localName)&&e.hasAttribute("href")||e.visited)){' + source + '***REMOVED***';
                  break;
                case 'link':
                  source = 'if((/^a|area$/i.test(e.localName)&&e.hasAttribute("href"))){' + source + '***REMOVED***';
                  break;
                case 'visited':
                  source = 'if((/^a|area$/i.test(e.localName)&&e.hasAttribute("href")&&e.visited)){' + source + '***REMOVED***';
                  break;
                case 'target':
                  source = 'if(((s.doc.compareDocumentPosition(e)&16)&&s.doc.location.hash&&e.id==s.doc.location.hash.slice(1))){' + source + '***REMOVED***';
                  break;
                default:
                  emit('\'' + selector_string + '\'' + qsInvalid);
                  break;
            ...
            ***REMOVED***
            ...
            // :hover, :active, :focus, :focus-visible, :focus-within
              ...
              switch (match[1]) {
                case 'hover':
                  source = 'if(e===s.HOVER){' + source + '***REMOVED***';
                  break;
                case 'active':
                  source = 'if(e===s.doc.activeElement){' + source + '***REMOVED***';
                  break;
                case 'focus':
                  source = 'if(s.isFocusable(e)){' + source + '***REMOVED***';
                  break;
                case 'focus-visible':
                  source = 'if(n=s.isFocusable(e)){' +
                    'if(e!==n){while(e){e=e.parentElement;if(e===n)break;***REMOVED******REMOVED******REMOVED***' +
                    'if((e===n||e.autofocus)){' + source + '***REMOVED***';
                  break;
                case 'focus-within':
                  source = 'if(n=s.isFocusable(e)){' +
                    'if(n!==e){while(n){n=n.parentElement;if(n===e)break;***REMOVED******REMOVED******REMOVED***' +
                    'if((n===e||n.autofocus)){' + source + '***REMOVED***';
                  break;
                default:
                  emit('\'' + selector_string + '\'' + qsInvalid);
                  break;
                ...
                case 'disabled':
                  ...
                  source = 'if((("form" in e||/^optgroup$/i.test(e.localName))&&"disabled" in e)){' +
                    ...
                    'if(!(/^(optgroup|option)$/i.test(e.localName))){' +
                      ...
                      '***REMOVED***' +
                    '***REMOVED***' +
                    'if(e.disabled===true||(F&&!L)){' + source + '***REMOVED******REMOVED***';
                  break;
                case 'read-only':
                  source =
                    'if(' +
            ...
            ***REMOVED***
            ...
            // :playing, :paused, :seeking, :buffering, :stalled, :muted, :volume-locked
              ...
              switch (match[1]) {
                case 'playing':
                  source = 'if(s.isPlaying(e)){' + source + '***REMOVED***';
                  break;
                case 'paused':
                  source = 'if(!s.isPlaying(e)){' + source + '***REMOVED***';
                  break;
                ...
                case 'stalled':
                  break;
                case 'muted':
                  source = 'if(e.localName=="audio"&&e.getAttribute("muted")){' + source + '***REMOVED***';
                  break;
                case 'volume-locked':
                  break;
                default:
            ...
            ***REMOVED***
            ...
            // assert: e.type is in double-colon format, like ::after
              ...
              source = 'if(e.element&&e.type.toLowerCase()=="' +
                ':' + match[0].toLowerCase() + '"){e=e.element;' + source + '***REMOVED***';
            ***REMOVED***
            ...
            ***REMOVED***
              ...
              for (expr in Selectors) {
                if ((match = selector.match(Selectors[expr].Expression))) {
                  ...
                  if ('match' in result) { match = result.match; ***REMOVED***
                  vars = result.modvar;
                  if (mode) {
  ...
  select =
    function _querySelectorAll(selectors, context, callback) {
      ...
      ***REMOVED*** else if (lastContext !== context) {
  ...
  collect =
    function(selectors, context, callback) {
      ...
      var i, l, seen = { ***REMOVED***, token = ['', '*', '*'], optimized = selectors,
  ...
  initEnv =
    (function() {
      doc.addEventListener('mouseover', function(e) { Snapshot.HOVER = e.target; ***REMOVED***, true);
      doc.addEventListener('mouseout', function(e) { Snapshot.HOVER = null; ***REMOVED***, true);
    ***REMOVED***)(),
  ...
  // cached lambdas
  matchLambdas = { ***REMOVED***,
  selectLambdas = { ***REMOVED***,
