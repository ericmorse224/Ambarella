 ...
 * @param {string***REMOVED*** text The text to capitalize.
 * @returns {string***REMOVED*** The text that the 1st letter was capitalized.
 */
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            missingAwait: "{{name***REMOVED******REMOVED*** has no 'await' expression."
        ***REMOVED***
    ***REMOVED***,
