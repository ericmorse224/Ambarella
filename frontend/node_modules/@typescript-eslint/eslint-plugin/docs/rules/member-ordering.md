...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "default": ["signature", "method", "constructor", "field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
class Foo {
  ...
  constructor() {***REMOVED*** // -> constructor

  public static A(): void {***REMOVED*** // -> method
  public B(): void {***REMOVED*** // -> method
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "default": ["public-instance-method", "public-static-field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
class Foo {
  ...
  constructor() {***REMOVED*** // (irrelevant)

  public static A(): void {***REMOVED*** // (irrelevant)

  [Z: string]: any; // (irrelevant)

  public B(): void {***REMOVED*** // -> public instance method
***REMOVED***
```
...
```jsonc
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "default": ["public-static-field", "static-field", "instance-field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
```ts
const foo = class {
  public T(): void {***REMOVED*** // method (irrelevant)

  private static B: string; // -> static field

  constructor() {***REMOVED*** // constructor (irrelevant)
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "classes": ["method", "constructor", "field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "classExpressions": ["method", "constructor", "field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "interfaces": ["signature", "method", "constructor", "field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "typeLiterals": ["signature", "method", "constructor", "field"] ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
// .eslintrc.json
{
  "rules": {
    "@typescript-eslint/member-ordering": [
      "error",
      { "default": { "memberTypes": "never", "order": "alphabetically" ***REMOVED*** ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
