 ...
 * @param {string***REMOVED*** publicPath The publicPath value from webpack's compilation.
 * @param {Array<string>***REMOVED*** paths File paths to join
 * @return {string***REMOVED*** Joined file path
 *
 * @private
 */
