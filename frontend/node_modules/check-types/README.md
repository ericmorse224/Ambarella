...
```javascript
check.like({ foo: 'bar' ***REMOVED***, { foo: 'baz' ***REMOVED***);
// Returns true
```

```javascript
check.like({ foo: 'bar' ***REMOVED***, { baz: 'qux' ***REMOVED***);
// Returns false
```
...
***REMOVED***, {
    foo: check.odd,
    bar: { baz: check.nonEmptyString ***REMOVED***
***REMOVED***);
// Returns { foo: false, bar: { baz: true ***REMOVED*** ***REMOVED***
```
...
check.all(
    check.map(
        { foo: 0, bar: '' ***REMOVED***,
        { foo: check.number, bar: check.string ***REMOVED***
    )
);
// Returns true
```
