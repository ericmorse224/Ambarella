...
import {
  ...
  sourceContentFor,
  isIgnored,
***REMOVED*** from '@jridgewell/trace-mapping';
...
const traced = originalPositionFor(tracer, { line: 1, column: 5 ***REMOVED***);
...
```typescript
import { traceSegment ***REMOVED*** from '@jridgewell/trace-mapping';
...
```typescript
import { AnyMap ***REMOVED*** from '@jridgewell/trace-mapping';
const fooOutput = 'foo';
const barOutput = 'bar';
  ...
  sections: [
    {
      ...
      offset: { line: 0, column: 0 ***REMOVED***,
    ...
    ***REMOVED***,
    {
      ...
      offset: { line: 1, column: 0 ***REMOVED***,
      map: {
        version: 3,
        sources: ['bar.js'],
        names: ['bar'],
