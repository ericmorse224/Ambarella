 ...
 * const tracing = trace_events.createTracing({ categories: ['node.perf'] ***REMOVED***);
 ...
 *
 * The logging file is by default called `node_trace.${rotation***REMOVED***.log`, where `${rotation***REMOVED***` is an incrementing log-rotation id. The filepath pattern can
 * be specified with `--trace-event-file-pattern` that accepts a template
 * string that supports `${rotation***REMOVED***` and `${pid***REMOVED***`:
 *
 * ```bash
 * node --trace-event-categories v8 --trace-event-file-pattern '${pid***REMOVED***-${rotation***REMOVED***.log' server.js
 * ```
 *
...
declare module "trace_events" {
    ...
    interface Tracing {
         ...
         * ```js
         * import trace_events from 'node:trace_events';
         * const t1 = trace_events.createTracing({ categories: ['node', 'v8'] ***REMOVED***);
         * const t2 = trace_events.createTracing({ categories: ['node.perf', 'node'] ***REMOVED***);
         * t1.enable();
         * t2.enable();
         *
    ...
    ***REMOVED***
     ...
     * const tracing = trace_events.createTracing({ categories ***REMOVED***);
     * tracing.enable();
     * // do stuff
     * tracing.disable();
     * ```
     ...
     * ```js
     * import trace_events from 'node:trace_events';
     * const t1 = trace_events.createTracing({ categories: ['node.async_hooks'] ***REMOVED***);
     * const t2 = trace_events.createTracing({ categories: ['node.perf'] ***REMOVED***);
     * const t3 = trace_events.createTracing({ categories: ['v8'] ***REMOVED***);
     *
     * t1.enable();
     * t2.enable();
     *
