...
function fakeArg(fn) {
	return function (st) {
		...
		st.teardown(mockProperty(Object.prototype, 1, { value: 2 ***REMOVED***));
		return fn(st);
	***REMOVED***;
***REMOVED***
...
module.exports = function (includes, t) {
	...
	***REMOVED***);
	...
	t.test('regex searchString', function (st) {
		...
		st['throws'](function () { includes('foo[a-z]+(bar)?', /[a-z]+/); ***REMOVED***, TypeError);
		st['throws'](function () { includes('foo/[a-z]+/(bar)?', /[a-z]+/); ***REMOVED***, TypeError);
		st.equals(includes('foo[a-z]+(bar)?', '(bar)?'), true);
		st['throws'](function () { includes('foo[a-z]+(bar)?', /(bar)?/); ***REMOVED***, TypeError);
		st['throws'](function () { includes('foo[a-z]+/(bar)?/', /(bar)?/); ***REMOVED***, TypeError);
		st.end();
	***REMOVED***);
	...
	***REMOVED***);
	...
	t.test('nullish this object', function (st) {
		st['throws'](function () { includes(undefined); ***REMOVED***, TypeError);
		st['throws'](function () { includes(undefined, 'b'); ***REMOVED***, TypeError);
		st['throws'](function () { includes(undefined, 'b', 4); ***REMOVED***, TypeError);
		st['throws'](function () { includes(null); ***REMOVED***, TypeError);
		st['throws'](function () { includes(null, 'b'); ***REMOVED***, TypeError);
		st['throws'](function () { includes(null, 'b', 4); ***REMOVED***, TypeError);
		st.end();
	***REMOVED***);
	...
	t.test('cast this object', function (st) {
		...
		st.equals(includes({ toString: function () { return 'abc'; ***REMOVED*** ***REMOVED***, 'b', 0), true);
		st.equals(includes({ toString: function () { return 'abc'; ***REMOVED*** ***REMOVED***, 'b', 1), true);
		st.equals(includes({ toString: function () { return 'abc'; ***REMOVED*** ***REMOVED***, 'b', 2), false);
		st['throws'](function () { includes({ toString: function () { throw new RangeError(); ***REMOVED*** ***REMOVED***, /./); ***REMOVED***, RangeError);
		st['throws'](function () { includes({ toString: function () { return 'abc'; ***REMOVED*** ***REMOVED***, /./); ***REMOVED***, TypeError);
		st.end();
	***REMOVED***);
***REMOVED***;
