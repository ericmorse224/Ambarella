...
function getInterfaceName() {
  ...
  if (platform === 'darwin') {
    val = 'en';
  ***REMOVED*** else if (platform === 'win32') {
    val = null;
  ***REMOVED***
  return val;
***REMOVED***
 ...
 * Get all addresses.
 *
 * @param {String***REMOVED*** [interfaceName] interface name, default is 'eth' on linux, 'en' on mac os.
 * @param {Function(err, addr)***REMOVED*** callback
 *  - {Object***REMOVED*** addr {
 *    - {String***REMOVED*** ip
 *    - {String***REMOVED*** ipv6
 *    - {String***REMOVED*** mac
 ...
 *
 * @param {String***REMOVED*** [interfaceName] interface name, default is 'eth' on linux, 'en' on mac os.
 * @return {String***REMOVED*** IP address
 */
...
var MAC_LINUX_START_LINE = /^(\w+)\s{2,***REMOVED***link encap:\w+/i;

// ether 78:ca:39:b0:e6:7d
// HWaddr 00:16:3E:00:0A:29
var MAC_RE = address.MAC_RE = /(?:ether|HWaddr)\s+((?:[a-z0-9]{2***REMOVED***\:){5***REMOVED***[a-z0-9]{2***REMOVED***)/i;
 ...
 *
 * @param {String***REMOVED*** [interfaceName] interface name, default is 'eth' on linux, 'en' on mac os.
 * @param {Function(err, address)***REMOVED*** callback
 */
address.mac = function (interfaceName, callback) {
  ...
  ***REMOVED***
  ...
  child.exec(getIfconfigCMD(), {timeout: 5000***REMOVED***, function (err, stdout, stderr) {
    if (err || !stdout) {
      return callback(err);
    ***REMOVED***
 ...
 * Get DNS servers.
 *
 * @param {String***REMOVED*** [filepath] resolv config file path. default is '/etc/resolv.conf'.
 * @param {Function(err, servers)***REMOVED*** callback
 */
