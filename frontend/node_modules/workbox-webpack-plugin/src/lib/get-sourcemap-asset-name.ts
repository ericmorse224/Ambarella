...
import {getSourceMapURL***REMOVED*** from 'workbox-build/build/lib/get-source-map-url';
import upath from 'upath';
import type {Compilation***REMOVED*** from 'webpack';
 ...
 *
 * @param {Object***REMOVED*** compilation The current webpack compilation.
 * @param {string***REMOVED*** swContents The contents of the swSrc file, which may or
 * may not include a valid sourcemap comment.
 * @param {string***REMOVED*** swDest The configured swDest value.
 * @return {string|undefined***REMOVED*** If the swContents contains a valid sourcemap
