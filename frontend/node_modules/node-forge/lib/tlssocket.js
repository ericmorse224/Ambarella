...
forge.tls.wrapSocket = function(options) {
  ...
  var tlsSocket = {
    id: socket.id,
    // set handlers
    connected: socket.connected || function(e) {***REMOVED***,
    closed: socket.closed || function(e) {***REMOVED***,
    data: socket.data || function(e) {***REMOVED***,
    error: socket.error || function(e) {***REMOVED***
  ***REMOVED***;
