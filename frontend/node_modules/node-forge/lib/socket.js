...
var net = module.exports = forge.net = forge.net || {***REMOVED***;

// map of flash ID to socket pool
net.socketPools = {***REMOVED***;
...
net.createSocketPool = function(options) {
  ...
  api.init({marshallExceptions: !options.msie***REMOVED***);
    ...
    sp.handler = function(e) {
      if(e.id in sp.sockets) {
        ...
        ***REMOVED***
        ...
        setTimeout(function() {sp.sockets[e.id][f](e);***REMOVED***, 0);
      ***REMOVED***
    ***REMOVED***;
  ***REMOVED*** else {
    sp.handler = function(e) {
   ...
   */
   sp.createSocket = function(options) {
     ...
     var socket = {
       id: id,
       // set handlers
       connected: options.connected || function(e) {***REMOVED***,
       closed: options.closed || function(e) {***REMOVED***,
       data: options.data || function(e) {***REMOVED***,
       error: options.error || function(e) {***REMOVED***
     ***REMOVED***;
