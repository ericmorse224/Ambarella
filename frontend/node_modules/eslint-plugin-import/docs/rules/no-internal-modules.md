...
import { settings ***REMOVED*** from './app/index'; // Reaching to "./app/index" is not allowed
...
export { settings ***REMOVED*** from './app/index'; // Reaching to "./app/index" is not allowed
...
import { settings ***REMOVED*** from '../app';
import getUser from '../actions/getUser';

export * from 'source-map-support/register';
export { settings ***REMOVED*** from '../app';
```
...
import { getUser ***REMOVED*** from '../actions';

export * from 'source-map-support';
export { getUser ***REMOVED*** from '../actions';
```
