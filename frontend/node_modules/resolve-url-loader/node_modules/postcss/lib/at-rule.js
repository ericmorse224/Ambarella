 ...
 *
 * If it’s followed in the CSS by a {***REMOVED*** block, this node will have
 * a nodes property representing its children.
 *
 * @extends Container
 *
 * @example
 * const root = postcss.parse('@charset "UTF-8"; @media print {***REMOVED***')
 *
...
var AtRule = /*#__PURE__*/function (_Container) {
  ...
  ***REMOVED***
  /**
   * @memberof AtRule#
   * @member {string***REMOVED*** name The at-rule’s name immediately follows the `@`.
   *
   * @example
   * const root  = postcss.parse('@media print {***REMOVED***')
   * media.name //=> 'media'
  ...
  /**
   * @memberof AtRule#
   * @member {string***REMOVED*** params The at-rule’s parameters, the values
   *                         that follow the at-rule’s name but precede
   *                         any {***REMOVED*** block.
   *
   * @example
   * const root  = postcss.parse('@media print, screen {***REMOVED***')
   * const media = root.first
