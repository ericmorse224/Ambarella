...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'FocusEvent'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
    ...
    constructor(type) {
      ...
      ***REMOVED***
      const args = [];
      {
        ...
        curArg = conversions["DOMString"](curArg, { context: "Failed to construct 'FocusEvent': parameter 1" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
      {
        let curArg = arguments[1];
        curArg = FocusEventInit.convert(curArg, { context: "Failed to construct 'FocusEvent': parameter 2" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
  ...
  ***REMOVED***
  Object.defineProperties(FocusEvent.prototype, {
    relatedTarget: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "FocusEvent", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
