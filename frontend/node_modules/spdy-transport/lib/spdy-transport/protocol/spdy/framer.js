...
Framer.prototype.headersToDict = function headersToDict (headers,
  ...
  function stringify (value) {
    if (value !== undefined) {
      ...
      ***REMOVED*** else if (typeof value === 'string') {
        return value
      ***REMOVED*** else {
  ...
  ***REMOVED***
  ...
  var loweredHeaders = {***REMOVED***
  Object.keys(headers || {***REMOVED***).map(function (key) {
    loweredHeaders[key.toLowerCase()] = headers[key]
  ***REMOVED***)

  // Allow outer code to add custom headers or remove something
  if (preprocess) { preprocess(loweredHeaders) ***REMOVED***
  ...
  ***REMOVED***
  ...
  function preprocess (headers) {
    ...
    ***REMOVED*** else {
      ...
      headers[':scheme'] = scheme
      headers[':host'] = host
      if (frame.status) { headers[':status'] = frame.status ***REMOVED***
    ***REMOVED***
  ***REMOVED***
...
Framer.prototype.pushFrame = function pushFrame (frame, callback) {
  ...
  this._checkPush(function (err) {
    ...
    self._synFrame({
      ...
      headers: Object.assign(Object.assign({***REMOVED***, frame.headers), frame.response)
    ***REMOVED***, callback)
  ***REMOVED***)
***REMOVED***
...
Framer.prototype.headersFrame = function headersFrame (frame, callback) {
  ...
  this.headersToDict(frame.headers, null, function (err, chunks) {
    if (err) {
      if (callback) { return callback(err) ***REMOVED*** else {
        return self.emit('error', err)
      ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***, function (buf) {
      ...
      // Unused data
      if (self.version === 2) { buf.writeUInt16BE(0) ***REMOVED***
...
Framer.prototype.settingsFrame = function settingsFrame (options, callback) {
  ...
  ***REMOVED***, function (buf) {
    ...
    params.forEach(function (param) {
      ...
      ***REMOVED*** else { buf.writeUInt32BE(flag | param.key) ***REMOVED***
