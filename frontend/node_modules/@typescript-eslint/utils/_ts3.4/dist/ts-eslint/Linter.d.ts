...
import { ParserOptions as TSParserOptions ***REMOVED*** from './ParserOptions';
import { RuleCreateFunction, RuleFix, RuleModule, SharedConfigurationSettings ***REMOVED*** from './Rule';
