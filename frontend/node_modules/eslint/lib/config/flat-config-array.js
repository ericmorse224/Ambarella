 ...
 * @returns {string?***REMOVED*** The name of the object if found or `null` if there
 *      is no name.
 */
function getObjectId(object) {
    ...
    ***REMOVED***
    ...
    if (version) {
        return `${name***REMOVED***@${version***REMOVED***`;
    ***REMOVED***
 ...
 * @param {Error***REMOVED*** error The original error.
 * @param {number***REMOVED*** originalLength The original length of the config array.
 * @param {number***REMOVED*** baseLength The length of the base config.
 * @returns {TypeError***REMOVED*** The new error with details.
 */
function wrapConfigErrorWithDetails(error, originalLength, baseLength) {
    ...
    if (error.index < baseLength) {
        location = "base";
    ***REMOVED*** else if (error.index < originalLength + baseLength) {
        location = "original";
    ...
    ***REMOVED***
    ...
    return new TypeError(
        `${error.message.slice(0, -1)***REMOVED*** at ${location***REMOVED*** index ${configIndex***REMOVED***.`,
        { cause: error ***REMOVED***
    );
***REMOVED***
...
class FlatConfigArray extends ConfigArray {
     ...
     * @param {{basePath: string, shouldIgnore: boolean, baseConfig: FlatConfig***REMOVED******REMOVED*** options The options
    ...
    ***REMOVED*** = {***REMOVED***) {
        ...
        ***REMOVED***
         ...
         * @type {Array<FlatConfig>***REMOVED***
         */
        this[originalBaseConfig] = baseConfig;
        Object.defineProperty(this, originalBaseConfig, { writable: false ***REMOVED***);
        ...
        Object.defineProperty(this, "shouldIgnore", { writable: false ***REMOVED***);
    ***REMOVED***
     ...
     * @param {any***REMOVED*** [context] The context to use to normalize the array.
     * @returns {Promise<FlatConfigArray>***REMOVED*** A promise that resolves when the array is normalized.
     */
    normalize(context) {
    ...
    ***REMOVED***
     ...
     * any ConfigError exceptions with additional details.
     * @param {any***REMOVED*** [context] The context to use to normalize the array.
     * @returns {FlatConfigArray***REMOVED*** The current instance.
    ...
    [ConfigArraySymbol.preprocessConfig](config) {
        ...
        ***REMOVED***
        ...
        if (
            ...
            const { ignores, ...otherKeys ***REMOVED*** = config;
    ...
    ***REMOVED***
    ...
    [ConfigArraySymbol.finalizeConfig](config) {
        ...
        if (languageOptions && languageOptions.parser) {
            const { parser ***REMOVED*** = languageOptions;
        ...
        ***REMOVED***
        ...
        if (processor) {
            if (typeof processor === "string") {
                const { pluginName, objectName: localProcessorName ***REMOVED*** = splitPluginIdentifier(processor);

                processorName = processor;

                if (!plugins || !plugins[pluginName] || !plugins[pluginName].processors || !plugins[pluginName].processors[localProcessorName]) {
                    throw new TypeError(`Key "processor": Could not find "${localProcessorName***REMOVED***" in plugin "${pluginName***REMOVED***".`);
                ***REMOVED***

                config.processor = plugins[pluginName].processors[localProcessorName];
            ***REMOVED*** else if (typeof processor === "object") {
                ...
                return {
                    ...
                    plugins: Object.entries(plugins).map(([namespace, plugin]) => {
                        ...
                        ***REMOVED***
                        ...
                        return `${namespace***REMOVED***:${pluginId***REMOVED***`;
                    ***REMOVED***),
                    languageOptions: {
                        ...languageOptions,
                        parser: parserName
