...
/** @typedef {import("./target").ApiTargetProperties***REMOVED*** ApiTargetProperties */
/** @typedef {import("./target").EcmaTargetProperties***REMOVED*** EcmaTargetProperties */
...
/**
 * @typedef {object***REMOVED*** BrowserslistHandlerConfig
 * @property {string=***REMOVED*** configPath
 * @property {string=***REMOVED*** env
 * @property {string=***REMOVED*** query
 */

/**
 * @param {string | null | undefined***REMOVED*** input input string
 * @param {string***REMOVED*** context the context directory
 * @returns {BrowserslistHandlerConfig***REMOVED*** config
 */
const parse = (input, context) => {
	...
	***REMOVED***
	...
	if (path.isAbsolute(input)) {
		...
		return { configPath, env ***REMOVED***;
	***REMOVED***

	const config = browserslist.findConfig(context);

	if (config && Object.keys(config).includes(input)) {
		return { env: input ***REMOVED***;
	***REMOVED***

	return { query: input ***REMOVED***;
***REMOVED***;

/**
 * @param {string | null | undefined***REMOVED*** input input string
 * @param {string***REMOVED*** context the context directory
 * @returns {string[] | undefined***REMOVED*** selected browsers
 */
const load = (input, context) => {
	const { configPath, env, query ***REMOVED*** = parse(input, context);
	...
	const config =
		...
		(configPath
			? browserslist.loadConfig({
					...
					env
				***REMOVED***)
			: browserslist.loadConfig({ path: context, env ***REMOVED***));
...
/**
 * @param {string[]***REMOVED*** browsers supported browsers list
 * @returns {EcmaTargetProperties & PlatformTargetProperties & ApiTargetProperties***REMOVED*** target properties
 */
const resolve = browsers => {
	/**
	 * Checks all against a version number
	 * @param {Record<string, number | [number, number]>***REMOVED*** versions first supported version
	 * @returns {boolean***REMOVED*** true if supports
	 */
