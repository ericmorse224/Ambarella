...
| :----------------------: | :--------------------------------------------------: | :---------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|       **`title`**        |                      `{String***REMOVED***`                      |                     `Webpack App`                     | The title to use for the generated HTML document                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|      **`filename`**      |                 `{String\|Function***REMOVED***`                 |                    `'index.html'`                     | The file to write the HTML to. Defaults to `index.html`. You can specify a subdirectory here too (eg: `assets/admin.html`). The `[name]` placeholder will be replaced with the entry name. Can also be a function e.g. `(entryName) => entryName + '.html'`.                                                                                                                                                                                                                                                                               |
|      **`template`**      |                      `{String***REMOVED***`                      |                          ``                           | `webpack` relative or absolute path to the template. By default it will use `src/index.ejs` if it exists. Please see the [docs](https://github.com/jantimon/html-webpack-plugin/blob/master/docs/template-option.md) for details                                                                                                                                                                                                                                                                                                           |
|  **`templateContent`**   |             `{string\|Function\|false***REMOVED***`              |                         false                         | Can be used instead of `template` to provide an inline template - please read the [Writing Your Own Templates](https://github.com/jantimon/html-webpack-plugin#writing-your-own-templates) section                                                                                                                                                                                                                                                                                                                                         |
| **`templateParameters`** |            `{Boolean\|Object\|Function***REMOVED***`             |                        `false`                        | Allows to overwrite the parameters used in the template - see [example](https://github.com/jantimon/html-webpack-plugin/tree/master/examples/template-parameters)                                                                                                                                                                                                                                                                                                                                                                          |
|       **`inject`**       |                 `{Boolean\|String***REMOVED***`                  |                        `true`                         | `true \|\| 'head' \|\| 'body' \|\| false` Inject all assets into the given `template` or `templateContent`. When passing `'body'` all javascript resources will be placed at the bottom of the body element. `'head'` will place the scripts in the head element. Passing `true` will add it to the head/body depending on the `scriptLoading` option. Passing `false` will disable automatic injections. - see the [inject:false example](https://github.com/jantimon/html-webpack-plugin/tree/master/examples/custom-insertion-position) |
|     **`publicPath`**     |                  `{String\|'auto'***REMOVED***`                  |                       `'auto'`                        | The publicPath used for script and link tags                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|   **`scriptLoading`**    | `{'blocking'\|'defer'\|'module'\|'systemjs-module'***REMOVED***` |                       `'defer'`                       | Modern browsers support non blocking javascript loading (`'defer'`) to improve the page startup performance. Setting to `'module'` adds attribute [`type="module"`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules#applying_the_module_to_your_html). This also implies "defer", since modules are automatically deferred.                                                                                                                                                                                          |
|      **`favicon`**       |                      `{String***REMOVED***`                      |                          ``                           | Adds the given favicon path to the output HTML                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|        **`meta`**        |                      `{Object***REMOVED***`                      |                         `{***REMOVED***`                          | Allows to inject `meta`-tags. E.g. `meta: {viewport: 'width=device-width, initial-scale=1, shrink-to-fit=no'***REMOVED***`                                                                                                                                                                                                                                                                                                                                                                                                                             |
|        **`base`**        |              `{Object\|String\|false***REMOVED***`               |                        `false`                        | Inject a [`base`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/base) tag. E.g. `base: "https://example.com/path/page.html`                                                                                                                                                                                                                                                                                                                                                                                                    |
|       **`minify`**       |                 `{Boolean\|Object***REMOVED***`                  | `true` if `mode` is `'production'`, otherwise `false` | Controls if and in what ways the output should be minified. See [minification](#minification) below for more details.                                                                                                                                                                                                                                                                                                                                                                                                                      |
|        **`hash`**        |                     `{Boolean***REMOVED***`                      |                        `false`                        | If `true` then append a unique `webpack` compilation hash to all included scripts and CSS files (i.e. `main.js?hash=compilation_hash`). This is useful for cache busting                                                                                                                                                                                                                                                                                                                                                                   |
|       **`cache`**        |                     `{Boolean***REMOVED***`                      |                        `true`                         | Emit the file only if it was changed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|     **`showErrors`**     |                     `{Boolean***REMOVED***`                      |                        `true`                         | Errors details will be written into the HTML page                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|       **`chunks`**       |                        `{?***REMOVED***`                         |                          `?`                          | Allows you to add only some chunks (e.g only the unit-test chunk)                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|   **`chunksSortMode`**   |                 `{String\|Function***REMOVED***`                 |                        `auto`                         | Allows to control how chunks should be sorted before they are included to the HTML. Allowed values are `'none' \| 'auto' \| 'manual' \| {Function***REMOVED***`                                                                                                                                                                                                                                                                                                                                                                                        |
|   **`excludeChunks`**    |                  `{Array.<string>***REMOVED***`                  |                          ``                           | Allows you to skip some chunks (e.g don't add the unit-test chunk)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|       **`xhtml`**        |                     `{Boolean***REMOVED***`                      |                        `false`                        | If `true` render the `link` tags as self-closing (XHTML compliant)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
module: {
  loaders: [
    { test: /\.hbs$/, loader: "handlebars-loader" ***REMOVED***
  ]
***REMOVED***,
plugins: [
  new HtmlWebpackPlugin({
...
new HtmlWebpackPlugin({
  inject: false,
  templateContent: ({ htmlWebpackPlugin ***REMOVED***) => `
    <html>
      <head>
        ${htmlWebpackPlugin.tags.headTags***REMOVED***
      </head>
      <body>
        <h1>Hello World</h1>
        ${htmlWebpackPlugin.tags.bodyTags***REMOVED***
      </body>
    </html>
  `,
***REMOVED***);
...
```js
new HtmlWebpackPlugin({
  base: { href: "http://example.com/some/page.html" ***REMOVED***,
***REMOVED***);
```
...
```
    AsyncSeriesWaterfallHook<{
      assets: {
        publicPath: string,
        js: Array<{string***REMOVED***>,
        css: Array<{string***REMOVED***>,
...
```js
plugins: [new MyPlugin({ options: "" ***REMOVED***)];
```
