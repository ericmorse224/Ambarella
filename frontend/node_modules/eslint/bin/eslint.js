 ...
 * @returns {Promise<string>***REMOVED*** The read text.
 */
function readStdin() {
 ...
 * @param {any***REMOVED*** error The value to get.
 * @returns {string***REMOVED*** The error message.
 */
function getErrorMessage(error) {
	...
	***REMOVED***
	...
	if (typeof error.messageTemplate === "string") {
		try {
			const template = require(`../messages/${error.messageTemplate***REMOVED***.js`);

			return template(error.messageData || {***REMOVED***);
		***REMOVED*** catch {
 ...
 * @param {any***REMOVED*** error The thrown error object.
...
ESLint: ${version***REMOVED***

${getErrorMessage(error)***REMOVED***`;
...
(async function main() {
	...
	***REMOVED***
	...
	if (process.argv.includes("--mcp")) {
		const { mcpServer ***REMOVED*** = require("../lib/mcp/mcp-server");
		const {
			StdioServerTransport,
		***REMOVED*** = require("@modelcontextprotocol/sdk/server/stdio.js");

		await mcpServer.connect(new StdioServerTransport());

		// Note: do not use console.log() because stdout is part of the server transport
		console.error(`ESLint MCP server is running. cwd: ${process.cwd()***REMOVED***`);
