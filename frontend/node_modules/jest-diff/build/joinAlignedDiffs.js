...
const createPatchMark = (aStart, aEnd, bStart, bEnd, {patchColor***REMOVED***) =>
  patchColor(
    `@@ -${aStart + 1***REMOVED***,${aEnd - aStart***REMOVED*** +${bStart + 1***REMOVED***,${bEnd - bStart***REMOVED*** @@`
  ); // jest --no-expand
//
...
const joinAlignedDiffsNoExpand = (diffs, options) => {
  ...
  ***REMOVED*** else if (hasExcessAtStartOrEnd) {
  ...
  ***REMOVED*** // Indexes of expected or received lines in current patch:
  ...
  ***REMOVED***;
  ...
  const pushInsertLine = line => {
    ...
    bEnd += 1;
  ***REMOVED***; // Second pass: push lines with diff formatting (and patch marks, if needed).
