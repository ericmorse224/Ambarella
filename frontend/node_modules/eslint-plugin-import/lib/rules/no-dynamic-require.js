'use strict';var _docsUrl = require('../docsUrl');var _docsUrl2 = _interopRequireDefault(_docsUrl);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-dynamic-require') ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      return {
            ...
            ***REMOVED***
            if (isRequire(node)) {
              return context.report({
                node: node,
                message: 'Calls to require() should use string literals' ***REMOVED***);

            ***REMOVED***
            if (options.esmodule && isDynamicImport(node)) {
              return context.report({
                node: node,
                message: dynamicImportErrorMessage ***REMOVED***);
        ...
        ImportExpression: function () {function ImportExpression(node) {
          ...
          ***REMOVED***return ImportExpression;***REMOVED***() ***REMOVED***;
