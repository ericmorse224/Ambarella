"use strict";Object.defineProperty(exports, "__esModule", {value: true***REMOVED***); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj ***REMOVED***; ***REMOVED***var _keywords = require('../parser/tokenizer/keywords');
...
var _Transformer = require('./Transformer'); var _Transformer2 = _interopRequireDefault(_Transformer);
  ...
  ***REMOVED***
  ...
  processNamedExportEnum() {
    if (this.isImportsTransformEnabled) {
      ...
      this.processEnum();
      this.tokens.appendCode(` exports.${enumName***REMOVED*** = ${enumName***REMOVED***;`);
    ***REMOVED*** else {
  ...
  ***REMOVED***
  ...
  processDefaultExportEnum() {
    ...
    this.processEnum();
    if (this.isImportsTransformEnabled) {
      this.tokens.appendCode(` exports.default = ${enumName***REMOVED***;`);
    ***REMOVED*** else {
      this.tokens.appendCode(` export default ${enumName***REMOVED***;`);
    ***REMOVED***
  ***REMOVED***
   ...
   *
   * Initializer enums:
   * enum E {A = 1, B = 2***REMOVED***
   *   ->
   * const E = require("flow-enums-runtime")({A: 1, B: 2***REMOVED***);
   *
   * Symbol enums:
   * enum E of symbol {A, B***REMOVED***
   *   ->
   * const E = require("flow-enums-runtime")({A: Symbol("A"), B: Symbol("B")***REMOVED***);
   *
  ...
  processEnum() {
    ...
    ***REMOVED***
    ...
    this.tokens.replaceToken(isMirrored ? "]);" : "***REMOVED***);");
  ***REMOVED***
  ...
  processEnumElement(isSymbolEnum, hasInitializers) {
    if (isSymbolEnum) {
      ...
      this.tokens.copyToken();
      this.tokens.appendCode(`: Symbol("${elementName***REMOVED***")`);
    ***REMOVED*** else if (hasInitializers) {
    ...
    ***REMOVED*** else {
      ...
      // A, -> "A",
      this.tokens.replaceToken(`"${this.tokens.identifierName()***REMOVED***"`);
    ***REMOVED***
  ***REMOVED***
***REMOVED*** exports.default = FlowTransformer;
