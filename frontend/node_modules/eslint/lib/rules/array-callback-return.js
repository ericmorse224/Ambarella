 ...
 * @returns {boolean***REMOVED*** - `true` if the node is a void expression
 */
 ...
 * @param {Object***REMOVED*** sourceCode context given by context.sourceCode
 * @param {ASTNode***REMOVED*** node The node to fix.
 * @param {Object***REMOVED*** fixer The fixer object provided by ESLint.
 * @returns {Array<Object>***REMOVED*** - An array of fix objects to apply to the node.
 */
function voidPrependFixer(sourceCode, node, fixer) {
	...
	return [
		fixer.insertTextBefore(
			firstToken,
			`${prependSpace ? " " : ""***REMOVED***void ${requiresParens ? "(" : ""***REMOVED***`,
		),
...
/**
 * Fixes the linting error by `wrapping {***REMOVED***` around the given node's body.
 * @param {Object***REMOVED*** sourceCode context given by context.sourceCode
 * @param {ASTNode***REMOVED*** node The node to fix.
 * @param {Object***REMOVED*** fixer The fixer object provided by ESLint.
 * @returns {Array<Object>***REMOVED*** - An array of fix objects to apply to the node.
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			expectedAtEnd:
				"{{arrayMethodName***REMOVED******REMOVED***() expects a value to be returned at the end of {{name***REMOVED******REMOVED***.",
			expectedInside:
				"{{arrayMethodName***REMOVED******REMOVED***() expects a return value from {{name***REMOVED******REMOVED***.",
			expectedReturnValue:
				"{{arrayMethodName***REMOVED******REMOVED***() expects a return value from {{name***REMOVED******REMOVED***.",
			expectedNoReturnValue:
				"{{arrayMethodName***REMOVED******REMOVED***() expects no useless return value from {{name***REMOVED******REMOVED***.",
			wrapBraces: "Wrap the expression in `{***REMOVED***`.",
		...
		***REMOVED***;
		...
		function checkLastSegment(node) {
			...
			***REMOVED***
			...
			const messageAndSuggestions = { messageId: "", suggest: [] ***REMOVED***;
