...
```js
import { table ***REMOVED*** from 'table';

// Using commonjs?
// const { table ***REMOVED*** = require('table');
...
Type: `{ [type: string]: string ***REMOVED***`\
...
Type: `Column[] | { [columnIndex: number]: Column ***REMOVED***`
...
const config = {
  ...
  ***REMOVED***,
  columns: [
    ...
    { alignment: 'center' ***REMOVED***,
    { alignment: 'right' ***REMOVED***,
    { alignment: 'justify' ***REMOVED***
  ],
***REMOVED***;
...
const config = {
  ...
  ***REMOVED***,
  columns: [
    { verticalAlignment: 'top' ***REMOVED***,
    { verticalAlignment: 'middle' ***REMOVED***,
    { verticalAlignment: 'bottom' ***REMOVED***,
  ],
***REMOVED***;
...
- `content` **{string***REMOVED*****: the header content.
...
const config = {
  columns: [
    { alignment: 'center', width: 12 ***REMOVED***,
    { alignment: 'center', width: 10 ***REMOVED***,
    { alignment: 'right' ***REMOVED***,
    { alignment: 'right' ***REMOVED***,
    { alignment: 'right' ***REMOVED***,
    { alignment: 'right' ***REMOVED***
  ...
  spanningCells: [
    { col: 0, row: 0, colSpan: 6 ***REMOVED***,
    { col: 0, row: 2, rowSpan: 2, verticalAlignment: 'middle'***REMOVED***,
    { col: 0, row: 4, colSpan: 2, alignment: 'right'***REMOVED***,
    { col: 0, row: 5, rowSpan: 2, verticalAlignment: 'middle'***REMOVED***,
    { col: 0, row: 7, colSpan: 2, alignment: 'right' ***REMOVED***,
    { col: 0, row: 8, colSpan: 2, alignment: 'right' ***REMOVED***
  ],
***REMOVED***;
...
```js
import { createStream ***REMOVED*** from 'table';
...
```js
import { table, getBorderCharacters ***REMOVED*** from 'table';
