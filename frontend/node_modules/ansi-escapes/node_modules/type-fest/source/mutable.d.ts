import {Except***REMOVED*** from './except';
import {Simplify***REMOVED*** from './simplify';
...
@example
```
import {Mutable***REMOVED*** from 'type-fest';
...
const mutableFoo: Mutable<Foo> = {a: 1, b: ['2']***REMOVED***;
mutableFoo.a = 3;
...
export type Mutable<BaseType, Keys extends keyof BaseType = keyof BaseType> =
	Simplify<
        ...
        {-readonly [KeyType in keyof Pick<BaseType, Keys>]: Pick<BaseType, Keys>[KeyType]***REMOVED***
	>;
