  ...
  ***REMOVED***,
  ...
  create: Components.detect((context, components, utils) => {
    ...
    ***REMOVED***
     ...
     * @param {ASTNode***REMOVED*** node The AST node being checked.
     * @returns {boolean***REMOVED*** True if React.forwardRef is nested inside React.memo, false if not.
     */
    ...
    ***REMOVED***
     ...
     * @param {Object***REMOVED*** contextObj The context object to process
     */
    ...
    ***REMOVED***
     ...
     * @param {ASTNode***REMOVED*** node The AST node being checked.
     * @returns {boolean***REMOVED*** True if component has a name, false if not.
     */
    ...
    return {
      ExpressionStatement(node) {
        if (checkContextObjects && isCreateContext(node)) {
          contextObjects.set(node.expression.left.name, { node, hasDisplayName: false ***REMOVED***);
        ***REMOVED***
      ***REMOVED***,
      VariableDeclarator(node) {
        if (checkContextObjects && isCreateContext(node)) {
          contextObjects.set(node.id.name, { node, hasDisplayName: false ***REMOVED***);
        ***REMOVED***
      ***REMOVED***,
