 ...
 * @param {Node***REMOVED*** node A node to get child node list.
 * @returns {Node[]|null***REMOVED*** The child node list.
 */
 ...
 * @returns {boolean***REMOVED*** `true` if the node is the last statement in the parent block.
 */
function isLastChild(node) {
	...
	***REMOVED***
	...
	return nodeList !== null && nodeList.at(-1) === node; // before `***REMOVED***` or etc.
***REMOVED***
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		schema: [{ enum: ["last", "first"] ***REMOVED***],
		fixable: "whitespace",

		messages: {
			expectedSemiColon: "Expected this semicolon to be at {{pos***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {Token***REMOVED*** semiToken The semicolon token to check.
		 * @param {"first"|"last"***REMOVED*** expected The expected location to check.
