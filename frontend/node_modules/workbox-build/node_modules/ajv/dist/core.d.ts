export { Format, FormatDefinition, AsyncFormatDefinition, KeywordDefinition, KeywordErrorDefinition, CodeKeywordDefinition, MacroKeywordDefinition, FuncKeywordDefinition, Vocabulary, Schema, SchemaObject, AnySchemaObject, AsyncSchema, AnySchema, ValidateFunction, AsyncValidateFunction, AnyValidateFunction, ErrorObject, ErrorNoParams, ***REMOVED*** from "./types";
...
export { JTDSchemaType, SomeJTDSchemaType, JTDDataType ***REMOVED*** from "./types/jtd-schema";
export { _, str, stringify, nil, Name, Code, CodeGen, CodeGenOptions ***REMOVED*** from "./compile/codegen";
import type { Schema, AnySchema, AnySchemaObject, SchemaObject, AsyncSchema, Vocabulary, KeywordDefinition, AddedKeywordDefinition, AnyValidateFunction, ValidateFunction, AsyncValidateFunction, ErrorObject, Format, AddedFormat, RegExpEngine, UriResolver ***REMOVED*** from "./types";
import type { JSONSchemaType ***REMOVED*** from "./types/json-schema";
import type { JTDSchemaType, SomeJTDSchemaType, JTDDataType ***REMOVED*** from "./types/jtd-schema";
import ValidationError from "./runtime/validation_error";
import MissingRefError from "./compile/ref_error";
import { ValidationRules ***REMOVED*** from "./compile/rules";
import { SchemaEnv ***REMOVED*** from "./compile";
import { Code, ValueScope ***REMOVED*** from "./compile/codegen";
...
export default class Ajv {
    ...
    ***REMOVED***;
    ...
    { separator, dataVar ***REMOVED***?: ErrorsTextOptions): string;
