...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			unexpected:
				"Unexpected negating the left operand of '{{operator***REMOVED******REMOVED***' operator.",
			suggestNegatedExpression:
				"Negate '{{operator***REMOVED******REMOVED***' expression instead of its left operand. This changes the current behavior.",
	...
	***REMOVED***,
	...
	create(context) {
		...
		const [{ enforceForOrderingRelations ***REMOVED***] = context.options;
							...
							***REMOVED***,
							{
								...
								fix(fixer) {
									return fixer.replaceText(
										node.left,
										`(${sourceCode.getText(node.left)***REMOVED***)`,
									);
								***REMOVED***,
							***REMOVED***,
						],
