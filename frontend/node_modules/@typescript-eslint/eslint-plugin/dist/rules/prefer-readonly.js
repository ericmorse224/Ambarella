...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        fixable: 'code',
        messages: {
            preferReadonly: "Member '{{name***REMOVED******REMOVED***' is never reassigned; mark it as `readonly`.",
        ***REMOVED***,
        schema: [
            {
        ...
        type: 'suggestion',
    ***REMOVED***,
    defaultOptions: [{ onlyInlineLambdas: false ***REMOVED***],
    create(context, [{ onlyInlineLambdas ***REMOVED***]) {
        ...
        return {
            ...
            ***REMOVED***,
            'ClassDeclaration, ClassExpression:exit'() {
                ...
                for (const violatingNode of finalizedClassScope.finalizeUnmodifiedPrivateNonReadonlys()) {
                    const { esNode, nameNode ***REMOVED*** = getEsNodesFromViolatingNode(violatingNode);
                    context.report({
                        data: {
            ...
            ***REMOVED***,
            [functionScopeBoundaries](node) {
                ...
                ***REMOVED***
            ***REMOVED***,
            [`${functionScopeBoundaries***REMOVED***:exit`](node) {
                if (utils_1.ASTUtils.isConstructor(node)) {
