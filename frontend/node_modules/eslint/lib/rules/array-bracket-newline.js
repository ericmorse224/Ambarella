...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {string|Object|undefined***REMOVED*** option An option value to parse.
        ...
        function normalizeOptionValue(option) {
            ...
            if (option) {
                ...
                ***REMOVED*** else if (option === "always" || option.minItems === 0) {
                    minItems = 0;
        ...
        ***REMOVED***
        ...
        function reportNoEndingLinebreak(node, token) {
            context.report({
                ...
                fix(fixer) {
                    const previousToken = sourceCode.getTokenBefore(token, { includeComments: true ***REMOVED***);
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node A node to check. This is an ArrayExpression node or an ArrayPattern node.
         * @returns {void***REMOVED***
         */
        function check(node) {
            ...
            const firstIncComment = sourceCode.getTokenAfter(openBracket, { includeComments: true ***REMOVED***);
            const lastIncComment = sourceCode.getTokenBefore(closeBracket, { includeComments: true ***REMOVED***);
