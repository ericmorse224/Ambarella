 ...
 * ```js
 * import * as readline from 'node:readline/promises';
 * import { stdin as input, stdout as output ***REMOVED*** from 'node:process';
 *
 * const rl = readline.createInterface({ input, output ***REMOVED***);
 *
 * const answer = await rl.question('What do you think of Node.js? ');
 *
 * console.log(`Thank you for your valuable feedback: ${answer***REMOVED***`);
 *
 * rl.close();
 * ```
 *
...
declare module "readline" {
    ...
    ***REMOVED***
    ...
    export class Interface extends EventEmitter implements Disposable {
         ...
         *   console.log(`Oh, so your favorite food is ${answer***REMOVED***`);
         * ***REMOVED***);
         * ```
         *
         ...
         *
         * rl.question('What is your favorite food? ', { signal ***REMOVED***, (answer) => {
         *   console.log(`Oh, so your favorite food is ${answer***REMOVED***`);
         * ***REMOVED***);
         *
         * signal.addEventListener('abort', () => {
         *   console.log('The food question timed out');
         * ***REMOVED***, { once: true ***REMOVED***);
         *
         ...
         * rl.write(null, { ctrl: true, name: 'u' ***REMOVED***);
         * ```
         *
    ...
    ***REMOVED***
     ...
     * ```js
     * rl.on('line', (line) => {
     *   console.log(`Received: ${line***REMOVED***`);
     * ***REMOVED***);
     * ```
     *
     ...
     *       break;
     *     default:
     *       console.log(`Say what? I might have heard '${line.trim()***REMOVED***'`);
     *       break;
     *   ***REMOVED***
     *   rl.prompt();
     * ***REMOVED***).on('close', () => {
     ...
     *     console.log(`Line from file: ${line***REMOVED***`);
     *   ***REMOVED***
     * ***REMOVED***
     *
     * processLineByLine();
     ...
     *
     * ```js
     * import { once ***REMOVED*** from 'node:events';
     * import { createReadStream ***REMOVED*** from 'node:fs';
     * import { createInterface ***REMOVED*** from 'node:readline';
     *
     * (async function processLineByLine() {
     *   try {
