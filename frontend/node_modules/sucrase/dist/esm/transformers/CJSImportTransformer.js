...
import {IdentifierRole, isDeclaration, isObjectShorthandDeclaration***REMOVED*** from "../parser/tokenizer";
...
***REMOVED*** from "../util/getDeclarationInfo";
import getImportExportSpecifierInfo from "../util/getImportExportSpecifierInfo";
import isExportFrom from "../util/isExportFrom";
import {removeMaybeImportAttributes***REMOVED*** from "../util/removeMaybeImportAttributes";
...
export default class CJSImportTransformer extends Transformer {
   __init() {this.hadExport = false***REMOVED***
   __init2() {this.hadNamedExport = false***REMOVED***
   __init3() {this.hadDefaultExport = false***REMOVED***
  ...
  ***REMOVED***
  ...
  getPrefixCode() {
    let prefix = "";
    if (this.hadExport) {
      prefix += 'Object.defineProperty(exports, "__esModule", {value: true***REMOVED***);';
    ***REMOVED***
    return prefix;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  /**
   * Transform this:
   * import foo, {bar***REMOVED*** from 'baz';
   * into
    ...
    if (this.tokens.matches2(tt._import, tt.parenL)) {
      ...
      ***REMOVED***
      const requireWrapper = this.enableLegacyTypeScriptModuleInterop
        ? ""
        : `${this.helperManager.getHelperName("interopRequireWildcard")***REMOVED***(`;
      this.tokens.replaceToken(`Promise.resolve().then(() => ${requireWrapper***REMOVED***require`);
  ...
  ***REMOVED***
   ...
   *  properly distinguishes `import 'foo'` from `import {***REMOVED*** from 'foo'` for TS
   *  purposes.
   *
   ...
   */
    ...
    ***REMOVED*** else if (this.isFlowTransformEnabled) {
      // In Flow, unlike TS, `import {***REMOVED*** from 'foo';` preserves the import.
    ...
    ***REMOVED***
    ...
    if (this.tokens.tokens[possibleOpenParenIndex].type === tt.parenL) {
      if (
        ...
        this.tokens.replaceToken(`${replacement***REMOVED***.call(void 0, `);
      ...
      ***REMOVED*** else {
        ...
        this.tokens.replaceToken(`(0, ${replacement***REMOVED***)`);
      ***REMOVED***
    ***REMOVED*** else {
  ...
  ***REMOVED***
  ...
  processObjectShorthand() {
    ...
    if (!replacement) {
      return false;
    ***REMOVED***
    this.tokens.replaceToken(`${identifier***REMOVED***: ${replacement***REMOVED***`);
    return true;
  ***REMOVED***
  ...
  processExport() {
    ...
    ***REMOVED***
    if (this.tokens.matches2(tt._export, tt._default)) {
      ...
      ***REMOVED***
      ...
      return true;
    ***REMOVED*** else if (this.tokens.matches2(tt._export, tt.braceL)) {
    ...
    ***REMOVED*** else if (
      ...
      // export type {a***REMOVED***;
      // export type {a as b***REMOVED***;
      // export type {a***REMOVED*** from './b';
      // export type * from './b';
      ...
      ***REMOVED*** else {
        ...
        ***REMOVED***
      ***REMOVED***
      // Remove type re-export `... ***REMOVED*** from './T'`
      if (
    ...
    ***REMOVED*** else if (
      ...
      return true;
    ***REMOVED*** else if (this.tokens.matches2(tt._export, tt.star)) {
  ...
  ***REMOVED***
    ...
    ***REMOVED***
    this.tokens.copyToken();
    this.tokens.appendCode(` ${assignmentSnippet***REMOVED*** =`);
    return true;
  ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
    ...
    ***REMOVED***
    ...
    if (operatorCode === "++") {
      this.tokens.replaceToken(`(${base***REMOVED*** = ${assignmentSnippet***REMOVED*** = ${base***REMOVED*** + 1, ${base***REMOVED*** - 1)`);
    ***REMOVED*** else if (operatorCode === "--") {
      this.tokens.replaceToken(`(${base***REMOVED*** = ${assignmentSnippet***REMOVED*** = ${base***REMOVED*** - 1, ${base***REMOVED*** + 1)`);
    ***REMOVED*** else {
      throw new Error(`Unexpected operator: ${operatorCode***REMOVED***`);
    ***REMOVED***
    this.tokens.removeToken();
    return true;
  ***REMOVED***
   ...
   processExportDefault() {
    ...
    if (
      ...
      this.tokens.appendCode(` exports.default = ${name***REMOVED***;`);
    ***REMOVED*** else if (
    ...
    ***REMOVED*** else if (
      ...
      this.tokens.removeToken();
      this.tokens.removeToken();
    ***REMOVED*** else if (this.reactHotLoaderTransformer) {
      // We need to assign E to a variable. Change "export default E" to
      // "let _default; exports.default = _default = E"
      const defaultVarName = this.nameManager.claimFreeName("_default");
      this.tokens.replaceToken(`let ${defaultVarName***REMOVED***; exports.`);
      this.tokens.copyToken();
      this.tokens.appendCode(` = ${defaultVarName***REMOVED*** =`);
  ...
  ***REMOVED***
   ...
   *
   * For example, this:
   * export const f = () => {***REMOVED***;
   * becomes this:
   * const f = () => {***REMOVED***; exports.f = f;
   *
   ...
   */
    ...
    ***REMOVED***
    while (this.tokens.currentIndex() < endIndex) {
      this.rootTransformer.processToken();
    ***REMOVED***
    this.tokens.appendCode(`; exports.${varName***REMOVED*** = ${varName***REMOVED***`);
  ***REMOVED***

  /**
   * Transform normal declaration exports, including handling destructuring.
   * For example, this:
   * export const {x: [a = 2, b], c***REMOVED*** = d;
   * becomes this:
   * ({x: [exports.a = 2, exports.b], c: exports.c***REMOVED*** = d;)
   */
    ...
    ***REMOVED***
    ...
    while (true) {
      if (
        ...
        depth++;
        this.tokens.copyToken();
      ***REMOVED*** else if (this.tokens.matches1(tt.braceR) || this.tokens.matches1(tt.bracketR)) {
        depth--;
        this.tokens.copyToken();
      ***REMOVED*** else if (
        depth === 0 &&
        ...
        break;
      ***REMOVED*** else if (this.tokens.matches1(tt.eq)) {
      ...
      ***REMOVED*** else {
        ...
        if (isDeclaration(token)) {
          ...
          if (replacement === null) {
            throw new Error(`Expected a replacement for ${name***REMOVED*** in \`export var\` syntax.`);
          ***REMOVED***
          if (isObjectShorthandDeclaration(token)) {
            replacement = `${name***REMOVED***: ${replacement***REMOVED***`;
          ***REMOVED***
          this.tokens.replaceToken(replacement);
        ***REMOVED*** else {
          this.rootTransformer.processToken();
  ...
  ***REMOVED***
   ...
   * into this:
   * function foo() {***REMOVED*** exports.foo = foo;
   */
   processExportFunction() {
    this.tokens.replaceToken("");
    const name = this.processNamedFunction();
    this.tokens.appendCode(` exports.${name***REMOVED*** = ${name***REMOVED***;`);
  ***REMOVED***
   ...
   */
   processNamedFunction() {
    if (this.tokens.matches1(tt._function)) {
      this.tokens.copyToken();
    ***REMOVED*** else if (this.tokens.matches2(tt.name, tt._function)) {
  ...
  ***REMOVED***
  ...
  /**
   * Transform this:
   * export class A {***REMOVED***
   * into this:
   * class A {***REMOVED*** exports.A = A;
   */
   processExportClass() {
    this.tokens.removeInitialToken();
    this.copyDecorators();
  ...
  ***REMOVED***
   ...
   *
   * Transform this:
   * export {a, b as c***REMOVED*** from './foo';
    ...
    while (true) {
      ...
      ***REMOVED***
      ...
      if (!shouldRemoveExport) {
        ...
        ***REMOVED***
        ...
        exportStatements.push(`exports.${exportedName***REMOVED*** = ${newLocalName || localName***REMOVED***;`);
      ***REMOVED***
      ...
      ***REMOVED***
      if (this.tokens.matches2(tt.comma, tt.braceR)) {
        ...
        this.tokens.removeToken();
        break;
      ***REMOVED*** else if (this.tokens.matches1(tt.comma)) {
        this.tokens.removeToken();
      ***REMOVED*** else {
        throw new Error(`Unexpected token: ${JSON.stringify(this.tokens.currentToken())***REMOVED***`);
      ***REMOVED***
    ***REMOVED***
