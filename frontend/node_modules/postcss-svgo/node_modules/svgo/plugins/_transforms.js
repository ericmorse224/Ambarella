...
/**
 * @typedef {{ name: string, data: Array<number> ***REMOVED******REMOVED*** TransformItem
 */

/**
 * Convert transform string to JS representation.
 *
 * @type {(transformString: string) => Array<TransformItem>***REMOVED***
 */
exports.transform2js = (transformString) => {
  // JS representation of the transform data
  /**
   * @type {Array<TransformItem>***REMOVED***
   */
  const transforms = [];
  // current transform context
  /**
   * @type {null | TransformItem***REMOVED***
   */
  let current = null;
  ...
  for (const item of transformString.split(regTransformSplit)) {
    ...
    if (item) {
      ...
      if (regTransformTypes.test(item)) {
        ...
        current = { name: item, data: [] ***REMOVED***;
 ...
 *
 * @type {(transforms: Array<TransformItem>) => TransformItem***REMOVED***
 */
...
const mth = {
  /**
   * @type {(deg: number) => number***REMOVED***
   */
  rad: (deg) => {
  ...
  ***REMOVED***,
  ...
  /**
   * @type {(rad: number) => number***REMOVED***
   */
  deg: (rad) => {
  ...
  ***REMOVED***,
  ...
  /**
   * @type {(val: number, floatPrecision: number) => number***REMOVED***
   */
 ...
 * ***REMOVED******REMOVED*** TransformParams
 */
 ...
 *
 * @type {(transform: TransformItem, params: TransformParams) => Array<TransformItem>***REMOVED***
 */
 ...
 *
 * @type {(transform: TransformItem) => Array<number> ***REMOVED***
 */
const transformToMatrix = (transform) => {
  ...
  ***REMOVED***
  switch (transform.name) {
    ...
    default:
      throw Error(`Unknown transform ${transform.name***REMOVED***`);
  ***REMOVED***
***REMOVED***;
 ...
 *
 * @type {(a: Array<number>, b: Array<number>) => Array<number>***REMOVED***
 */
