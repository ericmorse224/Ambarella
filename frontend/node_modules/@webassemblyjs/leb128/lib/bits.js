...
function extract(buffer, bitIndex, bitLength, defaultBit) {
  ...
  ***REMOVED***
  ...
  if (defaultBit === undefined) {
    defaultBit = 0;
  ***REMOVED*** else if (defaultBit !== 0 && defaultBit !== 1) {
    throw new Error("Bad value for defaultBit.");
  ***REMOVED***

  var defaultByte = defaultBit * 0xff;
  var result = 0; // All starts are inclusive. The {endByte, endBit***REMOVED*** pair is exclusive, but
...
function inject(buffer, bitIndex, bitLength, value) {
  ...
  ***REMOVED*** // Just keeping it simple, until / unless profiling shows that this
  // is a problem.
