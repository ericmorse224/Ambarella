...
import type { ParserOptions as TSParserOptions ***REMOVED*** from './ParserOptions';
import type { RuleCreateFunction, RuleFix, RuleModule, SharedConfigurationSettings ***REMOVED*** from './Rule';
