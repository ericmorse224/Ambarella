...
var countDependencies = function countDependencies(dependencies, lastNode, context) {var _ref =
  context.options[0] || { max: DEFAULT_MAX ***REMOVED***,max = _ref.max;
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('max-dependencies') ***REMOVED***,
    ...
    schema: [
    {
      type: 'object',
      properties: {
        max: { type: 'number' ***REMOVED***,
        ignoreTypeImports: { type: 'boolean' ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function create(context) {var _ref2 =
      ...
      context.options[0] || {***REMOVED***,_ref2$ignoreTypeImpor = _ref2.ignoreTypeImports,ignoreTypeImports = _ref2$ignoreTypeImpor === undefined ? DEFAULT_IGNORE_TYPE_IMPORTS : _ref2$ignoreTypeImpor;
