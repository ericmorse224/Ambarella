...
function _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; ***REMOVED***
...
***REMOVED***
/**
 * The {@link Root***REMOVED***, {@link AtRule***REMOVED***, and {@link Rule***REMOVED*** container nodes
...
var Container = /*#__PURE__*/function (_Node) {
  ...
  ***REMOVED***
   ...
   * nodes, use {@link Container#walk***REMOVED***.
   *
   * Unlike the for `{***REMOVED***`-cycle or `Array#forEach` this iterator is safe
   * if you are mutating the array of child nodes during iteration.
   * PostCSS will adjust the current index to match the mutations.
   *
   * @param {childIterator***REMOVED*** callback Iterator receives each node and index.
   *
   * @return {false|undefined***REMOVED*** Returns `false` if iteration was broke.
   *
   * @example
   * const root = postcss.parse('a { color: black; z-index: 1 ***REMOVED***')
   * const rule = root.first
   *
   * for (const decl of rule.nodes) {
   *   decl.cloneBefore({ prop: '-webkit-' + decl.prop ***REMOVED***)
  ...
  _proto.each = function each(callback) {
    ...
    if (!this.indexes) this.indexes = {***REMOVED***;
    this.lastEach += 1;
  ...
  ***REMOVED***
   ...
   * use {@link Container#each***REMOVED***.
   *
   * @param {childIterator***REMOVED*** callback Iterator receives each node and index.
   *
   * @return {false|undefined***REMOVED*** Returns `false` if iteration was broke.
  ...
  _proto.walk = function walk(callback) {
    return this.each(function (child, i) {
      ...
      ***REMOVED*** catch (e) {
        ...
        if (e.stack && child.source && /\n\s{4***REMOVED***at /.test(e.stack)) {
          var s = child.source;
          e.stack = e.stack.replace(/\n\s{4***REMOVED***at /, "$&" + s.input.from + ":" + s.start.line + ":" + s.start.column + "$&");
        ***REMOVED***
  ...
  ***REMOVED***
   ...
   *
   * Like {@link Container#each***REMOVED***, this method is safe
   * to use if you are mutating arrays during iteration.
   *
   * @param {string|RegExp***REMOVED*** [prop]   String or regular expression
  ...
  ***REMOVED***
   ...
   * to use if you are mutating arrays during iteration.
   *
   * @param {string|RegExp***REMOVED*** [selector] String or regular expression
   ...
   * ***REMOVED***)
   * console.log(`Your CSS uses ${ selectors.length ***REMOVED*** selectors`)
   */
  ;
  ...
  ***REMOVED***
   ...
   * to use if you are mutating arrays during iteration.
   *
   * @param {string|RegExp***REMOVED*** [name]   String or regular expression
  ...
  ***REMOVED***
   ...
   *
   * @param {...(Node|object|string|Node[])***REMOVED*** children New nodes.
   *
   * @return {Node***REMOVED*** This node for methods chain.
   *
   * @example
   * const decl1 = postcss.decl({ prop: 'color', value: 'black' ***REMOVED***)
   * const decl2 = postcss.decl({ prop: 'background-color', value: 'white' ***REMOVED***)
   * rule.append(decl1, decl2)
   *
   * root.append({ name: 'charset', params: '"UTF-8"' ***REMOVED***)  // at-rule
   * root.append({ selector: 'a' ***REMOVED***)                       // rule
   * rule.append({ prop: 'color', value: 'black' ***REMOVED***)       // declaration
   * rule.append({ text: 'Comment' ***REMOVED***)                     // comment
   *
   * root.append('a {***REMOVED***')
  ...
  ***REMOVED***
   ...
   *
   * @param {Node|number***REMOVED*** exist             Child or child’s index.
   * @param {Node|object|string|Node[]***REMOVED*** add New node.
   *
   * @return {Node***REMOVED*** This node for methods chain.
   *
   * @example
   * rule.insertBefore(decl, decl.clone({ prop: '-webkit-' + decl.prop ***REMOVED***))
   */
  ;
  ...
  ***REMOVED***
   ...
   *
   * @param {Node|number***REMOVED*** child Child or child’s index.
   *
   * @return {Node***REMOVED*** This node for methods chain
   *
   * @example
  ...
  ***REMOVED***
   ...
   *
   * @param {string|RegExp***REMOVED*** pattern      Replace pattern.
   * @param {object***REMOVED*** opts                Options to speed up the search.
   * @param {string|string[]***REMOVED*** opts.props An array of property names.
   * @param {string***REMOVED*** opts.fast           String that’s used to narrow down
   *                                     values and speed up the regexp search.
   * @param {function|string***REMOVED*** callback   String to replace pattern or callback
   ...
   *
   * @example
   * root.replaceValues(/\d+rem/, { fast: 'rem' ***REMOVED***, string => {
  ...
  ***REMOVED***
   ...
   *
   * @param {childCondition***REMOVED*** condition Iterator returns true or false.
   *
   * @return {boolean***REMOVED*** Is every child pass condition.
   *
   * @example
  ...
  ***REMOVED***
   ...
   * @param {childCondition***REMOVED*** condition Iterator returns true or false.
   *
   * @return {boolean***REMOVED*** Is some child pass condition.
   *
   * @example
  ...
  ***REMOVED***
  /**
   * Returns a `child`’s index within the {@link Container#nodes***REMOVED*** array.
   *
   * @param {Node***REMOVED*** child Child of the current container.
   *
   * @return {number***REMOVED*** Child index.
   *
   * @example
  ...
  ***REMOVED***
  ...
  _proto.normalize = function normalize(nodes, sample) {
    ...
    ***REMOVED*** else if (Array.isArray(nodes)) {
      nodes = nodes.slice(0);
      ...
      ***REMOVED***
    ***REMOVED*** else if (nodes.type === 'root') {
      ...
      ***REMOVED***
    ***REMOVED*** else if (nodes.type) {
      nodes = [nodes];
    ***REMOVED*** else if (nodes.prop) {
      if (typeof nodes.value === 'undefined') {
        throw new Error('Value field is missed in node creation');
      ***REMOVED*** else if (typeof nodes.value !== 'string') {
        nodes.value = String(nodes.value);
      ***REMOVED***

      nodes = [new _declaration.default(nodes)];
    ***REMOVED*** else if (nodes.selector) {
      var Rule = require('./rule');

      nodes = [new Rule(nodes)];
    ***REMOVED*** else if (nodes.name) {
      var AtRule = require('./at-rule');

      nodes = [new AtRule(nodes)];
    ***REMOVED*** else if (nodes.text) {
  ...
  ***REMOVED***
  /**
   * @memberof Container#
   * @member {Node[]***REMOVED*** nodes An array containing the container’s children.
   *
   * @example
   * const root = postcss.parse('a { color: black ***REMOVED***')
   * root.nodes.length           //=> 1
 ...
 * @param {Node***REMOVED*** node    Container child.
 * @param {number***REMOVED*** index Child index.
 * @param {Node[]***REMOVED*** nodes All container children.
 ...
 * @param {Node***REMOVED*** node    Container child.
 * @param {number***REMOVED*** index Child index.
 * @return {false|undefined***REMOVED*** Returning `false` will break iteration.
 */
