 ...
 * @returns {boolean***REMOVED*** True if the node is callee of a `NewExpression` node
 * @private
 */
...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @returns {boolean***REMOVED*** True if it is wrapped in any parens
         * @private
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node node to evaluate
         * @returns {boolean***REMOVED*** True if it is wrapped in grouping parens
         * @private
         */
        ...
        ***REMOVED***
         ...
         * @param {ASTNode***REMOVED*** node node to evaluate
         * @returns {ASTNode***REMOVED*** node that is the function expression of the given IIFE, or null if none exist
         */
                ...
                if (!isCallExpressionWrapped && !isFunctionExpressionWrapped) {
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            return fixer.replaceText(nodeToSurround, `(${sourceCode.getText(nodeToSurround)***REMOVED***)`);
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED*** else if (style === "inside" && !isFunctionExpressionWrapped) {
                    context.report({
                        node,
                        ...
                        fix(fixer) {
                            ...
                            if (isWrappedInGroupingParens(node) && !isCalleeOfNewExpression(node)) {
                                 ...
                                 * for example, in `(function(foo) {***REMOVED***(bar))`, the range `(bar))` should get replaced with `)(bar)`.
                                 */
                                ...
                                return fixer.replaceTextRange(
                                    ...
                                    `)${sourceCode.getText().slice(innerNode.range[1], parenAfter.range[0])***REMOVED***`
                                );
                            ***REMOVED***
                            ...
                            return fixer.replaceText(innerNode, `(${sourceCode.getText(innerNode)***REMOVED***)`);
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED*** else if (style === "outside" && !isCallExpressionWrapped) {
                    context.report({
                        node,
                        ...
                        fix(fixer) {
                             ...
                             * and the call expression. For example, in `(function(foo) {***REMOVED***)(bar)`, the range `)(bar)`
                            ...
                            return fixer.replaceTextRange(
                                ...
                                `${sourceCode.getText().slice(parenAfter.range[1], node.range[1])***REMOVED***)`
                            );
                        ***REMOVED***
                    ***REMOVED***);
                ***REMOVED***
