import type { Lib, TSESTree ***REMOVED*** from '@typescript-eslint/types';
import type { Scope ***REMOVED*** from '../scope';
import type { ScopeManager ***REMOVED*** from '../ScopeManager';
import type { ReferenceImplicitGlobal ***REMOVED*** from './Reference';
import type { VisitorOptions ***REMOVED*** from './Visitor';
import { Visitor ***REMOVED*** from './Visitor';
...
***REMOVED***
export { Referencer, ReferencerOptions ***REMOVED***;
