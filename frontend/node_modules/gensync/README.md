...
* `.errback(...args, (err, result) => {***REMOVED***)` - Calls the callback with the computed value, or error.
...
readFileAndMore.async("./file.js", "utf8").then(code => {***REMOVED***)
readFileAndMore.errback("./file.js", "utf8", (err, code) => {***REMOVED***);
...
readFile.async("./file.js", "utf8").then(code => {***REMOVED***)
readFile.errback("./file.js", "utf8", (err, code) => {***REMOVED***);
```
