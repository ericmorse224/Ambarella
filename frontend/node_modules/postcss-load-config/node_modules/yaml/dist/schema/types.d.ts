import type { CreateNodeContext ***REMOVED*** from '../doc/createNode';
import type { Node ***REMOVED*** from '../nodes/Node';
...
import type { ParseOptions ***REMOVED*** from '../options';
import type { StringifyContext ***REMOVED*** from '../stringify/stringify';
import type { Schema ***REMOVED*** from './Schema';
interface TagBase {
    /**
