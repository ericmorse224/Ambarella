...
export interface Options {
    ...
    /**
     * Arrays of regex'es that allow to support custom attribute assign expressions (e.g. `'<div flex?="{{mode != cover***REMOVED******REMOVED***"></div>'`)
     * @default []
     */
    ...
    /**
     * Arrays of regex'es that allow to support custom attribute surround expressions (e.g. `<input {{#if value***REMOVED******REMOVED***checked="checked"{{/if***REMOVED******REMOVED***>`)
     * @default []
     */
    ...
    /**
     * Array of regex'es that allow to ignore certain fragments, when matched (e.g. `<?php ... ?>`, `{{ ... ***REMOVED******REMOVED***`, etc.)
     * @default [/<%[\s\S]*?%>/, /<\?[\s\S]\*?\?>/]
     */
