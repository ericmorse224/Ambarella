...
export namespace visitors {
     ...
     * - `Identifier() { ... ***REMOVED***` -> `Identifier: { enter() { ... ***REMOVED*** ***REMOVED***`
     * - `"Identifier|NumericLiteral": { ... ***REMOVED***` -> `Identifier: { ... ***REMOVED***, NumericLiteral: { ... ***REMOVED***`
     * - Aliases in `@babel/types`: e.g. `Property: { ... ***REMOVED***` -> `ObjectProperty: { ... ***REMOVED***, ClassProperty: { ... ***REMOVED***`
     *
    ...
    function explode<S = unknown>(
        ...
        [Type in Exclude<Node, t.DeprecatedAliases>["type"]]?: VisitNodeObject<S, Extract<Node, { type: Type ***REMOVED***>>;
    ***REMOVED***;
...
export class Scope {
    ...
    parent: Scope;
    hub: HubInterface;
    bindings: { [name: string]: Binding ***REMOVED***;
    references: { [name: string]: true ***REMOVED***;
    globals: { [name: string]: t.Identifier | t.JSXIdentifier ***REMOVED***;
    uids: { [name: string]: boolean ***REMOVED***;
...
export class Binding {
    constructor(opts: { identifier: t.Identifier; scope: Scope; path: NodePath; kind: BindingKind ***REMOVED***);
...
export type Visitor<S = unknown> =
    ...
    & {
        [N in Node as N["type"]]?: VisitNode<S, N extends { type: N["type"] ***REMOVED*** ? N : never>;
    ***REMOVED***
    & {
    ...
    ***REMOVED***
    & {
        ...
        [k: `${string***REMOVED***|${string***REMOVED***`]: VisitNode<S, Node>;
    ***REMOVED***;
...
export type NodePaths<T extends Node | readonly Node[]> = T extends readonly Node[]
    ? { -readonly [K in keyof T]: NodePath<Extract<T[K], Node>> ***REMOVED***
...
export class NodePath<T = Node> {
    ...
    ***REMOVED***): NodePath<C[K]>;
    static get<C extends Node, L extends NodeKeyOfArrays<C>>(opts: {
        ...
        listKey: L;
        key: number;
    ***REMOVED***): C[L] extends Array<Node | null | undefined> ? NodePath<C[L][number]> : never;
     ...
     *
     * Returns an object in the form `{ confident, value, deopt ***REMOVED***`. `confident`
     ...
     * Example:
     *
     *   t.evaluate(parse("5 + 5")) // { confident: true, value: 10 ***REMOVED***
     *   t.evaluate(parse("!true")) // { confident: true, value: false ***REMOVED***
     *   t.evaluate(parse("foo + foo")) // { confident: false, value: undefined, deopt: NodePath ***REMOVED***
     */
    evaluate(): {
        confident: boolean;
        value: any;
    ...
    ***REMOVED***?: {
        ...
        noNewArrows?: boolean;
    ***REMOVED***): NodePath<Exclude<t.Function, t.Method | t.ArrowFunctionExpression> | t.CallExpression>;
...
type ImplGetOfArray<T extends readonly unknown[], K extends string> =
    K extends `${infer N extends number***REMOVED***` ? T[N]
...
type ImplGetByKey<T, K extends string>
    ...
    : K extends keyof T ? T[K]
    : K extends `${infer N extends number***REMOVED***`
        ? N extends keyof T ? T[N] : never
    : never;

// dprint-ignore
type ImplGetRecursive<T, K extends string>
    = K extends `${infer L***REMOVED***.${infer R***REMOVED***`
