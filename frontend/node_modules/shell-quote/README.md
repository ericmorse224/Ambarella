...
``` js
var parse = require('shell-quote/parse');
var xs = parse('beep --boop="$PWD"', { PWD: '/home/robot' ***REMOVED***);
console.dir(xs);
```
...
``` js
var parse = require('shell-quote/parse');
var xs = parse('beep ^--boop="$PWD"', { PWD: '/home/robot' ***REMOVED***, { escape: '^' ***REMOVED***);
console.dir(xs);
```
...
```
[ 'beep', { op: '>' ***REMOVED***, 'boop', { comment: '> kaboom' ***REMOVED*** ]
```
...
## parse(cmd, env={***REMOVED***)

Return an array of arguments from the quoted string `cmd`.

Interpolate embedded bash-style `$VARNAME` and `${VARNAME***REMOVED***` variables with
