...
var sortedFlags = availableFlags.slice().sort(function (a, b) { return a.localeCompare(b); ***REMOVED***).join('');
...
module.exports = function runTests(flags, t) {
	forEach(v.primitives, function (nonObject) {
		t['throws'](
			function () { flags(nonObject); ***REMOVED***,
			TypeError,
	...
	***REMOVED***);
	...
	t.test('sorting', function (st) {
		...
		***REMOVED***
		...
		var randomFlags = availableFlags.slice().sort(function () { return Math.random() > 0.5 ? 1 : -1; ***REMOVED***).join('').replace('v', '');
		st.equal(
	...
	***REMOVED***);
	...
	t.test('generic flags', function (st) {
		st.equal(flags({***REMOVED***), '');
		st.equal(flags({ ignoreCase: true ***REMOVED***), 'i');
		st.equal(flags({ dotAll: 1, global: 0, sticky: 1, unicode: 1 ***REMOVED***), 'suy');
		st.equal(flags({ __proto__: { multiline: true ***REMOVED*** ***REMOVED***), 'm');
	...
	***REMOVED***);
	...
	t.test('getters', { skip: !supportsDescriptors ***REMOVED***, function (st) {
