...
var Base = function(request, url, options) {
  Emitter.call(this);
  Base.validateOptions(options || {***REMOVED***, ['maxLength', 'masking', 'requireMasking', 'protocols']);
...
var instance = {
  ...
  _bindEventListeners: function() {
    ...
    this.messages.on('error', function() {***REMOVED***);
  ...
  ***REMOVED***,
  ...
  _open: function() {
    this.readyState = 1;
    this.__queue.forEach(function(args) { this.frame.apply(this, args) ***REMOVED***, this);
    this.__queue = [];
...
Base.ConnectEvent = function() {***REMOVED***;

Base.OpenEvent = function() {***REMOVED***;
