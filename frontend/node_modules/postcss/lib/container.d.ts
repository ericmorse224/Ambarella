...
import Node, { ChildNode, ChildProps, NodeProps ***REMOVED*** from './node.js'
...
declare namespace Container {
  ...
  ***REMOVED***
  ...
  export { Container_ as default ***REMOVED***
***REMOVED***
...
declare abstract class Container_<Child extends Node = ChildNode> extends Node {
   ...
   *
   * ```js
   * const decl1 = new Declaration({ prop: 'color', value: 'black' ***REMOVED***)
   * const decl2 = new Declaration({ prop: 'background-color', value: 'white' ***REMOVED***)
   ...
   *
   * ```js
   * rule.push(new Declaration({ prop: 'color', value: 'black' ***REMOVED***))
   * ```
   *
  ...
  replaceValues(
    ...
    replaced: { (substring: string, ...args: any[]): string ***REMOVED*** | string
  ): this
  /**
   ...
   * @param {object***REMOVED*** options             Options to speed up the search.
  ...
  /**
   * An internal method that converts a {@link NewChild***REMOVED*** into a list of actual
...
declare class Container<
  Child extends Node = ChildNode
> extends Container_<Child> {***REMOVED***
