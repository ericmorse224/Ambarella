            ...
            switch (node.type) {
                case "NewExpression":
                    if (!node.arguments.length &&
                        !(
                            astUtils.isOpeningParenToken(sourceCode.getLastToken(node, { skip: 1 ***REMOVED***)) &&
                ...
                ***REMOVED***
                ...
                case "ArrowFunctionExpression": {
                    const firstToken = sourceCode.getFirstToken(node, { skip: (node.async ? 1 : 0) ***REMOVED***);
                ...
                ***REMOVED***
                ...
                default:
                    throw new TypeError(`unexpected node with type ${node.type***REMOVED***`);
            ***REMOVED***
        ***REMOVED***
