...
test('shimmed', function (t) {
	...
	***REMOVED***);
	...
	t.test('bad object value', { skip: !supportsStrictMode ***REMOVED***, function (st) {
		st['throws'](function () { return Object.assign(undefined); ***REMOVED***, TypeError, 'undefined is not an object');
		st['throws'](function () { return Object.assign(null); ***REMOVED***, TypeError, 'null is not an object');
		st.end();
	***REMOVED***);

	// v8 in node 0.8 and 0.10 have non-enumerable string properties
	var stringCharsAreEnumerable = isEnumerable.call('xy', 0);
	t.test('when Object.assign is present and has pending exceptions', { skip: !stringCharsAreEnumerable || !Object.preventExtensions ***REMOVED***, function (st) {
		/*
		 * Firefox 37 still has "pending exception" logic in its Object.assign implementation,
		 * which is 72% slower than our shim, and Firefox 40's native implementation.
		 */
		var thrower = Object.preventExtensions({ 1: '2' ***REMOVED***);
		var error;
		try { Object.assign(thrower, 'xy'); ***REMOVED*** catch (e) { error = e; ***REMOVED***
