...
***REMOVED*** from "http";
import { Server as HTTPSServer ***REMOVED*** from "https";
import { createConnection ***REMOVED*** from "net";
import { Duplex, DuplexOptions ***REMOVED*** from "stream";
import { SecureContextOptions ***REMOVED*** from "tls";
import { URL ***REMOVED*** from "url";
import { ZlibOptions ***REMOVED*** from "zlib";
...
type BufferLike =
    ...
    | readonly any[]
    | readonly number[]
    | { valueOf(): ArrayBuffer ***REMOVED***
    | { valueOf(): SharedArrayBuffer ***REMOVED***
    | { valueOf(): Uint8Array ***REMOVED***
    | { valueOf(): readonly number[] ***REMOVED***
    | { valueOf(): string ***REMOVED***
    | { [Symbol.toPrimitive](hint: string): string ***REMOVED***;
...
declare class WebSocket extends EventEmitter {
    ...
    addEventListener<K extends keyof WebSocket.WebSocketEventMap>(
        ...
        listener:
            ...
            | { handleEvent(event: WebSocket.WebSocketEventMap[K]): void ***REMOVED***,
...
interface WebSocketAlias extends WebSocket {***REMOVED*** // eslint-disable-line @typescript-eslint/no-empty-interface
...
declare namespace WebSocket {
    ...
    ***REMOVED***) => boolean;
    ...
    type VerifyClientCallbackAsync<Request extends IncomingMessage = IncomingMessage> = (
        info: { origin: string; secure: boolean; req: Request ***REMOVED***,
    ...
    interface ClientOptions extends SecureContextOptions {
        ...
        headers?: { [key: string]: string ***REMOVED*** | undefined;
    ...
    ***REMOVED***
    ...
    interface WebSocketServer extends Server {***REMOVED*** // eslint-disable-line @typescript-eslint/no-empty-interface
    const WebSocket: typeof WebSocketAlias;
    interface WebSocket extends WebSocketAlias {***REMOVED*** // eslint-disable-line @typescript-eslint/no-empty-interface
