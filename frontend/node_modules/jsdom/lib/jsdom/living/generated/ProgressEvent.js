...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'ProgressEvent'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
    ...
    constructor(type) {
      ...
      ***REMOVED***
      const args = [];
      {
        ...
        curArg = conversions["DOMString"](curArg, { context: "Failed to construct 'ProgressEvent': parameter 1" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
      {
        let curArg = arguments[1];
        curArg = ProgressEventInit.convert(curArg, { context: "Failed to construct 'ProgressEvent': parameter 2" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
  ...
  ***REMOVED***
  Object.defineProperties(ProgressEvent.prototype, {
    lengthComputable: { enumerable: true ***REMOVED***,
    loaded: { enumerable: true ***REMOVED***,
    total: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "ProgressEvent", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
