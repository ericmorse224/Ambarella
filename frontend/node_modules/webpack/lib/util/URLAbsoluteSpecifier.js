...
/** @typedef {import("./fs").InputFileSystem***REMOVED*** InputFileSystem */
/** @typedef {(error: Error|null, result?: Buffer) => void***REMOVED*** ErrorFirstCallback */
 ...
 * @param {string***REMOVED*** specifier specifier
 * @returns {string|undefined***REMOVED*** scheme if absolute URL specifier provided
 */
...
/**
 * @param {string***REMOVED*** specifier specifier
 * @returns {string | null | undefined***REMOVED*** protocol if absolute URL specifier provided
 */
function getProtocol(specifier) {
	const scheme = getScheme(specifier);
	return scheme === undefined ? undefined : `${scheme***REMOVED***:`;
***REMOVED***
