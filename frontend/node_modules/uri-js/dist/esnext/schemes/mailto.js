import { pctEncChar, pctDecChars, unescapeComponent ***REMOVED*** from "../uri";
import punycode from "punycode";
import { merge, subexp, toUpperCase, toArray ***REMOVED*** from "../util";
const O = {***REMOVED***;
const isIRI = true;
//RFC 3986
...
const handler = {
    ...
    ***REMOVED***,
    serialize: function (mailtoComponents, options) {
        ...
        ***REMOVED***
        const headers = mailtoComponents.headers = mailtoComponents.headers || {***REMOVED***;
