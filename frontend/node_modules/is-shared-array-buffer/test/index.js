...
test('isSharedArrayBuffer', function (t) {
	...
	***REMOVED***);
	...
	t.test('actual SharedArrayBuffer instances', { skip: typeof SharedArrayBuffer === 'undefined' ***REMOVED***, function (st) {
	...
	***REMOVED***);
	...
	t.test('Typed Arrays', { skip: availableTypedArrays.length === 0 ***REMOVED***, function (st) {
