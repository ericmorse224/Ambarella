...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'SVGSVGElement'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
  ...
  ***REMOVED***
  Object.defineProperties(SVGSVGElement.prototype, {
    createSVGNumber: { enumerable: true ***REMOVED***,
    getElementById: { enumerable: true ***REMOVED***,
    suspendRedraw: { enumerable: true ***REMOVED***,
    unsuspendRedraw: { enumerable: true ***REMOVED***,
    unsuspendRedrawAll: { enumerable: true ***REMOVED***,
    forceRedraw: { enumerable: true ***REMOVED***,
    onafterprint: { enumerable: true ***REMOVED***,
    onbeforeprint: { enumerable: true ***REMOVED***,
    onbeforeunload: { enumerable: true ***REMOVED***,
    onhashchange: { enumerable: true ***REMOVED***,
    onlanguagechange: { enumerable: true ***REMOVED***,
    onmessage: { enumerable: true ***REMOVED***,
    onmessageerror: { enumerable: true ***REMOVED***,
    onoffline: { enumerable: true ***REMOVED***,
    ononline: { enumerable: true ***REMOVED***,
    onpagehide: { enumerable: true ***REMOVED***,
    onpageshow: { enumerable: true ***REMOVED***,
    onpopstate: { enumerable: true ***REMOVED***,
    onrejectionhandled: { enumerable: true ***REMOVED***,
    onstorage: { enumerable: true ***REMOVED***,
    onunhandledrejection: { enumerable: true ***REMOVED***,
    onunload: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "SVGSVGElement", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
