...
this.workbox.rangeRequests = (function (exports, WorkboxError_js, assert_js, logger_js) {
    ...
    */
    /**
     * @param {string***REMOVED*** rangeHeader A Range: header value.
     * @return {Object***REMOVED*** An object with `start` and `end` properties, reflecting
    ...
    function parseRangeHeader(rangeHeader) {
      ...
      ***REMOVED***
      ...
      if (!normalizedRangeHeader.startsWith('bytes=')) {
        ...
        ***REMOVED***);
      ***REMOVED*** // Specifying multiple ranges separate by commas is valid syntax, but this
    ...
    */
     ...
     *
     * @param {Request***REMOVED*** request A request, which should contain a Range:
     * header.
     * @param {Response***REMOVED*** originalResponse A response.
     * @return {Promise<Response>***REMOVED*** Either a `206 Partial Content` response, with
    ...
    async function createPartialResponse(request, originalResponse) {
      try {
        ...
        ***REMOVED***);
        ...
        slicedResponse.headers.set('Content-Range', `bytes ${effectiveBoundaries.start***REMOVED***-${effectiveBoundaries.end - 1***REMOVED***/` + `${originalBlob.size***REMOVED***`);
    ...
    */
    ...
    class RangeRequestsPlugin {
      constructor() {
         ...
         * @param {Request***REMOVED*** options.request The original request, which may or may not
         * contain a Range: header.
         * @param {Response***REMOVED*** options.cachedResponse The complete cached response.
         * @return {Promise<Response>***REMOVED*** If request contains a 'Range' header, then a
        ...
        ***REMOVED***) => {
          ...
          ***REMOVED*** // If there was no Range: header, or if cachedResponse wasn't valid, just
