...
suite.add('fast-uri: serialize IPv6', function () {
  fasturi.serialize({ host: '2606:2800:220:1:248:1893:25c8:1946' ***REMOVED***)
***REMOVED***)
suite.add('urijs: serialize IPv6', function () {
  urijs.serialize({ host: '2606:2800:220:1:248:1893:25c8:1946' ***REMOVED***)
***REMOVED***)
suite.add('fast-uri: serialize ws', function () {
  fasturi.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/foo?bar', secure: true ***REMOVED***)
***REMOVED***)
suite.add('urijs: serialize ws', function () {
  urijs.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/foo?bar', secure: true ***REMOVED***)
***REMOVED***)
