...
/** @typedef {{hash: string, entry: Chunk, content: string, assets: {[name: string]: { source: Source, info: import("webpack").AssetInfo ***REMOVED******REMOVED******REMOVED******REMOVED*** ChildCompilationTemplateResult */
...
class HtmlWebpackChildCompiler {
  /**
   *
   * @param {string[]***REMOVED*** templates
   */
  constructor(templates) {
    /**
     * @type {string[]***REMOVED*** templateIds
     * The template array will allow us to keep track which input generated which output
     */
    this.templates = templates;
    /** @type {Promise<{[templatePath: string]: ChildCompilationTemplateResult***REMOVED***>***REMOVED*** */
     ...
     * @type {{fileDependencies: string[], contextDependencies: string[], missingDependencies: string[]***REMOVED******REMOVED***
     */
  ...
  ***REMOVED***
   ...
   *
   * @param {import('webpack').Compilation***REMOVED*** mainCompilation
   * @returns {Promise<{[templatePath: string]: ChildCompilationTemplateResult***REMOVED***>***REMOVED***
   */
  compileTemplates(mainCompilation) {
    ...
    ***REMOVED***
    ...
    const outputOptions = {
      ...
      ***REMOVED***,
      scriptType: /** @type {'text/javascript'***REMOVED*** */ ("text/javascript"),
      iife: true,
    ***REMOVED***;
    ...
    const temporaryTemplateNames = this.templates.map(
      (template, index) => `__child-HtmlWebpackPlugin_${index***REMOVED***-${template***REMOVED***`,
    );
    ...
    this.templates.forEach((template, index) => {
      new EntryPlugin(
        ...
        `HtmlWebpackPlugin_${index***REMOVED***-${template***REMOVED***`,
      ).apply(childCompiler);
      new EntryPlugin(
        childCompiler.context,
        template,
    ...
    ***REMOVED***);
    ...
    childCompiler.options.module = { ...childCompiler.options.module ***REMOVED***;
    ...
    this.compilationPromise = new Promise((resolve, reject) => {
      ...
      childCompiler.runAsChild((err, entries, childCompilation) => {
        ...
        ***REMOVED***
        ...
        /**
         * @type {{[templatePath: string]: ChildCompilationTemplateResult***REMOVED******REMOVED***
         */
        const result = {***REMOVED***;

        /** @type {{[name: string]: { source: Source, info: import("webpack").AssetInfo ***REMOVED******REMOVED******REMOVED*** */
        const assets = {***REMOVED***;

        for (const asset of childCompilation.getAssets()) {
          assets[asset.name] = { source: asset.source, info: asset.info ***REMOVED***;
        ***REMOVED***
        ...
        compiledTemplates.forEach((templateSource, entryIndex) => {
          ...
          result[this.templates[entryIndex]] = {
            ...
            content: /** @type {string***REMOVED*** */ (templateSource),
