...
var vendor = {
   ...
   *
   * @param {string***REMOVED*** prop String with or without vendor prefix.
   *
   * @return {string***REMOVED*** vendor prefix or empty string
   *
   * @example
  ...
  ***REMOVED***,
  ...
  /**
     ...
     * @param {string***REMOVED*** prop String with or without vendor prefix.
     *
     * @return {string***REMOVED*** String name without vendor prefixes.
     *
     * @example
