        ...
        function TSPropertySignatureToProperty(node, type = utils_1.AST_NODE_TYPES.Property) {
            ...
            ***REMOVED***;
            if (type === utils_1.AST_NODE_TYPES.Property) {
                return Object.assign({ type ***REMOVED***, base);
            ***REMOVED***
            else {
                return Object.assign({ type, static: false, readonly: false, declare: false ***REMOVED***, base);
            ***REMOVED***
        ***REMOVED***
        return Object.assign({***REMOVED***, rules, {
            ...
            ***REMOVED***,
            TSImportEqualsDeclaration(node) {
                ...
                const { id, moduleReference ***REMOVED*** = node;
