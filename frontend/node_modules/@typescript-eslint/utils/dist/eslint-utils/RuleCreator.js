...
function RuleCreator(urlCreator) {
    ...
    return function createNamedRule(_a) {
        var { name, meta ***REMOVED*** = _a, rule = __rest(_a, ["name", "meta"]);
        return createRule(Object.assign({ meta: Object.assign(Object.assign({***REMOVED***, meta), { docs: Object.assign(Object.assign({***REMOVED***, meta.docs), { url: urlCreator(name) ***REMOVED***) ***REMOVED***) ***REMOVED***, rule));
    ***REMOVED***;
***REMOVED***
 ...
 */
function createRule({ create, defaultOptions, meta, ***REMOVED***) {
    return {
        create(context) {
