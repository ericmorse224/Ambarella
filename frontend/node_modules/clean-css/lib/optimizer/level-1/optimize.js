...
var PROPERTY_NAME_PATTERN = /^(?:-chrome-|-[\w-]+\w|\w[\w-]+\w|\w{1,***REMOVED***)$/;
...
function noopValueOptimizer(_name, value, _options) { return value; ***REMOVED***
...
function cleanupCharsets(tokens) {
  ...
  for (var i = 0, l = tokens.length; i < l; i++) {
    ...
    if (token[0] != Token.AT_RULE) { continue; ***REMOVED***

    if (!CHARSET_REGEXP.test(token[1])) { continue; ***REMOVED***
  ...
  ***REMOVED***;
  ...
  for (unit in roundingPrecision) {
    ...
    if (value != DEFAULT_ROUNDING_PRECISION) {
      precisionOptions.units[unit] = {***REMOVED***;
