    ...
    for (var _i = 0, absolutePathMappings_1 = absolutePathMappings; _i < absolutePathMappings_1.length; _i++) {
        ...
        if (starMatch !== undefined) {
            var _loop_1 = function (physicalPathPattern) {
                ...
                pathsToTry.push({ type: "file", path: physicalPath ***REMOVED***);
                pathsToTry.push.apply(pathsToTry, extensions.map(function (e) { return ({ type: "extension", path: physicalPath + e ***REMOVED***); ***REMOVED***));
                pathsToTry.push({
                    type: "package",
                    path: path.join(physicalPath, "/package.json"),
                ***REMOVED***);
                var indexPath = path.join(physicalPath, "/index");
                pathsToTry.push.apply(pathsToTry, extensions.map(function (e) { return ({ type: "index", path: indexPath + e ***REMOVED***); ***REMOVED***));
            ***REMOVED***;
