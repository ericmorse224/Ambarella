declare module "process" {
    ...
    import { Worker ***REMOVED*** from "node:worker_threads";
    ...
    ***REMOVED***
    global {
        ...
        namespace NodeJS {
            ...
            interface ReadStream extends tty.ReadStream {***REMOVED***
            interface WriteStream extends tty.WriteStream {***REMOVED***
            ...
            ***REMOVED***
            interface HRTime {
                /**
                 * This is the legacy version of {@link process.hrtime.bigint()***REMOVED***
                 ...
                 * ```js
                 * const { hrtime ***REMOVED*** = require('node:process');
                 ...
                 *   // [ 1, 552 ]
                 *
                 *   console.log(`Benchmark took ${diff[0] * NS_PER_SEC + diff[1]***REMOVED*** nanoseconds`);
                 *   // Benchmark took 1000000552 nanoseconds
                 * ***REMOVED***, 1000);
                 * ```
                 * @since 0.7.6
                 * @legacy Use {@link process.hrtime.bigint()***REMOVED*** instead.
                 * @param time The result of a previous call to `process.hrtime()`
                 */
                (time?: [number, number]): [number, number];
                /**
                 * The `bigint` version of the {@link process.hrtime()***REMOVED*** method returning the current high-resolution real time in nanoseconds as a `bigint`.
                 *
                 * Unlike {@link process.hrtime()***REMOVED***, it does not support an additional time argument since the difference can just be computed directly by subtraction of the two `bigint`s.
                 * ```js
                 * import { hrtime ***REMOVED*** from 'node:process';
                 *
                 ...
                 *   // 191052633396993n
                 *
                 *   console.log(`Benchmark took ${end - start***REMOVED*** nanoseconds`);
            ...
            ***REMOVED***
            interface Process extends EventEmitter {
                 ...
                 *
                 * ```js
                 * import { stdin, stdout ***REMOVED*** from 'node:process';
                 *
                 * stdin.pipe(stdout);
                 * ```
                 *
                ...
                ***REMOVED***;
                 ...
                 * be {@link execPath***REMOVED***. See `process.argv0` if access to the original value
                 ...
                 *   console.log(`${index***REMOVED***: ${val***REMOVED***`);
                 * ***REMOVED***);
                 * ```
                 *
                 ...
                 * appear in the array returned by the {@link argv***REMOVED*** property, and do not
                 ...
                 *
                 * ```js
                 * import { chdir, cwd ***REMOVED*** from 'node:process';
                 *
                 * console.log(`Starting directory: ${cwd()***REMOVED***`);
                 * try {
                 *   chdir('/tmp');
                 *   console.log(`New directory: ${cwd()***REMOVED***`);
                 * ***REMOVED*** catch (err) {
                 *   console.error(`chdir: ${err***REMOVED***`);
                 * ***REMOVED***
                 * ```
                 *
                 * This feature is not available in `Worker` threads.
                 ...
                 *
                 * ```js
                 * import { cwd ***REMOVED*** from 'node:process';
                 *
                 * console.log(`Current directory: ${cwd()***REMOVED***`);
                 * ```
                 * @since v0.1.8
                 */
                cwd(): string;
                 ...
                 *
                 * ```js
                 * import { dlopen ***REMOVED*** from 'node:process';
                 * import { constants ***REMOVED*** from 'node:os';
                 * import { fileURLToPath ***REMOVED*** from 'node:url';
                 *
                 * const module = { exports: {***REMOVED*** ***REMOVED***;
                 ...
                 *
                 * ```js
                 * import { emitWarning ***REMOVED*** from 'node:process';
                 *
                 ...
                 *
                 * ```js
                 * import { env ***REMOVED*** from 'node:process';
                 *
                 * env.foo = 'bar';
                 * console.log(env.foo);
                 * ```
                 ...
                 *
                 * ```js
                 * import { exit ***REMOVED*** from 'node:process';
                 *
                 * exit(1);
                 * ```
                 *
                 ...
                 * exits gracefully, or is exited via {@link exit***REMOVED*** without specifying
                 * a code.
                 *
                 * Specifying a code to {@link exit***REMOVED*** will override any
                ...
                ***REMOVED***;
                 ...
                 *
                 * ```js
                 * import { getActiveResourcesInfo ***REMOVED*** from 'node:process';
                 * import { setTimeout ***REMOVED*** from 'node:timers';
                 ...
                 *
                 * if (process.getgid) {
                 *   console.log(`Current gid: ${process.getgid()***REMOVED***`);
                 * ***REMOVED***
                 * ```
                 *
                 ...
                 *   try {
                 *     process.setgid(501);
                 *     console.log(`New gid: ${process.getgid()***REMOVED***`);
                 *   ***REMOVED*** catch (err) {
                 *     console.log(`Failed to set gid: ${err***REMOVED***`);
                 *   ***REMOVED***
                 * ***REMOVED***
                 * ```
                 *
                 ...
                 *
                 * if (process.getuid) {
                 *   console.log(`Current uid: ${process.getuid()***REMOVED***`);
                 * ***REMOVED***
                 * ```
                 *
                 * This function is only available on POSIX platforms (i.e. not Windows or
                 ...
                 *   try {
                 *     process.setuid(501);
                 *     console.log(`New uid: ${process.getuid()***REMOVED***`);
                 *   ***REMOVED*** catch (err) {
                 *     console.log(`Failed to set uid: ${err***REMOVED***`);
                 *   ***REMOVED***
                 * ***REMOVED***
                 * ```
                 *
                 ...
                 *
                 * if (process.geteuid) {
                 *   console.log(`Current uid: ${process.geteuid()***REMOVED***`);
                 * ***REMOVED***
                 * ```
                 *
                 * This function is only available on POSIX platforms (i.e. not Windows or
                 ...
                 *   try {
                 *     process.seteuid(501);
                 *     console.log(`New uid: ${process.geteuid()***REMOVED***`);
                 *   ***REMOVED*** catch (err) {
                 *     console.log(`Failed to set uid: ${err***REMOVED***`);
                 *   ***REMOVED***
                 * ***REMOVED***
                 ...
                 *
                 * if (process.getegid) {
                 *   console.log(`Current gid: ${process.getegid()***REMOVED***`);
                 * ***REMOVED***
                 * ```
                 *
                 * This function is only available on POSIX platforms (i.e. not Windows or
                 ...
                 *   try {
                 *     process.setegid(501);
                 *     console.log(`New gid: ${process.getegid()***REMOVED***`);
                 *   ***REMOVED*** catch (err) {
                 *     console.log(`Failed to set gid: ${err***REMOVED***`);
                 *   ***REMOVED***
                 * ***REMOVED***
                 ...
                 *   ***REMOVED*** catch (err) {
                 *     console.log(`Failed to set groups: ${err***REMOVED***`);
                 *   ***REMOVED***
                 * ***REMOVED***
                 * ```
                 *
                ...
                /**
                 * Indicates whether a callback has been set using {@link setUncaughtExceptionCaptureCallback***REMOVED***.
                 * @since v9.3.0
                 */
                 ...
                 *
                 * ```js
                 * import { version ***REMOVED*** from 'node:process';
                 *
                 * console.log(`Version: ${version***REMOVED***`);
                 * // Version: v14.8.0
                 * ```
                 *
                 ...
                 *
                 * ```js
                 * import { versions ***REMOVED*** from 'node:process';
                 *
                 ...
                 *
                 * ```js
                 * import process, { kill ***REMOVED*** from 'node:process';
                 *
                 * process.on('SIGHUP', () => {
                 ...
                 *
                 * ```js
                 * import { loadEnvFile ***REMOVED*** from 'node:process';
                 *
                 ...
                 *
                 * ```js
                 * import { pid ***REMOVED*** from 'node:process';
                 *
                 * console.log(`This process is pid ${pid***REMOVED***`);
                 * ```
                 * @since v0.1.15
                 */
                readonly pid: number;
                 ...
                 *
                 * ```js
                 * import { ppid ***REMOVED*** from 'node:process';
                 *
                 * console.log(`The parent process is pid ${ppid***REMOVED***`);
                 * ```
                 ...
                 *
                 * ```js
                 * import { arch ***REMOVED*** from 'node:process';
                 *
                 * console.log(`This processor architecture is ${arch***REMOVED***`);
                 * ```
                 * @since v0.5.0
                 */
                 ...
                 *
                 * ```js
                 * import { platform ***REMOVED*** from 'node:process';
                 *
                 * console.log(`This platform is ${platform***REMOVED***`);
                 * ```
                 *
                 ...
                 *
                 * ```js
                 * import { cpuUsage ***REMOVED*** from 'node:process';
                 *
                 * const startUsage = cpuUsage();
                 * // { user: 38579, system: 6986 ***REMOVED***
                 *
                 ...
                 * // { user: 514883, system: 11226 ***REMOVED***
                 * ```
                 * @since v6.1.0
                 ...
                 *
                 * ```js
                 * import { nextTick ***REMOVED*** from 'node:process';
                 *
                 * console.log('start');
                 * nextTick(() => {
                ...
                ***REMOVED***;
                 ...
                 *
                 * ```js
                 * import { allowedNodeEnvironmentFlags ***REMOVED*** from 'node:process';
                 *
                 ...
                 * silently.
                 *
                 * If Node.js was compiled _without_ `NODE_OPTIONS` support (shown in {@link config***REMOVED***), `process.allowedNodeEnvironmentFlags` will
                ...
                /**
                 * ```js
                 * import { resourceUsage ***REMOVED*** from 'node:process';
                 *
                 ...
                 * > process.emitWarning('test', 'DeprecationWarning');
                 * Thrown:
                 * [DeprecationWarning: test] { name: 'DeprecationWarning' ***REMOVED***
                 * ```
                 * @since v0.9.12
                 */
