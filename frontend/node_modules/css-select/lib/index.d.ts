import type { CompiledQuery, Options, Query, Adapter ***REMOVED*** from "./types";
export type { Options ***REMOVED***;
/**
...
export { filters, pseudos, aliases ***REMOVED*** from "./pseudo-selectors";
