...
import type { FS as HasteFS ***REMOVED*** from 'jest-haste-map';
import type { ResolveModuleConfig, default as Resolver ***REMOVED*** from 'jest-resolve';
import { SnapshotResolver ***REMOVED*** from 'jest-snapshot';
