...
function isInheritOnly(values) {
  for (var i = 0, l = values.length; i < l; i++) {
    ...
    if (value != 'inherit' && value != Marker.COMMA && value != Marker.FORWARD_SLASH) { return false; ***REMOVED***
  ***REMOVED***
    ...
    if (descriptor.doubleValues && descriptor.defaultValue.length == 1) {
      return component.value[0][1] == descriptor.defaultValue[0]
        && (component.value[1]
          ...
          : true);
    ***REMOVED*** if (descriptor.doubleValues && descriptor.defaultValue.length != 1) {
      return component.value[0][1] == descriptor.defaultValue[0]
  ...
  ***REMOVED***
  ...
  for (var i = components.length - 1; i >= 0; i--) {
    ...
    if (component.name == 'background-clip') {
      ...
      ***REMOVED*** else if (needsBoth) {
        restoreValue(component);
        restoreValue(originComponent);
      ***REMOVED***

      i--;
    ***REMOVED*** else if (component.name == 'background-size') {
      ...
      ***REMOVED*** else if (needsBoth) {
        ...
        restoreValue(positionComponent);
      ***REMOVED*** else if (positionComponent.value.length == 1) {
        restoreValue(positionComponent);
      ***REMOVED***

      i--;
    ***REMOVED*** else {
      if (isDefault || configuration[component.name].multiplexLastOnly && !lastInMultiplex) { continue; ***REMOVED***

      restoreValue(component);
    ***REMOVED***
  ***REMOVED***

  if (restored.length === 0 && property.value.length == 1 && property.value[0][1] == '0') { restored.push(property.value[0]); ***REMOVED***

  if (restored.length === 0) { restored.push([Token.PROPERTY_VALUE, configuration[property.name].defaultValue]); ***REMOVED***

  if (isInheritOnly(restored)) { return [restored[0]]; ***REMOVED***
...
function fourValues(property) {
  ...
  if (value1[1] == value2[1] && value1[1] == value3[1] && value1[1] == value4[1]) {
    return [value1];
  ***REMOVED*** if (value1[1] == value3[1] && value2[1] == value4[1]) {
    return [value1, value2];
  ***REMOVED*** if (value2[1] == value4[1]) {
...
function multiplex(restoreWith) {
  return function(property, configuration) {
    if (!property.multiplex) { return restoreWith(property, configuration, true); ***REMOVED***

    var multiplexSize = 0;
    var restored = [];
    var componentMultiplexSoFar = {***REMOVED***;
    var i, l;

    // At this point we don't know what's the multiplex size, e.g. how many background layers are there
    for (i = 0, l = property.components[0].value.length; i < l; i++) {
      if (property.components[0].value[i][1] == Marker.COMMA) { multiplexSize++; ***REMOVED***
    ***REMOVED***
    ...
    for (i = 0; i <= multiplexSize; i++) {
      ...
      ***REMOVED***
      ...
      if (i < multiplexSize) { restored.push([Token.PROPERTY_VALUE, Marker.COMMA]); ***REMOVED***
    ***REMOVED***
