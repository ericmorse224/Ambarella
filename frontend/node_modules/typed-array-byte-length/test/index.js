...
test('not arrays', function (t) {
	...
	***REMOVED***);
	...
	t.equal(false, typedArrayByteLength({***REMOVED***), 'object is not typed array');
...
test('Functions', function (t) {
	t.equal(false, typedArrayByteLength(function () {***REMOVED***), 'function is not typed array');
	t.end();
***REMOVED***);
...
test('Typed Arrays', { skip: availableTypedArrays.length === 0 ***REMOVED***, function (t) {
	var length = 64;
	var byteLength = 32;
