...
```javascript
import { v4 as uuidv4 ***REMOVED*** from 'uuid';
...
```javascript
const { v4: uuidv4 ***REMOVED*** = require('uuid');
...
```javascript
import { NIL as NIL_UUID ***REMOVED*** from 'uuid';
...
```javascript
import { parse as uuidParse ***REMOVED*** from 'uuid';
...
```javascript
import { stringify as uuidStringify ***REMOVED*** from 'uuid';
...
```javascript
import { v1 as uuidv1 ***REMOVED*** from 'uuid';
...
```javascript
import { v5 as uuidv5 ***REMOVED*** from 'uuid';
...
```javascript
import { validate as uuidValidate ***REMOVED*** from 'uuid';
...
```javascript
import { version as uuidVersion ***REMOVED*** from 'uuid';
import { validate as uuidValidate ***REMOVED*** from 'uuid';
...
```html
<script type="module">
  import { v4 as uuidv4 ***REMOVED*** from 'https://jspm.dev/uuid';
