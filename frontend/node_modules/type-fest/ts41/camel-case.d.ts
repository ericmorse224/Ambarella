import {WordSeparators***REMOVED*** from '../source/utilities';
...
export type Split<S extends string, D extends string> =
	...
	S extends '' ? [] :
	S extends `${infer T***REMOVED***${D***REMOVED***${infer U***REMOVED***` ? [T, ...Split<U, D>] :
	[S];
...
type InnerCamelCaseStringArray<Parts extends any[], PreviousPart> =
	Parts extends [`${infer FirstPart***REMOVED***`, ...infer RemainingParts]
		? FirstPart extends undefined
			? ''
			: FirstPart extends ''
					? InnerCamelCaseStringArray<RemainingParts, PreviousPart>
					: `${PreviousPart extends '' ? FirstPart : Capitalize<FirstPart>***REMOVED***${InnerCamelCaseStringArray<RemainingParts, FirstPart>***REMOVED***`
		: '';
...
type CamelCaseStringArray<Parts extends string[]> =
	Parts extends [`${infer FirstPart***REMOVED***`, ...infer RemainingParts]
		? Uncapitalize<`${FirstPart***REMOVED***${InnerCamelCaseStringArray<RemainingParts, FirstPart>***REMOVED***`>
		: never;
...
@example
```
import {CamelCase***REMOVED*** from 'type-fest';
