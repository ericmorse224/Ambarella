...
test('not arrays', function (t) {
	...
	***REMOVED***);
	...
	t.equal(false, typedArrayLength({***REMOVED***), 'object is not typed array');
...
test('Functions', function (t) {
	t.equal(false, typedArrayLength(function () {***REMOVED***), 'function is not typed array');
	t.end();
***REMOVED***);

test('Generators', { skip: generators.length === 0 ***REMOVED***, function (t) {
...
test('Arrow functions', { skip: !arrowFn ***REMOVED***, function (t) {
...
test('Typed Arrays', function (t) {
	forEach(typedArrayNames, function (typedArray) {
		/** @type {Int8ArrayConstructor | Uint8ArrayConstructor | Uint8ClampedArrayConstructor | Int16ArrayConstructor | Uint16ArrayConstructor | Int32ArrayConstructor | Uint32ArrayConstructor | Float32ArrayConstructor | Float64ArrayConstructor | BigInt64ArrayConstructor | BigUint64ArrayConstructor***REMOVED*** */
