...
module.exports = function (toSorted, t) {
	...
	var arrayLikeLengthValueOf = {
		length: {
			valueOf: function () { return 2; ***REMOVED***
		***REMOVED***,
		0: 4,
		1: 0,
		2: 1
	***REMOVED***;
	...
	t.test('not positive integer lengths', function (st) {
		st.deepEqual(toSorted({ length: -2 ***REMOVED***), []);
		st.deepEqual(toSorted({ length: 'dog' ***REMOVED***), []);
		st.deepEqual(toSorted({ length: NaN ***REMOVED***), []);

		st.end();
	***REMOVED***);

	t.test('getters', { skip: !Object.defineProperty ***REMOVED***, function (st) {
		var getCalls = [];
	...
	***REMOVED***);
	...
	t.test('too-large lengths', function (st) {
		...
		***REMOVED***;
		...
		st['throws'](
			function () { toSorted(arrayLike); ***REMOVED***,
			RangeError
		);
