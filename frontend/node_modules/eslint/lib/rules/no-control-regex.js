...
const collector = new (class {
    ...
    ***REMOVED***
    ...
    collectControlChars(regexpStr, flags) {
        ...
        try {
            this._validator.validatePattern(regexpStr, void 0, void 0, { unicode: uFlag, unicodeSets: vFlag ***REMOVED***); // Call onCharacter hook
        ***REMOVED*** catch {
...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            unexpected: "Unexpected control character(s) in regular expression: {{controlChars***REMOVED******REMOVED***."
        ***REMOVED***
    ***REMOVED***,
