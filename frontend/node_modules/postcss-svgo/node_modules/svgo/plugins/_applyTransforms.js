...
const {
  ...
  transform2js,
  transformArc,
***REMOVED*** = require('./_transforms.js');
const { removeLeadingZero ***REMOVED*** = require('../lib/svgo/tools.js');
const { referencesProps, attrsGroupsDefaults ***REMOVED*** = require('./_collections.js');
