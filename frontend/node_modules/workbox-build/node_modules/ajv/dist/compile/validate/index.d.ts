import type { AddedKeywordDefinition, AnySchemaObject, KeywordErrorCxt, KeywordCxtParams ***REMOVED*** from "../../types";
import type { SchemaCxt, SchemaObjCxt ***REMOVED*** from "..";
import { SubschemaArgs ***REMOVED*** from "./subschema";
import { Code, Name, CodeGen ***REMOVED*** from "../codegen";
import type { JSONType ***REMOVED*** from "../rules";
import { ErrorPaths ***REMOVED*** from "../errors";
...
***REMOVED***
export declare function getData($data: string, { dataLevel, dataNames, dataPathArr ***REMOVED***: SchemaCxt): Code | number;
