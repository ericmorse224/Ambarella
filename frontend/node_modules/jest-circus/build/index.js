...
const _dispatchDescribe = (blockFn, blockName, describeFn, mode) => {
  ...
  ***REMOVED***
  ...
  if (typeof blockFn !== 'function') {
    asyncError.message = `Invalid second argument, ${blockFn***REMOVED***. It must be a callback function.`;
    throw asyncError;
  ***REMOVED***
  ...
  ***REMOVED*** else if (describeReturn !== undefined) {
    throw new _jestUtil.ErrorWithStack(
...
const _addHook = (fn, hookType, hookFn, timeout) => {
  ...
  ***REMOVED***
  ...
  (0, _state.dispatchSync)({
    ...
    timeout
  ***REMOVED***);
***REMOVED***; // Hooks have to pass themselves to the HOF in order for us to trim stack traces.
...
const test = (() => {
  ...
  test.todo = (testName, ...rest) => {
    ...
    ***REMOVED***
    ...
    return _addTest(testName, 'todo', () => {***REMOVED***, test.todo);
  ***REMOVED***;
  ...
  const _addTest = (testName, mode, fn, testFn, timeout) => {
    ...
    if (typeof testName !== 'string') {
      asyncError.message = `Invalid first argument, ${testName***REMOVED***. It must be a string.`;
      throw asyncError;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (typeof fn !== 'function') {
      asyncError.message = `Invalid second argument, ${fn***REMOVED***. It must be a callback function.`;
      throw asyncError;
    ***REMOVED***
