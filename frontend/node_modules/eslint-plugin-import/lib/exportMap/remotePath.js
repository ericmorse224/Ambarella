'use strict';Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***);exports.RemotePath = undefined;var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);***REMOVED******REMOVED***return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;***REMOVED***;***REMOVED***();var _resolve2 = require('eslint-module-utils/resolve');var _resolve3 = _interopRequireDefault(_resolve2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");***REMOVED******REMOVED***var

RemotePath = exports.RemotePath = function () {
  function RemotePath(path, context) {_classCallCheck(this, RemotePath);
    this.path = path;
    this.context = context;
  ***REMOVED***_createClass(RemotePath, [{ key: 'resolve', value: function () {function resolve(

      value) {
        return _resolve3['default'].relative(value, this.path, this.context.settings);
      ***REMOVED***return resolve;***REMOVED***() ***REMOVED***]);return RemotePath;***REMOVED***();
