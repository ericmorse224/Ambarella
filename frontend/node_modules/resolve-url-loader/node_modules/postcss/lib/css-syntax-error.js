...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {***REMOVED***)); return true; ***REMOVED*** catch (e) { return false; ***REMOVED*** ***REMOVED***
 ...
 * the {@link Node#error***REMOVED*** method.
 *
 ...
 * throw node.error('Unknown variable', { plugin: 'postcss-vars' ***REMOVED***)
 */
var CssSyntaxError = /*#__PURE__*/function (_Error) {
   ...
   * @param {number***REMOVED*** [line]   Source line of the error.
   * @param {number***REMOVED*** [column] Source column of the error.
   * @param {string***REMOVED*** [source] Source code of the broken file.
   * @param {string***REMOVED*** [file]   Absolute path to the broken file.
   * @param {string***REMOVED*** [plugin] PostCSS plugin name, if error came from plugin.
   */
  function CssSyntaxError(message, line, column, source, file, plugin) {
    ...
    ***REMOVED***
    ...
    if (source) {
       ...
       *
       * @example
       * error.source       //=> 'a { b {***REMOVED*** ***REMOVED***'
       * error.input.column //=> 'a b { ***REMOVED***'
       */
      _this.source = source;
    ***REMOVED***
  ...
  ***REMOVED***
   ...
   *
   * @param {boolean***REMOVED*** [color] Whether arrow will be colored red by terminal
   ...
   *                        //      8 | b {"
   *
   * @return {string***REMOVED*** Few lines of CSS source that caused the error.
   */
  ;
  ...
  ***REMOVED***
   ...
   *                  //        | ^"
   *
   * @return {string***REMOVED*** Error position, message and source code.
   */
  ;
  ...
  ***REMOVED***
   ...
   * @member {Input***REMOVED*** input Input object with PostCSS internal information
