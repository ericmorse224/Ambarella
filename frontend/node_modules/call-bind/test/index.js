...
test('callBind', function (t) {
	forEach(v.nonFunctions, function (nonFunction) {
		t['throws'](
			function () { callBind(nonFunction); ***REMOVED***,
			TypeError,
			inspect(nonFunction) + ' is not a function'
		);
	***REMOVED***);

	var sentinel = { sentinel: true ***REMOVED***;
	...
	***REMOVED***;
	...
	t.equal(bound.length, func.length + 1, 'function length is preserved', { skip: !boundFnsHaveConfigurableLengths ***REMOVED***);
	...
	t.equal(boundR.length, func.length, 'function length is preserved', { skip: !boundFnsHaveConfigurableLengths ***REMOVED***);
	t.deepEqual(boundR(), [sentinel, undefined, undefined], 'bound func with receiver, with too few args');
	t.deepEqual(boundR(1, 2), [sentinel, 1, 2], 'bound func with receiver, with right args');
	t.deepEqual(boundR(1, 2, 3), [sentinel, 1, 2], 'bound func with receiver, with too many args');

	var boundArg = callBind(func, sentinel, 1);
	t.equal(boundArg.length, func.length - 1, 'function length is preserved', { skip: !boundFnsHaveConfigurableLengths ***REMOVED***);
