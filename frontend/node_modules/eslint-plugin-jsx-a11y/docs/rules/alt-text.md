...
const Image = props => {
  ...
  ***REMOVED*** = props;
  ...
  return (
    <img alt={alt***REMOVED*** {...otherProps***REMOVED*** />
  );
***REMOVED***
...
```jsx
function Foo({ alt, ...props***REMOVED***) {
    return <img alt={alt***REMOVED*** {...props***REMOVED*** />
***REMOVED***
...
function Foo(props) {
   ...
   return <img alt={alt***REMOVED*** {...otherProps***REMOVED*** />
***REMOVED***
```
...
<img src="foo" alt={"Foo eating a sandwich."***REMOVED*** />
<img src="foo" alt={altText***REMOVED*** />
<img src="foo" alt={`${person***REMOVED*** smiling`***REMOVED*** />
<img src="foo" alt="" />
...
<img src="foo" />
<img {...props***REMOVED*** />
<img {...props***REMOVED*** alt /> // Has no value
<img {...props***REMOVED*** alt={undefined***REMOVED*** /> // Has no value
<img {...props***REMOVED*** alt={`${undefined***REMOVED***`***REMOVED*** /> // Has no value
...
<object {...props***REMOVED*** />


<area {...props***REMOVED*** />

<input type="image" {...props***REMOVED*** />
```
