...
var _debug = require('debug');var _debug2 = _interopRequireDefault(_debug);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED*** /**
...
function findNodeIndexInScopeBody(body, nodeToFind) {
  return body.findIndex(function (node) {return containsNodeOrEqual(node, nodeToFind);***REMOVED***);
***REMOVED***
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('newline-after-import') ***REMOVED***,
    ...
    schema: [
    {
      ...
      properties: {
        ...
        exactCount: { type: 'boolean' ***REMOVED***,
        considerComments: { type: 'boolean' ***REMOVED*** ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      var options = Object.assign({
        count: 1,
        exactCount: false,
        considerComments: false ***REMOVED***,
      context.options[0]);
      ...
      function checkForNewLine(node, nextNode, type) {
        if (isExportDefaultClass(nextNode) || isExportNameClass(nextNode)) {
          ...
          ***REMOVED***
        ***REMOVED*** else if (isClassWithDecorator(nextNode)) {
          ...
          ***REMOVED***
          ...
          context.report({
            ...
            fix: options.exactCount && EXPECTED_LINE_DIFFERENCE < lineDifference ? undefined : function (fixer) {return fixer.insertTextAfter(
              node,
              '\n'.repeat(EXPECTED_LINE_DIFFERENCE - lineDifference));***REMOVED*** ***REMOVED***);
      ...
      function checkImport(node) {var
        ...
        ***REMOVED***
        ...
        if (typeof parent.comments !== 'undefined' && options.considerComments) {
          nextComment = parent.comments.find(function (o) {return o.loc.start.line >= endLine && o.loc.start.line <= endLine + options.count + 1;***REMOVED***);
        ***REMOVED***
        ...
        ***REMOVED*** else if (nextNode && nextNode.type !== 'ImportDeclaration' && (nextNode.type !== 'TSImportEqualsDeclaration' || nextNode.isExport)) {
      ...
      ***REMOVED***
      ...
      return {
        ...
        CallExpression: function () {function CallExpression(node) {
            ...
            ***REMOVED***
          ***REMOVED***return CallExpression;***REMOVED***(),
              ...
              ***REMOVED***
...

              {
                ...
                if (typeof statementWithRequireCall.parent.comments !== 'undefined' && options.considerComments) {
                  var endLine = node.loc.end.line;
                  nextComment = statementWithRequireCall.parent.comments.find(function (o) {return o.loc.start.line >= endLine && o.loc.start.line <= endLine + options.count + 1;***REMOVED***);
                ***REMOVED***
        ...
        'Decorator:exit': decrementLevel ***REMOVED***;
