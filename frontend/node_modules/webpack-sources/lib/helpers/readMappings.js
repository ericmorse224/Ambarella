...
/**
 * @param {string***REMOVED*** mappings the mappings string
 * @param {function(number, number, number, number, number, number): void***REMOVED*** onMapping called for each mapping
	...
	for (let i = 0; i < mappings.length; i++) {
		...
		if ((value & END_SEGMENT_BIT) !== 0) {
			...
			if (currentData[0] > generatedColumn) {
				...
				***REMOVED*** else if (currentDataPos === 4) {
					onMapping(
						generatedLine,
						currentData[0],
						currentData[1],
				...
				***REMOVED*** else if (currentDataPos === 5) {
					onMapping(
						generatedLine,
						currentData[0],
						currentData[1],
			...
			***REMOVED***
			...
			if (value === NEXT_LINE) {
				...
				generatedColumn = -1;
			***REMOVED***
		***REMOVED*** else if ((value & CONTINUATION_BIT) === 0) {
			// last sextet
