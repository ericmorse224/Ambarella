 ...
 * @param {string***REMOVED*** from The base path
 * @param {string***REMOVED*** to The full path
 */
function enhancedRelative(from, to) {
  ...
  var trailing = relative.replace(/^\.{2***REMOVED***[\\\/]/, ''),
 ...
 * @param {string***REMOVED*** directory A path to start searching
 * @returns {object***REMOVED*** A collection of sym-linked paths within the project keyed by their package name
 */
