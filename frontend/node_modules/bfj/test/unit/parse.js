  ...
  suite('require:', () => {
        ...
        walk: [
          {
            ...
            pause: spooks.fn({ name: 'pause', log: log, results: [ () => {***REMOVED*** ] ***REMOVED***),
            removeAllListeners: spooks.fn({ name: 'removeAllListeners', log: log ***REMOVED***)
          ***REMOVED***
        ]
      ***REMOVED***
    ...
    ***REMOVED***)
    ...
    test('parse does not throw if reviver is an object', () => {
      assert.doesNotThrow(() => {
        parse({***REMOVED***, { reviver: {***REMOVED*** ***REMOVED***).catch(() => {***REMOVED***)
      ***REMOVED***)
    ***REMOVED***)

    test('parse does not throw if revive is a function', () => {
      assert.doesNotThrow(() => {
        parse({***REMOVED***, { reviver: () => {***REMOVED*** ***REMOVED***)
      ***REMOVED***)
    ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    test('parse returns a different type of promise if the option is set', () => {
      ...
      assert.instanceOf(parse('', { Promise: global.Promise ***REMOVED***), global.Promise)
    ***REMOVED***)

    test('parse rejects immediately if reviver is an object', () => {
      return parse({***REMOVED***, { reviver: {***REMOVED*** ***REMOVED***)
        .then(() => assert(false))
    ...
    suite('parse:', () => {
      ...
      setup(() => {
        ...
        parse(stream, options)
          .then(spooks.fn({ name: 'resolve', log: log ***REMOVED***))
          .catch(spooks.fn({ name: 'reject', log: log ***REMOVED***))
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('parse with reviver:', () => {
      ...
      setup(() => {
        stream = {***REMOVED***
        options = { reviver: spooks.fn({ name: 'reviver', log: log, results: [ 'reviver result' ] ***REMOVED***) ***REMOVED***
        parse(stream, options)
          .then(spooks.fn({ name: 'resolve', log: log ***REMOVED***))
          .catch(spooks.fn({ name: 'reject', log: log ***REMOVED***))
      ***REMOVED***)
    ...
    ***REMOVED***)
    ...
    suite('parse with ndjson:', () => {
      ...
      setup(() => {
        stream = {***REMOVED***
        parse(stream, { ndjson: true ***REMOVED***)
          .then(spooks.fn({ name: 'resolve', log: log ***REMOVED***))
          .catch(spooks.fn({ name: 'reject', log: log ***REMOVED***))
      ***REMOVED***)
      ...
      suite('array, endArray, endLine:', () => {
        ...
        ***REMOVED***)
        ...
        suite('parse with ndjson:', () => {
          setup(() => {
            parse(stream, { ndjson: true ***REMOVED***)
              .then(spooks.fn({ name: 'resolve2', log: log ***REMOVED***))
              .catch(spooks.fn({ name: 'reject2', log: log ***REMOVED***))
          ***REMOVED***)
          ...
          suite('string, end:', () => {
            ...
            ***REMOVED***)
            ...
            suite('parse with ndjson:', () => {
              setup(() => {
                parse(stream, { ndjson: true ***REMOVED***)
                  .then(spooks.fn({ name: 'resolve3', log: log ***REMOVED***))
                  .catch(spooks.fn({ name: 'reject3', log: log ***REMOVED***))
              ***REMOVED***)
        ...
        ***REMOVED***)
        ...
        suite('parse with ndjson and fresh stream:', () => {
          setup(() => {
            parse({***REMOVED***, { ndjson: true ***REMOVED***)
              .then(spooks.fn({ name: 'resolve2', log: log ***REMOVED***))
              .catch(spooks.fn({ name: 'reject2', log: log ***REMOVED***))
          ***REMOVED***)
