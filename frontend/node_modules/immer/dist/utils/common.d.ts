import { Objectish, AnyObject, AnyMap, AnySet, ImmerState, Archtype ***REMOVED*** from "../internal";
...
export declare const getOwnPropertyDescriptors: <T>(o: T) => { [P in keyof T]: TypedPropertyDescriptor<T[P]>; ***REMOVED*** & {
