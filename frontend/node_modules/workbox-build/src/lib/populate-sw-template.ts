...
import {GeneratePartial, ManifestEntry***REMOVED*** from '../types';
import {ModuleRegistry***REMOVED*** from './module-registry';
import {runtimeCachingConverter***REMOVED*** from './runtime-caching-converter';
import {stringifyWithoutComments***REMOVED*** from './stringify-without-comments';
import {swTemplate***REMOVED*** from '../templates/sw-template';
...
export function populateSWTemplate({
  ...
  runtimeCaching = [],
  skipWaiting,
***REMOVED***: GeneratePartial & {manifestEntries?: Array<ManifestEntry>***REMOVED***): string {
  ...
  ***REMOVED***;
  ...
  if (ignoreURLParametersMatching) {
    precacheOptionsString = precacheOptionsString.replace(
      `"ignoreURLParametersMatching": []`,
      `"ignoreURLParametersMatching": [` +
        `${ignoreURLParametersMatching.join(', ')***REMOVED***]`,
    );
  ***REMOVED***
  ...
  ***REMOVED*** catch (error) {
    throw new Error(
      `${errors['populating-sw-tmpl-failed']***REMOVED*** '${
