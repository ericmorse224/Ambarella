 ...
 * @param {string***REMOVED*** str The input string to hash
 * @returns {number***REMOVED*** - The computed hash value.
 */
 ...
 * See https://en.wikipedia.org/wiki/Fowler%E2%80%93Noll%E2%80%93Vo_hash_function
 * @param {string***REMOVED*** str The input string to hash
 * @returns {bigint***REMOVED*** - The computed hash value.
 */
 ...
 * @param {string***REMOVED*** str The input string to hash.
 * @param {number***REMOVED*** range The range of the hash value (0 to range-1).
 * @returns {number***REMOVED*** - The computed hash value.
 * @example
 * ```js
