declare namespace yargsParser {
    ...
    ***REMOVED***
    ...
    interface DetailedArguments {
        ...
        aliases: { [alias: string]: string[] ***REMOVED***;
        /** Any new aliases added via camel-case expansion. */
        newAliases: { [alias: string]: boolean ***REMOVED***;
    ...
    ***REMOVED***
    ...
    interface Options {
        /** An object representing the set of aliases for a key: `{ alias: { foo: ['f']***REMOVED*** ***REMOVED***`. */
        alias?: { [key: string]: string | string[] ***REMOVED*** | undefined;
        /**
         * Indicate that keys should be parsed as an array: `{ array: ['foo', 'bar'] ***REMOVED***`.
         * Indicate that keys should be parsed as an array and coerced to booleans / numbers:
         * { array: [ { key: 'foo', boolean: true ***REMOVED***, {key: 'bar', number: true***REMOVED*** ] ***REMOVED***`.
         */
        array?:
            | string[]
            | Array<{ key: string; boolean?: boolean | undefined; number?: boolean | undefined ***REMOVED***>
            | undefined;
        /** Arguments should be parsed as booleans: `{ boolean: ['x', 'y'] ***REMOVED***`. */
        boolean?: string[] | undefined;
        /** Indicate a key that represents a path to a configuration file (this file will be loaded and parsed). */
        config?: string | string[] | { [key: string]: boolean ***REMOVED*** | undefined;
         ...
         */
        coerce?: { [key: string]: (arg: any) => any ***REMOVED*** | undefined;
        /** Indicate a key that should be used as a counter, e.g., `-vvv = {v: 3***REMOVED***`. */
        count?: string[] | undefined;
        /** Provide default values for keys: `{ default: { x: 33, y: 'hello world!' ***REMOVED*** ***REMOVED***`. */
        default?: { [key: string]: any ***REMOVED*** | undefined;
        /** Environment variables (`process.env`) with the prefix provided should be parsed. */
        envPrefix?: string | undefined;
        /** Specify that a key requires n arguments: `{ narg: {x: 2***REMOVED*** ***REMOVED***`. */
        narg?: { [key: string]: number ***REMOVED*** | undefined;
