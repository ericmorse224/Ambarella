...
```jsx
<label htmlFor={domId***REMOVED***>Surname</label>
<input type="text" id={domId***REMOVED*** />
```
...
<CustomInputLabel label="Surname">
  <CustomInput type="text" value={value***REMOVED*** />
</CustomInputLabel>
```
...
```jsx
{/* eslint jsx-a11y/label-has-associated-control: ["error", { assert: "either" ***REMOVED*** ] */***REMOVED***
<label htmlFor="a">
  Username:
</label>
...
