...
//  (and should run fine on older Firefox versions starting with FF4)
 ...
 //  - Harmony WeakMaps
 // Patches:
 //  - Object.{freeze,seal,preventExtensions***REMOVED***
 //  - Object.{isFrozen,isSealed,isExtensible***REMOVED***
...
// - get{Own***REMOVED***PropertyNames lists all sealed properties of the target.
// - keys lists all enumerable sealed properties of the target.
// - enumerate lists all enumerable sealed properties of the target.
// - if a property of a non-extensible proxy is reported as non-existent,
//   then it must forever be reported as non-existent. This applies to
//   own and inherited properties and is enforced in the
//   deleteProperty, get{Own***REMOVED***PropertyDescriptor, has{Own***REMOVED***,
//   get{Own***REMOVED***PropertyNames, keys and enumerate traps
...
if (typeof WeakMap === "undefined") {
  global.WeakMap = function(){***REMOVED***;
  global.WeakMap.prototype = {
    get: function(k) { return undefined; ***REMOVED***,
    set: function(k,v) { throw new Error("WeakMap not supported"); ***REMOVED***
  ***REMOVED***;
***REMOVED***
...
function toPropertyDescriptor(obj) {
  ...
  ***REMOVED***
  var desc = {***REMOVED***;
  if ('enumerable' in obj) { desc.enumerable = !!obj.enumerable; ***REMOVED***
  if ('configurable' in obj) { desc.configurable = !!obj.configurable; ***REMOVED***
  if ('value' in obj) { desc.value = obj.value; ***REMOVED***
  if ('writable' in obj) { desc.writable = !!obj.writable; ***REMOVED***
  if ('get' in obj) {
    var getter = obj.get;
...
function toCompletePropertyDescriptor(desc) {
  ...
  if (isGenericDescriptor(internalDesc) || isDataDescriptor(internalDesc)) {
    if (!('value' in internalDesc)) { internalDesc.value = undefined; ***REMOVED***
    if (!('writable' in internalDesc)) { internalDesc.writable = false; ***REMOVED***
  ***REMOVED*** else {
    if (!('get' in internalDesc)) { internalDesc.get = undefined; ***REMOVED***
    if (!('set' in internalDesc)) { internalDesc.set = undefined; ***REMOVED***
  ***REMOVED***
  if (!('enumerable' in internalDesc)) { internalDesc.enumerable = false; ***REMOVED***
  if (!('configurable' in internalDesc)) { internalDesc.configurable = false; ***REMOVED***
  return internalDesc;
***REMOVED***
...
function normalizeAndCompletePropertyDescriptor(attributes) {
  if (attributes === undefined) { return undefined; ***REMOVED***
...
function isFixed(name, target) {
  return ({***REMOVED***).hasOwnProperty.call(target, name);
***REMOVED***
function isSealed(name, target) {
  var desc = Object.getOwnPropertyDescriptor(target, name);
  if (desc === undefined) { return false; ***REMOVED***
...
function setIntegrityLevel(target, level) {
  ...
  if (level === "sealed") {
    ...
    for (var i = 0; i < l; i++) {
      k = String(ownProps[i]);
      try {
        Object.defineProperty(target, k, { configurable: false ***REMOVED***);
      ***REMOVED*** catch (e) {
      ...
      try {
        ...
        if (currentDesc !== undefined) {
          ...
          if (isAccessorDescriptor(currentDesc)) {
            desc = { configurable: false ***REMOVED***
          ***REMOVED*** else {
            desc = { configurable: false, writable: false ***REMOVED***
          ***REMOVED***
...
Validator.prototype = {
  ...
  ***REMOVED***,
  ...
  defineProperty: function(name, desc) {
    ...
    // Object.defineProperty(proxy, 'foo', {enumerable:false***REMOVED***)
    // This trap will receive desc =
    //  {value:undefined,writable:false,enumerable:false,configurable:false***REMOVED***
      ...
      if (isDataDescriptor(fixedDesc) &&
        ...
        if (!sameValue(res, fixedDesc.value)) {
          throw new TypeError("cannot report inconsistent value for "+
                              ...
                              name+"'");
        ***REMOVED***
      ***REMOVED*** else { // it's an accessor property
...
// patch Object.{preventExtensions,seal,freeze***REMOVED*** so that
...
Object.prototype.isPrototypeOf = function builtin(arg) {
  ...
  while (true) {
    ...
    if (vHandler2 !== undefined) {
      ...
      if (arg === null) {
        return false;
      ***REMOVED*** else if (sameValue(arg, this)) {
        return true;
      ***REMOVED***
    ***REMOVED*** else {
...
var __proto__setter = (function() {
  ...
  ***REMOVED***
  ...
  try {
    protoDesc.set.call({***REMOVED***,{***REMOVED***);
  ***REMOVED*** catch (e) {
    return function() {
      throw new TypeError("setPrototypeOf not supported on this platform");
    ***REMOVED***
...
var Reflect = {
  ...
  ***REMOVED***,
  defineProperty: function(target, name, desc) {
    ...
    ***REMOVED*** else if (isDataDescriptor(current) !== isDataDescriptor(desc)) {
      if (current.configurable === false) {
        return false;
      ***REMOVED***
    ***REMOVED*** else if (isDataDescriptor(current) && isDataDescriptor(desc)) {
      if (current.configurable === false) {
        ...
        ***REMOVED***
      ***REMOVED***
    ***REMOVED*** else if (isAccessorDescriptor(current) && isAccessorDescriptor(desc)) {
      if (current.configurable === false) {
        if ('set' in desc && !sameValue(desc.set, current.set)) {
          return false;
        ***REMOVED***
    ...
    if (existingDesc !== undefined) {
      var updateDesc =
        { value: value,
          ...
          configurable: existingDesc.configurable ***REMOVED***;
  ...
  ***REMOVED***,*/
  enumerate: function(target) {
    ...
    ***REMOVED*** else {
      result = [];
      for (var name in target) { result.push(name); ***REMOVED***;      
    ***REMOVED***
    var l = +result.length;
    var idx = 0;
    return {
      next: function() {
        if (idx === l) return { done: true ***REMOVED***;
        return { done: false, value: result[idx++] ***REMOVED***;
      ***REMOVED***
    ***REMOVED***;
  ***REMOVED***,
  ...
  construct: function(target, args, newTarget) {
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED***
      ...
      var instance = (Object(proto) === proto) ? Object.create(proto) : {***REMOVED***;
...
if (typeof Proxy !== "undefined" &&
  ...
  var revokedHandler = primCreate({
    get: function() { throw new TypeError("proxy is revoked"); ***REMOVED***
  ***REMOVED***);
  ...
  global.Proxy.revocable = function(target, handler) {
    ...
    var revoke = function() {
      ...
      ***REMOVED***
      return undefined;
    ***REMOVED***;
    return {proxy: proxy, revoke: revoke***REMOVED***;
  ***REMOVED***
...
***REMOVED***(typeof exports !== 'undefined' ? global : this));