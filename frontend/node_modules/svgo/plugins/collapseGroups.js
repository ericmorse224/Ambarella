        ...
        item.content.forEach(function(g, i) {
            ...
            if (g.isElem('g') && !g.isEmpty()) {
                    ...
                    if (inner.isElem() && !inner.hasAttr('id') && !g.hasAttr('filter') &&
                        ...
                        g.eachAttr(function(attr) {
                            ...
                            if (!inner.hasAttr(attr.name)) {
                                inner.addAttr(attr);
                            ***REMOVED*** else if (attr.name == 'transform') {
                                inner.attr(attr.name).value = attr.value + ' ' + inner.attr(attr.name).value;
                            ***REMOVED*** else if (inner.hasAttr(attr.name, 'inherit')) {
                ...
                ***REMOVED***
                ...
                if (!g.hasAttr() && !g.content.some(function(item) { return item.isElem(animationElems) ***REMOVED***)) {
