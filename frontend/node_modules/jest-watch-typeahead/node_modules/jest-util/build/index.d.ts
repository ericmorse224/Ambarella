...
import type {Global***REMOVED*** from '@jest/types';
...
declare namespace preRunMessage {
  export {print_2 as print, remove***REMOVED***;
***REMOVED***
export {preRunMessage***REMOVED***;
...
declare namespace specialChars {
  export {ARROW, ICONS, CLEAR***REMOVED***;
***REMOVED***
export {specialChars***REMOVED***;
