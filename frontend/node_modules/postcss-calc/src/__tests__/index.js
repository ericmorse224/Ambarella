'use strict';
const { test ***REMOVED*** = require('uvu');
const assert = require('uvu/assert');
const postcss = require('postcss');

const reduceCalc = require('../index.js');

const postcssOpts = { from: undefined ***REMOVED***;

function testValue(fixture, expected, opts = {***REMOVED***) {
  fixture = `foo{bar:${fixture***REMOVED******REMOVED***`;
  expected = `foo{bar:${expected***REMOVED******REMOVED***`;
...
function testCss(fixture, expected, opts = {***REMOVED***) {
  return async () => {
    const result = await postcss(reduceCalc(opts)).process(
      fixture,
      postcssOpts
...
function testThrows(fixture, expected, warning, opts = {***REMOVED***) {
  fixture = `foo{bar:${fixture***REMOVED******REMOVED***`;
  expected = `foo{bar:${expected***REMOVED******REMOVED***`;
...
test(
  ...
  testValue('calc(5/1000000)', '0.000005', { precision: 6 ***REMOVED***)
);
...
test(
  ...
  testCss('foo{bar:calc(1rem * 1.5)***REMOVED***', 'foo{bar:1.5rem;bar:calc(1rem * 1.5)***REMOVED***', {
    preserve: true,
  ***REMOVED***)
);
...
test(
  ...
  testValue('calc(500px - 0px)', '500px', { warnWhenCannotResolve: true ***REMOVED***)
);
...
test(
  ...
  testCss(
    'foo:nth-child(2n + $var-calc){***REMOVED***',
    'foo:nth-child(2n + $var-calc){***REMOVED***',
    { selectors: true ***REMOVED***
  )
);
...
test(
  ...
  testCss('button[disabled]{***REMOVED***', 'button[disabled]{***REMOVED***', { selectors: true ***REMOVED***)
);

test(
  'should ignore reducing custom property',
  testCss(
    ':root { --foo: calc(var(--bar) / 8); ***REMOVED***',
    ':root { --foo: calc(var(--bar)/8); ***REMOVED***'
  )
);
...
test(
  ...
  testCss(
    '@media (min-width:calc(10px+10px)){***REMOVED***',
    '@media (min-width:calc(10px+10px)){***REMOVED***'
  )
);
...
test(
  ...
  testCss('@media (min-width:calc(10px+10px)){***REMOVED***', '@media (min-width:20px){***REMOVED***', {
    mediaQueries: true,
  ***REMOVED***)
);
...
test(
  ...
  testCss('div[data-size="calc(3*3)"]{***REMOVED***', 'div[data-size="calc(3*3)"]{***REMOVED***')
);

test(
  'should ignore selectors (2)',
  testCss('div:nth-child(2n + calc(3*3)){***REMOVED***', 'div:nth-child(2n + calc(3*3)){***REMOVED***')
);

test(
  'should reduce calc in selectors when `selectors` option is set to true (1)',
  testCss('div[data-size="calc(3*3)"]{***REMOVED***', 'div[data-size="9"]{***REMOVED***', {
    selectors: true,
  ***REMOVED***)
);
...
test(
  ...
  testCss('div:nth-child(2n + calc(3*3)){***REMOVED***', 'div:nth-child(2n + 9){***REMOVED***', {
    selectors: true,
  ***REMOVED***)
);
...
test(
  ...
  testCss(
    '.@supports (width:calc(100% - constant(safe-area-inset-left))){.a{width:calc(100% - constant(safe-area-inset-left))***REMOVED******REMOVED***',
    '.@supports (width:calc(100% - constant(safe-area-inset-left))){.a{width:calc(100% - constant(safe-area-inset-left))***REMOVED******REMOVED***'
  )
);
...
test(
  ...
  testCss(
    'a{transform: translateY(calc(-100% - var(--tooltip-calculated-offset)))***REMOVED***',
    'a{transform: translateY(calc(-100% - var(--tooltip-calculated-offset)))***REMOVED***'
  )
);
