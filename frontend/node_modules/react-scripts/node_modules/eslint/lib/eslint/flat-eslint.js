...
const { existsSync ***REMOVED*** = require("fs");
 ...
 * @typedef {Object***REMOVED*** FlatESLintOptions
 ...
 * @param {CLIEngine***REMOVED*** eslint The CLIEngine instance.
 ...
 * @param {string***REMOVED*** cwd The current working directory to search from.
 * @returns {Promise<string|undefined>***REMOVED*** The filename if found or `undefined` if not.
 */
 ...
 * @param {string***REMOVED*** filePath The filename to load from.
 * @returns {Promise<any>***REMOVED*** The config loaded from the config file.
 */
async function loadFlatConfigFile(filePath) {
    debug(`Loading config from ${filePath***REMOVED***`);

    const fileURL = pathToFileURL(filePath);

    debug(`Config file URL is ${fileURL***REMOVED***`);
 ...
 * @param {import("./eslint").ESLintOptions***REMOVED*** options The ESLint instance options.
 * @returns {{configFilePath:string|undefined,basePath:string,error:Error|null***REMOVED******REMOVED*** Location information for
 *      the config file.
 */
async function locateConfigFileToUse({ configFile, cwd ***REMOVED***) {
    ...
    if (typeof configFile === "string") {
        debug(`Override config file path is ${configFile***REMOVED***`);
        configFilePath = path.resolve(cwd, configFile);
    ***REMOVED*** else if (configFile !== false) {
 ...
 * @param {FlatESLint***REMOVED*** eslint The instance to create the config array for.
 * @param {import("./eslint").ESLintOptions***REMOVED*** options The ESLint instance options.
 * @returns {FlatConfigArray***REMOVED*** The config array for `eslint``.
 */
...
***REMOVED***) {
    ...
    ***REMOVED***
    ...
    const { configFilePath, basePath, error ***REMOVED*** = await locateConfigFileToUse({ configFile, cwd ***REMOVED***);
    ...
    ***REMOVED***
    ...
    const configs = new FlatConfigArray(baseConfig || [], { basePath, shouldIgnore ***REMOVED***);
 ...
 * @param {FlatConfig***REMOVED*** config The config for the file that generated the message.
...
class FlatESLint {
     ...
     * @param {FlatESLintOptions***REMOVED*** options The options for this instance.
     */
    ...
    ***REMOVED***
    ...
    async lintFiles(patterns) {
        ...
        ***REMOVED***);
        ...
        debug(`${filePaths.length***REMOVED*** files found in: ${Date.now() - startTime***REMOVED***ms`);
    ...
    ***REMOVED***
    ...
    async loadFormatter(name = "stylish") {
        ...
        ***REMOVED*** else {
            ...
            ***REMOVED*** catch {
                formatterPath = path.resolve(__dirname, "../", "cli-engine", "formatters", `${normalizedFormatName***REMOVED***.js`);
            ***REMOVED***
        ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (typeof formatter !== "function") {
            throw new TypeError(`Formatter must be a function, but got a ${typeof formatter***REMOVED***.`);
        ***REMOVED***
        ...
        return {
             ...
             * @param {LintResults[]***REMOVED*** results The lint results to format.
    ...
    ***REMOVED***
     ...
     * @returns {string|undefined***REMOVED*** The path to the config file being used or
     *      `undefined` if no config file is being used.
     */
    async findConfigFile() {
        const options = privateMembers.get(this).options;
        const { configFilePath ***REMOVED*** = await locateConfigFileToUse(options);
 ...
 * @param {string***REMOVED*** [options.cwd] The current working directory.
 * @returns {Promise<boolean>***REMOVED*** Whether flat config should be used.
 */
async function shouldUseFlatConfig({ cwd = process.cwd() ***REMOVED*** = {***REMOVED***) {
