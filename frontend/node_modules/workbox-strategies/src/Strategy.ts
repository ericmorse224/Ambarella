...
abstract class Strategy implements RouteHandlerObject {
   ...
   */
  constructor(options: StrategyOptions = {***REMOVED***) {
    /**
  ...
  async _getResponse(
    ...
    ***REMOVED*** catch (error) {
      ...
      ***REMOVED*** else if (process.env.NODE_ENV !== 'production') {
        logger.log(
          `While responding to '${getFriendlyURL(request.url)***REMOVED***', ` +
            `an ${
              error instanceof Error ? error.toString() : ''
            ***REMOVED*** error occurred. Using a fallback response provided by ` +
