...
declare module "module" {
    ...
    ***REMOVED***
    interface Module extends NodeJS.Module {***REMOVED***
    namespace Module {
    ...
    ***REMOVED***
    namespace Module {
        ...
        namespace constants {
             ...
             * {@link enableCompileCache***REMOVED*** to indicate the result of the attempt to enable the
            ...
            namespace compileCacheStatus {
                 ...
                 * {@link enableCompileCache***REMOVED***, or by the `NODE_COMPILE_CACHE=dir`
        ...
        ***REMOVED***
        interface EnableCompileCacheResult {
            /**
             * One of the {@link constants.compileCacheStatus***REMOVED***
             */
            status: number;
            /**
        ...
        ***REMOVED***
         ...
         * `directory` field returned by this method, or with {@link getCompileCacheDir***REMOVED***.
         * @since v22.8.0
         ...
         * import { findPackageJSON ***REMOVED*** from 'node:module';
         *
        ...
        ***REMOVED***
         ...
         *
         * ```js
         * import { stripTypeScriptTypes ***REMOVED*** from 'node:module';
         ...
         * import { stripTypeScriptTypes ***REMOVED*** from 'node:module';
         * const code = 'const a: number = 1;';
         * const strippedCode = stripTypeScriptTypes(code, { mode: 'strip', sourceUrl: 'source.ts' ***REMOVED***);
         * console.log(strippedCode);
         * // Prints: const a         = 1\n\n//# sourceURL=source.ts;
         * ```
         *
         ...
         *   ***REMOVED***`;
         * const strippedCode = stripTypeScriptTypes(code, { mode: 'transform', sourceMap: true ***REMOVED***);
         * console.log(strippedCode);
         * // Prints:
         * // var MathUtil;
         * // (function(MathUtil) {
         * //     MathUtil.add = (a, b)=>a + b;
         * // ***REMOVED***)(MathUtil || (MathUtil = {***REMOVED***));
         ...
         * import { syncBuiltinESMExports ***REMOVED*** from 'node:module';
         *
         * fs.readFile = newAPI;
         *
        ...
        ***REMOVED***
         ...
         * when the hooks module is registered via {@link register***REMOVED***.
         *
         * This hook can receive data from a {@link register***REMOVED*** invocation, including
        ...
        ***REMOVED***
        ...
        class SourceMap {
             ...
             */
            findEntry(lineOffset: number, columnOffset: number): SourceMapping | {***REMOVED***;
            /**
             ...
             */
            findOrigin(lineNumber: number, columnNumber: number): SourceOrigin | {***REMOVED***;
        ***REMOVED***
    ...
    ***REMOVED***
    global {
        ...
        ***REMOVED***
        ...
        interface NodeModule extends NodeJS.Module {***REMOVED***
        /** @deprecated Use `NodeJS.Require` instead. */
        interface NodeRequire extends NodeJS.Require {***REMOVED***
        /** @deprecated Use `NodeJS.RequireResolve` instead. */
        interface RequireResolve extends NodeJS.RequireResolve {***REMOVED***
    ***REMOVED***
    export = Module;
***REMOVED***
