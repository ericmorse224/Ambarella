...
Returns: `{ afterEmit: SyncWaterfallHook, beforeEmit: SyncWaterfallHook ***REMOVED***`
...
```js
const { getCompilerHooks ***REMOVED*** = require('webpack-manifest-plugin');

class BatmanPlugin {
  apply(compiler) {
    const { beforeEmit ***REMOVED*** = getCompilerHooks(compiler);

    beforeEmit.tap('BatmanPlugin', (manifest) => {
      return { ...manifest, name: 'hello' ***REMOVED***;
    ***REMOVED***);
  ***REMOVED***
***REMOVED***
```
