...
/**
 * @typedef {import('@eslint-community/regexpp').AST.CharacterClass***REMOVED*** CharacterClass
 * @typedef {import('@eslint-community/regexpp').AST.ExpressionCharacterClass***REMOVED*** ExpressionCharacterClass
 */
//------------------------------------------------------------------------------
// Rule Definition
//------------------------------------------------------------------------------
 ...
 * ( ) [ ] { ***REMOVED*** / - \ | are ClassSetSyntaxCharacter
 */
const REGEX_CLASSSET_CHARACTER_ESCAPES = union(REGEX_GENERAL_ESCAPES, new Set("q/[{***REMOVED***|()-"));
...
module.exports = {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {boolean***REMOVED*** [disableEscapeBackslashSuggest] `true` if escapeBackslash suggestion should be turned off.
        ...
        ***REMOVED***
        ...
        function validateRegExp(node) {
            ...
            try {
                patternNode = parser.parsePattern(pattern, 0, pattern.length, { unicode, unicodeSets ***REMOVED***);
            ***REMOVED*** catch {
            ...
            ***REMOVED***
            ...
            /** @type {(CharacterClass | ExpressionCharacterClass)[]***REMOVED*** */
