    ...
    create(context, [options]) {
        ...
        ***REMOVED***
        function checkBeforeColon(node, expectedWhitespaceBeforeColon, mode) {
            const { typeAnnotation ***REMOVED*** = node;
        ...
        ***REMOVED***
        function checkAlignGroup(group) {
            ...
            ***REMOVED***
        ***REMOVED***
        function checkIndividualNode(node, { singleLine ***REMOVED***) {
            var _a, _b, _c;
        ...
        function validateBody(body) {
            ...
            ***REMOVED***
            for (const node of unalignedElements) {
                checkIndividualNode(node, { singleLine: isSingleLine ***REMOVED***);
            ***REMOVED***
        ***REMOVED***
        return Object.assign(Object.assign({***REMOVED***, baseRules), { TSTypeLiteral: validateBody, TSInterfaceBody: validateBody, ClassBody: validateBody ***REMOVED***);
    ***REMOVED***,
***REMOVED***);
