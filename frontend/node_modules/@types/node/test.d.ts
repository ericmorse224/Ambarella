...
declare module "node:test" {
    import { Readable ***REMOVED*** from "node:stream";
    /**
     ...
     *
     * ```js
     * import { tap ***REMOVED*** from 'node:test/reporters';
     * import { run ***REMOVED*** from 'node:test';
     * import process from 'node:process';
     * import path from 'node:path';
     *
     * run({ files: [path.resolve('./tests/test.js')] ***REMOVED***)
     *   .compose(tap)
     *   .pipe(process.stdout);
     * ```
     ...
     * @param fn The function under test. The first argument to this function is a {@link TestContext***REMOVED*** object.
    ...
    ***REMOVED***
     ...
     * Defaults to the `name` property of `fn`, or `'<anonymous>'` if `fn` does not have a name.
     * @param options Configuration options for the suite. This supports the same options as {@link test***REMOVED***.
     * @param fn The suite function declaring nested tests and suites. The first argument to this function is a {@link SuiteContext***REMOVED*** object.
    ...
    namespace suite {
        /**
         * Shorthand for skipping a suite. This is the same as calling {@link suite***REMOVED*** with `options.skip` set to `true`.
         * @since v20.13.0
         */
        ...
        /**
         * Shorthand for marking a suite as `TODO`. This is the same as calling {@link suite***REMOVED*** with `options.todo` set to `true`.
         * @since v20.13.0
         */
        ...
        /**
         * Shorthand for marking a suite as `only`. This is the same as calling {@link suite***REMOVED*** with `options.only` set to `true`.
         * @since v20.13.0
         */
    ...
    ***REMOVED***
    ...
    namespace describe {
        /**
         * Shorthand for skipping a suite. This is the same as calling {@link describe***REMOVED*** with `options.skip` set to `true`.
         * @since v18.15.0
         */
        function skip(name?: string, options?: TestOptions, fn?: SuiteFn): Promise<void>;
        function skip(name?: string, fn?: SuiteFn): Promise<void>;
        ...
        function skip(fn?: SuiteFn): Promise<void>;
        /**
         * Shorthand for marking a suite as `TODO`. This is the same as calling {@link describe***REMOVED*** with `options.todo` set to `true`.
         * @since v18.15.0
         */
        function todo(name?: string, options?: TestOptions, fn?: SuiteFn): Promise<void>;
        function todo(name?: string, fn?: SuiteFn): Promise<void>;
        ...
        function todo(fn?: SuiteFn): Promise<void>;
        /**
         * Shorthand for marking a suite as `only`. This is the same as calling {@link describe***REMOVED*** with `options.only` set to `true`.
         * @since v18.15.0
         */
        function only(name?: string, options?: TestOptions, fn?: SuiteFn): Promise<void>;
        function only(name?: string, fn?: SuiteFn): Promise<void>;
    ...
    ***REMOVED***
    ...
    namespace it {
        /**
         * Shorthand for skipping a test. This is the same as calling {@link it***REMOVED*** with `options.skip` set to `true`.
         */
        ...
        /**
         * Shorthand for marking a test as `TODO`. This is the same as calling {@link it***REMOVED*** with `options.todo` set to `true`.
         */
        ...
        /**
         * Shorthand for marking a test as `only`. This is the same as calling {@link it***REMOVED*** with `options.only` set to `true`.
         * @since v18.15.0
         */
    ...
    ***REMOVED***
    /**
     * Shorthand for skipping a test. This is the same as calling {@link test***REMOVED*** with `options.skip` set to `true`.
     * @since v20.2.0
     */
    function skip(name?: string, options?: TestOptions, fn?: TestFn): Promise<void>;
    function skip(name?: string, fn?: TestFn): Promise<void>;
    ...
    function skip(fn?: TestFn): Promise<void>;
    /**
     * Shorthand for marking a test as `TODO`. This is the same as calling {@link test***REMOVED*** with `options.todo` set to `true`.
     * @since v20.2.0
     */
    function todo(name?: string, options?: TestOptions, fn?: TestFn): Promise<void>;
    function todo(name?: string, fn?: TestFn): Promise<void>;
    ...
    function todo(fn?: TestFn): Promise<void>;
    /**
     * Shorthand for marking a test as `only`. This is the same as calling {@link test***REMOVED*** with `options.only` set to `true`.
     * @since v20.2.0
     */
    function only(name?: string, options?: TestOptions, fn?: TestFn): Promise<void>;
    function only(name?: string, fn?: TestFn): Promise<void>;
    ...
    function only(fn?: TestFn): Promise<void>;
    /**
     * The type of a function passed to {@link test***REMOVED***. The first argument to this function is a {@link TestContext***REMOVED*** object.
     * If the test uses callbacks, the callback function is passed as the second argument.
     */
    type TestFn = (t: TestContext, done: (result?: any) => void) => void | Promise<void>;
    /**
     * The type of a suite test function. The argument to this function is a {@link SuiteContext***REMOVED*** object.
     */
    ...
    ***REMOVED***
    ...
    class TestContext {
         ...
         * ```ts
         * import { test, type TestContext ***REMOVED*** from 'node:test';
         *
         ...
         *   t.plan(1, { wait: 2000 ***REMOVED***); // Waits for up to 2 seconds for the assertion to complete.
         *
         *   const asyncActivity = () => {
         *     setTimeout(() => {
         *          *       t.assert.ok(true, 'Async assertion completed within the wait time');
         *     ***REMOVED***, 1000); // Completes after 1 second, within the 2-second wait time.
         *   ***REMOVED***;
         *
         ...
         *     t.test('this subtest is run', { only: true ***REMOVED***),
         *   ]);
         * ***REMOVED***);
         * ```
         * @since v18.0.0, v16.17.0
         ...
         * ```js
         * test('top level test', async (t) => {
         *   await fetch('some/uri', { signal: t.signal ***REMOVED***);
         * ***REMOVED***);
         * ```
         ...
         * the same fashion as the top level {@link test***REMOVED*** function.
         * @since v18.0.0
         * @param name The name of the test, which is displayed when reporting test results.
         * Defaults to the `name` property of `fn`, or `'<anonymous>'` if `fn` does not have a name.
         * @param options Configuration options for the test.
         * @param fn The function under test. This first argument to this function is a {@link TestContext***REMOVED*** object.
         * If the test uses callbacks, the callback function is passed as the second argument.
         * @returns A {@link Promise***REMOVED*** resolved with `undefined` once the test completes.
         */
        test: typeof test;
        /**
    ...
    ***REMOVED***
        ...
        >
    {
         ...
         *   t.assert.fileSnapshot({ value1: 1, value2: 2 ***REMOVED***, './snapshots/snapshot.json');
         * ***REMOVED***);
         * ```
         *
         ...
         * ```js
         * test('snapshot test with default serialization', (t) => {
         *   t.assert.snapshot({ value1: 1, value2: 2 ***REMOVED***);
         * ***REMOVED***);
         *
         * test('snapshot test with custom serialization', (t) => {
         *   t.assert.snapshot({ value3: 3, value4: 4 ***REMOVED***, {
    ...
    ***REMOVED***
    ...
    class MockTracker {
         ...
         *   ***REMOVED***
         *
         *   const fn = t.mock.fn(addOne, addTwo, { times: 2 ***REMOVED***);
         *
         ...
         * @return The mocked function. The mocked function contains a special `mock` property, which is an instance of {@link MockFunctionContext***REMOVED***, and can be used for inspecting and changing the
         ...
         * @return The mocked method. The mocked method contains a special `mock` property, which is an instance of {@link MockFunctionContext***REMOVED***, and can be used for inspecting and changing the
    ...
    ***REMOVED***
    ...
    class MockTimers {
         ...
         *
         * ```js
         * import { mock ***REMOVED*** from 'node:test';
         * mock.timers.enable({ apis: ['setInterval', 'Date'], now: 1234 ***REMOVED***);
         * ```
         *
         ...
         * ```js
         * import { mock ***REMOVED*** from 'node:test';
         * mock.timers.enable({ apis: ['Date'], now: 1000 ***REMOVED***);
         * ```
         *
         ...
         * ```js
         * import { mock ***REMOVED*** from 'node:test';
         * mock.timers.enable({ apis: ['Date'], now: new Date() ***REMOVED***);
         * ```
         *
         ...
         * import { test ***REMOVED*** from 'node:test';
         * test('sets the time of a date object', (context) => {
         *   // Optionally choose what to mock
         *   context.mock.timers.enable({ apis: ['Date'], now: 100 ***REMOVED***);
         ...
         *
         *   context.mock.timers.enable({ apis: ['setTimeout'] ***REMOVED***);
         *
         *   setTimeout(fn, 9999);
         *
         ...
         *   const fn = context.mock.fn();
         *
         *   context.mock.timers.enable({ apis: ['setTimeout', 'Date'] ***REMOVED***);
         *   setTimeout(fn, 9999);
         *
         *   assert.strictEqual(fn.mock.callCount(), 0);
        ...
        runAll(): void;
        /**
         * Calls {@link MockTimers.reset()***REMOVED***.
         */
        [Symbol.dispose](): void;
    ***REMOVED***
    /**
...
declare module "node:test/reporters" {
    import { Transform, TransformOptions ***REMOVED*** from "node:stream";

    type TestEvent =
        | { type: "test:coverage"; data: TestCoverage ***REMOVED***
        | { type: "test:complete"; data: TestComplete ***REMOVED***
        | { type: "test:dequeue"; data: TestDequeue ***REMOVED***
        | { type: "test:diagnostic"; data: DiagnosticData ***REMOVED***
        | { type: "test:enqueue"; data: TestEnqueue ***REMOVED***
        | { type: "test:fail"; data: TestFail ***REMOVED***
        | { type: "test:pass"; data: TestPass ***REMOVED***
        | { type: "test:plan"; data: TestPlan ***REMOVED***
        | { type: "test:start"; data: TestStart ***REMOVED***
        | { type: "test:stderr"; data: TestStderr ***REMOVED***
        | { type: "test:stdout"; data: TestStdout ***REMOVED***
        | { type: "test:summary"; data: TestSummary ***REMOVED***
        | { type: "test:watch:drained"; data: undefined ***REMOVED***;
    ...
    ***REMOVED***
    ...
    export { dot, junit, lcov, spec, tap, TestEvent ***REMOVED***;
***REMOVED***
