...
function getPropertyNameFromType(type) {
    ...
    if (type.flags & (ts.TypeFlags.StringLiteral | ts.TypeFlags.NumberLiteral)) {
        ...
        return { displayName: value, symbolName: ts.escapeLeadingUnderscores(value) ***REMOVED***;
    ***REMOVED***
    if (type_1.isUniqueESSymbolType(type))
        return {
            displayName: `[${type.symbol
                ? `${isKnownSymbol(type.symbol) ? 'Symbol.' : ''***REMOVED***${type.symbol.name***REMOVED***`
                : type.escapedName.replace(/^__@|@\d+$/g, '')***REMOVED***]`,
