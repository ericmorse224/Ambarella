...
import { AST_Toplevel, AST_Node, walk, AST_Scope ***REMOVED*** from "./ast.js";
import { parse ***REMOVED*** from "./parse.js";
import { OutputStream ***REMOVED*** from "./output.js";
import { Compressor ***REMOVED*** from "./compress/index.js";
import { base54 ***REMOVED*** from "./scope.js";
import { SourceMap ***REMOVED*** from "./sourcemap.js";
import {
    mangle_properties,
    mangle_private_properties,
    reserve_quoted_keys,
    find_annotated_props,
***REMOVED*** from "./propmangle.js";
...
function init_cache(cache) {
    ...
    if (!("props" in cache)) {
        cache.props = new Map();
    ***REMOVED*** else if (!(cache.props instanceof Map)) {
...
function log_input(files, options, fs, debug_folder) {
    ...
    ***REMOVED***
    ...
    const log_path = `${debug_folder***REMOVED***/terser-debug-${(Math.random() * 9999999) | 0***REMOVED***.log`;
    ...
    ***REMOVED***, 4);
    ...
    const files_str = (file) => {
        ...
        ***REMOVED*** else if (typeof file === "object") {
            return Object.keys(file)
                .map((key) => key + ": " + files_str(file[key]))
                .join("\n\n");
        ***REMOVED*** else if (typeof file === "string") {
            return "```\n" + file + "\n```";
        ***REMOVED*** else {
            return file; // What do?
        ***REMOVED***
...
function* minify_sync_or_async(files, options, _fs_module) {
    ...
    ***REMOVED***
    options.format = options.format || options.output || {***REMOVED***;
    ...
    ***REMOVED***
    ...
    if (!HOP(options.format, "code") || options.format.code) {
        ...
        format_options = {...options.format***REMOVED***;
        ...
        ***REMOVED***
        ...
        if (options.sourceMap) {
            ...
            ***REMOVED*** else if (options.sourceMap.url) {
