...
```javascript
var ajv = new Ajv({schemaId: 'id'***REMOVED***);
// If you want to use both draft-04 and draft-06/07 schemas:
// var ajv = new Ajv({schemaId: 'auto'***REMOVED***);
...
var ajv = new Ajv(); // options can be passed, e.g. {allErrors: true***REMOVED***
...
var schema = {
  ...
  "type": "object",
  "properties": {
    "foo": { "$ref": "defs.json#/definitions/int" ***REMOVED***,
    "bar": { "$ref": "defs.json#/definitions/str" ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
var defsSchema = {
  ...
  "definitions": {
    "int": { "type": "integer" ***REMOVED***,
    "str": { "type": "string" ***REMOVED***
  ***REMOVED***
***REMOVED***;
```
...
```javascript
var ajv = new Ajv({schemas: [schema, defsSchema]***REMOVED***);
...
```javascript
var ajv = new Ajv({$data: true***REMOVED***);

var schema = {
  "properties": {
    "smaller": {
      "type": "number",
      "maximum": { "$data": "1/larger" ***REMOVED***
    ***REMOVED***,
    "larger": { "type": "number" ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
```json
{
  "$merge": {
    "source": {
      "type": "object",
      "properties": { "p": { "type": "string" ***REMOVED*** ***REMOVED***,
      "additionalProperties": false
    ***REMOVED***,
    "with": {
      "properties": { "q": { "type": "number" ***REMOVED*** ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
```json
{
  "$patch": {
    ...
    ***REMOVED***,
    "with": [
      { "op": "add", "path": "/properties/q", "value": { "type": "number" ***REMOVED*** ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
```json
{
  "type": "object",
  "properties": {
    "p": { "type": "string" ***REMOVED***,
    "q": { "type": "number" ***REMOVED***
  ***REMOVED***,
  "additionalProperties": false
***REMOVED***
```
...
ajv.addKeyword('range', {
  ...
  compile: function (sch, parentSchema) {
    ...
    return parentSchema.exclusiveRange === true
            ? function (data) { return data > min && data < max; ***REMOVED***
            : function (data) { return data >= min && data <= max; ***REMOVED***
  ***REMOVED***
***REMOVED***);

var schema = { "range": [2, 4], "exclusiveRange": true ***REMOVED***;
var validate = ajv.compile(schema);
...
```javascript
var ajv = new Ajv({ loadSchema: loadSchema ***REMOVED***);
...
var schema = {
  ...
  "properties": {
    "userId": {
      "type": "integer",
      "idExists": { "table": "users" ***REMOVED***
    ***REMOVED***,
    "postId": {
      "type": "integer",
      "idExists": { "table": "posts" ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
validate({ userId: 1, postId: 19 ***REMOVED***)
.then(function (data) {
  console.log('Data is valid', data); // { userId: 1, postId: 19 ***REMOVED***
***REMOVED***)
.catch(function (err) {
...
```javascript
var ajv = new Ajv({ processCode: transpileFunc ***REMOVED***);
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
```
...
const schema1 = {format: 'email'***REMOVED***;
isSchemaSecure(schema1); // false

const schema2 = {format: 'email', maxLength: MAX_LENGTH***REMOVED***;
...
```javascript
var ajv = new Ajv({ removeAdditional: true ***REMOVED***);
var schema = {
  "additionalProperties": false,
  "properties": {
    "foo": { "type": "number" ***REMOVED***,
    "bar": {
      "additionalProperties": { "type": "number" ***REMOVED***,
      "properties": {
        "baz": { "type": "string" ***REMOVED***
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
...
console.log(data); // { "foo": 0, "bar": { "baz": "abc", "additional2": 2 ***REMOVED***
```
...
```json
{
  ...
  ***REMOVED***,
  "additionalProperties": false,
  "oneOf": [
    { "required": [ "foo" ] ***REMOVED***,
    { "required": [ "bar" ] ***REMOVED***
  ]
***REMOVED***
```
...
```javascript
var ajv = new Ajv({ useDefaults: true ***REMOVED***);
var schema = {
  "type": "object",
  "properties": {
    "foo": { "type": "number" ***REMOVED***,
    "bar": { "type": "string", "default": "baz" ***REMOVED***
  ***REMOVED***,
  "required": [ "foo", "bar" ]
***REMOVED***;

var data = { "foo": 1 ***REMOVED***;

var validate = ajv.compile(schema);

console.log(validate(data)); // true
console.log(data); // { "foo": 1, "bar": "baz" ***REMOVED***
```
...
var schema = {
  ...
  "items": [
    { "type": "number" ***REMOVED***,
    { "type": "string", "default": "foo" ***REMOVED***
  ]
***REMOVED***
...
```javascript
var ajv = new Ajv({ coerceTypes: true ***REMOVED***);
var schema = {
  "type": "object",
  "properties": {
    "foo": { "type": "number" ***REMOVED***,
...
var data = { "foo": "1", "bar": "false" ***REMOVED***;

var validate = ajv.compile(schema);

console.log(validate(data)); // true
console.log(data); // { "foo": 1, "bar": false ***REMOVED***
```

Example 2 (array coercions):

```javascript
var ajv = new Ajv({ coerceTypes: 'array' ***REMOVED***);
var schema = {
  "properties": {
    "foo": { "type": "array", "items": { "type": "number" ***REMOVED*** ***REMOVED***,
    "bar": { "type": "boolean" ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
```javascript
{
  ...
  loadSchema:       undefined, // function(uri: string): Promise {***REMOVED***
  ...
  messages:         true,
  sourceCode:       false,
  processCode:      undefined, // function (str: string, schema: object): string {***REMOVED***
  cache:            new Cache,
  serialize:        undefined
***REMOVED***
```
