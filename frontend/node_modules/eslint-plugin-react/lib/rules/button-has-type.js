...
const messages = {
  ...
  invalidValue: '"{{value***REMOVED******REMOVED***" is an invalid value for button type attribute',
  forbiddenValue: '"{{value***REMOVED******REMOVED***" is an invalid value for button type attribute',
***REMOVED***;
...
module.exports = {
  ...
  ***REMOVED***,
  ...
  create(context) {
    const configuration = Object.assign({***REMOVED***, optionDefaults, context.options[0]);
    ...
    function checkValue(node, value) {
      if (!(value in configuration)) {
        report(context, messages.invalidValue, 'invalidValue', {
          ...
          ***REMOVED***,
        ***REMOVED***);
      ***REMOVED*** else if (!configuration[value]) {
