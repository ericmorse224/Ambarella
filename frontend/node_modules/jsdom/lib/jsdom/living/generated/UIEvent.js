...
exports.convert = (value, { context = "The provided value" ***REMOVED*** = {***REMOVED***) => {
  ...
  ***REMOVED***
  throw new TypeError(`${context***REMOVED*** is not of type 'UIEvent'.`);
***REMOVED***;
...
exports.install = (globalObject, globalNames) => {
    ...
    constructor(type) {
      ...
      ***REMOVED***
      const args = [];
      {
        ...
        curArg = conversions["DOMString"](curArg, { context: "Failed to construct 'UIEvent': parameter 1" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
      {
        let curArg = arguments[1];
        curArg = UIEventInit.convert(curArg, { context: "Failed to construct 'UIEvent': parameter 2" ***REMOVED***);
        args.push(curArg);
      ***REMOVED***
  ...
  ***REMOVED***
  Object.defineProperties(UIEvent.prototype, {
    initUIEvent: { enumerable: true ***REMOVED***,
    view: { enumerable: true ***REMOVED***,
    detail: { enumerable: true ***REMOVED***,
    which: { enumerable: true ***REMOVED***,
    [Symbol.toStringTag]: { value: "UIEvent", configurable: true ***REMOVED***
  ***REMOVED***);
  if (globalObject[ctorRegistrySymbol] === undefined) {
