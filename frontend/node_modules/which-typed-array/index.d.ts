 ...
 *
 * @param {unknown***REMOVED*** value The potential collection
 * @returns {TypedArrayName | false | null***REMOVED*** 'Int8Array' | 'Uint8Array' | 'Uint8ClampedArray' | 'Int16Array' | 'Uint16Array' | 'Int32Array' | 'Uint32Array' | 'Float32Array' | 'Float64Array' | 'BigInt64Array' | 'BigUint64Array' | false | null
 */
