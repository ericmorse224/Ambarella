...
const { runtimeEqual ***REMOVED*** = require("../util/runtime");

/** @typedef {import("../../declarations/plugins/optimize/MergeDuplicateChunksPlugin").MergeDuplicateChunksPluginOptions***REMOVED*** MergeDuplicateChunksPluginOptions */
...
class MergeDuplicateChunksPlugin {
	/**
	 * @param {MergeDuplicateChunksPluginOptions***REMOVED*** options options object
	 */
	constructor(options = { stage: STAGE_BASIC ***REMOVED***) {
		validate(options);
