import type { YAMLError, YAMLWarning ***REMOVED*** from '../errors';
import { Alias ***REMOVED*** from '../nodes/Alias';
import { NODE_TYPE ***REMOVED*** from '../nodes/identity';
import type { Node, NodeType, ParsedNode, Range ***REMOVED*** from '../nodes/Node';
import { Pair ***REMOVED*** from '../nodes/Pair';
import type { Scalar ***REMOVED*** from '../nodes/Scalar';
import type { YAMLMap ***REMOVED*** from '../nodes/YAMLMap';
import type { YAMLSeq ***REMOVED*** from '../nodes/YAMLSeq';
import type { CreateNodeOptions, DocumentOptions, ParseOptions, SchemaOptions, ToJSOptions, ToStringOptions ***REMOVED*** from '../options';
import { Schema ***REMOVED*** from '../schema/Schema';
import { Directives ***REMOVED*** from './directives';
