...
exports.default = (0, util_1.createRule)({
    ...
    meta: Object.assign(Object.assign({***REMOVED***, baseRule.meta), { docs: {
    ...
    create(context) {
        ...
        ***REMOVED***;
        ...
        function reportNoBeginningSpace(node, token) {
            const nextToken = context
                .getSourceCode()
                .getTokenAfter(token, { includeComments: true ***REMOVED***);
            context.report({
                node,
        ...
        ***REMOVED***
        ...
        function reportNoEndingSpace(node, token) {
            const previousToken = context
                .getSourceCode()
                .getTokenBefore(token, { includeComments: true ***REMOVED***);
            context.report({
                node,
        ...
        ***REMOVED***
        ...
        return Object.assign(Object.assign({***REMOVED***, rules), { TSMappedType(node) {
