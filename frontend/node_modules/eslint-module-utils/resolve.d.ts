import type { Rule ***REMOVED*** from 'eslint';

import type ModuleCache from './ModuleCache';
import type { ESLintSettings ***REMOVED*** from './types';

export type ResultNotFound = { found: false, path?: undefined ***REMOVED***;
export type ResultFound = { found: true, path: string | null ***REMOVED***;
...
export type Resolver = { interfaceVersion?: 1 | 2, resolve: ResolverResolve, resolveImport: ResolverResolveImport ***REMOVED***;
...
export { fileExistsWithCaseSync, relative ***REMOVED***;
