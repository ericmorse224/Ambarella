	...
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED***;
		...
		if (context.options.length) {
			if (context.options[0] === "tab") {
				indentSize = 1;
				indentType = "tab";
			***REMOVED*** /* c8 ignore start */ else if (
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** needed Expected indentation character count
		 * @param {number***REMOVED*** gottenSpaces Indentation space count in the actual node/code
		 * @param {number***REMOVED*** gottenTabs Indentation tab count in the actual node/code
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** neededIndent needed indent
		 * @returns {void***REMOVED***
		 */
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** indent needed indent
		 * @returns {void***REMOVED***
		 */
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** lastLineIndent needed indent
		 * @returns {void***REMOVED***
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node Node to examine
		 * @param {number***REMOVED*** firstLineIndent first line needed indent
		 * @returns {void***REMOVED***
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node Node to examine
		 * @param {number***REMOVED*** firstLineIndent needed indent
		 * @returns {void***REMOVED***
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node node to examine
		 * @param {number***REMOVED*** [providedSwitchIndent] indent for switch statement
		 * @returns {number***REMOVED*** indent size
		 */
