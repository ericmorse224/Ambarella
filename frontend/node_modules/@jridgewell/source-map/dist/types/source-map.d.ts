import { AnyMap, originalPositionFor, generatedPositionFor, eachMapping ***REMOVED*** from '@jridgewell/trace-mapping';
import { GenMapping, maybeAddMapping, toDecodedMap, toEncodedMap, setSourceContent ***REMOVED*** from '@jridgewell/gen-mapping';
import type { TraceMap, SourceMapInput, SectionedSourceMapInput, DecodedSourceMap ***REMOVED*** from '@jridgewell/trace-mapping';
export type { TraceMap, SourceMapInput, SectionedSourceMapInput, DecodedSourceMap ***REMOVED***;
import type { Mapping, EncodedSourceMap ***REMOVED*** from '@jridgewell/gen-mapping';
export type { Mapping, EncodedSourceMap ***REMOVED***;
