...
declare module 'inspector' {
    ...
    namespace Debugger {
        ...
        ***REMOVED***
        interface ScriptParsedEventDataType {
             ...
             * Embedder-specific auxiliary data.
             */
            executionContextAuxData?: {***REMOVED*** | undefined;
            /**
    ...
    ***REMOVED***
    ...
    class Session extends EventEmitter {
         ...
         *
         * ```js
         * session.post('Runtime.evaluate', { expression: '2 + 2' ***REMOVED***,
         *              (error, { result ***REMOVED***) => console.log(result));
         * // Output: { type: 'number', value: 4, description: '4' ***REMOVED***
         * ```
         *
...
declare module 'inspector/promises' {
    ...
    ***REMOVED*** from 'inspector';
    ...
    class Session extends EventEmitter {
         ...
         *
         * ```js
         * import { Session ***REMOVED*** from 'node:inspector/promises';
         * try {
         *   const session = new Session();
         *   session.connect();
         *   const result = await session.post('Runtime.evaluate', { expression: '2 + 2' ***REMOVED***);
         *   console.log(result);
         * ***REMOVED*** catch (error) {
         *   console.error(error);
         * ***REMOVED***
         * // Output: { result: { type: 'number', value: 4, description: '4' ***REMOVED*** ***REMOVED***
         * ```
         *
         * The latest version of the V8 inspector protocol is published on the
         * [Chrome DevTools Protocol Viewer](https://chromedevtools.github.io/devtools-protocol/v8/).
