...
```js
const { cosmiconfig, cosmiconfigSync ***REMOVED*** = require('cosmiconfig');
// ...
...
```js
const { cosmiconfig ***REMOVED*** = require('cosmiconfig');
...
If your [`searchPlaces`] value will include files, as it does by default (e.g. `${moduleName***REMOVED***rc`), your `moduleName` must consist of characters allowed in filenames. That means you should not copy scoped package names, such as `@my-org/my-package`, directly into `moduleName`.
...
```js
explorer.search([searchFrom]).then(result => {..***REMOVED***)
```
...
```js
explorer.load(loadPath).then(result => {..***REMOVED***)
```
...
```js
const { cosmiconfigSync ***REMOVED*** = require('cosmiconfig');
...
[
  ...
  `.config/${moduleName***REMOVED***rc`,
  `.config/${moduleName***REMOVED***rc.json`,
  `.config/${moduleName***REMOVED***rc.yaml`,
  `.config/${moduleName***REMOVED***rc.yml`,
  `.config/${moduleName***REMOVED***rc.js`,
  `.config/${moduleName***REMOVED***rc.cjs`,
...
```js
const { defaultLoaders ***REMOVED*** = require('cosmiconfig');
