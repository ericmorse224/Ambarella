...
const { isEqToken ***REMOVED*** = require("./utils/ast-utils");
...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			missingSpace: "Operator '{{operator***REMOVED******REMOVED***' must be spaced.",
		***REMOVED***,
	***REMOVED***,
	...
	create(context) {
		 ...
		 * @param {ASTNode***REMOVED*** left The left node of the main node
		 * @param {ASTNode***REMOVED*** right The right node of the main node
		 * @param {string***REMOVED*** op The operator of the main node
		 * @returns {Object***REMOVED*** The violator token or null
		 * @private
		 */
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** mainNode The node to report
		 * @param {Object***REMOVED*** culpritToken The token which has a problem
