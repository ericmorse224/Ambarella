...
const { parseFragment ***REMOVED*** = require("../../browser/parser/index");

const { HTML_NS ***REMOVED*** = require("../helpers/namespaces");
const { domSymbolTree ***REMOVED*** = require("../helpers/internal-constants");
const { compareBoundaryPointsPosition ***REMOVED*** = require("./boundary-point");
const { nodeRoot, nodeLength, isInclusiveAncestor ***REMOVED*** = require("../helpers/node");
const { createElement ***REMOVED*** = require("../helpers/create-element");

const AbstractRangeImpl = require("./AbstractRange-impl").implementation;

const Range = require("../generated/Range");
const DocumentFragment = require("../generated/DocumentFragment");
const { implForWrapper ***REMOVED*** = require("../generated/utils");
...
class RangeImpl extends AbstractRangeImpl {
  ...
  ***REMOVED***
  ...
  get commonAncestorContainer() {
    const { _start, _end ***REMOVED*** = this;
  ...
  ***REMOVED***
  ...
  compareBoundaryPoints(how, sourceRange) {
    ...
    ***REMOVED*** else if (how === RANGE_COMPARISON_TYPE.START_TO_END) {
      thisPoint = this._end;
      otherPoint = sourceRange._start;
    ***REMOVED*** else if (how === RANGE_COMPARISON_TYPE.END_TO_END) {
      thisPoint = this._end;
  ...
  ***REMOVED***
  ...
  deleteContents() {
    ...
    ***REMOVED***
    ...
    const { _start: originalStart, _end: originalEnd ***REMOVED*** = this;
  ...
  ***REMOVED***
  ...
  cloneRange() {
    const { _start, _end, _globalObject ***REMOVED*** = this;

    return Range.createImpl(_globalObject, [], {
      start: { node: _start.node, offset: _start.offset ***REMOVED***,
      end: { node: _end.node, offset: _end.offset ***REMOVED***
    ***REMOVED***);
  ***REMOVED***
  ...
  comparePoint(node, offset) {
    ...
    ***REMOVED***
    ...
    if (compareBoundaryPointsPosition(bp, this._start) === -1) {
      return -1;
    ***REMOVED*** else if (compareBoundaryPointsPosition(bp, this._end) === 1) {
      return 1;
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  intersectsNode(node) {
    ...
    ***REMOVED***
    ...
    return (
      compareBoundaryPointsPosition({ node: parent, offset ***REMOVED***, this._end) === -1 &&
      compareBoundaryPointsPosition({ node: parent, offset: offset + 1 ***REMOVED***, this._start) === 1
    );
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  createContextualFragment(fragment) {
    const { node ***REMOVED*** = this._start;
...
function isContained(node, range) {
  const { _start, _end ***REMOVED*** = range;
  return (
    compareBoundaryPointsPosition({ node, offset: 0 ***REMOVED***, _start) === 1 &&
    compareBoundaryPointsPosition({ node, offset: nodeLength(node) ***REMOVED***, _end) === -1
  );
***REMOVED***
...
function insertNodeInRange(node, range) {
  const { node: startNode, offset: startOffset ***REMOVED*** = range._start;
...
function cloneRange(range) {
  const { _start: originalStart, _end: originalEnd, _globalObject ***REMOVED*** = range;
  ...
  ***REMOVED***
  ...
  if (
    ...
    fragment.appendChild(cloned);
  ***REMOVED*** else if (firstPartialContainedChild !== null) {
    const cloned = clone(firstPartialContainedChild);
    fragment.appendChild(cloned);

    const subrange = Range.createImpl(_globalObject, [], {
      start: { node: originalStart.node, offset: originalStart.offset ***REMOVED***,
      end: { node: firstPartialContainedChild, offset: nodeLength(firstPartialContainedChild) ***REMOVED***
    ***REMOVED***);
  ...
  ***REMOVED***
  ...
  if (
    ...
    fragment.appendChild(cloned);
  ***REMOVED*** else if (lastPartiallyContainedChild !== null) {
    const cloned = clone(lastPartiallyContainedChild);
    fragment.appendChild(cloned);

    const subrange = Range.createImpl(_globalObject, [], {
      start: { node: lastPartiallyContainedChild, offset: 0 ***REMOVED***,
      end: { node: originalEnd.node, offset: originalEnd.offset ***REMOVED***
    ***REMOVED***);
