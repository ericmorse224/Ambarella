...
class LikertScale extends ArrayPrompt {
  constructor(options = {***REMOVED***) {
    ...
    if (typeof this.scale === 'number') {
      this.scaleKey = false;
      this.scale = Array(this.scale).fill(0).map((v, i) => ({ name: i + start ***REMOVED***));
    ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  renderScaleKey() {
    ...
    let scale = this.scale.map(item => `   ${item.name***REMOVED*** - ${item.message***REMOVED***`);
  ...
  ***REMOVED***
  ...
  async renderChoice(choice, i) {
    ...
    ***REMOVED***
    ...
    let msg = utils.wordWrap(message, { width: this.widths[0], newline ***REMOVED***);
  ...
  ***REMOVED***
  ...
  async render() {
    let { submitted, size ***REMOVED*** = this.state;
