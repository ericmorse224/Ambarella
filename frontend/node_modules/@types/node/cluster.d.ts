 ...
 * import { availableParallelism ***REMOVED*** from 'node:os';
 * import process from 'node:process';
 *
 * const numCPUs = availableParallelism();
 *
 * if (cluster.isPrimary) {
 *   console.log(`Primary ${process.pid***REMOVED*** is running`);
 *
 *   // Fork workers.
 ...
 *     console.log(`worker ${worker.process.pid***REMOVED*** died`);
 *   ***REMOVED***);
 * ***REMOVED*** else {
 ...
 *   ***REMOVED***).listen(8000);
 *
 *   console.log(`Worker ${process.pid***REMOVED*** started`);
 * ***REMOVED***
 * ```
 *
...
declare module "cluster" {
    ...
    ***REMOVED***
    ...
    export class Worker extends EventEmitter {
         ...
         *
         * ***REMOVED*** else if (cluster.isWorker) {
    ...
    ***REMOVED***
    export interface Cluster extends EventEmitter {
         ...
         *   cluster.fork();
         * ***REMOVED*** else if (cluster.isWorker) {
         *   console.log(`I am worker #${cluster.worker.id***REMOVED***`);
         * ***REMOVED***
         * ```
         * @since v0.7.0
         */
...
declare module "node:cluster" {
    export * from "cluster";
    export { default as default ***REMOVED*** from "cluster";
***REMOVED***
