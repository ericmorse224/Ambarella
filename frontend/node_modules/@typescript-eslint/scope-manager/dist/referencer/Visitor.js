...
Object.defineProperty(exports, "VisitorBase", { enumerable: true, get: function () { return VisitorBase_1.VisitorBase; ***REMOVED*** ***REMOVED***);
class Visitor extends VisitorBase_1.VisitorBase {
    constructor(optionsOrVisitor) {
        ...
        __classPrivateFieldSet(this, _Visitor_options, optionsOrVisitor instanceof Visitor
            ...
            : optionsOrVisitor, "f");
    ***REMOVED***
    visitPattern(node, callback, options = { processRightHandNodes: false ***REMOVED***) {
