...
var functionsHaveNames = function f() {***REMOVED***.name === 'f';
...
test('shimmed', function (t) {
	...
	***REMOVED***);
	...
	t.test('bad array/this value', { skip: !supportsStrictMode ***REMOVED***, function (st) {
		st['throws'](function () { return Array.prototype.findLast.call(undefined, 'a'); ***REMOVED***, TypeError, 'undefined is not an object');
		st['throws'](function () { return Array.prototype.findLast.call(null, 'a'); ***REMOVED***, TypeError, 'null is not an object');
		st.end();
	***REMOVED***);

	t.test('Symbol.unscopables', { skip: typeof Symbol !== 'function' || typeof Symbol.unscopables !== 'symbol' ***REMOVED***, function (st) {
