...
declare class Reference {
    ...
    /**
     * The {@link Variable***REMOVED*** object that this reference refers to. If such variable was not defined, this is `null`.
     * @public
     */
    ...
    isReadWrite(): boolean;
***REMOVED***
export { Reference, ReferenceFlag, ReferenceTypeFlag, ReferenceImplicitGlobal ***REMOVED***;
