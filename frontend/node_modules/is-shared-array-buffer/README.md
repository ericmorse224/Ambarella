...
assert(!isSharedArrayBuffer(function () {***REMOVED***));
assert(!isSharedArrayBuffer(null));
assert(!isSharedArrayBuffer(function* () { yield 42; return Infinity; ***REMOVED***);
...
assert(!isSharedArrayBuffer(new WeakRef({***REMOVED***)));
assert(!isSharedArrayBuffer(new FinalizationRegistry(() => {***REMOVED***)));
assert(!isSharedArrayBuffer(new ArrayBuffer()));

assert(isSharedArrayBuffer(new SharedArrayBuffer()));

class MySharedArrayBuffer extends SharedArrayBuffer {***REMOVED***
