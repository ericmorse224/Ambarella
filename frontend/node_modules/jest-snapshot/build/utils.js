...
const SNAPSHOT_VERSION_WARNING = _chalk.default.yellow(
  `${_chalk.default.bold('Warning')***REMOVED***: Before you upgrade snapshots, ` +
...
const writeSnapshotVersion = () =>
  `// Jest Snapshot v${SNAPSHOT_VERSION***REMOVED***, ${SNAPSHOT_GUIDE_LINK***REMOVED***`;
  ...
  if (!version) {
    return new Error(
      _chalk.default.red(
        `${_chalk.default.bold(
          'Outdated snapshot'
        )***REMOVED***: No snapshot header found. ` +
    ...
    return new Error(
      _chalk.default.red(
        `${_chalk.default.red.bold(
          'Outdated snapshot'
        )***REMOVED***: The version of the snapshot ` +
          'file associated with this test is outdated. The snapshot file ' +
          'version ensures that all developers on a project are using ' +
          'the same version of Jest. ' +
          'Please update all snapshots during this upgrade of Jest.\n\n'
      ) +
        `Expected: v${SNAPSHOT_VERSION***REMOVED***\n` +
        `Received: v${version***REMOVED***\n\n` +
        SNAPSHOT_VERSION_WARNING
    );
  ***REMOVED***
...
const getSnapshotData = (snapshotPath, update) => {
  ...
  ***REMOVED***
  ...
  return {
    ...
    dirty
  ***REMOVED***;
***REMOVED***; // Add extra line breaks at beginning and end of multiline snapshot
...
const serialize = (val, indent = 2, formatOverrides = {***REMOVED***) =>
  normalizeNewlines(
...
const minify = val =>
  (0, _prettyFormat.format)(val, {
    ...
    plugins: (0, _plugins.getSerializers)(),
    printFunctionName
  ***REMOVED***); // Remove double quote marks and unescape double quotes and backslashes.
...
const deepMergeArray = (target, source) => {
  ...
  source.forEach((sourceElement, index) => {
    ...
    ***REMOVED*** else if (isObject(targetElement)) {
  ...
  ***REMOVED***);
  return mergedOutput;
***REMOVED***; // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types

const deepMerge = (target, source) => {
  if (isObject(target) && isObject(source)) {
    const mergedOutput = {...target***REMOVED***;
    Object.keys(source).forEach(key => {
      ...
      ***REMOVED*** else if (Array.isArray(source[key])) {
    ...
    ***REMOVED***);
    return mergedOutput;
  ***REMOVED*** else if (Array.isArray(target) && Array.isArray(source)) {
