...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			replaced:
				"Assignment (=) can be replaced with operator assignment ({{operator***REMOVED******REMOVED***).",
			unexpected:
				"Unexpected operator assignment ({{operator***REMOVED******REMOVED***) shorthand.",
		***REMOVED***,
	***REMOVED***,
							...
							if (canBeFixed(left) && canBeFixed(expr.left)) {
								...
								***REMOVED***
								...
								return fixer.replaceText(
									node,
									`${leftText***REMOVED***${replacementOperator***REMOVED***${rightText***REMOVED***`,
								);
							***REMOVED***
							return null;
						***REMOVED***,
					...
					fix(fixer) {
						if (canBeFixed(node.left)) {
							...
							***REMOVED***
							...
							return fixer.replaceText(
								node,
								`${leftText***REMOVED***= ${leftText***REMOVED***${newOperator***REMOVED***${rightText***REMOVED***`,
							);
						***REMOVED***
						return null;
					***REMOVED***,
