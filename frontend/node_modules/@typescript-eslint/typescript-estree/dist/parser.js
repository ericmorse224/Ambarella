...
function parse(code, options) {
    const { ast ***REMOVED*** = parseWithNodeMapsInternal(code, options, false);
    return ast;
***REMOVED***
exports.parse = parse;
function parseWithNodeMapsInternal(code, options, shouldPreserveNodeMaps) {
    ...
    ***REMOVED***
     ...
     */
    const { estree, astMaps ***REMOVED*** = (0, ast_converter_1.astConverter)(ast, parseSettings, shouldPreserveNodeMaps);
    return {
        ast: estree,
...
let parseAndGenerateServicesCalls = {***REMOVED***;
...
function clearParseAndGenerateServicesCalls() {
    parseAndGenerateServicesCalls = {***REMOVED***;
***REMOVED***
...
function parseAndGenerateServices(code, options) {
    ...
    ***REMOVED***
    const { ast, program ***REMOVED*** = parseSettings.singleRun &&
        options.filePath &&
