...
following tokens are replaced in templates:
  ...
  * `{directory***REMOVED***` with the name of the directory.
  * `{files***REMOVED***` with the HTML of an unordered list of file links.
  * `{linked-path***REMOVED***` with the HTML of a link to the directory.
  * `{style***REMOVED***` with the specified stylesheet and embedded images.
...
var index = serveIndex('public/ftp', {'icons': true***REMOVED***)
...
app.use('/ftp', express.static('public/ftp'), serveIndex('public/ftp', {'icons': true***REMOVED***))
