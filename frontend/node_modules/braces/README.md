...
1. **lists**: which are defined using comma-separated values inside curly braces: `{a,b,c***REMOVED***`
2. **sequences**: which are defined using a starting value and an ending value, separated by two dots: `a{1..3***REMOVED***b`. Optionally, a third argument may be passed to define a "step" or increment to use: `a{1..100..10***REMOVED***b`. These are also sometimes referred to as "ranges".
...
```
{a,b,c***REMOVED***       => a b c
{a,b,c***REMOVED***{1,2***REMOVED***  => a1 a2 b1 b2 c1 c2
```

**Sequences**

```
{1..9***REMOVED***        => 1 2 3 4 5 6 7 8 9
{4..-4***REMOVED***       => 4 3 2 1 0 -1 -2 -3 -4
{1..20..3***REMOVED***    => 1 4 7 10 13 16 19
{a..j***REMOVED***        => a b c d e f g h i j
{j..a***REMOVED***        => j i h g f e d c b a
{a..z..3***REMOVED***     => a d g j m p s v y
```
...
```
{a,b,c***REMOVED***{1..3***REMOVED***   => a1 a2 a3 b1 b2 b3 c1 c2 c3
foo/{a,b,c***REMOVED***/bar => foo/a/bar foo/b/bar foo/c/bar
```
...
For example, the pattern `foo/{1..3***REMOVED***/bar` would match any of following strings:
...
Braces can also be combined with [glob patterns](https://github.com/jonschlinkert/micromatch) to perform more advanced wildcard matching. For example, the pattern `*/{1..3***REMOVED***/*` would match any of following strings:
...
```
{1,2***REMOVED***{3,4***REMOVED***      => (2X2)    => 13 14 23 24
{1,2***REMOVED***{3,4***REMOVED***{5,6***REMOVED*** => (2X2X2)  => 135 136 145 146 235 236 245 246
```

But add an element to a set, and we get a n-fold Cartesian product with `O(n^c)` complexity:

```
{1,2,3***REMOVED***{4,5,6***REMOVED***{7,8,9***REMOVED*** => (3X3X3) => 147 148 149 157 158 159 167 168 169 247 248
...
```
{1..100***REMOVED***{1..100***REMOVED***         => (100X100)     => 10,000 elements (38.4 kB)
{1..100***REMOVED***{1..100***REMOVED***{1..100***REMOVED*** => (100X100X100) => 1,000,000 elements (5.76 MB)
```
