...
var Container = /*#__PURE__*/function (_Node) {
    ...
    this.each(function (node) {
      if (node.atPosition) {
        ...
        if (foundChild) {
          ...
          return false;
        ***REMOVED***
      ***REMOVED*** else if (node.isAtPosition(line, col)) {
        found = node;
        return false;
      ***REMOVED***
    ***REMOVED***);
  ...
  ***REMOVED***
   ...
   * @param {number***REMOVED*** line The line number of the node to find. (1-based index)
   * @param {number***REMOVED*** col  The column number of the node to find. (1-based index)
   */;
  ...
  ***REMOVED***;
  _proto._inferEndPosition = function _inferEndPosition() {
    if (this.last && this.last.source && this.last.source.end) {
      this.source = this.source || {***REMOVED***;
      this.source.end = this.source.end || {***REMOVED***;
  ...
  _proto.split = function split(callback) {
    ...
    return this.reduce(function (memo, node, index) {
      ...
      if (split) {
        memo.push(current);
        current = [];
      ***REMOVED*** else if (index === _this11.length - 1) {
        memo.push(current);
      ***REMOVED***
      return memo;
    ***REMOVED***, []);
