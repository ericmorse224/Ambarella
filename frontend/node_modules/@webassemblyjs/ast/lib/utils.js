...
function orderedInsertNode(m, n) {
  ...
  ***REMOVED***
  ...
  m.fields = m.fields.reduce(function (acc, field) {
    ...
    ***REMOVED*** // $FlowIgnore: assertHasLoc ensures that
    ...
    ***REMOVED***
    ...
    acc.push(field);
    return acc;
  ***REMOVED***, []); // Handles empty modules or n is the last element
...
function shiftSection(ast, node, delta) {
  ...
  ***REMOVED*** // Custom sections doesn't have vectorOfSize
