...
module.exports = function (includes, t) {
	var sparseish = { length: 5, 0: 'a', 1: 'b' ***REMOVED***;
	var overfullarrayish = { length: 2, 0: 'a', 1: 'b', 2: 'c' ***REMOVED***;
	var thrower = { valueOf: function () { throw new RangeError('whoa'); ***REMOVED*** ***REMOVED***;
	var numberish = { valueOf: function () { return 2; ***REMOVED*** ***REMOVED***;
	...
	***REMOVED***);
	...
	t.test('exceptions', function (et) {
		et.test('fromIndex conversion', function (st) {
			st['throws'](function () { includes([0], 0, thrower); ***REMOVED***, RangeError, 'fromIndex conversion throws');
			st.end();
		***REMOVED***);

		et.test('ToLength', function (st) {
			st['throws'](function () { includes({ length: thrower, 0: true ***REMOVED***, true); ***REMOVED***, RangeError, 'ToLength conversion throws');
			st.end();
		***REMOVED***);
