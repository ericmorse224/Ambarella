...
const { NAMESPACES ***REMOVED*** = require("./constants");
...
function serializeAttributes(
  ...
  for (const attr of element.attributes) {
    ...
    ***REMOVED***
    ...
    if (attributeNamespace !== null) {
      ...
      if (attributeNamespace === NAMESPACES.XMLNS) {
        ...
        ***REMOVED***
      ***REMOVED*** else if (candidatePrefix === null) {
        candidatePrefix = generatePrefix(
          map,
          attributeNamespace,
          refs.prefixIndex++
        );
        result += ` xmlns:${candidatePrefix***REMOVED***="${serializeAttributeValue(
          attributeNamespace,
          requireWellFormed
        )***REMOVED***"`;
      ***REMOVED***
    ...
    ***REMOVED***
    result += `${attr.localName***REMOVED***="${serializeAttributeValue(
      attr.value,
      requireWellFormed
    )***REMOVED***"`;
  ***REMOVED***
