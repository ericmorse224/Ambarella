...
var applySourceMap = function(
	...
	var middleSourceContents = {***REMOVED***;

	var m2rMappingsByLine = {***REMOVED***;

	var rightSourceContentsSet = {***REMOVED***;
	var rightSourceContentsLines = {***REMOVED***;
					...
					if(rightLine) {
						...
						if(offset > 0) {
							...
							if(middlePart === rightPart) {
								...
								m2rBestFit = Object.assign({***REMOVED***, m2rBestFit, {
