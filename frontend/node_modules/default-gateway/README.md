...
const {gateway, interface***REMOVED*** = await defaultGateway.v4();
// gateway = '1.2.3.4', interface = 'en1'

const {gateway, interface***REMOVED*** = await defaultGateway.v6();
// gateway = '2001:db8::1', interface = 'en2'

const {gateway, interface***REMOVED*** = defaultGateway.v4.sync();
// gateway = '1.2.3.4', interface = 'en1'

const {gateway, interface***REMOVED*** = defaultGateway.v6.sync();
// gateway = '2001:db8::1', interface = 'en2'
```
...
The `.v{4,6***REMOVED***()` methods return a Promise while the `.v{4,6***REMOVED***.sync()` variants will return the result synchronously.
