...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        fixable: "whitespace",
        schema: [{ enum: ["starred-block", "separate-lines", "bare-block"] ***REMOVED***],
        messages: {
    ...
    ***REMOVED***,
    ...
    create(context) {
         ...
         * @param {string***REMOVED*** line A string representing a comment line.
         * @returns {boolean***REMOVED*** Whether or not the comment line is starred.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token[]***REMOVED*** commentGroup A group of comments, containing either multiple line comments or a single block comment.
         * @returns {boolean***REMOVED*** Whether or not the comment group is in starred block form.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token[]***REMOVED*** commentGroup A group of comments, containing either multiple line comments or a single block comment.
         * @returns {boolean***REMOVED*** Whether or not the comment group is in JSDoc form.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token[]***REMOVED*** commentGroup A group of comments containing multiple line comments.
         * @returns {string[]***REMOVED*** An array of the processed lines.
         */
        function processSeparateLineComments(commentGroup) {
            ...
            return commentGroup.map(({ value ***REMOVED***) => (allLinesHaveLeadingSpace ? value.replace(/^ /u, "") : value));
        ***REMOVED***

        /**
         * Processes a comment group that is currently in starred-block form, calculating the offset for each line.
         * @param {Token***REMOVED*** comment A single block comment token in starred-block form.
         * @returns {string[]***REMOVED*** An array of the processed lines.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** comment A single block comment token in bare-block form.
         * @returns {string[]***REMOVED*** An array of the processed lines.
         */
        function processBareBlockComment(comment) {
            ...
            const leadingWhitespace = `${sourceCode.text.slice(comment.range[0] - comment.loc.start.column, comment.range[0])***REMOVED***   `;
            let offset = "";
            ...
            ***REMOVED***
            ...
            return lines.map(line => {
                ...
                if (lineOffset.length > leadingWhitespace.length) {
                    return `${lineOffset.slice(leadingWhitespace.length - (offset.length + lineOffset.length))***REMOVED***${lineContents***REMOVED***`;
                ***REMOVED***

                if (lineOffset.length < leadingWhitespace.length) {
                    return `${lineOffset.slice(leadingWhitespace.length)***REMOVED***${lineContents***REMOVED***`;
                ***REMOVED***
        ...
        ***REMOVED***
         ...
         * @param {Token[]***REMOVED*** commentGroup A group of comments containing either multiple line comments or a single block comment.
         * @returns {string[]***REMOVED*** A list of comment lines.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** comment The token to check.
         * @returns {string***REMOVED*** The offset from the beginning of a line to the token.
         */
        ...
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** firstComment The first comment of the group being converted
         * @param {string[]***REMOVED*** commentLinesList A list of lines to appear in the new starred-block comment
         * @returns {string***REMOVED*** A representation of the comment value in starred-block form, excluding start and end markers
         */
        function convertToStarredBlock(firstComment, commentLinesList) {
            const initialOffset = getInitialOffset(firstComment);

            return `/*\n${commentLinesList.map(line => `${initialOffset***REMOVED*** * ${line***REMOVED***`).join("\n")***REMOVED***\n${initialOffset***REMOVED*** */`;
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** firstComment The first comment of the group being converted
         * @param {string[]***REMOVED*** commentLinesList A list of lines to appear in the new starred-block comment
         * @returns {string***REMOVED*** A representation of the comment value in separate-line form
         */
        function convertToSeparateLines(firstComment, commentLinesList) {
            return commentLinesList.map(line => `// ${line***REMOVED***`).join(`\n${getInitialOffset(firstComment)***REMOVED***`);
        ***REMOVED***
         ...
         * @param {Token***REMOVED*** firstComment The first comment of the group being converted
         * @param {string[]***REMOVED*** commentLinesList A list of lines to appear in the new starred-block comment
         * @returns {string***REMOVED*** A representation of the comment value in bare-block form
         */
        function convertToBlock(firstComment, commentLinesList) {
            return `/* ${commentLinesList.join(`\n${getInitialOffset(firstComment)***REMOVED***   `)***REMOVED*** */`;
        ***REMOVED***

        /**
         * Each method checks a group of comments to see if it's valid according to the given option.
         * @param {Token[]***REMOVED*** commentGroup A list of comments that appear together. This will either contain a single
        ...
        const commentGroupCheckers = {
            "starred-block"(commentGroup) {
                ...
                ***REMOVED*** else {
                    ...
                    const expectedLinePrefix = `${expectedLeadingWhitespace***REMOVED*** *`;
                    ...
                    if (!/^\*?\s*$/u.test(lines[0])) {
                        ...
                        context.report({
                            loc: {
                                start: firstComment.loc.start,
                                end: { line: firstComment.loc.start.line, column: firstComment.loc.start.column + 2 ***REMOVED***
                            ***REMOVED***,
                            messageId: "startNewline",
                            fix: fixer => fixer.insertTextAfterRange([start, start + 2], `\n${expectedLinePrefix***REMOVED***`)
                        ***REMOVED***);
                    ***REMOVED***
                    ...
                    if (!/^\s*$/u.test(lines[lines.length - 1])) {
                        context.report({
                            loc: {
                                start: { line: firstComment.loc.end.line, column: firstComment.loc.end.column - 2 ***REMOVED***,
                    ...
                    ***REMOVED***
                    ...
                    for (let lineNumber = firstComment.loc.start.line + 1; lineNumber <= firstComment.loc.end.line; lineNumber++) {
                        ...
                        if (!lineText.startsWith(expectedLinePrefix)) {
                            context.report({
                                loc: {
                                    start: { line: lineNumber, column: 0 ***REMOVED***,
                                    end: { line: lineNumber, column: lineText.length ***REMOVED***
                                ***REMOVED***,
                                messageId: errorType,
                                fix(fixer) {
                                    const lineStartIndex = sourceCode.getIndexFromLoc({ line: lineNumber, column: 0 ***REMOVED***);
                                    ...
                                    ***REMOVED***
                                    ...
                                    for (const [idx, line] of lines.entries()) {
                                        ...
                                        ***REMOVED***
                                        ...
                                        offset = `${commentTextPrefix.slice(prefix.length)***REMOVED***${initialOffset***REMOVED***`;
                                    ...
                                    ***REMOVED***
                                    ...
                                    return fixer.replaceTextRange([lineStartIndex, commentTextStartIndex], `${expectedLinePrefix***REMOVED***${offset***REMOVED***`);
                                ***REMOVED***
                            ***REMOVED***);
                        ***REMOVED***
                    ***REMOVED***
            ...
            ***REMOVED***,
            "separate-lines"(commentGroup) {
                ...
                ***REMOVED***
                ...
                const commentLines = getCommentLines(commentGroup);
                const tokenAfter = sourceCode.getTokenAfter(firstComment, { includeComments: true ***REMOVED***);
        ...
        return {
            Program() {
                return sourceCode.getAllComments()
                    ...
                    .filter(comment => {
                        const tokenBefore = sourceCode.getTokenBefore(comment, { includeComments: true ***REMOVED***);
