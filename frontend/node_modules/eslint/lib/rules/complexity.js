...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			complex:
				"{{name***REMOVED******REMOVED*** has a complexity of {{complexity***REMOVED******REMOVED***. Maximum allowed is {{max***REMOVED******REMOVED***.",
		***REMOVED***,
	***REMOVED***,
			...
			onCodePathEnd(codePath, node) {
				...
				***REMOVED***
				...
				if (complexity > threshold) {
					...
					***REMOVED*** else if (codePath.origin === "class-static-block") {
