...
/* XHR API */
var xhrApi = module.exports = forge.xhr = forge.xhr || {***REMOVED***;
    ...
    for(var key in _clients) {
      ...
      if(http.withinCookieDomain(client.url, domain)) {
        ...
        if(cookie !== null) {
          if(rval === null) {
            rval = cookie;
          ***REMOVED*** else if(!forge.util.isArray(rval)) {
            rval = [rval, cookie];
          ***REMOVED*** else {
            rval.push(cookie);
          ***REMOVED***
...
xhrApi.create = function(options) {
  ...
  options = $.extend({
    ...
    verbose: false,
    logError: function() {***REMOVED***,
    logWarning: function() {***REMOVED***,
    logDebug: function() {***REMOVED***,
    logVerbose: function() {***REMOVED***,
    url: null
