...
const errorMessage = (expression) => `The prop value with an expression type of ${expression***REMOVED*** could not be resolved. Please file an issue ( https://github.com/jsx-eslint/jsx-ast-utils/issues/new ) to get this fixed immediately.`;
...
const LITERAL_TYPES = {
  ...
  Literal: (value) => {
    ...
    // value explicitly defined (<div prop={null***REMOVED*** /> maps to 'null').
