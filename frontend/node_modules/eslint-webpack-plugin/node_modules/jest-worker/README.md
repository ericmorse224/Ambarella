...
async function main() {
  ...
  ***REMOVED***);
  ...
  const {forceExited***REMOVED*** = await myWorker.end();
  if (forceExited) {
...
export function foo(param) {
  return `Hello from foo: ${param***REMOVED***`;
***REMOVED***

export function bar(param) {
  return `Hello from bar: ${param***REMOVED***`;
***REMOVED***
