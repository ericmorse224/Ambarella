...
const LIST_MAP_OPTIONS = { columns: false ***REMOVED***;

const mapToBufferedMap = map => {
	if (typeof map !== "object" || !map) return map;
	const bufferedMap = Object.assign({***REMOVED***, map);
	if (map.mappings) {
...
const bufferedMapToMap = bufferedMap => {
	...
	const map = Object.assign({***REMOVED***, bufferedMap);
...
class CachedSource extends Source {
	...
	***REMOVED***
	...
	_getMapFromCacheEntry(cacheEntry) {
		...
		***REMOVED*** else if (cacheEntry.bufferedMap !== undefined) {
			return (cacheEntry.map = bufferedMapToMap(cacheEntry.bufferedMap));
		***REMOVED*** else if (cacheEntry.node !== undefined) {
		...
		***REMOVED*** else if (cacheEntry.listMap !== undefined) {
	...
	***REMOVED***
	...
	sourceAndMap(options) {
		const key = options ? JSON.stringify(options) : "{***REMOVED***";
		...
		if (cacheEntry !== undefined) {
			...
			return { source: this.source(), map ***REMOVED***;
		***REMOVED***
	...
	***REMOVED***
	...
	listMap(options) {
		...
		if (!options) {
			key = '{"columns":false***REMOVED***';
			options = LIST_MAP_OPTIONS;
		***REMOVED*** else {
			if (options.columns !== false) {
				options = Object.assign({***REMOVED***, options, LIST_MAP_OPTIONS);
			***REMOVED***
