 ...
 *
 * @example
 * const root = postcss.parse(css, { from: 'a.sass.css' ***REMOVED***)
...
var PreviousMap = /*#__PURE__*/function () {
   ...
   * @param {processOptions***REMOVED*** [opts] {@link Processor#process***REMOVED*** options.
   */
  ...
  ***REMOVED***
   ...
   *
   * @return {SourceMapGenerator***REMOVED*** Object with source map information.
   */
  ...
  ***REMOVED***
   ...
   *
   * @return {boolean***REMOVED*** Is `sourcesContent` present.
   */
  ;
  ...
  _proto.loadMap = function loadMap(file, prev) {
    ...
    if (prev) {
      ...
      ***REMOVED*** else if (typeof prev === 'function') {
        ...
        ***REMOVED***
      ***REMOVED*** else if (prev instanceof _sourceMap.default.SourceMapConsumer) {
        return _sourceMap.default.SourceMapGenerator.fromSourceMap(prev).toString();
      ***REMOVED*** else if (prev instanceof _sourceMap.default.SourceMapGenerator) {
