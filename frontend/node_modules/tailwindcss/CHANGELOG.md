...
- Support negative values for `{col,row***REMOVED***-{start,end***REMOVED***` utilities ([#13781](https://github.com/tailwindlabs/tailwindcss/pull/13781))
...
- Add `from-{position***REMOVED***`, `via-{position***REMOVED***` and `to-{position***REMOVED***` utilities ([#10886](https://github.com/tailwindlabs/tailwindcss/pull/10886))
...
- Rename `{u***REMOVED***-max-content` and `{u***REMOVED***-min-content` utilities to `{u***REMOVED***-max` and `{u***REMOVED***-min` in experimental extended spacing scale ([#2532](https://github.com/tailwindlabs/tailwindcss/pull/2532))
...
- Fix bug where the new `applyComplexClasses` experiment didn't behave as expected with rules with multiple selectors, like `.foo, .bar { color: red ***REMOVED***`
...
- Fix bug where target: 'browserslist' didn't work, only `target: ['browserslist', {...***REMOVED***]` did
...
- Fix issue where `purge: { enabled: false ***REMOVED***` was ignored, add `purge: false` shorthand
...
- Fix bug where `divide-{x/y***REMOVED***-0` utilities didn't work due to missing unit in `calc` call
...
- CSS Grid support
- Added `max-w-{screen***REMOVED***` utilities
...
- CSS Transform support
- CSS Grid support
- New `max-w-{screen***REMOVED***` utilities
- Added `max-w-none` utility
