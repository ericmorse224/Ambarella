...
class PrecacheStrategy extends Strategy {
    ...
    ***REMOVED***
    async _handleFetch(request, handler) {
        let response;
        const params = (handler.params || {***REMOVED***);
        ...
        if (this._fallbackToNetwork) {
            ...
            ***REMOVED***));
            ...
            if (integrityInManifest &&
                ...
                if (process.env.NODE_ENV !== 'production') {
                    if (wasCached) {
                        logger.log(`A response for ${getFriendlyURL(request.url)***REMOVED*** ` +
        ...
        ***REMOVED***
        if (process.env.NODE_ENV !== 'production') {
            ...
            logger.log(`Serving the precached url: ${getFriendlyURL(cacheKey instanceof Request ? cacheKey.url : cacheKey)***REMOVED***`);
