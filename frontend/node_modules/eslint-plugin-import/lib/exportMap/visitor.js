...
var _remotePath = require('./remotePath');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***;***REMOVED***function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");***REMOVED******REMOVED***
...
function makeSourceCode(text, ast) {
  ...
  ***REMOVED*** else {
    // ESLint 4, 5
    return new _eslint.SourceCode({ text: text, ast: ast ***REMOVED***);
  ***REMOVED***
***REMOVED***var
...
ImportExportVisitorBuilder = function () {
  ...
  {var _this = this;_classCallCheck(this, ImportExportVisitorBuilder);
    ...
    this.docStyleParsers = {***REMOVED***;
    docstyle.forEach(function (style) {
      _this.docStyleParsers[style] = _doc.availableDocStyleParsers[style];
    ***REMOVED***);
  ***REMOVED***_createClass(ImportExportVisitorBuilder, [{ key: 'build', value: function () {function build(
      ...
      astNode) {var _this3 = this;
        return Object.assign({
          ...
          ExportAllDeclaration: function () {function ExportAllDeclaration() {
              ...
              if (getter) {this.exportMap.dependencies.add(getter);***REMOVED***
              if (astNode.exported) {
          ...
          ImportDeclaration: function () {function ImportDeclaration() {
              ...
              var ns = astNode.specifiers.find(function (s) {return s.type === 'ImportNamespaceSpecifier';***REMOVED***);
              if (ns) {
          ...
          ExportNamedDeclaration: function () {function ExportNamedDeclaration() {var _this2 = this;
                ...
                switch (astNode.declaration.type) {
                  ...
                  case 'VariableDeclaration':
                    astNode.declaration.declarations.forEach(function (d) {
                      ...
                      d.id,
                      function (id) {return _this2.exportMap.namespace.set(id.name, (0, _doc.captureDoc)(_this2.source, _this2.docStyleParsers, d, astNode));***REMOVED***);
              ...
              ***REMOVED***
              astNode.specifiers.forEach(function (s) {return (0, _specifier2['default'])(s, astNode, _this2.exportMap, _this2.namespace);***REMOVED***);
            ***REMOVED***return ExportNamedDeclaration;***REMOVED***(),
          TSExportAssignment: function () {function TSExportAssignment() {return _this3.typeScriptExport(astNode);***REMOVED***return TSExportAssignment;***REMOVED***() ***REMOVED***,
        this.isEsModuleInteropTrue && { TSNamespaceExportDeclaration: function () {function TSNamespaceExportDeclaration() {return _this3.typeScriptExport(astNode);***REMOVED***return TSNamespaceExportDeclaration;***REMOVED***() ***REMOVED***);

      ***REMOVED***return build;***REMOVED***()

    // This doesn't declare anything, but changes what's being exported.
  ***REMOVED***, { key: 'typeScriptExport', value: function () {function typeScriptExport(astNode) {var _this4 = this;
        ...
        var exportedDecls = this.ast.body.filter(function (_ref) {var type = _ref.type,id = _ref.id,declarations = _ref.declarations;return (0, _arrayIncludes2['default'])(declTypes, type) && (
          id && id.name === exportedName || declarations && declarations.find(function (d) {return d.id.name === exportedName;***REMOVED***));***REMOVED***);
        ...
        ***REMOVED***
        ...
        && !this.exportMap.namespace.has('default') // and default isn't added already
            ...
            this.exportMap.namespace.set('default', {***REMOVED***); // add default export
          ***REMOVED***
        exportedDecls.forEach(function (decl) {
          if (decl.type === 'TSModuleDeclaration') {
            ...
            ***REMOVED*** else if (decl.body && decl.body.body) {
              decl.body.body.forEach(function (moduleBlockNode) {
                ...
                ***REMOVED*** else if (namespaceDecl.type === 'VariableDeclaration') {
                  namespaceDecl.declarations.forEach(function (d) {return (0, _patternCapture2['default'])(d.id, function (id) {return _this4.exportMap.namespace.set(
                      id.name,
                      (0, _doc.captureDoc)(_this4.source, _this4.docStyleParsers, decl, namespaceDecl, moduleBlockNode));***REMOVED***);***REMOVED***);
          ...
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED***return typeScriptExport;***REMOVED***() ***REMOVED***]);return ImportExportVisitorBuilder;***REMOVED***();exports['default'] = ImportExportVisitorBuilder;
