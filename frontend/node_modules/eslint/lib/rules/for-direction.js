	...
	***REMOVED***,
	...
	create(context) {
		...
		***REMOVED***
		 ...
		 * @param {number***REMOVED*** dir expected direction that could either be turned around or invalidated
		 * @returns {number***REMOVED*** return dir, the negated dir, or zero if the counter does not change or the direction is not clear
		 */
		...
		***REMOVED***
		 ...
		 * @returns {number***REMOVED*** if add return 1, if sub return -1, if nochange, return 0
		 */
