const tests = {
  // ECMAScript 2018
  "object-rest-spread": ["({ ...{***REMOVED*** ***REMOVED***)", "({ ...x ***REMOVED*** = {***REMOVED***)"], // Babel 7.2.0
  "async-generators": ["async function* f() {***REMOVED***"], //  Babel 7.2.0

  // ECMAScript 2019
  "optional-catch-binding": ["try {***REMOVED*** catch {***REMOVED***"], // Babel 7.2.0
  ...
  "class-properties": [
    "(class { x = 1 ***REMOVED***)",
    "(class { #x = 1 ***REMOVED***)",
    "(class { #x() {***REMOVED*** ***REMOVED***)",
  ],
  "private-property-in-object": ["(class { #x; m() { #x in y ***REMOVED*** ***REMOVED***)"],
  "class-static-block": ["(class { static {***REMOVED*** ***REMOVED***)"],
...
for (const [name, cases] of Object.entries(tests)) {
  if (cases.some(works)) {
    plugins.push(require.resolve(`@babel/plugin-syntax-${name***REMOVED***`));
  ***REMOVED***
***REMOVED***
...
***REMOVED***
module.exports = () => ({ plugins ***REMOVED***);
