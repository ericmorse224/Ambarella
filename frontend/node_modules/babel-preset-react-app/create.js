...
const validateBoolOption = (name, value, defaultValue) => {
  ...
  ***REMOVED***
  ...
  if (typeof value !== 'boolean') {
    throw new Error(`Preset react-app: '${name***REMOVED***' option must be a boolean.`);
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  return {
    presets: [
      ...
      [
        require('@babel/preset-react').default,
        {
          ...
          ...(opts.runtime !== 'automatic' ? { useBuiltIns: true ***REMOVED*** : {***REMOVED***),
    ...
    plugins: [
      ...
      // class { handleClick = () => { ***REMOVED*** ***REMOVED***
