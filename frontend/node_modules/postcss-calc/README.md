...
```js
var out = postcss()
  .use(calc({preserve: true***REMOVED***))
  .process(css)
  .css
```
...
```js
var out = postcss()
  .use(calc({warnWhenCannotResolve: true***REMOVED***))
  .process(css)
  .css
```
...
```js
var out = postcss()
  .use(calc({mediaQueries: true***REMOVED***))
  .process(css)
  .css
```
...
```js
var out = postcss()
  .use(calc({selectors: true***REMOVED***))
  .process(css)
  .css
```
