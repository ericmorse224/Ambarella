...
module.exports = {
    meta: {
        ...
        ***REMOVED***,
        ...
        messages: {
            multipleSpaces: "Multiple spaces found before '{{displayValue***REMOVED******REMOVED***'."
        ***REMOVED***
    ***REMOVED***,
    ...
    create(context) {
        ...
        const exceptions = Object.assign({ Property: true ***REMOVED***, options.exceptions);
        const hasExceptions = Object.keys(exceptions).filter(key => exceptions[key]).length > 0;

        /**
         * Formats value of given comment token for error message by truncating its length.
         * @param {Token***REMOVED*** token comment token
         * @returns {string***REMOVED*** formatted value
         * @private
         */
        function formatReportedCommentValue(token) {
            const valueLines = token.value.split("\n");
            const value = valueLines[0];
            const formattedValue = `${value.slice(0, 12)***REMOVED***...`;
                ...
                sourceCode.tokensAndComments.forEach((leftToken, leftIndex, tokensAndComments) => {
                    ...
                    ***REMOVED***
                    ...
                    if (rightToken.type === "Block") {
                        displayValue = `/*${formatReportedCommentValue(rightToken)***REMOVED****/`;
                    ***REMOVED*** else if (rightToken.type === "Line") {
                        displayValue = `//${formatReportedCommentValue(rightToken)***REMOVED***`;
                    ***REMOVED*** else {
                    ...
                    ***REMOVED***
                    ...
                    context.report({
                        node: rightToken,
                        loc: { start: leftToken.loc.end, end: rightToken.loc.start ***REMOVED***,
