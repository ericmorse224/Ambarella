...
exports.default = util.createRule({
    ...
    meta: {
        ...
        ***REMOVED***,
        messages: {
            tripleSlashReference: 'Do not use a triple slash reference for {{module***REMOVED******REMOVED***, use `import` style instead.',
        ***REMOVED***,
        schema: [
            {
                type: 'object',
    ...
    ***REMOVED***,
    ...
    create(context, [{ lib, path, types ***REMOVED***]) {
        let programNode;
                    ...
                    if (referenceResult) {
                        ...
                        ***REMOVED***
                        if (referenceResult[1] === 'types' && types === 'prefer-import') {
                            references.push({ comment, importName: referenceResult[2] ***REMOVED***);
                        ***REMOVED***
                    ***REMOVED***
                ***REMOVED***);
            ***REMOVED***,
