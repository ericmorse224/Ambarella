...
class FlatConfigArray extends ConfigArray {
	...
	constructor(
		configs,
		{ basePath, shouldIgnore = true, baseConfig = defaultConfig ***REMOVED*** = {***REMOVED***,
	) {
		super(configs, {
			basePath,
