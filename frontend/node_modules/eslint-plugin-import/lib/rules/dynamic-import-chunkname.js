...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('dynamic-import-chunkname') ***REMOVED***,
    ...
    hasSuggestions: true ***REMOVED***,


  create: function () {function create(context) {
      var config = context.options[0];var _ref =
      config || {***REMOVED***,_ref$importFunctions = _ref.importFunctions,importFunctions = _ref$importFunctions === undefined ? [] : _ref$importFunctions,_ref$allowEmpty = _ref.allowEmpty,allowEmpty = _ref$allowEmpty === undefined ? false : _ref$allowEmpty;var _ref2 =
      config || {***REMOVED***,_ref2$webpackChunknam = _ref2.webpackChunknameFormat,webpackChunknameFormat = _ref2$webpackChunknam === undefined ? '([0-9a-zA-Z-_/.]|\\[(request|index)\\])+' : _ref2$webpackChunknam;
      ...
      function run(node, arg) {
        ...
        if ((!leadingComments || leadingComments.length === 0) && !allowEmpty) {
          context.report({
            node: node,
            message: 'dynamic imports require a leading comment with the webpack chunkname' ***REMOVED***);
        ...
        var isEagerModePresent = false;var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
          ...
          for (var _iterator = leadingComments[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var comment = _step.value;
            if (comment.type !== 'Block') {
              context.report({
                node: node,
                message: 'dynamic imports require a /* foo */ style comment, not a // foo comment' ***REMOVED***);
            ...
            ***REMOVED***
            ...
            if (!paddedCommentRegex.test(comment.value)) {
              context.report({
                node: node,
                message: 'dynamic imports require a block comment padded with spaces - /* foo */' ***REMOVED***);
            ...
            ***REMOVED***
            ...
            try {
              ...
              _vm2['default'].runInNewContext('(function() {return {' + String(comment.value) + '***REMOVED******REMOVED***)()');
            ***REMOVED*** catch (error) {
              context.report({
                node: node,
                message: 'dynamic imports require a "webpack" comment with valid syntax' ***REMOVED***);
          ...
          context.report({
...

            {
              ...
              fix: function () {function fix(fixer) {var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
                ...
                ***REMOVED***return fix;***REMOVED***() ***REMOVED***] ***REMOVED***);
