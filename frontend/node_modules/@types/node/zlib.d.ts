 ...
 *
 * ```js
 * import { createGzip ***REMOVED*** from 'node:zlib';
 ...
 *
 * ```js
 * import { deflate, unzip ***REMOVED*** from 'node:zlib';
 *
 * const input = '.................................';
...
declare module "zlib" {
    ...
    ***REMOVED***
    interface ZstdOptions {
         ...
         */
        params?: { [key: number]: number | boolean ***REMOVED*** | undefined;
        /**
    ...
    ***REMOVED***
    interface ZlibReset {
        reset(): void;
    ***REMOVED***
    interface BrotliCompress extends stream.Transform, Zlib {***REMOVED***
    interface BrotliDecompress extends stream.Transform, Zlib {***REMOVED***
    interface Gzip extends stream.Transform, Zlib {***REMOVED***
    interface Gunzip extends stream.Transform, Zlib {***REMOVED***
    interface Deflate extends stream.Transform, Zlib, ZlibReset, ZlibParams {***REMOVED***
    interface Inflate extends stream.Transform, Zlib, ZlibReset {***REMOVED***
    interface DeflateRaw extends stream.Transform, Zlib, ZlibReset, ZlibParams {***REMOVED***
    interface InflateRaw extends stream.Transform, Zlib, ZlibReset {***REMOVED***
    interface Unzip extends stream.Transform, Zlib {***REMOVED***
    /**
     * @since v22.15.0
     * @experimental
     */
    interface ZstdCompress extends stream.Transform, Zlib {***REMOVED***
    /**
     * @since v22.15.0
     * @experimental
     */
    interface ZstdDecompress extends stream.Transform, Zlib {***REMOVED***
    /**
