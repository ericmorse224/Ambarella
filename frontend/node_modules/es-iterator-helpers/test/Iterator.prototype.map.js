...
module.exports = {
	tests: function (map, name, t) {
		t['throws'](
			function () { return new map(); ***REMOVED***, // eslint-disable-line new-cap
			TypeError,
		...
		forEach(v.primitives.concat(v.objects), function (nonIterator) {
			t['throws'](
				function () { iterate(map(nonIterator, function () {***REMOVED***)); ***REMOVED***,
				TypeError,
			...
			t['throws'](
				function () { iterate(map(badNext, function () {***REMOVED***)); ***REMOVED***,
				TypeError,
		...
		***REMOVED***);
		...
		forEach(v.nonFunctions, function (nonFunction) {
			t['throws'](
				function () { map({ next: function () {***REMOVED*** ***REMOVED***, nonFunction); ***REMOVED***,
				TypeError,
		...
		***REMOVED***;
		...
		t.deepEqual(
			result,
			{ value: sentinel, counter: 1, receiver: undefined, args: 2 ***REMOVED***,
		...
		t.test('actual iteration', { skip: !hasSymbols ***REMOVED***, function (st) {
			...
			st['throws'](
				function () { return new map(iterator()); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);
			st['throws'](
				function () { return new map(iterator(), function () {***REMOVED***); ***REMOVED***, // eslint-disable-line new-cap
				TypeError,
				'`' + name + '` iterator is not a constructor'
			);

			testIterator(iterator(), [1, 2, 3], st, 'original');
			testIterator(map(iterator(), function (x) { return x; ***REMOVED***), [1, 2, 3], st, 'identity mapper');
			testIterator(map(iterator(), function (x) { return 2 * x; ***REMOVED***), [2, 4, 6], st, 'doubler mapper');

			st.test('generators', { skip: generators.length === 0 ***REMOVED***, function (s2t) {
				forEach(generators, function (gen) {
					s2t.doesNotThrow(
						function () { map(gen(), function () {***REMOVED***); ***REMOVED***,
