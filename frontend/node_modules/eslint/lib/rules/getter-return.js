...
module.exports = {
	meta: {
		...
		***REMOVED***,
		...
		messages: {
			expected: "Expected to return a value in {{name***REMOVED******REMOVED***.",
			expectedAlways: "Expected {{name***REMOVED******REMOVED*** to always return a value.",
		***REMOVED***,
	***REMOVED***,

	create(context) {
		const [{ allowImplicit ***REMOVED***] = context.options;
		...
		***REMOVED***
		 ...
		 * @param {ASTNode***REMOVED*** node a node to check.
		 * @returns {boolean***REMOVED*** if node means a getter, return true; else return false.
		 */
