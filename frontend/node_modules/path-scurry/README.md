...
import { PathScurry, Path ***REMOVED*** from 'path-scurry'
// or:
const { PathScurry, Path ***REMOVED*** = require('path-scurry')
...
import { unlink ***REMOVED*** from 'fs/promises'
...
const walk = async (entry: Path) => {
  ...
  for (const child of await pw.readdir(entry)) {
    ...
    ***REMOVED*** else if (child.isDirectory()) {
...
#### `async pw.readdir(dir = pw.cwd, opts = { withFileTypes: true ***REMOVED***)`

Read the directory and resolve to an array of strings if
`withFileTypes` is explicitly set to `false` or Path objects
otherwise.

Can be called as `pw.readdir({ withFileTypes: boolean ***REMOVED***)` as
well.
...
#### `pw.readdirSync(dir = pw.cwd, opts = { withFileTypes: true ***REMOVED***)`

Synchronous `pw.readdir()`

#### `async pw.readlink(link = pw.cwd, opts = { withFileTypes: false ***REMOVED***)`

Call `fs.readlink` on the supplied string or Path object, and
return the result.

Can be called as `pw.readlink({ withFileTypes: boolean ***REMOVED***)` as
well.
...
#### `pw.readlinkSync(link = pw.cwd, opts = { withFileTypes: false ***REMOVED***)`
...
#### `pw.realpath(entry = pw.cwd, opts = { withFileTypes: false ***REMOVED***)`
...
May be called as `pw.realpath({ withFileTypes: boolean ***REMOVED***)` to run
on `pw.cwd`.

#### `pw.realpathSync(entry = pw.cwd, opts = { withFileTypes: false ***REMOVED***)`
...
Returns true if `is{t***REMOVED***()` returns true.
