...
export declare type AttributeEventForOptions<O extends SaxesOptions> = O extends {
    xmlns: true;
***REMOVED*** ? SaxesAttributeNSIncomplete : O extends {
    xmlns?: false | undefined;
***REMOVED*** ? SaxesAttributePlain : SaxesAttribute;
/**
...
export declare type TagForOptions<O extends SaxesOptions> = O extends {
    xmlns: true;
***REMOVED*** ? SaxesTagNS : O extends {
    xmlns?: false | undefined;
***REMOVED*** ? SaxesTagPlain : SaxesTag;
export declare type StartTagForOptions<O extends SaxesOptions> = O extends {
    xmlns: true;
***REMOVED*** ? SaxesStartTagNS : O extends {
    xmlns?: false | undefined;
***REMOVED*** ? SaxesStartTagPlain : SaxesStartTag;
export declare class SaxesParser<O extends SaxesOptions = {***REMOVED***> {
     ...
     * @returns this
     */
    write(chunk: string | {***REMOVED*** | null): this;
    /**
     ...
     *
     * @returns {number***REMOVED*** The character read.
     */
    private getCode11;
    /**
