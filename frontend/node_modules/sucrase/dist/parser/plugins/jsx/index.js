  ...
  while (true) {
    ...
    ***REMOVED***
    ...
    if (ch === _charcodes.charCodes.lineFeed) {
      sawNewline = true;
    ***REMOVED*** else if (ch !== _charcodes.charCodes.space && ch !== _charcodes.charCodes.carriageReturn && ch !== _charcodes.charCodes.tab) {
...
function jsxReadWord() {
  ...
  ***REMOVED*** while (_identifier.IS_IDENTIFIER_CHAR[ch] || ch === _charcodes.charCodes.dash);
...
// Does not parse the closing ***REMOVED***
    ...
    while (true) {
      switch (_base.state.type) {
        case _types.TokenType.jsxTagStart:
          ...
          if (_index.match.call(void 0, _types.TokenType.slash)) {
            ...
            if (_base.state.tokens[initialTokenIndex].jsxRole !== _index.JSXRole.KeyAfterPropSpread) {
              ...
              ***REMOVED*** else if (numExplicitChildren > 1) {
        ...
        case _types.TokenType.braceL:
          ...
          ***REMOVED*** else {
            // If we see {***REMOVED***, this is an empty pseudo-expression that doesn't
            // count as a child.
...
// Does not parse the last token.
 function jsxParseElement() {
  nextJSXTagToken();
  jsxParseElementAt();
***REMOVED*** exports.jsxParseElement = jsxParseElement;
...
// ==================================
 ...
 function nextJSXTagToken() {
  ...
  if (_identifier.IS_IDENTIFIER_START[code]) {
    jsxReadWord();
  ***REMOVED*** else if (code === _charcodes.charCodes.quotationMark || code === _charcodes.charCodes.apostrophe) {
    jsxReadString(code);
  ***REMOVED*** else {
    ...
    ***REMOVED***
  ***REMOVED***
***REMOVED*** exports.nextJSXTagToken = nextJSXTagToken;
