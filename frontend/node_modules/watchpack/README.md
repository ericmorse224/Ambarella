...
// Watchpack.prototype.getAggregated(): { changes: Set<string>, removals: Set<string> ***REMOVED***
const { changes, removals ***REMOVED*** = wp.getAggregated();
...
// key: absolute path, value: object with { safeTime, timestamp ***REMOVED***
