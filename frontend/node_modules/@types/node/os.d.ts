...
declare module "os" {
    ...
    ***REMOVED***
     ...
     * available to an application. Use {@link availableParallelism***REMOVED*** for this purpose.
     * @since v0.3.3
     */
     ...
     * @since v6.0.0
     */
    function userInfo(options: { encoding: "buffer" ***REMOVED***): UserInfo<Buffer>;
    function userInfo(options?: { encoding: BufferEncoding ***REMOVED***): UserInfo<string>;
    type SignalConstants = {
        [key in NodeJS.Signals]: number;
    ***REMOVED***;
    namespace constants {
        const UV_UDP_REUSEADDR: number;
        namespace signals {***REMOVED***
