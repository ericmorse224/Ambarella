...
| patternOptions |          | object | options for minimatch, default: { nocomment: true ***REMOVED*** |
...
```ts
/* eslint import/order: ["error", {"newlines-between": "always"***REMOVED***] */
import fs from 'fs';
import path from 'path';
import index from './';
...
```ts
/* eslint import/order: ["error", {"newlines-between": "always-and-inside-groups"***REMOVED***] */
import fs from 'fs';
...
```ts
/* eslint import/order: ["error", {"newlines-between": "never"***REMOVED***] */
import fs from 'fs';
import path from 'path';
...
### `named: true|false|{ enabled: true|false, import: true|false, export: true|false, require: true|false, cjsExports: true|false, types: mixed|types-first|types-last ***REMOVED***`
...
Use `import`, `export` and `require` and `cjsExports` to override the enablement for the following kind of expressions:
 ...
 - `import`:
   ...
   ```ts
   import { Readline ***REMOVED*** from "readline";
   ```

 - `export`:

   ```ts
   export { Readline ***REMOVED***;
   // and
   export { Readline ***REMOVED*** from "readline";
   ```

 - `require`

   ```ts
   const { Readline ***REMOVED*** = require("readline");
   ```
 ...
 - `cjsExports`
   ...
   // and
   module.exports = { Readline ***REMOVED***;
   ```
...
```ts
/* eslint import/order: ["error", {"named": true, "alphabetize": {"order": "asc"***REMOVED******REMOVED***] */
import { compose, apply ***REMOVED*** from 'xcompose';
```
...
```ts
/* eslint import/order: ["error", {"named": true, "alphabetize": {"order": "asc"***REMOVED******REMOVED***] */
import { apply, compose ***REMOVED*** from 'xcompose';
```

### `alphabetize: {order: asc|desc|ignore, orderImportKind: asc|desc|ignore, caseInsensitive: true|false***REMOVED***`
...
```ts
/* eslint import/order: ["error", {"alphabetize": {"order": "asc", "caseInsensitive": true***REMOVED******REMOVED***] */
import React, { PureComponent ***REMOVED*** from 'react';
...
```ts
/* eslint import/order: ["error", {"warnOnUnassignedImports": true***REMOVED***] */
import fs from 'fs';
import './styles.css';
import path from 'path';
```
