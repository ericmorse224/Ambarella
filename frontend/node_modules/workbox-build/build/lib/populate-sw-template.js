...
function populateSWTemplate({ cacheId, cleanupOutdatedCaches, clientsClaim, directoryIndex, disableDevLogs, ignoreURLParametersMatching, importScripts, manifestEntries = [], navigateFallback, navigateFallbackDenylist, navigateFallbackAllowlist, navigationPreload, offlineGoogleAnalytics, runtimeCaching = [], skipWaiting, ***REMOVED***) {
    ...
    ***REMOVED***
        ...
        throw new Error(`${errors_1.errors['populating-sw-tmpl-failed']***REMOVED*** '${error instanceof Error && error.message ? error.message : ''***REMOVED***'`);
    ***REMOVED***
***REMOVED***
