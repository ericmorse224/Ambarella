...
declare namespace yargs {
    ...
    ***REMOVED***;
    ...
    interface Argv<T = {***REMOVED***> {
        (): { [key in keyof Arguments<T>]: Arguments<T>[key] ***REMOVED***;
         ...
         */
        argv: { [key in keyof Arguments<T>]: Arguments<T>[key] ***REMOVED***;
        ...
        option<O extends { [key: string]: Options ***REMOVED***>(options: O): Argv<Omit<T, keyof O> & InferredOptionTypes<O>>;
         ...
         */
        parse(): { [key in keyof Arguments<T>]: Arguments<T>[key] ***REMOVED***;
        parse(
    ...
    ***REMOVED***
    ...
    type InferredOptionType<O extends Options | PositionalOptions> = O extends
        { default: any; coerce: (arg: any) => infer T ***REMOVED*** ? T
        : O extends { default: infer D ***REMOVED*** ? D
        : O extends { type: "count" ***REMOVED*** ? number
        : O extends { count: true ***REMOVED*** ? number
        : O extends { required: string | true ***REMOVED*** ? RequiredOptionType<O>
        : O extends { require: string | true ***REMOVED*** ? RequiredOptionType<O>
        : O extends { demand: string | true ***REMOVED*** ? RequiredOptionType<O>
        : O extends { demandOption: string | true ***REMOVED*** ? RequiredOptionType<O>
        : RequiredOptionType<O> | undefined;

    type RequiredOptionType<O extends Options | PositionalOptions> = O extends { type: "array"; string: true ***REMOVED***
        ? string[]
        : O extends { type: "array"; number: true ***REMOVED*** ? number[]
        : O extends { type: "array"; normalize: true ***REMOVED*** ? string[]
        : O extends { type: "string"; array: true ***REMOVED*** ? string[]
        : O extends { type: "number"; array: true ***REMOVED*** ? number[]
        : O extends { string: true; array: true ***REMOVED*** ? string[]
        : O extends { number: true; array: true ***REMOVED*** ? number[]
        : O extends { normalize: true; array: true ***REMOVED*** ? string[]
        ...
        : O extends { coerce: (arg: any) => infer T ***REMOVED*** ? T
        : unknown;
    ...
    ***REMOVED***
    ...
    type ParseCallback<T = {***REMOVED***> = (err: Error | undefined, argv: Arguments<T>, output: string) => void;
    ...
    type MiddlewareFunction<T = {***REMOVED***> = (args: Arguments<T>) => void;
