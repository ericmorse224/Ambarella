...
const { HTML_NS, SVG_NS ***REMOVED*** = require("./namespaces");
const { domSymbolTree ***REMOVED*** = require("./internal-constants");
const { validateAndExtract ***REMOVED*** = require("./validate-names");
const reportException = require("./runtime-script-errors");
const {
  isValidCustomElementName, upgradeElement, lookupCEDefinition, enqueueCEUpgradeReaction
***REMOVED*** = require("./custom-elements");
...
const TAG_INTERFACE_LOOKUP = {***REMOVED***;

for (const namespace of [HTML_NS, SVG_NS]) {
  TAG_INTERFACE_LOOKUP[namespace] = {***REMOVED***;
...
function createElement(
  ...
  const { _globalObject ***REMOVED*** = document;
  ...
  if (definition !== null && definition.name !== localName) {
    ...
    ***REMOVED***
  ***REMOVED*** else if (definition !== null) {
    if (synchronousCE) {
      try {
