...
/** @typedef {import("./PackFileCacheStrategy")***REMOVED*** PackFileCacheStrategy */
...
class IdleFileCachePlugin {
	/**
	 * @param {PackFileCacheStrategy***REMOVED*** strategy cache strategy
	 * @param {number***REMOVED*** idleTimeout timeout
	 * @param {number***REMOVED*** idleTimeoutForInitialStore initial timeout
	 * @param {number***REMOVED*** idleTimeoutAfterLargeChanges timeout after changes
	 */
	constructor(
		strategy,
		idleTimeout,
	...
	***REMOVED***
	...
	apply(compiler) {
		...
		/** @type {Map<string | typeof BUILD_DEPENDENCIES_KEY, () => Promise<void>>***REMOVED*** */
		const pendingIdleTasks = new Map();

		compiler.cache.hooks.store.tap(
			{ name: PLUGIN_NAME, stage: Cache.STAGE_DISK ***REMOVED***,
				...
				currentIdlePromise = currentIdlePromise
					...
					***REMOVED***)
					.catch(err => {
						...
						logger.warn(`Background tasks during idle failed: ${err.message***REMOVED***`);
						logger.debug(err.stack);
					***REMOVED***);
				isInitialStore = false;
			***REMOVED***
		***REMOVED***;
		/** @type {ReturnType<typeof setTimeout> | undefined***REMOVED*** */
		let idleTimer;
			...
			() => {
				...
				***REMOVED*** else if (
					...
					compiler
						.getInfrastructureLogger(PLUGIN_NAME)
						.log(
							`Spend ${Math.round(timeSpendInBuild) / 1000***REMOVED***s in build and ${
								Math.round(avgTimeSpendInStore) / 1000
							***REMOVED***s in average in cache store. This is considered as large change and cache will be persisted in ${
		...
		compiler.hooks.done.tap(PLUGIN_NAME, stats => {
			...
			timeSpendInBuild +=
				/** @type {number***REMOVED*** */ (stats.endTime) -
				/** @type {number***REMOVED*** */ (stats.startTime);
		***REMOVED***);
	***REMOVED***
***REMOVED***
