...
test('BigInts are supported', { skip: !hasBigInts() ***REMOVED***, function (t) {
...
test('BigInts are not supported', { skip: hasBigInts() ***REMOVED***, function (t) {
