...
const { ConfigArrayFactory ***REMOVED*** = require("./config-array-factory");
    ...
    ***REMOVED***
    ...
    if (eslintrcConfig.plugins && typeof eslintrcConfig.plugins === "object") {
        ...
        for (const pluginName of Object.keys(eslintrcConfig.plugins)) {
            ...
            const { definition: plugin, error ***REMOVED*** = eslintrcConfig.plugins[pluginName];
...
class FlatCompat {
    ...
    ***REMOVED***
     ...
     * @returns {Object***REMOVED*** A flag-config object representing the environments.
     */
    env(envConfig) {
        return this.config({
            env: envConfig
    ...
    ***REMOVED***
     ...
     * @returns {Object***REMOVED*** A flag-config object representing the config.
     */
    ...
    ***REMOVED***
     ...
     * @returns {Object***REMOVED*** A flag-config object representing the plugins.
     */
    plugins(...plugins) {
        return this.config({
            plugins
