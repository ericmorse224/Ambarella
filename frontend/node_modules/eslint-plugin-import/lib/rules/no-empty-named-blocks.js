...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: (0, _docsUrl2['default'])('no-empty-named-blocks') ***REMOVED***,
  ...
  create: function () {function create(context) {
      ...
      return {
        ImportDeclaration: function () {function ImportDeclaration(node) {
            if (!node.specifiers.some(function (x) {return x.type === 'ImportSpecifier';***REMOVED***)) {
              importsWithoutNameds.push(node);
            ***REMOVED***
          ***REMOVED***return ImportDeclaration;***REMOVED***(),

        'Program:exit': function () {function ProgramExit(program) {
            var importsTokens = importsWithoutNameds.map(function (node) {return [node, program.tokens.filter(function (x) {return x.range[0] >= node.range[0] && x.range[1] <= node.range[1];***REMOVED***)];***REMOVED***);
                    ...
                    context.report({
...

                      {
                        ...
                        fix: function () {function fix(fixer) {
                            ...
                            var fromToken = program.tokens.find(function (t) {return t.value === 'from';***REMOVED***);
                            var importToken = program.tokens.find(function (t) {return t.value === 'import';***REMOVED***);
